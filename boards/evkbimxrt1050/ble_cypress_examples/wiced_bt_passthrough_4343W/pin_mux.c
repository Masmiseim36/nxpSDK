...
- {pin_num: G10, pin_signal: GPIO_AD_B0_11, label: BT_REG_ON, identifier: INT2_COMBO;BOARD_INITPINS_BT_REG_ON_GPIO;BOARD_INITPINS_BT_REG_ON;BT_REG_ON}
- {pin_num: L11, pin_signal: GPIO_AD_B1_02, label: UART2_TXD, identifier: SPDIF_OUT;UART2_TXD}
- {pin_num: M12, pin_signal: GPIO_AD_B1_03, label: UARD2_RXD, identifier: SPDIF_IN;UART2_RXD}
