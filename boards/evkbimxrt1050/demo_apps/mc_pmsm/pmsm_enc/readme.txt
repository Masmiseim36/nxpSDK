...
Boards settings
===============
Before you connect the MIMXRT1050-EVKB board with FRDM-MC-LVPMSM ensure that the jumpers 
are configured according the PMSMDEMOUG users guide (from KSDK package\docs\MC\PMSMDEMOUG.pdf). 

For correct signal connection and proper demo working, it is necessary to solder/remove resistors from the board. Please, see the PMSMDEMOUG user guide and MIMXRT1050-EVKB board schematic.

The low-voltage evaluation board does not require any hardware configuration or jumper settings as well.

Prepare the Demo
===============
1.  Connect the FRDM-MC-LVPMSM with MIMXRT1050-EVKB board through cables according users guide PMSMDEMOUG. 
