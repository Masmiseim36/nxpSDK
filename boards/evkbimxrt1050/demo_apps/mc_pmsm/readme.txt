...
- MIMXRT1050-EVK board (schematic:SCH-29538 REV A5, board: 700-29538 REV A1)
...
For correct signal connection and proper demo working, it is necessary to solder/remove resistors from the board. Please, see the PMSMDEMOUG user guide and MIMXRT1050-EVK board schematic.
...
5.  Connect a USB cable between the host PC and the OpenSDA USB port on the target board MIMXRT1050-EVK. 
...
Motor spinning can be controlled also via FreeMASTER pmp file placed in: KSDK package\middleware\motor_control\freemaster\pmsm_demo.pmp. 
...
More information
================
More details about pmsm motor control application on MIMXRT1050-EVK board are described in document AN12214 or AN12169 and and 
the user guide in SDK install folder\docs\MC\PMSMDEMOUG.pdf
