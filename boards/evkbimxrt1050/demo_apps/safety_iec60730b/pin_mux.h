...
#define BOARD_INITPINS_CSI_PIXCLK_PERIPHERAL                               GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_CSI_PIXCLK_SIGNAL                                 gpio_io   /*!< Signal name */
#define BOARD_INITPINS_CSI_PIXCLK_CHANNEL                                    20U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_CSI_PIXCLK_GPIO                                     GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_CSI_PIXCLK_GPIO_PIN                                   20U   /*!< GPIO pin number */
#define BOARD_INITPINS_CSI_PIXCLK_GPIO_PIN_MASK                      (1U << 20U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_CSI_PIXCLK_PORT                                     GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_CSI_PIXCLK_PIN                                        20U   /*!< PORT pin number */
#define BOARD_INITPINS_CSI_PIXCLK_PIN_MASK                           (1U << 20U)   /*!< PORT pin mask */

/* GPIO_AD_B1_05 (coord K12), CSI_MCLK/J35[12]/J23[4] */
/* Routed pin properties */
#define BOARD_INITPINS_CSI_MCLK_PERIPHERAL                                 GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_CSI_MCLK_SIGNAL                                   gpio_io   /*!< Signal name */
#define BOARD_INITPINS_CSI_MCLK_CHANNEL                                      21U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_CSI_MCLK_GPIO                                       GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_CSI_MCLK_GPIO_PIN                                     21U   /*!< GPIO pin number */
#define BOARD_INITPINS_CSI_MCLK_GPIO_PIN_MASK                        (1U << 21U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_CSI_MCLK_PORT                                       GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_CSI_MCLK_PIN                                          21U   /*!< PORT pin number */
#define BOARD_INITPINS_CSI_MCLK_PIN_MASK                             (1U << 21U)   /*!< PORT pin mask */

/* GPIO_AD_B1_10 (coord L13), SAI1_RX_SYNC/CSI_D7/J35[9]/J23[1] */
/* Routed pin properties */
#define BOARD_INITPINS_CSI_D7_PERIPHERAL                                   GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_CSI_D7_SIGNAL                                     gpio_io   /*!< Signal name */
#define BOARD_INITPINS_CSI_D7_CHANNEL                                        26U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_CSI_D7_GPIO                                         GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_CSI_D7_GPIO_PIN                                       26U   /*!< GPIO pin number */
#define BOARD_INITPINS_CSI_D7_GPIO_PIN_MASK                          (1U << 26U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_CSI_D7_PORT                                         GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_CSI_D7_PIN                                            26U   /*!< PORT pin number */
#define BOARD_INITPINS_CSI_D7_PIN_MASK                               (1U << 26U)   /*!< PORT pin mask */
