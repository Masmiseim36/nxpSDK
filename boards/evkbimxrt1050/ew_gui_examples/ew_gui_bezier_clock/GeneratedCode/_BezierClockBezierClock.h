...
#ifndef _BezierClockBezierClock_H
#define _BezierClockBezierClock_H
...
/* Forward declaration of the class BezierClock::BezierClock */
#ifndef _BezierClockBezierClock_
  EW_DECLARE_CLASS( BezierClockBezierClock )
#define _BezierClockBezierClock_
#endif
...
EW_DEFINE_FIELDS( BezierClockBezierClock, CoreGroup )
  EW_OBJECT  ( PropertyObserver, CorePropertyObserver )
  EW_OBJECT  ( Background,      BezierClockBackground )
  EW_OBJECT  ( AutoDemoTimer,   CoreTimer )
  EW_VARIABLE( AutoState,       XInt32 )
EW_END_OF_FIELDS( BezierClockBezierClock )

/* Virtual Method Table (VMT) for the class : 'BezierClock::BezierClock' */
EW_DEFINE_METHODS( BezierClockBezierClock, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( BezierClockBezierClock )
...
#endif /* _BezierClockBezierClock_H */
