...
#ifndef _CutterMainButton_H
#define _CutterMainButton_H
...
/* Forward declaration of the class Cutter::MainButton */
#ifndef _CutterMainButton_
  EW_DECLARE_CLASS( CutterMainButton )
#define _CutterMainButton_
#endif
...
/* The class 'MainButton' implements a simple push button to start, stop or confirm 
   a certain action. */
EW_DEFINE_FIELDS( CutterMainButton, CoreGroup )
  EW_PROPERTY( OnStart,         XSlot )
  EW_PROPERTY( OnStop,          XSlot )
  EW_PROPERTY( OnOk,            XSlot )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_OBJECT  ( Text,            ViewsText )
  EW_OBJECT  ( TouchHandler,    CoreSimpleTouchHandler )
  EW_PROPERTY( Mode,            XEnum )
EW_END_OF_FIELDS( CutterMainButton )

/* Virtual Method Table (VMT) for the class : 'Cutter::MainButton' */
EW_DEFINE_METHODS( CutterMainButton, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( CutterMainButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( CutterMainButton _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
EW_END_OF_METHODS( CutterMainButton )
