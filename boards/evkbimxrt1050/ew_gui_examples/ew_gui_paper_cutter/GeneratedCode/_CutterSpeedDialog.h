...
#ifndef _CutterSpeedDialog_H
#define _CutterSpeedDialog_H
...
EW_DEFINE_FIELDS( CutterSpeedDialog, CoreGroup )
...
EW_END_OF_FIELDS( CutterSpeedDialog )

/* Virtual Method Table (VMT) for the class : 'Cutter::SpeedDialog' */
EW_DEFINE_METHODS( CutterSpeedDialog, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( CutterSpeedDialog )
