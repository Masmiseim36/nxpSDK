...
http://www.embedded-wizard.de/NXP-SDK-Examples/IMXRT1050-EVK/PulseOximeter/Simulation/ 
...
Running the demo
================
If this example runs correctly, the sample application is displayed on the LCD
screen. The log below shows the output of the sample application 'BezierClock'
