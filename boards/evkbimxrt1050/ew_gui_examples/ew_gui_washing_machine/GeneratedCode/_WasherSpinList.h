...
#ifndef _WasherSpinList_H
#define _WasherSpinList_H
...
/* Forward declaration of the class Washer::SpinList */
#ifndef _WasherSpinList_
  EW_DECLARE_CLASS( WasherSpinList )
#define _WasherSpinList_
#endif


/* This is a GUI component. */
EW_DEFINE_FIELDS( WasherSpinList, CoreGroup )
...
EW_DEFINE_METHODS( WasherSpinList, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( WasherSpinList )
