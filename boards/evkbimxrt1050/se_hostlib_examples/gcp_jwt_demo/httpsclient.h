...
extern const char https_root_ca_crt[];
extern size_t https_root_ca_crt_len;

int https_client_tls_connect(const char * server_name);
...
extern TLSDataParams tlsDataParams;
