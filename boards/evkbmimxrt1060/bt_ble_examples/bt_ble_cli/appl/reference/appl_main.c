...
================ M A I N   M E N U ================ \n\
 ...
 \n\
  210. GA Setup. \n\
  220. Enable Host low power on idle (CLI is disabled). \n\
 \n\
...
void Configure_sleep_wakeup (void)
{
	...
	/*Deep-Sleep Config for RB3P, C2H GPIO20, H2C GPIO12*/
	UCHAR vnd_cmd[6U] = {0x03U, 0x14U, 0x02U, 0x0CU, 0x00U, 0x00U};
#else
	/*Deep-Sleep Config for FC, C2H GPIO16, H2C GPIO19*/
	UCHAR vnd_cmd[6U] = {0x03U, 0x10U, 0x02U, 0xffU, 0x00U, 0x00U};
#endif
...
#endif /* EM_PLATFORM_MAIN */
{
	...
	case 100:
	 ...
	 case 110:
        ...
        case 200:
#if (defined(BT_GAM) && defined(APPL_GA_LEGACY_SUPPORT))
            main_ga_legacy_operations();
#else /* (defined(BT_GAM) && defined(APPL_GA_LEGACY_SUPPORT)) */
            printf("*** Enable 'BT_GAM' Compilation Flag and APPL_GA_LEGACY_SUPPORT\n");
#endif /* (defined(BT_GAM) && defined(APPL_GA_LEGACY_SUPPORT)) */
            break;
