 ...
 *  Created On : Fri Sep 24 19:33:21 2021
 */
 ...
 *   Total attribute value length (attr_len) = 4711 Bytes
...
UCHAR value_arr[] = {
    ...
    /* HIDDeviceReleaseNumber */
    0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06,

    /* HIDParserVersion */
    0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0A,
...
struct SDP_ATTR attr_arr[] = {
    ...
    /* ProtocolDescriptorList */
    {0x0004, 0x0020, value_arr + 0x0737},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0757},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x075C},

    /* ServiceAvailability */
    {0x0008, 0x0002, value_arr + 0x0767},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0769},

    /* ServiceName */
    {0x0100, 0x001F, value_arr + 0x0773},

    /* ServiceDescription */
    {0x0101, 0x0022, value_arr + 0x0792},

    /* SecurityDescription */
    {0x030A, 0x0003, value_arr + 0x07B4},

    /* NetAccessType */
    {0x030B, 0x0003, value_arr + 0x07B7},

    /* MaxNetAccessrate */
    {0x030C, 0x0005, value_arr + 0x07BA},

    /* IPv4Subnet */
    {0x030D, 0x000D, value_arr + 0x07BF},

    /* IPv6Subnet */
    {0x030E, 0x000C, value_arr + 0x07CC},

    /** Service Record 31 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x07D8},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x07DD},

    /* ProtocolDescriptorList */
    {0x0004, 0x0020, value_arr + 0x07E2},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0802},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0807},

    /* ServiceAvailability */
    {0x0008, 0x0002, value_arr + 0x0812},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0814},

    /* ServiceName */
    {0x0100, 0x001F, value_arr + 0x081E},

    /* ServiceDescription */
    {0x0101, 0x0028, value_arr + 0x083D},

    /* SecurityDescription */
    {0x030A, 0x0003, value_arr + 0x0865},

    /* IPv4Subnet */
    {0x030D, 0x000D, value_arr + 0x0868},

    /* IPv6Subnet */
    {0x030E, 0x000C, value_arr + 0x0875},

    /** Service Record 32 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0881},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0886},

    /* ProtocolDescriptorList */
    {0x0004, 0x0020, value_arr + 0x088B},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x08AB},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x08B0},

    /* ServiceAvailability */
    {0x0008, 0x0002, value_arr + 0x08BB},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x08BD},

    /* ServiceName */
    {0x0100, 0x001F, value_arr + 0x08C7},

    /* ServiceDescription */
    {0x0101, 0x001F, value_arr + 0x08E6},

    /* SecurityDescription */
    {0x030A, 0x0003, value_arr + 0x0905},

    /** Service Record 33 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0908},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x090D},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0912},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0925},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x092A},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0935},

    /* ServiceName */
    {0x0100, 0x000A, value_arr + 0x093F},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0949},

    /* SupportedCapabalities */
    {0x0310, 0x0002, value_arr + 0x094C},

    /* SupportedFeatures */
    {0x0311, 0x0003, value_arr + 0x094E},

    /* SupportedFunctions */
    {0x0312, 0x0005, value_arr + 0x0951},

    /* TotalImagingDataCapacity */
    {0x0313, 0x0009, value_arr + 0x0956},

    /** Service Record 34 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x095F},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0964},

    /* ServiceID */
    {0x0003, 0x0003, value_arr + 0x0969},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x096C},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x097F},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0984},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x098F},

    /* ServiceName */
    {0x0100, 0x001D, value_arr + 0x0999},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x09B6},

    /* SupportedFunctions */
    {0x0312, 0x0005, value_arr + 0x09B9},

    /** Service Record 35 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x09BE},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x09C3},

    /* ServiceID */
    {0x0003, 0x0003, value_arr + 0x09C8},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x09CB},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x09DE},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x09E3},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x09EE},

    /* ServiceName */
    {0x0100, 0x001C, value_arr + 0x09F8},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0A14},

    /* SupportedFunctions */
    {0x0312, 0x0005, value_arr + 0x0A17},

    /** Service Record 36 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0A1C},

    /* ServiceClassIDList */
    {0x0001, 0x000B, value_arr + 0x0A21},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0A2C},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0A3F},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0A44},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0A4F},

    /* AdditionalProtocolDescriptorLists */
    {0x000D, 0x0015, value_arr + 0x0A59},

    /* ServiceName */
    {0x0100, 0x0011, value_arr + 0x0A6E},

    /* DocumentFormatsSupported */
    {0x0350, 0x000D, value_arr + 0x0A7F},

    /* CharacterRepertoiresSupported */
    {0x0352, 0x0011, value_arr + 0x0A8C},

    /* XHTML-PrintImageFormatsSupported */
    {0x0354, 0x000E, value_arr + 0x0A9D},

    /* ColorSupported */
    {0x0356, 0x0002, value_arr + 0x0AAB},

    /* 1284ID */
    {0x0358, 0x000A, value_arr + 0x0AAD},

    /* PrinterName */
    {0x035A, 0x0006, value_arr + 0x0AB7},

    /* PrinterLocation */
    {0x035C, 0x0006, value_arr + 0x0ABD},

    /* DuplexSupported */
    {0x035E, 0x0002, value_arr + 0x0AC3},

    /* MediaTypesSupported */
    {0x0360, 0x000D, value_arr + 0x0AC5},

    /* MaxMediaWidth */
    {0x0362, 0x0003, value_arr + 0x0AD2},

    /* MaxMediaLength */
    {0x0364, 0x0003, value_arr + 0x0AD5},

    /* EnhancedLayoutSupported */
    {0x0366, 0x0002, value_arr + 0x0AD8},

    /* ReferencePrintingRUISupported */
    {0x0370, 0x0002, value_arr + 0x0ADA},

    /* DirectPrintingRUISupported */
    {0x0372, 0x0002, value_arr + 0x0ADC},

    /* ReferencePrintingTopURL */
    {0x0374, 0x0006, value_arr + 0x0ADE},

    /* DirectPrintingTopURL */
    {0x0376, 0x0006, value_arr + 0x0AE4},

    /** Service Record 37 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0AEA},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0AEF},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0AF4},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0B07},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0B0C},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0B17},

    /* AdditionalProtocolDescriptorLists */
    {0x000D, 0x0015, value_arr + 0x0B21},

    /* ServiceName */
    {0x0100, 0x001D, value_arr + 0x0B36},

    /** Service Record 38 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0B53},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0B58},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0B5D},
    ...
    /* ServiceName */
    {0x0100, 0x0028, value_arr + 0x0B80},

    /* RUIFormatsSupported */
    {0x0368, 0x0006, value_arr + 0x0BA8},

    /* PrinterAdminRUITopURL */
    {0x0378, 0x0006, value_arr + 0x0BAE},

    /** Service Record 39 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0BB4},

    /* ServiceClassIDList */
    {0x0001, 0x0008, value_arr + 0x0BB9},

    /* ProtocolDescriptorList */
    {0x0004, 0x0012, value_arr + 0x0BC1},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0BD3},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0BD8},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0BE3},

    /* AdditionalProtocolDescriptorLists */
    {0x000D, 0x0014, value_arr + 0x0BED},

    /* ServiceName */
    {0x0100, 0x0013, value_arr + 0x0C01},

    /* ProviderName */
    {0x0102, 0x000B, value_arr + 0x0C14},

    /* SupportedFeatures */
    {0x0311, 0x0003, value_arr + 0x0C1F},

    /** Service Record 40 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0C22},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0C27},

    /* ProtocolDescriptorList */
    {0x0004, 0x0012, value_arr + 0x0C2C},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0C3E},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0C43},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0C4E},

    /* AdditionalProtocolDescriptorLists */
    {0x000D, 0x0023, value_arr + 0x0C58},

    /* ServiceName */
    {0x0100, 0x000F, value_arr + 0x0C7B},

    /* ProviderName */
    {0x0102, 0x000B, value_arr + 0x0C8A},

    /* SupportedFeatures */
    {0x0311, 0x0003, value_arr + 0x0C95},

    /** Service Record 41 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0C98},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0C9D},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0CA2},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0CA7},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0CB2},

    /* ServiceName */
    {0x0100, 0x0018, value_arr + 0x0CBC},

    /** Service Record 42 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0CD4},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0CD9},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0CDE},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0CF1},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0CF6},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0D01},

    /* ServiceName */
    {0x0100, 0x0018, value_arr + 0x0D0B},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0D23},

    /* SupportedRepositories */
    {0x0314, 0x0002, value_arr + 0x0D26},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x0D28},

    /** Service Record 43 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0D2D},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0D32},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0D37},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0D3C},

    /* DocumentationURL */
    {0x000A, 0x0014, value_arr + 0x0D47},

    /* ClientExecutableURL */
    {0x000B, 0x0011, value_arr + 0x0D5B},

    /* ServiceDescription */
    {0x0101, 0x000B, value_arr + 0x0D6C},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0D77},

    /* HIDParserVersion */
    {0x0201, 0x0003, value_arr + 0x0D7A},

    /* HIDDeviceSubclass */
    {0x0202, 0x0003, value_arr + 0x0D7D},

    /* HIDCountryCode */
    {0x0203, 0x0003, value_arr + 0x0D80},

    /* HIDVirtualCable */
    {0x0204, 0x0002, value_arr + 0x0D83},

    /* HIDReconnectInitiate */
    {0x0205, 0x0003, value_arr + 0x0D85},

    /** Service Record 44 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0D88},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0D8D},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0D92},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0D97},

    /* DocumentationURL */
    {0x000A, 0x0016, value_arr + 0x0DA2},

    /* ClientExecutableURL */
    {0x000B, 0x0013, value_arr + 0x0DB8},

    /* ServiceDescription */
    {0x0101, 0x000D, value_arr + 0x0DCB},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0DD8},

    /* HIDParserVersion */
    {0x0201, 0x0003, value_arr + 0x0DDB},

    /* HIDDeviceSubclass */
    {0x0202, 0x0003, value_arr + 0x0DDE},

    /* HIDCountryCode */
    {0x0203, 0x0003, value_arr + 0x0DE1},

    /* HIDVirtualCable */
    {0x0204, 0x0002, value_arr + 0x0DE4},

    /* HIDReconnectInitiate */
    {0x0205, 0x0003, value_arr + 0x0DE6},

    /** Service Record 45 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0DE9},

    /* ServiceClassIDList */
    {0x0001, 0x0008, value_arr + 0x0DEE},

    /* ServiceRecordState */
    {0x0002, 0x0005, value_arr + 0x0DF6},

    /* ProtocolDescriptorList */
    {0x0004, 0x0012, value_arr + 0x0DFB},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0E0D},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0E12},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0E1D},

    /* AdditionalProtocolDescriptorLists */
    {0x000D, 0x0011, value_arr + 0x0E27},

    /* ServiceName */
    {0x0100, 0x0011, value_arr + 0x0E38},

    /* ServiceDescription */
    {0x0101, 0x0014, value_arr + 0x0E49},

    /* ProviderName */
    {0x0102, 0x000B, value_arr + 0x0E5D},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0020, value_arr + 0x0E68},

    /* Supported Data Stores List */
    {0x0301, 0x0002, value_arr + 0x0E88},

    /* MCAPSupportedProcedures */
    {0x0302, 0x0002, value_arr + 0x0E8A},

    /** Service Record 46 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0E8C},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0E91},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0E96},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0EA9},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0EAE},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0EB9},

    /* ServiceName */
    {0x0100, 0x001B, value_arr + 0x0EC3},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0EDE},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x0EE1},

    /** Service Record 47 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0EE6},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0EEB},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0EF0},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0F03},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0F08},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0F13},

    /* ServiceName */
    {0x0100, 0x0015, value_arr + 0x0F1D},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0F32},

    /* MASInstanceID */
    {0x0315, 0x0002, value_arr + 0x0F35},

    /* SupportedMessageTypes */
    {0x0316, 0x0002, value_arr + 0x0F37},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x0F39},

    /** Service Record 48 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0F3E},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0F43},

    /* ProtocolDescriptorList */
    {0x0004, 0x0013, value_arr + 0x0F48},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0F5B},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0F60},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0F6B},

    /* ServiceName */
    {0x0100, 0x0015, value_arr + 0x0F75},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0003, value_arr + 0x0F8A},

    /* MASInstanceID */
    {0x0315, 0x0002, value_arr + 0x0F8D},

    /* SupportedMessageTypes */
    {0x0316, 0x0002, value_arr + 0x0F8F},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x0F91},

    /** Service Record 49 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0F96},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0F9B},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0FA0},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0FA5},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0FB0},

    /* HIDDeviceReleaseNumber */
    {0x0200, 0x0009, value_arr + 0x0FBA},

    /* HIDParserVersion */
    {0x0201, 0x0009, value_arr + 0x0FC3},

    /* HIDDeviceSubclass */
    {0x0202, 0x0003, value_arr + 0x0FCC},

    /** Service Record 50 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0FCF},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0FD4},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x0FD9},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0FEE},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0FF3},

    /** Service Record 51 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0FFE},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x1003},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x1008},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x101D},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x1022},

    /** Service Record 52 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x102D},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x1032},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x1037},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x104C},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x1051},

    /** Service Record 53 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x105C},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x1061},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x1066},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x107B},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x1080},

    /** Service Record 54 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x108B},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x1090},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x1095},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x10AA},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x10AF},

    /** Service Record 55 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x10BA},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x10BF},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x10C4},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x10D9},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x10DE},

    /** Service Record 56 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x10E9},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x10EE},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x10F3},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x1108},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x110D},

    /** Service Record 57 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x1118},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x111D},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x1122},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x1137},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x113C},

    /** Service Record 58 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x1147},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x114C},

    /* ProtocolDescriptorList */
    {0x0004, 0x0015, value_arr + 0x1151},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x1166},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x116B},

    /** Service Record 59 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x1176},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x117B},

    /* ProtocolDescriptorList */
    {0x0004, 0x000F, value_arr + 0x1180},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x118F},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x1194},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x119F},

    /* ServiceName */
    {0x0100, 0x001B, value_arr + 0x11A9},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x11C4},

    /** Service Record 60 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x11C9},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x11CE},

    /* ProtocolDescriptorList */
    {0x0004, 0x000F, value_arr + 0x11D3},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x11E2},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x11E7},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x11F2},

    /* ServiceName */
    {0x0100, 0x0015, value_arr + 0x11FC},

    /* MASInstanceID */
    {0x0315, 0x0002, value_arr + 0x1211},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x1213},

    /** Service Record 61 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x1218},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x121D},

    /* ProtocolDescriptorList */
    {0x0004, 0x000F, value_arr + 0x1222},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x1231},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x1236},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x1241},

    /* ServiceName */
    {0x0100, 0x0015, value_arr + 0x124B},

    /* MASInstanceID */
    {0x0315, 0x0002, value_arr + 0x1260},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x1262}
};
...
void BT_dbase_init(void)
{
    ...
    dbase[45].num_attrs = 14;
    dbase[45].attr_offset = 403;
