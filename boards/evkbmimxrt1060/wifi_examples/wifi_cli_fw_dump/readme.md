Overview
========
This is the Wi-Fi CLI Firmware dump example to demonstrates the abiliy to capture a FW memory dump on a micro-USB memory device connected to the host platform.
