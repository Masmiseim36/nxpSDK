...
Board settings
==============
Please make sure R136 is welded for GPIO card detect. Note that the signal SD1_CD_B is muxed with ENET_MDC.
When R136 is welded, the signal ENET_MDC to access the PHY of the 100M port may be effected.
