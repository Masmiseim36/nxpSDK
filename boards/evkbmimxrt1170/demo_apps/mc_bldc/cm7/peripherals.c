...
- config_sets:
  - fsl_gpio:
    ...
    - gpio_interrupt_comb_0_15:
      - IRQn: 'GPIO13_Combined_0_31_IRQn'
...
static void GPIO13_init(void) {
  /* Make sure, the clock gate for GPIO13 is enabled (e. g. in pin_mux.c) */
  /* Interrupt vector GPIO13_Combined_0_31_IRQn priority settings in the NVIC. */
  NVIC_SetPriority(GPIO13_GPIO_COMB_0_15_IRQN, GPIO13_GPIO_COMB_0_15_IRQ_PRIORITY);
  /* Enable interrupt GPIO13_GPIO_COMB_0_15_IRQN request in the NVIC */
  EnableIRQ(GPIO13_GPIO_COMB_0_15_IRQN);
}
