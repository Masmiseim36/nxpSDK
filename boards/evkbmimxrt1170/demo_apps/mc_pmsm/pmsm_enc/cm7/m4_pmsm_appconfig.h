...
/*
    * FILE NAME: ../boards/evkbmimxrt1170/mc_pmsm/pmsm_enc/m4_pmsm_appconfig.h
    * DATE: Mon Apr 15 2024, 13:40:14
*/
...
/*
{
    "parameters": {
        "parametersPP": 3,
        "parametersRs": 0.37,
        "parametersLd": 0.0002143,
        "parametersLq": 0.0002749,
        "parametersKe": 0.0598,
        "parametersJ": 0.000023,
        "parametersIphNom": 2,
        "parametersUphNom": 15,
        "parametersNnom": 4000,
        "parametersImax": 8.25,
...
/*
{
    "motorName": "TG-drive TGT2-0032-30-24",
    "motorDescription": ""
}
*/
...
#define M1_N_OVERSPEED (1381.99F)
...
#define M1_SCALAR_INTEG_GAIN ACC32(0.0275000)
#define M1_SCALAR_RAMP_UP (0.0156250F)
#define M1_SCALAR_RAMP_DOWN (0.0156250F)
/* CURRENTLOOP*/
#define M1_D_KP_GAIN (0.405576F)
#define M1_D_KI_GAIN (0.0438578F)
#define M1_Q_KP_GAIN (0.624895F)
#define M1_Q_KI_GAIN (0.0562600F)
#define M1_CLOOP_LIMIT (0.519615F)
/* SPEEDLOOP*/
#define M1_SPEED_RAMP_UP (1.57080F)
#define M1_SPEED_RAMP_DOWN (1.57080F)
#define M1_SPEED_LOOP_HIGH_LIMIT (2.0F)
#define M1_SPEED_LOOP_LOW_LIMIT (-2.0F)
#define M1_SPEED_PI_PROP_GAIN (0.00818206F)
#define M1_SPEED_PI_INTEG_GAIN (0.0000719731F)
...
/* SENSORLESS*/
#define M1_OL_START_RAMP_INC (0.0589049F)
#define M1_OL_START_I (0.65F)
#define M1_MERG_SPEED_TRH (157.080F)
#define M1_MERG_COEFF FRAC16(0.00156250)
#define M1_I_SCALE (0.902601F)
#define M1_U_SCALE (0.263241F)
#define M1_E_SCALE (0.263241F)
#define M1_WI_SCALE (0.0000723650F)
#define M1_BEMF_DQ_KP_GAIN (0.437892F)
#define M1_BEMF_DQ_KI_GAIN (0.0475888F)
