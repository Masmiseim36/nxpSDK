...
void config_audio_parameters(int sample_rate, int channels, int bits)
{
	...
	lc3_codec_info.chan_allocation = BT_AUDIO_LOCATION_FRONT_LEFT | BT_AUDIO_LOCATION_FRONT_RIGHT | BT_AUDIO_LOCATION_BACK_LEFT | BT_AUDIO_LOCATION_BACK_RIGHT;
	...
	bt_audio_codec_cfg_set_chan_allocation(&bis_codec_specific_config[2][0], BT_AUDIO_LOCATION_BACK_LEFT);
	bt_audio_codec_cfg_set_chan_allocation(&bis_codec_specific_config[3][0], BT_AUDIO_LOCATION_BACK_RIGHT);
}
