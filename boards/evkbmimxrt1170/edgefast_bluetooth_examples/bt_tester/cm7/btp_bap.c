...
#if (defined(CONFIG_BT_BAP_UNICAST) && (CONFIG_BT_BAP_UNICAST > 0U)) || \
...
#else
static const struct bt_audio_codec_cap default_codec_cap = {
    .path_id = BT_ISO_DATA_PATH_HCI,
    .id = BT_HCI_CODING_FORMAT_LC3,
    .cid = 0x0000,
    .vid = 0x0000,
    .data_len = sizeof((uint8_t [])BT_AUDIO_CODEC_CAP_LC3_DATA(BT_AUDIO_CODEC_CAP_FREQ_ANY, BT_AUDIO_CODEC_CAP_DURATION_7_5 |
	BT_AUDIO_CODEC_CAP_DURATION_10, BT_AUDIO_CODEC_CAP_CHAN_COUNT_SUPPORT(1, 2), 26u, 155u, 1u)),
    .data = BT_AUDIO_CODEC_CAP_LC3_DATA(BT_AUDIO_CODEC_CAP_FREQ_ANY, BT_AUDIO_CODEC_CAP_DURATION_7_5 |
	BT_AUDIO_CODEC_CAP_DURATION_10, BT_AUDIO_CODEC_CAP_CHAN_COUNT_SUPPORT(1, 2), 26u, 155u, 1u),
    .meta_len = sizeof((uint8_t[])BT_AUDIO_CODEC_CAP_LC3_META(BT_AUDIO_CONTEXT_TYPE_ANY)),
    .meta = BT_AUDIO_CODEC_CAP_LC3_META(BT_AUDIO_CONTEXT_TYPE_ANY),
...
static const struct bt_audio_codec_cap vendor_codec_cap = {
    ...
    .cid = 0xffff,
    .vid = 0xffff,
    .data_len = sizeof((uint8_t [])BT_AUDIO_CODEC_CAP_LC3_DATA(BT_AUDIO_CODEC_CAP_FREQ_ANY,
	BT_AUDIO_CODEC_CAP_DURATION_7_5 | BT_AUDIO_CODEC_CAP_DURATION_10,
	BT_AUDIO_CODEC_CAP_CHAN_COUNT_SUPPORT(1, 2), 26u, 155, 1u)),
    .data = BT_AUDIO_CODEC_CAP_LC3_DATA(BT_AUDIO_CODEC_CAP_FREQ_ANY,
	BT_AUDIO_CODEC_CAP_DURATION_7_5 | BT_AUDIO_CODEC_CAP_DURATION_10,
	BT_AUDIO_CODEC_CAP_CHAN_COUNT_SUPPORT(1, 2), 26u, 155, 1u),
    .meta_len = sizeof((uint8_t[])BT_AUDIO_CODEC_CAP_LC3_META(BT_AUDIO_CONTEXT_TYPE_ANY)),
    .meta = BT_AUDIO_CODEC_CAP_LC3_META(BT_AUDIO_CONTEXT_TYPE_ANY),
...
static int set_location(void)
{
	...
	err = bt_pacs_set_location(BT_AUDIO_DIR_SINK,
				   (enum bt_audio_location)(BT_AUDIO_LOCATION_FRONT_CENTER |
...
static int set_supported_contexts(void)
{
	...
	err = bt_pacs_set_supported_contexts(BT_AUDIO_DIR_SOURCE,
					     (enum bt_audio_context)(SUPPORTED_SOURCE_CONTEXT));
	if (err != 0) {
		return err;
	}

	err = bt_pacs_set_supported_contexts(BT_AUDIO_DIR_SINK,
					     (enum bt_audio_context)(SUPPORTED_SINK_CONTEXT));
	if (err != 0) {
		return err;
	}
...
static const struct btp_handler bap_handlers[] = {
	...
	{
		.opcode = BTP_BAP_LOCAL_ADD_BROADCAST_SRC,
		.expect_len = BTP_HANDLER_LENGTH_VARIABLE,
		.func = btp_bap_local_add_broadcast_src,
	},
...
#endif /* CONFIG_CONFIG_BT_BAP_UNICAST | CONFIG_BT_BAP_BROADCAST_SOURCE | CONFIG_BT_BAP_BROADCAST_SINK */
