...
SHELL_COMMAND_DEFINE(lc3_preset_list,   "lc3_preset_list\r\r\n",   lc3_preset_list, 0);
SHELL_COMMAND_DEFINE(lc3_preset,        "lc3_preset <name>\r\r\n", lc3_preset,      1);
SHELL_COMMAND_DEFINE(scan,              "scan\r\r\n",              scan,            0);
SHELL_COMMAND_DEFINE(connect,           "connect [index]\r\r\n",   connect,         1);
SHELL_COMMAND_DEFINE(vol_set,           "vol_set [0-255]\r\r\n",   vol_set,         1);
SHELL_COMMAND_DEFINE(vol_up,            "vol_up\r\r\n",            vol_up,          0);
SHELL_COMMAND_DEFINE(vol_down,          "vol_down\r\r\n",          vol_down,        0);
SHELL_COMMAND_DEFINE(vol_mute,          "vol_mute\r\r\n",          vol_mute,        0);
SHELL_COMMAND_DEFINE(vol_unmute,        "vol_unmute\r\r\n",        vol_unmute,      0);
SHELL_COMMAND_DEFINE(play,              "play\r\r\n",              play,            0);
SHELL_COMMAND_DEFINE(pause,             "pause\r\r\n",             pause,           0);
SHELL_COMMAND_DEFINE(sync_info,         "sync_info\r\r\n",         sync_info,       0);
SHELL_COMMAND_DEFINE(config_rtn,        "config_rtn <rtn>\r\r\n",  config_rtn,      1);
SHELL_COMMAND_DEFINE(config_pd,         "config_pd <pd>\r\r\n",    config_pd,       1);
SHELL_COMMAND_DEFINE(config_phy,        "config_phy [1,2,4] - 1: 1M, 2: 2M, 4: Coded\r\r\n", config_phy, 1);
SHELL_COMMAND_DEFINE(config_packing,    "config_packing [0,1] - 0: sequentially, 1: interleaved\r\r\n", config_packing, 1);
SHELL_COMMAND_DEFINE(config_conn_param, "config_conn_param [interval_min] [interval_max] [latency] [timeout] - interval: N * 1.25ms, timeout: N * 10ms\r\r\n", config_conn_param, 4);
