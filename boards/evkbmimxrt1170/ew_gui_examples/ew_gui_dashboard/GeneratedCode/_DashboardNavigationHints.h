...
#ifndef _DashboardNavigationHints_H
#define _DashboardNavigationHints_H
...
/* Deklaration of class : 'Dashboard::NavigationHints' */
EW_DEFINE_FIELDS( DashboardNavigationHints, CoreGroup )
  EW_OBJECT  ( DistanceDisplay, WidgetSetValueDisplay )
  EW_OBJECT  ( DescText,        ViewsText )
  EW_OBJECT  ( DirectionImage,  ViewsImage )
  EW_PROPERTY( Distance,        XInt32 )
  EW_PROPERTY( Direction,       XInt32 )
EW_END_OF_FIELDS( DashboardNavigationHints )

/* Virtual Method Table (VMT) for the class : 'Dashboard::NavigationHints' */
EW_DEFINE_METHODS( DashboardNavigationHints, CoreGroup )
...
EW_END_OF_METHODS( DashboardNavigationHints )
...
#endif /* _DashboardNavigationHints_H */
