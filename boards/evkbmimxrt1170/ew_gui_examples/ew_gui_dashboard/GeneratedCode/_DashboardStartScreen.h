...
#ifndef _DashboardStartScreen_H
#define _DashboardStartScreen_H
...
/* Forward declaration of the class Dashboard::StartScreen */
#ifndef _DashboardStartScreen_
  EW_DECLARE_CLASS( DashboardStartScreen )
#define _DashboardStartScreen_
#endif
...
/* Deklaration of class : 'Dashboard::StartScreen' */
EW_DEFINE_FIELDS( DashboardStartScreen, CoreGroup )
  EW_OBJECT  ( glowEffect,      EffectsInt32Effect )
  EW_OBJECT  ( StartEngineGloom, ViewsImage )
  EW_OBJECT  ( StartEngineButton, WidgetSetPushButton )
  EW_OBJECT  ( Image,           ViewsImage )
EW_END_OF_FIELDS( DashboardStartScreen )

/* Virtual Method Table (VMT) for the class : 'Dashboard::StartScreen' */
EW_DEFINE_METHODS( DashboardStartScreen, CoreGroup )
...
EW_END_OF_METHODS( DashboardStartScreen )
