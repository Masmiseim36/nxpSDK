...
#ifndef _OximeterNumberDisplay_H
#define _OximeterNumberDisplay_H
...
/* Forward declaration of the class Oximeter::NumberDisplay */
#ifndef _OximeterNumberDisplay_
  EW_DECLARE_CLASS( OximeterNumberDisplay )
#define _OximeterNumberDisplay_
#endif


/* Deklaration of class : 'Oximeter::NumberDisplay' */
EW_DEFINE_FIELDS( OximeterNumberDisplay, CoreGroup )
...
EW_END_OF_FIELDS( OximeterNumberDisplay )

/* Virtual Method Table (VMT) for the class : 'Oximeter::NumberDisplay' */
EW_DEFINE_METHODS( OximeterNumberDisplay, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( OximeterNumberDisplay _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
EW_END_OF_METHODS( OximeterNumberDisplay )
...
#endif /* _OximeterNumberDisplay_H */
