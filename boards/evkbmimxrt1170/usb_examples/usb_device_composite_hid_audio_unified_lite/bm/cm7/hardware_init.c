...
extern void WM8962_USB_Audio_Init(void *I2CBase, void *i2cHandle);
extern void WM8962_Config_Audio_Formats(uint32_t samplingRate);
...
void BOARD_Codec_Init()
{
    ...
    if (CODEC_SetVolume(&codecHandle, kCODEC_PlayChannelHeadphoneLeft | kCODEC_PlayChannelHeadphoneRight, 50) !=
        kStatus_Success)
    {
        assert(false);
    }
