...
{
    PRINTF("[STREAMER] start usb speaker\r\n");
...
{
    PRINTF("[STREAMER] stop usb speaker\r\n");

    USB_DeviceStop(g_UsbDeviceAudioSpeaker.deviceHandle);
...
status_t STREAMER_speaker_Create(streamer_handle_t *handle)
{
