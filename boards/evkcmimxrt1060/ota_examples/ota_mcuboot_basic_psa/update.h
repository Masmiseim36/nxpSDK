 ...
 */
typedef struct { 
    /// @brief Current physical address of update partition.
    uint32_t update_phy_start;
    /// @brief Size of update partition.
    uint32_t update_phy_size;
} psa_fwu_impl_info_t;
 ...
 */
#define PSA_FWU_LOG2_WRITE_ALIGN        2
