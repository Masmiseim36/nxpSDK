...
void LPI2C3_InitPins(void) {                               /*!< Function assigned for the core: Cortex-M4[cm4] */
    IOMUXC_SetPinMux(LPI2C3_INITPINS_I2C3_SCL_PIN_FUNCTION_ID, 0U);
    IOMUXC_SetPinConfig(LPI2C3_INITPINS_I2C3_SCL_PIN_FUNCTION_ID,
                        IOMUXC0_SW_MUX_CTL_PAD_ODE_MASK);
    IOMUXC_SetPinMux(LPI2C3_INITPINS_I2C3_SDA_PIN_FUNCTION_ID, 0U);
    IOMUXC_SetPinConfig(LPI2C3_INITPINS_I2C3_SDA_PIN_FUNCTION_ID,
                        IOMUXC0_SW_MUX_CTL_PAD_ODE_MASK);
}
...
- options: {callFromInitBoot: 'false', coreID: cm4}
- pin_list:
  - {pin_num: AC8, peripheral: PTB, signal: 'port, 12', pin_signal: PTB12, identifier: ''}
  - {pin_num: AD8, peripheral: PTB, signal: 'port, 13', pin_signal: PTB13, identifier: ''}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
