...
void LPUART0_InitPins(void) {                              /*!< Function assigned for the core: Cortex-M4[cm4] */
    IOMUXC_SetPinMux(LPUART0_INITPINS_UART0_TX_PIN_FUNCTION_ID, 0U);
    IOMUXC_SetPinConfig(LPUART0_INITPINS_UART0_TX_PIN_FUNCTION_ID,
                        IOMUXC0_SW_MUX_CTL_PAD_PE_MASK |
                        IOMUXC0_SW_MUX_CTL_PAD_PS_MASK);
    IOMUXC_SetPinMux(LPUART0_INITPINS_UART0_RX_PIN_FUNCTION_ID, 0U);
    IOMUXC_SetPinConfig(LPUART0_INITPINS_UART0_RX_PIN_FUNCTION_ID,
                        IOMUXC0_SW_MUX_CTL_PAD_PE_MASK |
                        IOMUXC0_SW_MUX_CTL_PAD_PS_MASK);
}
 ...
 * Description   : Deint pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
