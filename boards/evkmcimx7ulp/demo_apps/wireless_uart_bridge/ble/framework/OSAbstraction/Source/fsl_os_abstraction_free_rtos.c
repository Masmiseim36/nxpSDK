...
/*FUNCTION**********************************************************************
 *
 * Function Name : OSA_TimerCreate
 * Description   : This function is used to create a timer.
 * Return        : the handle to the timer if create successfully, otherwise
 * return NULL.
 *
 *END**************************************************************************/
...
/*FUNCTION**********************************************************************
 *
 * Function Name : OSA_TimerStop
 * Description   : This function stops the timer.
 * Return        : osaStatus_Success if the timer stops successfully, otherwise return osaStatus_Error.
 *
 *END**************************************************************************/
...
/*FUNCTION**********************************************************************
 *
 * Function Name : OSA_TimerDestroy
 * Description   : This function is used to destroy the timer.
 * Return        : osaStatus_Success if the timer is destroyed successfully, otherwise return osaStatus_Error.
 *
 *END**************************************************************************/
...
/*FUNCTION**********************************************************************
 *
 * Function Name : OSA_Malloc
 * Description   : This function is used to allocate a buffer from heap
