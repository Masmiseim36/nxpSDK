...
#define gSerialTaskStackSize_c (512) /* bytes */
#endif
...
#define gSerialMgrRxBufSize_c (1024)
#endif
...
#if (gSerialManagerMaxInterfaces_c) && (!gSerialMgrUseUart_c) && (!gSerialMgrUseUSB_c) && \
    (!gSerialMgrUseUSB_VNIC_c) && (!gSerialMgrUseIIC_c) && (!gSerialMgrUseSPI_c) && (!gSerialMgrUseCustomInterface_c)
