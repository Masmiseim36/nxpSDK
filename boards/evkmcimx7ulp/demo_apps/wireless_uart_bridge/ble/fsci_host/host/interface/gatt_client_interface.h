...
#define GattClient_SimpleCharacteristicWrite(deviceId, pChar, valueLength, aValue) \
    GattClient_WriteCharacteristicValue(deviceId, pChar, valueLength, aValue, FALSE, FALSE, FALSE, NULL)
...
#define GattClient_CharacteristicWriteWithoutResponse(deviceId, pChar, valueLength, aValue) \
    GattClient_WriteCharacteristicValue(deviceId, pChar, valueLength, aValue, TRUE, FALSE, FALSE, NULL)
...
#define GattClient_CharacteristicSignedWrite(deviceId, pChar, valueLength, aValue, aCsrk) \
    GattClient_WriteCharacteristicValue(deviceId, pChar, valueLength, aValue, TRUE, TRUE, FALSE, aCsrk)
...
typedef void (*gattClientProcedureCallback_t)(
    ...
    bleResult_t error /*!< If procedureResult is not gGattProcSuccess_c, this contains the error that terminated the
                         procedure. */
);
