...
#if (gBLE41_d == TRUE)
        hciLeRemoteConnectionParameterRequestReplyCommandComplete_t
            hciLeRemoteConnectionParameterRequestReplyCommComplete;
        hciLeRemoteConnectionParameterRequestNegativeReplyCommandComplete_t
            hciLeRemoteConnectionParameterRequestNegativeReplyCommComplete;
#endif /* gBLE41_d */
#if (gBLE42_d == TRUE)
...
typedef struct hciCommand_tag
{
    ...
    union
    {
        ...
        /* hciReadBufferSizeCommand_t                      hciReadBufferSizeCmd; */ // Only needed for BR/EDR and LE
                                                                                    // Controllers?
        ...
        hciLeRemoteConnectionParameterRequestNegativeReplyCommand_t
            hciLeRemoteConnectionParameterRequestNegativeReplyCmd;
#endif /* gBLE41_d */
    } commData;
} hciCommand_t;
...
typedef enum
{
    gBlePBFlagStartNonAutomaticallyFlushableHigherLayerPktMsg_c =
        0x00,                                                        /* LE || H2C : Allowed      || C2H : Not Allowed */
...
/* Generic Interface */
bleResult_t Hci_Init(hciInterfaceStruct_t *pConfigStruct);

bleResult_t Hci_RegisterLeEventCallback(hciLeEventCallback_t pLeCallback);

bleResult_t Hci_RegisterCommandCompleteEventCallback(hciCommandCompleteCallback_t pCcCallback);

bleResult_t Hci_RegisterCommandStatusEventCallback(hciCommandStatusCallback_t pCsCallback);

bleResult_t Hci_RegisterGenericEventCallback(hciEventCallback_t pCallback);

bleResult_t Hci_RegisterL2caCallback(hciEventCallback_t pCallback, hciAclDataCallback_t pAclCallback);

bleResult_t Hci_RegisterSmCallback(hciEventCallback_t pSmCallback);
...
#if (gMwsIsSupported_d == TRUE)
bleResult_t Hci_SetMwsChannelParameters(hciMwsChannelParametersCommand_t *pParam);                        /* 3.80 */
bleResult_t Hci_SetExternalFrameConfiguration(hciSetExternalFrameConfigurationCommand_t *pParam);         /* 3.81 */
bleResult_t Hci_SetMwsSignaling(hciSetMwsSignalingCommand_t *pParam);                                     /* 3.82 */
bleResult_t Hci_SetMwsTransportLayer(hciSetMwsTransportLayerCommand_t *pParam);                           /* 3.83 */
bleResult_t Hci_GetMwsTransportLayerConfiguration(hciGetMwsTransportLayerConfigurationCommand_t *pParam); /* 5.11 */
bleResult_t Hci_SetMwsScanFrequencyTable(hciSetMwsScanFrequencyTableCommand_t *pParam);                   /* 3.84 */
bleResult_t Hci_SetMwsPatternConfiguration(hciSetMwsPatternConfigurationCommand_t *pParam);               /* 3.85 */
#endif
...
bleResult_t Hci_LeSetAdvertisingData(hciLeSetAdvertisingDataCommand_t *pParam);             /* 8.7 */
bleResult_t Hci_LeSetAdvertisingParameters(hciLeSetAdvertisingParametersCommand_t *pParam); /* 8.5 */
bleResult_t Hci_LeSetRandomAddress(hciLeSetRandomAddressCommand_t *pParam);                 /* 8.4 */
bleResult_t Hci_LeSetScanResponseData(hciLeSetScanResponseDataCommand_t *pParam);           /* 8.8 */
...
bleResult_t Hci_ReadRemoteVersionInformation(hciReadRemoteVersionInformationCommand_t *pParam); /* 1.23 */
bleResult_t Hci_LeReadRemoteUsedFeatures(hciLeReadRemoteUsedFeaturesCommand_t *pParam);         /* 8.21 */
...
bleResult_t Hci_HostBufferSize(hciHostBufferSizeCommand_t *pParam);                                 /* 3.39 */
bleResult_t Hci_SetControllerToHostFlowControl(hciSetControllerToHostFlowControlCommand_t *pParam); /* 3.38 */
...
/* Data Transfer Group */
bleResult_t Hci_SendAclData(uint16_t connectionHandle, void *pPacket, uint16_t packetSize);
bleResult_t Hci_SendAclDataWithSegmentation(uint16_t connectionHandle, void *pPacket, uint16_t packetLength);

/* Authentication and Encryption Group */
bleResult_t Hci_LeEncrypt(hciLeEncryptCommand_t *pParam);                                                 /* 8.22 */
bleResult_t Hci_LeLongTermKeyRequestReply(hciLeLongTermKeyRequestReplyCommand_t *pParam);                 /* 8.25 */
bleResult_t Hci_LeLongTermKeyRequestNegativeReply(hciLeLongTermKeyRequestNegativeReplyCommand_t *pParam); /* 8.26 */
...
bleResult_t Hci_LeSetDataLength(hciLeSetDataLengthCommand_t *pParam);                                     /* 8.33 */
bleResult_t Hci_LeReadSuggestedDefaultDataLength(void);                                                   /* 8.34 */
bleResult_t Hci_LeWriteSuggestedDefaultDataLength(hciLeWriteSuggestedDefaultDataLengthCommand_t *pParam); /* 8.35 */
bleResult_t Hci_LeReadLocalP256PublicKey(void);                                                           /* 8.36 */
bleResult_t Hci_LeGenerateDhKey(hciLeGenerateDhKeyCommand_t *pParam);                                     /* 8.37 */
bleResult_t Hci_LeAddDeviceToResolvingList(hciLeAddDeviceToResolvingListCommand_t *pParam);               /* 8.38 */
bleResult_t Hci_LeRemoveDeviceFromResolvingList(hciLeRemoveDeviceFromResolvingListCommand_t *pParam);     /* 8.39 */
bleResult_t Hci_LeClearResolvingList(void);                                                               /* 8.40 */
bleResult_t Hci_LeReadResolvingListSize(void);                                                            /* 8.41 */
bleResult_t Hci_LeReadPeerResolvableAddress(hciLeReadPeerResolvableAddressCommand_t *pParam);             /* 8.42 */
