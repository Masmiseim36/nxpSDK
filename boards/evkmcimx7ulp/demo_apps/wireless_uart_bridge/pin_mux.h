...
#define BOARD_INITPINS_UART2_RX_PERIPHERAL                               LPUART2   /*!< Device name: LPUART2 */
#define BOARD_INITPINS_UART2_RX_SIGNAL                                 lpuart_rx   /*!< LPUART2 signal: lpuart_rx */
#define BOARD_INITPINS_UART2_RX_PIN_NAME                                   PTA11   /*!< Pin name */
#define BOARD_INITPINS_UART2_RX_PIN_FUNCTION_ID          IOMUXC_PTA11_LPUART2_RX   /*!< Pin function id */
...
#define BOARD_INITPINS_UART2_TX_PERIPHERAL                               LPUART2   /*!< Device name: LPUART2 */
#define BOARD_INITPINS_UART2_TX_SIGNAL                                 lpuart_tx   /*!< LPUART2 signal: lpuart_tx */
#define BOARD_INITPINS_UART2_TX_PIN_NAME                                   PTA10   /*!< Pin name */
#define BOARD_INITPINS_UART2_TX_PIN_FUNCTION_ID          IOMUXC_PTA10_LPUART2_TX   /*!< Pin function id */
