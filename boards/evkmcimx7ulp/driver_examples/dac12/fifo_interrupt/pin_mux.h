...
#define BOARD_DAC0_OUT_PERIPHERAL                                           DAC0   /*!< Device name: DAC0 */
#define BOARD_DAC0_OUT_SIGNAL                                            dac_out   /*!< DAC0 signal: dac_out */
#define BOARD_DAC0_OUT_PIN_NAME                                         DAC0_OUT   /*!< Pin name */
#define BOARD_DAC0_OUT_PIN_FUNCTION_ID                  IOMUXC_DAC0_OUT_DAC0_OUT   /*!< Pin function id */
#define BOARD_DAC0_OUT_LABEL                                          "DAC0_OUT"   /*!< Label */
#define BOARD_DAC0_OUT_NAME                                           "DAC0_OUT"   /*!< Identifier name */
