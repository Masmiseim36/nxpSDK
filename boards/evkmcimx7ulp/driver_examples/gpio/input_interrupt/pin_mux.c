...
- pin_list:
  ...
  - {pin_num: AB16, peripheral: PTA, signal: 'port, 8', pin_signal: PTA8, identifier: UART2_CTS, direction: OUTPUT, OBE: OBE_1_Enabled}
  - {pin_num: AF14, peripheral: PTA, signal: 'port, 3', pin_signal: PTA3, direction: INPUT, IBE: IBE_1_Enabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: Cortex-M4[cm4] */
    ...
    IOMUXC_SetPinMux(BOARD_INITPINS_UART2_CTS_PIN_FUNCTION_ID, 0U);
    IOMUXC_SetPinConfig(BOARD_INITPINS_UART2_CTS_PIN_FUNCTION_ID,
