...
#define BOARD_INITPINS_UART2_CTS_PERIPHERAL                                  PTA   /*!< Device name: PTA */
#define BOARD_INITPINS_UART2_CTS_SIGNAL                                     port   /*!< PTA signal: port */
#define BOARD_INITPINS_UART2_CTS_CHANNEL                                       8   /*!< PTA port channel: 8 */
#define BOARD_INITPINS_UART2_CTS_PIN_NAME                                   PTA8   /*!< Pin name */
#define BOARD_INITPINS_UART2_CTS_PIN_FUNCTION_ID                IOMUXC_PTA8_PTA8   /*!< Pin function id */
#define BOARD_INITPINS_UART2_CTS_LABEL                               "UART2_CTS"   /*!< Label */
#define BOARD_INITPINS_UART2_CTS_NAME                                "UART2_CTS"   /*!< Identifier name */
#define BOARD_INITPINS_UART2_CTS_DIRECTION                   kGPIO_DigitalOutput   /*!< Direction */
...
#define BOARD_INITPINS_VOL_UP_DIRECTION                       kGPIO_DigitalInput   /*!< Direction */
