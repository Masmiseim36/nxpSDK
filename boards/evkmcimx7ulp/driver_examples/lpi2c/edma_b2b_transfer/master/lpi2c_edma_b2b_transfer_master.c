...
#define LPI2CMASTER_TRANSMIT_EDMA_REQUEST_SOURCE kDmaRequestMux0LPI2C3Tx
#define LPI2CMASTER_RECEIVE_EDMA_REQUEST_SOURCE kDmaRequestMux0LPI2C3Rx
#define EXAMPLE_LPI2C_MASTER_DMA_MUX (DMA_CH_MUX0)
