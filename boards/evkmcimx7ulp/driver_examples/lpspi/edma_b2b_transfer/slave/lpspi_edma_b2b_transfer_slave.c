...
#define EXAMPLE_LPSPI_SLAVE_DMA_MUX_BASE DMA_CH_MUX0
#define EXAMPLE_LPSPI_SLAVE_DMA_RX_REQUEST_SOURCE kDmaRequestMux0LPSPI1Rx
#define EXAMPLE_LPSPI_SLAVE_DMA_TX_REQUEST_SOURCE kDmaRequestMux0LPSPI1Tx
