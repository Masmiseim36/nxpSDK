...
#define BOARD_BATT_ADC_EN_PERIPHERAL                                         PTA   /*!< Device name: PTA */
#define BOARD_BATT_ADC_EN_SIGNAL                                            port   /*!< PTA signal: port */
#define BOARD_BATT_ADC_EN_CHANNEL                                             12   /*!< PTA port channel: 12 */
#define BOARD_BATT_ADC_EN_PIN_NAME                                         PTA12   /*!< Pin name */
...
#define BOARD_BATT_ADC_EN_NAME                                     "BATT_ADC_EN"   /*!< Identifier name */
