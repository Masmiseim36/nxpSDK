...
#define BOARD_PTB0_PERIPHERAL                                               TPM2   /*!< Device name: TPM2 */
#define BOARD_PTB0_SIGNAL                                                 tpm_ch   /*!< TPM2 signal: tpm_ch */
#define BOARD_PTB0_CHANNEL                                                     1   /*!< TPM2 tpm_ch channel: 1 */
#define BOARD_PTB0_PIN_NAME                                                 PTB0   /*!< Pin name */
#define BOARD_PTB0_PIN_FUNCTION_ID                          IOMUXC_PTB0_TPM2_CH1   /*!< Pin function id */
#define BOARD_PTB0_LABEL                                                  "PTB0"   /*!< Label */
#define BOARD_PTB0_NAME                                                   "PTB0"   /*!< Identifier name */
