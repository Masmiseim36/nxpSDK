 ...
 * Definitions
 ******************************************************************************/
/* low byte test cannot work on i.MX7ULP because ROM code will touch WDOG32 CS with TOVAL
 * default value 0x400, which means the WDOG will be reset immediately in ROM if we set
 * WDOG0_CS TST to 2.
 */
...
#define EXAMPLE_MSMC_BASE MSMC0
