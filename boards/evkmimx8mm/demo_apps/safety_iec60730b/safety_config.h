...
#include "project_setup_evkmimx8mm.h"
...
#define SYSTICK_FREQ          400000000U /* 400MHz */
#define SYSTICK_RELOAD_VALUE  400000U    /* 400MHz/400kHz = 1ms period */ 
...
#define WATCHDOG_REFRESH_RATIO 450      /* refresh wdog every 100th ISR */
