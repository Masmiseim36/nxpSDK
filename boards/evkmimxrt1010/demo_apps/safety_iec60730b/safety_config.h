...
#define WD_RUN_TEST_CONDITION   (SRC_SRSR_IPP_RESET_B_MASK | SRC_SRSR_LOCKUP_MASK | SRC_SRSR_IPP_USER_RESET_B_MASK | SRC_SRSR_JTAG_SW_RST_MASK)
#define WD_CHECK_TEST_CONDITION SRC_SRSR_WDOG3_RST_B_MASK
/********* Watchdog END *********/

#define PC_TEST_PATTERN 0x20007BEE /* Test address for Program counter test */
...
{\
  {(uint32_t)ADC_MIN_LIMIT(0), (uint32_t)ADC_MAX_LIMIT(100)}, \
...
#define FS_CFG_AIO_CHANNELS_INIT {0xAU, 0x19U, 0x7}  /* ADC Channels for V_refl, V_refh, bandgap */
/********* ADC END *********/
