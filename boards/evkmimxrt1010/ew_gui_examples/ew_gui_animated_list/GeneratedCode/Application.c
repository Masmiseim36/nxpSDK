...
void ApplicationApplication__Init( ApplicationApplication _this, XObject aLink, XHandle aArg )
{
  ...
  CoreGroup__Add( _this, ((CoreView)&_this->AnimatedList ), 0 );
}
...
EW_DEFINE_CLASS( ApplicationApplication, CoreRoot, AnimatedList, AnimatedList, AnimatedList, 
                 AnimatedList, _None, _None, "Application::Application" )
