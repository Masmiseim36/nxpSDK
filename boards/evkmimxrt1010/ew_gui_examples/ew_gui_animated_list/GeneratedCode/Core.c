...
static const unsigned short _StringsDefault0[] =
{
  ...
  0x0065, 0x002E, 0x0000, 0xC557, 0x0054, 0x0068, 0x0065, 0x0020, 0x006D, 0x0065,
  0x0074, 0x0068, 0x006F, 0x0064, 0x0020, 0x0041, 0x0064, 0x0064, 0x0028, 0x0029,
  0x0020, 0x0069, 0x0073, 0x0020, 0x006E, 0x006F, 0x0074, 0x0020, 0x0061, 0x0076,
  0x0061, 0x0069, 0x006C, 0x0061, 0x0062, 0x006C, 0x0065, 0x0020, 0x0069, 0x006E,
  0x0020, 0x0043, 0x006F, 0x0072, 0x0065, 0x003A, 0x003A, 0x0056, 0x0065, 0x0072,
  0x0074, 0x0069, 0x0063, 0x0061, 0x006C, 0x004C, 0x0069, 0x0073, 0x0074, 0x002E,
  0x0000, 0xC557, 0x0054, 0x0068, 0x0065, 0x0020, 0x0053, 0x006C, 0x0069, 0x0064,
  0x0065, 0x0020, 0x0054, 0x006F, 0x0075, 0x0063, 0x0068, 0x0020, 0x0048, 0x0061,
  0x006E, 0x0064, 0x006C, 0x0065, 0x0072, 0x003A, 0x0000, 0xC557, 0x0069, 0x0073,
  0x0020, 0x0061, 0x006C, 0x0072, 0x0065, 0x0061, 0x0064, 0x0079, 0x0020, 0x0063,
  0x006F, 0x006E, 0x006E, 0x0065, 0x0063, 0x0074, 0x0065, 0x0064, 0x0020, 0x0077,
  0x0069, 0x0074, 0x0068, 0x0020, 0x0061, 0x0020, 0x0076, 0x0069, 0x0065, 0x0077,
  0x002E, 0x0000, 0xC557, 0x0054, 0x0068, 0x0065, 0x0020, 0x0053, 0x006C, 0x0069,
  0x0064, 0x0065, 0x0020, 0x0054, 0x006F, 0x0075, 0x0063, 0x0068, 0x0020, 0x0048,
  0x0061, 0x006E, 0x0064, 0x006C, 0x0065, 0x0072, 0x0020, 0x0069, 0x0073, 0x0020,
  0x0061, 0x006C, 0x0072, 0x0065, 0x0061, 0x0064, 0x0079, 0x0020, 0x0063, 0x006F,
  0x006E, 0x006E, 0x0065, 0x0063, 0x0074, 0x0065, 0x0064, 0x0020, 0x0077, 0x0069,
  0x0074, 0x0068, 0x0020, 0x0061, 0x0020, 0x0076, 0x0069, 0x0065, 0x0077, 0x0020,
  0x0074, 0x006F, 0x0020, 0x0073, 0x0063, 0x0072, 0x006F, 0x006C, 0x006C, 0x0020,
  0x0069, 0x0074, 0x0073, 0x0020, 0x0063, 0x006F, 0x006E, 0x0074, 0x0065, 0x006E,
  0x0074, 0x002E, 0x0000, 0xC557, 0x0054, 0x0068, 0x0065, 0x0020, 0x004B, 0x0065,
...
static const XStringRes _Const0004 = { _StringsDefault0, 0x003B };
static const XColor _Const0005 = { 0x00, 0x00, 0x00, 0x00 };
static const XStringRes _Const0006 = { _StringsDefault0, 0x0054 };
static const XRect _Const0007 = {{ 0, 0 }, { 170, 120 }};
...
static const XStringRes _Const000B = { _StringsDefault0, 0x00FD };
static const XStringRes _Const000C = { _StringsDefault0, 0x014E };
  ...
  aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  if ( !fullScreenUpdate )
    ...
    aClip, aOffset ), _this->Super2.Bounds.Point1 ), _Const0005, _Const0005, _Const0005, 
    _Const0005, 0 );
...
void CoreVerticalList__Init( CoreVerticalList _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( CoreVerticalList );
  ...
  value )
{
  ...
  {
    EwTrace( "%s%*%s", EwLoadString( &_Const0009 ), value, EwLoadString( &_Const000A ));
