...
This sample shows the implementation of some fancy scrollable list
widgets to set a time and a day of the week.
The speciality of this sample application is the magnification effect of
the centered list items and the soft fade-in/fade-out effects.
...
http://www.embedded-wizard.de/NXP-SDK-Examples/IMXRT1010-EVK/AnimatedList/Simulation/
...
The log below shows the output of the sample application 'AnimatedList' in the terminal window:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
