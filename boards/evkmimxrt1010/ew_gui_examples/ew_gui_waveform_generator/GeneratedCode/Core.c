...
static const unsigned short _StringsDefault0[] =
{
  ...
  0x0054, 0x0068, 0x0065, 0x0020, 0x0053, 0x006C, 0x0069, 0x0064, 0x0065, 0x0020,
  0x0054, 0x006F, 0x0075, 0x0063, 0x0068, 0x0020, 0x0048, 0x0061, 0x006E, 0x0064,
  0x006C, 0x0065, 0x0072, 0x003A, 0x0000, 0xC557, 0x0069, 0x0073, 0x0020, 0x0061,
  0x006C, 0x0072, 0x0065, 0x0061, 0x0064, 0x0079, 0x0020, 0x0063, 0x006F, 0x006E,
  0x006E, 0x0065, 0x0063, 0x0074, 0x0065, 0x0064, 0x0020, 0x0077, 0x0069, 0x0074,
  0x0068, 0x0020, 0x0061, 0x0020, 0x0076, 0x0069, 0x0065, 0x0077, 0x002E, 0x0000,
  0xC557, 0x0054, 0x0068, 0x0065, 0x0020, 0x0053, 0x006C, 0x0069, 0x0064, 0x0065,
  0x0020, 0x0054, 0x006F, 0x0075, 0x0063, 0x0068, 0x0020, 0x0048, 0x0061, 0x006E,
  0x0064, 0x006C, 0x0065, 0x0072, 0x0020, 0x0069, 0x0073, 0x0020, 0x0061, 0x006C,
  0x0072, 0x0065, 0x0061, 0x0064, 0x0079, 0x0020, 0x0063, 0x006F, 0x006E, 0x006E,
  0x0065, 0x0063, 0x0074, 0x0065, 0x0064, 0x0020, 0x0077, 0x0069, 0x0074, 0x0068,
  0x0020, 0x0061, 0x0020, 0x0076, 0x0069, 0x0065, 0x0077, 0x0020, 0x0074, 0x006F,
  0x0020, 0x0073, 0x0063, 0x0072, 0x006F, 0x006C, 0x006C, 0x0020, 0x0069, 0x0074,
  0x0073, 0x0020, 0x0063, 0x006F, 0x006E, 0x0074, 0x0065, 0x006E, 0x0074, 0x002E,
  0x0000, 0xC557, 0x0054, 0x0068, 0x0065, 0x0020, 0x004B, 0x0065, 0x0079, 0x0050,
  0x0072, 0x0065, 0x0073, 0x0073, 0x0048, 0x0061, 0x006E, 0x0064, 0x006C, 0x0065,
  0x0072, 0x0020, 0x0069, 0x0073, 0x0020, 0x0065, 0x006D, 0x0062, 0x0065, 0x0064,
  0x0064, 0x0065, 0x0064, 0x0020, 0x0077, 0x0069, 0x0074, 0x0068, 0x0069, 0x006E,
  0x0020, 0x0061, 0x006E, 0x0020, 0x006F, 0x0062, 0x006A, 0x0065, 0x0063, 0x0074,
  0x0020, 0x006E, 0x006F, 0x0074, 0x0020, 0x0062, 0x0065, 0x0069, 0x006E, 0x0067,
  0x0020, 0x0064, 0x0065, 0x0072, 0x0069, 0x0076, 0x0065, 0x0064, 0x0020, 0x0066,
  0x0072, 0x006F, 0x006D, 0x0020, 0x0043, 0x006F, 0x0072, 0x0065, 0x003A, 0x003A,
  0x0047, 0x0072, 0x006F, 0x0075, 0x0070, 0x002E, 0x0000
};
...
static const XStringRes _Const0007 = { _StringsDefault0, 0x007D };
static const XColor _Const0008 = { 0x00, 0x00, 0x00, 0x00 };
static const XStringRes _Const0009 = { _StringsDefault0, 0x0096 };
static const XStringRes _Const000A = { _StringsDefault0, 0x00C8 };
static const XStringRes _Const000B = { _StringsDefault0, 0x00E2 };
static const XStringRes _Const000C = { _StringsDefault0, 0x0105 };
static const XStringRes _Const000D = { _StringsDefault0, 0x0156 };
...
EW_DEFINE_CLASS( CoreOutline, CoreRectView, scrollEffect, OnUpdate, ScrollOffset, 
...
void CoreSlideTouchHandler__Init( CoreSlideTouchHandler _this, XObject aLink, XHandle aArg )
{
  ...
  /* Allow the Immediate Garbage Collection to evalute the members of this class. */
  _this->_GCT = EW_CLASS_GCT( CoreSlideTouchHandler );
  ...
  aEvent )
{
  ...
  if ( !!_this->RetargetCondition )
  {
    ...
    if (( drag && (( _this->RetargetCondition & CoreRetargetReasonWipeUp ) == CoreRetargetReasonWipeUp )) 
        && (( event2->GlobalCurrentPos.Y - event2->GlobalHittingPos.Y ) <= -_this->RetargetOffset ))
      reason = CoreRetargetReasonWipeUp;
