...
/* ******************************************************************************
   ...
   RTC_MINIMUM_TIME.
   **************************************************************************** */
#define PLATFORM_STRING       "IMXRT1010-EVK"
...
/* ******************************************************************************
   ...
   **************************************************************************** */
#define EW_MEMORY_POOL_SECTION   EW_MEM_SECTION( OC_RAM )
#define EW_MEMORY_POOL_SIZE      ( 48 * 1024 )
...
#define EW_MAX_GLYPH_SURFACE_WIDTH        64
#define EW_MAX_GLYPH_SURFACE_HEIGHT      128
#define EW_MAX_ISSUE_TASKS                40
