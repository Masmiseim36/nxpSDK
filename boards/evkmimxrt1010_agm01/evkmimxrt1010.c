...
/**
 * @file evkmimxrt1010.c
 * @brief The evkmimxrt1010.c file defines GPIO pins and I2C CMSIS utilities for evkmimxrt1010 board.
 */

#include "evkmimxrt1010.h"
...
gpioHandleiMXSDK_t D13 = {
    .base = GPIO1, .pinNumber = 10, .mask = 1 << (10), .irq = GPIO1_Combined_16_31_IRQn, .portNumber = GPIO1_NUM};
// GPIO_AD_B0_13
gpioHandleiMXSDK_t D12 = {
    .base = GPIO1, .pinNumber = 13, .mask = 1 << (13), .irq = GPIO1_Combined_0_15_IRQn, .portNumber = GPIO1_NUM};
// GPIO_AD_B0_12
gpioHandleiMXSDK_t D11 = {
    .base = GPIO1, .pinNumber = 12, .mask = 1 << (12), .irq = GPIO1_Combined_0_15_IRQn, .portNumber = GPIO1_NUM};
// GPIO_AD_B0_11
gpioHandleiMXSDK_t D10 = {
    .base = GPIO1, .pinNumber = 11, .mask = 1 << (11), .irq = GPIO1_Combined_16_31_IRQn, .portNumber = GPIO1_NUM};
...
gpioHandleiMXSDK_t D1 = {
    .base = GPIO2, .pinNumber = 8, .mask = 1 << (8), .irq = GPIO2_Combined_0_15_IRQn, .portNumber = GPIO2_NUM};

// evkmimxrt1010 Arduino Connector Pin Defintion
