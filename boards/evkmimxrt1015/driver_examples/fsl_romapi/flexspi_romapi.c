...
int main(void)
{
    ...
    /*  Probe device presence by verifying Manufacturer ID and device ID */
    status = FLEXSPI_NorFlash_VerifyID(FlexSpiInstance, &vendorID);
    if (status == kStatus_Success)
    {
