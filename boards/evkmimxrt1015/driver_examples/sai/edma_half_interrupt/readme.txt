Overview
========
The sai_edma_half_interrupt example shows how to use sai driver with EDMA half interrupt feature:
...
4. Insert the headphones into the headphone jack on EVK-MIMXRT1015 board (J12).
