...
- pin_list:
  - {pin_num: '56', peripheral: USB, signal: usb_otg1_id, pin_signal: GPIO_AD_B1_11, software_input_on: Disable, open_drain: Enable, drive_strength: R0, pull_keeper_select: Pull,
