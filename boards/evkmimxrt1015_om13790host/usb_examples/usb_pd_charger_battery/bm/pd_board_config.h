...
#define BOARD_PD_USB3_CROSS_SUPPORT     (0U)
...
#define PD_PORT1_PHY_INTERRUPT_PIN  (3U)
#define PD_PORT1_PHY_INTERRUPT_PORT (3U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN  (27U)
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (1U)

#define PD_PORT1_EXTRA_SRC_PIN  (2U)
#define PD_PORT1_EXTRA_SRC_PORT (3U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN  (20U)
#define PD_PORT1_SHIELD2_DP4LANE_PORT (2U)

#define PD_PORT1_SHIELD2_XSD_PIN  (27U)
#define PD_PORT1_SHIELD2_XSD_PORT (2U)

#define PD_PORT1_SHIELD2_ORIENT_PIN  (22U)
#define PD_PORT1_SHIELD2_ORIENT_PORT (2U)

#define PD_PORT1_SHIELD2_HPD_PIN  (26U)
