...
This example implements the temperature controller function with Azure Plug and Play component.
The user can send the target temperature value to the device via the IoTHub.
...
10. Use Azure IoT explorer. Refer to https://docs.microsoft.com/en-us/azure/iot-pnp/howto-use-iot-explorer#use-azure-iot-explorer
   # Download the model file:
     ...
     2) Download https://raw.githubusercontent.com/Azure/opendigitaltwins-dtdl/master/DTDL/v2/samples/TemperatureController.json and save the JSON file to the 'models' folder.
