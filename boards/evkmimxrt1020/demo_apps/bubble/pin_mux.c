...
- pin_list:
  ...
  - {pin_num: '106', peripheral: GPIO1, signal: 'gpio_io, 05', pin_signal: GPIO_AD_B0_05, software_input_on: Disable, open_drain: Disable, drive_strength: R0_6, pull_keeper_select: Keeper,
