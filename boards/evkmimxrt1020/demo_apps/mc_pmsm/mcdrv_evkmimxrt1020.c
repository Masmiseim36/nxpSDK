...
{    
    ...
    CCM->CCGR4 = (CCM->CCGR4 & ~(uint16_t)(CCM_CCGR4_CG9_MASK)) | CCM_CCGR4_CG9(0x3);
    ...
    PWMBase->SM[M1_PWM_PAIR_PHA].DISMAP[0] = PWMBase->SM[0].DISMAP[0] & ~(uint16_t)(uint16_t)PWM_DISMAP_DIS0A_MASK | PWM_DISMAP_DIS0A(0x1);
    PWMBase->SM[M1_PWM_PAIR_PHB].DISMAP[0] = PWMBase->SM[0].DISMAP[0] & ~(uint16_t)(uint16_t)PWM_DISMAP_DIS0A_MASK | PWM_DISMAP_DIS0A(0x1);
    PWMBase->SM[M1_PWM_PAIR_PHC].DISMAP[0] = PWMBase->SM[0].DISMAP[0] & ~(uint16_t)(uint16_t)PWM_DISMAP_DIS0A_MASK | PWM_DISMAP_DIS0A(0x1);
    PWMBase->SM[M1_PWM_PAIR_PHA].DISMAP[0] = PWMBase->SM[0].DISMAP[0] & ~(uint16_t)(uint16_t)PWM_DISMAP_DIS0B_MASK | PWM_DISMAP_DIS0B(0x1);
    PWMBase->SM[M1_PWM_PAIR_PHB].DISMAP[0] = PWMBase->SM[0].DISMAP[0] & ~(uint16_t)(uint16_t)PWM_DISMAP_DIS0B_MASK | PWM_DISMAP_DIS0B(0x1);
    PWMBase->SM[M1_PWM_PAIR_PHC].DISMAP[0] = PWMBase->SM[0].DISMAP[0] & ~(uint16_t)(uint16_t)PWM_DISMAP_DIS0B_MASK | PWM_DISMAP_DIS0B(0x1); 

    /* Modules one and two gets clock from module zero */
    PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 & ~(uint16_t)PWM_CTRL2_CLK_SEL_MASK) | PWM_CTRL2_CLK_SEL(0x2);
    PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 & ~(uint16_t)PWM_CTRL2_CLK_SEL_MASK) | PWM_CTRL2_CLK_SEL(0x2);
    ...
    PWMBase->SM[M1_PWM_PAIR_PHA].CTRL = (PWMBase->SM[M1_PWM_PAIR_PHA].CTRL & ~(uint16_t)PWM_CTRL_LDFQ_MASK) | PWM_CTRL_LDFQ(M1_FOC_FREQ_VS_PWM_FREQ - 1);

    /* Master sync active for modules one and three*/
    PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 & ~(uint16_t)PWM_CTRL2_INIT_SEL_MASK) | PWM_CTRL2_INIT_SEL(0x2);
    PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 & ~(uint16_t)PWM_CTRL2_INIT_SEL_MASK) | PWM_CTRL2_INIT_SEL(0x2);
    ...
    PWMBase->OUTEN = (PWMBase->OUTEN & ~(uint16_t)PWM_OUTEN_PWMA_EN_MASK) | PWM_OUTEN_PWMA_EN(0xD);
    PWMBase->OUTEN = (PWMBase->OUTEN & ~(uint16_t)PWM_OUTEN_PWMB_EN_MASK) | PWM_OUTEN_PWMB_EN(0xD);
