...
{    
    ...
    PWMBase->SM[M1_PWM_PAIR_PHA].DISMAP[0] = ((PWMBase->SM[0].DISMAP[0] & ~PWM_DISMAP_DIS0A_MASK) | PWM_DISMAP_DIS0A(0x1));
    PWMBase->SM[M1_PWM_PAIR_PHB].DISMAP[0] = ((PWMBase->SM[0].DISMAP[0] & ~PWM_DISMAP_DIS0A_MASK) | PWM_DISMAP_DIS0A(0x1));
    PWMBase->SM[M1_PWM_PAIR_PHC].DISMAP[0] = ((PWMBase->SM[0].DISMAP[0] & ~PWM_DISMAP_DIS0A_MASK) | PWM_DISMAP_DIS0A(0x1));
    PWMBase->SM[M1_PWM_PAIR_PHA].DISMAP[0] = ((PWMBase->SM[0].DISMAP[0] & ~PWM_DISMAP_DIS0B_MASK) | PWM_DISMAP_DIS0B(0x1));
    PWMBase->SM[M1_PWM_PAIR_PHB].DISMAP[0] = ((PWMBase->SM[0].DISMAP[0] & ~PWM_DISMAP_DIS0B_MASK) | PWM_DISMAP_DIS0B(0x1));
    PWMBase->SM[M1_PWM_PAIR_PHC].DISMAP[0] = ((PWMBase->SM[0].DISMAP[0] & ~PWM_DISMAP_DIS0B_MASK) | PWM_DISMAP_DIS0B(0x1)); 

    /* Modules one and two gets clock from module zero */
    PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 & ~PWM_CTRL2_CLK_SEL_MASK) | PWM_CTRL2_CLK_SEL(0x2);
    PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 & ~PWM_CTRL2_CLK_SEL_MASK) | PWM_CTRL2_CLK_SEL(0x2);
    ...
    PWMBase->SM[M1_PWM_PAIR_PHA].CTRL = (PWMBase->SM[M1_PWM_PAIR_PHA].CTRL & ~PWM_CTRL_LDFQ_MASK) | PWM_CTRL_LDFQ(M1_FOC_FREQ_VS_PWM_FREQ - 1);

    /* Master sync active for modules one and three*/
    PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHB].CTRL2 & ~PWM_CTRL2_INIT_SEL_MASK) | PWM_CTRL2_INIT_SEL(0x2);
    PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 = (PWMBase->SM[M1_PWM_PAIR_PHC].CTRL2 & ~PWM_CTRL2_INIT_SEL_MASK) | PWM_CTRL2_INIT_SEL(0x2);
