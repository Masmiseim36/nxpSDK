...
MIMXRT1020-EVK with FRDM-MC-LVPMSM. FreeMASTER pmsm_demo.pmp file is used for real-time debug monitoring and data visualization. 
...
For correct signal connection and proper demo working, it is necessary to solder/remove resistors from the board. Please, see the PMSMDEMOUG user guide and MIMXRT1020-EVK schematic.

The low-voltage evaluation board does not require any hardware configuration or jumper settings as well.

Prepare the Demo
===============
1.  Connect the FRDM-MC-LVPMSM with MIMXRT1020-EVK board through cables according PMSMDEMOUG users guide.. 
...
More details about pmsm motor control application on MIMXRT1020-EVK board are described in document AN12214 and and 
