...
void LPM_RestorePLLs(lpm_power_mode_t power_mode)
{
    ...
    //    CCM->CBCDR = (CCM->CBCDR & ~(CCM_CBCDR_AHB_PODF_MASK | CCM_CBCDR_IPG_PODF_MASK |
...
void LPM_SystemOverRun(void)
{
    ...
    CCM_ANALOG->PLL_ENET_CLR = CCM_ANALOG_PLL_ENET_POWERDOWN_MASK;
    CCM_ANALOG->PLL_ENET_SET = CCM_ANALOG_PLL_ENET_ENABLE_MASK | CCM_ANALOG_PLL_ENET_BYPASS_MASK;
