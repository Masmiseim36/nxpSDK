...
.\..\srec_cat .\debug\safety_iec60730b.hex -intel -crop 0x60002410 0x60004000 -fill 0xFF 0x60002410 0x60004000 -Bit_Reverse -CRC32LE 0x60002400 -Bit_Reverse -XOR 0xff -o .\debug\tmp_cropped.hex -intel 
