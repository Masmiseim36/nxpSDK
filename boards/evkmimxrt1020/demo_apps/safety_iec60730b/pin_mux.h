...
#define BOARD_INITPINS_ENET_TXD1_GPIO                                      GPIO1   /*!< GPIO device name: GPIO1 */
#define BOARD_INITPINS_ENET_TXD1_PORT                                      GPIO1   /*!< PORT device name: GPIO1 */
#define BOARD_INITPINS_ENET_TXD1_PIN                                         15U   /*!< GPIO1 pin index: 15 */
