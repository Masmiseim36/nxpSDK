...
#define INITPDOS_CALLS                                                                       \
    ...
    MCO_InitTPDOFull(handle, 1, NODEID + 0x80000180, 500, 100, 255, 4, P600001_DigInput8_1); \
    MCO_InitTPDOFull(handle, 2, NODEID + 0x80000280, 1000, 250, 255, 4, P640101_AnalogInput16_1);

#else
#define INITPDOS_CALLS                                                               \
    MCO_InitRPDO(1, NODEID + 0x80000200, 4, P620001_DigOutput8_1);                   \
    MCO_InitRPDO(2, NODEID + 0x80000300, 4, P641101_AnalogOutput16_1);               \
    MCO_InitTPDOFull(1, NODEID + 0x80000180, 500, 100, 255, 4, P600001_DigInput8_1); \
    MCO_InitTPDOFull(2, NODEID + 0x80000280, 1000, 250, 255, 4, P640101_AnalogInput16_1);

#endif

#ifdef MCO_USE_HANDLE
#define INITHBCONSUMER_CALLS                 \
    MCOP_InitHBConsumer(handle, 1, 0x01, 0); \
    MCOP_InitHBConsumer(handle, 2, 0x02, 0); \
    MCOP_InitHBConsumer(handle, 3, 0x03, 0); \
    MCOP_InitHBConsumer(handle, 4, 0x04, 0); \
    MCOP_InitHBConsumer(handle, 5, 0x05, 0); \
    MCOP_InitHBConsumer(handle, 6, 0x06, 0); \
    MCOP_InitHBConsumer(handle, 7, 0x07, 0); \
    MCOP_InitHBConsumer(handle, 8, 0x08, 0); \
    MCOP_InitHBConsumer(handle, 9, 0x09, 0); \
    MCOP_InitHBConsumer(handle, 10, 0x0A, 0);

#else
#define INITHBCONSUMER_CALLS         \
    MCOP_InitHBConsumer(1, 0x01, 0); \
    MCOP_InitHBConsumer(2, 0x02, 0); \
    MCOP_InitHBConsumer(3, 0x03, 0); \
    MCOP_InitHBConsumer(4, 0x04, 0); \
    MCOP_InitHBConsumer(5, 0x05, 0); \
    MCOP_InitHBConsumer(6, 0x06, 0); \
    MCOP_InitHBConsumer(7, 0x07, 0); \
    MCOP_InitHBConsumer(8, 0x08, 0); \
    MCOP_InitHBConsumer(9, 0x09, 0); \
    MCOP_InitHBConsumer(10, 0x0A, 0);
