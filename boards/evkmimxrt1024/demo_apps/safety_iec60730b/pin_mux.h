...
#define BOARD_INITPINS_ENET_TXD0_GPIO                                      GPIO1   /*!< GPIO device name: GPIO1 */
#define BOARD_INITPINS_ENET_TXD0_PORT                                      GPIO1   /*!< PORT device name: GPIO1 */
#define BOARD_INITPINS_ENET_TXD0_PIN                                         14U   /*!< GPIO1 pin index: 14 */
