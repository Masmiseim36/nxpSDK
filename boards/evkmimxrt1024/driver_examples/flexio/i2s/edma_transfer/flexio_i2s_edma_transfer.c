...
/* Select Audio PLL (786.43 MHz) as sai3 clock source */
...
#define DEMO_SAI_CLK_FREQ                                                            \
    (CLOCK_GetFreq(kCLOCK_AudioPllClk) / (DEMO_SAI3_CLOCK_SOURCE_PRE_DIVIDER + 1U) / \
     (DEMO_SAI3_CLOCK_SOURCE_DIVIDER + 1U))
