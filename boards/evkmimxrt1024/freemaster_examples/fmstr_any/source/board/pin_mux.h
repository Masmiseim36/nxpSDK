...
#define BOARD_INITPINS_CAN1_RX_PERIPHERAL                                   CAN1   /*!< Device name: CAN1 */
#define BOARD_INITPINS_CAN1_RX_SIGNAL                                         RX   /*!< CAN1 signal: RX */

/* GPIO_SD_B1_00 (number 33), CAN1_TX/U9[1] */
#define BOARD_INITPINS_CAN1_TX_PERIPHERAL                                   CAN1   /*!< Device name: CAN1 */
#define BOARD_INITPINS_CAN1_TX_SIGNAL                                         TX   /*!< CAN1 signal: TX */
