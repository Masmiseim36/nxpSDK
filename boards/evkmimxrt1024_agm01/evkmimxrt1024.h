...
/**
 * @file evkmimxrt1024.h
 * @brief The evkmimxrt1024.h file defines GPIO pin mappings for evkmimxrt1024 board
 */

#ifndef EVKMIMX1024_H_
#define EVKMIMX1024_H_
...
/* Compatability definitions for evkmimxrt1024 */
#define I2C1          LPI2C4
