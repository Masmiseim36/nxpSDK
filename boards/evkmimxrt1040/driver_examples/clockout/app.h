...
#define APP_OUTPUT2_CLOCK_NAME_ARRAY                                                                        \
    {                                                                                                       \
        "Usdhc1 Clock Root", "LPI2C Clock Root", "OSC Clock", "Usdhc2 Clock Root", "SAI1 Clock Root",       \
            "SAI2 Clock Root", "SAI3 Clock Root(Shared with ADC1 and ADC2 alt_clk root)", "Can Clock Root", \
            "Flexspi Clock Root", "UART Clock Root", "Spdif0 Clock Root",                                   \
    }
#define APP_OUTPUT2_CLOCK_NAME_ENUM_ARRAY                                                           \
    {                                                                                               \
        kCLOCK_OutputUsdhc1Clk, kCLOCK_OutputLpi2cClk, kCLOCK_OutputOscClk, kCLOCK_OutputUsdhc2Clk, \
            kCLOCK_OutputSai1Clk, kCLOCK_OutputSai2Clk, kCLOCK_OutputSai3Clk, kCLOCK_OutputCanClk,  \
            kCLOCK_OutputFlexspiClk, kCLOCK_OutputUartClk, kCLOCK_OutputSpdif0Clk,                  \
    }
/*${macro:end}*/
