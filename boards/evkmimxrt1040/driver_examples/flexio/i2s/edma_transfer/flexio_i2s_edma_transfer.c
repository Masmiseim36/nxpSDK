...
int main(void)
{
    ...
    DMAMUX_Init(EXAMPLE_DMAMUX_TX_BASE);
    DMAMUX_SetSource(EXAMPLE_DMAMUX_TX_BASE, EXAMPLE_DMAMUX_TX_CHANNEL, EXAMPLE_TX_DMA_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_DMAMUX_TX_BASE, EXAMPLE_DMAMUX_TX_CHANNEL);
    DMAMUX_Init(EXAMPLE_DMAMUX_RX_BASE);
    DMAMUX_SetSource(EXAMPLE_DMAMUX_RX_BASE, EXAMPLE_DMAMUX_RX_CHANNEL, EXAMPLE_RX_DMA_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_DMAMUX_RX_BASE, EXAMPLE_DMAMUX_RX_CHANNEL);
#else
