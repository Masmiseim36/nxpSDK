...
#define PD_PORT1_PHY_INTERRUPT_PIN  (30U)
#define PD_PORT1_PHY_INTERRUPT_PORT (2U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN  (18U)
#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (1U)

#define PD_PORT1_EXTRA_SRC_PIN  (9U)
#define PD_PORT1_EXTRA_SRC_PORT (1U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN  (11U)
#define PD_PORT1_SHIELD2_DP4LANE_PORT (1U)

#define PD_PORT1_SHIELD2_XSD_PIN  (10U)
#define PD_PORT1_SHIELD2_XSD_PORT (1U)

#define PD_PORT1_SHIELD2_ORIENT_PIN  (31U)
