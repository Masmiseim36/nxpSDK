...
#warning "Replace mbed_cloud_dev_credentials.c with your own developer cert. Please see document Arm Pelion Device Management User Guide.pdf in the docs folder for details."
#endif
