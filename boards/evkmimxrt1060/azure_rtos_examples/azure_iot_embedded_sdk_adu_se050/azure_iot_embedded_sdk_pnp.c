...
UINT status;
    ...
    *iothub_device_id_length = sizeof(sample_iothub_device_id);
    ...
    /* Set symmetric key.  */
    else if ((status = nx_azure_iot_provisioning_client_symmetric_key_set(prov_client_ptr,
                                                                          (UCHAR *)DEVICE_SYMMETRIC_KEY,
                                                                          strlen(DEVICE_SYMMETRIC_KEY))))
    {
    ...
    else if ((status = nx_azure_iot_provisioning_client_registration_payload_set(prov_client_ptr,
                                                                                 (UCHAR *)SAMPLE_PNP_DPS_PAYLOAD,
