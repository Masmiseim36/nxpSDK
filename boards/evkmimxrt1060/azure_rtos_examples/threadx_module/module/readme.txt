Overview
========
This is a small demo of the ThreadX Module. It includes two threads of
same priorities, using two message queue to communicate between these
two threads and calling the uart interface to print information.
...
4.  Write the program to the flash(0x60080000) of the target board.
5.  Write the module manager image to the flash of the target board.
    Please refer to readme.txt of the threadx_module_manager project.
