...
static const INT8 *ENCODER_LOG_STRING[4] = {
    "",                                                 /* no error */
...
static const INT8 *DECODER_LOG_STRING[5] = {
    "",                                                 /* no error */
    "Input file open failed!",
...
static const INT8 *ENCODER_SUB_LOG_STRING[11] = {
    "",                                                 /* no error */
...
static const INT8 *DECODER_SUB_LOG_STRING[10] = {
    "",                                                 /* no error */
    "core buffer size is 0!",
    "core buffer handle is null!",
    "parameter init is failed!",
...
#define MAX_LC3_FRAMES_TO_DISPLAY            3
