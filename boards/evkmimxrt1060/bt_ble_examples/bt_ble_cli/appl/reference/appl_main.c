...
================ M A I N   M E N U ================ \n\
 ...
 \n\
  100. Simulate VU. \n\
 \n\
  205. Wake on BLE vendor command. \n\
  206. H2C sleep vendor command. \n\
  207. H2C sleep. \n\
  208. H2C wakeup. \n\
  209. Host sleep. \n\
 \n\
...
void Configure_sleep_wakeup (void)
{
	...
	UCHAR new[6U] = {0x03U, 0x10U, 0x02U, 0xffU, 0x00U, 0x00U};
	(BT_IGNORE_RETURN_VALUE) BT_hci_vendor_specific_command(0x0053U, new, sizeof(new));
}
...
#endif /* EM_PLATFORM_MAIN */
{
    ...
    BT_LOOP_FOREVER()
    {
		...
		case 205:
#ifdef OOB_WAKEUP
        	LOG_DEBUG("Sending wake on BLE vendor command\n");
        	Configure_sleep_wakeup();
#else /* OOB_WAKEUP */
            LOG_DEBUG("*** Enable 'OOB_WAKEUP' Compilation Flag\n");
#endif /* OOB_WAKEUP */
            break;

        case 206:
#ifdef OOB_WAKEUP
        	LOG_DEBUG("Sending controller sleep vendor command\n");
        ...
        case 207:
#ifdef OOB_WAKEUP
           	LOG_DEBUG("Make sure controller sleep vendor command is given before this. Simulating BT sleep\n");
           	H2C_sleep();
#else /* OOB_WAKEUP */
            LOG_DEBUG("*** Enable 'OOB_WAKEUP' Compilation Flag\n");
#endif /* OOB_WAKEUP */
        ...
        case 208:
#ifdef OOB_WAKEUP
        	LOG_DEBUG("Simulating BT wakeup\n");
        	H2C_wakeup();
#else /* OOB_WAKEUP */
            LOG_DEBUG("*** Enable 'OOB_WAKEUP' Compilation Flag\n");
#endif /* OOB_WAKEUP */
