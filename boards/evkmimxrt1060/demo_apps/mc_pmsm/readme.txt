...
MIMXRT1060-EVK with FRDM-MC-LVPMSM. FreeMASTER pmsm_demo.pmp file is used for real-time debug monitoring and data visualization. 
...
Boards settings
===============
Before you connect the MIMXRT1060-EVK board with FRDM-MC-LVPMSM ensure that the jumpers 
are configured according the PMSMDEMOUG users guide (from KSDK package\docs\MC\PMSMDEMOUG.pdf). 

For correct signal connection and proper demo working, it is necessary to solder/remove resistors from the board. Please, see the PMSMDEMOUG user guide and MIMXRT1060-EVK board schematic.

The low-voltage evaluation board does not require any hardware configuration or jumper settings as well.

Prepare the Demo
===============
1.  Connect the FRDM-MC-LVPMSM with MIMXRT1060-EVK board through cables according users guide PMSMFOCRT10xxUG. 
...
More details about pmsm motor control application on MIMXRT1060-EVK board are described in document AN12214 and 
