 ...
 *
 *   Number of SDP records (n_rec) = 42
 *   Number of attributes (n_attr) = 383
 *   UUID List Length (uuid_list_len) = 196
 *   Number of UUIDS (n_uuid) = 65
 *   Total attribute value length (attr_len) = 3514 Bytes
...
struct attr attr_arr[] = {
    ...
    /** Service Record 41 */
    /* ServiceRecordHandle */
    {0x0000, 0x0005, value_arr + 0x0D6B},

    /* ServiceClassIDList */
    {0x0001, 0x0005, value_arr + 0x0D70},

    /* ProtocolDescriptorList */
    {0x0004, 0x000F, value_arr + 0x0D75},

    /* BrowseGroupList  */
    {0x0005, 0x0005, value_arr + 0x0D84},

    /* LanguageBaseAttributeIDList  */
    {0x0006, 0x000B, value_arr + 0x0D89},

    /* BluetoothProfileDescriptorList */
    {0x0009, 0x000A, value_arr + 0x0D94},

    /* ServiceName */
    {0x0100, 0x0015, value_arr + 0x0D9E},

    /* MASInstanceID */
    {0x0315, 0x0002, value_arr + 0x0DB3},

    /* MapSupportedFeatures */
    {0x0317, 0x0005, value_arr + 0x0DB5}
};
