...
convolutional neural network model [1] that classifies the input image to
...
Files:
  ...
  image_data.h - image file converted to a C language array using
...
Label image object recognition example using a TensorFlow Lite model.
