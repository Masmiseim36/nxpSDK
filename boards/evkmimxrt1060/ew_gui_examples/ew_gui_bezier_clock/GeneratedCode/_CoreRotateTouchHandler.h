...
/* The class Core::RotateTouchHandler provides a special kind of a view able to 
   ...
   the handler sends signals to the slot method stored in the property @OnRotate. 
   The intention of this handler is to cover the internal aspects of the cursor 
   event handling. 
