...
static const XRect _Const0001 = {{ 375, 242 }, { 475, 272 }};
static const XStringRes _Const0002 = { _StringsDefault0, 0x0002 };
static const XPoint _Const0003 = { 0, 0 };
static const XPoint _Const0004 = { 480, 0 };
static const XPoint _Const0005 = { 480, 272 };
static const XPoint _Const0006 = { 0, 272 };
...
EW_DEFINE_CLASS( ApplicationApplication, CoreRoot, device, fpsTimer, fpsTimer, fpsTimer, 
