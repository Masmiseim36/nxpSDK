...
/* 'C' function for method : 'WidgetSet::ToggleButton.OnSetIconOnFrame()' */
void WidgetSetToggleButton_OnSetIconOnFrame( WidgetSetToggleButton _this, XInt32 
  value )
{
  if (((( value == _this->IconOnFrameDefault ) && ( value == _this->IconOnFrameDisabled )) 
