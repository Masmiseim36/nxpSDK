...
EW_DEFINE_FIELDS( DashboardDeviceClass, XObject )
  ...
  EW_PROPERTY( Recuperation,    XInt32 )
...
/* The following define announces the presence of the method Dashboard::DeviceClass.UpdateRecuperation(). */
#define _DashboardDeviceClass__UpdateRecuperation_
