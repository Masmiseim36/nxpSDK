...
#ifndef _CutterVertSlider_H
#define _CutterVertSlider_H
...
/* Forward declaration of the class Cutter::VertSlider */
#ifndef _CutterVertSlider_
  EW_DECLARE_CLASS( CutterVertSlider )
#define _CutterVertSlider_
#endif
...
EW_DEFINE_FIELDS( CutterVertSlider, CoreGroup )
...
EW_END_OF_FIELDS( CutterVertSlider )

/* Virtual Method Table (VMT) for the class : 'Cutter::VertSlider' */
EW_DEFINE_METHODS( CutterVertSlider, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( CutterVertSlider _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
  EW_METHOD( Restack,           void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( CutterVertSlider )
