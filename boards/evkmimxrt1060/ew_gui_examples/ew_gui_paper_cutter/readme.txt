...
cutting machine. The user can define the paper format, the paper feed, the
number of papers and the speed of the cutting process.

The different parameters are shown within separate small windows. As soon as
the user touches on a window, the window is enhanced to host the corresponding
settings dialog. Every transition between window and dialog appearance is done
with several move and fade-in/fade-out animations.
...
The log below shows the output of the sample application 'PaperCutter' in the terminal window:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
