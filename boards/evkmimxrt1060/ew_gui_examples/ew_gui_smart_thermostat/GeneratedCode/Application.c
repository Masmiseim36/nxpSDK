...
void ApplicationApplication__Init( ApplicationApplication _this, XObject aLink, XHandle aArg )
{
  ...
  ThermostatThermostat__Init( &_this->Thermostat, &_this->_XObject, 0 );
...
EW_DEFINE_CLASS( ApplicationApplication, CoreRoot, Thermostat, Thermostat, Thermostat, 
                 Thermostat, _None, _None, "Application::Application" )
