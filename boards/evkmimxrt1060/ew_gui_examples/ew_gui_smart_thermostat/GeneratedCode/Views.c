  ...
  XPoint aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  _this->Super1.Bounds, aOffset ), EwNewRect2Point( _Const0001, _this->Bitmap->FrameSize ), 
...
/* 'C' function for method : 'Views::Wallpaper.OnSetOpacity()' */
void ViewsWallpaper_OnSetOpacity( ViewsWallpaper _this, XInt32 value )
{
  if ( value > 255 )
    value = 255;
...
XInt32 ViewsWallpaper_OnGetOpacity( ViewsWallpaper _this )
{
  ...
  aClip, XPoint aOffset, XInt32 aOpacity, XBool aBlend )
{
  ...
  else
  {
    ...
    0, EwMoveRectPos( _this->Super1.Bounds, aOffset ), _Const0001, ctl, ctr, cbr, 
    cbl, 1 );
