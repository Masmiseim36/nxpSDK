...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x03, kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_1PAD,
//            0x18),
...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x0B, kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_1PAD,
//            0x18),
...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0xEB, kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_4PAD,
//            0x18),
...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x81, kFLEXSPI_Command_READ_SDR, kFLEXSPI_1PAD,
//            0x04),
//
//        /* Write Enable */
...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, /*0x20*/0xD7, kFLEXSPI_Command_RADDR_SDR,
//            kFLEXSPI_1PAD, 0x18),
//
//        /* Page Program - single mode */
//        [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_SINGLE] =
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x02, kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_1PAD,
//            0x18),
//        [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_SINGLE + 1] =
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_WRITE_SDR, kFLEXSPI_1PAD, 0x01/*0x04*/, kFLEXSPI_Command_STOP,
//            kFLEXSPI_1PAD, 0),
//
//        /* Page Program - quad mode */
//        [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_QUAD] =
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x32, kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_1PAD,
//            0x18),
//        [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_QUAD + 1] =
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_WRITE_SDR, kFLEXSPI_4PAD, 0x01/*0x04*/, kFLEXSPI_Command_STOP,
//            kFLEXSPI_1PAD, 0),
//
//        /* Read ID */
//        [4 * NOR_CMD_LUT_SEQ_IDX_READID] =
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0xAB, kFLEXSPI_Command_DUMMY_SDR, kFLEXSPI_1PAD,
//            0x18),
...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x01/*0x01*/, kFLEXSPI_Command_WRITE_SDR,
//            kFLEXSPI_1PAD, /*0x01*/0x04),
//
//        /* Enter QPI mode */
...
//            FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x05, kFLEXSPI_Command_READ_SDR, kFLEXSPI_1PAD,
//            /*0x01*/0x04),
//
//        /* Erase whole chip */
...
status_t sbl_flash_read_ipc(uint32_t address, void *buffer, size_t length)
{
    ...
    if ((uint32_t)buffer % sizeof(uint32_t))
    {
