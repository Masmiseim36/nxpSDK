...
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_host_hid_mouse_dual/<rtos>/readme.pdf.
For lite version, the files path is:
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_host_hid_mouse_lite_dual/<rtos>/readme.pdf.
Note
