...
- {pin_num: G10, pin_signal: GPIO_AD_B0_11, label: BT_REG_ON, identifier: INT2_COMBO;BT_REG_ON}
- {pin_num: L11, pin_signal: GPIO_AD_B1_02, label: UART2_TXD, identifier: SPDIF_OUT;UART2_TXD}
- {pin_num: M12, pin_signal: GPIO_AD_B1_03, label: UART2_RXD, identifier: SPDIF_IN;UART2_RXD}
- {pin_num: H13, pin_signal: GPIO_AD_B1_08, label: BT_REG_ON, identifier: BT_REG_ON}
- {pin_num: L12, pin_signal: GPIO_AD_B1_04, label: UART3_CTS, identifier: CSI_PIXCLK;UART3_CTS}
- {pin_num: K12, pin_signal: GPIO_AD_B1_05, label: UART3_RTS, identifier: CSI_MCLK;UART3_RTS}
- {pin_num: J12, pin_signal: GPIO_AD_B1_06, label: UART3_TX, identifier: CSI_VSYNC;UART3_TX}
- {pin_num: K10, pin_signal: GPIO_AD_B1_07, label: UART3_RX, identifier: CSI_HSYNC;UART3_RX}
...
- pin_list:
  ...
  - {pin_num: L12, peripheral: LPUART3, signal: CTS_B, pin_signal: GPIO_AD_B1_04, identifier: UART3_CTS}
  - {pin_num: K12, peripheral: LPUART3, signal: RTS_B, pin_signal: GPIO_AD_B1_05, identifier: UART3_RTS}
  - {pin_num: J12, peripheral: LPUART3, signal: TX, pin_signal: GPIO_AD_B1_06, identifier: UART3_TX}
  - {pin_num: K10, peripheral: LPUART3, signal: RX, pin_signal: GPIO_AD_B1_07, identifier: UART3_RX}
  - {pin_num: H13, peripheral: GPIO1, signal: 'gpio_io, 24', pin_signal: GPIO_AD_B1_08, direction: OUTPUT, gpio_init_state: 'false'}
