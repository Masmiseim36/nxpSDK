...
{
    while (!((FLEXSPI2->STS0 & FLEXSPI_STS0_ARBIDLE_MASK) && (FLEXSPI2->STS0 & FLEXSPI_STS0_SEQIDLE_MASK)))
    {
        ;
    }
    ...
    {
       /* PLL528 PFD2 will be used as flexspi2 clock. */
       CLOCK_SET_MUX(kCLOCK_Flexspi2Mux, 0x0);
...
void LPM_RestoreFlexspiClock(void)
{
    ...
    FLEXSPI2->DLLCR[0] = s_DllBackupValue;
    FLEXSPI2->MCR0 &= ~FLEXSPI_MCR0_MDIS_MASK;
    FLEXSPI2->MCR0 |= FLEXSPI_MCR0_SWRESET_MASK;
    while (FLEXSPI2->MCR0 & FLEXSPI_MCR0_SWRESET_MASK)
    {
...
void LPM_DisablePLLs(lpm_power_mode_t power_mode)
{
    ...
    if (LPM_PowerModeLowSpeedRun == power_mode)
    {
        ...
        CCM_ANALOG->PFD_528_CLR = CCM_ANALOG_PFD_528_PFD2_FRAC_MASK;
        CCM_ANALOG->PFD_528_SET = CCM_ANALOG_PFD_528_PFD2_FRAC(24);
        CCM_ANALOG->PFD_528_CLR = CCM_ANALOG_PFD_528_PFD2_CLKGATE_MASK;
        
        /*Select PLL528 PFD2 for pre_periph_clock 396MHz */
    ...
    else if (LPM_PowerModeSysIdle == power_mode)
    {
        ...
        CCM_ANALOG->PLL_SYS_CLR = CCM_ANALOG_PLL_SYS_BYPASS_MASK;
        CCM_ANALOG->PFD_528_CLR = CCM_ANALOG_PFD_528_PFD2_FRAC_MASK;
        CCM_ANALOG->PFD_528_SET = CCM_ANALOG_PFD_528_PFD2_FRAC(35);
        CCM_ANALOG->PFD_528_CLR = CCM_ANALOG_PFD_528_PFD2_CLKGATE_MASK;
        
        /*Select PLL528 PFD2 for pre_periph_clock*/
        CLOCK_SetMux(kCLOCK_PrePeriphMux, 1);             
        CLOCK_SetMux(kCLOCK_PeriphMux, 0);
