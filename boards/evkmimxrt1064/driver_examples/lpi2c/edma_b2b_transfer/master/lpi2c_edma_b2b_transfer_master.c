...
#if defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT
#if defined(LPI2C_TRANSMIT_DMAMUX_CHANNEL) && defined(LPI2C_RECEIVE_DMAMUX_CHANNEL)
    /* DMAMUX init */
    DMAMUX_Init(EXAMPLE_LPI2C_MASTER_TX_DMA_MUX);
    DMAMUX_Init(EXAMPLE_LPI2C_MASTER_RX_DMA_MUX);

    DMAMUX_SetSource(EXAMPLE_LPI2C_MASTER_TX_DMA_MUX, LPI2C_TRANSMIT_DMAMUX_CHANNEL,
                     LPI2CMASTER_TRANSMIT_EDMA_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPI2C_MASTER_TX_DMA_MUX, LPI2C_TRANSMIT_DMAMUX_CHANNEL);

    DMAMUX_SetSource(EXAMPLE_LPI2C_MASTER_RX_DMA_MUX, LPI2C_RECEIVE_DMAMUX_CHANNEL, LPI2CMASTER_RECEIVE_EDMA_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPI2C_MASTER_RX_DMA_MUX, LPI2C_RECEIVE_DMAMUX_CHANNEL);
#else
    /* DMAMUX init */
