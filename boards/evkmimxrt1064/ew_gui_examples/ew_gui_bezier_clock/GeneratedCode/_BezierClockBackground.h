...
#ifndef _BezierClockBackground_H
#define _BezierClockBackground_H
...
/* Forward declaration of the class BezierClock::Background */
#ifndef _BezierClockBackground_
  EW_DECLARE_CLASS( BezierClockBackground )
#define _BezierClockBackground_
#endif
...
/* Deklaration of class : 'BezierClock::Background' */
EW_DEFINE_FIELDS( BezierClockBackground, CoreGroup )
  EW_OBJECT  ( BubbleEffect1,   EffectsFloatEffect )
  EW_OBJECT  ( BubbleEffect2,   EffectsFloatEffect )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Background,      ViewsImage )
  EW_OBJECT  ( Bubble,          BezierClockBubble )
  EW_OBJECT  ( ShiftEffect,     EffectsPointEffect )
  EW_PROPERTY( CurrentBackground, XInt32 )
EW_END_OF_FIELDS( BezierClockBackground )

/* Virtual Method Table (VMT) for the class : 'BezierClock::Background' */
EW_DEFINE_METHODS( BezierClockBackground, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( BezierClockBackground _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( BezierClockBackground _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( BezierClockBackground )
...
#endif /* _BezierClockBackground_H */
