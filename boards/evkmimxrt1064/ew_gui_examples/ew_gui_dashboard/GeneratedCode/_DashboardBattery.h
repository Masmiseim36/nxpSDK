...
EW_DEFINE_FIELDS( DashboardBattery, TemplatesHorizontalValueBar )
  ...
  EW_OBJECT  ( Energy1,         ViewsRectangle )
  EW_OBJECT  ( Energy2,         ViewsRectangle )
  EW_OBJECT  ( Energy3,         ViewsRectangle )
  EW_OBJECT  ( Energy4,         ViewsRectangle )
  EW_OBJECT  ( Energy5,         ViewsRectangle )
