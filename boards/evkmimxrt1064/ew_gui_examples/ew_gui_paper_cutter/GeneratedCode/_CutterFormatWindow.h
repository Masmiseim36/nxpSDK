...
#ifndef _CutterFormatWindow_H
#define _CutterFormatWindow_H
...
/* Forward declaration of the class Cutter::FormatWindow */
#ifndef _CutterFormatWindow_
  EW_DECLARE_CLASS( CutterFormatWindow )
#define _CutterFormatWindow_
#endif
...
EW_DEFINE_FIELDS( CutterFormatWindow, CutterWindow )
  EW_VARIABLE( dialog,          CutterFormatDialog )
...
EW_END_OF_FIELDS( CutterFormatWindow )

/* Virtual Method Table (VMT) for the class : 'Cutter::FormatWindow' */
EW_DEFINE_METHODS( CutterFormatWindow, CutterWindow )
  ...
  EW_METHOD( FadeAnimation,     void )( CutterFormatWindow _this, XEnum aMode, XInt32 
    aValue )
EW_END_OF_METHODS( CutterFormatWindow )
