...
#ifndef _WasherTempItemL_H
#define _WasherTempItemL_H
...
/* Forward declaration of the class Washer::TempItemL */
#ifndef _WasherTempItemL_
  EW_DECLARE_CLASS( WasherTempItemL )
#define _WasherTempItemL_
#endif


/* This is a GUI component. */
EW_DEFINE_FIELDS( WasherTempItemL, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( Text,            ViewsText )
  EW_PROPERTY( Caption,         XString )
  EW_PROPERTY( ColorTop,        XColor )
  EW_PROPERTY( ColorBottom,     XColor )
EW_END_OF_FIELDS( WasherTempItemL )

/* Virtual Method Table (VMT) for the class : 'Washer::TempItemL' */
EW_DEFINE_METHODS( WasherTempItemL, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( WasherTempItemL )
