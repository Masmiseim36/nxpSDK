...
By default the demo operates as WiFi station mode and attempts connecting to AP with parameters defined by WIFI_SSID, WIFI_PASSWORD and WIFI_SECURITY.
Alternatively the demo may be run in AP mode by defining WIFI_AP_MODE to 1 and optionally adjusting other AP related parameters.
In this mode the board acts as a WiFi AP with a DHCP server. The default IP address of the board itself is 192.168.1.1.
Please note that AP mode is an experimetal feature.
