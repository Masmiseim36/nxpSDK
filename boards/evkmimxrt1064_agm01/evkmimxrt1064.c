...
/**
 * @file evkmimxrt1064.c
 * @brief The evkmimxrt1064.c file defines GPIO pins and I2C CMSIS utilities for evkmimxrt1064 board.
 */

#include "evkmimxrt1064.h"

// I2C20 Pin Handles
gpioHandleiMXSDK_t D15 = {
    .base = GPIO1, .pinNumber = 0, .mask = 1 << (0), .irq = GPIO1_Combined_0_15_IRQn, .portNumber = GPIO1_NUM};
gpioHandleiMXSDK_t D14 = {
    .base = GPIO1, .pinNumber = 1, .mask = 1 << (1), .irq = GPIO1_Combined_0_15_IRQn, .portNumber = GPIO1_NUM};

// I2C1 Pin Handles
gpioHandleiMXSDK_t A5 = {
    .base = GPIO1, .pinNumber = 16, .mask = 1 << (16), .irq = GPIO1_Combined_16_31_IRQn, .portNumber = GPIO1_NUM};
gpioHandleiMXSDK_t A4 = {
    .base = GPIO1, .pinNumber = 17, .mask = 1 << (17), .irq = GPIO1_Combined_16_31_IRQn, .portNumber = GPIO1_NUM};
...
gpioHandleiMXSDK_t D12 = {
    .base = GPIO3, .pinNumber = 15, .mask = 1 << (15), .irq = GPIO3_Combined_0_15_IRQn, .portNumber = GPIO3_NUM};
gpioHandleiMXSDK_t D11 = {
    .base = GPIO3, .pinNumber = 14, .mask = 1 << (14), .irq = GPIO3_Combined_0_15_IRQn, .portNumber = GPIO3_NUM};
...
gpioHandleiMXSDK_t D0 = {
    .base = GPIO1, .pinNumber = 23, .mask = 1 << (23), .irq = GPIO1_Combined_16_31_IRQn, .portNumber = GPIO1_NUM};
gpioHandleiMXSDK_t D1 = {
    .base = GPIO1, .pinNumber = 22, .mask = 1 << (22), .irq = GPIO1_Combined_16_31_IRQn, .portNumber = GPIO1_NUM};

// EVKMIMXRT1064 Arduino Connector Pin Defintion
...
// i.MXRT1064 EVK Combo Sensor Pin Definitions
