...
void WatchdogEnable(void)
{
    ...
    __asm("cpsid i");
    /* RT1160 has RTWDOG 3,4 - they are enabled by default and second one (RTWDOG4) is unused thus must be disabled*/
    /* RTWDOG 4 */
...
{
    __asm("cpsid i");
    /* RT60 has RTWDOG 3,4 - they are enabled by default and second one (RTWDOG4) is unused thus must be disabled*/
    /* RTWDOG 4 */
    if ((RTWDOG4->CS & RTWDOG_CS_CMD32EN_MASK) != 0U)
    {
        RTWDOG4->CNT = 0xD928C520U; /* 0xD928C520U is the update key */
