...
Jumper settings for RT1160-EVK (enables external 5V supply):
remove  J38 5-6
connect J38 1-2
...
The hardware should be reworked according to the Hardware Rework Guide for MIMXRT1160-EVK and Murata 1XK M.2 Adapter in document Hardware Rework Guide for EdgeFast BT PAL.
The hardware should be reworked according to the Hardware Rework Guide for MIMXRT1160-EVK and Murata 1ZM M.2 Adapter in document Hardware Rework Guide for EdgeFast BT PAL.
