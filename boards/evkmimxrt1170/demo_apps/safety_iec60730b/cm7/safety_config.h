...
#define SYSTICK_RELOAD_VALUE  996000    /* 996MHz/996kHz = 1ms period */ // TODO: BUG in SDK/RM, core_clock.c says that Systick runs at 10kHz, but this value is 996 MHz
...
#define REFRESH_INDEX         FS_IMXRTWDOG
#define CLEAR_FLAG            1
...
#define FS_CFG_AIO_CHANNELS_INIT {0x01U, 0x03U, 0x02U}  /* ADC Channels for V_refl, V_refh, bandgap */
/********* ADC END *********/
