...
EW_DEFINE_CLASS( ViewsLine, CoreLineView, _None, _None, _None, _None, _None, _None, 
                 "Views::Line" )
...
/* 'C' function for method : 'Views::Rectangle.OnGetColor()' */
...
/* 'C' function for method : 'Views::WarpImage.OnSetOpacity()' */
void ViewsWarpImage_OnSetOpacity( ViewsWarpImage _this, XInt32 value )
{
  if ( value > 255 )
    value = 255;
...
/* 'C' function for method : 'Views::FillPath.OnSetColorBL()' */
void ViewsFillPath_OnSetColorBL( ViewsFillPath _this, XColor value )
{
...
/* 'C' function for method : 'Views::FillPath.OnSetColorBR()' */
void ViewsFillPath_OnSetColorBR( ViewsFillPath _this, XColor value )
{
...
/* 'C' function for method : 'Views::FillPath.OnSetColorTR()' */
void ViewsFillPath_OnSetColorTR( ViewsFillPath _this, XColor value )
{
...
/* 'C' function for method : 'Views::FillPath.OnSetColorTL()' */
void ViewsFillPath_OnSetColorTL( ViewsFillPath _this, XColor value )
{
...
/* 'C' function for method : 'Views::FillPath.OnSetFlipY()' */
void ViewsFillPath_OnSetFlipY( ViewsFillPath _this, XBool value )
{
...
/* 'C' function for method : 'Views::FillPath.OnSetVisible()' */
void ViewsFillPath_OnSetVisible( ViewsFillPath _this, XBool value )
{
  if ( value )
    CoreView__ChangeViewState( _this, CoreViewStateVisible, 0 );
  else
...
/* 'C' function for method : 'Views::StrokePath.OnSetColorBL()' */
void ViewsStrokePath_OnSetColorBL( ViewsStrokePath _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorBL ))
    return;
...
/* 'C' function for method : 'Views::StrokePath.OnSetColorBR()' */
void ViewsStrokePath_OnSetColorBR( ViewsStrokePath _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorBR ))
    return;
...
/* 'C' function for method : 'Views::StrokePath.OnSetColorTR()' */
void ViewsStrokePath_OnSetColorTR( ViewsStrokePath _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorTR ))
    return;
...
/* 'C' function for method : 'Views::StrokePath.OnSetColorTL()' */
void ViewsStrokePath_OnSetColorTL( ViewsStrokePath _this, XColor value )
{
  if ( !EwCompColor( value, _this->ColorTL ))
    return;
