...
#ifndef _OximeterPulseSettings_H
#define _OximeterPulseSettings_H
...
/* Deklaration of class : 'Oximeter::PulseSettings' */
EW_DEFINE_FIELDS( OximeterPulseSettings, CoreGroup )
...
EW_END_OF_FIELDS( OximeterPulseSettings )

/* Virtual Method Table (VMT) for the class : 'Oximeter::PulseSettings' */
EW_DEFINE_METHODS( OximeterPulseSettings, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( OximeterPulseSettings _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( CoreGroup _this, XSet aState )
  EW_METHOD( InvalidateArea,    void )( CoreGroup _this, XRect aArea )
EW_END_OF_METHODS( OximeterPulseSettings )
...
#endif /* _OximeterPulseSettings_H */
