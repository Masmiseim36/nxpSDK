...
- pin_list:
  ...
  - {pin_num: M15, peripheral: LPUART1, signal: RXD, pin_signal: GPIO_AD_25, software_input_on: Enable, pull_keeper_select: Keeper}
  ...
  - {pin_num: D15, peripheral: USDHC1, signal: usdhc_clk, pin_signal: GPIO_SD_B1_01, software_input_on: Enable, pull_down_pull_up_config: Pull_Up}
  ...
  - {pin_num: A6, peripheral: LPUART2, signal: RXD, pin_signal: GPIO_DISP_B2_11, pull_up_down_config: Pull_Up, pull_keeper_select: Keeper}
  - {pin_num: D9, peripheral: LPUART2, signal: TXD, pin_signal: GPIO_DISP_B2_10, pull_keeper_select: Keeper}
  ...
  - {pin_num: J16, peripheral: GPIO10, signal: 'gpio_io, 01', pin_signal: GPIO_AD_34, direction: OUTPUT, gpio_init_state: 'true', pull_up_down_config: Pull_Up}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of WL_REG_ON on GPIO_AD_31 (pin J17) */
  ...
  GPIO_PinInit(GPIO9, 30U, &WL_REG_ON_config);

  /* GPIO configuration of SD1_VSELECT on GPIO_AD_34 (pin J16) */
  gpio_pin_config_t SD1_VSELECT_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_AD_34 (pin J16) */
  GPIO_PinInit(GPIO10, 1U, &SD1_VSELECT_config);
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_34_GPIO10_IO01,          /* GPIO_AD_34 is configured as GPIO10_IO01 */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
  ...
  IOMUXC_SetPinConfig(
      ...
      0x02U);                                 /* Slew Rate Field: Slow Slew Rate
                                                 ...
                                                 Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_34_GPIO10_IO01,          /* GPIO_AD_34 PAD functional properties : */
