...
enum FlexspiPad
{
    FLEXSPI_1PAD = 0x00U, // Transmit command/address and transmit/receive data only through DATA0/DATA1.
    FLEXSPI_2PAD = 0x01U, // Transmit command/address and transmit/receive data only through DATA[1:0].
    FLEXSPI_4PAD = 0x02U, // Transmit command/address and transmit/receive data only through DATA[3:0].
    FLEXSPI_8PAD = 0x03U, // Transmit command/address and transmit/receive data only through DATA[7:0].
};
...
typedef struct _FlexSPIConfig
{
    ...
    uint8_t serialClkFreq;           //!< [0x046-0x046] Serial Flash Frequency, device specific definitions, See System Boot  Chapter for more details
