...
- name: BOARD_InitPeripherals
  UUID: 43980c8d-7a82-4128-bb51-a990239d85c3
  ...
  - fsl_qtmr:
    ...
    - qtmr_channels:
      - 0:
        ...
        - primarySource: 'kQTMR_ClockDivide_16'
        ...
        - interrupts: 'kQTMR_Compare1InterruptEnable'
    - interruptVector:
      - enable_irq: 'true'
      - interrupt:
        - IRQn: 'TMR5_IRQn'
...
static void TIMER_init(void) {
  ...
  QTMR_SetTimerPeriod(TIMER_PERIPHERAL, TIMER_CHANNEL_0_CHANNEL, 165U);
  /* Enable interrupt requests of the timer channel */
  QTMR_EnableInterrupts(TIMER_PERIPHERAL, TIMER_CHANNEL_0_CHANNEL, kQTMR_Compare1InterruptEnable);
  /* Enable interrupt TMR5_IRQn request in the NVIC. */
