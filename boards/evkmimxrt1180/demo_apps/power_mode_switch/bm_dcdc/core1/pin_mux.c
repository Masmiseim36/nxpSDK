...
- pin_list:
  - {pin_num: D5, peripheral: LPUART12, signal: TXD, pin_signal: GPIO_AON_19, pull_up_down_config: Pull_Down, pull_keeper_select: Keeper, open_drain: Disable, drive_strength: High,
    slew_rate: Slow}
  - {pin_num: E5, peripheral: LPUART12, signal: RXD, pin_signal: GPIO_AON_20, pull_up_down_config: Pull_Down, pull_keeper_select: Keeper, open_drain: Disable, drive_strength: High,
    slew_rate: Slow}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
