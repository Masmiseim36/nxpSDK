...
Running the demo
================
When the example runs successfully, the following message will display in the terminal:
...
Note:
      If the command 'led x on'/'led x off' run success, the corresponding LEDx on board will turn on/turn off.
