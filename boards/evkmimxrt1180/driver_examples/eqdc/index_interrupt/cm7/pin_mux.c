...
void BOARD_InitPins(void) {
  ...
  BLK_CTRL_WAKEUPMIX->XBAR_DIR_CTRL1 = ((BLK_CTRL_WAKEUPMIX->XBAR_DIR_CTRL1 &
    (~(BLK_CTRL_WAKEUPMIX_XBAR_DIR_CTRL1_IOMUXC_XBAR_DIR_SEL_18_MASK | BLK_CTRL_WAKEUPMIX_XBAR_DIR_CTRL1_IOMUXC_XBAR_DIR_SEL_20_MASK | BLK_CTRL_WAKEUPMIX_XBAR_DIR_CTRL1_IOMUXC_XBAR_DIR_SEL_22_MASK))) /* Mask bits to zero which are setting */
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_SD_B1_00_XBAR1_XBAR_INOUT20,  /* GPIO_SD_B1_00 is configured as XBAR1_XBAR_INOUT20 */
      1U);                                    /* Software Input On Field: Force input path of pad GPIO_SD_B1_00 */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_SD_B1_02_XBAR1_XBAR_INOUT22,  /* GPIO_SD_B1_02 is configured as XBAR1_XBAR_INOUT22 */
