...
- pin_list:
  - {pin_num: M16, peripheral: FLEXIO2, signal: 'IO, 27', pin_signal: GPIO_AD_27, open_drain: no_init}
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_27_FLEXIO2_FLEXIO27,     /* GPIO_AD_27 is configured as FLEXIO2_FLEXIO27 */
