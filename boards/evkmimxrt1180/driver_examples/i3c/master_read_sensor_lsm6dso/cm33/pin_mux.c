...
- pin_list:
  ...
  - {pin_num: B1, peripheral: LPUART1, signal: TXD, pin_signal: GPIO_AON_08, pull_up_down_config: Pull_Down, pull_keeper_select: Keeper, open_drain: Disable, drive_strength: High,
    slew_rate: Slow}
  - {pin_num: K16, peripheral: I3C2, signal: i3c_scl, pin_signal: GPIO_AD_18, software_input_on: Enable, pull_up_down_config: Pull_Up}
  - {pin_num: L13, peripheral: I3C2, signal: i3c_sda, pin_signal: GPIO_AD_19, software_input_on: Enable, pull_up_down_config: Pull_Up}
  - {pin_num: M17, peripheral: I3C2, signal: i3c_pur, pin_signal: GPIO_AD_17, pull_keeper_select: Pull}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_17_I3C2_PUR,             /* GPIO_AD_17 PAD functional properties : */
  ...
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_18_I3C2_SCL,             /* GPIO_AD_18 PAD functional properties : */
      0x0EU);                                 /* Slew Rate Field: Fast Slew Rate
                                                 ...
                                                 Force ibe off Field: Disabled */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_19_I3C2_SDA,             /* GPIO_AD_19 PAD functional properties : */
      0x0EU);                                 /* Slew Rate Field: Fast Slew Rate
                                                 Drive Strength Field: high driver
                                                 Pull / Keep Select Field: Pull Enable
                                                 Pull Up / Down Config. Field: Weak pull up
