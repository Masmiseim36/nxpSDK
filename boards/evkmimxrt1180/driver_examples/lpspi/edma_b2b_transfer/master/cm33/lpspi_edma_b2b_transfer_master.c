...
#if defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT
#if defined(EXAMPLE_LPSPI_MASTER_DMAMUX_TX_CHANNEL) && defined(EXAMPLE_LPSPI_MASTER_DMAMUX_RX_CHANNEL)
    /* DMA MUX init*/
    DMAMUX_Init(EXAMPLE_LPSPI_RX_MASTER_DMA_MUX_BASE);

    DMAMUX_SetSource(EXAMPLE_LPSPI_RX_MASTER_DMA_MUX_BASE, EXAMPLE_LPSPI_MASTER_DMAMUX_RX_CHANNEL,
                     EXAMPLE_LPSPI_MASTER_DMA_RX_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPSPI_RX_MASTER_DMA_MUX_BASE, EXAMPLE_LPSPI_MASTER_DMAMUX_RX_CHANNEL);

    DMAMUX_Init(EXAMPLE_LPSPI_TX_MASTER_DMA_MUX_BASE);

    DMAMUX_SetSource(EXAMPLE_LPSPI_TX_MASTER_DMA_MUX_BASE, EXAMPLE_LPSPI_MASTER_DMAMUX_TX_CHANNEL,
                     EXAMPLE_LPSPI_MASTER_DMA_TX_REQUEST_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_LPSPI_TX_MASTER_DMA_MUX_BASE, EXAMPLE_LPSPI_MASTER_DMAMUX_TX_CHANNEL);
#else
    /* DMA MUX init*/
