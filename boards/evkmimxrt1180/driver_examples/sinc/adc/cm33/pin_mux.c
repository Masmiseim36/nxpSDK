...
- pin_list:
  ...
  - {pin_num: B1, peripheral: LPUART1, signal: TXD, pin_signal: GPIO_AON_08, pull_up_down_config: Pull_Down, pull_keeper_select: Keeper, open_drain: Disable, drive_strength: High,
    slew_rate: Slow}
  - {pin_num: J17, peripheral: SINC2, signal: 'EMCLK, 3', pin_signal: GPIO_AD_32, pull_keeper_select: Pull}
  - {pin_num: H17, peripheral: SINC2, signal: 'MOD_CLK, 0', pin_signal: GPIO_AD_35, pull_keeper_select: Pull}
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      ...
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_32_SINC2_EMCLK03,        /* GPIO_AD_32 PAD functional properties : */
  ...
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_35_SINC2_MOD_CLK0,       /* GPIO_AD_35 PAD functional properties : */
      0x06U);                                 /* Slew Rate Field: Fast Slew Rate
                                                 Drive Strength Field: high driver
                                                 Pull / Keep Select Field: Pull Enable
                                                 Pull Up / Down Config. Field: Weak pull down
