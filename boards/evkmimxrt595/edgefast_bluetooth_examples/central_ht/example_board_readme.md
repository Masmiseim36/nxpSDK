...
The hardware should be reworked according to the Hardware Rework Guide for Low Power Feature on MIMXRT595-EVK and Murata 1XK M.2 Module in document Hardware Rework Guide for EdgeFast BT PAL.
The hardware should be reworked according to the Hardware Rework Guide for Low Power Feature on MIMXRT595-EVK and Murata 2EL M.2 Module in document Hardware Rework Guide for EdgeFast BT PAL.
