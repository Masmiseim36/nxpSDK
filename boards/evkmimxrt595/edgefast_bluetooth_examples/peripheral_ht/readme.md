...
Low power feature is supported for Murata 1XK M.2. Please set APP_LOWPOWER_ENABLED as 1 in the app_bluetooth_config.h to enable low power feature.
The hardware should be reworked according to the Hardware Rework Guide for Low Power Feature on MIMXRT595-EVK with Direct Murata 1XK M.2 Module in document Hardware Rework Guide for EdgeFast BT PAL.
