...
void USB_DeviceCalculateFeedback(void)
{
    ...
    if (audioSpeakerUsedSpace <=
        (g_deviceComposite->audioUnified.audioPlayTransferSize * USB_AUDIO_PLAY_BUFFER_TOLERANCE_THRESHOLD))
    {
        ...
        case USB_DEVICE_AUDIO_CUR_REQUEST:
            switch (controlSelector)
            {
                case USB_DEVICE_AUDIO_TE_COPY_PROTECT_CONTROL:
                    ...
                    {
                        return kStatus_USB_InvalidRequest; /* Input Terminals only support the Get Terminal Copy Protect Control
                                                     request */
                    }
                    break;
        ...
        case USB_DEVICE_AUDIO_CUR_REQUEST:
            switch (controlSelector)
            {
                case USB_DEVICE_AUDIO_TE_COPY_PROTECT_CONTROL:
                    ...
                    {
                        return kStatus_USB_InvalidRequest; /* Output Terminals only support the Set Terminal Copy Protect Control
                                                     request */
                    }
                    break;
                default:
