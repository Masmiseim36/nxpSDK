...
int main(void)
{
    ...
    /* FLEXCOMM12 */
    RESET_ClearPeripheralReset(kFC12_RST_SHIFT_RSTn);
    /* attach FRG12 clock to FLEXCOMM12 */
    const clock_frg_clk_config_t clk_cfg = {12, kCLOCK_FrgPllDiv, 255U, 0}; /*!< Select FRG12 mux as frg_pll */
    CLOCK_SetFRGClock(&clk_cfg);
    CLOCK_AttachClk(kFRG_to_FLEXCOMM12);
    DbgConsole_Init(12U, BOARD_DEBUG_UART_BAUDRATE, BOARD_DEBUG_UART_TYPE, CLOCK_GetFlexcommClkFreq(12U));
