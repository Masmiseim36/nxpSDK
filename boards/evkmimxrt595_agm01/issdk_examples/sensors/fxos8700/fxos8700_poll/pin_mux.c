...
- pin_list:
  - {pin_num: P10, peripheral: FLEXCOMM11, signal: TXD_SCL_MISO, pin_signal: PIO4_21/DBI_DSX/SD1_D7/FC11_TXD_SCL_MISO/FLEXIO_D1, identifier: '', ibena: enabled, drive: full,
    odena: enabled}
  - {pin_num: U10, peripheral: FLEXCOMM11, signal: RXD_SDA_MOSI, pin_signal: PIO4_22/SD1_CARD_DET_N/FC11_RXD_SDA_MOSI/FLEXIO_D2, identifier: '', ibena: enabled, drive: full,
    odena: enabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void SPI5_DeinitPins(void)
{
    ...
    const uint32_t SPI_CLK = (/* Pin is configured as PIO1_3 */
                              IOPCTL_PIO_FUNC0 |
                              /* Disable pull-up / pull-down function */
                              IOPCTL_PIO_PUPD_DI |
                              /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, SPI5_DEINITPINS_SPI_CLK_PORT, SPI5_DEINITPINS_SPI_CLK_PIN, SPI_CLK);

    const uint32_t SPI_MISO = (/* Pin is configured as PIO1_4 */
                               IOPCTL_PIO_FUNC0 |
                               /* Disable pull-up / pull-down function */
                               IOPCTL_PIO_PUPD_DI |
                               /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, SPI5_DEINITPINS_SPI_MISO_PORT, SPI5_DEINITPINS_SPI_MISO_PIN, SPI_MISO);

    const uint32_t SPI_MOSI = (/* Pin is configured as PIO1_5 */
                               IOPCTL_PIO_FUNC0 |
                               /* Disable pull-up / pull-down function */
                               IOPCTL_PIO_PUPD_DI |
                               /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, SPI5_DEINITPINS_SPI_MOSI_PORT, SPI5_DEINITPINS_SPI_MOSI_PIN, SPI_MOSI);

    const uint32_t SPI_SS0 = (/* Pin is configured as PIO1_6 */
                              IOPCTL_PIO_FUNC0 |
                              /* Disable pull-up / pull-down function */
                              IOPCTL_PIO_PUPD_DI |
                              /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, SPI5_DEINITPINS_SPI_SS0_PORT, SPI5_DEINITPINS_SPI_SS0_PIN, SPI_SS0);
}
...
void USART0_DeinitPins(void)
{
    ...
    const uint32_t DEBUG_UART_TXD = (/* Pin is configured as PIO0_1 */
                                     IOPCTL_PIO_FUNC0 |
                                     /* Disable pull-up / pull-down function */
                                     IOPCTL_PIO_PUPD_DI |
                                     /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, USART0_DEINITPINS_DEBUG_UART_TXD_PORT, USART0_DEINITPINS_DEBUG_UART_TXD_PIN, DEBUG_UART_TXD);

    const uint32_t DEBUG_UART_RX = (/* Pin is configured as PIO0_2 */
                                    IOPCTL_PIO_FUNC0 |
                                    /* Disable pull-up / pull-down function */
                                    IOPCTL_PIO_PUPD_DI |
                                    /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, USART0_DEINITPINS_DEBUG_UART_RX_PORT, USART0_DEINITPINS_DEBUG_UART_RX_PIN, DEBUG_UART_RX);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
