...
int lenet_process(ml_lenet_t *handle, unsigned char *output)
{
    ...
    // LAYER 2 RELU
#ifdef OPTIMIZE_ASYNC
    xa_nn_vec_relu_f32_f32_async(nn_cb, handle->queue,
#else
    xa_nn_vec_relu_f32_f32(
#endif
                                 handle->p_buffer0, // OUTPUT
                                 handle->p_buffer1, // INPUT
                                 relu_threshold, layer2_relu_size);
    ...
    xa_nn_vec_relu_f32_f32(
                                 ...
                                 handle->p_buffer1, // OUTPUT
                                 handle->p_buffer0, // INPUT
                                 relu_threshold, layer5_relu_size);
    ...
    xa_nn_vec_relu_f32_f32(
                                 ...
                                 handle->p_buffer0, // OUTPUT
                                 handle->p_buffer1, // INPUT
                                 relu_threshold, layer8_relu_size);
