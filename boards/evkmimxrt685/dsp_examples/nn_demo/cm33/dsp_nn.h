...
signed int xa_nn_vec_relu_32_32(signed int *p_out,
                                const signed int *p_vec,
                                signed int threshold,
                                signed int vec_length);
#endif
...
signed int xa_nn_conv2d_depthwise_asym8xasym8(punsigned char p_out,
                                              const unsigned char *p_kernel,
                                              const unsigned char *p_inp,
                                              const signed int *p_bias,
                                              signed int input_height,
...
void xa_nn_conv2d_pointwise_asym8xasym8_async(void (*cb)(void *, srtm_message *msg),
                                              void *params,
                                              punsigned char p_out,
                                              punsigned char p_kernel,
                                              punsigned char p_inp,
                                              signed int *p_bias,
                                              signed int input_height,
                                              signed int input_width,
                                              signed int input_channels,
...
signed int xa_nn_conv2d_pointwise_asym8xasym8(punsigned char p_out,
                                              punsigned char p_kernel,
                                              punsigned char p_inp,
                                              signed int *p_bias,
                                              signed int input_height,
...
signed int xa_nn_fully_connected_asym8xasym8_asym8(punsigned char p_out,
                                                   const unsigned char *p_weight,
                                                   const unsigned char *p_inp,
                                                   const signed int *p_bias,
                                                   signed int weight_depth,
