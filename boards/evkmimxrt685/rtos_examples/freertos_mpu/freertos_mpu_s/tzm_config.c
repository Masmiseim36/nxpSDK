...
/* Region end address */
    ...
    /* Mask Pins RxD and TXD for FLEXCOMM0 to avoid information leakage from UART pins to normal world */
    AHB_SECURE_CTRL->SEC_GPIO_MASK0 =
        AHB_SECURE_CTRL->SEC_GPIO_MASK0 & ~(AHB_SECURE_CTRL_SEC_GPIO_MASK0_PIO0_PIN1_SEC_MASK_MASK |
