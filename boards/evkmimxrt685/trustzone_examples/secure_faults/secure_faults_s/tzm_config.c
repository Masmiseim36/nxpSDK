...
- ahb:
  - regions:
    ...
    - relative_region: {memory: SRAM, security: ns_user, start: '0x00040000', size: '0x00070000'}
    - relative_region: {memory: SRAM, security: s_priv, start: '0x000B0000', size: '0x00050000'}
