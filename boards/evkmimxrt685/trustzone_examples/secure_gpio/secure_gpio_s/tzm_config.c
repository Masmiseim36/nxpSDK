...
#define SAU_REGION_2_BASE 0x20180000U
#define SAU_REGION_2_END  0x201FFFFFU
#define SAU_REGION_3_BASE 0x40000000U
#define SAU_REGION_3_END  0x401FFFFFU
  ...
  - peripherals:
    - ns_user:
      - !!seq:id [ADC0, CASPER, CMP, CRC_ENGINE, CTIMER0, CTIMER1, CTIMER2, CTIMER3, CTIMER4, DMA0, DMA1, DMIC0, FLEXCOMM1, FLEXCOMM14, FLEXCOMM15, FLEXCOMM2, FLEXCOMM3,
        ...
        SCT0, SEMA42, TRNG, USBHSD, USBHSH, USBPHY, USDHC0, USDHC1, UTICK0, WWDT0, WWDT1]
    - s_priv:
      - !!seq:id [CLKCTL0, CLKCTL1, FLEXCOMM0, IOPCTL, RSTCTL0, RSTCTL1, SECGPIO, SYSCTL0, SYSCTL1]
  - interrupts:
    - masking:
      - Non-masked:
...
- sau:
  ...
  - regions:
    ...
    - region: {index: '2', enabled: 'true', security: ns, start: '0x20180000', size: '0x00080000'}
    - region: {index: '3', enabled: 'true', security: ns, start: '0x40000000', size: '0x00200000'}
...
void BOARD_InitTrustZone()
{
    ...
    */
    ...
    AHB_SECURE_CTRL->AHB_PERIPH3_SLAVE_RULE0  = 0x00003000U;
