 ...
 * Copyright 2016-2018 NXP, Not a Contribution.
 *
...
typedef struct _nghttp2_con_info
{
    uint16_t serverPort;
    const char *serverScheme;
    const char *serverName;
    const char *serverPagePath;
    const char *serverAuthority;
    TLSDataParams tlsDataParams;
} nghttp2_con_info_t;

typedef struct _nghttp2_user_session
{
    nghttp2_con_info_t con;
    nghttp2_session *nghttp2Session;
    void *user_data;
} nghttp2_user_session_t;
