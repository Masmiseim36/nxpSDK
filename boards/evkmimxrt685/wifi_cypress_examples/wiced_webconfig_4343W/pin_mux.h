...
/*! @name PIO2_12 (coord T3), J1[4]
  @{ */
#define BOARD_INITPINS_OSPI_RESET_GPIO GPIO                          /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_OSPI_RESET_PORT 2U                            /*!<@brief PORT device name: 2U */
#define BOARD_INITPINS_OSPI_RESET_PIN 12U                            /*!<@brief 2U pin index: 12 */
                                                                     /* @} */
