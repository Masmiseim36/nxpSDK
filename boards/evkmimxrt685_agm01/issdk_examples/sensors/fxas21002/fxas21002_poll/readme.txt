...
- EVKMIMXRT685 board with easy access to MCU input/output through Arduino™ R3 compatible I/O connectors
...
On MIMXRT685-EVK board:
--------------------------------------
Ensure VDDIO_1 is 3.3V (JP12 2-3 connected).

Demo Overview
============
The FXAS21002 poll example application demonstrates the use of the FXAS21002 sensor in the Poll (Non-Buffered) Mode.
