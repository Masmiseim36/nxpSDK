...
// PARAMETERS
#define ParametersPp 						(4.0F)
#define ParametersRs 						(0.54F)
#define ParametersLd 						(0.0003356F)
#define ParametersLq 						(0.000218F)
#define ParametersKt 						(0.05477461F)
...
#define ParametersUdcbUnder 				(16.0F)
#define ParametersUdcbOver 					(30.0F)
#define ParametersNover 					(4399.0F)
...
#define ParametersFaultDuration 			(6.0F)
...
#define ParametersScalarVHzRatio 			(100.0F)


// CURRENT LOOP PARAMETERS	
#define CurrentLoopSampleTime				(0.0000625F)
#define CurrentLoopF0						(1000.0F)
#define CurrentLoopKsi						(1.0F)
#define CurrentLoopOutputLimit				(90.0F)
		
		
// SPEED LOOP PARAMETERS	
#define SpeedLoopSampleTime 				(0.001F)
#define SpeedLoopF0 						(10.0F)
#define SpeedLoopKsi 						(1.0F)
#define SpeedLoopIncUp 						(5000.0F)
...
#define PositionLoopSampleTime 				(0.001F)
#define PositionLoopF0 						(20.0F)
#define PositionLoopKsi 					(1.0F)
#define Servo_positionLoopUpperLimit 		(3000.0F)
#define Servo_positionLoopLowerLimit 		(-3000.0F)
#define Servo_speedLoopUpperLimit 			(4.0F)
#define Servo_speedLoopLowerLimit 			(-4.0F)
	
	
// SENSORLESS PARAMETERS	
#define SensorlessBemfObsrvF0 				(300.0F)
#define SensorlessBemfObsrvKsi 				(1.0F)
#define SensorlessTrackObsrvF0 				(70.0F)
#define SensorlessTrackObsrvKsi 			(1.0F)
#define SensorlessTrackObsrvIIRSpeedCutOff 	(400.0F)
#define SensorlessStartupRamp 				(3000.0F)
#define SensorlessStartupCurrent 			(0.65F)
