...
void M1_InitSinc(void)
{
    ...
    SINCBase->CHANNEL[0].CCFR = SINC_CCFR_ITLVL(0U) | SINC_CCFR_IBSEL(0U) | SINC_CCFR_IBFMT(0U) | SINC_CCFR_ICESEL(2U) | SINC_CCFR_FIFOWMK(0U) | SINC_CCFR_RDFMT(1U) | SINC_CCFR_PFSFT(0x14U) | SINC_CCFR_ICSEL(1U) | SINC_CCFR_ITSEL(1U); /* MCLK_OUT1 clock output with internal loopback, HW trigger conversion */
    SINCBase->CHANNEL[1].CCFR = SINC_CCFR_ITLVL(0U) | SINC_CCFR_IBSEL(0U) | SINC_CCFR_IBFMT(0U) | SINC_CCFR_ICESEL(2U) | SINC_CCFR_FIFOWMK(0U) | SINC_CCFR_RDFMT(0U) | SINC_CCFR_PFSFT(0x14U) | SINC_CCFR_ICSEL(7U) | SINC_CCFR_ITSEL(3U); /* Tie the clock internally to adjacent channel, grouped trigger shared with adjacent channel */
