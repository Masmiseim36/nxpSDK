...
app_ver_t g_sAppIdFM = {
    "../../../examples/_boards/frdmimxrt1186/demo_apps/mc_pmsm/pmsm_servo_dual/cm7",         /* User Path 1- the highest priority */
    "../../../boards/frdmimxrt1186/demo_apps/mc_pmsm/pmsm_servo_dual/cm7",       /* User Path 2 */
...
int main(void)
{
    ...
    /* Enable target USER_LED */
    RGPIO_PinWrite(BOARD_INITPINS_TP_J3_18_GPIO, BOARD_INITPINS_TP_J3_18_GPIO_PIN, 1); 
    BOARD_INITPINS_TP_J3_18_GPIO->PDDR |= (1U << BOARD_INITPINS_TP_J3_18_GPIO_PIN);                        
...
RAM_FUNC_LIB
void SINC2_CH1_IRQHandler(void)
{
