...
#if defined(FSL_FEATURE_SOC_DMAMUX_COUNT) && FSL_FEATURE_SOC_DMAMUX_COUNT
#if defined(FLEXIO_SPI_TX_DMAMUX_LPSPI_CHANNEL) && defined(FLEXIO_SPI_RX_DMAMUX_LPSPI_CHANNEL)
    /*Init DMAMUX */
    DMAMUX_Init(EXAMPLE_FLEXIO_SPI_TX_DMAMUX_BASEADDR);
    DMAMUX_Init(EXAMPLE_FLEXIO_SPI_RX_DMAMUX_BASEADDR);
    /* Set channel for FLEXIO */
    DMAMUX_SetSource(EXAMPLE_FLEXIO_SPI_TX_DMAMUX_BASEADDR, FLEXIO_SPI_TX_DMAMUX_LPSPI_CHANNEL, EXAMPLE_TX_DMA_SOURCE);
    DMAMUX_SetSource(EXAMPLE_FLEXIO_SPI_RX_DMAMUX_BASEADDR, FLEXIO_SPI_RX_DMAMUX_LPSPI_CHANNEL, EXAMPLE_RX_DMA_SOURCE);
    DMAMUX_EnableChannel(EXAMPLE_FLEXIO_SPI_TX_DMAMUX_BASEADDR, FLEXIO_SPI_TX_DMAMUX_LPSPI_CHANNEL);
    DMAMUX_EnableChannel(EXAMPLE_FLEXIO_SPI_RX_DMAMUX_BASEADDR, FLEXIO_SPI_RX_DMAMUX_LPSPI_CHANNEL);
#else
    /* Init DMAMUX */
