...
/* DMA related. */
#define EXAMPLE_FLEXSPI_DMA (DMA3)

#define FLEXSPI_TX_DMA_REQUEST_SOURCE kDma3RequestMuxFlexSPI2Tx
#define FLEXSPI_RX_DMA_REQUEST_SOURCE kDma3RequestMuxFlexSPI2Rx
...
{
    /*Clock setting for flexspi21*/
    CLOCK_SetRootClockDiv(kCLOCK_Root_Flexspi2, 2);
    CLOCK_SetRootClockMux(kCLOCK_Root_Flexspi2, kCLOCK_FLEXSPI2_ClockRoot_MuxOscRc24M);
}
/*${prototype:end}*/
