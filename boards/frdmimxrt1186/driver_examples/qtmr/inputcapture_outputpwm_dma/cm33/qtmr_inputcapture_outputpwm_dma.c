...
#if defined(FSL_FEATURE_EDMA_HAS_CHANNEL_MUX) && FSL_FEATURE_EDMA_HAS_CHANNEL_MUX && defined(QTMR_EDMA_REQUEST_CAPT_SOURCE)
...
#if defined(FSL_FEATURE_EDMA_HAS_CHANNEL_MUX) && FSL_FEATURE_EDMA_HAS_CHANNEL_MUX && defined(QTMR_EDMA_REQUEST_CMPLD_SOURCE)
