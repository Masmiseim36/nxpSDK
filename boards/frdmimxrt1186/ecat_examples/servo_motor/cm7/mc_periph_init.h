 ...
 * Valid for iMXRT1186 together with FRDM-MC-LVPMSM
 *
 * Motor 1
 * Quantity     | ADC1                 | ADC2    
 *              | A         | B        | A        | B        
...
#define M1_ADC2_PH_B (N/A)
/* Phase current C assigned to ADC1 and ADC2 */
#define M1_ADC1_PH_C (N/A)
#define M1_ADC2_PH_C (5)
/* DC bus voltage assigned to ADC1 and ADC2 */
 ...
 ******************************************************************************/
#define M1_MCDRV_CURR_3PH_VOLT_DCB_INIT() (InitADC())
...
/* SENSORS - parameters moved from appconfig (not generated by MCAT after servo loops integration) */
