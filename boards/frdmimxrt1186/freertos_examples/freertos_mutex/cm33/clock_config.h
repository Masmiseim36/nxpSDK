...
#define BOARD_BOOTCLOCKRUN_ACMP_CLK_ROOT              240000000UL    /* Clock consumers of ACMP_CLK_ROOT output : CMP3 */
...
#define BOARD_BOOTCLOCKRUN_BUS_AON_CLK_ROOT           132000000UL    /* Clock consumers of BUS_AON_CLK_ROOT output : CAN1, I3C1, IOMUXC_AON, LPI2C1, LPI2C2, LPIT1, LPSPI1, LPSPI2, LPTMR1, LPUART1, LPUART2, LPUART7, LPUART8, MU2_MUA, MU2_MUB, RTWDOG1, RTWDOG2, RTWDOG3, RTWDOG4, RTWDOG5, SAI1, SEMA1, TPM1, TPM2, TSTMR1_TSTMRA */
#define BOARD_BOOTCLOCKRUN_BUS_WAKEUP_CLK_ROOT        132000000UL    /* Clock consumers of BUS_WAKEUP_CLK_ROOT output : ADC1, ADC2, AOI1, AOI2, AOI3, AOI4, CAN2, CMP3, DAC, EQDC1, EQDC2, EQDC3, EQDC4, EWM, FLEXIO1, FLEXIO2, I3C2, IOMUXC, KPP, LPI2C3, LPI2C6, LPIT2, LPIT3, LPSPI3, LPSPI4, LPSPI5, LPSPI6, LPTMR2, LPTMR3, LPUART3, LPUART4, LPUART5, LPUART6, MECC1, MECC2, MU1_MUA, MU1_MUB, PDM, PWM1, PWM2, PWM3, PWM4, RGPIO2, RGPIO3, RGPIO4, RGPIO5, RGPIO6, RTWDOG3, SAI2, SAI4, SEMA2, SINC1, SINC2, SINC3, SPDIF, TMR1, TMR2, TMR3, TMR4, TMR5, TMR6, TMR7, TMR8, TPM3, TPM4, TSTMR2_TSTMRA, USBPHY1, USDHC2, XBAR1, XBAR2, XBAR3 */
...
#define BOARD_BOOTCLOCKRUN_FLEXIO1_CLK_ROOT           48000000UL     /* Clock consumers of FLEXIO1_CLK_ROOT output : FLEXIO1 */
#define BOARD_BOOTCLOCKRUN_FLEXIO2_CLK_ROOT           48000000UL     /* Clock consumers of FLEXIO2_CLK_ROOT output : FLEXIO2 */
#define BOARD_BOOTCLOCKRUN_FLEXSPI1_CLK_ROOT          196363636UL    /* Clock consumers of FLEXSPI1_CLK_ROOT output : FLEXSPI1 */
#define BOARD_BOOTCLOCKRUN_FLEXSPI2_CLK_ROOT          98181818UL     /* Clock consumers of FLEXSPI2_CLK_ROOT output : FLEXSPI2 */
...
#define BOARD_BOOTCLOCKRUN_LPI2C0304_CLK_ROOT         60000000UL     /* Clock consumers of LPI2C0304_CLK_ROOT output : LPI2C3 */
#define BOARD_BOOTCLOCKRUN_LPI2C0506_CLK_ROOT         60000000UL     /* Clock consumers of LPI2C0506_CLK_ROOT output : LPI2C6 */
...
#define BOARD_BOOTCLOCKRUN_LPUART0910_CLK_ROOT        24000000UL     /* Clock consumers of LPUART0910_CLK_ROOT output : N/A */
#define BOARD_BOOTCLOCKRUN_LPUART1112_CLK_ROOT        24000000UL     /* Clock consumers of LPUART1112_CLK_ROOT output : N/A */
...
#define BOARD_BOOTCLOCKRUN_MAC0_CLK_ROOT              125000000UL    /* Clock consumers of MAC0_CLK_ROOT output : NETC */
...
#define BOARD_BOOTCLOCKRUN_OSC_24M                    24000000UL     /* Clock consumers of OSC_24M output : CAN1, CAN2, DAC, GPT1, GPT2, SPDIF, TMPSNS */
#define BOARD_BOOTCLOCKRUN_OSC_32K                    32768UL        /* Clock consumers of OSC_32K output : CMP3, EWM, GPT1, GPT2, KPP, LPTMR1, LPTMR2, LPTMR3, RTWDOG1, RTWDOG2, RTWDOG3, RTWDOG4, RTWDOG5, USBPHY1, USB_OTG1, USDHC2 */
...
#define BOARD_BOOTCLOCKRUN_SAI3_MCLK1                 0UL            /* Clock consumers of SAI3_MCLK1 output : N/A */
#define BOARD_BOOTCLOCKRUN_SAI3_MCLK2                 0UL            /* Clock consumers of SAI3_MCLK2 output : N/A */
#define BOARD_BOOTCLOCKRUN_SAI3_MCLK3                 0UL            /* Clock consumers of SAI3_MCLK3 output : N/A */
...
#define BOARD_BOOTCLOCKRUN_TPM5_CLK_ROOT              80000000UL     /* Clock consumers of TPM5_CLK_ROOT output : N/A */
#define BOARD_BOOTCLOCKRUN_TPM6_CLK_ROOT              80000000UL     /* Clock consumers of TPM6_CLK_ROOT output : N/A */
#define BOARD_BOOTCLOCKRUN_USDHC1_CLK_ROOT            198000000UL    /* Clock consumers of USDHC1_CLK_ROOT output : N/A */
#define BOARD_BOOTCLOCKRUN_USDHC2_CLK_ROOT            396000000UL    /* Clock consumers of USDHC2_CLK_ROOT output : USDHC2 */
#define BOARD_BOOTCLOCKRUN_WAKEUP_AXI_CLK_ROOT        240000000UL    /* Clock consumers of WAKEUP_AXI_CLK_ROOT output : DMA4, FLEXSPI1, IEE, MECC1, MECC2, USB_OTG1, USDHC2 */
