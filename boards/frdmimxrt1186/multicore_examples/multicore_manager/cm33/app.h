...
#define BUTTON_1_INIT()                                      \
    rgpio_pin_config_t sw_config = {kRGPIO_DigitalInput, 0}; \
    RGPIO_PinInit(BOARD_USER_BUTTON_GPIO, BOARD_USER_BUTTON_GPIO_PIN, &sw_config)
#define IS_BUTTON_1_PRESSED() \
    ((0U == RGPIO_PinRead(BOARD_USER_BUTTON_GPIO, BOARD_USER_BUTTON_GPIO_PIN)) && (secondary_core_started == 1))
#define BUTTON_1_NAME BOARD_USER_BUTTON_NAME

#define IS_BUTTON_2_PRESSED() \
    ((0U == RGPIO_PinRead(BOARD_USER_BUTTON_GPIO, BOARD_USER_BUTTON_GPIO_PIN)) && (secondary_core_started == 0))
