...
The FXLC95000L Accelerometer I2C example application demonstrates the use of the FXLC95000L as an Accelerometer in I2C Mode with ISF1P195K GetAccelDataWithCI is running on 32-bit ColdFire MCU.
...
--------------------------------------
For I2C Mode: The examples use I2C and Pins 3-4 of Jumpers J10 on FRDM-STBC-SA9500 should be connected.
