...
- pin_list:
  ...
  - {pin_num: N3, peripheral: VREF, signal: OUT, pin_signal: VREF_OUT/CMP1_IN5/CMP0_IN5/ADC0_SE22}
  - {pin_num: N3, peripheral: ADC0, signal: 'SE, 22', pin_signal: VREF_OUT/CMP1_IN5/CMP0_IN5/ADC0_SE22}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
