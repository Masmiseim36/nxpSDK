...
- pin_list:
  ...
  - {pin_num: A9, peripheral: GPIOC, signal: 'GPIO, 11', pin_signal: PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b/FXIO0_D19}
...
void BOARD_InitPins(void)
{
    ...
    /* PORTC11 (pin A9) is configured as PTC11 */
