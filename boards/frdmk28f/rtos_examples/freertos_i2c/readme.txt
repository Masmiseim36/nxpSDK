...
If using 1 FRDM-K28F board, you can see the similar information from the terminal as below.
...
If using 2 FRDM-K28F boards, you can see the similar information from the terminal associated with master board and slave board as below.
