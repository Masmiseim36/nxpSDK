...
For HSRUN mode which is L command, to ensure the HSRUN mode works well, the J22 jumper should be removed and 1.4V external power should be supplied via J22 pin2. 
~~~~~~~~~~~~~~~~~~~~~
