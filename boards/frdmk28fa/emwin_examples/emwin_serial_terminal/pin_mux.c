...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpioa_pinN10_config = {
    ...
    gpio_pin_config_t gpioa_pinM10_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    ...
    gpio_pin_config_t gpioa_pinK7_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    ...
    gpio_pin_config_t gpioa_pinK8_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA22 (pin K8)  */
    GPIO_PinInit(GPIOA, 22U, &gpioa_pinK8_config);
