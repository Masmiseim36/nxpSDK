...
#define BOARD_DEBUG_UART_RX_PIN 25U                   /*!<@brief PORT pin number */
#define BOARD_DEBUG_UART_RX_PIN_MASK (1U << 25U)      /*!<@brief PORT pin mask */
                                                      /* @} */
...
#define BOARD_DEBUG_UART_TX_PIN 24U                   /*!<@brief PORT pin number */
#define BOARD_DEBUG_UART_TX_PIN_MASK (1U << 24U)      /*!<@brief PORT pin mask */
                                                      /* @} */
