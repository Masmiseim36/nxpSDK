...
#define WD_RUN_TEST_CONDITION_SRS0    RCM_SRS_PIN_MASK | RCM_SRS_POR_MASK | RCM_SRS_WAKEUP_MASK | RCM_SRS_SW_MASK
#define WD_RUN_TEST_CONDITION_SRS1    RCM_SRS_SW_MASK /* unsued */
#define WD_CHECK_TEST_CONDITION       RCM_SRS_WDOG_MASK   
   
#define Watchdog_refresh              USED_WDOG->CNT = 0xB480A602

#define WD_REF_TIMER_CLOCK_FREQUENCY  32768 /*LPTMR has 32768kHz clock for WD test */

#define ENDLESS_LOOP_ENABLE           1          /* set 1 or 0 */
#define WATCHDOG_RESETS_LIMIT         1000
#define WATCHDOG_REFRESH_RATIO        10
#define WATCHDOG_TIMEOUT_VALUE        512  /* set the appropriate watchdog timeout value */
...
#define FS_CFG_AIO_CHANNELS_INIT {30, 29, 27}  /* ADC Channels for V_refl, V_refh, bandgap */
