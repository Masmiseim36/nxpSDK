...
- pin_list:
  - {pin_num: '26', peripheral: GPIOE, signal: 'GPIO, 29', pin_signal: CMP1_IN5/CMP0_IN5/ADC0_SE4B/EMVSIM0_CLK/TPM0_CH2/TPM0_CLKIN}
  - {pin_num: '28', peripheral: GPIOE, signal: 'GPIO, 31', pin_signal: EMVSIM0_VCCEN/TPM0_CH4/TPM2_CLKIN/LPI2C0_HREQ}
  ...
  - {pin_num: '76', peripheral: GPIOC, signal: 'GPIO, 4', pin_signal: LLWU_P8/LPSPI0_PCS0/LPUART1_TX/TPM0_CH3/CMP1_OUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
