...
Board settings
============
Target platform for this example is FRDM-K32L2B and OM2385/SF001. This evaluation board is designed to be pinout compatible with named FRDM-K32L2B and also with wide range of freedom boards based on Kinetis MCUs. Please refer to the SIGFOX software driver user guide for more details.
