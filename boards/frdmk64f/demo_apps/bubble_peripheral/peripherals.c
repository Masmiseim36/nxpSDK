...
void BOARD_TIMER_init(void) {
  ...
  FTM_EnableInterrupts(BOARD_TIMER_PERIPHERAL, kFTM_Chnl0InterruptEnable | kFTM_Chnl1InterruptEnable | kFTM_TimeOverflowInterruptEnable);
  /* Enable interrupt FTM0_IRQn request in the NVIC */
  EnableIRQ(BOARD_TIMER_IRQN);
}
