...
To modify content available through the web server you must complete following steps:
  1. Modify, add or delete files in folder "middleware\lwip_2.0.2\src\apps\httpsrv\mkfs\web_pages".
  2. Run the script file "middleware\lwip_2.0.2\src\apps\httpsrv\mkfs\mkfs.pl <directory name>" to generate new "httpsrv_fs_data.c".
	 For example:
		C:\sdk\middleware\lwip_2.0.2\src\apps\httpsrv\mkfs> mkfs.pl webpage
		...
		Done.
  3. Overwrite the middleware\lwip_2.0.2\src\apps\httpsrv\httpsrv_fs_data.c file by the new generated middleware\lwip_2.0.2\src\apps\httpsrv\mkfs\httpsrv_fs_data.c file.
