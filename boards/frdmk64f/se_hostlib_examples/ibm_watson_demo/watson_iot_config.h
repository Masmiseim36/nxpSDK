...
/*The org details w8ye38 which is mentioned below is obtained when we create a IBM Cloud account. Please replace
 * the Org details which is relevant the Organisation
 * ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
 * */
#define WATSONIOT_MQTT_BROKER_ENDPOINT              "1ydt2h.messaging.internetofthings.ibmcloud.com"

#define WATSONIOT_MQTT_BROKER_PORT              8883 ///< default port for MQTT/S
#define WatsonechoCLIENT_ID          "d:1ydt2h:NXP-A71CH-D:70028004012051989053" ///< MQTT client ID should be unique for every device
