...
- The A71CH on board requires Keys & certificates provosisioned for cloud connectvity demos.
  (Please consult A71CH-Kinetis-AWS Application notes / user manual for
  further details.)
