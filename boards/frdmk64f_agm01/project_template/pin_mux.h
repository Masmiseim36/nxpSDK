...
/*! @name PORTE25 (number 32), SH_J2[9]/SH_J7[1]/SH_U1[6]/SH_U2[12]/SH_I2C_SDA0/J2[18]/U8[6]
  @{ */
#define BOARD_ACCEL_SDA_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_ACCEL_SDA_PIN 25U    /*!<@brief PORTE pin index: 25 */
                                   /* @} */

/*! @name PORTE24 (number 31), SH_J2[10]/SH_J6[1]/SH_U1[4]/SH_U2[11]/SH_I2C_SCL0/J2[20]/U8[4]
  @{ */
...
/*! @name PORTC10 (number 82), SH_J10[6]/SH_J6[3]/SH_U1[4]/SH_U2[11]/SH_I2C_SCL1/J4[12]
  @{ */
#define SHIELD_I2C1_SCLK_PORT PORTC /*!<@brief PORT device name: PORTC */
#define SHIELD_I2C1_SCLK_PIN 10U    /*!<@brief PORTC pin index: 10 */
                                    /* @} */

/*! @name PORTC11 (number 83), SH_J10[5]/SH_J7[3]/SH_U1[6]/SH_U2[12]/SH_I2C_SDA1/J4[10]
  @{ */
#define SHIELD_I2C1_SDA_PORT PORTC /*!<@brief PORT device name: PORTC */
#define SHIELD_I2C1_SDA_PIN 11U    /*!<@brief PORTC pin index: 11 */
                                   /* @} */

/*! @name PORTB9 (number 57), SH_J1[3]/SH_J4[1]/SH_U1[11]/SH_INT1_8700/J1[6]
  @{ */
#define SHIELD_INT1_8700_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define SHIELD_INT1_8700_PORT PORTB /*!<@brief PORT device name: PORTB */
#define SHIELD_INT1_8700_PIN 9U     /*!<@brief PORTB pin index: 9 */
                                    /* @} */

/*! @name PORTB23 (number 69), SH_J1[5]/SH_J4[3]/SH_U1[9]/SH_INT2_8700/J1[10]
  @{ */
#define SHIELD_INT2_8700_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define SHIELD_INT2_8700_PORT PORTB /*!<@brief PORT device name: PORTB */
#define SHIELD_INT2_8700_PIN 23U    /*!<@brief PORTB pin index: 23 */
                                    /* @} */

/*! @name PORTA2 (number 36), SH_J1[6]/SH_J4[8]/SH_U2[3]/SH_INT1_21002/J1[12]/J9[6]/TRACE_SWO
  @{ */
#define SHIELD_INT1_21002_GPIO GPIOA /*!<@brief GPIO device name: GPIOA */
#define SHIELD_INT1_21002_PORT PORTA /*!<@brief PORT device name: PORTA */
#define SHIELD_INT1_21002_PIN 2U     /*!<@brief PORTA pin index: 2 */
                                     /* @} */

/*! @name PORTC12 (number 84), SH_J2[1]/SH_J4[9]/SH_U2[2]/SH_INT2_21002/J2[2]
  @{ */
#define SHIELD_INT2_21002_GPIO GPIOC /*!<@brief GPIO device name: GPIOC */
#define SHIELD_INT2_21002_PORT PORTC /*!<@brief PORT device name: PORTC */
#define SHIELD_INT2_21002_PIN 12U    /*!<@brief PORTC pin index: 12 */
                                     /* @} */
