...
#define F_1DOF_P_BASIC \
    0x0100 ///< 1DOF pressure (altitude) and temperature algorithm selector  - 0x0100 to include, 0x0000 otherwise
...
/// Use to specify zero, one or two UARTs used by control subsystem.
/// Defaults are defined in control.c if these are not defined here.
///@{
