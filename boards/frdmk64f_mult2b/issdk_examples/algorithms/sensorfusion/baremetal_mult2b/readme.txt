...
Demo Overview
============
The baremetal Sensor Fusion example for FRDM-K64F with FRDM-FXS-MULT2B sensor shield board
...
magnetometer and gyroscope sensor. The FRDM-FXS-MULT2-B sensor board also contains the
NXP MPL3115A2 Altitude and Temperature sensor.
