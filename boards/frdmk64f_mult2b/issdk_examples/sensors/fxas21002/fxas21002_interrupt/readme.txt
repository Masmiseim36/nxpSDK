...
The example demonstrates configuration of all registers required to put the sensor in Non-Buffered Mode, enable Interrupts and read out samples.
...
In order to route INT1 signal from FXAS21002 to the FRDM-K64F, Pins 1-2 of Jumper J6 on the FRDM-FXS-MULT2-B should be connected.
