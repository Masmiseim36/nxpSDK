...
In order to route INT2 signal from FXOS8700 to the FRDM-K64F, Pins 1-2 of Jumper J4 on the FRDM-FXS-MULT2-B should be connected.

Demo Overview
============
The FXOS8700 Interrupt example application demonstrates the use of the FXOS8700 sensor in interrupt mode.
