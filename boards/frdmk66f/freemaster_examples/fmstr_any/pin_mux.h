...
/* Symbols to be used with PORT driver */
#define BOARD_FTM2_CH1_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_FTM2_CH1_PIN 19U                   /*!<@brief PORT pin number */
#define BOARD_FTM2_CH1_PIN_MASK (1U << 19U)      /*!<@brief PORT pin mask */
                                                 /* @} */
