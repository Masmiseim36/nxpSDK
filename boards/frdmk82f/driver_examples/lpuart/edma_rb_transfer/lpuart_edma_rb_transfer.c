 ...
 * Definitions
 ******************************************************************************/
#define EXAMPLE_LPUART LPUART4
#define EXAMPLE_LPUART_CLKSRC kCLOCK_Osc0ErClk
#define EXAMPLE_LPUART_CLK_FREQ CLOCK_GetFreq(kCLOCK_Osc0ErClk)
#define LPUART_TX_DMA_CHANNEL 0U
#define LPUART_RX_DMA_CHANNEL 1U
#define EXAMPLE_LPUART_DMAMUX_BASEADDR DMAMUX0
#define EXAMPLE_LPUART_DMA_BASEADDR DMA0
#define LPUART_TX_DMA_REQUEST kDmaRequestMux0LPUART4Tx
#define LPUART_RX_DMA_REQUEST kDmaRequestMux0LPUART4Rx
#define EXAMPLE_LPUART_IRQHandler LPUART4_IRQHandler
#define EXAMPLE_LPUART_IRQn LPUART4_IRQn
