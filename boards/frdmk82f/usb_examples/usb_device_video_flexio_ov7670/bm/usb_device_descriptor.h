...
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_DATA_BITS (2U)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_WIDTH (160U)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_HEIGHT (120U)
