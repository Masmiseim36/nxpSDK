...
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_DATA_BITS (2)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_WIDTH (160)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_HEIGHT (120)
