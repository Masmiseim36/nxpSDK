...
#define FMSTR_DEMO_SUPPORT_DBL 0 /* support for double type, disabled on this platform to make the 
                                    demo run faster and communicate well also in UART-polled mode  */
