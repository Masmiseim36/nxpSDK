...
void InitClock(void)
{
    ...
    g_sClockSetup.ui16M1PwmFreq = M1_PWM_FREQ; /* 10 kHz */
                                             ...
                                             * PWM_MOD = SYS_CLOCK / PWM_FREQUNCY = 72 MHz / 10 kHz = 7200   */
...
void InitADC16(void)
{
    ...
    /* ADC0_SE4 and ADC0SE5 interleaved (ADC1_SE14 and ADC1_SE15 taken instead) */
