...
- {id: PCC.PCC_LPI2C0_CLK.outFreq, value: 24 MHz}
- {id: PCC.PCC_LPSPI0_CLK.outFreq, value: 24 MHz}
...
/*******************************************************************************
 ******************* Configuration BOARD_BootClockRUN_FIRC *********************
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
!!Configuration
name: BOARD_BootClockRUN_FIRC
outputs:
- {id: Bus_clock.outFreq, value: 24 MHz}
- {id: Core_clock.outFreq, value: 48 MHz}
- {id: Flash_clock.outFreq, value: 24 MHz}
...
/*******************************************************************************
 * Variables for BOARD_BootClockRUN_FIRC configuration
 ******************************************************************************/
const scg_sys_clk_config_t g_sysClkConfig_BOARD_BootClockRUN_FIRC =
    {
        .divSlow = kSCG_SysClkDivBy2,             /* Slow Clock Divider: divided by 2 */
        .divCore = kSCG_SysClkDivBy1,             /* Core Clock Divider: divided by 1 */
        .src = kSCG_SysClkSrcFirc,                /* Fast IRC is selected as System Clock Source */
    };
const scg_sosc_config_t g_scgSysOscConfig_BOARD_BootClockRUN_FIRC =
    {
...
const scg_sirc_config_t g_scgSircConfig_BOARD_BootClockRUN_FIRC =
    {
...
const scg_firc_config_t g_scgFircConfig_BOARD_BootClockRUN_FIRC =
    {
        .enableMode = kSCG_FircEnable,            /* Enable FIRC clock */
...
const scg_lpfll_config_t g_scgLpFllConfig_BOARD_BootClockRUN_FIRC =
    {
...
/*******************************************************************************
 * Code for BOARD_BootClockRUN_FIRC configuration
 ******************************************************************************/
void BOARD_BootClockRUN_FIRC(void)
{
    scg_sys_clk_config_t curConfig;

    /* Init FIRC. */
    CLOCK_CONFIG_FircSafeConfig(&g_scgFircConfig_BOARD_BootClockRUN_FIRC);
    /* Init SIRC. */
    CLOCK_InitSirc(&g_scgSircConfig_BOARD_BootClockRUN_FIRC);
    /* Set SCG to FIRC mode. */
    CLOCK_SetRunModeSysClkConfig(&g_sysClkConfig_BOARD_BootClockRUN_FIRC);
    /* Wait for clock source switch finished. */
    do
    {
         CLOCK_GetCurSysClkConfig(&curConfig);
    } while (curConfig.src != g_sysClkConfig_BOARD_BootClockRUN_FIRC.src);
    /* Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_BOOTCLOCKRUN_FIRC_CORE_CLOCK;
}
