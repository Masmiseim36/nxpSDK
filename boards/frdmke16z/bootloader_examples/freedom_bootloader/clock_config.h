 ...
 ******************************************************************************/
/*******************************************************************************
 * Definitions for BOARD_BootClockRUN_FIRC configuration
 ******************************************************************************/
#define BOARD_BOOTCLOCKRUN_FIRC_CORE_CLOCK         48000000U  /*!< Core clock frequency: 48000000Hz */

/*! @brief SCG set for BOARD_BootClockRUN_FIRC configuration.
 */
extern const scg_sys_clk_config_t g_sysClkConfig_BOARD_BootClockRUN_FIRC;
/*! @brief System OSC set for BOARD_BootClockRUN_FIRC configuration.
 */
extern const scg_sosc_config_t g_scgSysOscConfig_BOARD_BootClockRUN_FIRC;
/*! @brief SIRC set for BOARD_BootClockRUN_FIRC configuration.
 */
extern const scg_sirc_config_t g_scgSircConfig_BOARD_BootClockRUN_FIRC;
/*! @brief FIRC set for BOARD_BootClockRUN_FIRC configuration.
 */
extern const scg_firc_config_t g_scgFircConfigBOARD_BootClockRUN_FIRC;
/*! @brief Low Power FLL set for BOARD_BootClockRUN_FIRC configuration.
 */
extern const scg_lpfll_config_t g_scgLpFllConfigBOARD_BootClockRUN_FIRC;

/*******************************************************************************
 * API for BOARD_BootClockRUN_FIRC configuration
 ******************************************************************************/
#if defined(__cplusplus)
extern "C" {
#endif /* __cplusplus*/
