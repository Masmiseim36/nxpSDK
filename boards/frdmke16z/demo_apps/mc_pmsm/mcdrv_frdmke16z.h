...
#define M1_MCDRV_TMR_SLOWLOOP (MCDRV_FTM1)
 ...
 * Valid for Kinetis KE16Z Freedom board (FRDM-KE16Z) together with FRDM-MC-LVPMSM
 *
 * Proper ADC channel assignment needs to follow these rules:
 *   - ke16z has only single ADC channel
 *   - current samples are sensed in continuous mode
 *   - first 2 samples are phase currents, 3rd Udcb
...
/* Phase current B assigned to ADC0 */
#define M1_ADC0_PH_B (1)
/* Phase current C assigned to ADC0 */
...
#if (M1_MCDRV_TMR_SLOWLOOP == MCDRV_FTM1)
