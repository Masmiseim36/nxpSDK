...
TSI_CH 2   3   6   7   23  22
       ...
       x   x   x   x   x   x C5 11
                                TSI_CH
*/
#define FRDM_BOARD_TOUCHPAD_ELECTRODE_R1 TF_TSI_SELF_CAP_CHANNEL_22   /* PTC0 */
#define FRDM_BOARD_TOUCHPAD_ELECTRODE_R2 TF_TSI_SELF_CAP_CHANNEL_23   /* PTC1 */
#define FRDM_BOARD_TOUCHPAD_ELECTRODE_R3 TF_TSI_SELF_CAP_CHANNEL_7    /* PTD6 */
#define FRDM_BOARD_TOUCHPAD_ELECTRODE_R4 TF_TSI_SELF_CAP_CHANNEL_6    /* PTD5 */
#define FRDM_BOARD_TOUCHPAD_ELECTRODE_R5 TF_TSI_SELF_CAP_CHANNEL_3    /* PTE11*/
#define FRDM_BOARD_TOUCHPAD_ELECTRODE_R6 TF_TSI_SELF_CAP_CHANNEL_2    /* PTE10*/
...
#define FRDM_BOARD_SHIELD_ELECTRODE     TF_TSI_SELF_CAP_CHANNEL_12    /* PTC5 */
