...
- pin_list:
  - {pin_num: '15', peripheral: FTM0, signal: 'CH, 5', pin_signal: PTB5/TSI0_CH9/FTM0_CH5/LPSPI0_PCS1/TRGMUX_IN0}
  - {pin_num: '16', peripheral: FTM0, signal: 'CH, 4', pin_signal: PTB4/TSI0_CH8/FTM0_CH4/LPSPI0_SOUT/TRGMUX_IN1}
  - {pin_num: '1', peripheral: FTM0, signal: 'CH, 3', pin_signal: PTD1/TSI0_CH5/FTM0_CH3/TRGMUX_OUT2}
...
void BOARD_InitPins(void) {
  ...
  PORT_SetPinMux(PORTB, PIN5_IDX, kPORT_MuxAlt2);           /* PORTB5 (pin 15) is configured as FTM0_CH5 */
  PORT_SetPinMux(PORTB, PIN4_IDX, kPORT_MuxAlt2);           /* PORTB4 (pin 16) is configured as FTM0_CH4 */
  PORT_SetPinMux(PORTD, PIN1_IDX, kPORT_MuxAlt2);           /* PORTD1 (pin 1) is configured as FTM0_CH3 */
}
