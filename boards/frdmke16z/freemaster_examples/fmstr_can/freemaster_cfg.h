...
#define FMSTR_DEMO_LARGE_ROM   0    /* ROM not large enough to store the extended data structures used in FreeMASTER demo */
...
#define FMSTR_CAN_DRV           FMSTR_CAN_MCUX_MSCAN // Use serial driver for msCAN */
