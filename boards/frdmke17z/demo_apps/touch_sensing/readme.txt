...
4.  Open the FreeMASTER project NXPTouchKE15.pmp file from: MCUXpresso SDK\middleware\touch\freemaster\NXPTouchKE17.pmp and choose Project -> Options... from FreeMASTER menu.  
