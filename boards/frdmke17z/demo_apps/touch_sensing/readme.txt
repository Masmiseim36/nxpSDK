...
NXP’s capacitive touch sensing hardware IP that’s available on Kinetis KE15Z/KE16Z/KE17Z MCUs.
...
4.  Open the FreeMASTER project NXPTouchKE17.pmp file from: MCUXpresso SDK\middleware\touch\freemaster\ and choose Project -> Options... from FreeMASTER menu.  
...
Running the demo
================
The control page in FreeMASTER should show changing values from TSI measurement. The Led on FRDM-KE17Z board 
