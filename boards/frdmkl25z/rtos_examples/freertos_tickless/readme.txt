...
Board settings
==============
FRDM-KL25Z board missing application button. Application using button simulated by wire.
Connect one wire end to ground on pin J2-14 and use second wire ending as button by tapping on J2-11.
Prepare the Demo
================
