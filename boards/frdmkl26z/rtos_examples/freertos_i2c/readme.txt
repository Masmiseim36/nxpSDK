...
2.  Open a serial terminal with the following settings:
    ...
    - No flow control
3.
    If using 1 FRDM-KL26Z board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-KL26Z boards:
        In file freertos_i2c.c in folder: boards\frdmkl26z\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
