...
- options: {coreID: singlecore, enableClock: 'true'}
- pin_list:
  - {pin_num: '35', peripheral: I2C0, signal: SCL, pin_signal:
ADC0_SE8/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0/SPI1_MOSI/SPI1_MISO, pull_enable: no_init}
...
#define PIN1_IDX 1u /*!< Pin number for pin 1 in a port */
                    ...
                    - options: {coreID: singlecore, enableClock: 'true'}
                    - pin_list:
                      - {pin_num: '35', peripheral: ADC0, signal: 'SE, 8', pin_signal:
                    ADC0_SE8/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0/SPI1_MOSI/SPI1_MISO}
...
- options: {coreID: singlecore, enableClock: 'true'}
- pin_list:
  - {pin_num: '63', peripheral: I2C1, signal: SDA, pin_signal:
...
#define PIN7_IDX 7u /*!< Pin number for pin 7 in a port */
                    ...
                    - pin_list:
                      - {pin_num: '63', peripheral: ADC0, signal: 'SE, 7b', pin_signal:
                    ADC0_SE7b/PTD6/LLWU_P15/SPI1_MOSI/LPUART0_RX/I2C1_SDA/SPI1_MISO/FXIO0_D6}
                      - {pin_num: '64', peripheral: n/a, signal: disabled, pin_signal:
...
#define PIN7_IDX 7u /*!< Pin number for pin 7 in a port */
                    ...
                    - pin_list:
                      ...
                      - {pin_num: '63', peripheral: SPI1, signal: MOSI, pin_signal:
                    ADC0_SE7b/PTD6/LLWU_P15/SPI1_MOSI/LPUART0_RX/I2C1_SDA/SPI1_MISO/FXIO0_D6}
