...
Board settings
============
Target platform for this example is FRDM-KL43Z and OM2385/SF001. This evaluation board is designed to be pinout compatible with named FRDM-KL43Z and also with wide range of freedom boards based on Kinetis MCUs. Please refer to the SIGFOX software driver user guide for more details.
