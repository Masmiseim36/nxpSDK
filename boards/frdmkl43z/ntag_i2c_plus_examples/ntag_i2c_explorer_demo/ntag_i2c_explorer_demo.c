...
#define CHAR_BOARD_1 'L';
#define CHAR_BOARD_2 '4';
#define CHAR_BOARD_3 '3';
...
/* On the FRDM-KL43Z there is no BLUE LED, so do nothing when it is called */
#define LED_BLUE_INIT(output) \
    do                        \
    {                         \
    } while (0) /*!< Enable target LED_BLUE */
#define LED_BLUE_ON()                                                 \
    GPIO_PortClear(BOARD_LED_RED_GPIO, 1U << BOARD_LED_RED_GPIO_PIN); \
    GPIO_PortClear(BOARD_LED_GREEN_GPIO, 1U << BOARD_LED_GREEN_GPIO_PIN) /*!< Turn on both RED and GREEN LEDs */
#define LED_BLUE_OFF()                                              \
    GPIO_PortSet(BOARD_LED_RED_GPIO, 1U << BOARD_LED_RED_GPIO_PIN); \
    GPIO_PortSet(BOARD_LED_GREEN_GPIO, 1U << BOARD_LED_GREEN_GPIO_PIN) /*!< Turn off both RED and GREEN LEDs */
#define LED_BLUE_TOGGLE()                                              \
    GPIO_PortToggle(BOARD_LED_RED_GPIO, 1U << BOARD_LED_RED_GPIO_PIN); \
    GPIO_PortToggle(BOARD_LED_GREEN_GPIO, 1U << BOARD_LED_GREEN_GPIO_PIN) /*!< Toggle both RED and GREEN LEDs */
...
void Setup(void)
{
    ...
    I2C1_InitPins(); /* initialize appropriate I2C bus */
