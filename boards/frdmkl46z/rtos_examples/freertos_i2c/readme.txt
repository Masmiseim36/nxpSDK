...
Using 2 FRDM-KL46Z boards:
    ...
    The connection should be se as following:
        - J4-6 (master board) connected to J2-20 (slave board).
        - J4-8 (master board) connected to J2-18 (slave board).
...
2.  Open a serial terminal with the following settings:
    ...
    - No flow control
3.
    If using 1 FRDM-KL46Z board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-KL46Z boards:
        In file freertos_i2c.c in folder: boards\frdmkl46z\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
...
If using 1 FRDM-KL46Z board, you can see the similar information from the terminal as below.
...
If using 2 FRDM-KL46Z boards, you can see the similar information from the terminal associated with master board and slave board as below.
