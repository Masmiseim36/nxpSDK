...
#define DEMO_ADC16_CHANNEL 27U
#define ADC16_RESULT_REG_ADDR (uint32_t)(&ADC0->R[0]) /* Get adc16 result register address */

#define DEMO_DMA_BASEADDR DMA0
#define DEMO_DMA_IRQ_ID DMA0_DMA4_IRQn
#define DEMO_DMA_CHANNEL 0U
#define DEMO_DMA_ADC_SOURCE kDmaRequestMux0ADC0 /* kDmaRequestMux0ADC0 */
...
void BOARD_ConfigTriggerSource(void)
{
    ...
    SIM->SOPT7 |= SIM_SOPT7_ADC0TRGSEL(14U);
}
