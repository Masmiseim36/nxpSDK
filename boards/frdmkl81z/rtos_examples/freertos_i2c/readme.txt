...
If using 1 FRDM-KL81Z board, you can see the similar information from the terminal as below.
...
If using 2 FRDM-KL81Z boards, you can see the similar information from the terminal associated with master board and slave board as below.
...
==============
The example supports 2 different connections:
Using 1 FRDM-KL81Z board:
    The 2 I2C instances on one board are used, one as I2C master , another as I2C slave.
    The connection should be set as following:
        - J12-03 , J12-14 connected
        - J12-04 , J12-16 connected
Using 2 FRDM-KL81Z boards:
    ...
    The connection should be se as following:
        - J12-03 (master board) connected to J12-14 (slave board).
        - J12-04 (master board) connected to J12-16 (slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 FRDM-KL81Z board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-KL81Z boards:
        In file freertos_i2c.c in folder: boards\frdmkl81z\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
