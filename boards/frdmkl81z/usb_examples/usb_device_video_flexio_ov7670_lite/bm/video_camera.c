...
camera_receiver_handle_t cameraReceiver = {
    .resource = &flexio_cameraResource, .ops = &flexio_camera_ops, .privateData = &flexioCameraPrivateData,
};
...
{
    /* Clear the interrupt flag for PTA16 */
    PORT_ClearPinsInterruptFlags(PORTA, 1U << BOARD_FLEXIO_VSYNC_PIN_INDEX);
