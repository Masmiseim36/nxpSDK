...
#define SIM_EMVSIM_CLK_SEL_PLLFLLSEL_CLK                  1U  /*!< EMVSIM clock select: PLLFLLSEL output clock */
...
- {id: EMVSIMCLK.outFreq, value: 48 MHz}
- {id: ERCLK32K.outFreq, value: 32.768 kHz}
- {id: FLEXIOCLK.outFreq, value: 72 MHz}
...
- {id: SIM.EMVSIMSRCSEL.sel, value: SIM.PLLFLLDIV}
...
void BOARD_BootClockHSRUN(void)
{
    ...
    CLOCK_SetEmvsimClock(SIM_EMVSIM_CLK_SEL_PLLFLLSEL_CLK);
