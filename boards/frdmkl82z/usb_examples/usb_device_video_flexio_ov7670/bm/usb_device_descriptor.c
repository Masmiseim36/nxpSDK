...
usb_device_class_struct_t g_UsbDeviceVideoFlexioCameraConfig = {
...
uint8_t g_UsbDeviceDescriptor[] = {
    ...
    0x9AU, 0x00U,                                        /* Product ID (assigned by the manufacturer) */
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(USB_DESCRIPTOR_LENGTH_CONFIGURE + USB_DESCRIPTOR_LENGTH_INTERFACE_ASSOCIATION +
                      USB_DESCRIPTOR_LENGTH_INTERFACE + USB_VIDEO_CAMERA_VC_INTERFACE_HEADER_LENGTH +
                      USB_VIDEO_CAMERA_VC_INPUT_TERMINAL_LENGTH + USB_VIDEO_CAMERA_VC_OUTPUT_TERMINAL_LENGTH +
                      USB_VIDEO_CAMERA_VC_PROCESSING_UNIT_LENGTH + USB_DESCRIPTOR_LENGTH_ENDPOINT +
                      USB_DESCRIPTOR_LENGTH_INTERFACE + USB_VIDEO_CAMERA_VS_INTERFACE_HEADER_LENGTH +
    ...
    USB_VIDEO_CAMERA_INTERFACE_COUNT,                   /* Number of interfaces supported by this configuration */
    USB_VIDEO_CAMERA_CONFIGURE_INDEX,                   /* Value to use as an argument to the
...
|| defined(USB_DEVICE_VIDEO_CLASS_VERSION_1_5) && (USB_DEVICE_VIDEO_CLASS_VERSION_1_5 > 0U)
    ...
    USB_LONG_GET_BYTE0(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_20FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_20FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_20FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_20FPS),
    /* 20fps */
    USB_LONG_GET_BYTE0(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_15FPS),
    /* 15fps */
    ...
    /* 10fps */
    USB_LONG_GET_BYTE0(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_5FPS),
    USB_LONG_GET_BYTE1(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_5FPS),
    USB_LONG_GET_BYTE2(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_5FPS),
    USB_LONG_GET_BYTE3(USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_5FPS),
    /* 5fps */
...
{
    if (USB_VIDEO_CAMERA_CONFIGURE_INDEX > configurationDescriptor->configuration)
    {
...
usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed)
{
    ...
    while (descriptorHead < descriptorTail)
    {
        if (descriptorHead->common.bDescriptorType == USB_DESCRIPTOR_TYPE_ENDPOINT)
        {
            ...
            {
                if (USB_VIDEO_CAMERA_STREAM_ENDPOINT_IN ==
