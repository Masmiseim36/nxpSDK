...
#define INT_ADC_IRQN ADC0_IRQn
/* NVIC interrupt vector priority. */
#define INT_ADC_IRQ_PRIORITY 0
/* NVIC interrupt handler identifier. */
#define INT_ADC_IRQHANDLER ADC0_IRQHandler
/* NVIC interrupt vector ID (number). */
#define INT_PDB_IRQN PDB0_PDB1_IRQn
/* NVIC interrupt vector priority. */
#define INT_PDB_IRQ_PRIORITY 1
/* NVIC interrupt handler identifier. */
#define INT_PDB_IRQHANDLER PDB0_PDB1_IRQHandler
/* NVIC interrupt vector ID (number). */
...
/* NVIC interrupt vector ID (number). */
#define INT_GPIO_IRQN PORTB_PORTC_PORTD_PORTE_IRQn
/* NVIC interrupt vector priority. */
#define INT_GPIO_IRQ_PRIORITY 3
/* NVIC interrupt handler identifier. */
#define INT_GPIO_IRQHANDLER PORTB_PORTC_PORTD_PORTE_IRQHandler
/* Definition of peripheral ID */
#define FTM0_PERIPHERAL FTM0
/* Definition of timer input frequency in Hz. */
#define FTM0_TIMER_INTPUT_FREQUENCY 75000000UL
/* Definition of timer initialization value. */
#define FTM0_TIMER_INIT_VALUE -3749L
/* Definition of timer modulo value. */
#define FTM0_TIMER_MODULO_VALUE 3748L
...
/* FTM0_DEADTIME: DTPS=2, DTVAL=9 */
#define FTM0_DEADTIME_INIT 0x89U
...
/* FTM0_PWMLOAD: CH5SEL=0, CH4SEL=0, CH3SEL=0, CH2SEL=0, CH1SEL=0, CH0SEL=0 */
...
/* Definition of timer input frequency in Hz. */
#define FTM2_TIMER_INTPUT_FREQUENCY 4687500UL
/* Definition of timer initialization value. */
#define FTM2_TIMER_INIT_VALUE 0UL
/* Definition of timer modulo value. */
#define FTM2_TIMER_MODULO_VALUE 4687UL
/* Definition of the output initialization mask (the OUTINIT, OUTMASK and POL registers). */
...
/* ADC0_CFG1: ADLPC=0, ADIV=1, ADLSMP=0, MODE=1, ADICLK=0 */
#define ADC0_CFG1_INIT 0x24U
...
/* ADC1_CFG1: ADLPC=0, ADIV=1, ADLSMP=0, MODE=1, ADICLK=0 */
#define ADC1_CFG1_INIT 0x24U
...
/* CMP1_MUXCR: PSEL=4, MSEL=7 */
#define CMP1_MUXCR_INIT 0x27U
...
/* Definition of the clock source frequency */
#define FREEMASTER_SERIAL_PERIPHERAL_CLK_FREQ 75000000UL
