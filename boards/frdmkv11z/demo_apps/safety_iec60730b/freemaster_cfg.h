...
#define FMSTR_DEMO_LARGE_ROM   0     /* Platform has large ROM enough to store the extended data structures used in FreeMASTER demo */
...
#define FMSTR_TRANSPORT         FMSTR_SERIAL    //!< Use PD BDM transport layer */
...
#define FMSTR_SERIAL_DRV FMSTR_SERIAL_MCUX_UART /*Use serial driver for LPUART */
