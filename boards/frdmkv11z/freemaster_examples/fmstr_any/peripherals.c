...
- name: BOARD_InitPeripherals
  UUID: d4460108-61f4-4213-b96f-8a39af639267
  ...
  - freemaster_config:
    ...
    - generalConfig:
      ...
      - serialConfig:
        ...
        - stopBitCount_uart: 'kUART_OneStopBit'
      ...
      - canConfig:
        - peripheralCAN: 'CAN0'
        - generic_can_driver_version: '2.7.1'
...
static void FreeMASTER_init(void) {
  ...
  FreeMASTER_serial_config.stopBitCount = kUART_OneStopBit;
