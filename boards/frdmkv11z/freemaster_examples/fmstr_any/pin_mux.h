...
/* Symbols to be used with PORT driver */
#define BOARD_CAN_TX_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_CAN_TX_PIN 24U                   /*!<@brief PORT pin number */
#define BOARD_CAN_TX_PIN_MASK (1U << 24U)      /*!<@brief PORT pin mask */
                                               /* @} */
