...
Prepare the Demo
===============
1.  Connect the FRDM-MC-LVPMSM shield on top of the FRDM-KV31F board (there is only one 
    possible option). 
...
Running the demo
================
Press button SW2 on FRDM-KV31F board to switch on or off demonstration mode - the motor will rotate.
