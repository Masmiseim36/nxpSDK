...
#define SYSTICK_RELOAD_VALUE      1000000          /* 12.5 ms with 80Mhz */
#define ISR_FREQUENCY             120  /* Hz */
...
#define WD_RUN_TEST_CONDITION_SRS0  RCM_SRS0_PIN_MASK | RCM_SRS0_POR_MASK
#define WD_RUN_TEST_CONDITION_SRS1  RCM_SRS1_JTAG_MASK | RCM_SRS1_SW_MASK
#define WD_CHECK_TEST_CONDITION     RCM_SRS0_WDOG_MASK

#define Watchdog_refresh    WDOG->REFRESH = 0xA602;WDOG->REFRESH = 0xB480

#define WDOG_USED    WDOG
...
#define WATCHDOG_TIMEOUT_VALUE    100U
...
#define FS_CFG_AIO_SAMPLES_INIT {2}  /* ADC SAMPLES number for test  KV46 */
