...
Using 2 FRDM-KV31F boards:
    ...
    The connection should be se as following:
        - J2-20 (master board) connected to J4-12 (slave board).
        - J2-18 (master board) connected to J4-10 (slave board).
        - J2-14 (GND of master board) connected to J2-14 (GND of slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 FRDM-KV31F board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-KV31F boards:
...
If using 1 FRDM-KV31F board, you can see the similar information from the terminal as below.
...
If using 2 FRDM-KV31F boards, you can see the similar information from the terminal associated with master board and slave board as below.
