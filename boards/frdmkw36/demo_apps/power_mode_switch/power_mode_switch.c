...
{    
    ...
    DCDC->REG0 &= ~(DCDC_REG0_VLPR_VLPW_CONFIG_DCDC_HP_MASK | DCDC_REG0_VLPS_CONFIG_DCDC_HP_MASK | DCDC_REG0_DCDC_LP_DF_CMP_ENABLE_MASK);
    /* Configure DCDC for Continuous mode */
    DCDC->REG0 |= (DCDC_REG0_VLPR_VLPW_CONFIG_DCDC_HP_MASK | DCDC_REG0_VLPS_CONFIG_DCDC_HP_MASK);
    /* Enable low power differential comparators */
    DCDC->REG0 |= (DCDC_REG0_DCDC_LP_DF_CMP_ENABLE_MASK);
    /* Enable hysteresis on comparators - improve transient supply characteristics */ 
 ...
 */
#if (defined(FSL_FEATURE_SMC_HAS_VERY_LOW_LEAKAGE_STOP_MODE) && FSL_FEATURE_SMC_HAS_VERY_LOW_LEAKAGE_STOP_MODE)
            else if ((kAPP_PowerModeVlls3 == targetPowerMode) ||
#if (defined(FSL_FEATURE_SMC_HAS_STOP_SUBMODE2) && FSL_FEATURE_SMC_HAS_STOP_SUBMODE2)
...
#endif /* FSL_FEATURE_SMC_HAS_STOP_SUBMODE0 */
#if (defined(FSL_FEATURE_SMC_HAS_LOW_LEAKAGE_STOP_MODE) && FSL_FEATURE_SMC_HAS_LOW_LEAKAGE_STOP_MODE)
                     (kAPP_PowerModeVlls == targetPowerMode) ||
#endif /* FSL_FEATURE_SMC_HAS_LOW_LEAKAGE_STOP_MODE */
