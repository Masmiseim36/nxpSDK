...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - One stop bit
    - No flow control
3.  On FREEDOM KW36 it is not possible to use external channels so the temperature sensor is used instead, defined by "DEMO_ADC16_USER_CHANNEL" in source code.
