...
- pin_list:
  ...
  - {pin_num: '17', peripheral: CMT, signal: IRO, pin_signal: ADC0_SE1/CMP0_IN5/PTB1/RF_PRIORITY/DTM_RX/I2C0_SDA/LPTMR0_ALT1/TPM0_CH2/CMT_IRO/CAN0_RX}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  PORT_SetPinMux(PORTB, PIN1_IDX, kPORT_MuxAlt7);            /* PORTB1 (pin 17) is configured as CMT_IRO */
