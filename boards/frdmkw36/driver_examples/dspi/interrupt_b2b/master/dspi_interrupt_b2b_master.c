...
#define EXAMPLE_DSPI_MASTER_CLK_SRC DSPI1_CLK_SRC
#define EXAMPLE_DSPI_MASTER_CLK_FREQ CLOCK_GetFreq(DSPI1_CLK_SRC)
#define EXAMPLE_DSPI_MASTER_PCS kDSPI_Pcs0
#define EXAMPLE_DSPI_MASTER_IRQ SPI1_IRQn
#define EXAMPLE_DSPI_MASTER_IRQHandler SPI1_IRQHandler
