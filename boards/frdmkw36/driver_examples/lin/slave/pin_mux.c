...
- pin_list:
  - {pin_num: '17', peripheral: TPM0, signal: 'CH, 2', pin_signal: ADC0_SE1/CMP0_IN5/PTB1/RF_PRIORITY/DTM_RX/I2C0_SDA/LPTMR0_ALT1/TPM0_CH2/CMT_IRO/CAN0_RX, direction: INPUT,
...
void BOARD_InitPins(void) {
  ...
  const port_pin_config_t portb1_pin17_config = {
    ...
    kPORT_MuxAlt5,                                           /* Pin is configured as TPM0_CH2 */
  };
  PORT_SetPinConfig(PORTB, PIN1_IDX, &portb1_pin17_config);  /* PORTB1 (pin 17) is configured as TPM0_CH2 */
}
