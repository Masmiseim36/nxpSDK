...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 FRDM-KW36 board:
        Default settings in app.h is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-KW36 boards:
        In file app.h in folder: boards\frdmkw36\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
