Overview
========
The application implements a BLE node that proxies a connected GAP Peripheral for any connnected GAP Central and relays communication between the 2 active connections.
