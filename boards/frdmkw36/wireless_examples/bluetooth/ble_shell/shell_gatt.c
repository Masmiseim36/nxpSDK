    ...
    if (procedureResult == gGattProcSuccess_c)
    {
        switch(procedureType)
        {
            ...
            case gGattProcReadCharacteristicValue_c:
            {
                ...
                shell_write("\r\n     Value: ");
                shell_writeHexLe(mpCharBuffer->value.paValue, (uint8_t)mpCharBuffer->value.valueLength);
                shell_cmd_finished();
 ...
 *
 * \param[in]    serverDeviceId               Server peer device ID.
 * \param[in]    characteristicValueHandle    Handle of the notificated characteristic
...
)
{
    ...
    else
    {
        ...
        shell_write("\r\n     Value: ");
        shell_writeHexLe(aValue, (uint8_t)valueLength);
        SHELL_NEWLINE();
    }
}
...
/*! *********************************************************************************
 * \brief        Handles "gatt writecdm" and "gatt writersp" shell commands.
 *
 * \param[in]    argc           Number of arguments
 * \param[in]    argv           Array of argument's values
...
)
{
    switch (procedureType)
    {
        ...
        case gGattProcDiscoverAllCharacteristicDescriptors_c: /* Fallthrough */
        case gGattProcDiscoverAllCharacteristics_c:
        {
