...
static void TimerMeasurementCallback(void * pParam)
{
    ...
    if (mMeasurementSelect < 5U)
    {
        ...
        cp.cuffPressure = 120U + ((uint16_t)randomNumber & 0x03U);
    ...
    else
    {
        ...
        bp.systolicValue = 120U + ((uint16_t)randomNumber & 0x03U);
        bp.diastolicValue = 80U + ((uint16_t)randomNumber & 0x03U);
        ...
        bp.pulseRate = 90U + ((uint16_t)randomNumber & 0x03U) ;
    ...
    mMeasurementSelect += 1U;
    mMeasurementSelect = mMeasurementSelect % 6U;
