...
- pin_list:
  - {pin_num: '46', peripheral: RADIO, signal: PTC17/LLWU_P1/RF_EXT_OSC_EN/SPI0_SOUT/I2C1_SCL/LPUART0_RX/BSM_FRAME/DTM_RX/LPUART1_RX}
  - {pin_num: '47', peripheral: RADIO, signal: PTC18/LLWU_P2/SPI0_SIN/I2C1_SDA/LPUART0_TX/BSM_DATA/DTM_TX/LPUART1_TX}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitDTM(void) {
   ...
   PORT_SetPinMux(PORTC, PIN17_IDX, kPORT_MuxAlt7); /* PORTC17 (pin 46) is configured as DTM_RX */
   PORT_SetPinMux(PORTC, PIN18_IDX, kPORT_MuxAlt7); /* PORTC18 (pin 47) is configured as DTM_TX */
}
