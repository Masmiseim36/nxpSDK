...
static const uint8_t adData1[2] = { UuidArray(gBleSig_LocationAndNavigationService_d)};
...
static const gapServiceSecurityRequirements_t serviceSecurity[3] = {
  {
    ...
    .serviceHandle = (uint16_t)service_location_and_navigation
  },
  {
    .requirements = {
        .securityModeLevel = gSecurityMode_1_Level_3_c,
