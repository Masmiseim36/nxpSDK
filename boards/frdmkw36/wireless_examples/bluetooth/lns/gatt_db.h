...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c | gGattCharPropWrite_c) )
            VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 11, "NXP_BLE_LNS")
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 8, "LNS Demo")
...
PRIMARY_SERVICE(service_location_and_navigation, gBleSig_LocationAndNavigationService_d)
    CHARACTERISTIC(char_ln_feature, gBleSig_LnFeature_d, (gGattCharPropRead_c) )
        VALUE(value_ln_feature, gBleSig_LnFeature_d, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
    CHARACTERISTIC(char_location_and_speed, gBleSig_LocationAndSpeed_d, (gGattCharPropNotify_c) )
        VALUE_VARLEN(value_location_and_speed, gBleSig_LocationAndSpeed_d, (gPermissionNone_c), 20, 2, 0x00, 0x00)
        CCCD(cccd_location_and_speed)
    CHARACTERISTIC(char_position_quality, gBleSig_PositionQuality_d, (gGattCharPropRead_c) )
        VALUE_VARLEN(value_position_quality, gBleSig_PositionQuality_d, (gPermissionFlagReadable_c), 16, 2, 0x00, 0x00)
    CHARACTERISTIC(char_lncp, gBleSig_LnControlPoint_d, (gGattCharPropWrite_c | gGattCharPropIndicate_c) )
        VALUE_VARLEN(value_lncp, gBleSig_LnControlPoint_d, (gPermissionFlagWritable_c), 16, 2, 0x00, 0x00 )
        CCCD(cccd_lncp)
    CHARACTERISTIC(char_navigation, gBleSig_Navigation_d, (gGattCharPropNotify_c) )
        VALUE(value_navigation, gBleSig_Navigation_d, (gPermissionNone_c), 19, 0x00, 0x00 )
        CCCD(cccd_navigation)
