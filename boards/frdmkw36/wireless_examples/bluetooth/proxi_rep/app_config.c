...
static uint8_t adData1[] = { UuidArray(gBleSig_ImmediateAlertService_d),
                                    UuidArray(gBleSig_LinkLossService_d),
                                    UuidArray(gBleSig_TxPowerService_d)};
...
static gapServiceSecurityRequirements_t serviceSecurity[] = {
  {
    .requirements = {
    ...
    .serviceHandle = (uint16_t)service_link_loss
  },
  
  {
    ...
    .serviceHandle = (uint16_t)service_tx_power
  },
  
  {
    ...
    .serviceHandle = (uint16_t)service_immediate_alert
  },
