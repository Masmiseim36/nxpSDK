...
gapAdvertisingParameters_t gAdvParams = {
    /* minInterval */         160, /* 100 ms */
    /* maxInterval */         160, /* 100 ms */
...
gapExtAdvertisingParameters_t gExtAdvParams =
{
    ...
    /* filterPolicy */              gProcessAll_c, \
    /* extAdvProperties */          (bleAdvRequestProperties_t)gAdvReqConnectable_c, \
...
{
    .scanInterval = 160,        /* 100 ms */
    .scanWindow = 80,           /* 50 ms */
    .filterPolicy = gUseDeviceAddress_c,
    .ownAddressType = gBleAddrTypePublic_c,
    .connIntervalMin = 250,     /* 312 ms */
    .connIntervalMax = 250,     /* 312 ms */
    .connLatency = 0,
