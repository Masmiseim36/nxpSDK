...
/* LPUART hardware instance count. */
...
#define l_u8_wr_LI0_Motor1Temp(A)                                                                                      \
    {                                                                                                                  \
        g_lin_frame_data_buffer[LIN_LI0_Motor1Temp_BYTE_OFFSET] = (l_u8)((((A) << 0U) & 0xffU));                       \
