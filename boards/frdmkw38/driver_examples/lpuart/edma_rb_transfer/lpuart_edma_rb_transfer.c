...
#define EXAMPLE_LPUART_CLKSRC kCLOCK_CoreSysClk
#define EXAMPLE_LPUART_CLK_FREQ CLOCK_GetFreq(kCLOCK_CoreSysClk)
...
#define EXAMPLE_LPUART_IRQHandler LPUART0_LPUART1_IRQHandler
#define EXAMPLE_LPUART_IRQn LPUART0_LPUART1_IRQn
