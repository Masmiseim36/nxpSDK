 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * MANUAL EDIT : BOARD_BootClockVLPR() has been removed from this file as the BOARD_BootClockRUN() already provides
 *     clock setting for lowpower. The idea is to wakeup at maximum speed so the wakeup time is reduced and the device remains
 *     less time in active.  The configuration provided by BOARD_BootClockRUN() is also fully tested.  Any other clocks
 *     setting configuration could impact the wakeup timings and thus, the lowpower functionnality, so this is not recommended.
 **********************************************************************************************************************/
/*
