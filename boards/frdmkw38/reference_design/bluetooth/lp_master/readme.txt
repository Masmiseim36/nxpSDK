...
Power consumption is optimized during Scan, connected and no activity states.
...
Running the demo
================
At power on, device is scanning. A device with Lowpower reference design application could be used to get connected.
