...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
INSTANCE0(I2C0)     CONNECTS TO         INSTANCE1(I2C1)
Pin Name   Board Location     Pin Name  Board Location
SCL        J2  pin 10         SCL       J2  pin 4
SDA        J2  pin 9          SDA       J2  pin 5
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
The connection should be set as following:
- J9-1 , J9-2 connected
- J7-1 , J7-2 connected
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 FRDM-kw38 board:
        Default settings in app.h is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-kw38 boards:
        In file app.h in folder: boards\frdmkw38\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
...
If using 1 FRDM-kw38 board, you can see the similar information from the terminal as below.
...
If using 2 FRDM-kw38 boards, you can see the similar information from the terminal associated with master board and slave board as below.
