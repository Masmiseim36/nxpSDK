...
static const gapAdStructure_t extAdvScannableData[] = {
  {
    .length = NumberOfElements(adData0) + 1,
    .adType = gAdFlags_c,
    .aData = (uint8_t*)adData0
...
static const gapAdStructure_t extAdvConnectableData[] = {
  {
    .length = NumberOfElements(adData0) + 1,
    .adType = gAdFlags_c,
    .aData = (uint8_t*)adData0
...
static const gapAdStructure_t extAdvNonConnNonScanDataId1[] = {
  {
    .length = NumberOfElements(adData0) + 1,
    .adType = gAdFlags_c,
    .aData = (uint8_t*)adData0
...
static const gapAdStructure_t extAdvNonConnNonScanDataId2[] = {
  {
    .length = NumberOfElements(adData0) + 1,
    .adType = gAdFlags_c,
    .aData = (uint8_t*)adData0
...
static const gapAdStructure_t extAdvPeriodicDataId1[] = {
  {
...
static const gapAdStructure_t extAdvPeriodicDataId2[] = {
  {
