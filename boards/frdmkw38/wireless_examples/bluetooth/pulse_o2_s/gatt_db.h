...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c | gGattCharPropWrite_c) )
        VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 11, "NXP_BLE_PLX")
    CHARACTERISTIC(char_appearance, gBleSig_GapAppearance_d, (gGattCharPropRead_c) )
        VALUE(value_appearance, gBleSig_GapAppearance_d, (gPermissionFlagReadable_c), 2, UuidArray(gGenericPulseOximeter_c))
...
PRIMARY_SERVICE(service_pulse_oximeter, gBleSig_PulseOximeterService_d)
    CHARACTERISTIC(char_plx_sc_measurement, gBleSig_PlxSCMeasurement_d, gGattCharPropIndicate_c)
        VALUE_VARLEN(value_plx_sc_measurement, gBleSig_PlxSCMeasurement_d, (gPermissionFlagReadable_c), 19, 5, 0x00, 0xFF, 0x0F, 0xFF, 0x0F,)
        CCCD(cccd_plx_measurement)
    CHARACTERISTIC(char_plx_cont_measurement, gBleSig_PlxContMeasurement_d, gGattCharPropNotify_c)
        VALUE_VARLEN(value_plx_cont_measurement, gBleSig_PlxContMeasurement_d, (gPermissionFlagReadable_c), 20, 5, 0x00, 0xFF, 0x0F, 0xFF, 0x0F,)
        CCCD(cccd_plx_cont_measurement)
    CHARACTERISTIC(char_plx_feature, gBleSig_PulseOximeterFeature_d, (gGattCharPropRead_c) )
        VALUE_VARLEN(value_plx_feature, gBleSig_PulseOximeterFeature_d, (gPermissionFlagReadable_c), 8, 2, 0x0000)
    CHARACTERISTIC(char_ra_ctrl_point, gBleSig_RaCtrlPoint_d, (gGattCharPropIndicate_c | gGattCharPropWrite_c) )
        VALUE_VARLEN(value_ra_ctrl_point, gBleSig_RaCtrlPoint_d, (gPermissionFlagWritable_c), 19, 7, 0x00, 0xFF, 0x0F, 0xFF, 0x0F, 0xFF, 0x0F,)
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 8, "PLX Demo")
