...
Using 2 FRDM-KW41Z boards:
    ...
    The connection should be se as following:
        - J1-4 (master board) connected to J2-9 (slave board).
        - J1-3 (master board) connected to J2-10 (slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 FRDM-KW41Z board:
        Default settings in app.h is applied.
        Build project.
        Download the program to the target board.
    If using 2 FRDM-KW41Z boards:
        In file app.h in folder: boards\frdmkw41z\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
