...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c | gGattCharPropWrite_c) )
            VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 11, "FSL_BLE_ANS")
    CHARACTERISTIC(char_appearance, gBleSig_GapAppearance_d, (gGattCharPropRead_c) )
            VALUE(value_appearance, gBleSig_GapAppearance_d, (gPermissionFlagReadable_c), 2, UuidArray(gGenericPhone_c))
...
PRIMARY_SERVICE(service_alert, gBleSig_AlertNotificationService_d)
    CHARACTERISTIC(char_supp_new_alert_cat, gBleSig_SupportedNewAlertCategory_d, (gGattCharPropRead_c))
        VALUE(value_supp_new_alert_cat, gBleSig_SupportedNewAlertCategory_d, (gPermissionFlagReadable_c), 2, 0xFF, 0x01)
    CHARACTERISTIC(char_new_alert, gBleSig_NewAlert_d, (gGattCharPropNotify_c))
        VALUE_VARLEN(value_new_alert, gBleSig_NewAlert_d, (gPermissionNone_c), 10, 0x02, 0x00, 0x00)
        CCCD(cccd_new_alert)
    CHARACTERISTIC(char_supp_unread_alert_cat, gBleSig_SupportedUnreadAlertCategory_d, (gGattCharPropRead_c))
        VALUE(value_supp_unread_alert_cat, gBleSig_SupportedUnreadAlertCategory_d, (gPermissionFlagReadable_c), 2, 0xFF, 0x01)
    CHARACTERISTIC(char_unread_alert, gBleSig_UnreadAlertStatus_d, (gGattCharPropNotify_c))
        VALUE(value_unread_alert, gBleSig_UnreadAlertStatus_d, (gPermissionNone_c), 2, 0x00, 0x00)
        CCCD(cccd_unread_alert)
    CHARACTERISTIC(char_alert_cp, gBleSig_AlertNotifControlPoint_d, (gGattCharPropWrite_c))
        VALUE(value_alert_cp, gBleSig_AlertNotifControlPoint_d, (gPermissionFlagWritable_c), 2, 0x00, 0x00)
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 8, "ANS Demo")
...
PRIMARY_SERVICE(service_current_time, gBleSig_CurrentTimeService_d)
    CHARACTERISTIC(char_current_time, gBleSig_CurrentTime_d, (gGattCharPropNotify_c | gGattCharPropWrite_c | gGattCharPropRead_c))
        VALUE_VARLEN(value_current_time, gBleSig_CurrentTime_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 10, 2, 0x00, 0x00)
