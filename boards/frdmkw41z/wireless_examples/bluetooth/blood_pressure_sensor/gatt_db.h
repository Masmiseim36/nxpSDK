...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c | gGattCharPropWrite_c) )
            VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 11, "FSL_BLE_BPS")
    CHARACTERISTIC(char_appearance, gBleSig_GapAppearance_d, (gGattCharPropRead_c) )
            VALUE(value_appearance, gBleSig_GapAppearance_d, (gPermissionFlagReadable_c), 2, UuidArray(gGenericBloodPressure_c))
...
PRIMARY_SERVICE(service_blood_pressure, gBleSig_BloodPressureService_d)
    CHARACTERISTIC(char_bp_measurement, gBleSig_BpMeasurement_d, (gGattCharPropIndicate_c))
        VALUE_VARLEN(value_bp_measurement, gBleSig_BpMeasurement_d, (gPermissionNone_c), 19, 7, 0x00, 0xFF, 0x0F, 0xFF, 0x0F, 0xFF, 0x0F,)
        CCCD(cccd_bp_measurement)
    CHARACTERISTIC(char_interm_cuff_pressure, gBleSig_IntermediateCuffPressure_d, (gGattCharPropNotify_c))
        VALUE_VARLEN(value_interm_cuff_pressure, gBleSig_IntermediateCuffPressure_d, (gPermissionNone_c), 19, 7, 0x00, 0xFF, 0x0F, 0xFF, 0x0F, 0xFF, 0x0F,)
        CCCD(cccd_interm_cuff_pressure)
    CHARACTERISTIC(char_bp_feature, gBleSig_BloodPressureFeature_d, (gGattCharPropRead_c) )
        VALUE(value_bp_feature, gBleSig_BloodPressureFeature_d, (gPermissionFlagReadable_c), 2, 0x0000)
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 8, "BPS Demo")
