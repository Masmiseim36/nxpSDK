...
- options: {coreID: singlecore, enableClock: 'true'}
- pin_list:
  - {pin_num: '17', peripheral: DTM, signal: DTM_RX, pin_signal: ADC0_SE1/CMP0_IN5/PTB1/DTM_RX/I2C0_SDA/LPTMR0_ALT1/TPM0_CH2/CMT_IRO}
  - {pin_num: '18', peripheral: DTM, signal: DTM_TX, pin_signal: ADC0_SE3/CMP0_IN3/PTB2/RF_NOT_ALLOWED/DTM_TX/TPM1_CH0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR THE PINS TOOL ***
 */
