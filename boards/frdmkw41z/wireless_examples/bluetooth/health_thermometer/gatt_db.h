...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c | gGattCharPropWrite_c) )
            VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 11, "FSL_BLE_HTS")
    CHARACTERISTIC(char_appearance, gBleSig_GapAppearance_d, (gGattCharPropRead_c) )
            VALUE(value_appearance, gBleSig_GapAppearance_d, (gPermissionFlagReadable_c), 2, UuidArray(gGenericThermometer_c))
...
PRIMARY_SERVICE(service_health_therm, gBleSig_HealthThermometerService_d)
    CHARACTERISTIC(char_temp_measurement, gBleSig_TemperatureMeasurement_d, (gGattCharPropIndicate_c))
        VALUE_VARLEN(value_temp_measurement, gBleSig_TemperatureMeasurement_d, (gPermissionNone_c), 13, 5, 0x00, 0x00, 0x00, 0x00, 0x00)
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 8, "HTS Demo")
