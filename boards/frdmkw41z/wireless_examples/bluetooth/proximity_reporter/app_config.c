...
static const uint8_t adData1[] = { UuidArray(gBleSig_ImmediateAlertService_d),
...
static const gapServiceSecurityRequirements_t serviceSecurity[] = {
  {
    ...
    .serviceHandle = service_link_loss
  },
  
  {
    ...
    .serviceHandle = service_tx_power
  },
  
  {
    ...
    .serviceHandle = service_immediate_alert
  },
