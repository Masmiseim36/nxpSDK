...
#define ZB_FSCI_CMD_OFFSET (0x37)
#define ZB_COMMON_FSCI_OG  (0x00 + ZB_FSCI_CMD_OFFSET)
#define ZB_ZHA_FSCI_OG     (0x01 + ZB_FSCI_CMD_OFFSET)
#define ZB_PDM_FSCI_OG     (0x02 + ZB_FSCI_CMD_OFFSET)
#define ZB_MISC_FSCI_OG    (0x03 + ZB_FSCI_CMD_OFFSET)
#define ZB_IAS_FSCI_OG     (0x04 + ZB_FSCI_CMD_OFFSET)
#define ZB_OTA_FSCI_OG     (0x05 + ZB_FSCI_CMD_OFFSET)
...
/* Common Commands */
    ...
    E_SL_MSG_POLL_INTERVAL_SET                                 =   0x002D,
    E_SL_MSG_ADD_IN_OUT_CLUSTERS                               =   0x002E,
    E_SL_MSG_FIND                                              =   0x002F,
    ...
    E_SL_MSG_ADD_ENHANCED_SCENE_RESPONSE                       =   0x80A7,
    E_SL_MSG_VIEW_ENHANCED_SCENE                               =   0x00A8,
    E_SL_MSG_VIEW_ENHANCED_SCENE_RESPONSE                      =   0x80A8,
    E_SL_MSG_COPY_SCENE                                        =   0x00A9,
    E_SL_MSG_COPY_SCENE_RESPONSE                               =   0x80A9,
