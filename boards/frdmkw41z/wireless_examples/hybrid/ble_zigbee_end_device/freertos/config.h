...
#ifndef _ZIGBEE_BDB_END_DEVICE_H_
#define _ZIGBEE_BDB_END_DEVICE_H_

/*!=================================================================================================
\file       config.h
\brief      This is the header file for the configuration of the Zigbee BDB End Device demo
            application.
==================================================================================================*/
...
/*! FreeRTOS heap size */
#define gTotalHeapSize_c (15*1024+500)
...
/*! Aplication PDM ID */
#define PDM_APP_ID  PDM_APP_BDB_ZED_ID 
...
#endif /* _ZIGBEE_BDB_END_DEVICE_H_ */
