Overview
========
This application represents the "802.15.4 EndDevice" of the My Wireless Application Beaconed Enabled Demo, and it demonstrates the following:
- scanning for a coordinator
- association procedure to a slotted Personal Area Network (PAN)
