...
6.  Follow onscreen instructions to configure and enter MCU low power modes.
7.  Repeat the steps above to prepare a second board for the low power preamble search scenario which requires two boards.