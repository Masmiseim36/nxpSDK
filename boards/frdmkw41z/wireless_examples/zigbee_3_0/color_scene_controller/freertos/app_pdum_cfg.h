...
#define PdumsDetails_c \
         _pdum_handler_name_ (pdum_apduZDP)  _pdum_block_size_ (100) _pdum_queue_size_ (14)  _eol_ \
		 _pdum_handler_name_ (pdum_apduZCL)  _pdum_block_size_ (100) _pdum_queue_size_ (14)  _eol_
#endif
/****************************************************************************/
/***        Type Definitions                                              ***/
/****************************************************************************/
