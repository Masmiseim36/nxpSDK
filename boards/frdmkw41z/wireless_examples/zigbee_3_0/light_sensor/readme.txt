Overview
========
This application represents the "Light Sensor" Zigbee 3.0 demo application.
The Light Sensor can be used to provide regular illuminance measurements to a control application, like Control Bridge, that adjusts the level of light emitted by light nodes.
