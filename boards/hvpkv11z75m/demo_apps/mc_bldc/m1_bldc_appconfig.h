 ...
 */
/**********************************************************************/
// File Name: bldc_appconfig.h 
//
// Date:  July 17, 2017, 13:37:48
//
...
#define M1_U_DCB_UNDERVOLTAGE              FRAC16(0.112866817156)
...
//----------------------------------------------------------------------
//Timer Frequency                       = 491520 [Hz]
//----------------------------------------------------------------------
#define M1_N_MIN                           FRAC16(0.02)
#define M1_N_START_TRH                     FRAC16(0.025714285714)
#define M1_STARTUP_CMT_CNT                 (8)
#define M1_STARTUP_CMT_PER                 (22118)
#define M1_CMT_T_OFF                       FRAC16(0.22)
#define M1_FREEWHEEL_T_LONG                (1000)
#define M1_FREEWHEEL_T_SHORT               (500)
#define M1_SPEED_SCALE_CONST               (2107)
#define M1_CMT_PER_MIN                     (351)
#define M1_START_CMT_ACCELER               FRAC16(0.933403196103)
