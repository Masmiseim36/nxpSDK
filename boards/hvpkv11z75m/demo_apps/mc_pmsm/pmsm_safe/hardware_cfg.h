...
#define VECTOR_031             IRQHNDLR_fsADC0
 ...
 * Clock configuration.
 ******************************************************************************/
/* The trimmed SLOW_IRCLK frequency in Hz.
 * -Use the table below to select trimming factor to obtain desired SLOW_IRCLK
 *  value.
 *
 * | CLOCK_SLOW_IRCLK_TRIM | CLOCK_SLOW_IRCLK_FREQ [kHz] |
 * |-----------------------|-----------------------------|
 * |          70           |            40.634           |
 * |          80           |            39.093           |
 * |          81           |            38.911           | <- Newly adjusted value.
 * |          90           |            37.608           |
 * |          100          |            36.245           |
 * |          110          |            35.014           |
 * |          120          |            33.875           |
 * |          129          |            32.884           | <- Default value.
 * |          130          |            32.776           |
 * |          140          |            31.756           |
 * |          150          |            30.779           |
 */
#define CLOCK_SLOW_IRCLK_TRIM      (81U)
#define CLOCK_SLOW_IRCLK_FREQ      (38911UL)

/* The FLL output frequency in Hz.
   -By default set to 74.709120 MHz. */
#define CLOCK_MCGOUTCLK_FREQ       (CLOCK_SLOW_IRCLK_FREQ * 1920UL)
...
/* The bus-clock frequency in Hz.
   -By default set to 24.903040 MHz. */
#define CLOCK_BUS_OUTDIV           (3UL)
#define CLOCK_BUS_FREQ             (CLOCK_MCGOUTCLK_FREQ / CLOCK_BUS_OUTDIV)

/* The alternative ADC clock frequency in Hz.
   -By default set to 18.677280 MHz.*/
#define CLOCK_ALT_ADC_OUTDIV       (4UL)
#define CLOCK_ALT_ADC_FREQ         (CLOCK_MCGOUTCLK_FREQ / CLOCK_ALT_ADC_OUTDIV)
...
/* The ADC frequency in Hz for ADC16 calibration process (should be in 2-4 MHz
   range).
   -The ADC0 and ADC1 alternative clock is used as input to ADC0 and ADC1.
   -By default set to 2.33466 MHz. */
#define CLOCK_ADC_CAL_ADC16_DIV    (3UL)
#define CLOCK_ADC_CAL_FREQ         (CLOCK_ALT_ADC_FREQ / (1UL << CLOCK_ADC_CAL_ADC16_DIV))

/*******************************************************************************
 * PWM pin configuration.
 ******************************************************************************/
/* PWM signal pin assignment. */
#define PIN_PWM0_PORT     (PORTE)
#define PIN_PWM0_PIN      (24U)
#define PIN_PWM0_MUX      (3U)
#define PIN_PWM1_PORT     (PORTE)
#define PIN_PWM1_PIN      (25U)
#define PIN_PWM1_MUX      (3U)
...
#define PIN_FAULT_1_PORT  (PORTC)   /*< Port periphery. */
#define PIN_FAULT_1_PIN   (0U)      /*< Pin number. */
#define PIN_FAULT_1_MUX   (6U)      /*< Initial GPIO pin state. */
...
#define PIN_MCU_BRAKE_GPIO     (GPIOD)    /*< GPIO periphery. */
#define PIN_MCU_BRAKE_PIN      (3U)       /*< Pin number. */

/* In-rush relay control macros. */
#define PIN_RELAY_GPIO         (GPIOA)    /*< GPIO periphery. */
#define PIN_RELAY_PIN          (18U)      /*< Pin number. */

/* USER_LED control macro. */
#define PIN_USER_LED_GPIO      (GPIOD)   /*< GPIO periphery. */
#define PIN_USER_LED_PIN       (2U)      /*< Pin number. */
...
#define PIN_USER_LED_2_GPIO    (GPIOC)   /*< GPIO periphery. */
#define PIN_USER_LED_2_PIN     (3U)      /*< Pin number. */
...
#define PIN_MB_TP_26_GPIO      (GPIOA)    /*< GPIO periphery. */
#define PIN_MB_TP_26_PIN       (4U)       /*< Pin number. */
...
#define PIN_GPIO_INIT_TABLE {\
    ...
    {PIN_GPIO2IDX(GPIOA),                2U,                     0U       },\
    {PIN_GPIO2IDX(GPIOB),                0U,                     0U       },\
    {PIN_GPIO2IDX(GPIOB),                2U,                     0U       },\
    {PIN_GPIO2IDX(GPIOB),               17U,                     0U       },\
    {PIN_GPIO2IDX(GPIOC),                6U,                     0U       },\
    {PIN_GPIO2IDX(GPIOC),                7U,                     0U       },\
    {PIN_GPIO2IDX(GPIOD),                6U,                     0U       },\
    {PIN_GPIO2IDX(GPIOD),                7U,                     0U       },\
    {PIN_GPIO2IDX(GPIOE),               16U,                     0U       },\
    {PIN_GPIO2IDX(GPIOE),               29U,                     0U       }\
}
...
#define PIN_UART_RXD_PORT          (PORTD)
#define PIN_UART_RXD_PIN           (0U)
#define PIN_UART_RXD_MUX           (5U)
#define PIN_UART_TXD_PORT          (PORTD)
#define PIN_UART_TXD_PIN           (1U)
#define PIN_UART_TXD_MUX           (5U)
...
/* The PDB0 periphery IRQ handler. */
extern void IRQHNDLR_fsPDB0(void);
