...
#define M1_PWM_MODULO           (62914560UL / M1_PWM_FREQ)
...
#define M1_SLOW_LOOP_MODULO     (62914560UL / M1_SLOW_LOOP_FREQ)
/* Fast loop period */
...
#define M1_PWM_DEADTIME_LENGTH_DTPS     (4U)
/* Output PWM deadtime register value */
#define M1_PWM_DEADTIME_LENGTH_DTVAL    (23U)
...
#define PDB_PRETRIG_DELAY       (15U)

/******************************************************************************
 * Inrush relay
 ******************************************************************************/
/* Inrush relay enable */
#define M1_INRUSH_ENABLE        (1U)
/* Inrush relay delay */
#define M1_INRUSH_DELAY         (1000U)
/* Inrush relay pin */
#define M1_INRUSH_SET()         GPIOA->PSOR |= GPIO_PSOR_PTSO(1 << 18)
#define M1_INRUSH_CLEAR()       GPIOA->PCOR |= GPIO_PCOR_PTCO(1 << 18)
