...
void InitClock(void)
{
    ...
    g_sClockSetup.ui16PwmDeadTime  = g_sClockSetup.ui32BusClock / (1000000000U / M1_PWM_DEADTIME);
...
void InitFTM2(void)
{
    ...
    g_sClockSetup.ui16SpeedLoopModulo =
        (g_sClockSetup.ui32BusClock / g_sClockSetup.ui16SlowLoopFreq) >> (FTM2->SC & FTM_SC_PS_MASK);
...
void InitADC16(void)
{
    ...
    /* Bus clock 30MHz during calibration */
    SIM->CLKDIV1 = ((SIM->CLKDIV1 & ~(SIM_CLKDIV1_OUTDIV2_MASK)) | SIM_CLKDIV1_OUTDIV2(3));
    ...
    /* Bus clock back to 60MHz */
    SIM->CLKDIV1 = ((SIM->CLKDIV1 & ~(SIM_CLKDIV1_OUTDIV2_MASK)) | SIM_CLKDIV1_OUTDIV2(1));
...
void InitPDB(void)
{
    ...
    /* PDB interrupt delay */
    PDB0->IDLY = (g_sClockSetup.ui16PwmModulo * M1_FOC_FREQ_VS_PWM_FREQ - g_sClockSetup.ui16PwmModulo / 2);
...
float_t M1_GetIPMTemperature(frac16_t f16RawData)
{
    ...
    fltTemperature =
        ((((IPM_TEMP_APROX_P1 * fltRawData) + IPM_TEMP_APROX_P2) * fltRawData + IPM_TEMP_APROX_P3) * fltRawData +
         IPM_TEMP_APROX_P4) *
            fltRawData +
        IPM_TEMP_APROX_P5;
