...
#define METERLIB_CFG                                                                                                \
    {                                                                                                               \
        U_MAX, I_MAX, FRAC32(((+0.5000) / (U_MAX * I_MAX / 2.0))), FRAC32((+0.0200) / I_MAX),                       \
            {{0l, 0l, 0l}, {0l, 0l, 0l}}, {{0l, 0l, 0l}, {0l, 0l, 0l}}, {{0l, 0l, 0l}, {0l, 0l, 0l}},               \
            {{+32736, -32737, -32706}}, {{+5189, +5189, -32768}}, {{0, 0l}, {0, 0l}}, {0, 0l}, {{0, 0l}, {0, 0l}},  \
            {{0, 0l}, {0, 0l}}, {0, 0l}, {{0, 0l}, {0, 0l}}, {{0, 0l}, {0, 0l}}, {0, 0l}, {{0, 0l}, {0, 0l}},       \
            {41,                                                                                                    \
             {FRAC16(0.0), FRAC16(-0.00099353190431), FRAC16(0.0), FRAC16(-0.00300094510483),                       \
              ...
              FRAC16(0.0)},                                                                                         \
             21,                                                                                                    \
             {FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0),            \
              FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0),            \
              FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(0.0), FRAC16(-1.0)}},         \
            ...
            {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l},   \
            {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l}, {0l, 0l, 0, 0l},   \
            {FRAC32((+0.0000 / (U_MAX * I_MAX))),                                                                   \
             FRAC16(+1.0000),                                                                                       \
             METERLIBLP_KWH_DR(10000),                                                                              \
             {0ll, 0ll, 0ll},                                                                                       \
             0ll,                                                                                                   \
             0l,                                                                                                    \
             FRAC16(-1.0)},                                                                                         \
        {                                                                                                           \
            FRAC32((+0.0000 / (U_MAX * I_MAX))), FRAC16(+1.0000), METERLIBLP_KVARH_DR(10000), {0ll, 0ll, 0ll}, 0ll, \
                0l, FRAC16(-1.0)                                                                                    \
        }                                                                                                           \
    }
