...
void InitClock(void)
{
    ...
    g_sClockSetup.ui16PwmFreq     = PWM_FREQ; /* 20 kHz */
                                               ...
                                               * PWM_MOD = PWM_CLOCK / PWM_FREQUNCY = 60 MHz / 20 kHz = 3000 */
...
void InitFTM0(void)
{
    ...
    /*Enable Clock to port A - Fault pin */
    SIM->SCGC5 |= SIM_SCGC5_PORTA_MASK;

    /*Configure PTA19 as FTM0 fault pin*/
    PORTA->PCR[19] = PORT_PCR_MUX(2);
...
void InitFTM2(void)
{
    ...
    g_sClockSetup.ui16CtrlLoopModulo =
        ((g_sClockSetup.ui32BusClock / g_sClockSetup.ui16CtrlLoopFreq) >> (FTM2->SC & FTM_SC_PS_MASK));
...
void InitADC16(void)
{
    ...
    MCDRV_Adc16Init_hvp_kv31(&g_sM1AdcSensor, &g_sM1Adc16Init);
