...
#define M1_ADC_SVM16_I_PHB_CHN     (0U)
...
#define M1_ADC_SVM23_I_PHA_CHN     (8U)
...
#define M1_ADC_SVM45_I_PHA_CHN     (8U)
#define M1_ADC_SVM45_I_PHB_ADC     (ADC0)
#define M1_ADC_SVM45_I_PHB_CHN     (3U | ADC_SC1_AIEN_MASK)
