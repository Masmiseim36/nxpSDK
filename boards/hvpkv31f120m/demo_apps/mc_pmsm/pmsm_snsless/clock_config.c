...
- {id: Flash_clock.outFreq, value: 15.72864 MHz}
- {id: FlexBus_clock.outFreq, value: 15.72864 MHz}
...
const sim_clock_config_t simConfig_BOARD_BootClockRUN =
    {
        ...
        .clkdiv1 = 0x1330000U,                    /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV2: /2, OUTDIV3: /4, OUTDIV4: /4 */
    };
...
- {id: FlexBus_clock.outFreq, value: 83.88608/3 MHz}
- {id: LPO_clock.outFreq, value: 1 kHz}
- {id: LPUARTCLK.outFreq, value: 4 MHz}
- {id: MCGFFCLK.outFreq, value: 32.768 kHz}
- {id: MCGIRCLK.outFreq, value: 4 MHz}
...
void BOARD_BootClockHSRUN(void)
{
    ...
    CLOCK_BootToFeiMode(mcgConfig_BOARD_BootClockHSRUN.dmx32,
                        ...
                        CLOCK_CONFIG_FllStableDelay);
#else
    CLOCK_BootToFeiMode(mcgConfig_BOARD_BootClockHSRUN.drs,
                        CLOCK_CONFIG_FllStableDelay);
#endif
    /* Set the clock configuration in SIM module. */
