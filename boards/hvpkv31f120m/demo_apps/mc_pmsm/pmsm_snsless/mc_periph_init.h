...
#define M1_PWM_MODULO           (41943040UL / M1_PWM_FREQ)
...
#define M1_SLOW_LOOP_MODULO     (41943040UL / M1_SLOW_LOOP_FREQ)
/* Fast loop period */
...
#define M1_PWM_DEADTIME_LENGTH_DTVAL    (62U)
...
/* Inrush relay pin */
#define M1_INRUSH_SET()         GPIOC->PSOR |= GPIO_PSOR_PTSO(1 << 13)
#define M1_INRUSH_CLEAR()       GPIOC->PCOR |= GPIO_PCOR_PTCO(1 << 13)
