...
#ifndef _MCDRV_HVP_KV31F512_H_
#define _MCDRV_HVP_KV31F512_H_
 ...
 * Valid for Kinetis KV31 HVP board (HVP-KV31F) together with HVP-MC3PH
 *
 ...
 *   --------------------------------------------------------------------------
 *   I_A (pin 53)     | --------      | ADCB_CH8
 *   I_B (pin 20)     | ADCA_CH3      | ADCB_CH0
 *   I_C (pin 18)     | ADCA_CH0      | --------
 *   U_DCB (pin 56)   | --------      | ADCB_CH13
 *   Aux(IPM tmp)     | -             | ADC1_SE7B (PTC11)
 */
