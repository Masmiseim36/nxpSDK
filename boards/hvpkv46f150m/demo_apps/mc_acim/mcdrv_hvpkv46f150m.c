...
void InitClock(void)
{
    ...
    g_sClockSetup.ui16SlowLoopFreq = M1_SPEED_LOOP_FREQ; /* 1kHz */
}
...
void InitPWMA(void)
{
    ...
    PWMA->SM[3].VAL4 = PWM_VAL4_VAL4((uint16_t)(-(g_sClockSetup.ui16PwmModulo / 2) + 28));
...
void InitFTM1(void)
{
    ...
    g_sClockSetup.ui16SpeedLoopModulo =
        (g_sClockSetup.ui32FastPeripheralClock / g_sClockSetup.ui16SlowLoopFreq) >> (FTM1->SC & FTM_SC_PS_MASK);
...
void InitADC12(void)
{
    ...
    /* Auxiliary channel measurement */
    /*  channel Aux = M1_ADC1_UDCB, SAMPLE & RESULT = 9 */
