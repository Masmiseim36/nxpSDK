...
void InitPWMA(void)
{
    ...
    PWMA->SM[3].VAL4 = PWM_VAL4_VAL4((uint16_t)(-(g_sClockSetup.ui16M1PwmModulo / 2) + 28));
...
void InitFTM1(void)
{
    ...
    g_sClockSetup.ui16M1SpeedLoopModulo =
        (g_sClockSetup.ui32FastPeripheralClock / g_sClockSetup.ui16M1SpeedLoopFreq) >> (FTM1->SC & FTM_SC_PS_MASK);
