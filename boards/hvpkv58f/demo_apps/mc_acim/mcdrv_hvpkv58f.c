...
void InitHSADC(void)
{
    ...
    HSADC0->CTRL1 = HSADC_CTRL1_SMODE(5) | HSADC_CTRL1_EOSIEA_MASK | HSADC_CTRL1_SYNCA_MASK;
    HSADC0->CTRL2 = HSADC_CTRL2_SYNCB_MASK | HSADC_CTRL2_DIVA(0x3) | HSADC_CTRL2_SIMULT_MASK;
    ...
    /* HSADC module 1:
       ...
       -stop HSADCD
       -input clock is 25MHz (100MHz Fast Peripheral clock divided by 4) */
    HSADC1->CTRL1 = HSADC_CTRL1_SMODE(4) | HSADC_CTRL1_SYNCA_MASK;
    HSADC1->CTRL2 = HSADC_CTRL2_STOPB_MASK | HSADC_CTRL2_DIVA(0x3);
