...
VERSION:   7.10, ESA 20-SEP-02
           $LastChangedDate: 2020-10-14 17:15:04 +0200 (Wed, 14 Oct 2020) $
...
#if (defined(LPC55S16_SERIES) || defined(LPC55S06_SERIES))
...
void MCOUSER_ResetApplication(void)
{
    ...
    /*
      ...
      config.timeoutValue = 2;
      config.warningValue = 1;
      ...
      while (1) // Now wait until Watchdog hits
      {
      }
      }
    */
