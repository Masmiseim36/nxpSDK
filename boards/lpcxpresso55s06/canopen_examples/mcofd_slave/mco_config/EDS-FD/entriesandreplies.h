...
// Generated from project E:\ESA_new\MicroCANopenPlus\trunk\MCO_CiA401_LPC54xxx_MCUX_SDK\Example-Config\EDS-FD\CANopenFD_NXP_SDK_Device.cax
...
#define OD_1000H_LIST \
  0x000F0191L, /* [0x1000,0x01] Device Type - Device Type 1 (Unsigned32) */ \
...
SDOREPLY(0x1A01, 0x00, 1, 0x00000008L), \
...
/* [0x1A01,0x03] Transmit PDO Mapping Parameter - Mapping 3 (Unsigned32) */ \
SDOREPLY(0x1A01, 0x03, 4, 0x64010310L), \
/* [0x1A01,0x04] Transmit PDO Mapping Parameter - Mapping 4 (Unsigned32) */ \
SDOREPLY(0x1A01, 0x04, 4, 0x64010410L), \
/* [0x1A01,0x05] Transmit PDO Mapping Parameter - Mapping 5 (Unsigned32) */ \
SDOREPLY(0x1A01, 0x05, 4, 0x64010510L), \
/* [0x1A01,0x06] Transmit PDO Mapping Parameter - Mapping 6 (Unsigned32) */ \
SDOREPLY(0x1A01, 0x06, 4, 0x64010610L), \
/* [0x1A01,0x07] Transmit PDO Mapping Parameter - Mapping 7 (Unsigned32) */ \
SDOREPLY(0x1A01, 0x07, 4, 0x64010710L), \
/* [0x1A01,0x08] Transmit PDO Mapping Parameter - Mapping 8 (Unsigned32) */ \
SDOREPLY(0x1A01, 0x08, 4, 0x64010810L), \
\
...
SDOREPLY(0x6401, 0x00, 1, 0x00000008L), \
...
ODGENTRYP(0x1008, 0x00, ODRD, 35, P100800_Manufacturer_Device_Name), \
...
ODGENTRYP(0x2010, 0x00, ODRD+ODWR, 128, P201000_128byte_Buffer_Segmentation_Test), \
...
ODENTRY(0x6401, 0x03, 2+ODRD+RMAP, P640103_AnalogInput16_3), \
ODENTRY(0x6401, 0x04, 2+ODRD+RMAP, P640104_AnalogInput16_4), \
ODENTRY(0x6401, 0x05, 2+ODRD+RMAP, P640105_AnalogInput16_5), \
ODENTRY(0x6401, 0x06, 2+ODRD+RMAP, P640106_AnalogInput16_6), \
ODENTRY(0x6401, 0x07, 2+ODRD+RMAP, P640107_AnalogInput16_7), \
ODENTRY(0x6401, 0x08, 2+ODRD+RMAP, P640108_AnalogInput16_8), \
ODENTRY(0x1000, 0x00, 1+ODRD+COFD, P100000_Highest_Subindex), \
ODENTRY(0x1000, 0x01, 4+ODRD+COFD, P100001_Device_Type_1), \
ODENTRY(0x1002, 0x00, 4+ODRD, P100200_Manufacturer_Status_Register), \
ODENTRY(0x1030, 0x00, 1+ODRD+COFD, P103000_Highest_Subindex), \
ODENTRY(0x1030, 0x01, 4+ODRD+COFD, P103001_Version_Information_1), \
ODENTRY(0x1030, 0x02, 4+ODRD+COFD, P103002_Version_Information_2), \
ODENTRY(0x1031, 0x00, 1+ODRD+COFD, P103100_Highest_Subindex), \
ODENTRY(0x1031, 0x01, 4+ODRD+COFD, P103101_Error_History_Status), \
ODENTRY(0x1031, 0x02, 2+ODRD+ODWR+COFD, P103102_Error_History_Command), \
ODENTRY(0x1031, 0x03, 2+ODRD+ODWR+COFD, P103103_Error_History_Command_Input), \
ODENTRY(0x1031, 0x05, 4+ODRD+ODWR+COFD, P103105_Error_History_Processing), \
ODENTRY(0x1032, 0x00, 1+ODRD+COFD, P103200_Highest_Subindex), \
ODENTRY(0x1032, 0x01, 4+ODRD+COFD, P103201_Error_Event_1), \
ODENTRY(0x1032, 0x02, 4+ODRD+COFD, P103202_Error_Event_2), \
ODENTRY(0x1032, 0x03, 4+ODRD+COFD, P103203_Error_Event_3), \
ODENTRY(0x1032, 0x04, 4+ODRD+COFD, P103204_Error_Event_4), \
...
#define OD_ID_LIST \
  ...
  0x1A0103, /* [0x1A01,0x03] Transmit PDO Mapping Parameter - Mapping 3 (Unsigned32) */ \
  0x1A0104, /* [0x1A01,0x04] Transmit PDO Mapping Parameter - Mapping 4 (Unsigned32) */ \
  0x1A0105, /* [0x1A01,0x05] Transmit PDO Mapping Parameter - Mapping 5 (Unsigned32) */ \
  0x1A0106, /* [0x1A01,0x06] Transmit PDO Mapping Parameter - Mapping 6 (Unsigned32) */ \
  0x1A0107, /* [0x1A01,0x07] Transmit PDO Mapping Parameter - Mapping 7 (Unsigned32) */ \
  0x1A0108, /* [0x1A01,0x08] Transmit PDO Mapping Parameter - Mapping 8 (Unsigned32) */ \
  0x201000, /* [0x2010,0x00] 128byte Buffer Segmentation Test (VisibleString) */ \
  ...
  0x640103, /* [0x6401,0x03] Read Analog Input 16-bit - AnalogInput16_3 (Integer16) */ \
  0x640104, /* [0x6401,0x04] Read Analog Input 16-bit - AnalogInput16_4 (Integer16) */ \
  0x640105, /* [0x6401,0x05] Read Analog Input 16-bit - AnalogInput16_5 (Integer16) */ \
  0x640106, /* [0x6401,0x06] Read Analog Input 16-bit - AnalogInput16_6 (Integer16) */ \
  0x640107, /* [0x6401,0x07] Read Analog Input 16-bit - AnalogInput16_7 (Integer16) */ \
  0x640108, /* [0x6401,0x08] Read Analog Input 16-bit - AnalogInput16_8 (Integer16) */ \
...
#define OD_ID_TYPE \
  ...
  TYPE_UNSIGNED32     , /* [0x1A01,0x03] Transmit PDO Mapping Parameter - Mapping 3 (Unsigned32) */ \
  TYPE_UNSIGNED32     , /* [0x1A01,0x04] Transmit PDO Mapping Parameter - Mapping 4 (Unsigned32) */ \
  TYPE_UNSIGNED32     , /* [0x1A01,0x05] Transmit PDO Mapping Parameter - Mapping 5 (Unsigned32) */ \
  TYPE_UNSIGNED32     , /* [0x1A01,0x06] Transmit PDO Mapping Parameter - Mapping 6 (Unsigned32) */ \
  TYPE_UNSIGNED32     , /* [0x1A01,0x07] Transmit PDO Mapping Parameter - Mapping 7 (Unsigned32) */ \
  TYPE_UNSIGNED32     , /* [0x1A01,0x08] Transmit PDO Mapping Parameter - Mapping 8 (Unsigned32) */ \
  TYPE_VISIBLE_STRING , /* [0x2010,0x00] 128byte Buffer Segmentation Test (VisibleString) */ \
  ...
  TYPE_INTEGER16      , /* [0x6401,0x03] Read Analog Input 16-bit - AnalogInput16_3 (Integer16) */ \
  TYPE_INTEGER16      , /* [0x6401,0x04] Read Analog Input 16-bit - AnalogInput16_4 (Integer16) */ \
  TYPE_INTEGER16      , /* [0x6401,0x05] Read Analog Input 16-bit - AnalogInput16_5 (Integer16) */ \
  TYPE_INTEGER16      , /* [0x6401,0x06] Read Analog Input 16-bit - AnalogInput16_6 (Integer16) */ \
  TYPE_INTEGER16      , /* [0x6401,0x07] Read Analog Input 16-bit - AnalogInput16_7 (Integer16) */ \
  TYPE_INTEGER16      , /* [0x6401,0x08] Read Analog Input 16-bit - AnalogInput16_8 (Integer16) */ \
...
/* WARNING - TABLE OF ENTRY IS UNKNOWN */ \
  ...
  ODLOC_ODENTRY , /* [0x1030,0x00] Version Information - Highest Subindex (Unsigned8) */ \
  ...
  ODLOC_ODENTRY , /* [0x1031,0x00] Active Error History - Highest Subindex (Unsigned8) */ \
  ...
  ODLOC_ODENTRY , /* [0x1031,0x03] Active Error History - Error History Command Input (Unsigned16) */ \
/* WARNING - TABLE OF ENTRY IS UNKNOWN */ \
  ...
  ODLOC_ODENTRY , /* [0x1032,0x00] Active Error List - Highest Subindex (Unsigned8) */ \
  ...
  ODLOC_SDOREPLY, /* [0x1A01,0x03] Transmit PDO Mapping Parameter - Mapping 3 (Unsigned32) */ \
  ODLOC_SDOREPLY, /* [0x1A01,0x04] Transmit PDO Mapping Parameter - Mapping 4 (Unsigned32) */ \
  ODLOC_SDOREPLY, /* [0x1A01,0x05] Transmit PDO Mapping Parameter - Mapping 5 (Unsigned32) */ \
  ODLOC_SDOREPLY, /* [0x1A01,0x06] Transmit PDO Mapping Parameter - Mapping 6 (Unsigned32) */ \
  ODLOC_SDOREPLY, /* [0x1A01,0x07] Transmit PDO Mapping Parameter - Mapping 7 (Unsigned32) */ \
  ODLOC_SDOREPLY, /* [0x1A01,0x08] Transmit PDO Mapping Parameter - Mapping 8 (Unsigned32) */ \
  ODLOC_ODGENTRY, /* [0x2010,0x00] 128byte Buffer Segmentation Test (VisibleString) */ \
  ...
  ODLOC_ODENTRY , /* [0x6401,0x03] Read Analog Input 16-bit - AnalogInput16_3 (Integer16) */ \
  ODLOC_ODENTRY , /* [0x6401,0x04] Read Analog Input 16-bit - AnalogInput16_4 (Integer16) */ \
  ODLOC_ODENTRY , /* [0x6401,0x05] Read Analog Input 16-bit - AnalogInput16_5 (Integer16) */ \
  ODLOC_ODENTRY , /* [0x6401,0x06] Read Analog Input 16-bit - AnalogInput16_6 (Integer16) */ \
  ODLOC_ODENTRY , /* [0x6401,0x07] Read Analog Input 16-bit - AnalogInput16_7 (Integer16) */ \
  ODLOC_ODENTRY , /* [0x6401,0x08] Read Analog Input 16-bit - AnalogInput16_8 (Integer16) */ \
