...
Board settings
==============
Plug SX-ULPAN-2401 or GT202 Adaptor board to stackable headers (P16, P19, P17, P18) or WiFi10Click to headers (P23, P24).

The default compilation settings are predefined for WiFi10Click.
