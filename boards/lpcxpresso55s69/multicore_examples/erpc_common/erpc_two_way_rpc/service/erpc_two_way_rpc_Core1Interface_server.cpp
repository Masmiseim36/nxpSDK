...
static ManuallyConstructed<Core1Interface_service> s_Core1Interface_service;
...
erpc_status_t Core1Interface_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec * codec, MessageBufferFactory *messageFactory)
{
    switch (methodId)
    {
        case kCore1Interface_increaseNumber_id:
            return increaseNumber_shim(codec, messageFactory, sequence);

        case kCore1Interface_getGetCallbackFunction_id:
            return getGetCallbackFunction_shim(codec, messageFactory, sequence);

        case kCore1Interface_getNumberFromCore0_id:
            return getNumberFromCore0_shim(codec, messageFactory, sequence);
...
erpc_service_t create_Core1Interface_service()
{
    s_Core1Interface_service.construct();
    return s_Core1Interface_service.get();
}

void destroy_Core1Interface_service()
{
