...
- ahb:
  ...
  - peripherals:
    - ns_user: {id: ADC0, id: AHB_SECURE_CTRL, id: ANACTRL, id: CASPER, id: CRC_ENGINE, id: CTIMER0, id: CTIMER1, id: CTIMER2, id: CTIMER3, id: CTIMER4, id: DBGMAILBOX,
      ...
      id: SCT0, id: SDIF, id: SECPINT, id: SPI8, id: SYSCTL, id: USB0, id: USBFSH, id: USBHSD, id: USBHSH, id: USBPHY, id: UTICK0, id: WWDT}
    - s_priv: {id: FLEXCOMM0, id: IOCON, id: SECGPIO, id: SYSCON}
  - interrupts:
    - masking:
...
- sau:
  ...
  - regions:
    ...
    - region: {index: '2', enabled: 'false', security: nsc, start: '0x1000FE00', size: '0x00000200'}
...
- user_memory_regions:
  - user_memory_region: {id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x00010000'}
  - user_memory_region: {id: Region_2, security: s_priv, name: Secure Stack and Data, start: '0x30000000', size: '0x00008000'}
  - user_memory_region: {id: Region_3, security: ns_user, name: Non-secure Code, description: Privilege check is disabled so reset value (NS-User) can be used,
    start: '0x00010000', size: '0x00062000'}
  - user_memory_region: {id: Region_4, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can
...
void BOARD_InitTrustZone()
{
    ...
    AHB_SECURE_CTRL->SEC_CTRL_AHB_PORT10[0].SLAVE1_RULE                    = 0x00000003U;
