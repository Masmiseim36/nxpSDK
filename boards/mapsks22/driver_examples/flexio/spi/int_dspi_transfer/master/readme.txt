...
Board settings
==============
The flexio_spi_master_interrupt_dspi_slave example is configured to use UART1 with PTE0 and PTE1 pins. To make JLink
...
The flexio_spi_master_interrupt_dspi_slave example is configured to use FLEXIO D0, D1, D2 and D3 with PTC12, PTC13,
PTC14 and PTC15 to simulate spi master and communicate with a on board dspi slave, with pin connections below:
