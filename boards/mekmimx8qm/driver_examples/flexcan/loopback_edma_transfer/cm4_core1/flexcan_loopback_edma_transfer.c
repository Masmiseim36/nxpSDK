...
#define EXAMPLE_CAN_DMA DMA__EDMA1
#define EXAMPLE_CAN_DMA_CHANNEL 26
...
int main(void)
{
    ...
    if (sc_pm_set_resource_power_mode(ipc, SC_R_DMA_1_CH26, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, DMA_FLEXCAN0_DMA_INT_IRQn);
