...
If use MAX9286+OV10635, change step 3 and step 4, connect MAX9286 IMX8 DEMO board J9
and MAXCAM10635EVKIT, make sure J15 on MAX9286 IMX8 DEMO board is shorten. Then connect
MAX9286 IMX8 DEMO board to CPU board J10 use X-IMX-VAL-SAS cable. In isi_config.h, change
