 ...
 * Definitions
 ******************************************************************************/
#define DEMO_LPADC_BASE DMA__ADC0
#define DEMO_LPADC_USER_CHANNEL 0U
#define DEMO_LPADC_USER_CMDID 1U /* The available command number are 1-15 */

#define DEMO_LPADC_IRQn DMA_ADC0_INT_IRQn
#define DEMO_LPADC_IRQ_HANDLER_FUNC DMA_ADC0_INT_IRQHandler
...
int main(void)
{
    ...
    IRQSTEER_EnableInterrupt(IRQSTEER, DMA_ADC0_INT_IRQn);
