 ...
 * Definitions
 ******************************************************************************/
#define APP_SEMA42 CM4_1__SEMA42
#define APP_SEMA42_GATE 0
#define APP_CORTEX_M_DID 4
#define APP_CORTEX_A_DID 0
#define APP_SEMA42_GATE_ADDR 0x3b1b0003 /* Remote address of the SEMA42 gate. */
...
int main(void)
{
    ...
    if (sc_pm_set_resource_power_mode(ipc, SC_R_M4_1_SEMA42, SC_PM_PW_MODE_ON) != SC_ERR_NONE)
    {
        PRINTF("Error: Failed to power on SEMA42\r\n");
    }

    /* Set M4 SEMA42 permissions for all other partitions */
    if (sc_rm_set_peripheral_permissions(ipc, SC_R_M4_1_SEMA42, SC_RM_PT_ALL, SC_RM_PERM_FULL) != SC_ERR_NONE)
    {
