...
#define BOARD_INITPINSEX_FTDI_M40_UART0_RX_PERIPHERAL                 M40__UART0   /*!< Device name: M40__UART0 */
#define BOARD_INITPINSEX_FTDI_M40_UART0_RX_SIGNAL                        uart_rx   /*!< M40__UART0 signal: uart_rx */
#define BOARD_INITPINSEX_FTDI_M40_UART0_RX_PIN_NAME                 M40_I2C0_SCL   /*!< Pin name */
#define BOARD_INITPINSEX_FTDI_M40_UART0_RX_PIN_FUNCTION_ID     SC_P_M40_I2C0_SCL   /*!< Pin function id */
#define BOARD_INITPINSEX_FTDI_M40_UART0_RX_LABEL             "FTDI_M40_UART0_RX"   /*!< Label */
#define BOARD_INITPINSEX_FTDI_M40_UART0_RX_NAME              "FTDI_M40_UART0_RX"   /*!< Identifier name */

/* M40_I2C0_SDA (number AU51), FTDI_M40_UART0_TX */
#define BOARD_INITPINSEX_FTDI_M40_UART0_TX_PERIPHERAL                 M40__UART0   /*!< Device name: M40__UART0 */
#define BOARD_INITPINSEX_FTDI_M40_UART0_TX_SIGNAL                        uart_tx   /*!< M40__UART0 signal: uart_tx */
#define BOARD_INITPINSEX_FTDI_M40_UART0_TX_PIN_NAME                 M40_I2C0_SDA   /*!< Pin name */
#define BOARD_INITPINSEX_FTDI_M40_UART0_TX_PIN_FUNCTION_ID     SC_P_M40_I2C0_SDA   /*!< Pin function id */
#define BOARD_INITPINSEX_FTDI_M40_UART0_TX_LABEL             "FTDI_M40_UART0_TX"   /*!< Label */
#define BOARD_INITPINSEX_FTDI_M40_UART0_TX_NAME              "FTDI_M40_UART0_TX"   /*!< Identifier name */
 ...
 *
 */
void BOARD_InitPinsEx(sc_ipc_t ipc);                       /*!< Function assigned for the core: Cortex-M4F[cm4_0] */
