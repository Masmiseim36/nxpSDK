 ...
 */
void M4_0_LPIT_IRQHandler(void)
{
    vPortLpitIsr();
}
...
/* Define the init structure for the input switch pin */
    ...
    LPIT_Init(CM4_0__LPIT, &lpitConfig);
    ...
    /* Init lpit channel 0 */
    LPIT_SetupChannel(CM4_0__LPIT, kLPIT_Chnl_0, &lpitChannelConfig);
    /* Enable timer interrupts for channel 0 */
    LPIT_EnableInterrupts(CM4_0__LPIT, kLPIT_Channel0TimerInterruptEnable);
#endif
