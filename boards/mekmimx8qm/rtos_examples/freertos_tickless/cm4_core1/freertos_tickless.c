 ...
 */
void M4_1_LPIT_IRQHandler(void)
{
    vPortLpitIsr();
}
...
/* Define the init structure for the input switch pin */
    ...
    if (CLOCK_SetIpFreq(kCLOCK_M4_1_Lpit, SC_66MHZ) == 0)
    {
    ...
    LPIT_Init(CM4_1__LPIT, &lpitConfig);
    ...
    /* Init lpit channel 0 */
    LPIT_SetupChannel(CM4_1__LPIT, kLPIT_Chnl_0, &lpitChannelConfig);
    /* Enable timer interrupts for channel 0 */
    LPIT_EnableInterrupts(CM4_1__LPIT, kLPIT_Channel0TimerInterruptEnable);
#endif
