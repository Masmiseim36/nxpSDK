...
NOTES:
1. DSP image can only be debugged using J-Link debugger. See again 'Getting Started with Xplorer for MIMXRT685-AUD-EVK.pdf' for more information.
2. The example is set to use EAP16 by default. In order to use EAP32 it is necessary to remove the EAP16 library from xcc/xtensa linker project settings
   and replace EAP_PROC with EAP32_PROC.
