...
#define kMEMORY_DMA2Local ARM_BUS_NON_CACHEABLE_NONSECURE
    ...
    switch (msg->head.command)
    {
        ...
        case SRTM_Command_xa_nn_matXvec_16x16_16:
            rc = xa_nn_matXvec_16x16_16(
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local), // p_out
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local), // p_mat1
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local), // p_mat2
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local), // p_vec1
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local), // p_vec2
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local), // p_bias
        ...
        case SRTM_Command_xa_nn_matXvec_16x16_32:
            rc = xa_nn_matXvec_16x16_32(
                (signed int *)MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local),   // p_out
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local), // p_mat1
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local), // p_mat2
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local), // p_vec1
                (signed short *)MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local), // p_vec2
        ...
        case SRTM_Command_xa_nn_matXvec_16x16_64:
            rc = xa_nn_matXvec_16x16_64(
                (signed long long *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),     // p_mat1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)),     // p_mat2
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),     // p_vec1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)),     // p_vec2
        ...
        case SRTM_Command_xa_nn_matXvec_16x16_16_tanh:
            rc = xa_nn_matXvec_16x16_16_tanh(
                ...
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)),         // p_bias
                (signed int)(msg->param[6]),                                                        // rows
                (signed int)(msg->param[7]),                                                        // cols1
                (signed int)(msg->param[8]),                                                        // cols2
                (signed int)(msg->param[9]),                                                        // row_stride1
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[14], kMEMORY_DMA2Local))         // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_matXvec_16x16_16_sigmoid:
            rc = xa_nn_matXvec_16x16_16_sigmoid(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_mat2
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)), // p_vec2
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[6], kMEMORY_DMA2Local)),         // p_bias
                (signed int)(msg->param[6]),                                                        // rows
                (signed int)(msg->param[7]),                                                        // cols1
                (signed int)(msg->param[8]),                                                        // cols2
                (signed int)(msg->param[9]),                                                        // row_stride1
        ...
        case SRTM_Command_xa_nn_matXvec_batch_16x16_64:
            rc = xa_nn_matXvec_batch_16x16_64(
                (signed long long **)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),      // p_mat1
                (signed short **)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),     // p_vec1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),      // p_bias
        ...
        case SRTM_Command_xa_nn_matmul_16x16_16:
            rc = xa_nn_matmul_16x16_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                              // rows
        ...
        case SRTM_Command_xa_nn_matXvec_8x16_16:
            rc = xa_nn_matXvec_8x16_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_mat1
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)),  // p_mat2
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[6]),                                                        // rows
        ...
        case SRTM_Command_xa_nn_matXvec_batch_8x16_64:
            rc = xa_nn_matXvec_batch_8x16_64(
                (signed long long **)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),       // p_mat1
                (signed short **)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)),     // p_vec1
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),      // p_bias
                (signed int)(msg->param[4]),                                                             // rows
                (signed int)(msg->param[5]),                                                             // cols1
                (signed int)(msg->param[6]),                                                             // row_stride1
                (signed int)(msg->param[7]),                                                             // acc_shift
        ...
        case SRTM_Command_xa_nn_matmul_8x16_16:
            rc = xa_nn_matmul_8x16_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_mat1
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                              // rows
                (signed int)(msg->param[5]),                                                              // cols
        ...
        case SRTM_Command_xa_nn_matXvec_8x8_8:
            rc = xa_nn_matXvec_8x8_8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[6]),                                                       // rows
                (signed int)(msg->param[7]),                                                       // cols1
                (signed int)(msg->param[8]),                                                       // cols2
                (signed int)(msg->param[9]),                                                       // row_stride1
        ...
        case SRTM_Command_xa_nn_matXvec_batch_8x8_32:
            rc = xa_nn_matXvec_batch_8x8_32(
                (signed int **)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),  // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_mat1
                (signed char **)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_vec1
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),  // p_bias
                (signed int)(msg->param[4]),                                                        // rows
                (signed int)(msg->param[5]),                                                        // cols1
                (signed int)(msg->param[6]),                                                        // row_stride1
                (signed int)(msg->param[7]),                                                        // acc_shift
        ...
        case SRTM_Command_xa_nn_matmul_8x8_8:
            rc = xa_nn_matmul_8x8_8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                             // rows
                (signed int)(msg->param[5]),                                                             // cols
                (signed int)(msg->param[6]),                                                             // row_stride
                (signed int)(msg->param[7]),                                                             // acc_shift
        ...
        case SRTM_Command_xa_nn_matXvec_f32xf32_f32_sigmoid:
            rc = xa_nn_matXvec_f32xf32_f32_sigmoid(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[6]),                                                 // rows
                (signed int)(msg->param[7]),                                                 // cols1
                (signed int)(msg->param[8]),                                                 // cols2
                (signed int)(msg->param[9]),                                                 // row_stride1
                (signed int)(msg->param[10]),                                                // row_stride2
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[11], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_matXvec_f32xf32_f32:
            rc = xa_nn_matXvec_f32xf32_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[6]),                                                       // rows
                (signed int)(msg->param[7]),                                                       // cols1
                (signed int)(msg->param[8]),                                                       // cols2
                (signed int)(msg->param[9]),                                                       // row_stride1
        ...
        case SRTM_Command_xa_nn_matXvec_batch_f32xf32_f32:
            rc = xa_nn_matXvec_batch_f32xf32_f32(
                (float **)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_mat1
                (float **)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_vec1
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),  // p_bias
                (signed int)(msg->param[4]),                                                  // rows
                (signed int)(msg->param[5]),                                                  // cols1
                (signed int)(msg->param[6]),                                                  // row_stride1
        ...
        case SRTM_Command_xa_nn_matmul_f32xf32_f32:
            rc = xa_nn_matmul_f32xf32_f32(
                ...
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                       // rows
                (signed int)(msg->param[5]),                                                       // cols
                (signed int)(msg->param[6]),                                                       // row_stride
                (signed int)(msg->param[7]),                                                       // vec_count
        ...
        case SRTM_Command_xa_nn_matXvec_asym8uxasym8u_asym8u:
            rc = xa_nn_matXvec_asym8uxasym8u_asym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)),    // p_bias
                (signed int)(msg->param[6]),                                                               // rows
                (signed int)(msg->param[7]),                                                               // cols1
                (signed int)(msg->param[8]),                                                               // cols2
                (signed int)(msg->param[9]),  // row_stride1
        ...
        case SRTM_Command_xa_nn_matXvec_sym8sxasym8s_asym8s:
            rc = xa_nn_matXvec_sym8sxasym8s_asym8s(
                ...
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_mat2
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_vec1
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)), // p_vec2
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)),  // p_bias
                (signed int)(msg->param[6]),                                                             // rows
                (signed int)(msg->param[7]),                                                             // cols1
                (signed int)(msg->param[8]),                                                             // cols2
        ...
        case SRTM_Command_xa_nn_matXvec_out_stride_sym8sxasym8s_16:
            rc = xa_nn_matXvec_out_stride_sym8sxasym8s_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),      // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_mat1
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_vec1
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),  // p_bias
                (signed int)(msg->param[4]),                                                             // rows
                (signed int)(msg->param[5]),                                                             // cols1
                (signed int)(msg->param[6]),                                                             // row_stride1
        ...
        case SRTM_Command_xa_nn_vec_sigmoid_32_32:
            rc = xa_nn_vec_sigmoid_32_32(
                (signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_vec
        ...
        case SRTM_Command_xa_nn_vec_sigmoid_f32_f32:
            rc = xa_nn_vec_sigmoid_f32_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_vec
                (signed int)(msg->param[2])                                                        // vec_length
            );
        ...
        case SRTM_Command_xa_nn_vec_relu_16_16:
            rc = xa_nn_vec_relu_16_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_vec
        ...
        case SRTM_Command_xa_nn_vec_relu_8_8:
            rc = xa_nn_vec_relu_8_8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_vec
        ...
        case SRTM_Command_xa_nn_vec_interpolation_q15:
            rc = xa_nn_vec_interpolation_q15(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_ifact
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp1
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_inp2
        ...
        case SRTM_Command_xa_nn_conv1d_std_8x16:
            rc = xa_nn_conv1d_std_8x16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)),  // p_kernel
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[15], kMEMORY_DMA2Local))         // p_handle
            );
        ...
        case SRTM_Command_xa_nn_conv1d_std_8x8:
            rc = xa_nn_conv1d_std_8x8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_kernel
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                       // input_height
                (signed int)(msg->param[5]),                                                       // input_width
        ...
        case SRTM_Command_xa_nn_conv1d_std_16x16:
            rc = xa_nn_conv1d_std_16x16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_kernel
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                        // input_height
                (signed int)(msg->param[5]),                                                        // input_width
                (signed int)(msg->param[6]),                                                        // input_channels
        ...
        case SRTM_Command_xa_nn_conv1d_std_f32:
            rc = xa_nn_conv1d_std_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_kernel
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                 // input_height
                (signed int)(msg->param[5]),                                                 // input_width
                (signed int)(msg->param[6]),                                                 // input_channels
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[13], kMEMORY_DMA2Local))  // p_handle
            );
        ...
        case SRTM_Command_xa_nn_conv2d_std_8x16:
            ...
            rc = xa_nn_conv2d_std_8x16(
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[19], kMEMORY_DMA2Local))       // p_handle
            );
        ...
        case SRTM_Command_xa_nn_conv2d_std_f32:
            rc = xa_nn_conv2d_std_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_kernel
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                       // input_height
                (signed int)(msg->param[5]),                                                       // input_width
                (signed int)(msg->param[6]),                                                       // input_channels
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[17], kMEMORY_DMA2Local))        // p_handle
            );
        ...
        case SRTM_Command_xa_nn_conv2d_pointwise_f32:
            rc = xa_nn_conv2d_pointwise_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                 // input_height
                (signed int)(msg->param[5]),                                                 // input_width
                (signed int)(msg->param[6]),                                                 // input_channels
        ...
        case SRTM_Command_xa_nn_conv2d_pointwise_8x16:
            rc = xa_nn_conv2d_pointwise_8x16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_kernel
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                        // input_height
                (signed int)(msg->param[5]),                                                        // input_width
                (signed int)(msg->param[6]),                                                        // input_channels
        ...
        case SRTM_Command_xa_nn_conv2d_pointwise_8x8:
            rc = xa_nn_conv2d_pointwise_8x8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                       // input_height
                (signed int)(msg->param[5]),                                                       // input_width
                (signed int)(msg->param[6]),                                                       // input_channels
        ...
        case SRTM_Command_xa_nn_conv2d_depthwise_8x8:
            rc = xa_nn_conv2d_depthwise_8x8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                             // input_height
                (signed int)(msg->param[5]),                                                             // input_width
                (signed int)(msg->param[6]),                                                // input_channels
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[20], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_conv2d_depthwise_f32:
            rc = xa_nn_conv2d_depthwise_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                       // input_height
                (signed int)(msg->param[5]),                                                       // input_width
                (signed int)(msg->param[6]),                                                       // input_channels
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[18], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_conv2d_depthwise_8x16:
            rc = xa_nn_conv2d_depthwise_8x16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_kernel
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                // input_height
                (signed int)(msg->param[5]),                                                // input_width
                (signed int)(msg->param[6]),                                                // input_channels
        ...
        case SRTM_Command_xa_nn_conv2d_depthwise_16x16:
            rc = xa_nn_conv2d_depthwise_16x16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                // input_height
                (signed int)(msg->param[5]),                                                // input_width
        ...
        case SRTM_Command_xa_nn_conv2d_pointwise_16x16:
            rc = xa_nn_conv2d_pointwise_16x16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                        // input_height
                (signed int)(msg->param[5]),                                                        // input_width
        ...
        case SRTM_Command_xa_nn_avgpool_8:
            rc = xa_nn_avgpool_8(
                (signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local),       // p_out
                (const signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local), // p_inp
                ...
                (signed int)(msg->param[13]),                                               // inp_data_format
                (signed int)(msg->param[14]),                                               // out_data_format
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[15], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_avgpool_16:
            rc = xa_nn_avgpool_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (signed int)(msg->param[2]),                                                // input_height
                (signed int)(msg->param[3]),                                                // input_width
                (signed int)(msg->param[4]),                                                // input_channels
                (signed int)(msg->param[5]),                                                // kernel_height
        ...
        case SRTM_Command_xa_nn_avgpool_asym8u:
            rc = xa_nn_avgpool_asym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (signed int)(msg->param[2]),                                                // input_height
                (signed int)(msg->param[3]),                                                // input_width
                (signed int)(msg->param[4]),                                                // input_channels
                (signed int)(msg->param[5]),                                                // kernel_height
        ...
        case SRTM_Command_xa_nn_fully_connected_f32:
            rc = xa_nn_fully_connected_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_weight
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
        ...
        case SRTM_Command_xa_nn_fully_connected_16x16_16:
            rc = xa_nn_fully_connected_16x16_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_weight
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                        // weight_depth
                (signed int)(msg->param[5]),                                                        // out_depth
        ...
        case SRTM_Command_xa_nn_fully_connected_8x16_16:
            rc = xa_nn_fully_connected_8x16_16(
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_weight
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_bias
                (signed int)(msg->param[4]),                                                        // weight_depth
                (signed int)(msg->param[5]),                                                        // out_depth
        ...
        case SRTM_Command_xa_nn_fully_connected_asym8uxasym8u_asym8u:
            rc = xa_nn_fully_connected_asym8uxasym8u_asym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_weight
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),    // p_bias
                (signed int)(msg->param[4]), // weight_depth
                (signed int)(msg->param[5]), // out_depth
        ...
        case SRTM_Command_xa_nn_fully_connected_sym8sxasym8s_asym8s:
            rc = xa_nn_fully_connected_sym8sxasym8s_asym8s(
                (signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local),       // p_out
                (const signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local), // p_weight
                (const signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local), // p_inp
                (const signed int *)MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local),  // p_bias
                (signed int)(msg->param[4]),                                                           // weight_depth
                (signed int)(msg->param[5]),                                                           // out_depth
        ...
        case SRTM_Command_xa_nn_vec_activation_min_max_asym8u_asym8u:
            rc = xa_nn_vec_activation_min_max_asym8u_asym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_vec
        ...
        case SRTM_Command_xa_nn_vec_softmax_asym8u_asym8u:
            rc = xa_nn_vec_softmax_asym8u_asym8u(
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[6], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_vec_prelu_asym8s_asym8s:
            rc = xa_nn_vec_prelu_asym8s_asym8s(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_vec
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_vec_alpha
        ...
        case SRTM_Command_xa_nn_conv1d_std_asym8uxasym8u:
            rc = xa_nn_conv1d_std_asym8uxasym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_kernel
        ...
        case SRTM_Command_xa_nn_conv2d_std_asym8uxasym8u:
            rc = xa_nn_conv2d_std_asym8uxasym8u(
                (unsigned char *)MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local),       // p_out
                (const unsigned char *)MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local), // p_inp
                (const unsigned char *)MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local), // p_kernel
                (const signed int *)MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local),    // p_bias
                (signed int)(msg->param[4]),                                                             // input_height
                (signed int)(msg->param[5]),                                                             // input_width
                (signed int)(msg->param[6]),                                                // input_channels
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[22], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_conv2d_std_per_chan_sym8sxasym8s:
            rc = xa_nn_conv2d_std_per_chan_sym8sxasym8s(
                (signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local),       // p_out
                (const signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local), // p_inp
                (const signed char *)MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local), // p_kernel
                (const signed int *)MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local),  // p_bias
                (signed int)(msg->param[4]),                                                           // input_height
                (signed int)(msg->param[5]),                                                           // input_width
                (signed int)(msg->param[6]),                                                           // input_channels
                ...
                (signed int)(msg->param[15]),                                                          // out_width
                (signed int)(msg->param[16]),                                                      // input_zero_bias
                (signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[17], kMEMORY_DMA2Local)), // p_out_multiplier
                (signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[18], kMEMORY_DMA2Local)), // p_out_shift
                (signed int)(msg->param[19]),                                                      // out_zero_bias
                (signed int)(msg->param[20]),                                                      // out_data_format
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[21], kMEMORY_DMA2Local))        // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_matXvec_batch_asym8uxasym8u_asym8u:
            rc = xa_nn_matXvec_batch_asym8uxasym8u_asym8u(
                (unsigned char **)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_mat1
                (unsigned char **)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_vec1
                (signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),     // p_bias
                (signed int)(msg->param[4]),                                                          // rows
                (signed int)(msg->param[5]),                                                          // cols1
                (signed int)(msg->param[6]),                                                          // row_stride1
                (signed int)(msg->param[7]),                                                          // vec_count
        ...
        case SRTM_Command_xa_nn_conv2d_depthwise_asym8uxasym8u:
            rc = xa_nn_conv2d_depthwise_asym8uxasym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),    // p_bias
                (signed int)(msg->param[4]),                                                // input_height
                (signed int)(msg->param[5]),                                                // input_width
                ...
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[23], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_conv2d_pointwise_asym8uxasym8u:
            rc = xa_nn_conv2d_pointwise_asym8uxasym8u(
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // p_out
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_kernel
                (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),    // p_bias
                (signed int)(msg->param[4]),                                                         // input_height
                (signed int)(msg->param[5]),                                                         // input_width
                (signed int)(msg->param[6]),                                                         // input_channels
        ...
        case SRTM_Command_xa_nn_elm_mul_f32xf32_f32:
            rc = xa_nn_elm_mul_f32xf32_f32(
                (float *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp1
                (const float *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp2
        ...
        case SRTM_Command_xa_nn_elm_add_asym8uxasym8u_asym8u:
            rc = xa_nn_elm_add_asym8uxasym8u_asym8u(
                ...
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[6], kMEMORY_DMA2Local)), // p_inp1
                (signed int)(msg->param[7]), // inp1_zero_bias
                (signed int)(msg->param[8]), // inp1_left_shift
                (signed int)(msg->param[9]), // inp1_multiplier
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[10], kMEMORY_DMA2Local)), // p_inp2
        ...
        case SRTM_Command_xa_nn_elm_add_asym8sxasym8s_asym8s:
            rc = xa_nn_elm_add_asym8sxasym8s_asym8s(
                ...
                (signed int)(msg->param[4]),                                                       // out_activation_min
                (signed int)(msg->param[5]),                                                       // out_activation_max
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[6], kMEMORY_DMA2Local)), // p_inp1
                (signed int)(msg->param[7]), // inp1_zero_bias
                (signed int)(msg->param[8]), // inp1_left_shift
                (signed int)(msg->param[9]), // inp1_multiplier
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[10], kMEMORY_DMA2Local)), // p_inp2
                (signed int)(msg->param[11]), // inp2_zero_bias
                (signed int)(msg->param[12]), // inp2_left_shift
                (signed int)(msg->param[13]), // inp2_multiplier
                (signed int)(msg->param[14]), // left_shift
        ...
        case SRTM_Command_xa_nn_elm_mul_asym8uxasym8u_asym8u:
            rc = xa_nn_elm_mul_asym8uxasym8u_asym8u(
                ...
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[6], kMEMORY_DMA2Local)), // p_inp1
                (signed int)(msg->param[7]), // inp1_zero_bias
                (const unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[8], kMEMORY_DMA2Local)), // p_inp2
        ...
        case SRTM_Command_xa_nn_elm_mul_asym8sxasym8s_asym8s:
            rc = xa_nn_elm_mul_asym8sxasym8s_asym8s(
                ...
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[6], kMEMORY_DMA2Local)), // p_inp1
                (signed int)(msg->param[7]), // inp1_zero_bias
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[8], kMEMORY_DMA2Local)), // p_inp2
                (signed int)(msg->param[9]), // inp2_zero_bias
                (signed int)(msg->param[10]) // num_elm
            );
        ...
        case SRTM_Command_xa_nn_elm_max_8x8_8:
            rc = xa_nn_elm_max_8x8_8(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_in1
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_in2
        ...
        case SRTM_Command_xa_nn_elm_equal_asym8sxasym8s:
            rc = xa_nn_elm_equal_asym8sxasym8s(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp1
                (signed int)(msg->param[2]), // inp1_zero_bias
                (signed int)(msg->param[3]), // inp1_shift
                (signed int)(msg->param[4]), // inp1_multiplier
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[5], kMEMORY_DMA2Local)), // p_inp2
        ...
        case SRTM_Command_xa_nn_reduce_max_getsize_nhwc:
            rc = xa_nn_reduce_getsize_nhwc(
                ...
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp_shape
                (signed int)(msg->param[2]),                                                            // num_inp_dims
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // p_axis
        ...
        case SRTM_Command_xa_nn_reduce_max_4D_asym8s_asym8s:
            rc = xa_nn_reduce_max_4D_asym8s_asym8s(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)),  // p_out_shape
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)),  // p_inp_shape
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[4], kMEMORY_DMA2Local)),  // p_axis
                (signed int)(msg->param[5]),                                                             // num_out_dims
                (signed int)(msg->param[6]),                                                             // num_inp_dims
                (signed int)(msg->param[7]),                                               // num_axis_dims
                (void *)(MEMORY_ConvertMemoryMapAddress(msg->param[8], kMEMORY_DMA2Local)) // p_scratch
            );
        ...
        case SRTM_Command_xa_nn_elm_logicaland_boolxbool_bool:
            rc = xa_nn_elm_logicaland_boolxbool_bool(
                (signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)),       // p_out
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // p_inp1
                (const signed char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local)), // p_inp2
                (signed int)(msg->param[3])                                                              // num_elm
            );
        ...
        case SRTM_Command_xa_nn_dot_prod_16x16_asym8s:
            rc = xa_nn_dot_prod_16x16_asym8s(
                ...
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[1],
                                                                      kMEMORY_DMA2Local)), // p_inp1_start
                (const signed short *)(MEMORY_ConvertMemoryMapAddress(msg->param[2],
                                                                      kMEMORY_DMA2Local)),              // p_inp2_start
                (const signed int *)(MEMORY_ConvertMemoryMapAddress(msg->param[3], kMEMORY_DMA2Local)), // bias_ptr
                (signed int)(msg->param[4]),                                                            // vec_length
                (signed int)(msg->param[5]), // out_multiplier
                (signed int)(msg->param[6]), // out_shift
                (signed int)(msg->param[7]), // out_zero_bias
        ...
        case SRTM_Command_inference:
            model((unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[0], kMEMORY_DMA2Local)), // constantWeight
                  (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[1], kMEMORY_DMA2Local)), // mutableWeight
                  (unsigned char *)(MEMORY_ConvertMemoryMapAddress(msg->param[2], kMEMORY_DMA2Local))  // activations
            );
