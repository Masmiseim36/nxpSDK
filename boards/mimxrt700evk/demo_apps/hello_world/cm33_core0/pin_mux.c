...
- pin_list:
  ...
  - {pin_num: V11, peripheral: SWD, signal: SWO, pin_signal: PIO8_3/LP_FLEXCOMM17_P3/CTIMER_S_INP1/UTICK1_CAP0/JTAG_TDO, pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port8_pin3_config = (/* Pin is configured as SWD_OUT */
                                        IOPCTL_PIO_FUNC5 |
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT8 PIN3 (coords: V11) is configured as SWD_OUT */
    IOPCTL_PinMuxSet(8U, 3U, port8_pin3_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
