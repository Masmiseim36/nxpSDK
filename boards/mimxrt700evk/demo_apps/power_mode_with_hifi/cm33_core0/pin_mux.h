...
/*!
 * @brief Slew Rate Control: Disables. Standard mode. */
#define PMIC_I2C_SCL_SLEWRATE_SLEWRATE_0 0x00u
/*!
 * @brief Input Buffer Enable: Enables */
...
/*!
 * @brief Slew Rate Control: Disables, in standard mode. */
#define PMIC_I2C_SDA_SLEWRATE_SLEWRATE_0 0x00u
