...
- pin_list:
  ...
  - {pin_num: N10, peripheral: ACMP0, signal: 'IN, 4', pin_signal: PIO10_17/PDM_DATA67/SDADC_INN3/CMP0_IND, input_buffer: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port10_pin17_config = (/* Pin is configured as CMP0_IND */
                                          IOPCTL_PIO_FUNC0 |
                                          /* Disable pull-up / pull-down function */
                                          IOPCTL_PIO_PUPD_DI |
                                          /* Enable pull-down function */
                                          ...
                                          /* Input function is not inverted */
                                          IOPCTL_PIO_INV_DI);
    /* PORT10 PIN17 (coords: N10) is configured as CMP0_IND */
    IOPCTL_PinMuxSet(10U, 17U, port10_pin17_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
