...
- pin_list:
  ...
  - {pin_num: N16, peripheral: CTIMER5, signal: 'MATCH, 2', pin_signal: PIO8_23/SAI3_RX_BCLK/CTIMER5_MAT2/LP_FLEXCOMM19_P0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port8_pin23_config = (/* Pin is configured as CTIMER5_MAT2 */
                                         IOPCTL_PIO_FUNC2 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT8 PIN23 (coords: N16) is configured as CTIMER5_MAT2 */
