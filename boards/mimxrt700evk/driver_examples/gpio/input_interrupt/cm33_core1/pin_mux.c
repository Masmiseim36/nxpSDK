...
- pin_list:
  ...
  - {pin_num: U13, peripheral: GPIO8, signal: 'GPIO, 5', pin_signal: PIO8_5/LP_FLEXCOMM17_P0/CTIMER5_MAT3/CTIMER_S_INP0, input_buffer: enable}
  - {pin_num: T13, peripheral: GPIO8, signal: 'GPIO, 6', pin_signal: PIO8_6/LP_FLEXCOMM17_P1/CTIMER6_MATCH0/CMP0_OUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
