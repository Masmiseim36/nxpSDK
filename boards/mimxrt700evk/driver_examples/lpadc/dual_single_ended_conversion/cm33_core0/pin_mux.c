...
- pin_list:
  ...
  - {pin_num: P17, peripheral: ADC0, signal: 'CH, 19', pin_signal: PIO10_3/PDM_DATA45/ADC0_B1}
  - {pin_num: R17, peripheral: ADC0, signal: 'CH, 0', pin_signal: PIO10_0/PDM_CLK/ADC0_A0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port10_pin0_config = (/* Pin is configured as ADC0_A0 */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT10 PIN0 (coords: R17) is configured as ADC0_A0 */
    IOPCTL_PinMuxSet(10U, 0U, port10_pin0_config);

    const uint32_t port10_pin3_config = (/* Pin is configured as ADC0_B1 */
                                         IOPCTL_PIO_FUNC0 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT10 PIN3 (coords: P17) is configured as ADC0_B1 */
