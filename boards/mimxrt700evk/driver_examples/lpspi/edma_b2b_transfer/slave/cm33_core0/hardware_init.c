...
void BOARD_InitHardware(void)
{
    ...
    EDMA_EnableRequest(EXAMPLE_LPSPI_SLAVE_DMA_BASE, DEMO_LPSPI_TRANSMIT_EDMA_CHANNEL);
    EDMA_EnableRequest(EXAMPLE_LPSPI_SLAVE_DMA_BASE, DEMO_LPSPI_RECEIVE_EDMA_CHANNEL);
