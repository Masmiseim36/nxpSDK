...
- pin_list:
  ...
  - {pin_num: R1, peripheral: LP_FLEXCOMM2, signal: P1, pin_signal: PIO1_12/LP_FLEXCOMM2_P1/SCT0_GPIN3/SCT0_OUT9/CTIMER1_MAT1/SWD_TRACEDATA1, open_drain: enable,
    input_buffer: enable}
  - {pin_num: T14, peripheral: SDADC, signal: 'INP, 0', pin_signal: PIO10_6}
  - {pin_num: U15, peripheral: SDADC, signal: 'INP, 1', pin_signal: PIO10_12/PDM_DATA67/ADC0_A4/SDADC_INP1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port10_pin12_config = (/* Pin is configured as SDADC_INP1 */
                                          IOPCTL_PIO_FUNC0 |
                                          /* Disable pull-up / pull-down function */
                                          IOPCTL_PIO_PUPD_DI |
                                          /* Enable pull-down function */
                                          ...
                                          /* Input function is not inverted */
                                          IOPCTL_PIO_INV_DI);
    /* PORT10 PIN12 (coords: U15) is configured as SDADC_INP1 */
    IOPCTL_PinMuxSet(10U, 12U, port10_pin12_config);

    const uint32_t port10_pin6_config = (/* Pin is configured as PIO10_6 */
                                         IOPCTL_PIO_FUNC0 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT10 PIN6 (coords: T14) is configured as PIO10_6 */
    IOPCTL_PinMuxSet(10U, 6U, port10_pin6_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
