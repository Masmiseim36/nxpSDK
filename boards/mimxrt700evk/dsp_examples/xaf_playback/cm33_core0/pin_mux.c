...
- pin_list:
  ...
  - {pin_num: J3, peripheral: SAI0, signal: RXD0, pin_signal: PIO0_2, input_buffer: enable}
  ...
  - {pin_num: G12, peripheral: USDHC1, signal: CARD_DET_N, pin_signal: PIO7_24, selects_transmitter_current_drive: O_33, input_buffer: enable, pull_select: up, pull_enable: enable}
  ...
  - {pin_num: C5, peripheral: GPIO7, signal: 'GPIO, 11', pin_signal: PIO7_11}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
