/* This linker script generated from xt-genldscripts.tpp for LSP /home/nxf33034/dev/mcu-sdk-2.0/boards/mimxrt700evk/dsp_examples/xaf_playback/hifi1/linker/min-rt */
...
MEMORY
{
  ...
  iram1_0_seg :                       	org = 0x00740000, len = 0x40000
  dram0_0_seg :                       	org = 0x20680000, len = 0xC0000
}
...
_memmap_mem_iram1_start = 0x740000;
_memmap_mem_iram1_end   = 0x780000;
_memmap_mem_dram0_start = 0x20680000;
_memmap_mem_dram0_end   = 0x20740000;
...
_memmap_seg_iram1_0_start = 0x740000;
_memmap_seg_iram1_0_max   = 0x780000;
_memmap_seg_dram0_0_start = 0x20680000;
_memmap_seg_dram0_0_max   = 0x20740000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x20740000);
  _heap_sentry = 0x20740000;
