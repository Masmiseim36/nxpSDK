...
/*! @name PIO0_9 (coord L7), SW5
  @{ */
/* Routed pin properties */
#define BOARD_INITPINSBUTTON_SW5_PERIPHERAL GPIO0         /*!<@brief Peripheral name */
#define BOARD_INITPINSBUTTON_SW5_SIGNAL IO                /*!<@brief Signal name */
#define BOARD_INITPINSBUTTON_SW5_CHANNEL 9                /*!<@brief Signal channel */
#define BOARD_INITPINSBUTTON_SW5_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINSBUTTON_SW5_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_INITPINSBUTTON_SW5_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                          /* @} */
 ...
 *
 */
void BOARD_InitPinsButton(void); /* Function assigned for the Cortex-M33 (Core #0) */
