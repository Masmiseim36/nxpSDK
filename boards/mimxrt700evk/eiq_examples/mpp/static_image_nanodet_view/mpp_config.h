...
#define APP_TFLITE_NANODET_DATA "nanodet_m_0.5x_nhwc_nopermute_npu64_tflite.h"
#define APP_TFLITE_NANODET_INFO "nanodet_m_0.5x_nhwc_nopermute_npu64_tflite_info.h"
