 ...
 *
 */
void BOARD_InitMipiPanelPinsEvk(void); /* Function assigned for the Cortex-M33 (Core #0) */
 ...
 *
 */
void BOARD_InitUARTPins(void); /* Function assigned for the Cortex-M33 (Core #0) */
...
/*!
 * @brief Port Data Direction: Pin is configured as general-purpose output for the GPIO function. */
#define PDDR_PDD0_pdd1 0x01u
/*!
 * @brief Port Data Direction: Pin is configured as general-purpose output for the GPIO function. */
#define PDDR_PDD15_pdd1 0x01u
/*!
 * @brief Port Data Direction: Pin is configured as general-purpose output for the GPIO function. */
#define PDDR_PDD1_pdd1 0x01u

/*!
 * @brief Configures pin routing and optionally pin electrical features.
 *
 */
void BOARD_InitFlexIOPanelPins(void); /* Function assigned for the Cortex-M33 (Core #0) */
 ...
 *
 */
void BOARD_InitLcdDBIPanelPins(void); /* Function assigned for the Cortex-M33 (Core #0) */
 ...
 *
 */
void BOARD_InitCameraPins(void); /* Function assigned for the Cortex-M33 (Core #0) */
