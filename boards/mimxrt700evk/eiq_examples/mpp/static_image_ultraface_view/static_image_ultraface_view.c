 ...
 *                   +-> image converter -> inference engine (model: Ultraface-ultraslim optimized for MCX-N NPU)
 ...
 * The goal of this application is to check if multiple faces detection is possible on MCX-N.
 * the model output is displayed on UART console by the application. */
