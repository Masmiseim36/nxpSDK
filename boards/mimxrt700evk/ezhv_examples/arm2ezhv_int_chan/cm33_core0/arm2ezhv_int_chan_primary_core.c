...
int main(void)
{
    ...
    PRINTF("Arm to ezhv interrupt request demo - message from primary core side.\r\n");
    ...
    PRINTF("Send MEI request from arm to ezhv.\r\n");
    SYSCON4->ARM2EZHV_INT_CTRL = SYSCON4_ARM2EZHV_INT_CTRL_MEIP_MASK;
