...
- pin_list:
  ...
  - {pin_num: J5, peripheral: GPIO0, signal: 'GPIO, 6', pin_signal: PIO0_6/LP_FLEXCOMM4_P2/SCT0_GPIN6/SCT0_OUT6/CTIMER_C_INP10/LP_FLEXCOMM8_P0, direction: INPUT}
  - {pin_num: K5, peripheral: GPIO0, signal: 'GPIO, 7', pin_signal: PIO0_7/LP_FLEXCOMM4_P3/SCT0_GPIN7/SCT0_OUT7/CTIMER_C_INP11/LP_FLEXCOMM8_P1, direction: OUTPUT,
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t gpio0_pinJ5_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_6 (pin J5)  */
    GPIO_PinInit(GPIO0, 6U, &gpio0_pinJ5_config);

    gpio_pin_config_t gpio0_pinK5_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO0_7 (pin K5)  */
    GPIO_PinInit(GPIO0, 7U, &gpio0_pinK5_config);
