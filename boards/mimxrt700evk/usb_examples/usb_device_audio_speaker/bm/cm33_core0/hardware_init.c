...
void BOARD_InitHardware(void)
{
    ...
    EDMA_EnableRequest(DMA0, kDmaRequestMuxSai0Tx);
    ...
    g_UsbDeviceAudioSpeaker.curAudioPllFrac = CLKCTL2->AUDIOPLL0NUM;
#endif
}
...
{
    CLKCTL2->AUDIOPLL0NUM = g_UsbDeviceAudioSpeaker.curAudioPllFrac;
}
