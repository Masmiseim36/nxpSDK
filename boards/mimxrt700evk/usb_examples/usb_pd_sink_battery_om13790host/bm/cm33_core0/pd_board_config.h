...
#define PD_PORT1_PHY_INTERRUPT_PORT (2U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PIN (6U)

#define PD_PORT1_SHIELD2_EXTERNAL_POWER_DETECT_PORT (2U)

#define PD_PORT1_EXTRA_SRC_PIN (0U)

#define PD_PORT1_EXTRA_SRC_PORT (2U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN (14U)

#define PD_PORT1_SHIELD2_DP4LANE_PORT (2U)

#define PD_PORT1_SHIELD2_XSD_PIN (1U)

#define PD_PORT1_SHIELD2_XSD_PORT (2U)

#define PD_PORT1_SHIELD2_ORIENT_PIN (9U)

#define PD_PORT1_SHIELD2_ORIENT_PORT (2U)

#define PD_PORT1_SHIELD2_HPD_PIN (15U)

#define PD_PORT1_SHIELD2_HPD_PORT (2U)
