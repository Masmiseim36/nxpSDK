...
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 33 MHz}
...
const clock_sys_pll_config_t sysPllConfig_BOARD_BootClockRUN =
    {
        ...
        .src = 0,                                 /* Bypass clock source, 0 - OSC 24M, 1 - CLK1_P and CLK1_N */
        .ss_stop = 50000,                         /*!< Stop value to get frequency change. */
        .ss_enable = true,                        /*!< Enable spread spectrum modulation */
        .ss_step = 1000,                          /*!< Step value to get frequency change step. */
    };
