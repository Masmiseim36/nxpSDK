 ...
 *
 */
/* this hook is defined in wwd_rtos as well, use that */
#if 1
                                   ...
                                   uint32_t *pulIdleTaskStackSize)
{
    ...
    __attribute__((section(".ocram_data"))) static StackType_t uxIdleTaskStack[configMINIMAL_STACK_SIZE];
                                    ...
                                    uint32_t *pulTimerTaskStackSize)
{
    ...
    __attribute__((section(".ocram_data"))) static StackType_t uxTimerTaskStack[configTIMER_TASK_STACK_DEPTH];
