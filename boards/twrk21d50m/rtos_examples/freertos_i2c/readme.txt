...
Using 2 TWR-K21D50M boards:
    ...
    The connection should be se as following:
        - A-76 (master board) connected to A-7 (slave board).
        - A-77 (master board) connected to A-8 (slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 TWR-K21D50M board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 TWR-K21D50M boards:
        In file freertos_i2c.c in folder: boards\twrk21d50m\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
