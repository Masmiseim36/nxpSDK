...
4.  Connect the headphones to the headphone jack on the TWR-SGTL5000 board. Insert line-in line into SGTL5000 board
5.  Insert sdcard to board.
6.  Either press the reset button on your board or launch the debugger in your IDE to begin running the demo.

Running the demo
================
When the demo runs successfully, the following log is visible on the OpenSDA terminal:
