...
#define RTC_OSC_CAP_LOAD_18PF 0x2400U        /*!< RTC oscillator capacity load: 18pF */
...
- {id: LPUARTCLK.outFreq, value: 80 MHz}
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_CONFIG_SetRtcClock(RTC_OSC_CAP_LOAD_18PF, RTC_RTC32KCLK_PERIPHERALS_ENABLED);
