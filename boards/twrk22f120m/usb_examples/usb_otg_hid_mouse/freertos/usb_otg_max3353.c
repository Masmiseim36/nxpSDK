...
#define GPIO_IRQHandler PORTC_IRQHandler
#define BOARD_MAX3353_GPIO_PIN (6)
#define BOARD_MAX3353_GPIO_PORT (PORTC)
#define BOARD_MAX3353_GPIO (GPIOC)
#define BOARD_MAX3353_GPIO_IRQ (PORTC_IRQn)
