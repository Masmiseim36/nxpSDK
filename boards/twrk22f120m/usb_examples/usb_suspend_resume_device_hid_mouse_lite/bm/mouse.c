...
void USB_SetClockRunFromHsrun(void)
{
...
void USB_PreLowpowerMode(void)
{
    /* enter VLPS from HSRUN, so fisrt change clock to RUN. */
    USB_SetClockRunFromHsrun();
    /* Power mode change. */
...
void USB_PostLowpowerMode(void)
{
    ...
    USB_SetClockHsrun(); /* Change clock setting after power mode change. */
}
void USB_ControllerSuspended(void)
{
}
