...
==============
The example supports 2 different connections:
Using 1 TWR-K24F120M board:
    The 2 I2C instances on one board are used, one as I2C master , another as I2C slave.
    The connection should be set as following:
        - J5-1 connected to B-50
        - J6-1 connected to B-51
Using 2 TWR-K24F120M boards:
    ...
    The connection should be se as following:
        - J5-1 (master board) connected to B-50 (slave board).
        - J6-1 (master board) connected to B-51 (slave board).
...
2.  Open a serial terminal with the following settings:
    ...
    - No flow control
3.
    If using 1 TWR-K24F120M board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 TWR-K24F120M boards:
        In file freertos_i2c.c in folder: boards\twrk24f120m\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
