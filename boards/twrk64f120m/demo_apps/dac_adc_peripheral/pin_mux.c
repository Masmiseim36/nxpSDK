...
- pin_list:
  ...
  - {pin_num: G12, peripheral: ADC0, signal: 'SE, 12', pin_signal: ADC0_SE12/PTB2/I2C0_SCL/UART0_RTS_b/ENET0_1588_TMR0/FTM0_FLT3}
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_TMR3_PORT, BOARD_TMR3_PIN, kPORT_PinDisabledOrAnalog);
