...
/*! @name PORTB2 (coord G12), J11[B33]
  @{ */
#define BOARD_TMR3_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_TMR3_PIN 2U     /*!<@brief PORTB pin index: 2 */
                              /* @} */

/*! @name DAC0_OUT (coord L3), J11[A32]
  @{ */
/* @} */
