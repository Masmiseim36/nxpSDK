...
- config_sets:
  - fsl_sai:
    - mclk_config:
      ...
      - masterClockSourceFreq: 'custom:120000000'
...
sai_transceiver_t DEMO_SAI_Tx_config = {.masterSlave = kSAI_Master,
                                        ...
                                        .endChannel   = 0U,
                                        .channelNums  = 1U,
                                        .serialData   = {.dataWord0Length     = (uint8_t)kSAI_WordWidth16bits,
...
sai_transceiver_t DEMO_SAI_Rx_config    = {.masterSlave = kSAI_Master,
                                        .bitClock    = {.bclkSrcSwap    = false,
                                                     .bclkSource     = kSAI_BclkSourceMclkDiv,
                                                     .bclkPolarity   = kSAI_PolarityActiveLow,
                                                     .bclkInputDelay = false},
...
sai_master_clock_t DEMO_SAI_MCLK_config = {.mclkOutputEnable = true,
                                           .mclkSource       = kSAI_MclkSourceSysclk,
                                           .mclkSourceClkHz  = DEMO_SAI_MCLK_SOURCE_CLOCK_HZ,
                                           .mclkHz           = DEMO_SAI_USER_MCLK_HZ};
...
void DEMO_SAI_init(void)
{
    ...
    SAI_SetMasterClockConfig(DEMO_SAI_PERIPHERAL, &DEMO_SAI_MCLK_config);
}
