...
- PORTB18 is connected to CAN0_TX (elevator pin B42)
- PORTB19 is connected to CAN0_RX (elevator pin B41)
...
2.  Connect TWR-SER J7 connector pins (1:CANH, 2:GND, 3:CANH) to the CAN Interface on PC
