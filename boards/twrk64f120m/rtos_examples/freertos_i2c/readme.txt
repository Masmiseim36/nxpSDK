...
Using 2 TWR-K64F120M boards:
    ...
    The connection should be se as following:
        - A-07 (master board) connected to A-75 (slave board).
        - A-08 (master board) connected to B-71 (slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 TWR-K64F120M board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 TWR-K64F120M boards:
        In file freertos_i2c.c in folder: boards\twrk64f120m\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
...
If using 1 TWR-K64F120M board, you can see the similar information from the terminal as below.
...
If using 2 TWR-K64F120M boards, you can see the similar information from the terminal associated with master board and slave board as below.
