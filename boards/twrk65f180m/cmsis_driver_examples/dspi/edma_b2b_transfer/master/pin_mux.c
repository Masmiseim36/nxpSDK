...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A2, peripheral: n/a, signal: disabled, pin_signal: PTD14/SPI2_SIN/SDHC0_D6/FB_A22}
  - {pin_num: B2, peripheral: n/a, signal: disabled, pin_signal: PTD12/SPI2_SCK/FTM3_FLT0/SDHC0_D4/FB_A20}
  - {pin_num: C2, peripheral: n/a, signal: disabled, pin_signal: PTD11/LLWU_P25/SPI2_PCS0/SDHC0_CLKIN/LPUART0_CTS_b/FB_A19}
  - {pin_num: B3, peripheral: n/a, signal: disabled, pin_signal: PTD13/SPI2_SOUT/SDHC0_D5/FB_A21}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
