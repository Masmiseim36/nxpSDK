Overview
========
The cmsis_lpuart_interrupt_validation example tests cmsis lpuart interrupt driver using CMSIS Driver Validation Suite 
...
LPUART0_TX - A59(Elevator) to  LPUART0_RX - A58(Elevator)
...
CMSIS-Driver Test Suite   Jul 28 2016   10:36:55 
