...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_TSI_ELECTRODE_1_PORT, BOARD_TSI_ELECTRODE_1_PIN, kPORT_MuxAlt6);

    /* PORTB19 (pin D11) is configured as FTM2_QD_PHB */
    PORT_SetPinMux(BOARD_TSI_ELECTRODE_2_PORT, BOARD_TSI_ELECTRODE_2_PIN, kPORT_MuxAlt6);
