...
#define LED_1_INIT() LED_YELLOW_INIT(LOGIC_LED_OFF)
#define LED_2_INIT() LED_ORANGE_INIT(LOGIC_LED_OFF)
#define LED_3_INIT() LED_GREEN_INIT(LOGIC_LED_OFF)
#define LED_4_INIT() LED_BLUE_INIT(LOGIC_LED_OFF)
#define LED_1_ON() LED_YELLOW_ON()
#define LED_1_OFF() LED_YELLOW_OFF()
#define LED_2_ON() LED_ORANGE_ON()
#define LED_2_OFF() LED_ORANGE_OFF()
