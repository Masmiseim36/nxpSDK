...
Then change CMP analog input, and watch the change of LED.
    - CMP2_IN2 (Jump A19 on Elevator Tower) connected to VCC =3.3V (Jump A3 on Elevator Tower): LED GREEN on
    - CMP2_IN2 (Jump A19 on Elevator Tower) connected to GND (Jump A2 on Elevator Tower): LED GREEN off
