...
void BOARD_InitPins(void)
{
    ...
    /* PORTA30 (pin H10) is configured as CAN0_TX */
    PORT_SetPinMux(PORTA, 30U, kPORT_MuxAlt2);

    /* PORTA31 (pin J9) is configured as CAN0_RX */
    PORT_SetPinMux(PORTA, 31U, kPORT_MuxAlt2);
