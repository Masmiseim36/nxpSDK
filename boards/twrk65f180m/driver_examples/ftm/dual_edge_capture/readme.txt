...
If FTM conuter overflow when capturing dual-edge of input signal. The pulse width value may be ambiguity.
...
Board settings
==============
- Plug the board to the primary
- Connect input signal to A76
