...
- pin_list:
  ...
  - {pin_num: H9, peripheral: ENET, signal: 'TMR_1588, 2', pin_signal: ADC1_SE10/PTB4/ENET0_1588_TMR2/SDRAM_CS1_b/FTM1_FLT0, slew_rate: fast, open_drain: enable,
    pull_select: down, pull_enable: disable}
  - {pin_num: F13, peripheral: ENET, signal: 'TMR_1588, 3', pin_signal: ADC1_SE11/PTB5/ENET0_1588_TMR3/FTM2_FLT0, slew_rate: fast, open_drain: enable, pull_select: down,
    pull_enable: disable}
