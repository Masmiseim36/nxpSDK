...
3. I2C master abort transfer when read 4 data(I2C master read data from I2C slave with DMA.I2C Slave using interrupt to send the data)
4. I2C master abort transfer when send 2 data(I2C master send data to I2C slave with DMA.I2C Slave using interrupt to receive the data)
5. I2C master read data from I2C slave with DMA in nostop mode. (I2C Slave using interrupt to send the data) then I2C master read data again. 
6. I2C master send data to I2C slave with DMA in nostop mode. (I2C Slave using interrupt to read the data) then I2C master send data again.
