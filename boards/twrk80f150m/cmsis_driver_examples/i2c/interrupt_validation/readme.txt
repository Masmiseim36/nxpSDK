Overview
========
The cmsis_i2c_interrupt_validation example tests cmsis i2c interrupt driver using CMSIS Driver Validation Suite 
...
In this example , we use one I2C as test instance and test the following functions:
...
CMSIS-Driver Test Suite   Jul 28 2016   15:02:21 
