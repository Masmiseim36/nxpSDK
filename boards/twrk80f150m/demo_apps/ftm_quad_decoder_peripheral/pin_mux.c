...
- pin_list:
  - {pin_num: D9, peripheral: FTM2, signal: 'QD_PH, A', pin_signal: TSI0_CH11/PTB18/FTM2_CH0/I2S0_TX_BCLK/FB_AD15/SDRAM_A23/FTM2_QD_PHA/TPM2_CH0/FXIO0_D6}
  - {pin_num: C9, peripheral: FTM2, signal: 'QD_PH, B', pin_signal: TSI0_CH12/PTB19/FTM2_CH1/I2S0_TX_FS/FB_OE_b/FTM2_QD_PHB/TPM2_CH1/FXIO0_D7}
...
void BOARD_InitPins(void)
{
    ...
    /* PORTB18 (pin D9) is configured as FTM2_QD_PHA */
    PORT_SetPinMux(BOARD_SDRAM_A23_PORT, BOARD_SDRAM_A23_PIN, kPORT_MuxAlt6);

    /* PORTB19 (pin C9) is configured as FTM2_QD_PHB */
