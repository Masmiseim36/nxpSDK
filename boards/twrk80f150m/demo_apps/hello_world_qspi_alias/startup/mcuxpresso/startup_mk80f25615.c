//*****************************************************************************
// MK80F25615 startup code for use with MCUXpresso IDE
//
// Version : 050117
//*****************************************************************************
//
...
__attribute__ ((used,section(".FlashConfig"))) const struct {
    ...
    unsigned int word3;
    unsigned int word4;
} Flash_Config = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFBDFE};
...
void (* const g_pfnVectors[])(void) = {
    ...
    ResetISR_QSPI + 0x64000000,        // The reset handler
