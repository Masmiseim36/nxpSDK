...
#define APP_DEBUG_UART_CLKSRC_NAME kCLOCK_Osc0ErClk /* OSC0 external reference clock (OSC0ERCLK) */
...
#define LLWU_WAKEUP_PIN_IDX 21U /* LLWU_P21 */
...
#define DEBUG_CONSOLE_RX_PIN 3U
...
#define DEBUG_CONSOLE_TX_PIN 4U
