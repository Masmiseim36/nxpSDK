...
#define SIM_EMVSIM_CLK_SEL_MCGIRCLK_CLK 3U    /*!< EMVSIM clock select: MCGIRCLK clock */
...
- {id: EMVSIMCLK.outFreq, value: 2 MHz}
...
void BOARD_BootClockHSRUN(void)
{
    ...
    CLOCK_SetEmvsimClock(SIM_EMVSIM_CLK_SEL_MCGIRCLK_CLK);
