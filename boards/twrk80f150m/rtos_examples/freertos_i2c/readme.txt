...
==============
The example supports 2 different connections:
Using 1 TWR-K80F150M board:
    The 2 I2C instances on one board are used, one as I2C master , another as I2C slave.
    The connection should be set as following:
        - A-7 connected to B-50
        - A-8 connected to B-51
Using 2 TWR-K80F150M boards:
    ...
    The connection should be se as following:
        - A-7 (master board) connected to B-50 (slave board).
        - A-8 (master board) connected to B-51 (slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 TWR-K80F150M board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 TWR-K80F150M boards:
        In file freertos_i2c.c in folder: boards\twrk80f150m\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
...
If using 1 TWR-K80F150M board, you can see the similar information from the terminal as below.
...
If using 2 TWR-K80F150M boards, you can see the similar information from the terminal associated with master board and slave board as below.
