...
- name: BOARD_InitPeripherals
  UUID: 9b27ed85-9519-42cd-aeaa-695ad1b200f7
...
void DEMO_FTM_init(void) {
  ...
  FTM_SetupPwm(DEMO_FTM_PERIPHERAL, DEMO_FTM_combinedPwmSignalParams, sizeof(DEMO_FTM_combinedPwmSignalParams) / sizeof(ftm_chnl_pwm_signal_param_t), kFTM_CombinedPwm, 24000U, DEMO_FTM_CLOCK_SOURCE);
}
