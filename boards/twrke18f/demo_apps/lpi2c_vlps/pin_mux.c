...
- pin_list:
  ...
  - {pin_num: '45', peripheral: GPIOC, signal: 'GPIO, 15', pin_signal: ADC0_SE13/ACMP2_IN4/PTC15/FTM1_CH3}
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_ACCEL_I2C_RST_PORT, BOARD_ACCEL_I2C_RST_PIN, kPORT_MuxAsGpio);
}
