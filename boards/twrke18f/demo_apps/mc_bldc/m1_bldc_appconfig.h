...
#define M1_U_DCB_UNDERVOLTAGE              FRAC16(0.399449035813)
...
#define M1_SPEED_SCALE_CONST               (5625)
#define M1_CMT_PER_MIN                     (938)
#define M1_START_CMT_ACCELER               FRAC16(0.694444444444)
