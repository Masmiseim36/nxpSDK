...
#define FMSTR_SERIAL_MCUX_PERIPHERAL FMSTR_SERIAL_MCUX_LPUART
...
void ADC0_IRQHandler(void)
{
    ...
    PDB2->SC = (PDB2->SC & (~PDB_SC_TRGSEL_MASK)) | PDB_SC_TRGSEL(0xF);
...
void PDB0_IRQHandler(void)
{
    ...
    else
    {
        ...
        PDB2->SC = (PDB2->SC & (~PDB_SC_TRGSEL_MASK)) | PDB_SC_TRGSEL(0x0); /* PDB Trigger on (FTM0 init trigger) */
        PDB2->SC |= PDB_SC_LDOK_MASK;                                       /* LDOK */
        PDB2->SC &= (~PDB_SC_PDBIF_MASK);                                   /* Clear PDB interrupt flag */
    }
}
