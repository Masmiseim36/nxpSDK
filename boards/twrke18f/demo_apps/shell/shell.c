...
#define LED_1_INIT() LED_RED2_INIT(LOGIC_LED_OFF)
#define LED_2_INIT() LED_GREEN2_INIT(LOGIC_LED_OFF)
#define LED_3_INIT() LED_BLUE_INIT(LOGIC_LED_OFF)
#define LED_1_ON() LED_RED2_ON()
#define LED_1_OFF() LED_RED2_OFF()
#define LED_2_ON() LED_GREEN2_ON()
#define LED_2_OFF() LED_GREEN2_OFF()
