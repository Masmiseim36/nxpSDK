...
#define DEMO_ACMP_ROUND_ROBIN_CHANNELS_CHECKER_MASK 0x04U   /* Left-most bit is for channel 7. */
#define DEMO_ACMP_ROUND_ROBIN_CHANNELS_PRE_STATE_MASK 0x04U /* Left-most bit is for channel 7. */
