...
Board settings
==============
The example requires connecting between CAN pins of two TWR-KE18F boards.
The connection should be set as follows:
On board:
- J6-1, J6-2 connected
- J7-1, J7-2 connected
Between TWR-KE18F boards:
- J8-1 node A, J8-1 node B
- J8-2 node A, J8-2 node B
- J8-3 node A, J8-3 node B
