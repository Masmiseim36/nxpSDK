...
- pin_list:
  ...
  - {pin_num: '71', peripheral: FLEXIO, signal: 'D, 4', pin_signal: ADC1_SE2/PTD2/FTM3_CH4/LPSPI1_SOUT/FXIO_D4/TRGMUX_IN5}
  - {pin_num: '70', peripheral: FLEXIO, signal: 'D, 5', pin_signal: ADC1_SE3/PTD3/FTM3_CH5/LPSPI1_PCS0/FXIO_D5/TRGMUX_IN4/NMI_b}
...
void BOARD_InitPins(void)
{
    ...
    /* PORTD2 (pin 71) is configured as FXIO_D4 */
    PORT_SetPinMux(PORTD, 2U, kPORT_MuxAlt4);

    /* PORTD3 (pin 70) is configured as FXIO_D5 */
