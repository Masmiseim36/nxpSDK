...
Board settings
==============
To make this demo work, connect TWR-KE18F board to tower primary board and connections need to be setup as follows:
- PTD8 (B51 Elevator) --> PTA2 (A8 Elevator)
- PTD9 (B50 Elevator) --> PTA3 (A7 Elevator)
