 ...
 *  enablePorDetectInVlls0 - When set to true, power on reset detection circuit is disabled in
 *   Very low leakage stop 0 mode. When set to false, circuit is enabled. This item is chip-specific.
 *  enableLpoClock - When set to true, the 1 kHz Low power oscillator is disabled in any
