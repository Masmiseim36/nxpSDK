...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: C7, peripheral: CMP0, signal: 'IN, 0', pin_signal: CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/EXTRG_IN/FXIO0_D14}
  - {pin_num: B7, peripheral: CMP0, signal: 'IN, 1', pin_signal: CMP0_IN1/PTC7/SPI0_SIN/USB0_SOF_OUT/FXIO0_D15}
  - {pin_num: D4, peripheral: n/a, signal: disabled, pin_signal: PTD0/LLWU_P12/SPI0_PCS0/LPUART2_RTS_b/FXIO0_D22}
  - {pin_num: D3, peripheral: ADC0, signal: 'SE, 5b', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/LPUART2_CTS_b/FXIO0_D23}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: D10, peripheral: SPI1, signal: PCS0_SS, pin_signal: PTB10/SPI1_PCS0/FXIO0_D4}
  - {pin_num: C10, peripheral: SPI1, signal: SCK, pin_signal: PTB11/SPI1_SCK/FXIO0_D5}
  - {pin_num: B10, peripheral: SPI1, signal: SOUT, pin_signal: TSI0_CH9/PTB16/SPI1_SOUT/LPUART0_RX/TPM_CLKIN0/EWM_IN}
  - {pin_num: E9, peripheral: SPI1, signal: SIN, pin_signal: TSI0_CH10/PTB17/SPI1_SIN/LPUART0_TX/TPM_CLKIN1/EWM_OUT_b}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: D10, peripheral: n/a, signal: disabled, pin_signal: PTB10/SPI1_PCS0/FXIO0_D4}
  - {pin_num: C10, peripheral: n/a, signal: disabled, pin_signal: PTB11/SPI1_SCK/FXIO0_D5}
  - {pin_num: B10, peripheral: TSI0, signal: 'CH, 9', pin_signal: TSI0_CH9/PTB16/SPI1_SOUT/LPUART0_RX/TPM_CLKIN0/EWM_IN}
  - {pin_num: E9, peripheral: TSI0, signal: 'CH, 10', pin_signal: TSI0_CH10/PTB17/SPI1_SIN/LPUART0_TX/TPM_CLKIN1/EWM_OUT_b}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void DSPI1_DeinitPins(void)
{
    ...
    /* PORTB10 (pin D10) is disabled */
    PORT_SetPinMux(PORTB, 10U, kPORT_PinDisabledOrAnalog);

    /* PORTB11 (pin C10) is disabled */
