...
- pin_list:
  - {pin_num: A10, peripheral: I2C0, signal: SCL, pin_signal: PTD8/LLWU_P24/I2C0_SCL/FXIO0_D24, slew_rate: fast, open_drain: enable, pull_select: up, pull_enable: enable}
  - {pin_num: A9, peripheral: I2C0, signal: SDA, pin_signal: PTD9/I2C0_SDA/FXIO0_D25, slew_rate: fast, open_drain: enable, pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: A10, peripheral: n/a, signal: disabled, pin_signal: PTD8/LLWU_P24/I2C0_SCL/FXIO0_D24}
  - {pin_num: A9, peripheral: n/a, signal: disabled, pin_signal: PTD9/I2C0_SDA/FXIO0_D25}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
