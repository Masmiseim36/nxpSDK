...
- pin_list:
  ...
  - {pin_num: A10, peripheral: FLEXIO0, signal: 'D, 24', pin_signal: PTD8/LLWU_P24/I2C0_SCL/FXIO0_D24, slew_rate: fast, open_drain: enable, pull_select: down, pull_enable: disable}
  - {pin_num: A9, peripheral: FLEXIO0, signal: 'D, 25', pin_signal: PTD9/I2C0_SDA/FXIO0_D25, slew_rate: fast, open_drain: enable, pull_select: down, pull_enable: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t portd8_pinA10_config = {/* Internal pull-up/down resistor is disabled */
                                                    ...
                                                    /* Pin is configured as FXIO0_D24 */
                                                    kPORT_MuxAlt7,
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORTD8 (pin A10) is configured as FXIO0_D24 */
    ...
    const port_pin_config_t portd9_pinA9_config = {/* Internal pull-up/down resistor is disabled */
                                                   ...
                                                   /* Open drain is enabled */
                                                   kPORT_OpenDrainEnable,
                                                   /* Pin is configured as FXIO0_D25 */
                                                   kPORT_MuxAlt7,
                                                   /* Pin Control Register fields [15:0] are not locked */
                                                   kPORT_UnlockRegister};
    /* PORTD9 (pin A9) is configured as FXIO0_D25 */
