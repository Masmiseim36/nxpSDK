...
- pin_list:
  ...
  - {pin_num: E11, peripheral: GPIOB, signal: 'GPIO, 7', pin_signal: PTB7/EMVSIM1_PD}
  ...
  - {pin_num: F11, peripheral: EMVSIM1, signal: VCCEN, pin_signal: PTB6/EMVSIM1_VCCEN, slew_rate: fast, open_drain: disable, pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORTB7 (pin E11) is configured as PTB7 */
