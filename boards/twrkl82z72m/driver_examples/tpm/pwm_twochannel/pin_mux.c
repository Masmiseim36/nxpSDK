...
- pin_list:
  ...
  - {pin_num: D9, peripheral: TPM2, signal: 'CH, 0', pin_signal: TSI0_CH11/PTB18/TPM2_CH0/FXIO0_D6}
  - {pin_num: C9, peripheral: TPM2, signal: 'CH, 1', pin_signal: TSI0_CH12/PTB19/TPM2_CH1/FXIO0_D7}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    SIM->SOPT9 = ((SIM->SOPT9 &
                  ...
                  | SIM_SOPT9_TPM2CH0SRC(SOPT9_TPM2CH0SRC_TPM2CH0));
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
