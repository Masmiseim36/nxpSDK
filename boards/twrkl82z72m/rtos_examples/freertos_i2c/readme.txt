...
If using 1 TWR-KL82Z72M board, you can see the similar information from the terminal as below.
...
If using 2 TWR-KL82Z72M boards, you can see the similar information from the terminal associated with master board and slave board as below.
...
Using 2 TWR-KL82Z72M boards:
    ...
    The connection should be se as following:
        - A7 (master board) connected to B50 (slave board).
        - A8 (master board) connected to B51 (slave board).
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 TWR-KL82Z72M board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 TWR-KL82Z72M boards:
        In file freertos_i2c.c in folder: boards\twrkl82z72m\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
