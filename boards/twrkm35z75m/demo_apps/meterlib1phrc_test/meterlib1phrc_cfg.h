 ...
 *
 **************************************************************************************
 * Filter-Based Metering Library Configuration File, Created: Sun May 31 09:38:47 2015
 **************************************************************************************
 * @TAGNAME       = METERLIB1PHRC_CFG
 * @LOCKED        =         0
 * @FSAMPLE       =      1200
 * @DFACTOR       =         1
 * @IMAX          =  141.4214
 ...
 * @MCU_CORE      =         1
 **************************************************************************************/
#ifndef __METERLIB1PHRC_CFG_H
#define __METERLIB1PHRC_CFG_H
