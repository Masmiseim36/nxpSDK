 ...
 *
 **************************************************************************************
 * Filter-Based Metering Library Configuration File, Created: Sun May 31 09:39:22 2015
 **************************************************************************************
 * @TAGNAME       = METERLIB3PH_CFG
 * @LOCKED        =         0
 * @FSAMPLE       =      1200
 * @DFACTOR       =         1
 * @IMAX          =  141.4214
 ...
 * @MCU_CORE      =         1
 **************************************************************************************/
#ifndef __METERLIB3PHKWH_CFG_H
#define __METERLIB3PHKWH_CFG_H
