...
void main (void)
{
  ...
  while (1)
  {
    ...
    METERLIBLP3PH_ReadResultsPh1(&mlib,&U_RMS_Ph1,&I_RMS_Ph1,&P_Ph1,&Q_Ph1,&S_Ph1);
    METERLIBLP3PH_ReadResultsPh2(&mlib,&U_RMS_Ph2,&I_RMS_Ph2,&P_Ph2,&Q_Ph2,&S_Ph2);
    METERLIBLP3PH_ReadResultsPh3(&mlib,&U_RMS_Ph3,&I_RMS_Ph3,&P_Ph3,&Q_Ph3,&S_Ph3);
    cycle++;
  }
}
