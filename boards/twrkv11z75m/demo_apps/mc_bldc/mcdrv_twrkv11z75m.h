...
#ifndef _MCDRV_TWR_KV11_Z75_H_
#define _MCDRV_TWR_KV11_Z75_H_
 ...
 * Valid for Kinetis KV11 Tower board (TWR-KV11Z32) together with TWR-MC-LVBLDC
 *
 ...
 *   Quantity          |   ADC0           |   ADC1
 *   --------------------------------------------------------------------------
 *   BEMF_A            | ADC0_SE6  (0x06) | ADC1_SE1  (0x01)
 *   BEMF_B            | ADC0_SE12 (0x0C) |
 *   BEMF_C            | ADC0_SE7  (0x07) | ADC1_SE7  (0x07)
 *   U_dcb             | ADC0_SE13 (0x0D) |
 *   I_dcb             | ADC0_SE4  (0x04) |
 */
...
#define M1_MCDRV_ADC_GET(par)         \
    ...
    MCDRV_VoltDcBusGet_twr_kv11(par); \
    MCDRV_CurrDcBusGet_twr_kv11(par); \
    MCDRV_AuxValGet(par);             \
    MCDRV_AssignDCBusChannel(par)
...
#define M1_MCDRV_CURR_CALIB(par) MCDRV_CurrOffsetCalib_twr_kv11(par)
