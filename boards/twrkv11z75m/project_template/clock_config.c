...
#define SIM_ADC_ALT_CLK_SEL_OUTDIV5_CLK 0U /*!< ADC ALT clock select: OUTDIV5 clock */
#define SIM_CLKOUT_SEL_BUS_FLASH_CLK 2U    /*!< CLKOUT pin clock select: BUS/FLASH clock */
...
/*FUNCTION**********************************************************************
 *
 * Function Name : CLOCK_CONFIG_SetAdc0AltClock
 * Description   : Set ADC0 ALT clock source.
 * Param src     : The value to set ADC0 ALT clock source.
 *
 *END**************************************************************************/
static void CLOCK_CONFIG_SetAdc0AltClock(uint8_t src)
{
    SIM->SOPT7 = ((SIM->SOPT7 & ~SIM_SOPT7_ADC0ALTCLKSRC_MASK) | SIM_SOPT7_ADC0ALTCLKSRC(src));
}

/*FUNCTION**********************************************************************
 *
 * Function Name : CLOCK_CONFIG_SetAdc1AltClock
 * Description   : Set ADC1 ALT clock source.
 * Param src     : The value to set ADC1 ALT clock source.
 *
 *END**************************************************************************/
static void CLOCK_CONFIG_SetAdc1AltClock(uint8_t src)
{
    SIM->SOPT7 = ((SIM->SOPT7 & ~SIM_SOPT7_ADC1ALTCLKSRC_MASK) | SIM_SOPT7_ADC1ALTCLKSRC(src));
}
...
- {id: SIM.OUTDIV5.scale, value: '4'}
- {id: SIM_CLKDIV1_OUTDIV5EN_CFG, value: 'yes'}
...
const sim_clock_config_t simConfig_BOARD_BootClockRUN = {
    ...
    .clkdiv1  = 0x2b000U,              /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV4: /3, OUTDIV5: /4, enabled */
};
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set ADC0 ALT clock source. */
    CLOCK_CONFIG_SetAdc0AltClock(SIM_ADC_ALT_CLK_SEL_OUTDIV5_CLK);
    /* Set ADC1 ALT clock source. */
    CLOCK_CONFIG_SetAdc1AltClock(SIM_ADC_ALT_CLK_SEL_OUTDIV5_CLK);
    /* Set WDOG clock source. */
    CLOCK_CONFIG_SetWdogClock(SIM_WDOG_CLK_SEL_LPO_CLK);
    /* Set CLKOUT source. */
    CLOCK_SetClkOutClock(SIM_CLKOUT_SEL_BUS_FLASH_CLK);
}
...
const sim_clock_config_t simConfig_BOARD_BootClockVLPR = {
    ...
    .clkdiv1  = 0x41000U,                    /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV4: /5, OUTDIV5: /2, disabled */
};
