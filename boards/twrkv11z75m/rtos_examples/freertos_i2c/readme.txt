...
2.  Open a serial terminal with the following settings:
    ...
    - One stop bit
    - No flow control
3.  In file freertos_i2c.c in folder: boards\twrkw24d512\rtos_examples\freertos_i2c, do following definition:
...
For 2 TWR-KV11Z75M boards, you can see the similar information from the terminal associated with master board and slave board as below.
