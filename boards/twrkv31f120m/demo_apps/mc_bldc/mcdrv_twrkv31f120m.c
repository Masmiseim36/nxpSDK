...
void InitClock(void)
{
    ...
    g_sClockSetup.ui32CmtTimerFreq = g_sClockSetup.ui32BusClock / 128;
    g_sClockSetup.ui16CtrlLoopFreq = CTRL_LOOP_FREQ; /* 1kHz */
}
...
void InitADC16(void)
{
    ...
    ADC0->SC3 = 0;
    ADC1->SC3 = 0;
    /* bus clock source (60 MHz), ADC0 clock = Bus clock / 4 (15 MHz), 12-bit */
    ADC0->CFG1 = (ADC_CFG1_MODE(1) | ADC_CFG1_ADIV(2));
