 ...
 * Valid for Kinetis KV31 Freedom board (TWR-KV31F) together with TWR-MC-LV3PH
 *
 ...
 *   Quantity          |   ADC0           |   ADC1
 *   --------------------------------------------------------------------------
 *   BEMF_A (PTB0)     | ADC0_SE8  (0x08) | ADC1_SE8  (0x08)
 *   BEMF_B (ADC0_DP3) | ADC0_DP3  (0x03) | ADC1_DP0  (0x00)
 *   BEMF_C (ADC0_DP0) | ADC0_DP0  (0x00) | ADC1_DP3  (0x03)
 *   U_dcb (PTB3)      | ADC0_SE13 (0x0D) |
 *   I_dcb (ADC1_SE9)  |                  | ADC1_SE9  (0x09)
 */
