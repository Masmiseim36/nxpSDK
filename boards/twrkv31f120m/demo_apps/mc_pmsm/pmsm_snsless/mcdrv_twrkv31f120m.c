...
#if 0 /* Fault signal DRV_OC from TWR-MC-LV3PH board is assigned to wrong 
         FTM Fault (PTC9 - FTM2_FLT0) */   
...
void InitSPI(void)
{
    ...
    /* Enable PIN & PORT */
    g_sM1Driver3ph.sSpiData.pGpioEnBase = (GPIO_Type *)(PTA); /* GPIOx Base Address */
    g_sM1Driver3ph.sSpiData.ui32GpioEnPin = 5; /* pin number for driver enabled */

    /* Interrupt PIN & PORT */
    g_sM1Driver3ph.sSpiData.pGpioIntBase = (GPIO_Type *)(PTB); /* GPIOx Base Address */
    g_sM1Driver3ph.sSpiData.ui32GpioIntPin = 18; /* pin number for interrupt detection */

    /* Reset PIN & PORT */
    g_sM1Driver3ph.sSpiData.pGpioResetBase = (GPIO_Type *)(PTC);   /* GPIOx Base Address */
    g_sM1Driver3ph.sSpiData.ui32GpioResetPin = 7;                  /* pin number for reset, driver */

    g_sM1Driver3ph.sSpiData.bResetPinControl = TRUE;
...
void InitFTM2(void)
{
    ...
    g_sClockSetup.ui16M1SpeedLoopModulo =
        (g_sClockSetup.ui32BusClock / g_sClockSetup.ui16M1SpeedLoopFreq) >> (FTM2->SC & FTM_SC_PS_MASK);
...
void InitADC16(void)
{
    ...
    /* setting the clock to 2 MHz (ADIV - div alternate clock (8 MHz) by 4 and
    ...
    ADC0->CFG1 = (ADC_CFG1_MODE(1) | ADC_CFG1_ADIV(2) | ADC_CFG1_ADICLK(2));
    ADC1->CFG1 = (ADC_CFG1_MODE(1) | ADC_CFG1_ADIV(2) | ADC_CFG1_ADICLK(2));
