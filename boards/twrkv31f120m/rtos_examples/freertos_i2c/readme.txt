...
Using 2 TWR-KV31F120M boards:
    ...
    The connection should be se as following:
        - J17-1 (master board) connected to J9-2 (slave board).
        - J17-3 (master board) connected to J12-2 (slave board).
        - GND of master board  connected to GND of slave board
...
2.  Open a serial terminal on PC for OpenSDA serial device with these settings:
    ...
    - No flow control
3.
    If using 1 TWR-KV31F120M board:
        Default settings in freertos_i2c.c is applied.
        Build project.
        Download the program to the target board.
    If using 2 TWR-KV31F120M boards:
        In file freertos_i2c.c in folder: boards\twrk21f120m\rtos_examples\freertos_i2c, do following definition:
            #define EXAMPLE_CONNECT_I2C BOARD_TO_BOARD
...
If using 1 TWR-KV31F120M board, you can see the similar information from the terminal as below.
...
If using 2 TWR-KV31F120M boards, you can see the similar information from the terminal associated with master board and slave board as below.
