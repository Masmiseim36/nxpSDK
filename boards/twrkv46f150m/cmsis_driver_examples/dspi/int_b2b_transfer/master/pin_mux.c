...
- pin_list:
  ...
  - {pin_num: '45', peripheral: CMP3, signal: 'IN, 1', pin_signal: CMP3_IN1/PTA15/SPI0_SCK/UART0_RX}
  - {pin_num: '47', peripheral: ADC, signal: 'ADCA, 7', pin_signal: ADCA_CH7e/PTA17/SPI0_SIN/UART0_RTS_b}
  - {pin_num: '46', peripheral: CMP3, signal: 'IN, 2', pin_signal: CMP3_IN2/PTA16/SPI0_SOUT/UART0_CTS_b/UART0_COL_b}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void DSPI0_DeinitPins(void)
{
    ...
    /* PORTA15 (pin 45) is configured as CMP3_IN1 */
    PORT_SetPinMux(PORTA, 15U, kPORT_PinDisabledOrAnalog);

    /* PORTA16 (pin 46) is configured as CMP3_IN2 */
    PORT_SetPinMux(PORTA, 16U, kPORT_PinDisabledOrAnalog);

    /* PORTA17 (pin 47) is configured as ADCA_CH7e */
    ...
    SIM->ADCOPT = ((SIM->ADCOPT &
                   ...
                   /* ADCA MUX1 selection for ADCA channel 7: ADCA MUX1's channel e. */
                   | SIM_ADCOPT_ADCACH7SEL(ADCOPT_ADCACH7SEL_CH_E));
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
