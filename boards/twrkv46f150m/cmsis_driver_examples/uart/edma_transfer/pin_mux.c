...
- options: {coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '1', peripheral: ADC, signal: 'ADCB, 6', pin_signal: ADCB_CH6f/PTE0/UART1_TX/XBAROUT10/XBARIN11}
  - {pin_num: '2', peripheral: ADC, signal: 'ADCB, 7', pin_signal: ADCB_CH7f/PTE1/LLWU_P0/UART1_RX/XBAROUT11/XBARIN7}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void UART1_DeinitPins(void)
{
    ...
    /* PORTE0 (pin 1) is configured as ADCB_CH6f */
    PORT_SetPinMux(PORTE, 0U, kPORT_PinDisabledOrAnalog);

    /* PORTE1 (pin 2) is configured as ADCB_CH7f */
    ...
    SIM->ADCOPT = ((SIM->ADCOPT &
                   ...
                   /* ADCB MUX1 selection for ADCB channel 6: ADCB MUX0's channel f. */
                   | SIM_ADCOPT_ADCBCH6SEL(ADCOPT_ADCBCH6SEL_CH_F)

                   /* ADCB MUX1 selection for ADCB channel 7: ADCB MUX1's channel f. */
                   | SIM_ADCOPT_ADCBCH7SEL(ADCOPT_ADCBCH7SEL_CH_F));
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
