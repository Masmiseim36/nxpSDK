...
- TWR-KV46F150M board
- Personal Computer
- Encoder with PHA and PHB signal.

Board settings
==============
1. Connect the "J16-1" (PTA12, FTM1_QD_PHA) to encoder's PHA signal.
2. Connect the "J16-3" (PTA13, FTM1_QD_PHB) to encoder's PHB signal.
