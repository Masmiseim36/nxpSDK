...
void InitPWMA(void)
{
    ...
    PWMA->SM[3].VAL4 = PWM_VAL4_VAL4((uint16_t)(-(g_sClockSetup.ui16PwmModulo / 2) + 10));
...
void InitFTM0(void)
{
    ...
    g_sClockSetup.ui16SpeedLoopModulo =
        (g_sClockSetup.ui32FastPeripheralClock / g_sClockSetup.ui16SpeedLoopFreq) >> (FTM0->SC & FTM_SC_PS_MASK);
    FTM0->MOD = g_sClockSetup.ui16SpeedLoopModulo;
