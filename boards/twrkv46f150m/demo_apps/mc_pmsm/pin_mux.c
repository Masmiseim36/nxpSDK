...
void PinTool_PWM(void)
{
    ...
    PORT_SetPinMux(PINTOOL_PWM_PWM_A0_PORT, PINTOOL_PWM_PWM_A0_PIN, kPORT_MuxAlt6);

    /* PORTD1 (pin 94) is configured as FlexPWM_B0 */
    PORT_SetPinMux(PINTOOL_PWM_PWM_B0_PORT, PINTOOL_PWM_PWM_B0_PIN, kPORT_MuxAlt6);

    /* PORTD2 (pin 95) is configured as FlexPWM_A1 */
    PORT_SetPinMux(PINTOOL_PWM_PWM_A1_PORT, PINTOOL_PWM_PWM_A1_PIN, kPORT_MuxAlt6);

    /* PORTD3 (pin 96) is configured as FlexPWM_B1 */
    PORT_SetPinMux(PINTOOL_PWM_PWM_B1_PORT, PINTOOL_PWM_PWM_B1_PIN, kPORT_MuxAlt6);

    /* PORTD4 (pin 97) is configured as FlexPWM_A2 */
    PORT_SetPinMux(PINTOOL_PWM_PWM_A2_PORT, PINTOOL_PWM_PWM_A2_PIN, kPORT_MuxAlt5);

    /* PORTD5 (pin 98) is configured as FlexPWM_B2 */
    PORT_SetPinMux(PINTOOL_PWM_PWM_B2_PORT, PINTOOL_PWM_PWM_B2_PIN, kPORT_MuxAlt5);
}
...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '7', peripheral: GPIOE, signal: 'GPIO, 6', pin_signal: PTE6/LLWU_P16/FTM3_CH1, direction: INPUT, slew_rate: fast, open_drain: no_init, pull_select: up,
    pull_enable: enable}
  ...
  - {pin_num: '62', peripheral: GPIOB, signal: 'GPIO, 16', pin_signal: PTB16/UART0_RX/FTM_CLKIN2/CAN0_TX/EWM_IN/XBARIN5, direction: OUTPUT, slew_rate: no_init, open_drain: no_init,
    pull_select: no_init}
  - {pin_num: '79', peripheral: PWMA, signal: 'FAULT, 0', pin_signal: CMP3_IN4/CMP0_IN1/PTC7/SPI0_SIN/XBARIN4/UART0_TX/XBAROUT7/I2C0_SDA}
  - {pin_num: '78', peripheral: GPIOC, signal: 'GPIO, 6', pin_signal: CMP2_IN4/CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/PDB0_EXTRG/XBARIN3/UART0_RX/XBAROUT6/I2C0_SCL}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void PinTool_Misc(void)
{
    ...
    PORT_SetPinMux(PINTOOL_MISC_TMR_2_PORT, PINTOOL_MISC_TMR_2_PIN, kPORT_MuxAsGpio);

    /* PORTC7 (pin 79) is configured as XBARIN4 */
    PORT_SetPinMux(PINTOOL_MISC_DRV_OC_PORT, PINTOOL_MISC_DRV_OC_PIN, kPORT_MuxAlt4);
    ...
    /* XBARIN4 input pin output assigned to XBARA_IN4 input is connected
     * to XBARA_OUT29 output assigned to PWMA fault 0 */
    XBARA_SetSignalsConnection(XBARA, kXBARA_InputXbarIn4, kXBARA_OutputPwmAFault0);
}
