...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_LED_GREEN4_PORT, BOARD_LED_GREEN4_PIN, kPORT_MuxAsGpio);

    /* PORTC2 (pin 72) is configured as PTC2 */
    PORT_SetPinMux(BOARD_LED_YELLOW4_PORT, BOARD_LED_YELLOW4_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_LED_YELLOW1_PORT, BOARD_LED_YELLOW1_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_LED_YELLOW2_PORT, BOARD_LED_YELLOW2_PIN, kPORT_MuxAsGpio);

    /* PORTD4 (pin 97) is configured as PTD4 */
    PORT_SetPinMux(BOARD_LED_GREEN3_PORT, BOARD_LED_GREEN3_PIN, kPORT_MuxAsGpio);

    /* PORTD5 (pin 98) is configured as PTD5 */
    PORT_SetPinMux(BOARD_LED_YELLOW3_PORT, BOARD_LED_YELLOW3_PIN, kPORT_MuxAsGpio);
