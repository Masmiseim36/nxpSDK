...
- pin_list:
  ...
  - {pin_num: '86', peripheral: I2C0, signal: SCL, pin_signal: PTC14/I2C0_SCL, slew_rate: fast, open_drain: enable, pull_select: up, pull_enable: enable}
  - {pin_num: '87', peripheral: I2C0, signal: SDA, pin_signal: PTC15/I2C0_SDA, slew_rate: fast, open_drain: enable, pull_select: up, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
