...
- pin_list:
  ...
  - {pin_num: '25', peripheral: FTM1, signal: 'QD_PH, A', pin_signal: HSADC0A_CH8/ADC0_SE5b/PTE20/FTM1_CH0/UART0_TX/FTM1_QD_PHA}
  - {pin_num: '26', peripheral: FTM1, signal: 'QD_PH, B', pin_signal: HSADC0A_CH9/HSADC1A_CH7/PTE21/XB_IN9/FTM1_CH1/UART0_RX/FTM1_QD_PHB}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORTE20 (pin 25) is configured as FTM1_QD_PHA */
    PORT_SetPinMux(PORTE, 20U, kPORT_MuxAlt5);

    /* PORTE21 (pin 26) is configured as FTM1_QD_PHB */
    PORT_SetPinMux(PORTE, 21U, kPORT_MuxAlt5);
