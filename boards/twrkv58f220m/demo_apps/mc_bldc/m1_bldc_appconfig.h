 ...
 */
/**********************************************************************/
// File Name: {FM_project_loc}/../../../src/projects/twr-kv58f/bldc_appconfig.h
//
// Date:  July 19, 2016, 17:19:53
//
...
#define M1_ALIGN_CURRENT FRAC16(0.125)
...
#define M1_SPEED_LOOP_KP_GAIN ACC32(0.0034557519189487725)
#define M1_SPEED_LOOP_KI_GAIN ACC32(0.0034557519189487725)
...
//----------------------------------------------------------------------
// Timer Frequency                       = 927734 [Hz]
//----------------------------------------------------------------------
#define M1_N_MIN FRAC16(0.056818181818)
#define M1_N_START_TRH FRAC16(0.068181818182)
#define M1_STARTUP_CMT_CNT (2)
#define M1_STARTUP_CMT_PER (23193)
#define M1_CMT_T_OFF FRAC16(0.22)
#define M1_FREEWHEEL_T_LONG (1000)
#define M1_FREEWHEEL_T_SHORT (500)
#define M1_SPEED_SCALE_CONST (6325)
#define M1_CMT_PER_MIN (1054)
#define M1_START_CMT_ACCELER FRAC16(0.666666666667)
