...
- {pin_num: '88', pin_signal: HSADC1A_CH13/PTB7/CAN2_RX/FLEXPWM1_X3/FB_AD22, label: 'J15[B22]', identifier: BREAKING_RESISTOR}
...
- pin_list:
  ...
  - {pin_num: '88', peripheral: GPIOB, signal: 'GPIO, 7', pin_signal: HSADC1A_CH13/PTB7/CAN2_RX/FLEXPWM1_X3/FB_AD22, direction: OUTPUT, gpio_init_state: 'true'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
- pin_list:
  ...
  - {pin_num: '45', peripheral: PWM0, signal: 'FAULT, 0', pin_signal: HSADC0B_CH4/HSADC1B_CH4/PTE24/CAN1_TX/FTM0_CH0/XB_IN2/I2C0_SCL/EWM_OUT_b/XB_OUT4/UART4_TX}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void PinTool_PWM(void)
{
    ...
    PORT_SetPinMux(PINTOOL_PWM_PWM_A2_PORT, PINTOOL_PWM_PWM_A2_PIN, kPORT_MuxAlt6);
    ...
    /* PORTE24 (pin 45) is configured as XB_IN2 */
    PORT_SetPinMux(PORTE, 24U, kPORT_MuxAlt4);
