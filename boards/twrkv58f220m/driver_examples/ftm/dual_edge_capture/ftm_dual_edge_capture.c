...
/* FTM channel pair used for the dual-edge capture, channel pair 3 uses channels 6 and 7 */
#define BOARD_FTM_INPUT_CAPTURE_CHANNEL_PAIR kFTM_Chnl_3
...
#define FTM_FIRST_CHANNEL_INTERRUPT_ENABLE kFTM_Chnl6InterruptEnable
#define FTM_FIRST_CHANNEL_FLAG kFTM_Chnl6Flag
#define FTM_SECOND_CHANNEL_INTERRUPT_ENABLE kFTM_Chnl7InterruptEnable
#define FTM_SECOND_CHANNEL_FLAG kFTM_Chnl7Flag
