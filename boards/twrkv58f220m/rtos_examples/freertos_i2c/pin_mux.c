...
- pin_list:
  ...
  - {pin_num: '111', peripheral: I2C0, signal: SCL, pin_signal: CMP2_IN4/CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/PDB0_EXTRG/XB_IN3/UART0_RX/XB_OUT6/I2C0_SCL/FB_AD9, slew_rate: fast,
    open_drain: enable, pull_select: up, pull_enable: enable}
  - {pin_num: '112', peripheral: I2C0, signal: SDA, pin_signal: CMP3_IN4/CMP0_IN1/PTC7/SPI0_SIN/XB_IN4/UART0_TX/XB_OUT7/I2C0_SDA/FB_AD8, slew_rate: fast, open_drain: enable,
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t portc6_pin111_config = {/* Internal pull-up resistor is enabled */
                                                    kPORT_PullUp,
    ...
    /* PORTC6 (pin 111) is configured as I2C0_SCL */
    PORT_SetPinConfig(PORTC, 6U, &portc6_pin111_config);

    const port_pin_config_t portc7_pin112_config = {/* Internal pull-up resistor is enabled */
                                                    kPORT_PullUp,
                                                    /* Fast slew rate is configured */
                                                    kPORT_FastSlewRate,
                                                    /* Passive filter is disabled */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORTC7 (pin 112) is configured as I2C0_SDA */
    PORT_SetPinConfig(PORTC, 7U, &portc7_pin112_config);
