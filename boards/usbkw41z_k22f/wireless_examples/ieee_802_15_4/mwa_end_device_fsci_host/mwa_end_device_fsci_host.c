...
*************************************************************************************
********************************************************************************** */
#include "mwa_end_device_fsci_host.h"
...
NVM_DataEntry_t NvDataTable[] = {
  {&mCoordInfo,          1,   sizeof(panDescriptor_t), mCoordInfo_ID_c},
  {&maMyAddress,         1,   8, maMyAddress_ID_c},
  {&mAddrMode,           1,   sizeof(addrModeType_t), mAddrMode_ID_c},
  {NULL,                 0,   0, gNvEndOfTableId_c}
};

NVM_DataEntry_t *pNVM_DataTable = NvDataTable;
#endif
