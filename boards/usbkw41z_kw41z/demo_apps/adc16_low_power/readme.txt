...
Note:
 - when the temperature is rised: LED RED D2 on, LED RED D3 off.
 - when the temperature is reduced: LED RED D3 on, LED RED D2 off.
 - When the temperature is constant: both LED RED D2 and D3 are on. 
