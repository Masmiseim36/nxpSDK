...
#if gAppUseBonding_d
static bool_t mRestoringBondedLinkEncryption = FALSE;
#endif
...
{    
    ...
    L2ca_RegisterLePsm (gOtap_L2capLePsm_c,
                        gOtapCmdImageChunkCocMaxLength_c);  /*!< The negotiated MTU must be higher than the bigest data chunk that will be sent fragmented */
...
static void BleApp_ConnectionCallback (deviceId_t peerDeviceId, gapConnectionEvent_t* pConnectionEvent)
{
    ...
    switch (pConnectionEvent->eventType)
    {
        case gConnEvtConnected_c:
        {
            ...
            {              
                mRestoringBondedLinkEncryption = TRUE;
        ...
        {
            if (mRestoringBondedLinkEncryption)
            {
                mRestoringBondedLinkEncryption = FALSE;
            }
        }
        break;
...
)
{
     ...
     * it in the applciation data structure. */
