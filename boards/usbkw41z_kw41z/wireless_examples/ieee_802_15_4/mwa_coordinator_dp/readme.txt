Overview
========
This application represents the "802.15.4 Coordinator" of the My Wireless Application Dual PAN Demo, and it demonstrates 
the following:
- channel selection algorithm
- the creation of two Personal Area Network (PAN) on the same device (same channel or different channels)
...
Prepare the Demo
================
1.  Connect the board the PC host.
