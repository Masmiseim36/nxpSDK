Overview
========
This application represents the "802.15.4 Coordinator" of the My Wireless Application Security Enabled Demo, and it 
demonstrates the following:
- configuration of security parameters
- channel selection algorithm
- the creation of a secured Personal Area Network (PAN)
- device association procedure
- the exchange of encrypted data between the coordinator and the device.
