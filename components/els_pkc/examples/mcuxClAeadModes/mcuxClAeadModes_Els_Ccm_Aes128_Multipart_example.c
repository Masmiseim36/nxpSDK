...
/**
 * @file:  mcuxClAeadModes_Els_Ccm_Aes128_Multipart_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClAeadModes_Els_Ccm_Aes128_Multipart_example)
{
    ...
    MCUXCLEXAMPLE_ALLOCATE_AND_INITIALIZE_SESSION(session, MCUXCLEXAMPLE_MAX_WA(MCUXCLAEAD_WA_SIZE_MAX, MCUXCLRANDOMMODES_NCINIT_WACPU_SIZE), 0u);
