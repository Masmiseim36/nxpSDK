...
static ALIGNED uint8_t const msg_plain[3u * MCUXCLAES_BLOCK_SIZE - 4u] = {
...
static ALIGNED uint8_t const msg_enc_expected[3u * MCUXCLAES_BLOCK_SIZE - 4u] = {
...
MCUXCLEXAMPLE_FUNCTION(mcuxClCipherModes_Els_Ctr_Aes128_Oneshot_example)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    ALIGNED uint8_t msg_enc[3u * MCUXCLAES_BLOCK_SIZE - 4u];
    ...
    ALIGNED uint8_t msg_dec[3u * MCUXCLAES_BLOCK_SIZE - 4u];
