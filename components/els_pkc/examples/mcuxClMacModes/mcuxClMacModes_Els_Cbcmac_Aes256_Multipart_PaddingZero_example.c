...
MCUXCLEXAMPLE_FUNCTION(mcuxClMacModes_Els_Cbcmac_Aes256_Multipart_PaddingZero_example)
{
    static ALIGNED uint8_t key256[] = {
    ...
    static const ALIGNED uint8_t inputZeroPadd[] = {
    ...
    static const ALIGNED uint8_t resZeroPadd[] = {
