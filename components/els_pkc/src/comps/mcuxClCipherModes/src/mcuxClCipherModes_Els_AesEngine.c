...
*/
    ...
    .removePaddingEnc = mcuxClPadding_removePadding_None,
    ...
    .protection_token_removePaddingEnc = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClPadding_removePadding_None),
...
*/
    ...
    .removePaddingEnc = mcuxClPadding_removePadding_Stream,
    .protection_token_engine = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClCipherModes_EngineEls),
    .protection_token_addPadding = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClPadding_addPadding_Random),
    .protection_token_removePaddingEnc = MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClPadding_removePadding_Stream),
