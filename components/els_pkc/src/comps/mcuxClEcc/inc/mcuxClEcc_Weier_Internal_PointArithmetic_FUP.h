...
extern const mcuxClPkc_FUPEntry_t mcuxClEcc_FUP_Weier_DoubleAdd[20];
extern const mcuxClPkc_FUPEntry_t mcuxClEcc_FUP_Weier_RepeatDouble[24];

#endif /* MCUXCLECC_WEIER_INTERNAL_POINTARITHMETIC_FUP*/ 
