...
#define MCUXCLHASH_INTERNAL_WACPU_MAX            MCUXCLCORE_MAX(MCUXCLHASHMODES_INTERNAL_WACPU_MAX, MCUXCLOSCCASM3_WACPU_SIZE_SM3)

#define MCUXCLHASH_CONTEXT_MAX_SIZE_INTERNAL     MCUXCLCORE_MAX(MCUXCLHASHMODES_CONTEXT_MAX_SIZE_INTERNAL, MCUXCLOSCCASM3_CONTEXT_SIZE_SM3)
#else
