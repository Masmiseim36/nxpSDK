...
/** @file  mcuxClMacModes_Common_Algorithms.h
 *  @brief Internal header for the MAC context for modes using the SGI
 */

#ifndef MCUXCLMACMODES_COMMON_ALGORITHMS_H_
#define MCUXCLMACMODES_COMMON_ALGORITHMS_H_
...
#endif /* MCUXCLMACMODES_COMMON_ALGORITHMS_H_ */
