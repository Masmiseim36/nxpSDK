...
#define MCUXCL_VERSION "SDK_V2.0.0" ///< String literal for the version string of CLNS release that this header is part of
...
/** @attention This header was delivered as part of a CLNS release with the version string: SDK_V2.0.0.
