...
//#define MCUXCL_FEATURE_HW_DMA_WORKAROUND
...
#define MCUXCL_FEATURE_CIPHERMODES_SM4 1
#define MCUXCL_FEATURE_CIPHER_RSA_DECRYPT 1
#define MCUXCL_FEATURE_CIPHER_RSA_ENCRYPT 1
#define MCUXCL_FEATURE_CRC_CRC32 1
#define MCUXCL_FEATURE_CRC_SW 1
#define MCUXCL_FEATURE_ECC_ECDSA_DETERMINISTIC 1
#define MCUXCL_FEATURE_ECC_STRENGTH_CHECK 1
#define MCUXCL_FEATURE_ELS_AES_WITH_SIDE_CHANNEL_PROTECTION 1
#define MCUXCL_FEATURE_ELS_CMD_CRC 1
#define MCUXCL_FEATURE_ELS_DMA_ADDRESS_READBACK 1
#define MCUXCL_FEATURE_ELS_DMA_FINAL_ADDRESS_READBACK 1
#define MCUXCL_FEATURE_ELS_ECC_ECKXCH_ODD_EVEN 1
#define MCUXCL_FEATURE_ELS_GET_FW_VERSION 1
#define MCUXCL_FEATURE_ELS_KEY_MGMT_KEYPROV_DUK_UPDATE_TEST 1
#define MCUXCL_FEATURE_ELS_KEY_MGMT_KEYPROV_ROM_TEST 1
#define MCUXCL_FEATURE_ELS_LOCKING 1
#define MCUXCL_FEATURE_ELS_NO_INTERNAL_STATE_FLAGS 1
#define MCUXCL_FEATURE_ELS_PRND_INIT 1
#define MCUXCL_FEATURE_ELS_PUK_INTERNAL 1
#define MCUXCL_FEATURE_ELS_PUK_INTERNAL_BIT 1
#define MCUXCL_FEATURE_ELS_RANDOMIZE_RFC3394_OUT 1
#define MCUXCL_FEATURE_ELS_RND_RAW 1
#define MCUXCL_FEATURE_ELS_SHA_DIRECT 1
#define MCUXCL_FEATURE_ELS_SHA_DIRECT_MODE_FLAG 1
#define MCUXCL_FEATURE_GLIKEY 1
#define MCUXCL_FEATURE_GLIKEY_STEPS_4 1
#define MCUXCL_FEATURE_HASH_HW_SM3 1
#define MCUXCL_FEATURE_HW_DMA_WORKAROUND 1
#define MCUXCL_FEATURE_HW_GDET 1
#define MCUXCL_FEATURE_HW_GLIKEY 1
#define MCUXCL_FEATURE_HW_SAFO_SM3 1
#define MCUXCL_FEATURE_HW_SAFO_SM4 1
#define MCUXCL_FEATURE_HW_TRNG 1
#define MCUXCL_FEATURE_KEY_AGREEMENT 1
#define MCUXCL_FEATURE_KEY_DERIVATION 1
#define MCUXCL_FEATURE_KEY_DERIVATION_HKDF 1
#define MCUXCL_FEATURE_KEY_DERIVATION_NIST_SP800_108 1
#define MCUXCL_FEATURE_KEY_DERIVATION_NIST_SP800_56C 1
#define MCUXCL_FEATURE_KEY_DERIVATION_PBKDF2 1
#define MCUXCL_FEATURE_KEY_GENERATION 1
#define MCUXCL_FEATURE_KEY_SELFTEST 1
#define MCUXCL_FEATURE_MACMODES_CBCMAC_SM4 1
#define MCUXCL_FEATURE_MACMODES_CMAC_SM4 1
#define MCUXCL_FEATURE_OSCCA_RNG_256 1
#define MCUXCL_FEATURE_PLATFORM_MIMXRT 1
...
#define MCUXCL_FEATURE_RANDOMMODES_HMACDRBG 1
#define MCUXCL_FEATURE_RANDOMMODES_NORMALMODE 1
#define MCUXCL_FEATURE_RANDOMMODES_OSCCA_TRNG 1
...
#define MCUXCL_FEATURE_RSA_RSAES_PKCS1v15 1
#define MCUXCL_FEATURE_RSA_STRENGTH_CHECK 1
#define MCUXCL_FEATURE_SIGNATURE_ONESHOT 1
#define MCUXCL_FEATURE_SIGNATURE_SELFTEST 1
#define MCUXCL_FEATURE_SIGNATURE_SIGN 1
#define MCUXCL_FEATURE_SIGNATURE_VERIFY 1
#define MCUXCL_FEATURE_SM2_CIPHER 1
#define MCUXCL_FEATURE_SM2_INTERNAL 1
#define MCUXCL_FEATURE_SM2_KEYAGREEMENT 1
#define MCUXCL_FEATURE_SM2_KEYGEN 1
#define MCUXCL_FEATURE_SM2_SIGNATURE 1
#define MCUXCL_FEATURE_SM4_CCM 1
