...
/*****************************************************************************************************************/
/* WARNING: These recipes are here only for compilation success, EL2Go support is not yet done for lpc family */
/*****************************************************************************************************************/
...
#define RECIPE_STEP_CREATE_NXP_DIE_KEK_SK                                                                          \
    {                                                                                                              \
        ...
        .ckdf = {                                                                                                  \
            ...
            .derivation_data           = {0x96, 0xba, 0x23, 0x8c, 0x81, 0x50, 0x42, 0x44, 0x13, 0x8f, 0xf6, 0x32}, \
        },                                                                                                         \
    }
