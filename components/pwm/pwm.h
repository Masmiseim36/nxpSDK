 ...
 *  @code
 *     uint8_t halPwmHandle[HAL_PWM_HANDLE_SIZE];
 *   HAL_PwmInit((hal_pwm_handle_t)&halPwmHandle,BOARD_PWM_INSTANCE,BOARD_PWM_SOURCE_CLOCK)
 *  @endcode
 *
 ...
 *                              detail information please refer to the SOC corresponding RM.Invalid instance value will
