if(NOT COMPONENT_SERIAL_MANAGER_UART_MIMX8QM6_cm4_core0_INCLUDED)
    ...
    #OR Logic component
    if(CONFIG_USE_driver_lpuart_MIMX8QM6_cm4_core0)
         include(driver_lpuart_MIMX8QM6_cm4_core0)
    endif()
    if(NOT (CONFIG_USE_driver_lpuart_MIMX8QM6_cm4_core0))
        message(WARNING "Since driver_lpuart_MIMX8QM6_cm4_core0 is not included at first or config in config.cmake file, use driver_uart_MIMX8QM6_cm4_core0 by default.")
        include(driver_uart_MIMX8QM6_cm4_core0)
    endif()
