...
#define ASRC_FILTER_FIRMWARE_VER 1
#define ASRC_FILTER_FIRMWARE_HEAD 0xdead
/*! @brief ASRC interpolation filter firmware info*/
#define ASRC_FILTER_INTERPOLATION_FILTER_NUM 3
#define ASRC_FILTER_INTERPOLATION_FIRMWARE_LEN 8192 * 2
#define ASRC_FILTER_INTERPOLATION_TAP_INDEX 1
#define ASRC_FILTER_INTERPOLATION_PHASE_INDEX 2
#define ASRC_FILTER_INTERPOLATION_CENTER_TAP_INDEX 3
#define ASRC_FILTER_INTERPOLATION_DATA_INDEX 4
/*! @brief ASRC  prefilter firmware info*/
#define ASRC_FILTER_PREFILTER_FILTER_NUM 0x23
#define ASRC_FILTER_PREFILTER_FIRMWARE_LEN 256 * 2
#define ASRC_FILTER_PREFILTER_IN_SAMPLE_RATE_INDEX 1
#define ASRC_FILTER_PREFILTER_OUT_SAMPLE_RATE_INDEX 2
#define ASRC_FILTER_PREFILTER_STAGE_1_TAPS_INDEX 3
#define ASRC_FILTER_PREFILTER_STAGE_2_TAPS_INDEX 4
#define ASRC_FILTER_PREFILTER_STAGE_1_EXPANSION_FACTOR_INDEX 5
#define ASRC_FILTER_PREFILTER_STAGE_1_DATA_INDEX 6
