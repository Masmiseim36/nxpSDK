; -------------------------------------------------------------------------
;  @file:    startup_MIMX8QM6_cm4_core0.s
...
__vector_table_0x1c
        ...
        DCD     M4_0_MCM_IRQHandler                           ;MCM IRQ
        ...
        DCD     M4_0_TPM_IRQHandler                           ;Timer PWM Module
        DCD     Reserved36_IRQHandler                         ;Reserved
        DCD     Reserved37_IRQHandler                         ;Reserved
        DCD     M4_0_LPIT_IRQHandler                          ;Low-Power Periodic Interrupt Timer
        DCD     Reserved39_IRQHandler                         ;Reserved
        DCD     Reserved40_IRQHandler                         ;Reserved
        DCD     M4_0_LPUART_IRQHandler                        ;Low Power UART
        DCD     Reserved42_IRQHandler                         ;Reserved
        DCD     M4_0_LPI2C_IRQHandler                         ;Low-Power I2C - Logical OR of master and slave interrupts
        DCD     Reserved44_IRQHandler                         ;Reserved
        DCD     M4_0_MU0_B0_IRQHandler                        ;Messaging Unit 0 (IPC with other subsystems) - Side B (local), Port 0, Logical OR of all general-purpose, TX, and RX interrupts
        ...
        DCD     M4_0_MU0_B1_IRQHandler                        ;Messaging Unit 0 (IPC with other subsystems) - Side B (local), Port 1, Logical OR of all general-purpose, TX, and RX interrupts
        DCD     M4_0_MU0_B2_IRQHandler                        ;Messaging Unit 0 (IPC with other subsystems) - Side B (local), Port 2, Logical OR of all general-purpose, TX, and RX interrupts
        DCD     M4_0_MU0_B3_IRQHandler                        ;Messaging Unit 0 (IPC with other subsystems) - Side B (local), Port 3, Logical OR of all general-purpose, TX, and RX interrupts
        DCD     Reserved63_IRQHandler                         ;Reserved
        DCD     Reserved64_IRQHandler                         ;Reserved
        DCD     M4_0_MU1_A_IRQHandler                         ;Messaging Unit 1 (IPC with System Controller) - Side A (MCU), Logical OR of all general-purpose, TX, and RX interrupts
        DCD     M4_0_SW_IRQHandler                            ;Software interrupt (asserted/cleared via NVIC registers, INTISR[50] input tied low)
        ...
        DCD     M4_0_INTMUX_SOURCE_TPM_IRQHandler             ;INTMUX Input source: TPM Interrupt
        DCD     Reserved581_IRQHandler                        ;xxx Interrupt 581
        DCD     Reserved582_IRQHandler                        ;xxx Interrupt 582
        DCD     M4_0_INTMUX_SOURCE_LPIT_IRQHandler            ;INTMUX Input source: LPIT Interrupt
        DCD     Reserved584_IRQHandler                        ;xxx Interrupt 584
        DCD     Reserved585_IRQHandler                        ;xxx Interrupt 585
        DCD     M4_0_INTMUX_SOURCE_LPUART_IRQHandler          ;INTMUX Input source: LPUART Interrupt
        DCD     Reserved587_IRQHandler                        ;xxx Interrupt 587
        DCD     M4_0_INTMUX_SOURCE_LPI2C_IRQHandler           ;INTMUX Input source: LPI2C Interrupt
        ...
        DCD     M4_0_INTMUX_SOURCE_MU0_A3_IRQHandler          ;INTMUX Input source: MU0_A3 Interrupt
        DCD     M4_0_INTMUX_SOURCE_MU0_A2_IRQHandler          ;INTMUX Input source: MU0_A2 Interrupt
        DCD     M4_0_INTMUX_SOURCE_MU0_A1_IRQHandler          ;INTMUX Input source: MU0_A1 Interrupt
        DCD     M4_0_INTMUX_SOURCE_MU0_A0_IRQHandler          ;INTMUX Input source: MU0_A0 Interrupt
        DCD     DefaultISR                                    ;611
        DCD     DefaultISR                                    ;612
        DCD     DefaultISR                                    ;613
        DCD     DefaultISR                                    ;614
...
SysTick_Handler
        ...
        PUBWEAK M4_0_TPM_IRQHandler
        PUBWEAK Reserved36_IRQHandler
        PUBWEAK Reserved37_IRQHandler
        PUBWEAK M4_0_LPIT_IRQHandler
        PUBWEAK Reserved39_IRQHandler
        PUBWEAK Reserved40_IRQHandler
        PUBWEAK M4_0_LPUART_IRQHandler
        PUBWEAK M4_0_LPUART_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_LPUART_IRQHandler
        LDR     R0, =M4_0_LPUART_DriverIRQHandler
        BX      R0

        PUBWEAK Reserved42_IRQHandler
        PUBWEAK M4_0_LPI2C_IRQHandler
        PUBWEAK M4_0_LPI2C_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_LPI2C_IRQHandler
        LDR     R0, =M4_0_LPI2C_DriverIRQHandler
        BX      R0

        PUBWEAK Reserved44_IRQHandler
        PUBWEAK M4_0_MU0_B0_IRQHandler
...
IRQSTEER_7_IRQHandler
        ...
        PUBWEAK M4_0_MU0_B1_IRQHandler
        PUBWEAK M4_0_MU0_B2_IRQHandler
        PUBWEAK M4_0_MU0_B3_IRQHandler
        PUBWEAK Reserved63_IRQHandler
        PUBWEAK Reserved64_IRQHandler
        PUBWEAK M4_0_MU1_A_IRQHandler
        PUBWEAK M4_0_SW_IRQHandler
...
AUDIO_SPDIF1_TX_DMA_INT_IRQHandler
        ...
        PUBWEAK M4_0_INTMUX_SOURCE_TPM_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_TPM_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_TPM_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_TPM_DriverIRQHandler
        BX      R0

        PUBWEAK Reserved581_IRQHandler
        PUBWEAK Reserved582_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_LPIT_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_LPIT_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_LPIT_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_LPIT_DriverIRQHandler
        BX      R0

        PUBWEAK Reserved584_IRQHandler
        PUBWEAK Reserved585_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_LPUART_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_LPUART_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_LPUART_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_LPUART_DriverIRQHandler
        BX      R0

        PUBWEAK Reserved587_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_LPI2C_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_LPI2C_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_LPI2C_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_LPI2C_DriverIRQHandler
        BX      R0
        ...
        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A3_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A3_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_MU0_A3_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_MU0_A3_DriverIRQHandler
        BX      R0

        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A2_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A2_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_MU0_A2_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_MU0_A2_DriverIRQHandler
        BX      R0

        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A1_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A1_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_MU0_A1_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_MU0_A1_DriverIRQHandler
        BX      R0

        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A0_IRQHandler
        PUBWEAK M4_0_INTMUX_SOURCE_MU0_A0_DriverIRQHandler
        SECTION .text:CODE:REORDER:NOROOT(2)
M4_0_INTMUX_SOURCE_MU0_A0_IRQHandler
        LDR     R0, =M4_0_INTMUX_SOURCE_MU0_A0_DriverIRQHandler
        BX      R0
...
M4_0_MU0_B1_IRQHandler
M4_0_MU0_B2_IRQHandler
M4_0_MU0_B3_IRQHandler
Reserved63_IRQHandler
Reserved64_IRQHandler
M4_0_MU1_A_IRQHandler
M4_0_SW_IRQHandler
...
M4_0_INTMUX_SOURCE_TPM_DriverIRQHandler
Reserved581_IRQHandler
Reserved582_IRQHandler
M4_0_INTMUX_SOURCE_LPIT_DriverIRQHandler
Reserved584_IRQHandler
Reserved585_IRQHandler
M4_0_INTMUX_SOURCE_LPUART_DriverIRQHandler
Reserved587_IRQHandler
M4_0_INTMUX_SOURCE_LPI2C_DriverIRQHandler
...
M4_0_INTMUX_SOURCE_MU0_A3_DriverIRQHandler
M4_0_INTMUX_SOURCE_MU0_A2_DriverIRQHandler
M4_0_INTMUX_SOURCE_MU0_A1_DriverIRQHandler
M4_0_INTMUX_SOURCE_MU0_A0_DriverIRQHandler
DefaultISR
        B DefaultISR
