...
/*!
 * @file MIMX8QM6_cm4_core1
 * @version 4.0
 * @date 2018-08-30
 * @brief Device specific configuration file for MIMX8QM6_cm4_core1
 *        (implementation file)
 *
...
#if (DISABLE_WDOG)
  CM4_1__WDOG->CNT = WDOG_UPDATE_KEY;
  CM4_1__WDOG->TOVAL = 0xFFFF;
...
/* i.MX8QM SystemCoreClockUpdate */
  ...
  err = sc_pm_get_clock_rate(ipcHandle, SC_R_M4_1_PID0, SC_PM_CLK_CPU, &freq);
...
void SystemInitScfwIpc (void) {
    ...
    err = sc_ipc_open(&ipc, (sc_ipc_id_t)CM4_1__MU1_A);
