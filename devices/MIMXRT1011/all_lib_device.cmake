...
include_if_use(component_log_backend_debug_console.MIMXRT1011)
include_if_use(component_log_backend_debug_console_lite.MIMXRT1011)
...
include_if_use(component_mem_manager_freertos.MIMXRT1011)
include_if_use(component_mem_manager_legacy.MIMXRT1011)
include_if_use(component_mem_manager_light.MIMXRT1011)
include_if_use(component_mflash_offchip.MIMXRT1011)
include_if_use(component_mflash_onchip.MIMXRT1011)
...
include_if_use(component_tfa9896_adapter.MIMXRT1011)
include_if_use(component_tfa9xxx_adapter.MIMXRT1011)
include_if_use(component_timer_manager.MIMXRT1011)
include_if_use(component_trng_adapter.MIMXRT1011)
include_if_use(component_wm8524_adapter.MIMXRT1011)
include_if_use(component_wm8904_adapter.MIMXRT1011)
include_if_use(component_wm8960_adapter.MIMXRT1011)
include_if_use(component_wm8962_adapter.MIMXRT1011)
include_if_use(device_CMSIS.MIMXRT1011)
include_if_use(device_RTE.MIMXRT1011)
include_if_use(device_boot_header.MIMXRT1011)
include_if_use(device_project_template.MIMXRT1011)
include_if_use(device_startup.MIMXRT1011)
include_if_use(device_system.MIMXRT1011)
...
include_if_use(driver_ak4497.MIMXRT1011)
include_if_use(driver_aoi.MIMXRT1011)
include_if_use(driver_cache_armv7_m7.MIMXRT1011)
include_if_use(driver_camera-common.MIMXRT1011)
include_if_use(driver_camera-device-ap1302.MIMXRT1011)
include_if_use(driver_camera-device-common.MIMXRT1011)
include_if_use(driver_camera-device-max9286.MIMXRT1011)
include_if_use(driver_camera-device-mt9m114.MIMXRT1011)
include_if_use(driver_camera-device-ov5640.MIMXRT1011)
include_if_use(driver_camera-device-ov7670.MIMXRT1011)
...
include_if_use(driver_display-adv7535.MIMXRT1011)
include_if_use(driver_display-common.MIMXRT1011)
include_if_use(driver_display-it6161.MIMXRT1011)
include_if_use(driver_display-it6263.MIMXRT1011)
include_if_use(driver_display-sn65dsi83.MIMXRT1011)
include_if_use(driver_dmamux.MIMXRT1011)
include_if_use(driver_edma.MIMXRT1011)
include_if_use(driver_ektf2k.MIMXRT1011)
...
include_if_use(driver_lsm6dso.MIMXRT1011)
include_if_use(driver_max30101.MIMXRT1011)
...
include_if_use(driver_pcm186x.MIMXRT1011)
include_if_use(driver_pcm512x.MIMXRT1011)
include_if_use(driver_pf1550.MIMXRT1011)
include_if_use(driver_pf3000.MIMXRT1011)
include_if_use(driver_pf5020.MIMXRT1011)
include_if_use(driver_pit.MIMXRT1011)
include_if_use(driver_pmu.MIMXRT1011)
include_if_use(driver_psp27801.MIMXRT1011)
...
include_if_use(driver_ssd1963.MIMXRT1011)
include_if_use(driver_st7796s.MIMXRT1011)
include_if_use(driver_tempmon.MIMXRT1011)
include_if_use(driver_tfa9896.MIMXRT1011)
include_if_use(driver_tfa9xxx.MIMXRT1011)
include_if_use(driver_tfa9xxx_hal.MIMXRT1011)
include_if_use(driver_tma525b.MIMXRT1011)
include_if_use(driver_trng.MIMXRT1011)
include_if_use(driver_tsl2561.MIMXRT1011)
include_if_use(driver_video-common.MIMXRT1011)
include_if_use(driver_video-i2c.MIMXRT1011)
include_if_use(driver_wdog01.MIMXRT1011)
include_if_use(driver_wm8524.MIMXRT1011)
include_if_use(driver_wm8904.MIMXRT1011)
include_if_use(driver_wm8960.MIMXRT1011)
include_if_use(driver_wm8962.MIMXRT1011)
...
include_if_use(utility_debug_console_template_config.MIMXRT1011)
include_if_use(utility_incbin.MIMXRT1011)
