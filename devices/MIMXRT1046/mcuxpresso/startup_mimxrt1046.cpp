//*****************************************************************************
// MIMXRT1046 startup code for use with MCUXpresso IDE
//
// Version : 251024
//*****************************************************************************
//
...
WEAK void USB_OTG_IRQHandler(void);
...
void USB_OTG_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    LPSPI4_IRQHandler,                // 50 : LPSPI4 single interrupt vector for all sources
    LPSPI3_IRQHandler,                // 51 : LPSPI3 single interrupt vector for all sources
    ...
    USB_PHY_IRQHandler,               // 81 : USBPHY (UTMI0), Interrupt
    ...
    FLEXSPI_IRQHandler,               // 124: FlexSPI interrupt
    ...
    USB_OTG_IRQHandler,               // 129: USBO2 USB OTG
