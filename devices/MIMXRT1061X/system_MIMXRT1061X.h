 ...
 * @version 0.1
 * @date 2022-01-25
 * @brief Device specific configuration file for MIMXRT1061X (header file)
 *
...
#ifndef _SYSTEM_MIMXRT1061X_H_
#define _SYSTEM_MIMXRT1061X_H_                   /**< Symbol preventing repeated inclusion */
