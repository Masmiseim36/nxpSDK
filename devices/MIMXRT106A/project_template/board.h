...
#define BOARD_PDM_SAI_CLK_FREQ (CLOCK_GetFreq(kCLOCK_AudioPllClk) / (BOARD_PDM_SAI_CLOCK_SOURCE_DIVIDER + 1U) / (BOARD_PDM_SAI_CLOCK_SOURCE_PRE_DIVIDER + 1U))
...
#define BOARD_AMP_SAI_CLK_FREQ (CLOCK_GetFreq(kCLOCK_AudioPllClk) / (BOARD_AMP_SAI_CLOCK_SOURCE_DIVIDER + 1U) / (BOARD_AMP_SAI_CLOCK_SOURCE_PRE_DIVIDER + 1U))
...
#define BOARD_WL_REG_ON_port GPIO5
#define BOARD_WL_REG_ON_pin  1U
...
/* @brief BLE PWR Pins*/
#define BOARD_BT_REG_ON_port GPIO2
#define BOARD_BT_REG_ON_pin  30U
