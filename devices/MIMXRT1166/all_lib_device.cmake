...
#  # description: board_pt_cm4_evkmimxrt1160
#  set(CONFIG_USE_board_project_template_cm4 true)
...
#  set(CONFIG_USE_driver_mipi_csi2rx_soc true)
...
#  # description: RPMsg-Lite for evkmimxrt1160 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_imxrt1160 true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmimxrt1160/project_template
...
include_if_use(component_codec_i2c.MIMXRT1166)
...
include_if_use(component_flash_nand_flexspi.MIMXRT1166)
include_if_use(component_flash_nand_semc.MIMXRT1166)
include_if_use(component_flash_nor_flexspi.MIMXRT1166)
include_if_use(component_flash_nor_lpspi.MIMXRT1166)
...
include_if_use(component_log.MIMXRT1166)
include_if_use(component_log_backend_debug_console.MIMXRT1166)
include_if_use(component_log_backend_debug_console_lite.MIMXRT1166)
include_if_use(component_log_backend_ringbuffer.MIMXRT1166)
include_if_use(component_lpi2c_adapter.MIMXRT1166)
...
include_if_use(component_mem_manager_light.MIMXRT1166)
include_if_use(component_mflash_offchip.MIMXRT1166)
include_if_use(component_mflash_onchip.MIMXRT1166)
...
include_if_use(component_serial_manager_uart.MIMXRT1166)
include_if_use(component_serial_manager_usb_cdc.MIMXRT1166)
include_if_use(component_serial_manager_virtual.MIMXRT1166)
include_if_use(component_sgtl_adapter.MIMXRT1166)
include_if_use(component_silicon_id.MIMXRT1166)
include_if_use(component_silicon_id_imx8.MIMXRT1166)
include_if_use(component_silicon_id_imx93.MIMXRT1166)
...
include_if_use(component_software_rng_adapter.MIMXRT1166)
...
include_if_use(component_wm8962_adapter.MIMXRT1166)
include_if_use(device_CMSIS.MIMXRT1166)
include_if_use(device_RTE.MIMXRT1166)
include_if_use(device_boot_header.MIMXRT1166)
include_if_use(device_project_template.MIMXRT1166)
include_if_use(device_startup.MIMXRT1166)
include_if_use(device_system.MIMXRT1166)
include_if_use(driver_acmp.MIMXRT1166)
include_if_use(driver_adc_etc.MIMXRT1166)
include_if_use(driver_ak4497.MIMXRT1166)
include_if_use(driver_anatop_ai.MIMXRT1166)
include_if_use(driver_aoi.MIMXRT1166)
include_if_use(driver_asrc.MIMXRT1166)
include_if_use(driver_asrc_edma.MIMXRT1166)
include_if_use(driver_caam.MIMXRT1166)
include_if_use(driver_cache_armv7_m7.MIMXRT1166)
include_if_use(driver_cache_lmem.MIMXRT1166)
include_if_use(driver_camera-common.MIMXRT1166)
include_if_use(driver_camera-device-ap1302.MIMXRT1166)
include_if_use(driver_camera-device-common.MIMXRT1166)
include_if_use(driver_camera-device-max9286.MIMXRT1166)
include_if_use(driver_camera-device-mt9m114.MIMXRT1166)
include_if_use(driver_camera-device-ov5640.MIMXRT1166)
include_if_use(driver_camera-device-ov7670.MIMXRT1166)
include_if_use(driver_camera-device-ov7725.MIMXRT1166)
...
include_if_use(driver_cmsis_lpi2c.MIMXRT1166)
include_if_use(driver_cmsis_lpspi.MIMXRT1166)
include_if_use(driver_cmsis_lpuart.MIMXRT1166)
include_if_use(driver_codec.MIMXRT1166)
include_if_use(driver_common.MIMXRT1166)
include_if_use(driver_cs42448.MIMXRT1166)
include_if_use(driver_cs42888.MIMXRT1166)
...
include_if_use(driver_dc-fb-elcdif.MIMXRT1166)
include_if_use(driver_dc-fb-lcdifv2.MIMXRT1166)
include_if_use(driver_dc-fb-ssd1963.MIMXRT1166)
include_if_use(driver_dcdc_2.MIMXRT1166)
include_if_use(driver_dcic.MIMXRT1166)
include_if_use(driver_dialog7212.MIMXRT1166)
include_if_use(driver_display-adv7535.MIMXRT1166)
include_if_use(driver_display-co5300.MIMXRT1166)
include_if_use(driver_display-common.MIMXRT1166)
include_if_use(driver_display-hx8394.MIMXRT1166)
include_if_use(driver_display-it6161.MIMXRT1166)
include_if_use(driver_display-it6263.MIMXRT1166)
include_if_use(driver_display-mipi-dsi-cmd.MIMXRT1166)
include_if_use(driver_display-rm67162.MIMXRT1166)
include_if_use(driver_display-rm67191.MIMXRT1166)
include_if_use(driver_display-rm68191.MIMXRT1166)
include_if_use(driver_display-rm68200.MIMXRT1166)
include_if_use(driver_display-rm692c9.MIMXRT1166)
include_if_use(driver_display-rpi.MIMXRT1166)
include_if_use(driver_display-sn65dsi83.MIMXRT1166)
include_if_use(driver_dmamux.MIMXRT1166)
include_if_use(driver_edma.MIMXRT1166)
include_if_use(driver_ektf2k.MIMXRT1166)
include_if_use(driver_elcdif.MIMXRT1166)
include_if_use(driver_enc.MIMXRT1166)
include_if_use(driver_enet.MIMXRT1166)
include_if_use(driver_ewm.MIMXRT1166)
include_if_use(driver_fbdev.MIMXRT1166)
...
include_if_use(driver_flexio_uart_edma.MIMXRT1166)
include_if_use(driver_flexram.MIMXRT1166)
include_if_use(driver_flexram_allocate.MIMXRT1166)
include_if_use(driver_flexspi.MIMXRT1166)
include_if_use(driver_flexspi_edma.MIMXRT1166)
include_if_use(driver_ft3267.MIMXRT1166)
include_if_use(driver_ft5406.MIMXRT1166)
include_if_use(driver_ft5406_rt.MIMXRT1166)
include_if_use(driver_ft6x06.MIMXRT1166)
include_if_use(driver_fxas21002cq.MIMXRT1166)
include_if_use(driver_fxls8974cf.MIMXRT1166)
include_if_use(driver_fxos8700cq.MIMXRT1166)
include_if_use(driver_gpc_xxx_ctrl.MIMXRT1166)
include_if_use(driver_gpt.MIMXRT1166)
include_if_use(driver_gt911.MIMXRT1166)
include_if_use(driver_htu21d.MIMXRT1166)
include_if_use(driver_icm42688p.MIMXRT1166)
include_if_use(driver_iee.MIMXRT1166)
include_if_use(driver_iee_apc.MIMXRT1166)
include_if_use(driver_igpio.MIMXRT1166)
include_if_use(driver_ili9341.MIMXRT1166)
include_if_use(driver_iomuxc.MIMXRT1166)
include_if_use(driver_key_manager.MIMXRT1166)
include_if_use(driver_kpp.MIMXRT1166)
include_if_use(driver_lcdifv2.MIMXRT1166)
include_if_use(driver_lpadc.MIMXRT1166)
include_if_use(driver_lpi2c.MIMXRT1166)
include_if_use(driver_lpi2c_edma.MIMXRT1166)
include_if_use(driver_lpi2c_freertos.MIMXRT1166)
include_if_use(driver_lpspi.MIMXRT1166)
include_if_use(driver_lpspi_edma.MIMXRT1166)
include_if_use(driver_lpspi_freertos.MIMXRT1166)
include_if_use(driver_lpuart.MIMXRT1166)
include_if_use(driver_lpuart_edma.MIMXRT1166)
include_if_use(driver_lpuart_freertos.MIMXRT1166)
include_if_use(driver_lsm6dso.MIMXRT1166)
include_if_use(driver_max30101.MIMXRT1166)
include_if_use(driver_mecc.MIMXRT1166)
include_if_use(driver_memory.MIMXRT1166)
include_if_use(driver_mipi_csi2rx.MIMXRT1166)
include_if_use(driver_mipi_csi2rx_soc.MIMXRT1166)
include_if_use(driver_mipi_dsi_split.MIMXRT1166)
include_if_use(driver_mma8451q.MIMXRT1166)
include_if_use(driver_mma8652fc.MIMXRT1166)
...
include_if_use(driver_pcm512x.MIMXRT1166)
include_if_use(driver_pdm.MIMXRT1166)
include_if_use(driver_pdm_edma.MIMXRT1166)
include_if_use(driver_pf1550.MIMXRT1166)
include_if_use(driver_pf3000.MIMXRT1166)
include_if_use(driver_pf5020.MIMXRT1166)
include_if_use(driver_pgmc.MIMXRT1166)
include_if_use(driver_pit.MIMXRT1166)
include_if_use(driver_pmu_1.MIMXRT1166)
include_if_use(driver_psp27801.MIMXRT1166)
include_if_use(driver_puf.MIMXRT1166)
include_if_use(driver_pwm.MIMXRT1166)
include_if_use(driver_pxp.MIMXRT1166)
include_if_use(driver_qtmr_1.MIMXRT1166)
include_if_use(driver_rdc.MIMXRT1166)
include_if_use(driver_rdc_sema42.MIMXRT1166)
include_if_use(driver_romapi.MIMXRT1166)
include_if_use(driver_rtwdog.MIMXRT1166)
include_if_use(driver_sai.MIMXRT1166)
include_if_use(driver_sai_edma.MIMXRT1166)
include_if_use(driver_sema4.MIMXRT1166)
include_if_use(driver_semc.MIMXRT1166)
include_if_use(driver_sgtl5000.MIMXRT1166)
include_if_use(driver_smartcard_emvsim.MIMXRT1166)
include_if_use(driver_smartcard_phy_emvsim.MIMXRT1166)
include_if_use(driver_smartcard_uart.MIMXRT1166)
include_if_use(driver_snvs_hp.MIMXRT1166)
include_if_use(driver_snvs_lp.MIMXRT1166)
include_if_use(driver_soc_mipi_dsi.MIMXRT1166)
include_if_use(driver_spdif.MIMXRT1166)
include_if_use(driver_spdif_edma.MIMXRT1166)
include_if_use(driver_src_2.MIMXRT1166)
include_if_use(driver_ssarc.MIMXRT1166)
include_if_use(driver_ssd1963.MIMXRT1166)
include_if_use(driver_st7796s.MIMXRT1166)
include_if_use(driver_tempsensor.MIMXRT1166)
include_if_use(driver_tfa9896.MIMXRT1166)
include_if_use(driver_tfa9xxx.MIMXRT1166)
include_if_use(driver_tfa9xxx_hal.MIMXRT1166)
include_if_use(driver_tma525b.MIMXRT1166)
include_if_use(driver_tsl2561.MIMXRT1166)
include_if_use(driver_usdhc.MIMXRT1166)
include_if_use(driver_video-common.MIMXRT1166)
include_if_use(driver_video-i2c.MIMXRT1166)
include_if_use(driver_wdog01.MIMXRT1166)
include_if_use(driver_wm8524.MIMXRT1166)
include_if_use(driver_wm8904.MIMXRT1166)
include_if_use(driver_wm8960.MIMXRT1166)
include_if_use(driver_wm8962.MIMXRT1166)
include_if_use(driver_xbara.MIMXRT1166)
include_if_use(driver_xbarb.MIMXRT1166)
include_if_use(driver_xecc.MIMXRT1166)
include_if_use(driver_xrdc2.MIMXRT1166)
...
include_if_use(middleware_multicore_rpmsg-lite_imxrt1160)
...
include_if_use(utilities_misc_utilities.MIMXRT1166)
include_if_use(utility_assert.MIMXRT1166)
include_if_use(utility_assert_lite.MIMXRT1166)
include_if_use(utility_debug_console.MIMXRT1166)
include_if_use(utility_debug_console_lite.MIMXRT1166)
include_if_use(utility_debug_console_template_config.MIMXRT1166)
include_if_use(utility_incbin.MIMXRT1166)
include_if_use(utility_notifier.MIMXRT1166)
include_if_use(utility_shell.MIMXRT1166)
include_if_use(utility_str.MIMXRT1166)
