 ...
 * @version 1.0
 * @date 2021-02-03
 * @brief Device specific configuration file for MIMXRT1172 (header file)
 *
...
#ifndef _SYSTEM_MIMXRT1172_H_
#define _SYSTEM_MIMXRT1172_H_                    /**< Symbol preventing repeated inclusion */
