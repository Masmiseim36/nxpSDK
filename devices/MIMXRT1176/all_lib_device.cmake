...
#  # description: board_pt_cm7_evkbmimxrt1170
#  set(CONFIG_USE_board_project_template_cm7 true)

#  # description: board_pt_cm4_evkbmimxrt1170
...
#  # description: RPMsg-Lite for evkmimxrt1170 application
#  set(CONFIG_USE_middleware_multicore_rpmsg-lite_imxrt1170 true)
...
#  # description: PSA crypto driver for CAAM
#  set(CONFIG_USE_component_psa_crypto_driver_caam true)
...
#  # description: MCAT2.0 bldc frac files
#  set(CONFIG_USE_middleware_motor_control_bldc_frac_imcat true)
...
include_if_use(component_ak4497_adapter.MIMXRT1176)
include_if_use(component_at_least_one_i2c_mux_device_enabled.MIMXRT1176)
...
include_if_use(component_enable_pca9544.MIMXRT1176)
include_if_use(component_enable_pca9548.MIMXRT1176)
include_if_use(component_eth_phy_common.MIMXRT1176)
include_if_use(component_exception_handling_cm7.MIMXRT1176)
include_if_use(component_flash_adapter.MIMXRT1176)
include_if_use(component_flash_nand_flexspi.MIMXRT1176)
include_if_use(component_flash_nand_semc.MIMXRT1176)
include_if_use(component_flash_nor_flexspi.MIMXRT1176)
include_if_use(component_flash_nor_lpspi.MIMXRT1176)
...
include_if_use(component_i2c_adapter_interface.MIMXRT1176)
include_if_use(component_i2c_mux_pca954x.MIMXRT1176)
...
include_if_use(component_log_backend_debug_console.MIMXRT1176)
include_if_use(component_log_backend_debug_console_lite.MIMXRT1176)
...
include_if_use(component_mcxw_flash_adapter.MIMXRT1176)
include_if_use(component_mem_manager.MIMXRT1176)
include_if_use(component_mem_manager_freertos.MIMXRT1176)
include_if_use(component_mem_manager_legacy.MIMXRT1176)
include_if_use(component_mem_manager_light.MIMXRT1176)
include_if_use(component_messaging.MIMXRT1176)
include_if_use(component_mflash_offchip.MIMXRT1176)
include_if_use(component_mflash_onchip.MIMXRT1176)
...
include_if_use(component_pcm186x_adapter.MIMXRT1176)
include_if_use(component_pcm512x_adapter.MIMXRT1176)
include_if_use(component_phyaqr113c.MIMXRT1176)
include_if_use(component_phyar8031.MIMXRT1176)
include_if_use(component_phydp8384x.MIMXRT1176)
include_if_use(component_phygpy215.MIMXRT1176)
include_if_use(component_phyksz8041.MIMXRT1176)
include_if_use(component_phyksz8081.MIMXRT1176)
include_if_use(component_phylan8720a.MIMXRT1176)
include_if_use(component_phylan8741.MIMXRT1176)
include_if_use(component_phyrtl8201.MIMXRT1176)
include_if_use(component_phyrtl8211f.MIMXRT1176)
include_if_use(component_phytja1100.MIMXRT1176)
include_if_use(component_phytja1120.MIMXRT1176)
include_if_use(component_phyvsc8541.MIMXRT1176)
include_if_use(component_phyyt8521.MIMXRT1176)
include_if_use(component_pit_adapter.MIMXRT1176)
include_if_use(component_pit_time_stamp_adapter.MIMXRT1176)
include_if_use(component_power_manager_framework.MIMXRT1176)
include_if_use(component_psa_crypto_driver_caam)
...
include_if_use(component_rng_adapter_interface.MIMXRT1176)
include_if_use(component_rnga_adapter.MIMXRT1176)
...
include_if_use(component_silicon_id_imx8.MIMXRT1176)
include_if_use(component_silicon_id_imx93.MIMXRT1176)
include_if_use(component_silicon_id_imxrt10xx.MIMXRT1176)
include_if_use(component_silicon_id_imxrt1170.MIMXRT1176)
include_if_use(component_silicon_id_imxrt1180.MIMXRT1176)
include_if_use(component_silicon_id_mcxn.MIMXRT1176)
include_if_use(component_silicon_id_rw610.MIMXRT1176)
include_if_use(component_silicon_id_scfw.MIMXRT1176)
include_if_use(component_software_crc_adapter.MIMXRT1176)
include_if_use(component_software_rng_adapter.MIMXRT1176)
include_if_use(component_tfa9896_adapter.MIMXRT1176)
include_if_use(component_tfa9xxx_adapter.MIMXRT1176)
include_if_use(component_timer_manager.MIMXRT1176)
include_if_use(component_wifi_bt_module_88W8987.MIMXRT1176)
include_if_use(component_wifi_bt_module_IW416.MIMXRT1176)
include_if_use(component_wifi_bt_module_IW61X.MIMXRT1176)
include_if_use(component_wifi_bt_module_RW61X.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_am457_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_am457ma.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_am510_arduino.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_am510_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_am510ma.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_cm358_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_aw_cm358ma.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_frdm_rw61x.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_1xk_m2.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_1xk_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_1zm_m2.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_1zm_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_2dl_m2.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_2dl_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_2el_m2.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_2el_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_murata_2ll_m2.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_rd_rw61x.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_ubx_jody_w2_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_ubx_jody_w5_m2.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_ubx_jody_w5_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_board_ubx_maya_w1_usd.MIMXRT1176)
include_if_use(component_wifi_bt_module_bt_only_fw.MIMXRT1176)
include_if_use(component_wifi_bt_module_config.MIMXRT1176)
include_if_use(component_wifi_bt_module_slim.MIMXRT1176)
include_if_use(component_wifi_bt_module_tx_pwr_limits.MIMXRT1176)
include_if_use(component_wifi_bt_module_wifi_bt_combo_fw.MIMXRT1176)
include_if_use(component_wm8524_adapter.MIMXRT1176)
include_if_use(component_wm8904_adapter.MIMXRT1176)
include_if_use(component_wm8960_adapter.MIMXRT1176)
include_if_use(component_wm8962_adapter.MIMXRT1176)
include_if_use(device_CMSIS.MIMXRT1176)
include_if_use(device_RTE.MIMXRT1176)
include_if_use(device_boot_header.MIMXRT1176)
include_if_use(device_project_template.MIMXRT1176)
include_if_use(device_startup.MIMXRT1176)
include_if_use(device_system.MIMXRT1176)
include_if_use(driver_acmp.MIMXRT1176)
include_if_use(driver_adc_etc.MIMXRT1176)
include_if_use(driver_ak4497.MIMXRT1176)
...
include_if_use(driver_camera-device-ap1302.MIMXRT1176)
...
include_if_use(driver_dc-fb-dbi.MIMXRT1176)
...
include_if_use(driver_dcdc_2.MIMXRT1176)
...
include_if_use(driver_display-co5300.MIMXRT1176)
...
include_if_use(driver_display-rm692c9.MIMXRT1176)
include_if_use(driver_display-rpi.MIMXRT1176)
include_if_use(driver_display-sn65dsi83.MIMXRT1176)
include_if_use(driver_dmamux.MIMXRT1176)
include_if_use(driver_edma.MIMXRT1176)
include_if_use(driver_ektf2k.MIMXRT1176)
...
include_if_use(driver_psp27801.MIMXRT1176)
...
include_if_use(driver_smartcard_uart.MIMXRT1176)
...
include_if_use(driver_src_2.MIMXRT1176)
include_if_use(driver_ssarc.MIMXRT1176)
include_if_use(driver_ssd1963.MIMXRT1176)
include_if_use(driver_st7796s.MIMXRT1176)
include_if_use(driver_tempsensor.MIMXRT1176)
include_if_use(driver_tfa9896.MIMXRT1176)
include_if_use(driver_tfa9xxx.MIMXRT1176)
include_if_use(driver_tfa9xxx_hal.MIMXRT1176)
include_if_use(driver_tma525b.MIMXRT1176)
include_if_use(driver_tsl2561.MIMXRT1176)
...
include_if_use(driver_wm8524.MIMXRT1176)
include_if_use(driver_wm8904.MIMXRT1176)
...
include_if_use(middleware_motor_control_bldc_frac_imcat)
...
include_if_use(middleware_multicore_rpmsg-lite_imxrt1170)
...
include_if_use(utility_debug_console_template_config.MIMXRT1176)
