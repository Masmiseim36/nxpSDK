...
#if !defined(MIMXRT1182_COMMON_H_)
#define MIMXRT1182_COMMON_H_                     /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT1182.h"         /* Device specific configuration file */
