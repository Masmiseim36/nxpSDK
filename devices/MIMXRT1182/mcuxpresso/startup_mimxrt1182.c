//*****************************************************************************
// MIMXRT1182_cm33 startup code for use with MCUXpresso IDE
//
// Version : 131223
//*****************************************************************************
//
...
WEAK void Reserved196_IRQHandler(void);
WEAK void Reserved197_IRQHandler(void);
WEAK void Reserved198_IRQHandler(void);
WEAK void Reserved199_IRQHandler(void);
...
WEAK void Reserved205_IRQHandler(void);
...
WEAK void ECAT_INT_IRQHandler(void);
...
WEAK void Reserved228_IRQHandler(void);
WEAK void Reserved229_IRQHandler(void);
WEAK void Reserved230_IRQHandler(void);
WEAK void Reserved231_IRQHandler(void);
...
WEAK void Reserved240_IRQHandler(void);
WEAK void Reserved241_IRQHandler(void);
WEAK void Reserved242_IRQHandler(void);
WEAK void Reserved243_IRQHandler(void);
WEAK void Reserved244_IRQHandler(void);
WEAK void Reserved245_IRQHandler(void);
...
WEAK void ECAT_RST_OUT_IRQHandler(void);
...
void Reserved174_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void Reserved191_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved192_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved193_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved194_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved195_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved196_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved197_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved198_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved199_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved200_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void EQDC1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void EQDC2_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved203_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved204_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved205_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void DCDC_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved207_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void ECAT_INT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void Reserved228_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved229_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved230_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved231_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void Reserved240_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved241_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved242_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved243_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved244_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved245_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved246_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved247_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void ECAT_RST_OUT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    Reserved196_IRQHandler,                          // 196: Reserved interrupt
    Reserved197_IRQHandler,                          // 197: Reserved interrupt
    Reserved198_IRQHandler,                          // 198: Reserved interrupt
    Reserved199_IRQHandler,                          // 199: Reserved interrupt
    ...
    Reserved205_IRQHandler,                          // 205: Reserved interrupt
    ...
    ECAT_INT_IRQHandler,                          // 223: EtherCAT interrupt
    ...
    Reserved228_IRQHandler,                          // 228: Reserved interrupt
    Reserved229_IRQHandler,                          // 229: Reserved interrupt
    Reserved230_IRQHandler,                          // 230: Reserved interrupt
    Reserved231_IRQHandler,                          // 231: Reserved interrupt
    ...
    Reserved240_IRQHandler,                          // 240: Reserved interrupt
    Reserved241_IRQHandler,                          // 241: Reserved interrupt
    Reserved242_IRQHandler,                          // 242: Reserved interrupt
    Reserved243_IRQHandler,                          // 243: Reserved interrupt
    Reserved244_IRQHandler,                          // 244: Reserved interrupt
    Reserved245_IRQHandler,                          // 245: Reserved interrupt
    ...
    ECAT_RST_OUT_IRQHandler,                         // 254: ECAT reset out interrupt
}; /* End of g_pfnVectors */
...
WEAK void Reserved196_IRQHandler(void)
{   Reserved196_DriverIRQHandler();
}

WEAK void Reserved197_IRQHandler(void)
{   Reserved197_DriverIRQHandler();
}
...
WEAK void Reserved228_IRQHandler(void)
{   Reserved228_DriverIRQHandler();
}

WEAK void Reserved229_IRQHandler(void)
{   Reserved229_DriverIRQHandler();
}
...
WEAK void Reserved240_IRQHandler(void)
{   Reserved240_DriverIRQHandler();
}

WEAK void Reserved241_IRQHandler(void)
{   Reserved241_DriverIRQHandler();
}

WEAK void Reserved242_IRQHandler(void)
{   Reserved242_DriverIRQHandler();
}

WEAK void Reserved243_IRQHandler(void)
{   Reserved243_DriverIRQHandler();
}

WEAK void Reserved244_IRQHandler(void)
{   Reserved244_DriverIRQHandler();
}

WEAK void Reserved245_IRQHandler(void)
{   Reserved245_DriverIRQHandler();
}
