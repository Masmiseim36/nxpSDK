...
#set.board.frdmimxrt1186
#  # description: Utility frdmimxrt1186_xmcd
#  set(CONFIG_USE_utility_xmcd true)

#  # description: board_pt_cm33_frdmimxrt1186
#  set(CONFIG_USE_board_project_template_cm33 true)

#  # description: board_pt_cm7_frdmimxrt1186
#  set(CONFIG_USE_board_project_template_cm7 true)

#  # description: Board_project_template frdmimxrt1186
#  set(CONFIG_USE_board_project_template true)

#  # description: XIP Board Driver
#  set(CONFIG_USE_board_boot_header true)

#set.device.MIMXRT1186
...
#  # description: Devices_project_template MIMXRT1186
#  set(CONFIG_USE_device_project_template true)

#  # description: Device MIMXRT1186_startup
...
#  # description: Device MIMXRT1186_cmsis
#  set(CONFIG_USE_device_CMSIS true)

#  # description: Device MIMXRT1186_system
...
#  # description: SYSCTR Driver
#  set(CONFIG_USE_driver_sysctr true)

#  # description: sramc Driver
#  set(CONFIG_USE_driver_sramc true)
...
#  # description: FLEXIO Endat2p2 Driver
#  set(CONFIG_USE_driver_flexio_endat2p2 true)

#  # description: FLEXIO BiSS Driver
#  set(CONFIG_USE_driver_flexio_biss true)

#  # description: FLEXIO T-format Driver
#  set(CONFIG_USE_driver_flexio_t-format true)

#  # description: FLEXIO A-format Driver
#  set(CONFIG_USE_driver_flexio_a-format true)
...
#  # description: Component flash_nand_semc
#  set(CONFIG_USE_component_flash_nand_semc true)
...
#  # description: MCUBOOT MIMXRT1186 startup sources
#  set(CONFIG_USE_middleware_mcu-boot_MIMXRT1186_startup true)

#  # description: MCUBOOT MIMXRT1186 sources
#  set(CONFIG_USE_middleware_mcu-boot_MIMXRT1186_sources true)
...
#  # description: SOEM NETC SWITCH
#  set(CONFIG_USE_middleware_soem_netc_swt true)
...
#  # description: RPMsg-Lite for evkmimxrt1180 application
...
#  set(CONFIG_USE_middleware_mbedtls3x_crypto_storage_fatfs true)
...
#  set(CONFIG_USE_component_psa_crypto_driver_ele_s4xx_psa_with_persistent_storage true)
...
#  set(CONFIG_USE_component_psa_crypto_driver_ele_s4xx_sd_nvm_mgr true)
...
#  # description: Servo control middleware, floating point implementation.
#  set(CONFIG_USE_middleware_mc_pmsm_servo_float true)

#  # description: Servo dual control middleware, floating point implementation.
#  set(CONFIG_USE_middleware_mc_pmsm_servo_dual_float true)
...
#  # description: FreeMASTER TSA table for PMSM servo control floating-point
#  set(CONFIG_USE_middleware_motor_control_pmsm_servo_float_tsa true)
...
#  # description: PMSM encoder control for adcimxrt1186 and pwma based MCUs
#  set(CONFIG_USE_middleware_motor_control_mc_drivers_adcimxrt1186_pwma_enc true)

#  # description: PMSM encoder control for sinc and pwma based MCUs
#  set(CONFIG_USE_middleware_motor_control_mc_drivers_imxrt1186_pwma_sinc_endat true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmimxrt1186/project_template
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmimxrt1186/xip
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmimxrt1186/xmcd
...
include_if_use(board_project_template_cm33)
include_if_use(board_project_template_cm7)
include_if_use(component_ak4497_adapter.MIMXRT1186)
include_if_use(component_at_least_one_i2c_mux_device_enabled.MIMXRT1186)
include_if_use(component_audio_sai_edma_adapter.MIMXRT1186)
include_if_use(component_button.MIMXRT1186)
include_if_use(component_codec_adapters.MIMXRT1186)
include_if_use(component_codec_i2c.MIMXRT1186)
include_if_use(component_common_task)
include_if_use(component_cs42448_adapter.MIMXRT1186)
include_if_use(component_cs42888_adapter.MIMXRT1186)
include_if_use(component_da7212_adapter.MIMXRT1186)
include_if_use(component_ele_crypto)
include_if_use(component_ele_nvm_manager)
include_if_use(component_enable_pca9544.MIMXRT1186)
include_if_use(component_enable_pca9548.MIMXRT1186)
include_if_use(component_eth_phy_common.MIMXRT1186)
include_if_use(component_exception_handling_cm7.MIMXRT1186)
include_if_use(component_flash_adapter.MIMXRT1186)
include_if_use(component_flash_nand_flexspi.MIMXRT1186)
include_if_use(component_flash_nand_semc.MIMXRT1186)
include_if_use(component_flash_nor_flexspi.MIMXRT1186)
include_if_use(component_flash_nor_lpspi.MIMXRT1186)
include_if_use(component_gpt_adapter.MIMXRT1186)
include_if_use(component_i2c_adapter_interface.MIMXRT1186)
include_if_use(component_i2c_mux_pca954x.MIMXRT1186)
include_if_use(component_i3c_adapter.MIMXRT1186)
include_if_use(component_i3c_bus.MIMXRT1186)
include_if_use(component_i3c_bus_adapter.MIMXRT1186)
include_if_use(component_lists.MIMXRT1186)
include_if_use(component_log.MIMXRT1186)
include_if_use(component_log_backend_debug_console.MIMXRT1186)
include_if_use(component_log_backend_debug_console_lite.MIMXRT1186)
include_if_use(component_log_backend_ringbuffer.MIMXRT1186)
include_if_use(component_lpi2c_adapter.MIMXRT1186)
include_if_use(component_lpit_adapter.MIMXRT1186)
include_if_use(component_lptmr_adapter.MIMXRT1186)
include_if_use(component_lpuart_adapter.MIMXRT1186)
include_if_use(component_mcxw_flash_adapter.MIMXRT1186)
include_if_use(component_mflash_offchip.MIMXRT1186)
include_if_use(component_mflash_onchip.MIMXRT1186)
...
include_if_use(component_panic.MIMXRT1186)
include_if_use(component_pcm186x_adapter.MIMXRT1186)
include_if_use(component_pcm512x_adapter.MIMXRT1186)
include_if_use(component_phyaqr113c.MIMXRT1186)
include_if_use(component_phyar8031.MIMXRT1186)
include_if_use(component_phydp8384x.MIMXRT1186)
include_if_use(component_phygpy215.MIMXRT1186)
include_if_use(component_phyksz8041.MIMXRT1186)
include_if_use(component_phyksz8081.MIMXRT1186)
include_if_use(component_phylan8720a.MIMXRT1186)
include_if_use(component_phylan8741.MIMXRT1186)
include_if_use(component_phyrtl8201.MIMXRT1186)
include_if_use(component_phyrtl8211f.MIMXRT1186)
include_if_use(component_phytja1100.MIMXRT1186)
include_if_use(component_phytja1120.MIMXRT1186)
include_if_use(component_phyvsc8541.MIMXRT1186)
include_if_use(component_phyyt8521.MIMXRT1186)
...
include_if_use(component_psa_crypto_driver_ele_s4xx_psa_with_persistent_storage)
include_if_use(component_psa_crypto_driver_ele_s4xx_rng)
include_if_use(component_psa_crypto_driver_ele_s4xx_sd_nvm_mgr)
...
include_if_use(component_reset_adapter.MIMXRT1186)
include_if_use(component_rgpio_adapter.MIMXRT1186)
include_if_use(component_serial_manager.MIMXRT1186)
include_if_use(component_serial_manager_swo.MIMXRT1186)
include_if_use(component_serial_manager_uart.MIMXRT1186)
include_if_use(component_serial_manager_usb_cdc.MIMXRT1186)
include_if_use(component_serial_manager_virtual.MIMXRT1186)
include_if_use(component_sgtl_adapter.MIMXRT1186)
include_if_use(component_silicon_id.MIMXRT1186)
include_if_use(component_silicon_id_imx8.MIMXRT1186)
include_if_use(component_silicon_id_imx93.MIMXRT1186)
include_if_use(component_silicon_id_imxrt10xx.MIMXRT1186)
include_if_use(component_silicon_id_imxrt1170.MIMXRT1186)
include_if_use(component_silicon_id_imxrt1180.MIMXRT1186)
include_if_use(component_silicon_id_mcxe31x.MIMXRT1186)
include_if_use(component_silicon_id_mcxn.MIMXRT1186)
include_if_use(component_silicon_id_rw610.MIMXRT1186)
include_if_use(component_silicon_id_scfw.MIMXRT1186)
include_if_use(component_tfa9896_adapter.MIMXRT1186)
include_if_use(component_tfa9xxx_adapter.MIMXRT1186)
include_if_use(component_timer_manager.MIMXRT1186)
include_if_use(component_tpm_adapter.MIMXRT1186)
include_if_use(component_wifi_bt_module_88W8987.MIMXRT1186)
include_if_use(component_wifi_bt_module_IW416.MIMXRT1186)
include_if_use(component_wifi_bt_module_IW61X.MIMXRT1186)
include_if_use(component_wifi_bt_module_RW61X.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_am457_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_am457ma.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_am510_arduino.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_am510_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_am510ma.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_cm358_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_aw_cm358ma.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_frdm_rw61x.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_1xk_m2.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_1xk_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_1zm_m2.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_1zm_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_2dl_m2.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_2dl_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_2el_m2.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_2el_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_2ll_m2.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_murata_2ll_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_rd_rw61x.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_ubx_jody_w2_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_ubx_jody_w5_m2.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_ubx_jody_w5_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_board_ubx_maya_w1_usd.MIMXRT1186)
include_if_use(component_wifi_bt_module_bt_only_fw.MIMXRT1186)
include_if_use(component_wifi_bt_module_config.MIMXRT1186)
include_if_use(component_wifi_bt_module_nb_fw.MIMXRT1186)
include_if_use(component_wifi_bt_module_tx_pwr_limits.MIMXRT1186)
include_if_use(component_wifi_bt_module_uncompressed_firmware.MIMXRT1186)
include_if_use(component_wifi_bt_module_wifi_bt_combo_fw.MIMXRT1186)
include_if_use(component_wifi_bt_module_wifi_fw.MIMXRT1186)
include_if_use(component_wifi_bt_module_wifi_nb_combo_fw.MIMXRT1186)
include_if_use(component_wm8524_adapter.MIMXRT1186)
include_if_use(component_wm8904_adapter.MIMXRT1186)
include_if_use(component_wm8960_adapter.MIMXRT1186)
include_if_use(component_wm8962_adapter.MIMXRT1186)
include_if_use(device_CMSIS.MIMXRT1186)
include_if_use(device_RTE.MIMXRT1186)
include_if_use(device_boot_header.MIMXRT1186)
include_if_use(device_project_template.MIMXRT1186)
include_if_use(device_startup.MIMXRT1186)
include_if_use(device_system.MIMXRT1186)
include_if_use(driver_acmp.MIMXRT1186)
include_if_use(driver_ak4497.MIMXRT1186)
include_if_use(driver_anadig_pmu_1.MIMXRT1186)
include_if_use(driver_aoi.MIMXRT1186)
include_if_use(driver_asrc.MIMXRT1186)
include_if_use(driver_asrc_edma.MIMXRT1186)
include_if_use(driver_cache_armv7_m7.MIMXRT1186)
include_if_use(driver_cache_xcache.MIMXRT1186)
include_if_use(driver_clock.MIMXRT1186)
include_if_use(driver_cmsis_lpi2c.MIMXRT1186)
include_if_use(driver_cmsis_lpspi.MIMXRT1186)
include_if_use(driver_cmsis_lpuart.MIMXRT1186)
include_if_use(driver_codec.MIMXRT1186)
include_if_use(driver_common.MIMXRT1186)
include_if_use(driver_cs42448.MIMXRT1186)
include_if_use(driver_cs42888.MIMXRT1186)
include_if_use(driver_dac12.MIMXRT1186)
include_if_use(driver_dcdc_3.MIMXRT1186)
include_if_use(driver_dialog7212.MIMXRT1186)
include_if_use(driver_ecat.MIMXRT1186)
include_if_use(driver_edma4.MIMXRT1186)
include_if_use(driver_edma_soc.MIMXRT1186)
include_if_use(driver_ele_base_api.MIMXRT1186)
include_if_use(driver_eqdc.MIMXRT1186)
include_if_use(driver_ewm.MIMXRT1186)
include_if_use(driver_flexcan.MIMXRT1186)
include_if_use(driver_flexcan_edma.MIMXRT1186)
include_if_use(driver_flexio.MIMXRT1186)
include_if_use(driver_flexio_a-format.MIMXRT1186)
include_if_use(driver_flexio_biss.MIMXRT1186)
include_if_use(driver_flexio_endat2p2.MIMXRT1186)
include_if_use(driver_flexio_i2c_master.MIMXRT1186)
include_if_use(driver_flexio_i2s.MIMXRT1186)
include_if_use(driver_flexio_i2s_edma.MIMXRT1186)
include_if_use(driver_flexio_spi.MIMXRT1186)
include_if_use(driver_flexio_spi_edma.MIMXRT1186)
include_if_use(driver_flexio_t-format.MIMXRT1186)
include_if_use(driver_flexio_uart.MIMXRT1186)
include_if_use(driver_flexio_uart_edma.MIMXRT1186)
include_if_use(driver_flexspi.MIMXRT1186)
include_if_use(driver_flexspi_edma.MIMXRT1186)
include_if_use(driver_flexspi_flr.MIMXRT1186)
include_if_use(driver_fxas21002cq.MIMXRT1186)
include_if_use(driver_fxls8974cf.MIMXRT1186)
include_if_use(driver_fxos8700cq.MIMXRT1186)
include_if_use(driver_gpc_3.MIMXRT1186)
include_if_use(driver_gpt.MIMXRT1186)
include_if_use(driver_htu21d.MIMXRT1186)
include_if_use(driver_i3c.MIMXRT1186)
include_if_use(driver_i3c_edma.MIMXRT1186)
include_if_use(driver_icm42688p.MIMXRT1186)
include_if_use(driver_iee.MIMXRT1186)
include_if_use(driver_iee_apc.MIMXRT1186)
include_if_use(driver_iomuxc.MIMXRT1186)
include_if_use(driver_kpp.MIMXRT1186)
include_if_use(driver_lpadc.MIMXRT1186)
include_if_use(driver_lpi2c.MIMXRT1186)
include_if_use(driver_lpi2c_edma.MIMXRT1186)
include_if_use(driver_lpi2c_freertos.MIMXRT1186)
include_if_use(driver_lpit.MIMXRT1186)
include_if_use(driver_lpspi.MIMXRT1186)
include_if_use(driver_lpspi_edma.MIMXRT1186)
include_if_use(driver_lpspi_freertos.MIMXRT1186)
include_if_use(driver_lptmr.MIMXRT1186)
include_if_use(driver_lpuart.MIMXRT1186)
include_if_use(driver_lpuart_edma.MIMXRT1186)
include_if_use(driver_lpuart_freertos.MIMXRT1186)
include_if_use(driver_lsm6dso.MIMXRT1186)
include_if_use(driver_max30101.MIMXRT1186)
include_if_use(driver_mecc.MIMXRT1186)
include_if_use(driver_memory.MIMXRT1186)
include_if_use(driver_misc.MIMXRT1186)
include_if_use(driver_mma8451q.MIMXRT1186)
include_if_use(driver_mma8652fc.MIMXRT1186)
include_if_use(driver_msgintr.MIMXRT1186)
include_if_use(driver_mu1.MIMXRT1186)
include_if_use(driver_netc.MIMXRT1186)
include_if_use(driver_netc_msg.MIMXRT1186)
include_if_use(driver_netc_phywrapper.MIMXRT1186)
include_if_use(driver_netc_rt1180.MIMXRT1186)
include_if_use(driver_netc_switch.MIMXRT1186)
include_if_use(driver_nmh1000.MIMXRT1186)
include_if_use(driver_p3t1755.MIMXRT1186)
include_if_use(driver_pcm186x.MIMXRT1186)
include_if_use(driver_pcm512x.MIMXRT1186)
include_if_use(driver_pdm.MIMXRT1186)
include_if_use(driver_pdm_edma.MIMXRT1186)
include_if_use(driver_pf1550.MIMXRT1186)
include_if_use(driver_pf3000.MIMXRT1186)
include_if_use(driver_pf5020.MIMXRT1186)
include_if_use(driver_pwm.MIMXRT1186)
include_if_use(driver_qtmr_1.MIMXRT1186)
include_if_use(driver_rgpio.MIMXRT1186)
include_if_use(driver_romapi.MIMXRT1186)
include_if_use(driver_rtt.MIMXRT1186)
include_if_use(driver_rtt_template.MIMXRT1186)
include_if_use(driver_rtwdog.MIMXRT1186)
include_if_use(driver_s3mu.MIMXRT1186)
include_if_use(driver_sai.MIMXRT1186)
include_if_use(driver_sai_edma.MIMXRT1186)
include_if_use(driver_sema42.MIMXRT1186)
include_if_use(driver_semc.MIMXRT1186)
include_if_use(driver_sgtl5000.MIMXRT1186)
include_if_use(driver_sinc.MIMXRT1186)
include_if_use(driver_spdif.MIMXRT1186)
include_if_use(driver_spdif_edma.MIMXRT1186)
include_if_use(driver_sramc.MIMXRT1186)
include_if_use(driver_src_3.MIMXRT1186)
include_if_use(driver_sysctr.MIMXRT1186)
include_if_use(driver_syspm.MIMXRT1186)
include_if_use(driver_tempsensor.MIMXRT1186)
include_if_use(driver_tfa9896.MIMXRT1186)
include_if_use(driver_tfa9xxx.MIMXRT1186)
include_if_use(driver_tfa9xxx_hal.MIMXRT1186)
include_if_use(driver_tpm.MIMXRT1186)
include_if_use(driver_trdc.MIMXRT1186)
include_if_use(driver_tsl2561.MIMXRT1186)
include_if_use(driver_tstmr.MIMXRT1186)
include_if_use(driver_usdhc.MIMXRT1186)
include_if_use(driver_vref_1.MIMXRT1186)
include_if_use(driver_wm8524.MIMXRT1186)
include_if_use(driver_wm8904.MIMXRT1186)
include_if_use(driver_wm8960.MIMXRT1186)
include_if_use(driver_wm8962.MIMXRT1186)
include_if_use(driver_xbar_1.MIMXRT1186)
include_if_use(middleware_baremetal.MIMXRT1186)
...
include_if_use(middleware_iot_reference_logging.MIMXRT1186)
include_if_use(middleware_iot_reference_transport_mbedtls.MIMXRT1186)
include_if_use(middleware_iot_reference_transport_mbedtls3x.MIMXRT1186)
include_if_use(middleware_iot_reference_transport_mbedtls_psa.MIMXRT1186)
...
include_if_use(middleware_mbedtls3x_crypto_storage_fatfs)
...
include_if_use(middleware_mc_pmsm_servo_dual_float)
include_if_use(middleware_mc_pmsm_servo_float)
include_if_use(middleware_mc_pmsm_snsless_float)
include_if_use(middleware_mcu-boot_CMSIS_cm7_headers)
include_if_use(middleware_mcu-boot_MIMXRT1186_sources)
include_if_use(middleware_mcu-boot_MIMXRT1186_startup)
...
include_if_use(middleware_motor_control_mc_drivers_adcimxrt1180_pwma_enc)
include_if_use(middleware_motor_control_mc_drivers_adcimxrt1186_pwma_enc)
include_if_use(middleware_motor_control_mc_drivers_imxrt1186_pwma_sinc_endat)
...
include_if_use(middleware_motor_control_pmsm_servo_float_tsa)
...
include_if_use(middleware_multicore_mcmgr_imxrt1180)
...
include_if_use(middleware_multicore_rpmsg-lite_imxrt1180)
...
include_if_use(middleware_soem_netc_swt)
...
include_if_use(utilities_misc_utilities.MIMXRT1186)
include_if_use(utility_assert.MIMXRT1186)
include_if_use(utility_assert_lite.MIMXRT1186)
include_if_use(utility_debug_console.MIMXRT1186)
include_if_use(utility_debug_console_lite.MIMXRT1186)
include_if_use(utility_debug_console_template_config.MIMXRT1186)
include_if_use(utility_incbin.MIMXRT1186)
include_if_use(utility_notifier.MIMXRT1186)
include_if_use(utility_shell.MIMXRT1186)
include_if_use(utility_str.MIMXRT1186)
include_if_use(utility_xmcd)
