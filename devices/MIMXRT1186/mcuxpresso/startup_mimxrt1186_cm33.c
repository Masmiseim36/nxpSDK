//*****************************************************************************
// MIMXRT1186_cm33 startup code for use with MCUXpresso IDE
//
// Version : 060226
//*****************************************************************************
//
...
void Reserved216_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved217_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void ACMP3_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void Reserved219_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
