...
#if !defined(MIMXRT1189_cm7_H_)  /* Check if memory map has not been already included */
#define MIMXRT1189_cm7_H_
...
#endif  /* #if !defined(MIMXRT1189_cm7_H_) */
