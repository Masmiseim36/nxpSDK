...
typedef enum _clock_attach_id
{
    ...
    kFRO_DIV1_to_MIPI_DPHYESC_CLK =
        CLKCTL0_TUPLE_MUXA(DPHYESCCLKSEL_OFFSET, 0), /*!< Attach FRO_DIV1 to MIPI_DPHYESC_CLK. */

    kFRO_DIV16_to_MIPI_DPHYESC_CLK =
        CLKCTL0_TUPLE_MUXA(DPHYESCCLKSEL_OFFSET, 1), /*!< Attach FRO_DIV16 to MIPI_DPHYESC_CLK. */

    kAUX0_PLL_to_MIPI_DPHYESC_CLK =
        CLKCTL0_TUPLE_MUXA(DPHYESCCLKSEL_OFFSET, 2), /*!< Attach AUX0_PLL to MIPI_DPHYESC_CLK. */

    kAUX1_PLL_to_MIPI_DPHYESC_CLK =
        CLKCTL0_TUPLE_MUXA(DPHYESCCLKSEL_OFFSET, 3), /*!< Attach AUX1_PLL to MIPI_DPHYESC_CLK. */

    kMIPI_DPHY_CLK_to_DCPIXEL_CLK =
        CLKCTL0_TUPLE_MUXA(DCPIXELCLKSEL_OFFSET, 0), /*!< Attach MIPI_DPHY_CLK to DCPIXEL_CLK. */
