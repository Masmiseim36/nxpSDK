...
#if !defined(MIMXRT735S_hifi1_H_)  /* Check if memory map has not been already included */
#define MIMXRT735S_hifi1_H_
...
#endif  /* #if !defined(MIMXRT735S_hifi1_H_) */
