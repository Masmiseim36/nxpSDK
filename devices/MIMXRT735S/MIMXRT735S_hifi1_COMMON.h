...
#if !defined(MIMXRT735S_HIFI1_COMMON_H_)
#define MIMXRT735S_HIFI1_COMMON_H_               /**< Symbol preventing repeated inclusion */
...
#include "system_MIMXRT735S_hifi1.h"     /* Device specific configuration file */
