...
#if !defined(MIMXRT758S_cm33_core0_H_)  /* Check if memory map has not been already included */
#define MIMXRT758S_cm33_core0_H_
...
#endif  /* #if !defined(MIMXRT758S_cm33_core0_H_) */
