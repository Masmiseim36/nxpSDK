...
#if !defined(MIMXRT758S_cm33_core1_H_)  /* Check if memory map has not been already included */
#define MIMXRT758S_cm33_core1_H_
...
#endif  /* #if !defined(MIMXRT758S_cm33_core1_H_) */
