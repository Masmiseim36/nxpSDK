...
/*!
 * @file MIMXRT758S_cm33_core1
 * @version 1.0
 * @date 2025-06-06
 * @brief Device specific configuration file for MIMXRT758S_cm33_core1 (header file)
 *
...
#ifndef _SYSTEM_MIMXRT758S_cm33_core1_H_
#define _SYSTEM_MIMXRT758S_cm33_core1_H_ /**< Symbol preventing repeated inclusion */
...
#define FRO_FREQ_GET_FROM_TUNER(base)                                                       \
    ((uint32_t)((uint64_t)(base->TEXPCNT.RW & FRO_TEXPCNT_TEXPCNT_MASK) *                   \
...
#endif /* _SYSTEM_MIMXRT758S_cm33_core1_H_ */
