...
#ifndef _MIMXRT798S_ezhv_FEATURES_H_
#define _MIMXRT798S_ezhv_FEATURES_H_
...
#define FSL_FEATURE_SOC_CDOG_COUNT (5)
/* @brief CRC availability on the SoC. */
#define FSL_FEATURE_SOC_CRC_COUNT (1)
/* @brief CTIMER availability on the SoC. */
#define FSL_FEATURE_SOC_CTIMER_COUNT (8)
/* @brief EDMA availability on the SoC. */
#define FSL_FEATURE_SOC_EDMA_COUNT (4)
/* @brief ELS availability on the SoC. */
#define FSL_FEATURE_SOC_ELS_COUNT (4)
...
#define FSL_FEATURE_SOC_GPIO_COUNT (22)
/* @brief I3C availability on the SoC. */
#define FSL_FEATURE_SOC_I3C_COUNT (4)
...
#define FSL_FEATURE_SOC_LPI2C_COUNT (19)
...
#define FSL_FEATURE_SOC_SYSPM_COUNT (4)
...
#define FSL_FEATURE_SOC_UTICK_COUNT (2)
/* @brief WWDT availability on the SoC. */
#define FSL_FEATURE_SOC_WWDT_COUNT (4)
...
#define FSL_FEATURE_XSPI_HAS_FR_IPEDERRn(x) \
    (((x) == XSPI0) ? (1) : \
    (((x) == XSPI1) ? (1) : \
    (((x) == XSPI2) ? (0) : (-1))))
/* @brief XSPI has BFGENCR ALIGN bit */
#define FSL_FEATURE_XSPI_HAS_BFGENCR_ALIGNn(x) \
    (((x) == XSPI0) ? (1) : \
    (((x) == XSPI1) ? (1) : \
    (((x) == XSPI2) ? (0) : (-1))))
...
#endif /* _MIMXRT798S_ezhv_FEATURES_H_ */
