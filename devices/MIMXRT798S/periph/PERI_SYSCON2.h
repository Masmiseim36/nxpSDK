...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for SYSCON2
**
 ...
 * @version 4.0
 * @date 2025-06-06
 * @brief CMSIS Peripheral Access Layer for SYSCON2
 *
 * CMSIS Peripheral Access Layer for SYSCON2
 */

#if !defined(PERI_SYSCON2_H_)
#define PERI_SYSCON2_H_                          /**< Symbol preventing repeated inclusion */
...
/** SYSCON2 - Size of Registers Arrays */
#define SYSCON2_GPR_COUNT                         2u

/** SYSCON2 - Register Layout Typedef */
typedef struct {
       uint8_t RESERVED_0[4064];
  __IO uint32_t GPR[SYSCON2_GPR_COUNT];            /**< General Purpose Register 0..General Purpose Register 1, array offset: 0xFE0, array step: 0x4 */
} SYSCON2_Type;
