...
**     - rev. 2.14 (2016-03-21)
**         Added MK24FN1M0CAJ12 part.
**
** ###################################################################
*/

#ifndef _MK24F12_FEATURES_H_
#define _MK24F12_FEATURES_H_

/* SOC module features */

#if defined(CPU_MK24FN1M0CAJ12) || defined(CPU_MK24FN1M0VDC12) || defined(CPU_MK24FN1M0VLQ12)
...
#elif defined(CPU_MK24FN1M0VLL12)
    /* @brief ADC16 availability on the SoC. */
    #define FSL_FEATURE_SOC_ADC16_COUNT (2)
    /* @brief AIPS availability on the SoC. */
    #define FSL_FEATURE_SOC_AIPS_COUNT (2)
...
/* UART module features */
    ...
    #define FSL_FEATURE_UART_HAS_SEPARATE_DMA_RX_TX_REQn(x) \
        ...
        ((x) == UART3 ? (1) : \
        ((x) == UART4 ? (0) : (-1))))))
#endif /* defined(CPU_MK24FN1M0CAJ12) || defined(CPU_MK24FN1M0VDC12) || defined(CPU_MK24FN1M0VLQ12) */
