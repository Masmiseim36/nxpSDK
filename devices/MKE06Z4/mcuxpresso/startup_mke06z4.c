//*****************************************************************************
// MKE06Z4 startup code for use with MCUXpresso IDE
//
// Version : 180919
//*****************************************************************************
//
...
WEAK void MSCAN_1_IRQHandler(void);
WEAK void MSCAN_2_IRQHandler(void);
...
void (* const g_pfnVectors[])(void) = {
    ...
    MSCAN_1_IRQHandler,      // 46: MSCAN Rx Interrupt
    MSCAN_2_IRQHandler,      // 47: MSCAN Tx, Err and Wake-up interrupt
...
WEAK_AV void MSCAN_1_IRQHandler(void)
{   MSCAN_DriverIRQHandler();
}

WEAK_AV void MSCAN_2_IRQHandler(void)
{   MSCAN_DriverIRQHandler();
}
