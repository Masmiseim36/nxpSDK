 ...
 * @version 2.0
 * @date 2018-09-17
 * @brief Device specific configuration file for MKE16Z4 (header file)
 *
...
#define _SYSTEM_MKE16Z4_H_                       /**< Symbol preventing repeated inclusion */
