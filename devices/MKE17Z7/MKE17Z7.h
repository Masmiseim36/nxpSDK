...
#ifndef _MKE17Z7_H_
#define _MKE17Z7_H_                              /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  FTFA_IRQn                    = 5,                /**< Single interrupt vector for all sources */
...
#include "system_MKE17Z7.h"            /* Device specific configuration file */
...
typedef struct {
  __IO uint32_t CLKCFG[116];                       /**< PCC Register, array offset: 0x0, array step: 0x4 */
} PCC_Type;
...
typedef struct {
  __IO uint32_t TRGCFG[29];                        /**< TRGMUX Register, array offset: 0x0, array step: 0x4 */
} TRGMUX_Type;
...
#define TSI_MODE_S_W_SHIELD_MASK                 (0x3800000U)
...
/** Peripheral TSI1 base address */
#define TSI1_BASE                                (0x40047000u)
/** Peripheral TSI1 base pointer */
#define TSI1                                     ((TSI_Type *)TSI1_BASE)
/** Array initializer of TSI peripheral base addresses */
#define TSI_BASE_ADDRS                           { TSI0_BASE, TSI1_BASE }
/** Array initializer of TSI peripheral base pointers */
#define TSI_BASE_PTRS                            { TSI0, TSI1 }
/** Interrupt vectors for the TSI peripheral type */
#define TSI_IRQS                                 { TSI0_IRQn, TSI1_IRQn }
