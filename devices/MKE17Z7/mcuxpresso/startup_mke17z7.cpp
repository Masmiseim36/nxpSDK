//*****************************************************************************
// MKE17Z7 startup code for use with MCUXpresso IDE
//
// Version : 070721
//*****************************************************************************
//
...
WEAK void TSI1_IRQHandler(void);
...
void TSI1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    FTFA_IRQHandler,         // 21: Single interrupt vector for all sources
    ...
    TSI0_IRQHandler,         // 40: TSI0 interrupt
    TSI1_IRQHandler,         // 41: TSI1 interrupt
...
WEAK_AV void TSI1_IRQHandler(void)
{   TSI1_DriverIRQHandler();
}
