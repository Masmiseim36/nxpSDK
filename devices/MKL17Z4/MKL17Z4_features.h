...
#ifndef _MKL17Z4_FEATURES_H_
#define _MKL17Z4_FEATURES_H_
...
/* FLASH module features */
...
#if defined(CPU_MKL17Z128VFM4) || defined(CPU_MKL17Z128VFT4) || defined(CPU_MKL17Z128VLH4) || defined(CPU_MKL17Z128VMP4)
...
#elif defined(CPU_MKL17Z256CAL4R) || defined(CPU_MKL17Z256VFM4) || defined(CPU_MKL17Z256VFT4) || defined(CPU_MKL17Z256VLH4) || \
    defined(CPU_MKL17Z256VMP4)
    /* @brief Is of type FTFA. */
    #define FSL_FEATURE_FLASH_IS_FTFA (1)
    /* @brief Is of type FTFE. */
    #define FSL_FEATURE_FLASH_IS_FTFE (0)
    ...
    /* @brief Emulated eeprom size code 1111 mapping to emulated eeprom size in bytes (0xFFFF = reserved). */
    #define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1111 (0xFFFF)
#endif /* defined(CPU_MKL17Z128VFM4) || defined(CPU_MKL17Z128VFT4) || defined(CPU_MKL17Z128VLH4) || defined(CPU_MKL17Z128VMP4) */
