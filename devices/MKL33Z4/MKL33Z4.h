...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MKL33Z4
**
 ...
 * @version 1.5
 * @date 2016-02-02
 * @brief CMSIS Peripheral Access Layer for MKL33Z4
 *
 * CMSIS Peripheral Access Layer for MKL33Z4
 */

#ifndef _MKL33Z4_H_
#define _MKL33Z4_H_                              /**< Symbol preventing repeated inclusion */
...
#include "system_MKL33Z4.h"            /* Device specific configuration file */
 ...
 *  0b0..All front plane and back plane pins are disabled. The LCD controller system is also disabled, and all LCD waveform generation clocks are stopped. V LL3 is connected to V DD internally. All LCD pins, LCD_Pn, enabled using the LCD Pin Enable register, output a low value.
 *  0b1..LCD controller driver system is enabled, and front plane and back plane waveforms are generated. All LCD pins, LCD_Pn, enabled if PAD_SAFE is clearusing the LCD Pin Enable register, output an LCD driver waveform. The back plane pins output an LCD driver back plane waveform based on the settings of DUTY[2:0]. Charge pump or resistor bias is enabled.
 */
