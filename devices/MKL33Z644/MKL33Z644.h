...
#ifndef _MKL33Z644_H_
#define _MKL33Z644_H_                            /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  PORTB_PORTC_PORTD_PORTE_IRQn = 31                /**< Single interrupt vector for PORTB; PORTC; PORTD; PORTE Pin detect */
} IRQn_Type;
 ...
 *  0b0..Pre-trigger ADHWTSA is selected, thus ADC0 will use ADC0_SC1A configuration for the next ADC conversion and store the result in ADC0_RA register.
 *  0b1..Pre-trigger ADHWTSB is selected, thus ADC0 will use ADC0_SC1B configuration for the next ADC conversion and store the result in ADC0_RB register.
 */
