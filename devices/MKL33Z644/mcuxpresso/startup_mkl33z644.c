//*****************************************************************************
// MKL33Z644 startup code for use with MCUXpresso IDE
//
// Version : 180919
//*****************************************************************************
//
...
void (* const g_pfnVectors[])(void) = {
    ...
    PORTB_PORTC_PORTD_PORTE_IRQHandler,  // 47: Single interrupt vector for PORTB; PORTC; PORTD; PORTE Pin detect
