...
**         Initial version.
**     - rev. 1.1 (2015-04-24)
**         Add feature for QSPI
**     - rev. 1.2 (2015-07-29)
**         Add features for LTC and USB KHCI
**     - rev. 1.3 (2015-08-10)
**         Add features for INTMUX and align with 1.3 REL stream
**     - rev. 1.4 (2015-08-13)
**         Add new SIM feature FSL_FEATURE_SIM_OPT_ADC_HAS_ALTERNATE_TRIGGER for ADC
**     - rev. 1.5 (2015-08-20)
**         Update according to latest RM Rev.1 and RDP
**     - rev. 1.6 (2015-12-15)
**         Correct USB RAM
**
** ###################################################################
...
#ifndef _MKL81Z7_FEATURES_H_
#define _MKL81Z7_FEATURES_H_
...
#define FSL_FEATURE_DRYICE_HAS_SECURE_REGISTER_FILE_SELECT (1)
/* @brief Has active tamper clock source select (register bit CR[ATCS]). */
#define FSL_FEATURE_DRYICE_HAS_ACTIVE_TAMPER_CLOCK_SOURCE_SELECT (1)
/* @brief Has tamper pin sampling (register bits PGFRn[TPSW] and PGFRn[TPSF]). */
#define FSL_FEATURE_DRYICE_HAS_TAMPER_PIN_SAMPLING (1)
/* @brief Has tamper pin pull select (register bit PGFRn[TPS]). */
#define FSL_FEATURE_DRYICE_HAS_TAMPER_PIN_PULL_SELECT (1)
...
/* LLWU module features */
...
#if defined(CPU_MKL81Z128VLH7) || defined(CPU_MKL81Z128VLK7) || defined(CPU_MKL81Z128VMP7)
...
#elif defined(CPU_MKL81Z128VLL7)
    /* @brief Maximum number of pins (maximal index plus one) connected to LLWU device. */
    ...
    /* @brief Has DMA Enable register (LLWU_DE). */
    #define FSL_FEATURE_LLWU_HAS_DMA_ENABLE_REG (0)
#elif defined(CPU_MKL81Z128VMC7)
    /* @brief Maximum number of pins (maximal index plus one) connected to LLWU device. */
    ...
    /* @brief Has DMA Enable register (LLWU_DE). */
    #define FSL_FEATURE_LLWU_HAS_DMA_ENABLE_REG (0)
#endif /* defined(CPU_MKL81Z128VLH7) || defined(CPU_MKL81Z128VLK7) || defined(CPU_MKL81Z128VMP7) */
...
#define FSL_FEATURE_LTC_HAS_SHA (1)
...
#define FSL_FEATURE_SIM_HAS_MISCCTRL (1)
/* @brief Has LTCEN bit (e.g SIM_MISCCTRL). */
#define FSL_FEATURE_SIM_HAS_MISCCTRL_LTCEN (1)
/* @brief Has DMAINTSEL0 bit (e.g SIM_MISCCTRL). */
#define FSL_FEATURE_SIM_HAS_MISCCTRL_DMAINTSEL0 (1)
/* @brief Has DMAINTSEL1 bit (e.g SIM_MISCCTRL). */
#define FSL_FEATURE_SIM_HAS_MISCCTRL_DMAINTSEL1 (1)
/* @brief Has DMAINTSEL2 bit (e.g SIM_MISCCTRL). */
#define FSL_FEATURE_SIM_HAS_MISCCTRL_DMAINTSEL2 (1)
/* @brief Has DMAINTSEL3 bit (e.g SIM_MISCCTRL). */
#define FSL_FEATURE_SIM_HAS_MISCCTRL_DMAINTSEL3 (1)
/* @brief Has SECKEY0 reg. */
#define FSL_FEATURE_SIM_HAS_SECKEY0 (1)
/* @brief Has SECKEY bit (e.g SIM_SECKEY0). */
#define FSL_FEATURE_SIM_HAS_SECKEY0_SECKEY (1)
/* @brief Has SECKEY1 reg. */
#define FSL_FEATURE_SIM_HAS_SECKEY1 (1)
/* @brief Has SECKEY bit (e.g SIM_SECKEY1). */
#define FSL_FEATURE_SIM_HAS_SECKEY1_SECKEY (1)
/* @brief Has SECKEY2 reg. */
#define FSL_FEATURE_SIM_HAS_SECKEY2 (1)
/* @brief Has SECKEY bit (e.g SIM_SECKEY2). */
#define FSL_FEATURE_SIM_HAS_SECKEY2_SECKEY (1)
/* @brief Has SECKEY3 reg. */
#define FSL_FEATURE_SIM_HAS_SECKEY3 (1)
/* @brief Has SECKEY bit (e.g SIM_SECKEY3). */
#define FSL_FEATURE_SIM_HAS_SECKEY3_SECKEY (1)
...
#elif defined(CPU_MKL81Z128VLL7) || defined(CPU_MKL81Z128VMC7)
    /* @brief Receive/transmit FIFO size in number of items. */
    #define FSL_FEATURE_DSPI_FIFO_SIZEn(x) \
        ((x) == SPI0 ? (4) : \
        ((x) == SPI1 ? (1) : (-1)))
