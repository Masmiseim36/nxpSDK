...
#define SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY 75000000
#endif
...
#define FTM_CLOCKS                                                                   \
    {                                                                                \
        kCLOCK_Ftm0, kCLOCK_Ftm1, kCLOCK_Ftm2, kCLOCK_Ftm3, kCLOCK_Ftm4, kCLOCK_Ftm5 \
    }
 ...
 *
 * @param outdiv1 Clock 5 output divider value.
 */
static inline void CLOCK_SetOutDiv(uint32_t outdiv1, uint32_t outdiv4, uint32_t outdiv5)
{
    SIM->CLKDIV1 = SIM_CLKDIV1_OUTDIV1(outdiv1) | SIM_CLKDIV1_OUTDIV4(outdiv4) | SIM_CLKDIV1_OUTDIV5(outdiv5);
}
