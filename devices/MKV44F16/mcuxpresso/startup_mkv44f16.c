//*****************************************************************************
// MKV44F16 startup code for use with MCUXpresso IDE
//
// Version : 180919
//*****************************************************************************
//
...
WEAK void PWMA_CMP0_IRQHandler(void);
WEAK void PWMA_RELOAD0_IRQHandler(void);
WEAK void PWMA_CMP1_IRQHandler(void);
WEAK void PWMA_RELOAD1_IRQHandler(void);
WEAK void PWMA_CMP2_IRQHandler(void);
WEAK void PWMA_RELOAD2_IRQHandler(void);
WEAK void PWMA_CMP3_IRQHandler(void);
WEAK void PWMA_RELOAD3_IRQHandler(void);
WEAK void PWMA_CAP_IRQHandler(void);
WEAK void PWMA_RERR_IRQHandler(void);
WEAK void PWMA_FAULT_IRQHandler(void);
...
void PWMA_CMP0_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_RELOAD0_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_CMP1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_RELOAD1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_CMP2_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_RELOAD2_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_CMP3_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_RELOAD3_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_CAP_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_RERR_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PWMA_FAULT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
WEAK void PWMA_CMP0_IRQHandler(void)
{   PWMA_CMP0_DriverIRQHandler();
}

WEAK void PWMA_RELOAD0_IRQHandler(void)
{   PWMA_RELOAD0_DriverIRQHandler();
}

WEAK void PWMA_CMP1_IRQHandler(void)
{   PWMA_CMP1_DriverIRQHandler();
}

WEAK void PWMA_RELOAD1_IRQHandler(void)
{   PWMA_RELOAD1_DriverIRQHandler();
}

WEAK void PWMA_CMP2_IRQHandler(void)
{   PWMA_CMP2_DriverIRQHandler();
}

WEAK void PWMA_RELOAD2_IRQHandler(void)
{   PWMA_RELOAD2_DriverIRQHandler();
}

WEAK void PWMA_CMP3_IRQHandler(void)
{   PWMA_CMP3_DriverIRQHandler();
}

WEAK void PWMA_RELOAD3_IRQHandler(void)
{   PWMA_RELOAD3_DriverIRQHandler();
}

WEAK void PWMA_CAP_IRQHandler(void)
{   PWMA_CAP_DriverIRQHandler();
}

WEAK void PWMA_RERR_IRQHandler(void)
{   PWMA_RERR_DriverIRQHandler();
}

WEAK void PWMA_FAULT_IRQHandler(void)
{   PWMA_FAULT_DriverIRQHandler();
}
