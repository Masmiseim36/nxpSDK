 ...
 * @version 1.5
 * @date 2019-09-10
 * @brief Device specific configuration file for MKW35A4 (header file)
 *
...
#ifndef _SYSTEM_MKW35A4_H_
#define _SYSTEM_MKW35A4_H_                       /**< Symbol preventing repeated inclusion */
