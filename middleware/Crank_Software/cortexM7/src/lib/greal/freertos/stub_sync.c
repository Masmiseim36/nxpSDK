...
//This provides a stub mutex/condvar * implementation that does nothing
...
pthread_cond_init(pthread_cond_t *cond, const pthread_condattr_t *attr) {
	...
	//TODO: Choose some rational limits
//TF Need to support non-counting semaphores ...
...
pthread_cond_timedwait(pthread_cond_t *cond, pthread_mutex_t * mutex, const struct timespec * abstime) {
    ...
    if(abstime) {
            ...
            //timeout_ticks =  10/portTICK_RATE_MS;
...
pthread_cond_signal(pthread_cond_t *cond) {
	...
	//TF Inside or out, there is always a race condition here
	if(count > 0) {
