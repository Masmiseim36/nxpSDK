# Add set(CONFIG_USE_middleware_crank_evkmimxrt1170 true) in config.cmake to use this component

include_guard(GLOBAL)
message("${CMAKE_CURRENT_LIST_FILE} component is included.")

if(CONFIG_USE_middleware_crank_template_evkmimxrt1170 AND CONFIG_USE_middleware_freertos-kernel AND (CONFIG_USE_middleware_crank_freetype OR CONFIG_USE_middleware_crank_sbfont))
...
message(SEND_ERROR "middleware_crank_evkmimxrt1170 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
