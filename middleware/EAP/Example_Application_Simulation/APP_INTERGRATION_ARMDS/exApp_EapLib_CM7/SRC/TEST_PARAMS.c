...
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AllEffectOff_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AllEffectOff_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AllEffectOff_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_VOICE_ENHANCER
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short_voiceEnhancer.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_VoiceEnhancer_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_VoiceEnhancer_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_VoiceEnhancer_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_MUSIC_ENHANCER_RMSLIMITER
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_musicEnhancerRMSLimiter_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_MusicEnhancerRMSLimiter_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_MusicEnhancerRMSLimiter_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_AUTO_VOLUME_LEVELER
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short_autoVolumeLeveler.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AutoVolumeLeveler_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AutoVolumeLeveler_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AutoVolumeLeveler_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_CONCERTSOUND
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short_concertSound.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_ConcertSound_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_ConcertSound_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_ConcertSound_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_LOUDNESS_MAXIMISER
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short_loudnessMaximiser.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_LoudnessMaximiser_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_LoudnessMaximiser_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_LoudnessMaximiser_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_CUSTOM
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_Custom_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_Custom_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_Custom_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_TONE_GENERATOR
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_ToneGenerator_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_ToneGenerator_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_ToneGenerator_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_TEST_ALL_ON
char	inputFilename[]			= "..\\..\\In\\EAP_demo_48000_2ch_short.pcm";
char	outputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AllTestOn_OUT.pcm";
char	PSAOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AllTestOn_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\..\\Out_ARMDS\\EAP_demo_48000_2ch_short_AllTestOn_AVL.pcm";
#endif
#endif
...
int eapTest (void)
{
    ...
    */
    /* Audio IN OUT File handle */
     ...
     LVM_INT16               OutBuffer[2 * MAX_INTERNAL_BLOCKSIZE + 1]  	     = {0};        		     /* Output buffer for the samples, output is always stereo */
    ...
    */
    ...
    {
        printf("Cannot open output audio file\n");
        return -1;
    }
		...
		/* PSA output file */
		    ...
		    {
		        printf("Cannot open output file for PSA\n");
		        return -1;
		    }
#endif /* ALGORITHM_PSA */
	...
	{
		printf("Cannot open output file for AVL READ GAIN file\n");
		return -1;
	}
#endif
    ...
    *******************************************************************************/
    do
    {
        ...
        if(EAP_eventPending_flag==LVM_TRUE)
        {
		    ...
		    WriteSamplesTotal 			= ReadSamplesPerChannel * InputNumChannels;				/* number of sample to write to the file */
