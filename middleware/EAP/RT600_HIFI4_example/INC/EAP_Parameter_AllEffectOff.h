 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_allEffectOff[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_allEffectOff[MAX_EQNB_BANDS] = {
...
LVM_Custom_TuningParams_st CustomTuningParams_allEffectOff = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_allEffectOff[0], /* EQ band configuration */
};
