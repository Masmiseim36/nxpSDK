 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_autoVolumeLeveler[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_autoVolumeLeveler[MAX_EQNB_BANDS] = {
...
LVM_ControlParams_t	ControlParamSet_autoVolumeLeveler = {
	...
	.VC_EffectLevel 		= (LVM_INT16)-9, 			// Volume Control setting in dBs -96 to 0 dB
...
LVM_Custom_TuningParams_st CustomTuningParams_autoVolumeLeveler = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_autoVolumeLeveler[0], /* EQ band configuration */
};
