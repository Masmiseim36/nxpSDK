 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_concertSound[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_concertSound[MAX_EQNB_BANDS] = {
...
LVM_Custom_TuningParams_st CustomTuningParams_concertSound = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_concertSound[0], /* EQ band configuration */
};
