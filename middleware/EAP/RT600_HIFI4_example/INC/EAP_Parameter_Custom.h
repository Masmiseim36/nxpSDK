 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_custom[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_custom[MAX_EQNB_BANDS] = {
...
LVM_Custom_TuningParams_st CustomTuningParams_custom = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_custom[0], /* EQ band configuration */
};
