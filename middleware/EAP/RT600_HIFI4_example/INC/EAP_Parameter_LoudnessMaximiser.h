 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_loudnessMaximiser[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_loudnessMaximiser[MAX_EQNB_BANDS] = {
...
LVM_Custom_TuningParams_st CustomTuningParams_loudnessMaximiser = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_loudnessMaximiser[0], /* EQ band configuration */
};
