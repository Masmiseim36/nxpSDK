 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_musicEnhancer[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_musicEnhancer[MAX_EQNB_BANDS] = {
 ...
 *
 */
LVM_InstParams_t InstParams_musicEnhancer = {
	/* General */
...
LVM_HeadroomBandDef_t HeadroomBandDef_musicEnhancer[LVM_HEADROOM_MAX_NBANDS]  = { 20,4999,3,    		/* Limit_Low, Limit_High, Headroom_Offset */
																		 5000,24000,4,
																		 0,0,0,
																		 0,0,0,
																		 0,0,0 };

LVM_HeadroomParams_t HeadroomParams_musicEnhancer = {
		.Headroom_OperatingMode	= LVM_HEADROOM_ON,  		/* Headroom Control On/Off */
		.pHeadroomDefinition	= &HeadroomBandDef_musicEnhancer[0], /* Headroom band definition */
 ...
 *
 */
LVM_ControlParams_t	ControlParamSet_musicEnhancer = {
	/* General parameters */
	...
	.VirtualizerType 			= LVM_CINEMASOUND_MUSIC,// LVM_CONCERTSOUND or LVM_CINEMASOUND_MUSIC or LVM_CINEMASOUND_MOVIE or LVM_CINEMASOUND_STEREO;
	...
	.pEQNB_BandDefinition			= &EQNB_BandDefs_UserEq1_musicEnhancer[0],// EQ band configuration
...
LVM_Custom_TuningParams_st CustomTuningParams_musicEnhancer = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_musicEnhancer[0], /* EQ band configuration */
};
