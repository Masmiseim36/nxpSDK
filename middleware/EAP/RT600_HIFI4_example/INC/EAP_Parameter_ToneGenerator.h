 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_toneGenerator[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_toneGenerator[MAX_EQNB_BANDS] = {
...
LVM_Custom_TuningParams_st CustomTuningParams_toneGenerator = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_toneGenerator[0], /* EQ band configuration */
};
