 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_UserEq1_voiceEnhancer[MAX_EQNB_BANDS] 	= {
 ...
 *
 */
LVM_EQNB_BandDef_t EQNB_BandDefs_SpeakerEq1_voiceEnhancer[MAX_EQNB_BANDS] = {
...
LVM_ControlParams_t	ControlParamSet_voiceEnhancer = {
	...
	.EQNB_NBands					= (LVM_UINT16)3,          		 // Number of bands 0 to MAX_EQNB_BANDS
	...
	.RS_Config 				= LVM_RS_CONFIG_AVL_FEQ, 	// LVM_RS_CONFIG_AVL_AEQ or LVM_RS_CONFIG_AVL_FEQ or LVM_RS_CONFIG_AVL or LVM_RS_CONFIG_FEQ
...
LVM_Custom_TuningParams_st CustomTuningParams_voiceEnhancer = {
    ...
    .pTuningBandDefs        = &EQNB_BandDefs_SpeakerEq1_voiceEnhancer[0], /* EQ band configuration */
};
