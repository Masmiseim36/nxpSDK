...
//#define EAP_PARAM_MUSIC_ENHANCER
...
/* custom tuning is used
 * enable/disable the advanced custom tuning parameters
 * The custom tuning controls allow the customer to define a particular taste for speaker equalization,
 * speaker virtualization and headphone virtualization.
 * Where no such tuning requirements exist, the default tuning values can be used and
 * the GetCustomTuning and SetCustomTuning parameter functions can be ignored. */
//#define EXAMPLE_CUSTOM_TUNING
...
/************************************************************************************/
/* FILE HANDLE */
char	inputFilename[]			= "..\\In\\EAP_demoFile_48Khz.pcm";
char	modeInputFilename[] 	= "r+b";

#ifdef EAP_PARAM_ALL_EFFECT_OFF
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_allEffectOff.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_allEffectOff_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_allEffectOff_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_VOICE_ENHANCER
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_voiceEnhancer.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_voiceEnhancer_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_voiceEnhancer_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_MUSIC_ENHANCER
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_musicEnhancer.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_musicEnhancer_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_musicEnhancer_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_AUTO_VOLUME_LEVELER
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_autoVolumeLeveler.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_autoVolumeLeveler_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_autoVolumeLeveler_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_CONCERTSOUND
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_concertSound.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_concertSound_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_concertSound_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_LOUDNESS_MAXIMISER
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_loudnessMaximiser.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_loudnessMaximiser_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_loudnessMaximiser_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_CUSTOM
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_custom.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_custom_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_custom_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_TONE_GENERATOR
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_toneGenerator.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_toneGenerator_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_toneGenerator_AVL.pcm";
#endif
#endif

#ifdef EAP_PARAM_TEST_ALL_ON
char	outputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_testAllOn.pcm";
char	PSAOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_testAllOn_PSA.dat";
#ifdef EXAMPLE_AVL_READ_GAIN
char	AVLOutputFilename[]		= "..\\Out\\OUT_HIFI4_EXAPP_EAP_demoFile_48Khz_testAllOn_AVL.pcm";
#endif
#endif
...
int main (void)
{
    ...
    */
    ...
    LVM_INT16               IOBuffer[LVM_MAX_CHANNELS * LVM_MAX_BLK_SIZE + 1] = {0};   				 /* Read buffer for the samples */
    LVM_INT16   			*pReadBuffer 									  = &IOBuffer[0];
    void                    *AUDIO_OUTPUT_FILE;           					 						 /* File handles for I/O */
    LVM_INT16               OutBuffer[2 * LVM_MAX_BLK_SIZE + 1] 			  = {0};        		 /* Output buffer for the samples, output is always stereo */
	LVM_INT16   			*pWriteBuffer 									  = &OutBuffer[0];
    LVM_INT16               InplaceProcessing_Flag 							  = 0;					 /* 1 for in place processing then OutBuffer can be removed */
    ...
    LVM_Custom_TuningParams_st 	EAP_TuningParams;					/* tuning params */
    LVM_Custom_TuningParams_st 	*pEAP_TuningParams;					/* tuning params */
#endif
#ifdef ALGORITHM_PSA
    ...
    LVM_UINT32              EAP_PSA_DisplayTimeInc 						 = 33;            	/* Display time increment in ms, when "Delta EAP_AudioTime" > EAP_PSA_DisplayTimeInc then update spectrum value */
    LVM_INT8                EAP_PSA_CurrPeaks[LVM_MAX_PSA_BANDS] 		 = {0};  			/* Current spectral peaks */
    LVM_INT8                EAP_PSA_PastPeaks[LVM_MAX_PSA_BANDS] 		 = {0};  			/* Past Spectral Peaks */
    LVM_UINT16              EAP_PSA_BandFreq[LVM_MAX_PSA_BANDS]  		 = {0};  			/* PSA spectral band center frequencies*/
#endif   /*ALGORITHM_PSA*/
#ifdef EXAMPLE_AVL_READ_GAIN
    ...
    *******************************************************************************/
    ...
    EAP_clearAudioBuffer_flag = LVM_TRUE;		/* call clear audio buffer function after EAP set control parameter */
		...
		#endif
		#ifdef EXAMPLE_CUSTOM_TUNING
			pEAP_TuningParams 		= &CustomTuningParams_allEffectOff;	/* custom tuning parameters */
		#endif
	#endif
		...
		#endif
		#ifdef EXAMPLE_CUSTOM_TUNING
			pEAP_TuningParams 		= &CustomTuningParams_voiceEnhancer;	/* custom tuning parameters */
		#endif
	#endif

	#ifdef EAP_PARAM_MUSIC_ENHANCER
		pEAP_ControlParams 	= &ControlParamSet_musicEnhancer;               /* Control Parameters */
		pEAP_InstParams 	= &InstParams_musicEnhancer;       	            /* Instance parameters */
		#ifdef ALGORITHM_EQNB
			pEAP_HeadroomParams	= &HeadroomParams_musicEnhancer;   		    /* Headroom parameters */
		#endif
		#ifdef EXAMPLE_CUSTOM_TUNING
			pEAP_TuningParams 		= &CustomTuningParams_musicEnhancer;	/* custom tuning parameters */
		#endif
	#endif
		...
		#endif
		#ifdef EXAMPLE_CUSTOM_TUNING
			pEAP_TuningParams 		= &CustomTuningParams_loudnessMaximiser; /* custom tuning parameters */
		#endif
	#endif
		...
		#endif
		#ifdef EXAMPLE_CUSTOM_TUNING
			pEAP_TuningParams 		= &CustomTuningParams_concertSound;  	/* custom tuning parameters */
		#endif
		...
		#endif
		#ifdef EXAMPLE_CUSTOM_TUNING
			pEAP_TuningParams 		= &CustomTuningParams_autoVolumeLeveler; /* custom tuning parameters */
		#endif
	#endif
	...
	#endif
	#ifdef EXAMPLE_CUSTOM_TUNING
		pEAP_TuningParams 		= &CustomTuningParams_custom;	/* custom tuning parameters */
	#endif
#endif
	...
	#endif
	#ifdef EXAMPLE_CUSTOM_TUNING
		pEAP_TuningParams 		= &CustomTuningParams_toneGenerator;	/* custom tuning parameters */
	#endif
#endif
	...
	#endif
	#ifdef EXAMPLE_CUSTOM_TUNING
		pEAP_TuningParams 		= &CustomTuningParams_testAllOn;	/* custom tuning parameters */
	#endif
#endif
    ...
    *******************************************************************************/
    ...
    {
        /* Log the memory size */
        printf(" Memory region %d, size %d in Bytes\n",(LVM_INT16)i,(LVM_UINT16)EAP_MemTab.Region[i].Size);
    ...
    *******************************************************************************/
    do
    {
        ...
        if(EAP_eventPending_flag==LVM_TRUE)
        {
			...
			if (pEAP_ControlParams->SourceFormat == LVM_5DOT1) 		 {InputNumChannels = 6;}; // LVM_MONO or LVM_MONOINSTEREO or LVM_STEREO or LVM_5DOT1 or LVM_7DOT1
			if (pEAP_ControlParams->SourceFormat == LVM_7DOT1) 		 {InputNumChannels = 8;}; // LVM_MONO or LVM_MONOINSTEREO or LVM_STEREO or LVM_5DOT1 or LVM_7DOT1

		    // Read the processing block size
			ReadSamplesPerChannel = SampleRate * LVM_FRAME_SIZE_MS / 1000 ;
		    if (ReadSamplesPerChannel > LVM_MAX_BLK_SIZE)
		    {
		        printf("Block size too large(Max = %d): %d\n", LVM_MAX_BLK_SIZE, ReadSamplesPerChannel);
		        return -1;
		    }
		    ReadSamplesTotal 			= ReadSamplesPerChannel * InputNumChannels;        		/* Number of samples to read from the file */
		    WriteSamplesTotal 			= ReadSamplesPerChannel * 2;							/* number of sample to write to the file, always stereo */
		...
		/* PSA output file */
			...
			*******************************************************************************/
			...
			/* OPTIONAL) */
			/******************************************************************************
			Call set custom tuning parameters
				- propagate the configuration to EAP
			*******************************************************************************/
			LVM_Status = LVM_SetCustomTuning( EAP_hInstance,
											  pEAP_TuningParams);
			if (LVM_Status == LVM_OUTOFRANGE)
			{
				printf("SetCustomTuning error - out of range\n");
				return -1;
			}
#endif // end custom parameters
        ...
        */
		...
		else // else enough sample to call LVM_Process
		{
			...
			fwrite( pWriteBuffer, sizeof(LVM_INT16), (LVM_INT32)WriteSamplesTotal, AUDIO_OUTPUT_FILE );
    	...
    	******************************************************************************/
		if (EAP_AudioTime == EXAMPLE_PARAMETER_UPDATE_TIME)
    	{
    	     ...
    	     */
    		pEAP_TuningParams = &EAP_TuningParams;
    		LVM_Status = LVM_GetCustomTuning(	EAP_hInstance,
    											pEAP_TuningParams);

			if (LVM_Status == LVM_NULLADDRESS)
			{
				printf("LVM_GetCustomTuning error - null pointer\n");
				return -1;
			}
			if (LVM_Status == LVM_OUTOFRANGE)
			{
				printf("LVM_GetCustomTuning error - out of range\n");
				return -1;
			}
    	    /*
    	     ...
    	     *     instance will be updated later as EAP_eventPending_flag = LVM_TRUE
    	     */
			pEAP_TuningParams->Tuning_HPF_Mode 	    = LVM_EQNB_FILTER_OFF;
#endif
