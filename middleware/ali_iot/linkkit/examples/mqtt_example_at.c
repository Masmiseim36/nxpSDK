...
char g_product_key[IOTX_PRODUCT_KEY_LEN + 1]       = "a1JXjn4AaGR";
char g_product_secret[IOTX_PRODUCT_SECRET_LEN + 1] = "";
char g_device_name[IOTX_DEVICE_NAME_LEN + 1]       = "light";
char g_device_secret[IOTX_DEVICE_SECRET_LEN + 1]   = "Xj8J45OQYIHN5s5wUxn3007pFWmVlF4p";
