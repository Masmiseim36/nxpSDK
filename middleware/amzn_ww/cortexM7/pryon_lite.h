...
typedef struct PryonLiteEngineAttributes
{
    ...
    long int maxMetadataBlobSize;    ///< Maximum size of metadata blob returned as part of a PryonLiteResult
...
{
    long int samplesPerFrame;   ///< input frame size required for calls to PryonLiteDecoder_PushAudioSamples()
