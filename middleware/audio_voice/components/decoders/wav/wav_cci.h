...
////////////////////////////////////////////////////////////////////////////////
//! \addtogroup wavdec WAVE Decoder
//! @{
//
// Copyright (c) 2013-2014 Freescale Semiconductor, Inc.
//
//! \file wav_cci.h
//! \brief Contains WAVE Decoder APIs definations.
////////////////////////////////////////////////////////////////////////////////
#ifndef __wav_cci_h__
#define __wav_cci_h__

#include <stdint.h>

// WAV Decoder Public API
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
int32_t WAVDecoderGetMemorySize ();
...
/////////////////////////////////////////////////////////////////////////////////
int32_t WAVDecoderInit (int32_t *pMemory[], int32_t *pCallbackFn[], int32_t *pUserData);
...
/////////////////////////////////////////////////////////////////////////////////
int32_t WAVDecoderDecode(int32_t *memory[],int32_t *sampleProudced,int32_t *bufOut);
...
/////////////////////////////////////////////////////////////////////////////////
int32_t WAVDecoderReset(int32_t *memory[]);
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////
int32_t WAVDecoderSeek(int32_t *memory[],int32_t seekOffset);
...
int32_t WAVDecoderGetIOFrameSize(int32_t *inSize, int32_t *outSize);
