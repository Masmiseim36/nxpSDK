#
# Copyright (c) 2011-2025 by Cadence Design Systems, Inc.  ALL RIGHTS RESERVED.
...
Version 1.21 API 1.13: February 7, 2024

+ GA release
+ Pull Mode support added for all HiFi codebases.
+ Programmer's Guide updated.
+ Tools : RI.11 with xt-clang compiler

----------------------------------------------------------------------

Version 1.20_Beta API 1.13: December 12, 2023

+ Beta release.
+ Extended Pull mode support for all HiFi codebases.
+ Quality enhancements for Pull mode operation.
+ Added jitter buffer at output of ASRC library for Pull mode operation
+ Built using RI.11 tools and xt-clang compiler.

----------------------------------------------------------------------

Version 1.19_Alpha API 1.13: September 29, 2023

+ Alpha release.
+ Added config parameter to set push/pull mode and error code to indicate invalid config for pull mode
+ Updated filter stages order to support push/pull modes and init time switching
+ Added jitter buffer support for ASRC library
+ Fixed warnings for LLVM15 compiler
+ Built using RI.11 tools and xt-clang compiler.
...
----------------------------------------------------------------------
2024-12-15:20:04:RJ-2024.3:873057:916035:873210::
