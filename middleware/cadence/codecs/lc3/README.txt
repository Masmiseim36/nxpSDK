#
# Copyright (c) 2019-2025 by Cadence Design Systems, Inc.  ALL RIGHTS RESERVED.
...
Version 1.17 API 1.2: November 19, 2024

+ GA release
+ Programmer's Guide updated
+ Tools : RJ.3 and xt-clang compiler

----------------------------------------------------------------------

Version 1.16 API 1.2: September 5, 2023
...
Version 1.15_Beta API 1.2: August 11, 2023
                                                                                                                           
+ [TENA-4052]/[TENA-3845] fix for issues reported by customer
+ Programmer's Guide is updated
+ Tools : RI.11 with xt-clang compiler

----------------------------------------------------------------------

Version 1.14p1 API 1.2: February 15, 2023

+ patch release with crash fix reported by customer

----------------------------------------------------------------------

Version 1.14 API 1.2: February 10, 2023

+ GA release using RI.9 tools with xt-clang compiler
+ Programmer's Guide is updated

----------------------------------------------------------------------

Version 1.13_Beta API 1.2: December 9, 2022

+ Code upgraded to latest LC3 source code
+ Code optimized for Advanced Packet Loss Concealment function
routines.
+ API updates for dynamic scratch calculations.
+ Tools : RI.9 with xt-clang compiler
...
2024-11-18:21:16:RJ-2024.3:927750:924321:927297::
