...
Version 1.27 API 1.0: September 4, 2024
 
+ GA release for Opus codec with Multichannel Encoder support.
+ Ogg Container support added for multichannel encoder.
+ Updates to multichannel encoder/decoder for Channel Mapping Family 255 support.
+ Release with RJ.3 tools and xt-clang compiler.
+ PG doc updated.

---------------------------------------------------------------------

Version 1.26_Beta2 API 1.0: August 14, 2024

+ Beta release for Opus codec with support for Channel Mapping Family 255.
+ Release with RJ.3 tools on FS_AVS_LE7_FP.
+ PG doc not updated.

---------------------------------------------------------------------
Version 1.25_Beta API 1.0: July 1, 2024

+ Beta release for Opus codec with Multichannel Encoder support.
+ Ogg Container support added for multichannel encoder.
+ Release with RJ.3 tools on FS_AVS_LE7_FP / AE_HiFi3_LE7_FP / AE_HiFi5e_LE7_AO_FP cores.
+ PG doc updated.
...
2024-09-12:23:17:RJ-2024.3:914146:916035:914472::
