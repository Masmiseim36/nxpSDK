#
# Copyright (c) 2009-2022 by Cadence Design Systems, Inc.  ALL RIGHTS RESERVED.
...
Version 1.9 API 1.12: March 31, 2021

+ GA release using RI.8 tools and xt-clang compiler.
+ Code is optimized for HiFi 1 DSP.
+ Programmer's Guide is updated.

----------------------------------------------------------------------

Version 1.8_Beta API 1.12: December 24, 2021

+ Beta release using RI.8 tools and xt-clang compiler.
+ Code is optimized for HiFi 1 DSP.
+ Programmer's Guide is not updated.
...
-------------------------------------------------------------------------
2022-09-22:23:05:RI-2022.9:734216:726678:733936::
