...
void fir_lxcorr32x32(int32_t * r, const int32_t * restrict x, const int32_t * restrict y, int N, int M)
{
    ...
    ae_f32x2   y0, y1;
    ae_f32x2   y0_high, y0_low, y1_high, y1_low;
    ...
    */
    {
        ...
        for (n = 0; n < ((M - 1)&~3); n += 4, pY -= 4)
        {
            ...
            for (m = 0; m < (n >> 2); m++)
            {
                ...
                AE_MULAF32R_LL(q0, x0, y0_high);
                AE_MULAF32R_LH(q0, y0_low, x1);
                AE_MULAF32R_LL(q0, x1, y1_high);
                AE_MULAF32R_LH(q0, y1_low, x2);

                AE_MULAF32R_HH(q1, x1, y0_high);
                AE_MULAF32R_LL(q1, x1, y0_low);
                AE_MULAF32R_HH(q1, x2, y1_high);
                AE_MULAF32R_LL(q1, x2, y1_low);

                AE_MULAF32R_LL(q2, x1, y0_high);
                AE_MULAF32R_LH(q2, y0_low, x2);
                AE_MULAF32R_LL(q2, x2, y1_high);
                AE_MULAF32R_LH(q2, y1_low, x3);

                AE_MULAF32R_HH(q3, x2, y0_high);
                AE_MULAF32R_LL(q3, x2, y0_low);
                AE_MULAF32R_HH(q3, x3, y1_high);
                AE_MULAF32R_LL(q3, x3, y1_low);
                x0 = x2;
                x1 = x3;
            }
        ...
        for (n = ((M - 1)&~3); n < (M - 1); n++)
        {
            ...
            for (m = 0; m < (n + 1) >> 1; m++)
            {
                AE_LA32X2_IP(t0, ax, X);
                x0 = (t0);
                AE_LA32X2_IP(t0, ay, Y);
                y0 = (t0);
            ...
            AE_S32_L_IP(AE_SEL32_LH(x0,x0), castxcc(ae_int32, R), 4);
        }
    }
    ...
    */
    {
        ...
        if (n_iter)
        {
            ...
            if (n_iter>2) AE_S32_L_IP(AE_SEL32_LH(x0,x0), castxcc(ae_int32, R), 4);
        }
    }
