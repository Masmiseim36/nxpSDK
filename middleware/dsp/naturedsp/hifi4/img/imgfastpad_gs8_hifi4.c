...
-------------------------------------------------------------------------*/
#if 0
DISCARD_FUN(void, imgfastpad_gs8, (void * restrict pScr, void * restrict outImg, const void * restrict inImg, const imgpad_params_t* params));
DISCARD_FUN(size_t, imgfastpad_gs8_getScratchSize,(const imgpad_params_t * params));
#else
