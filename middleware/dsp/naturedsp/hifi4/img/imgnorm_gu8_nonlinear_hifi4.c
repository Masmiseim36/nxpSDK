    ...
    for (i = 0; i < h; i++)
    {
        ...
        if (sh_in != sh_out)
        {
            ...
            for (j = 0; j < ((w - sh_in) >> 3); j++)
            {
                ...
                x = AE_AND16(p, AE_MOVDA16(0xff00));
                ...
                out[shift + j * 8 + 0] = (uint8_t)AE_MOVAD16_3(z_);
                out[shift + j * 8 + 1] = (uint8_t)AE_MOVAD16_3(z);
                out[shift + j * 8 + 2] = (uint8_t)AE_MOVAD16_2(z_);
                out[shift + j * 8 + 3] = (uint8_t)AE_MOVAD16_2(z);
                out[shift + j * 8 + 4] = (uint8_t)AE_MOVAD16_1(z_);
                out[shift + j * 8 + 5] = (uint8_t)AE_MOVAD16_1(z);
                out[shift + j * 8 + 6] = (uint8_t)AE_MOVAD16_0(z_);
                out[shift + j * 8 + 7] = (uint8_t)AE_MOVAD16_0(z);
            }
