        ...
        case 0: // k=0...3
            {
                ...
                for (n=0; n<N; n++)
                {
                    ...
                    pB[n*N+8]=AE_MULP32X2(pB[n*N+8],expB_coef);
                    pB[n*N+9]=AE_MULP32X2(pB[n*N+9],expB_coef);
                ...
                Bk8=AE_L32X2_X(pB,8*sizeof(ae_int32x2));
                Bk9=AE_L32X2_X(pB,9*sizeof(ae_int32x2));
                ...
                for (i=0; i<N-1; i++)
                {
                    ...
                    Bin8=AE_L32X2_X(pB,8*sizeof(ae_int32x2));
                    Bin9=AE_L32X2_X(pB,9*sizeof(ae_int32x2));
                    ...
                    Bin8=AE_MULFP32X2RAS(Bin8,esh_coef);
                    Bin9=AE_MULFP32X2RAS(Bin9,esh_coef);
                    ...
                    AE_S32X2_X(Bin8,pBwr,8*sizeof(ae_int32x2));
                    AE_S32X2_X(Bin9,pBwr,9*sizeof(ae_int32x2));
                ...
                AE_S32X2_X(Bk8,pBwr,8*sizeof(ae_int32x2));
                AE_S32X2_X(Bk9,pBwr,9*sizeof(ae_int32x2));
        ...
        case 1: // k=4...7
            {
                ...
                Bk8=AE_L32X2_I(pB,4*sizeof(ae_int32x2));
                Bk9=AE_L32X2_I(pB,5*sizeof(ae_int32x2));
                ...
                for (i=0; i<N-1; i++)
                {
                    ...
                    Bin8=AE_L32X2_I(pB,4*sizeof(ae_int32x2));
                    Bin9=AE_L32X2_I(pB,5*sizeof(ae_int32x2));
                    ...
                    AE_S32X2_I(Bin8,pBwr,4*sizeof(ae_int32x2));
                    AE_S32X2_I(Bin9,pBwr,5*sizeof(ae_int32x2));
                ...
                AE_S32X2_X(Bk8,pBwr,4*sizeof(ae_int32x2));
                AE_S32X2_X(Bk9,pBwr,5*sizeof(ae_int32x2));
        ...
        case 2: // k=8..9
            {
                ...
                pB=(B+k*N+8);
                pT=(T+k);
                Bk9=AE_L32X2_I(pB,1*sizeof(ae_int32x2));
                AE_L32X2_XC(Bk8,pB,N*sizeof(ae_int32x2));
                AE_ADDCIRC32X2_XC1(pT,sizeof(ae_int32x2));
                pBwr=pB;
                esh_coef=AE_SLAA32S(0x40000000,-e+1);
                for (i=0; i<N-1; i++)
                {
                    ...
                    AE_S32X2_X (Cin,pT,(int)((uintptr_t)C-(uintptr_t)T));
                    AE_ADDCIRC32X2_XC1(pT,sizeof(ae_int32x2));
                    Bin9=AE_L32X2_I(pB,1*sizeof(ae_int32x2));
                    AE_L32X2_XC(Bin8,pB,N*sizeof(ae_int32x2));
                    Bin8=AE_MULFP32X2RAS(Bin8,esh_coef);
                    Bin9=AE_MULFP32X2RAS(Bin9,esh_coef);
                    AE_MULAFC32RAS(Bin8,Bk8,Ti);
                    AE_MULAFC32RAS(Bin9,Bk9,Ti);
                    AE_S32X2_I(Bin9,pBwr,1*sizeof(ae_int32x2));
                    AE_L32X2_XC(Bin8,pBwr,N*sizeof(ae_int32x2));
                }
                Ti=AE_L32X2_I(pT,0);
                Ckn=AE_MULFC32RAS(Ckn,Ti);
                AE_S32X2_X (Ckn,pT,(int)((uintptr_t)C-(uintptr_t)T));
                Bk8=AE_MULFC32RAS(Bk8,Ti);
                Bk9=AE_MULFC32RAS(Bk9,Ti);
                AE_S32X2_I(Bk9,pBwr,1*sizeof(ae_int32x2));
                AE_L32X2_XC(Bk8,pBwr,N*sizeof(ae_int32x2));
                pBwr=(B+k);
                for (i=0; i<N; i++)  AE_S32X2_XP(AE_ZERO32(),pBwr,N*sizeof(ae_int32x2));
                __Pragma("no_reorder");
            }
...
// scratch allocation
size_t cmtx_gjelim10x10_32x32_getScratchSize   () { return  (10*10+2*10)*sizeof(complex_fract32);  }
