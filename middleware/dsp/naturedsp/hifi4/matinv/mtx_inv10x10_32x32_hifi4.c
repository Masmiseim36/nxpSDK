    ...
    for (k=0; k<N; k++)
    {
        ...
        // Gauss-Jordan elimination: might be made using curcular addressing on B/C
        {
            ...
            for (i=0; i<N-1; i++)
            {
                ...
                AE_L32X2_XC(Bin0,pB,N/2*sizeof(ae_int32x2));
                ...
                Cin4=AE_L32X2_I(pC,4*sizeof(ae_int32x2));
                ...
                Cin4=AE_MULFP32X2RAS(Cin4,esh_coef);
                ...
                AE_MULSFP32X2RAS(Bin4,Bk4,Ti);
                AE_MULSFP32X2RAS(Cin4,Ck4,Ti);
                ...
                AE_S32X2_I (Cin4,pCwr,4*sizeof(ae_int32x2));
                ...
                AE_S32X2_XC (Bin0,pBwr,N/2*sizeof(ae_int32x2));
            }
            AE_L32_XC1(Ti,castxcc(ae_int32,pT),sizeof(int32_t));
            ...
            AE_S32X2_I (Ck4,pCwr,4*sizeof(ae_int32x2));
            ...
            AE_S32X2_XC (Bk0,pBwr,N/2*sizeof(ae_int32x2));
            __Pragma("no_reorder");
        }
        pB=(ae_int32x2*)(B+k);
