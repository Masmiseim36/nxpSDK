...
void mtx_inv10x10f(void * pScr,float32_t* x) 
{
...

    {
        ...
        for(n=0; n<N; n++)
        {
            ...
            XT_SSX2IP(a3,pA,sizeof(xtfloatx2));
            XT_SSX2IP(a4,pA,sizeof(xtfloatx2));
    ...
    for(k=0; k<N; k++)
    {
        ...
        /* elimination */
        {
            ...
            Ak6=XT_LSX2I(pA,6*sizeof(xtfloatx2));
            Ak7=XT_LSX2I(pA,7*sizeof(xtfloatx2));
            Ak8=XT_LSX2X(pA,8*sizeof(xtfloatx2));
            Ak9=XT_LSX2X(pA,9*sizeof(xtfloatx2));
            ...
            Ak6=XT_MUL_SX2(Ak6,R);
            Ak7=XT_MUL_SX2(Ak7,R);
            Ak8=XT_MUL_SX2(Ak8,R);
            Ak9=XT_MUL_SX2(Ak9,R);
            ...
            XT_SSX2I(Ak6,pAwr,6*sizeof(xtfloatx2));
            XT_SSX2I(Ak7,pAwr,7*sizeof(xtfloatx2));
            XT_SSX2X(Ak8,pAwr,8*sizeof(xtfloatx2));
            XT_SSX2X(Ak9,pAwr,9*sizeof(xtfloatx2));
            ...
            for (n=0; n<N-1; n++)
            {
                ...
                An6=XT_LSX2I(pA,6*sizeof(xtfloatx2));
                An7=XT_LSX2I(pA,7*sizeof(xtfloatx2));
                An8=XT_LSX2X(pA,8*sizeof(xtfloatx2));
                An9=XT_LSX2X(pA,9*sizeof(xtfloatx2));
                ...
                XT_MSUB_SX2(An6,Ak6,c);
                XT_MSUB_SX2(An7,Ak7,c);
                XT_MSUB_SX2(An8,Ak8,c);
                XT_MSUB_SX2(An9,Ak9,c);
                ...
                XT_SSX2I(An6,pAwr,6*sizeof(xtfloatx2));
                XT_SSX2I(An7,pAwr,7*sizeof(xtfloatx2));
                XT_SSX2X(An8,pAwr,8*sizeof(xtfloatx2));
                XT_SSX2X(An9,pAwr,9*sizeof(xtfloatx2));
    ...
    /* copy to x */
    {
        ...
        for(n=0; n<N; n++)
        {
            ...
            a3=XT_LSX2I(pA,3*sizeof(xtfloatx2));
            a4=XT_LSX2I(pA,4*sizeof(xtfloatx2));
