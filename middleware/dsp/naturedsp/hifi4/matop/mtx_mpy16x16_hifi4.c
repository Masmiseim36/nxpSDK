               ...
               int M, int N, int P, int lsh )
{
    ...
    for (p = 0; p < (P >> 2); p++)
    {
        ...
        py1 = (const ae_int16x4 *)XT_ADDX2(P, (uintptr_t)py0);
        py2 = (const ae_int16x4 *)XT_ADDX2(P, (uintptr_t)py1);
        py3 = (const ae_int16x4 *)XT_ADDX2(P, (uintptr_t)py2);
        pz = (ae_int16x4 *)scr;
        for (n = 0; n < (N >> 2); n++)
        {
            vy0 = AE_LA64_PP(py0);
            ...
            py0 = (const ae_int16x4 *)XT_ADDX8(P - 1, (uintptr_t)py0);
            py1 = (const ae_int16x4 *)XT_ADDX8(P - 1, (uintptr_t)py1);
            py2 = (const ae_int16x4 *)XT_ADDX8(P - 1, (uintptr_t)py2);
            py3 = (const ae_int16x4 *)XT_ADDX8(P - 1, (uintptr_t)py3);
...
{
    (void)M;(void)P;
    return N<=0 ? 0: 4*((N+3)&~3)*sizeof(int16_t);
}
