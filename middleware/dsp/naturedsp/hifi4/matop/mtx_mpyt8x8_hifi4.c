               ...
               int M, int N, int P, int lsh )
{
        ...
        for (p=0; p<(P&~3); p+=4)
        {
            for (m=0; m<(M&~1);m+=2)
            {
                ...
                for (n=0; n<(N&~1); n+=2)
                {
                    ae_int32x2 t0,t1,s0;
                    ae_int32x2 t2,t3,s1;
                    t0=AE_MOVDA32X2((uint8_t)y[p*N+n+0*N+0],(uint8_t)y[p*N+n+0*N+1]);
                    t1=AE_MOVDA32X2((uint8_t)y[p*N+n+2*N+0],(uint8_t)y[p*N+n+2*N+1]);
                    s0=AE_MOVDA32X2((uint8_t)x[m*N+n]  ,(uint8_t)x[m*N+n+1]);
                    t2=AE_MOVDA32X2((uint8_t)y[p*N+n+1*N+0],(uint8_t)y[p*N+n+1*N+1]);
                    t3=AE_MOVDA32X2((uint8_t)y[p*N+n+3*N+0],(uint8_t)y[p*N+n+3*N+1]);
                ...
                {
                    ae_int32x2 t0,t1,s0;
                    t0=AE_MOVDA32X2((uint8_t)y[p*N+n+0*N],(uint8_t)y[p*N+n+1*N]);
                    t1=AE_MOVDA32X2((uint8_t)y[p*N+n+2*N],(uint8_t)y[p*N+n+3*N]);
            ...
            if (M&1)
            {
                ...
                for (n=0; n<(N&~1); n+=2)
                {
                    ...
                    t0=AE_MOVDA32X2((uint8_t)y[p*N+n+0*N+0],(uint8_t)y[p*N+n+0*N+1]);
                    t1=AE_MOVDA32X2((uint8_t)y[p*N+n+1*N+0],(uint8_t)y[p*N+n+1*N+1]);
                    t2=AE_MOVDA32X2((uint8_t)y[p*N+n+2*N+0],(uint8_t)y[p*N+n+2*N+1]);
                    t3=AE_MOVDA32X2((uint8_t)y[p*N+n+3*N+0],(uint8_t)y[p*N+n+3*N+1]);
                    s0=AE_MOVDA32X2((uint8_t)x[m*N+n]  ,(uint8_t)x[m*N+n+1]);
                    t0=AE_SEXT32(t0,7);
                    t1=AE_SEXT32(t1,7);
    ...
    if(P&2)
    {
        for (m=0; m<(M&~3);m+=4)
        {
            ...
            for (n=0; n<(N&~1); n+=2)
            {
                ...
                s0=AE_MOVDA32X2((uint8_t)y[p*N+n+0+0*N],(uint8_t)y[p*N+n+1+0*N]);
                s1=AE_MOVDA32X2((uint8_t)y[p*N+n+0+1*N],(uint8_t)y[p*N+n+1+1*N]);
            ...
            {
                ae_int32x2 s0,t0,t1;
                s0=AE_MOVDA32X2((uint8_t)y[p*N+n    ],(uint8_t)y[p*N+n+1*N]);
        ...
        case 3:
            {
                ...
                {
                    ae_int32x2 t0,t1,s0;
                    s0=AE_MOVDA32X2((uint8_t)y[p*N+n+0*N],(uint8_t)y[p*N+n+1*N]);
                    t0=AE_MOVDA32X2((uint8_t)x[m*N+n    ],(uint8_t)x[m*N+n+1*N]);
    ...
    if (P&1)
    {
        for (m=0; m<(M&~3);m+=4)
        {
            ...
            {
                ae_int32x2 s0,t0,t1,t2,t3;
                s0=AE_MOVDA32X2((uint8_t)y[p*N+n+0  ],(uint8_t)y[p*N+n+1]);
            ...
            {
                ae_int32x2 s0,t0,t1;
                s0=AE_MOVDA32X2((uint8_t)y[p*N+n+0  ],(uint8_t)y[p*N+n+0  ]);
