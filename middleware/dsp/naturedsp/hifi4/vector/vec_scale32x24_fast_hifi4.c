...
/*-------------------------------------------------------------------------
  ...
  vec_shift32x32, vec_shift16x16, vec_shiftf, vec_scale32x32, 
  vec_scale16x16, vec_scalef, vec_scale_sf) work with 
  arbitrary arguments, faster versions (vec_shift32x32_fast,
...
For floating point:
  ...
  vec_shiftf, vec_scale32x32, vec_scale16x16, 
  ...
  For faster versions (vec_shift32x32_fast, 
  vec_shift16x16_fast, vec_scale32x24_fast, vec_scale32x32_fast,
  vec_scale16x16_fast):
  x,y should not overlap
