...
int dct_32x32( int32_t * restrict y, int32_t * restrict x, dct_handle_t h, int scalingOpt )
{
  ...
  //
    ...
    /* DCT split algorithm */
    {
      ae_int32x2  vF0, vF1, vC0, vW0, vW1;
      ae_f32x2    vFR;
      ...
      N4 = N >> 2;
      p_cos = (const ae_int32x2 *)(descr->rfft_split_twd)+1;
      p_w   = (const ae_int32x2 *)(descr->dct_twd);
      ...
      AE_L32X2_IP(vF0, p_y0, sizeof(ae_int32x2));
      AE_L32X2_IP(vW0, p_w, sizeof(ae_int32x2));
      vA0 = (vF0);
      vA1 = AE_SEL32_LH(vA0, vA0);
      vB0 = AE_ADDSUB32S(vA1, vA0);
      vF0 = (vB0);
      vFR = AE_MULFP32X2RAS(vF0, vW0);
      vR0 = (vFR);

      AE_L32X2_IP(vF0, p_y0 , sizeof(ae_int32x2));
      AE_L32X2_XP(vF1, p_y1 , step_back);
      AE_L32X2_IP(vC0, p_cos, sizeof(ae_int32x2));
      AE_L32X2_IP(vW0, p_w  , sizeof(ae_int32x2));
      AE_L32X2_IP(vW1, p_w  , sizeof(ae_int32x2));

      vB0 = AE_SUBADD32S(vF0, vF1);
      vB1 = AE_ADDSUB32S(vF0, vF1);
      vF0 = (vB0);
      vFR = AE_MULFC32RAS(vF0, vC0);
      ...
      */
      vA0 = AE_MULFC32RAS(vF0, vW0);
      vA1 = AE_NEG32S(vA0);
      vB1 = AE_MULFC32RAS(vF1, vW1);
      ...
      AE_S32X2_X (vF1, p_z0, N4*sizeof(*p_z0));
      AE_S32X2_IP(vF0, p_z0, sizeof(*p_z0));
      ...
      for (i = 1; i < (N>>3); i++)
      {
        ...
        */
        ...
        vF0 = vB0;
        vF1 = vA1;
        AE_S32X2_X (vF0, p_z1, -N4*(int)sizeof(*p_z1));
        AE_S32X2_XP(vF1, p_z1, step_back);
        AE_L32X2_IP(vF0, p_y0 , sizeof(ae_int32x2));
        AE_L32X2_XP(vF1, p_y1 , step_back);
        AE_L32X2_IP(vC0, p_cos, sizeof(ae_int32x2));
        AE_L32X2_IP(vW0, p_w  , sizeof(ae_int32x2));
      ...
      */
      ...
      vB0 = AE_MULFC32RAS(vF0, vW0);
      vA0 = AE_SEL32_HH(vB0, vR0);
      vA1 = AE_SEL32_LL(vB0, vR0);
      vF0 = vA0;
      vF1 = vA1;

      AE_S32X2_I(vF0, p_z0, 0);
      AE_S32X2_I(vF1, p_z1, 0);
    }
