...
int fft_stageS3_DFT4_32x32(const int32_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp)
{ 
  int i, j, shift, _v;
  ...
  WUR_AE_SAR(shift>>1);
  {
    ...
    for (j = 0; j < (_v>>2); j++)
    {
      ...
      for (i = 0; i < (stride>>log_v); i++)
      {
        ...
        AE_S32X2_XP(x1, py0, _v * sizeof(ae_int32x2));
        AE_S32X2_XP(x2, py0, _v * sizeof(ae_int32x2));
        AE_S32X2_XP(x3, py0, (1-3*_v) * sizeof(ae_int32x2));
        ...
        AE_S32X2_XP(x1, py0, _v * sizeof(ae_int32x2));
        AE_S32X2_XP(x2, py0, _v * sizeof(ae_int32x2));
        AE_S32X2_XP(x3, py0, (_v-3) * sizeof(ae_int32x2));
      }
    }
    *v *= R;
    return shift;
