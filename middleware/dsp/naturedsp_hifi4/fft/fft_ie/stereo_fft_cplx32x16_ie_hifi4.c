...
int stereo_fft_cplx32x16_ie(complex_fract32* y,complex_fract32* x, const complex_fract16* twd, int twdstep, int N, int scalingOpt)
{
    ...
    ae_int32x2 * restrict p_y1l = p_y0l + (N>>1);
    ae_int32x2 * restrict p_y2l = p_y1l + (N>>1);
    ae_int32x2 * restrict p_y3l = p_y2l + (N>>1);
    ...
    if ( (i&1)!=0 )
    {
        ...
        do
        {
            ...
            AE_S32X2_X(vB0, p_y0l, i0);
            AE_S32X2_X(vB1, p_y1l, i0);
            AE_S32X2_X(vB2, p_y2l, i0);
            AE_S32X2_X(vB3, p_y3l, i0);
            ...
            AE_ADDANDSUBRNG32(vB0, vB2, vA0, vA1);
            AE_ADDANDSUBRNG32(vB1, vB3, vA2, vA3);
            AE_S32X2_X(vB0, p_y0r, i0);
            AE_S32X2_X(vB1, p_y1r, i0);
            AE_S32X2_X(vB2, p_y2r, i0);
            AE_S32X2_X(vB3, p_y3r, i0);
    ...
    else
    {
        ...
        do
        {
            ...
            AE_S32X2_X(vA0, p_y0l, i0);
            AE_S32X2_X(vA1, p_y1l, i0);
            AE_S32X2_X(vA2, p_y2l, i0);
            AE_S32X2_X(vA3, p_y3l, i0);
            ...
            AE_ADDANDSUB32S(vA0, vA2, vB0, vB1);
            AE_ADDANDSUB32S(vA3, vA1, vB2, vB3);
            AE_S32X2_X(vA0, p_y0r, i0);
            AE_S32X2_X(vA1, p_y1r, i0);
            AE_S32X2_X(vA2, p_y2r, i0);
            AE_S32X2_X(vA3, p_y3r, i0);
