...
void conv2d_11x7_8x16 (void* pScr, int16_t *z, const int8_t  * x, const int16_t * y, int rsh, int P, int Q)
{
    int m;
    ae_int16x4 t;
    ae_int16x4 *pW=(ae_int16x4 *)pScr;  /* first 80 int16_t elements are temporary storage for modified coefficients */
    NASSERT_ALIGN(x,8);
    NASSERT_ALIGN(y,8);
    NASSERT_ALIGN(z,8);
    ...
    conv2d_11x7_16x16 (pW,z, (const int16_t*)pScr, y, rsh, P, Q);
}
