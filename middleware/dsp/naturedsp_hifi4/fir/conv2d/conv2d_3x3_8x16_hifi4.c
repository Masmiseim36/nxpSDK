...
{
    ae_int16x4 t;
    ae_int16x4 *pW=(ae_int16x4 *)pScr;  /* first 12 int16_t elements are temporary storage for modified coefficients */
    NASSERT_ALIGN(x,8);
    NASSERT_ALIGN(y,8);
    NASSERT_ALIGN(z,8);
