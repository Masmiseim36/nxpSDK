                          ...
                          int wrIx, int D, int N, int M )
{
  ...
  ae_int32x2 t0, t1, t2, t3, t4, t5, t6, t7, t8, t9;
  ae_int32x2 c0, c1;
  ae_f64   q0, q1, q2, q3;
  ae_f64     z;
  ...
  for ( n=0; n<(N>>2); n++ )
  {
    ...
    for ( m=0; m<(M>>2)+1; m++ )
    {
      ...
      // Q31
      AE_L32X2_XC( t8, D_rd0, +8 );              
      AE_L32X2_XC( t9, D_rd0, +8 );
      
      // Q9.62 <- Q9.62 + [ Q31*Q31 ] without symmetric rounding
      AE_MULAAFD32RA_HH_LL (q0,t0,c0);
      AE_MULAAFD32RA_HH_LL (q0,t1,c1);
      AE_MULAAFD32RA_HH_LL (q1,t2,c0);
      AE_MULAAFD32RA_HH_LL (q1,t3,c1);
      AE_MULAAFD32RA_HH_LL (q2,t4,c0);
      AE_MULAAFD32RA_HH_LL (q2,t5,c1);
      AE_MULAAFD32RA_HH_LL (q3,t6,c0);
