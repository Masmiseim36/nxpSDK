    ...
    */
    {
        ...
        if (n_iter > 1)
        {
            ...
            if (m_iter == 1)
            {
                ...
                AE_MULAF32R_HH(q0, x1, y0_high);
                AE_MULAF32R_LL(q0, x1, y0_low);

                AE_MULAF32R_LL(q1, x1, y0_high);
                AE_MULAF32R_LH(q1, y0_low, x2);
            }
            if (m_iter > 1)
            {
    ...
    */
    {
        ...
        if (n_iter)
        {
            ...
            AE_S32_L_IP(AE_SEL32_LH(x0,x0), castxcc(ae_int32, R), 4);
            if (n_iter>1) 
              AE_S32_L_IP(x0, castxcc(ae_int32, R), 4);
