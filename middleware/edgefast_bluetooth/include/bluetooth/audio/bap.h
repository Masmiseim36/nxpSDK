...
#else
#define BT_BAP_SCAN_DELEGATOR_MAX_METADATA_LEN 32 /* Walkaround for "unkown-size array" compile error, change 0 -> 32 */
#define BT_BAP_SCAN_DELEGATOR_MAX_SUBGROUPS    1  /* Walkaround for "unkown-size array" compile error, change 0 -> 1 */
#endif
