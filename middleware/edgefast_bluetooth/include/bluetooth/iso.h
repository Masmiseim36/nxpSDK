...
#if ((defined(CONFIG_BT_SMP) && (CONFIG_BT_SMP > 0))  && (defined(CONFIG_BT_ISO_UNICAST) && (CONFIG_BT_ISO_UNICAST > 0))) || defined(__DOXYGEN__)
	/**
...
#if (defined(CONFIG_BT_ISO_TEST_PARAMS) && (CONFIG_BT_ISO_TEST_PARAMS > 0)) || defined(__DOXYGEN__)
	/**
...
struct bt_iso_info {
    ...
    defined(__DOXYGEN__)
	union {
#if (defined(CONFIG_BT_ISO_UNICAST) && (CONFIG_BT_ISO_UNICAST > 0)) || defined(__DOXYGEN__)
		/** Unicast specific Info.
		 * Only available when @kconfig{CONFIG_BT_ISO_UNICAST} is enabled.
		 */
		struct bt_iso_unicast_info unicast;
#endif /* CONFIG_BT_ISO_UNICAST */
#if (defined(CONFIG_BT_ISO_BROADCASTER) && (CONFIG_BT_ISO_BROADCASTER > 0)) || defined(__DOXYGEN__)
...
#if (defined(CONFIG_BT_ISO_SYNC_RECEIVER) && (CONFIG_BT_ISO_SYNC_RECEIVER > 0)) || defined(__DOXYGEN__)
...
#endif /* CONFIG_BT_ISO_UNICAST || CONFIG_BT_ISO_BROADCASTER || CONFIG_BT_ISO_SYNC_RECEIVER */
};
