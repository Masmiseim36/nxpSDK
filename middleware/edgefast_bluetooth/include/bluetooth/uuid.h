...
/** @def BT_UUID_TX_POWER_VAL
 *  @brief Tx Power Level UUID value
 */
#define BT_UUID_TX_POWER_LEVEL_VAL   0x2a07
/** @def BT_UUID_TX_POWER
 *  @brief Tx Power Level
 */
#define BT_UUID_TX_POWER \
	BT_UUID_DECLARE_16(BT_UUID_TX_POWER_LEVEL_VAL)
