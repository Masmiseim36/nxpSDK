...
#define LOG_ENABLE IS_ENABLED(CONFIG_BT_DEBUG_CAP_COMMANDER)
#define LOG_MODULE_NAME bt_cap_commander
...
#if BT_GAP_PER_ADV_MAX_INTERVAL < 0xFFFF
...
#else
		CHECKIF(start_param->pa_interval > BT_GAP_PER_ADV_MIN_INTERVAL) {
			LOG_DBG("param->param[%zu]->pa_interval is out of range", i);
			return false;
		}
#endif
