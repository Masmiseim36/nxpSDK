...
int bt_audio_codec_cfg_get_freq(const struct bt_audio_codec_cfg *codec_cfg)
{
	...
	freq = (enum bt_audio_codec_cfg_freq)data[0];
...
int bt_audio_codec_cfg_get_frame_dur(const struct bt_audio_codec_cfg *codec_cfg)
{
	...
	frame_dur = (enum bt_audio_codec_cfg_frame_dur)data[0];
					   ...
					   bool fallback_to_default)
{
	...
	*chan_allocation = (enum bt_audio_location)0;
	...
	*chan_allocation = (enum bt_audio_location)sys_get_le32(data);
				    ...
				    const uint8_t **data)
{
	...
	return codec_meta_get_val(codec_cfg->meta, codec_cfg->meta_len, (enum bt_audio_metadata_type)type, data);
}
				    ...
				    const uint8_t **data)
{
	...
	return codec_meta_get_val(codec_cap->meta, codec_cap->meta_len, (enum bt_audio_metadata_type)type, data);
}
