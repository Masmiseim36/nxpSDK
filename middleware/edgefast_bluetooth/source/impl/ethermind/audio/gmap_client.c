...
#define LOG_ENABLE IS_ENABLED(CONFIG_BT_DEBUG_GMAP_CLIENT)
#define LOG_MODULE_NAME bt_gmap_client
...
static void discover_failed(struct bt_gmap_client *gmap_cli, int err)
{
	...
	gmap_cb->discover(conn, err, (enum bt_gmap_role)0, (struct bt_gmap_feat){(enum bt_gmap_ugg_feat)0, (enum bt_gmap_ugt_feat)0, (enum bt_gmap_bgs_feat)0, (enum bt_gmap_bgr_feat)0});
}
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.bgr_feat = (enum bt_gmap_bgr_feat)net_buf_simple_pull_u8(&buf);
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.bgs_feat = (enum bt_gmap_bgs_feat)net_buf_simple_pull_u8(&buf);
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.ugt_feat = (enum bt_gmap_ugt_feat)net_buf_simple_pull_u8(&buf);
				...
				struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->feat.ugg_feat = (enum bt_gmap_ugg_feat)net_buf_simple_pull_u8(&buf);
			    ...
			    struct bt_gatt_read_params *params, const void *data, uint16_t len)
{
	...
	gmap_cli->role = (enum bt_gmap_role)net_buf_simple_pull_u8(&buf);
