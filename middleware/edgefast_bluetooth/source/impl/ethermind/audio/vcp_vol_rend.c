...
#define LOG_ENABLE IS_ENABLED(CONFIG_BT_DEBUG_VCP_VOL_REND)
#define LOG_MODULE_NAME bt_vcp_vol_rend
...
#if defined(CONFIG_BT_VCP_VOL_REND_VOL_FLAGS_NOTIFIABLE) && (CONFIG_BT_VCP_VOL_REND_VOL_FLAGS_NOTIFIABLE > 0)
