...
#if !defined(TFLITE_WITH_RUY) && !defined(TFLITE_MCU)
  ...
  switch (kernel_type) {
    case kReference: {
      reference_integer_ops::ConvPerChannel(
          ...
          (int32*)data->per_channel_output_shift.data(), GetTensorShape(input),
...
#elif defined(TFLITE_WITH_RUY) || defined(TFLITE_MCU)
