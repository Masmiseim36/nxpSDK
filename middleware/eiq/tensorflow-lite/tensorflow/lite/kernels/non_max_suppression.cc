...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (is_soft_nms) {
    ...
    reference_ops::NonMaxSuppression(
        ...
        (int*)output_selected_indices->data.i32, output_selected_scores->data.f,
        (int*)output_num_selected_indices->data.i32);
    ...
    reference_ops::NonMaxSuppression(
        ...
        (int*)output_selected_indices->data.i32, /**selected_scores=**/ nullptr,
        (int*)output_num_selected_indices->data.i32);
    ResetUnusedElementsToZeroes(max_output_size_value,
                                *output_num_selected_indices->data.i32,
                                (int*)output_selected_indices->data.i32, nullptr);
  }
