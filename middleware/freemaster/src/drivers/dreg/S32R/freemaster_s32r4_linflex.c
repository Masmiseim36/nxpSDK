...
#define FMSTR_SERIAL_S32R4_LINFLEXD_ID 1

#if (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32R4_LINFLEXD_ID)
#if !(FMSTR_DISABLE)

#include "freemaster_serial.h"
#include "freemaster_s32r4_linflex.h"
...
static FMSTR_BOOL _FMSTR_S32R4_Init(void);
static void _FMSTR_S32R4_EnableTransmit(FMSTR_BOOL enable);
static void _FMSTR_S32R4_EnableReceive(FMSTR_BOOL enable);
static void _FMSTR_S32R4_EnableTransmitInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32R4_EnableTransmitCompleteInterrupt(FMSTR_BOOL enable);
static void _FMSTR_S32R4_EnableReceiveInterrupt(FMSTR_BOOL enable);
static FMSTR_BOOL _FMSTR_S32R4_IsTransmitRegEmpty(void);
static FMSTR_BOOL _FMSTR_S32R4_IsReceiveRegFull(void);
static FMSTR_BOOL _FMSTR_S32R4_IsTransmitterActive(void);
static void _FMSTR_S32R4_PutChar(FMSTR_BCHR  ch);
static FMSTR_BCHR _FMSTR_S32R4_GetChar(void);
static void _FMSTR_S32R4_Flush(void);
...
const FMSTR_SERIAL_DRV_INTF FMSTR_SERIAL_S32R4_LINFLEXD =
{
    .Init                       = _FMSTR_S32R4_Init,
    .EnableTransmit             = _FMSTR_S32R4_EnableTransmit,
    .EnableReceive              = _FMSTR_S32R4_EnableReceive,
    .EnableTransmitInterrupt    = _FMSTR_S32R4_EnableTransmitInterrupt,
    .EnableTransmitCompleteInterrupt= _FMSTR_S32R4_EnableTransmitCompleteInterrupt,
    .EnableReceiveInterrupt     = _FMSTR_S32R4_EnableReceiveInterrupt,
    .IsTransmitRegEmpty         = _FMSTR_S32R4_IsTransmitRegEmpty,
    .IsReceiveRegFull           = _FMSTR_S32R4_IsReceiveRegFull,
    .IsTransmitterActive        = _FMSTR_S32R4_IsTransmitterActive,
    .PutChar                    = _FMSTR_S32R4_PutChar,
    .GetChar                    = _FMSTR_S32R4_GetChar,
    .Flush                      = _FMSTR_S32R4_Flush,
};
...
#endif /* !(FMSTR_DISABLE) */
#endif /* (FMSTR_MK_IDSTR(FMSTR_SERIAL_DRV) == FMSTR_SERIAL_S32R4_LINFLEXD_ID) */
