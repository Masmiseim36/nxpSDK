 ...
 *
 * Also see the fmstr_any demo application if it is available for your target platform. This
 ...
 *
 * Remove the error statement below when this file is edited.
 */
...
#define FMSTR_TRANSPORT  // TODO: select FMSTR_SERIAL, FMSTR_CAN or FMSTR_PDBDM transport interface
