...
/**
 * @file evkmimxrt1015.c
 * @brief The evkmimxrt1015.c file defines GPIO pins and I2C CMSIS utilities for evkmimxrt1015 board.
 */

#include "evkmimxrt1015.h"
...
// evkmimxrt1015 Arduino Connector Pin Defintion
