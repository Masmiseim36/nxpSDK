...
/**
 * @file evkmimxrt1024.c
 * @brief The evkmimxrt1024.c file defines GPIO pins and I2C CMSIS utilities for evkmimxrt1024 board.
 */
...
// evkmimxrt1024 Arduino Connector Pin Defintion
