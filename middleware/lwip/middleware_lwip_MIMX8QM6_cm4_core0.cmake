if(NOT MIDDLEWARE_LWIP_MIMX8QM6_cm4_core0_INCLUDED)
    
    set(MIDDLEWARE_LWIP_MIMX8QM6_cm4_core0_INCLUDED true CACHE BOOL "middleware_lwip component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_lwip_empty_ethernetif_MIMX8QM6_cm4_core0)
         include(middleware_lwip_empty_ethernetif_MIMX8QM6_cm4_core0)
    endif()
    if(CONFIG_USE_middleware_lwip_usb_ethernetif_MIMX8QM6_cm4_core0)
         include(middleware_lwip_usb_ethernetif_MIMX8QM6_cm4_core0)
    endif()
    if(CONFIG_USE_middleware_lwip_enet_ethernetif_MIMX8QM6_cm4_core0)
         include(middleware_lwip_enet_ethernetif_MIMX8QM6_cm4_core0)
    endif()
    if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MIMX8QM6_cm4_core0 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MIMX8QM6_cm4_core0 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MIMX8QM6_cm4_core0))
        message(WARNING "Since middleware_lwip_empty_ethernetif_MIMX8QM6_cm4_core0/middleware_lwip_usb_ethernetif_MIMX8QM6_cm4_core0/middleware_lwip_enet_ethernetif_MIMX8QM6_cm4_core0 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MIMX8QM6_cm4_core0 by default.")
        include(middleware_lwip_empty_ethernetif_MIMX8QM6_cm4_core0)
    endif()
