...
#OR Logic component
if(CONFIG_USE_middleware_lwip_empty_ethernetif_MIMXRT1042)
     include(middleware_lwip_empty_ethernetif_MIMXRT1042)
endif()
if(CONFIG_USE_middleware_lwip_usb_ethernetif_MIMXRT1042)
     include(middleware_lwip_usb_ethernetif_MIMXRT1042)
endif()
if(CONFIG_USE_middleware_lwip_enet_ethernetif_MIMXRT1042)
     include(middleware_lwip_enet_ethernetif_MIMXRT1042)
endif()
if(CONFIG_USE_middleware_lwip_netc_ethernetif_MIMXRT1042)
     include(middleware_lwip_netc_ethernetif_MIMXRT1042)
endif()
if(CONFIG_USE_middleware_wifi_MIMXRT1042)
     include(middleware_wifi_MIMXRT1042)
endif()
if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MIMXRT1042 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MIMXRT1042 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MIMXRT1042 OR CONFIG_USE_middleware_lwip_netc_ethernetif_MIMXRT1042 OR CONFIG_USE_middleware_wifi_MIMXRT1042))
    message(WARNING "Since middleware_lwip_empty_ethernetif_MIMXRT1042/middleware_lwip_usb_ethernetif_MIMXRT1042/middleware_lwip_enet_ethernetif_MIMXRT1042/middleware_lwip_netc_ethernetif_MIMXRT1042/middleware_wifi_MIMXRT1042 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MIMXRT1042 by default.")
    include(middleware_lwip_empty_ethernetif_MIMXRT1042)
endif()
