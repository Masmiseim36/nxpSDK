if(NOT MIDDLEWARE_LWIP_MIMXRT1176_cm7_INCLUDED)
    
    set(MIDDLEWARE_LWIP_MIMXRT1176_cm7_INCLUDED true CACHE BOOL "middleware_lwip component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_lwip_empty_ethernetif_MIMXRT1176_cm7)
         include(middleware_lwip_empty_ethernetif_MIMXRT1176_cm7)
    endif()
    if(CONFIG_USE_middleware_lwip_usb_ethernetif_MIMXRT1176_cm7)
    ...
    if(CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT1176_cm7)
         include(middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT1176_cm7)
    endif()
    if(CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT1176_cm7)
         include(middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT1176_cm7)
    endif()
    if(CONFIG_USE_middleware_wifi_wiced_AW_NM372SM_MIMXRT1176_cm7)
         include(middleware_wifi_wiced_AW_NM372SM_MIMXRT1176_cm7)
    endif()
    if(CONFIG_USE_middleware_wifi_MIMXRT1176_cm7)
         include(middleware_wifi_MIMXRT1176_cm7)
    endif()
    if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MIMXRT1176_cm7 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MIMXRT1176_cm7 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MIMXRT1176_cm7 OR CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT1176_cm7 OR CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT1176_cm7 OR CONFIG_USE_middleware_wifi_wiced_AW_NM372SM_MIMXRT1176_cm7 OR CONFIG_USE_middleware_wifi_MIMXRT1176_cm7))
        message(WARNING "Since middleware_lwip_empty_ethernetif_MIMXRT1176_cm7/middleware_lwip_usb_ethernetif_MIMXRT1176_cm7/middleware_lwip_enet_ethernetif_MIMXRT1176_cm7/middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT1176_cm7/middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT1176_cm7/middleware_wifi_wiced_AW_NM372SM_MIMXRT1176_cm7/middleware_wifi_MIMXRT1176_cm7 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MIMXRT1176_cm7 by default.")
        include(middleware_lwip_empty_ethernetif_MIMXRT1176_cm7)
    endif()
