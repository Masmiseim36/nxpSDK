if(NOT MIDDLEWARE_LWIP_MIMXRT685S_cm33_INCLUDED)
    
    set(MIDDLEWARE_LWIP_MIMXRT685S_cm33_INCLUDED true CACHE BOOL "middleware_lwip component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_lwip_empty_ethernetif_MIMXRT685S_cm33)
         include(middleware_lwip_empty_ethernetif_MIMXRT685S_cm33)
    endif()
    if(CONFIG_USE_middleware_lwip_usb_ethernetif_MIMXRT685S_cm33)
         include(middleware_lwip_usb_ethernetif_MIMXRT685S_cm33)
    endif()
    if(CONFIG_USE_middleware_lwip_enet_ethernetif_MIMXRT685S_cm33)
         include(middleware_lwip_enet_ethernetif_MIMXRT685S_cm33)
    endif()
    if(CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT685S_cm33)
         include(middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT685S_cm33)
    endif()
    if(CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT685S_cm33)
         include(middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT685S_cm33)
    endif()
    if(CONFIG_USE_middleware_wifi_wiced_AW_NM372SM_MIMXRT685S_cm33)
         include(middleware_wifi_wiced_AW_NM372SM_MIMXRT685S_cm33)
    endif()
    if(CONFIG_USE_middleware_wifi_MIMXRT685S_cm33)
         include(middleware_wifi_MIMXRT685S_cm33)
    endif()
    if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MIMXRT685S_cm33 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MIMXRT685S_cm33 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MIMXRT685S_cm33 OR CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT685S_cm33 OR CONFIG_USE_middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT685S_cm33 OR CONFIG_USE_middleware_wifi_wiced_AW_NM372SM_MIMXRT685S_cm33 OR CONFIG_USE_middleware_wifi_MIMXRT685S_cm33))
        message(WARNING "Since middleware_lwip_empty_ethernetif_MIMXRT685S_cm33/middleware_lwip_usb_ethernetif_MIMXRT685S_cm33/middleware_lwip_enet_ethernetif_MIMXRT685S_cm33/middleware_wifi_wiced_MURATA_TYPE1LV_MIMXRT685S_cm33/middleware_wifi_wiced_MURATA_TYPE1DX_MIMXRT685S_cm33/middleware_wifi_wiced_AW_NM372SM_MIMXRT685S_cm33/middleware_wifi_MIMXRT685S_cm33 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MIMXRT685S_cm33 by default.")
        include(middleware_lwip_empty_ethernetif_MIMXRT685S_cm33)
    endif()
