                                     ...
                                     STREAMER_T *task_data)
{
    ...
    element = (StreamElement *)task_data->elems[ELEMENT_FILE_SINK_INDEX];
     ...
     */
    ret = link_elements(task_data->elems[ELEMENT_AUDIO_SRC_INDEX], 0, task_data->elems[ELEMENT_FILE_SINK_INDEX], 0);
    if (STREAM_OK != ret)
    {
    ...
    ret = element_set_property(task_data->elems[ELEMENT_FILE_SINK_INDEX], prop.prop, prop.val);
    ...
    ret = element_set_property(
                 task_data->elems[ELEMENT_FILE_SINK_INDEX],
                 prop.prop, prop.val);
...
int streamer_destroy_mic2file_pipeline(int8_t pipeline_index, STREAMER_T *task_data)
{
    ...
    ret = unlink_elements(task_data->elems[ELEMENT_AUDIO_SRC_INDEX], 0, task_data->elems[ELEMENT_FILE_SINK_INDEX], 0);
    if (STREAM_OK != ret)
    {
