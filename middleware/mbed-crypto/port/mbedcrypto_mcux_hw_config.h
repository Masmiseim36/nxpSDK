...
/* Enable HASHCRYPT use in library if there is HASHCRYPT on chip. */
    ...
    #define MBEDTLS_MCUX_HASHCRYPT_AES    /* Enable use of HASHCRYPT AES.*/
...
/* Enable CASPER use in library if there is CASPER on chip. */
    ...
    #define MBEDTLS_MCUX_CASPER_PKHA   /* Enable use of CASPER PKHA.*/
    #define MBEDTLS_MCUX_PKHA_INT_MAX_BYTES (512)

/* CASPER hw acceleration supports only one curve (SECP256R1 or SECP384R1) */
        ...
        (defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED) && defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED))) && /* Only one curve */ \
        (defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED) || defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED))) /* (SECP256R1 or SECP384R1) */ \
        && ((CASPER_ECC_P256 && defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED)) || (CASPER_ECC_P384 && defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED))) /* Check driver support */
...
#if defined(MBEDTLS_MCUX_HASHCRYPT_AES)
...
#if defined(MBEDTLS_MCUX_CASPER_PKHA)
