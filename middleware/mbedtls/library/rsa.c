...
#endif /* MBEDTLS_RSA_PRIVATE_ALT NXP added */
...
int mbedtls_rsa_self_test(int verbose)
{
...
#if defined(MBEDTLS_PKCS1_V15) && !defined(MBEDTLS_RSA_KEYGEN_ALT)
    ...
    /*
       ...
       if( verbose != 0 )
        mbedtls_printf( "passed\n");*/
#endif /* defined(MBEDTLS_PKCS1_V21) && defined(MBEDTLS_RSA_KEYGEN_ALT) */
#endif /* defined(MBEDTLS_PKCS1_V15) && !defined(MBEDTLS_RSA_KEYGEN_ALT) */
...
int mbedtls_rsa_self_test(int verbose)
{
    ...
    for (i = 0; i < sizeof(rsa_keys) / sizeof(rsa_keys[0]); i++) {
        ...
        MBEDTLS_MPI_CHK(mbedtls_pk_parse_key(&pk, (const unsigned char *) rsa_keys[i],
        ...
        MBEDTLS_MPI_CHK(mbedtls_rsa_pkcs1_sign(rsa, myrand, NULL, MBEDTLS_RSA_PRIVATE,
                                               MBEDTLS_MD_SHA1, 0,
        ...
        MBEDTLS_MPI_CHK(mbedtls_rsa_pkcs1_verify(rsa, NULL, NULL, MBEDTLS_RSA_PUBLIC,
                                                 MBEDTLS_MD_SHA1, 0,
                                                 sha1sum, rsa_ciphertext));
