if(NOT MIDDLEWARE_MBEDTLS_K32L2A41A_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_K32L2A41A_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_K32L2A41A)
         include(middleware_mbedtls_port_ksdk_K32L2A41A)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_K32L2A41A)
         include(middleware_mbedtls_port_sssapi_K32L2A41A)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_K32L2A41A OR CONFIG_USE_middleware_mbedtls_port_sssapi_K32L2A41A))
        message(WARNING "Since middleware_mbedtls_port_ksdk_K32L2A41A/middleware_mbedtls_port_sssapi_K32L2A41A is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_K32L2A41A by default.")
        include(middleware_mbedtls_port_ksdk_K32L2A41A)
    endif()
