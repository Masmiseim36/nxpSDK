if(NOT MIDDLEWARE_MBEDTLS_K32L3A60_cm0plus_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_K32L3A60_cm0plus_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_K32L3A60_cm0plus)
         include(middleware_mbedtls_port_ksdk_K32L3A60_cm0plus)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_K32L3A60_cm0plus)
         include(middleware_mbedtls_port_sssapi_K32L3A60_cm0plus)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_K32L3A60_cm0plus OR CONFIG_USE_middleware_mbedtls_port_sssapi_K32L3A60_cm0plus))
        message(WARNING "Since middleware_mbedtls_port_ksdk_K32L3A60_cm0plus/middleware_mbedtls_port_sssapi_K32L3A60_cm0plus is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_K32L3A60_cm0plus by default.")
        include(middleware_mbedtls_port_ksdk_K32L3A60_cm0plus)
    endif()
