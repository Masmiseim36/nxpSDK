if(NOT MIDDLEWARE_MBEDTLS_MCIMX7U5_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_MCIMX7U5_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_MCIMX7U5)
         include(middleware_mbedtls_port_ksdk_MCIMX7U5)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_MCIMX7U5)
         include(middleware_mbedtls_port_sssapi_MCIMX7U5)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_MCIMX7U5 OR CONFIG_USE_middleware_mbedtls_port_sssapi_MCIMX7U5))
        message(WARNING "Since middleware_mbedtls_port_ksdk_MCIMX7U5/middleware_mbedtls_port_sssapi_MCIMX7U5 is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_MCIMX7U5 by default.")
        include(middleware_mbedtls_port_ksdk_MCIMX7U5)
    endif()
