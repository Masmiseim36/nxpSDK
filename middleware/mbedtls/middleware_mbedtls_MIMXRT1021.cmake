if(NOT MIDDLEWARE_MBEDTLS_MIMXRT1021_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_MIMXRT1021_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT1021)
         include(middleware_mbedtls_port_ksdk_MIMXRT1021)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT1021)
         include(middleware_mbedtls_port_sssapi_MIMXRT1021)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT1021 OR CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT1021))
        message(WARNING "Since middleware_mbedtls_port_ksdk_MIMXRT1021/middleware_mbedtls_port_sssapi_MIMXRT1021 is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_MIMXRT1021 by default.")
        include(middleware_mbedtls_port_ksdk_MIMXRT1021)
    endif()
