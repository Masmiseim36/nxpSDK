if(NOT MIDDLEWARE_MBEDTLS_MIMXRT1062_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_MIMXRT1062_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT1062)
         include(middleware_mbedtls_port_ksdk_MIMXRT1062)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT1062)
         include(middleware_mbedtls_port_sssapi_MIMXRT1062)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT1062 OR CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT1062))
        message(WARNING "Since middleware_mbedtls_port_ksdk_MIMXRT1062/middleware_mbedtls_port_sssapi_MIMXRT1062 is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_MIMXRT1062 by default.")
        include(middleware_mbedtls_port_ksdk_MIMXRT1062)
    endif()
