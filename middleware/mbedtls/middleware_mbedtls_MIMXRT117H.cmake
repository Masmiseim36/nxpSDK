if(NOT MIDDLEWARE_MBEDTLS_MIMXRT117H_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_MIMXRT117H_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT117H)
         include(middleware_mbedtls_port_ksdk_MIMXRT117H)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT117H)
         include(middleware_mbedtls_port_sssapi_MIMXRT117H)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT117H OR CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT117H))
        message(WARNING "Since middleware_mbedtls_port_ksdk_MIMXRT117H/middleware_mbedtls_port_sssapi_MIMXRT117H is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_MIMXRT117H by default.")
        include(middleware_mbedtls_port_ksdk_MIMXRT117H)
    endif()
