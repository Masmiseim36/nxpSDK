if(NOT MIDDLEWARE_MBEDTLS_MIMXRT595S_cm33_INCLUDED)
    
    set(MIDDLEWARE_MBEDTLS_MIMXRT595S_cm33_INCLUDED true CACHE BOOL "middleware_mbedtls component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT595S_cm33)
         include(middleware_mbedtls_port_ksdk_MIMXRT595S_cm33)
    endif()
    if(CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT595S_cm33)
         include(middleware_mbedtls_port_sssapi_MIMXRT595S_cm33)
    endif()
    if(NOT (CONFIG_USE_middleware_mbedtls_port_ksdk_MIMXRT595S_cm33 OR CONFIG_USE_middleware_mbedtls_port_sssapi_MIMXRT595S_cm33))
        message(WARNING "Since middleware_mbedtls_port_ksdk_MIMXRT595S_cm33/middleware_mbedtls_port_sssapi_MIMXRT595S_cm33 is not included at first or config in config.cmake file, use middleware_mbedtls_port_ksdk_MIMXRT595S_cm33 by default.")
        include(middleware_mbedtls_port_ksdk_MIMXRT595S_cm33)
    endif()
