...
#if ((!defined(MBEDTLS_AES_SETKEY_ENC_ALT)) || (defined(MBEDTLS_AES192_ALT_SW) || \
    defined(MBEDTLS_AES256_ALT_SW) || defined(MBEDTLS_AES_CBC_ALT_SW)))
/*
 * Forward S-box
 */
 ...
 */
#if defined(MBEDTLS_AES_SETKEY_DEC_ALT) && (defined(MBEDTLS_AES192_ALT_SW) || \
    defined(MBEDTLS_AES256_ALT_SW))
 ...
 * AES-ECB block encryption
 */
#if defined(MBEDTLS_AES_ENCRYPT_ALT) && (defined(MBEDTLS_AES192_ALT_SW) || \
    defined(MBEDTLS_AES256_ALT_SW))
 ...
 * AES-ECB block decryption
 */
#if defined(MBEDTLS_AES_DECRYPT_ALT) && (defined(MBEDTLS_AES192_ALT_SW) || \
    defined(MBEDTLS_AES256_ALT_SW))
                          ...
                          unsigned char *output)
{
    ...
    status_t status =
        HASHCRYPT_AES_CryptCtr(HASHCRYPT,
                               ctx,
                               input,
                               output,
                               length,
