...
static const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] = {
    ...
    {LIN_FRM_UNCD, 8U, LIN_RES_SUB, 0, 0, 1, 2, 0},
    {LIN_FRM_UNCD, 8U, LIN_RES_PUB, 0, 1, 1, 2, 0},
    {LIN_FRM_UNCD, 8U, LIN_RES_PUB, 0, 2, 1, 10, 0},
    {LIN_FRM_UNCD, 6U, LIN_RES_SUB, 13, 6, 1, 10, 0},
    {LIN_FRM_DIAG, 8U, LIN_RES_SUB, 0, 0, 0, 2, 0},
    {LIN_FRM_DIAG, 8U, LIN_RES_PUB, 0, 0, 0, 2, 0}
};
...
const lin_protocol_user_config_t g_lin_protocol_user_cfg_array[LIN_NUM_OF_IFCS] = {
    ...
    /* Interface_name = LI0 */
    {
        ...
        .number_of_configurable_frames = 3,                         /*  num_of_frames */
...
lin_protocol_state_t g_lin_protocol_state_array[LIN_NUM_OF_IFCS] = {
    ...
    {.successful_transfer         = 0U,
     ...
     .transmit_error_resp_sig_flg = (_Bool)false,
     .go_to_sleep_flg             = (_Bool)false,
     .next_transmit_tick          = 0U,
     .save_config_flg             = (_Bool)false,
     .event_trigger_collision_flg = (_Bool)false}};
