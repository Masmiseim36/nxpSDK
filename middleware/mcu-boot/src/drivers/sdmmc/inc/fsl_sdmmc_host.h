...
#define SDMMCHOST_SWITCH_VOLTAGE120V(base, enable12v)
#define SDMMCHOST_CONFIG_SD_MUX(base, busWidth) BOARD_SD_MUX_CONFIG(base, busWidth)
#define SDMMCHOST_UPDATE_SD_IO(base, busWidth, speed, strength) BOARD_SD_IO_UPDATE(base, busWidth, speed, strength)
#define SDMMCHOST_CONFIG_SD_IO(speed, strength) BOARD_SD_PIN_CONFIG(speed, strength)
#define SDMMCHOST_CONFIG_MMC_MUX(base, busWidth) BOARD_MMC_MUX_CONFIG(base, busWidth)
#define SDMMCHOST_UPDATE_MMC_IO(base, busWidth, speed, strength) BOARD_MMC_IO_UPDATE(base, busWidth, speed, strength)
...
#define SDMMCHOST_ADJUST_TUNING_DELAY(base, delay)
#else
#define SDMMCHOST_EXECUTE_STANDARD_TUNING_ENABLE(base, start, step, flag) \
    (USDHC_EnableStandardTuning(base, start, step, flag))
...
/* sd card vselect */
#define SDMMCHOST_INIT_SD_VSEL(base) BOARD_USDHC_SDCARD_VSELECT_INIT(base)
/* mmc card vselect */
#define SDMMCHOST_INIT_MMC_VSEL(base) BOARD_USDHC_MMCCARD_VSELECT_INIT(base)
/* sd card reset pin*/
#define SDMMCHOST_INIT_SD_RESET(base) BOARD_USDHC_SDCARD_RESET_CONTROL_INIT(base)
#define SDMMCHOST_SET_SD_RESET(base, enable) BOARD_USDHC_SDCARD_RESET_CONTROL(base, enable)
/* mmc card reset pin*/
#define SDMMCHOST_INIT_MMC_RESET(base) BOARD_USDHC_MMCCARD_RESET_CONTROL_INIT(base)
#define SDMMCHOST_SET_MMC_RESET(base, enable) BOARD_USDHC_MMCCARD_RESET_CONTROL(base, enable)
