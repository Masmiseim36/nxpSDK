...
typedef enum _clock_name
{
    ...
    kCLOCK_EnetPllClk0 = 0x12U,        /*!< Enet PLLCLK ref_enetpll0. */
    kCLOCK_EnetPllClk1 = 0x13U,        /*!< Enet PLLCLK ref_enetpll1. */
    kCLOCK_EnetPllRefClk25Mhz = 0x14U, /*!< Enet PLLCLK ref_enetpll1. */
...
typedef enum _clock_ip_name
{
    ...
    /* CCM CCGR4 */
    kCLOCK_SimM7RegAcc = (4U << 8U) | CCM_CCGR4_CG0_SHIFT, /*!< CCGR4, CG0   */
    ...
    kCLOCK_AxbsI = (7U << 8U) | CCM_CCGR7_CG2_SHIFT,    /*!< CCGR7, CG2   */
    kCLOCK_CanFdS = (7U << 8U) | CCM_CCGR7_CG3_SHIFT,   /*!< CCGR7, CG3   */
    kCLOCK_AipsLite = (7U << 8U) | CCM_CCGR7_CG4_SHIFT, /*!< CCGR7, CG4   */
    kCLOCK_Flexio3 = (7U << 8U) | CCM_CCGR7_CG5_SHIFT,  /*!< CCGR7, CG5   */
                                                        /*!< CCGR7, CG6, Reserved  */
                                                        /*!< CCGR7, CG7, Reserved  */
                                                        /*!< CCGR7, CG8, Reserved  */
                                                        /*!< CCGR7, CG9, Reserved  */
...
typedef struct _clock_enet_pll_config
{
    ...
    uint8_t loopDivider1;      /*!< Controls the frequency of the ENET1 reference clock.
                                    ...
                                    b10 100MHz (not 50% duty cycle)
                                    b11 125MHz */
    uint8_t refclk25MhzEnable; /*!< clock enable */
...
typedef enum _clock_pll
{
    ...
    kCLOCK_PllEnetClk0 = CCM_ANALOG_TUPLE(PLL_ENET, 13),                              /*!< PLL Enet0 */
    kCLOCK_PllEnetClk1 = CCM_ANALOG_TUPLE(PLL_ENET, 20),                              /*!< PLL Enet1 */
    kCLOCK_PllEnetRefClk25Mhz = CCM_ANALOG_TUPLE(PLL_ENET, 21),                       /*!< PLL Enet1 */
...
{
    CCM_ANALOG_TUPLE_REG(base, pll) |=
        (CCM_ANALOG_TUPLE_REG(base, pll) & (~CCM_ANALOG_PLL_ARM_BYPASS_CLK_SRC_MASK)) | src;
}
...
{
    return (((CCM_ANALOG_TUPLE_REG(base, pll) & CCM_ANALOG_PLL_ARM_BYPASS_CLK_SRC_MASK) >>
             CCM_ANALOG_PLL_ARM_BYPASS_CLK_SRC_SHIFT) == kCLOCK_PllBypassClkSrc24M) ?
               CLOCK_GetOscFreq() :
               CLKPN_FREQ;
}
