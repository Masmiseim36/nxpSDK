...
static void bootloader_init(void)
{
    ...
    debug_printf("\r\n\r\nRunning bootloader...\r\n");
#ifdef __ICCARM__
#define TOOLCHAIN "IAR EWARM"
#elif (defined(__CC_ARM) || defined(__ARMCC_VERSION))
#define TOOLCHAIN "ARMCC/ARMCLANG"
#else
...
static void bootloader_run(void)
{
    ...
    debug_printf("    b) blhost <peripheral> -- fill-memory 0x1c000  4 0xc0403001\r\n");
    debug_printf("    c) blhost <peripheral> --  configure-memory 0x9 0x1c000 \r\n");
    debug_printf("    d) blhost <peripheral> --  flash-erase-region <addr> <length> \r\n");
    debug_printf("    e) blhost <peripheral> --  write-memory <addr> <ota-application file> \r\n");
