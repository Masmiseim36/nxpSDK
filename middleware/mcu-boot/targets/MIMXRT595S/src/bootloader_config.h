...
// The FLASH is a Octal FLASH which support from Macronix, connected via PORTA
#define BL_FLEXSPI_NOR_CFG_BLOCK_OFFSET (0x400u)
#if !defined(BL_FLEXSPI_NOR_CFG_BLOCK) || (BL_FLLEXSPI_NOR_CFG_BLOCK == 0)
#define BL_FLEXSPI_NOR_CFG_OPT0 (0xc0403002u)
#define BL_FLEXSPI_NOR_CFG_OPT1 (0x00000000u)
#endif
