...
#define UART2_RX_FUNC_ALT_MODE 3 // ALT mode for UART1 RX functionality
#define UART2_RX_GPIO_ALT_MODE 1 // ALT mdoe for GPIO functionality
...
#define UART2_TX_FUNC_ALT_MODE 3 // ALT mode for UART1 TX functionality
#elif defined(FREEDOM)
#define UART0_RX_PORT_BASE PORTB
#define UART0_RX_GPIO_BASE PTB
#define UART0_RX_GPIO_PIN_NUM 16 // PTB16
#define UART0_RX_FUNC_ALT_MODE 3 // ALT mode for UART1 RX functionality
...
#define UART0_TX_FUNC_ALT_MODE 3 // ALT mode for UART1 TX functionality
#else                            // flashloader
#define UART4_RX_PORT_BASE PORTE
#define UART4_RX_GPIO_BASE PTE
#define UART4_RX_GPIO_PIN_NUM 25 // PTE25
#define UART4_RX_FUNC_ALT_MODE 3 // ALT mode for UART1 RX functionality
...
#define UART4_TX_FUNC_ALT_MODE 3 // ALT mode for UART1 TX functionality
#endif                           // TOWER
...
#define I2C0_SCL_FUNC_ALT_MODE 2 // ALT mode for I2C1 SCL functionality
#define I2C0_SDA_PORT_BASE PORTD
#define I2C0_SDA_GPIO_PIN_NUM 9  // PTD9
#define I2C0_SDA_FUNC_ALT_MODE 2 // ALT mode for I2C1 SDA functionality
#endif                           // FREEDOM
...
#define SPI0_PCS_FUNC_ALT_MODE 2 // ALT mode for SPI1 PCS functionality
#define SPI0_SCK_PORT_BASE PORTD
#define SPI0_SCK_GPIO_PIN_NUM 1  // PTD1
#define SPI0_SCK_FUNC_ALT_MODE 2 // ALT mode for SPI1 SCK functionality
#define SPI0_SOUT_PORT_BASE PORTD
#define SPI0_SOUT_GPIO_PIN_NUM 2  // PTD2
#define SPI0_SOUT_FUNC_ALT_MODE 2 // ALT mode for SPI1 SOUT functionality
#define SPI0_SIN_PORT_BASE PORTD
#define SPI0_SIN_GPIO_PIN_NUM 3  // PTD3
#define SPI0_SIN_FUNC_ALT_MODE 2 // ALT mode for SPI1 SIN functionality
#else
#define SPI2_PCS_PORT_BASE PORTD
#define SPI2_PCS_GPIO_PIN_NUM 11 // PTD11
#define SPI2_PCS_FUNC_ALT_MODE 2 // ALT mode for SPI1 PCS functionality
#define SPI2_SCK_PORT_BASE PORTD
#define SPI2_SCK_GPIO_PIN_NUM 12 // PTD12
#define SPI2_SCK_FUNC_ALT_MODE 2 // ALT mode for SPI1 SCK functionality
#define SPI2_SOUT_PORT_BASE PORTD
#define SPI2_SOUT_GPIO_PIN_NUM 13 // PTD13
#define SPI2_SOUT_FUNC_ALT_MODE 2 // ALT mode for SPI1 SOUT functionality
#define SPI2_SIN_PORT_BASE PORTD
#define SPI2_SIN_GPIO_PIN_NUM 14 // PTD14
#define SPI2_SIN_FUNC_ALT_MODE 2 // ALT mode for SPI1 SIN functionality
#endif
