...
#define USB_DEVICE_CONFIG_EHCI (BL_CONFIG_HS_USB_HID | BL_CONFIG_HS_USB_MSC)
...
#define USB_DEVICE_CONFIG_HID (BL_CONFIG_USB_HID + BL_CONFIG_HS_USB_HID)

/*! @brief CDC ACM instance count */
#define USB_DEVICE_CONFIG_CDC_ACM (0U)

/*! @brief MSC instance count */
#define USB_DEVICE_CONFIG_MSC (BL_CONFIG_USB_MSC + BL_CONFIG_HS_USB_MSC)
