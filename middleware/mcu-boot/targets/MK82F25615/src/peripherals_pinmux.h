...
#define UART4_RX_PORT_BASE PORTC
#define UART4_RX_GPIO_BASE GPIOC
#define UART4_RX_GPIO_PIN_NUM 14               // PTC14
#define UART4_RX_FUNC_ALT_MODE kPORT_MuxAlt3   // ALT mode for UART4 RX
#define UART4_RX_GPIO_ALT_MODE kPORT_MuxAsGpio // ALT mdoe for GPIO
#define UART4_RX_GPIO_IRQn PORTC_IRQn
#define UART4_RX_GPIO_IRQHandler PORTC_IRQHandler
#define UART4_TX_PORT_BASE PORTC
#define UART4_TX_GPIO_PIN_NUM 15             // PTC15
#define UART4_TX_FUNC_ALT_MODE kPORT_MuxAlt3 // ALT mode for UART4 TX
