...
typedef struct _sd_user_config
{
    ...
    uint32_t powerDownDelay_US;   /*!< SD power power up delay time */
    uint32_t powerUpDelay_US;     /*!< SD power power down time */
    bool enablePowerCycle;        /*!< execute power cycle before initialization */
    bool powerPolarity;           /*!< SD power control polarity, false for low-disable, true for high-disable */
    uint32_t tuningStart;         /*!< Tuning start dll delay */
    uint32_t tuningStep;          /*!< Tuning step dll delay */
} sd_user_config_t;
