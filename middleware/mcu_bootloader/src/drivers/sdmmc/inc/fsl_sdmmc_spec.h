 ...
 * Definitions
 ******************************************************************************/
/*! @brief SD/MMC card compatible initialization clock frequency */
#define SDMMC_CLOCK_300KHZ (300000U)
...
typedef enum _mmc_boot_data_bus_width
{
...
typedef struct _mmc_boot_config
{
    ...
    mmc_boot_data_bus_width_t bootDataBusWidth; /*!< Boot data bus width */
    bool retainBootbusCondition;                /*!< If retain boot bus width and boot mode conditions */

    bool updateBootConfigProtection; /*!< Write boot protect configuration into the device */
