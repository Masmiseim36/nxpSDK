...
extern "C"
{
     ...
     */
    static inline void USDHC_EnableInterruptStatus(USDHC_Type *base, uint32_t mask) { base->INT_STATUS_EN |= mask; }
     ...
     */
    static inline void USDHC_DisableInterruptStatus(USDHC_Type *base, uint32_t mask) { base->INT_STATUS_EN &= ~mask; }
     ...
     * @param mask The interrupt status flags mask(_usdhc_interrupt_status_flag).
     */
    static inline void USDHC_EnableInterruptSignal(USDHC_Type *base, uint32_t mask) { base->INT_SIGNAL_EN |= mask; }
     ...
     * @param mask The interrupt status flags mask(_usdhc_interrupt_status_flag).
     */
    static inline void USDHC_DisableInterruptSignal(USDHC_Type *base, uint32_t mask) { base->INT_SIGNAL_EN &= ~mask; }
     ...
     */
    static inline uint32_t USDHC_GetInterruptStatusFlags(USDHC_Type *base) { return base->INT_STATUS; }
     ...
     * @param mask The interrupt status flags mask(_usdhc_interrupt_status_flag).
     */
    static inline void USDHC_ClearInterruptStatusFlags(USDHC_Type *base, uint32_t mask) { base->INT_STATUS = mask; }
     ...
     */
    static inline uint32_t USDHC_GetAdmaErrorStatusFlags(USDHC_Type *base) { return base->ADMA_ERR_STATUS & 0xFU; }
     ...
     */
    static inline uint32_t USDHC_GetPresentStatusFlags(USDHC_Type *base) { return base->PRES_STATE; }
     ...
     */
    static inline void USDHC_WriteData(USDHC_Type *base, uint32_t data) { base->DATA_BUFF_ACC_PORT = data; }
     ...
     */
    static inline uint32_t USDHC_ReadData(USDHC_Type *base) { return base->DATA_BUFF_ACC_PORT; }
     ...
     * @param base USDHC peripheral base address.
     */
    static inline void USDHC_SetContinueRequest(USDHC_Type *base) { base->PROT_CTRL |= USDHC_PROT_CTRL_CREQ_MASK; }
     ...
     */
    static inline void USDHC_SetForceEvent(USDHC_Type *base, uint32_t mask) { base->FORCE_EVENT = mask; }
 ...
 */
     ...
     * @param base USDHC peripheral base address.
     */
    static inline uint32_t USDHC_GetStrobeDLLStatus(USDHC_Type *base) { return base->STROBE_DLL_STATUS; }
