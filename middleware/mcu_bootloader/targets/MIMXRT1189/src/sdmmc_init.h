...
#define BOARD_USDHC1_CLK_FREQ (CLOCK_GetRootClockFreq(kCLOCK_Root_Usdhc1))
#define BOARD_USDHC2_CLK_FREQ (CLOCK_GetRootClockFreq(kCLOCK_Root_Usdhc2))
#else
#define BOARD_USDHC1_CLK_FREQ (FPGA_FREQ_BUS)
#define BOARD_USDHC2_CLK_FREQ (FPGA_FREQ_BUS)
#endif
...
#define BOARD_USDHC1_RESET_B_GPIO_BASE (RGPIO5)
#define BOARD_USDHC1_RESET_B_GPIO_PIN (3)
#define BOARD_USDHC1_RESET_B_GPIO_IOMUXC IOMUXC_GPIO_AD_35_GPIO5_IO03
...
#define BOARD_USDHC2_VSELECT_IOMUXC IOMUXC_GPIO_AD_29_USDHC2_VSELECT
#define BOARD_USDHC2_RESET_B_GPIO_BASE (RGPIO5)
#define BOARD_USDHC2_RESET_B_GPIO_PIN (16)
#define BOARD_USDHC2_RESET_B_GPIO_IOMUXC IOMUXC_GPIO_SD_B2_06_GPIO5_IO16
