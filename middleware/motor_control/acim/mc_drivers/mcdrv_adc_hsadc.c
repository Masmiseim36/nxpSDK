...
bool_t MCDRV_Curr3Ph2ShChanAssignInit(mcdrv_hsadc_t *this)
{
    ...
    /* Aux sampling - select CLIST3 (sample number 9) */
    this->ui16AdcSmplAux = HSADC_CLIST3_SAMPLE9(this->ui16ChanNumAux + 8);
    this->pui32AdcBaseAux->CLIST3 =
        ((this->pui32AdcBaseAux->CLIST3 & ~(uint16_t)HSADC_CLIST3_SAMPLE9_MASK) | this->ui16AdcSmplAux);
...
bool_t MCDRV_AuxValGet(mcdrv_hsadc_t *this)
{
    ...
    *this->pui16AuxChan = (frac16_t)(this->pui32AdcBaseAux->RSLT[9]);
