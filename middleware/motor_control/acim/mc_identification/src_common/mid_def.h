...
#define MID_PWRCHR_CURR_POINT_NUM (65) /* number of points to be measured during characterization [33,65,129,...]. Must match MCAT settings. */
#define MID_PWRCHR_MEASTIME (0.25F) /* time for measurement of single point */
#define MID_PWRCHR_FILTCOEFF (0.0309F) /* error voltage filter coefficient, calculated as 1-exp(-2*pi*smapling_period*filt_freq) */
