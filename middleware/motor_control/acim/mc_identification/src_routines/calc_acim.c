...
void MID_CalcElPar(void)                                 
{
    ...
    fltXNoLoad = g_sMID.sNoLoad.fltQ / (g_sMID.sNoLoad.fltIrms * 
                                       g_sMID.sNoLoad.fltIrms);
    ...
    /* rotor resistance */
    g_sMID.sPar.fltRr = (fltR - g_sMID.sPar.fltRs) * (fltX2 + fltXm) * 
                      (fltX2 + fltXm) / (fltXm * fltXm);
    ...
    /* leakage inductance */
    fltLeak = 1.0F - (g_sMID.sPar.fltLm * g_sMID.sPar.fltLm) / 
             (g_sMID.sPar.fltLs * g_sMID.sPar.fltLr);
    

    /* calculate current controllers parameters */
    g_sMID.sAlgNew.fltIdPIKp = 4.0F * FLOAT_PI * g_sMID.fltFreqCLoop * 
        g_sMID.sPar.fltLs * fltLeak  - g_sMID.sPar.fltRs; 
    g_sMID.sAlgNew.fltIdPIKi = 4.0F * FLOAT_PI * FLOAT_PI * M1_FAST_LOOP_TS *
        g_sMID.fltFreqCLoop * g_sMID.fltFreqCLoop * g_sMID.sPar.fltLs* fltLeak ;  
    ...
    g_sMID.sAlgNew.fltPsiSA1Gain = (0.1591549431F) / 
                                 (0.1591549431F + M1_FAST_LOOP_TS);
    g_sMID.sAlgNew.fltPsiSA2Gain = g_sMID.sAlgNew.fltPsiSA1Gain * 
        M1_FAST_LOOP_TS;
    g_sMID.sAlgNew.fltKrInvGain = g_sMID.sPar.fltLr / g_sMID.sPar.fltLm;
    g_sMID.sAlgNew.fltKrLsTotLeakGain = g_sMID.sAlgNew.fltKrInvGain * 
        g_sMID.sPar.fltLs * fltLeak;
    g_sMID.sAlgNew.fltRsEst = g_sMID.sPar.fltRs;
    g_sMID.sAlgNew.fltGainTrq = (1.5F * g_sMID.sPar.fltPp * g_sMID.sPar.fltLm) / 
                              g_sMID.sPar.fltLr;
    ...
    fltTmp = 2.0F * FLOAT_PI * MID_CALC_FW_BANDWIDTH / (g_sMID.sPar.fltLm *                 
                     g_sMID.sPar.fltRr); 
    g_sMID.sAlgNew.fltFWPIKp = g_sMID.sPar.fltLr * fltTmp;                          /* calculate flux-weakening controller proportional gain */
    g_sMID.sAlgNew.fltFWPIKi = M1_SLOW_LOOP_TS * g_sMID.sPar.fltRr * fltTmp;        /* calculate flux-weakening controller integral gain */
        
    /* prepare mechanical parameters measurement */
    g_sMID.sMech.fltGainTrq = g_sMID.sAlgNew.fltGainTrq * g_sMID.sPar.fltLm * 
                            g_sMID.sAlgNew.fltIdMax;
...
{      
    ...
    g_sMID.sPar.fltJ = g_sMID.sPar.fltPp * g_sMID.sMech.fltTrqInteg * 
        g_sMID.sPar.fltTauMech /(g_sMID.sPar.fltTauMech * (g_sMID.sMech.fltSpdElEnd - 
        g_sMID.sMech.fltSpdElStart) + g_sMID.sMech.fltSpdInteg);
    
    /* speed controller parameters */
    fltTmp = 1.0F / (g_sMID.sAlgNew.fltGainTrq * g_sMID.sPar.fltLm);
    g_sMID.sAlgNew.fltSpdPIKp = MID_CALC_RPM2RAD * (4.0F * FLOAT_PI * 
        g_sMID.fltFreqSLoop - g_sMID.sPar.fltTauMech) * g_sMID.sPar.fltJ * fltTmp;
    g_sMID.sAlgNew.fltSpdPIKi = MID_CALC_RPM2RAD * 4.0F * FLOAT_PI * 
        FLOAT_PI * g_sMID.fltFreqSLoop * g_sMID.fltFreqSLoop * g_sMID.sPar.fltJ *
        M1_SLOW_LOOP_TS * fltTmp;
    ...
    /* scalar control */
    g_sMID.sAlgNew.fltGainSpdMe2PosEl =
        MID_CALC_RPM2RAD * g_sMID.sPar.fltPp * M1_FAST_LOOP_TS;
    g_sMID.sAlgNew.fltGainRpm2Volt = 
       g_sMID.sNoLoad.fltUMeasMax / g_sMID.sAlgNew.fltSpdMeReqMax;  
