...
void MID_getMech(void)
{
    ...
    if(g_sMID.bRotBlocked) return;
    
    /* increment loop counter */
    g_sMID.ui32LoopCntr += 1;
    
    /* filter speed */
    g_sMID.sMech.fltSpdLPF += g_sMID.sMech.fltLPFCoeff * 
        ((*g_sMID.sIO.pfltSpeedEl) - g_sMID.sMech.fltSpdLPF);
    
    /* filter torque */
    g_sMID.sMech.fltTrqLPF += g_sMID.sMech.fltLPFCoeff * 
        ((*g_sMID.sIO.pfltTorque) - g_sMID.sMech.fltTrqLPF); 
    ...
    case kMID_MechDecelerate:
        ...
        {
            *g_sMID.sIO.pfltIdReq = MID_MECH_ID_DECEL_PCT * 
                                  g_sMID.sAlgNew.fltIdStart;
        ...
        {
            g_sMID.sPar.fltTauMech = ((float_t)(g_sMID.ui32LoopCntr - 
                                    (0.05F * M1_MID_TIME_ONESEC))) * 
                                    M1_FAST_LOOP_TS;
            /* end measurement */
            g_sMID.sMech.eState = kMID_MechEndOfMeas;
        }
