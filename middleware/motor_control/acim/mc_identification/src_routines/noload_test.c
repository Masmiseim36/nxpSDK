...
void MID_testNoLoad(void)
{
    ...
    if(g_sMID.ui32LoopCntr < g_sMID.sNoLoad.ui32TimeMeas)
    {
        ...
        g_sMID.sNoLoad.fltUMeasMax += 0.031F*(*g_sMID.sIO.pfltUdReq - 
                                          g_sMID.sNoLoad.fltUMeasMax);
        
        *g_sMID.sIO.pfltUdReq = GFLIB_Ramp_FLT(g_sMID.sNoLoad.fltUMeas, 
                                             &g_sMID.sNoLoad.sUMeasRmpPar);
