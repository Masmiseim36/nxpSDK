...
void MID_GetTrfChar(void)
{
    ...
    g_sMID.sPwrStgCh.pfltUErrLUT[g_sMID.sPwrStgCh.ui16LUTId] += 
        MID_PWRCHR_FILTCOEFF * (*g_sMID.sIO.pfltUdReq - 
        (*g_sMID.sIO.pfltId) * g_sMID.sPwrStgCh.fltRs - 
        g_sMID.sPwrStgCh.pfltUErrLUT[g_sMID.sPwrStgCh.ui16LUTId]);
    ...
    if(g_sMID.ui32LoopCntr >= (MID_PWRCHR_MEASTIME*M1_MID_TIME_ONESEC))
    {
        ...
        if((MLIB_Abs_FLT(*g_sMID.sIO.pfltId) < 
           (g_sMID.sPwrStgCh.fltICal - MID_RS_MIN_CURR)) && 
          (g_sMID.sPwrStgCh.ui16LUTId == 0))
        {
        ...
        if((MLIB_Abs_FLT(*g_sMID.sIO.pfltId) < MID_RS_MIN_CURR) && 
           (g_sMID.sPwrStgCh.ui16LUTId == 0))
        {
        ...
        *g_sMID.sIO.pfltIdReq = g_sMID.sPwrStgCh.fltIReqAct;
        ...
        else g_sMID.sPwrStgCh.pfltUErrLUT[g_sMID.sPwrStgCh.ui16LUTId] = 0.0F;
    }
}
