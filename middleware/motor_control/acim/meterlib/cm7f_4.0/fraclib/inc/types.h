 ...
 ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @brief   Converts double precision
                                                                               *64-bit floating point value to Qn.15
                                                                               *          fractional value.
                                                                               * @details This macro converts double
                                                                               *precision 64-bit floating point value to
                                                                               *Qn.15 fractional value.
                                                                               * @param   x     Double precision 64-bit
                                                                               *floating point value.
                                                                               * @note    Implemented as an inline
                                                                               *macro.
                                                                               * @see     @ref F16TODBL
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts Qn.15 fractional
                                                                               *value to double precision 64-bit
                                                                               *floating point value.
                                                                               * @details This macro converts Qn.15
                                                                               *fractional value to double precision
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts double precision
                                                                               *64-bit floating point value to Qn.23
                                                                               *          fractional value.
                                                                               * @details This macro converts double
                                                                               *precision 64-bit floating point value to
                                                                               *Qn.23 fractional value.
                                                                               * @param   x     Double precision 64-bit
                                                                               *floating point value.
                                                                               * @note    Implemented as an inline
                                                                               *macro.
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts Qn.23 fractional
                                                                               *value to double precision 64-bit
                                                                               *floating point value.
                                                                               * @details This macro converts Qn.23
                                                                               *fractional value to double precision
                                                                               *          64-bit floating point value.
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts double precision
                                                                               *64-bit floating point value to Qn.31
                                                                               *          fractional value.
                                                                               * @details This macro converts double
                                                                               *precision 64-bit floating point value to
                                                                               *Qn.31 fractional value.
                                                                               * @param   x     Double precision 64-bit
                                                                               *floating point value.
                                                                               * @note    Implemented as an inline
                                                                               *macro.
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts Qn.31 fractional
                                                                               *value to double precision 64-bit
                                                                               *floating point value.
                                                                               * @details This macro converts Qn.31
                                                                               *fractional value to double precision
                                                                               *          64-bit floating point value.
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts double precision
                                                                               *64-bit floating point value to Qn.47
                                                                               *          fractional value.
                                                                               * @details This macro converts double
                                                                               *precision 64-bit floating point value to
                                                                               *Qn.47 fractional value.
                                                                               * @param   x     Double precision 64-bit
                                                                               *floating point value.
                                                                               * @note    Implemented as an inline
                                                                               *macro.
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts Qn.47 fractional
                                                                               *value to double precision 64-bit
                                                                               *floating point value.
                                                                               * @details This macro converts Qn.47
                                                                               *fractional value to double precision
                                                                               *          64-bit floating point value.
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts double precision
                                                                               *64-bit floating point value to Q0.63
                                                                               *          fractional value.
                                                                               * @details This macro converts double
                                                                               *precision 64-bit floating point value to
                                                                               *the Q0.63 fractional value.
                                                                               * @param   x     Double precision 64-bit
                                                                               *floating point value.
                                                                               * @note    Note that this macro doesn't
                                                                               *work correctly for floating point values
                                                                               *close to 1.0 and -1.0. Implemented as an
                                                                               *inline macro.
                                                                               * @see     @ref F64TODBL
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               * @brief   Converts Q0.63 fractional
                                                                               *value to double precision 64-bit
                                                                               *floating point value.
                                                                               * @details This macro converts Q0.63
                                                                               *fractional value to double precision
                                                                               *          64-bit floating point value.
