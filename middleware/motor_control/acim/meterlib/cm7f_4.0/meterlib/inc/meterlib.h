 ...
 ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @brief   Return fine delay of the
                                                                               *active energy pulse output transition
                                                                               *          scaled to the computation step
                                                                               *(1/KWH_CALC_FREQ).
                                                                               * @param   p     Pointer to either
                                                                               *tMETERLIB1PH_DATA, tMETERLIB2PH_DATA or
                                                                               *                tMETERLIB3PH_DATA
                                                                               *structure.
                                                                               * @return  If raw pulse output state
                                                                               *changes then this macro returns fine
                                                                               *delay in range from 0x0000 to 0x7fff
                                                                               *otherwise 0x8000. The raw pulse output
                                                                               *state can be read by @ref
                                                                               *METERLIB_KWH_PS macro.
                                                                               ******************************************************************************/
#define METERLIB_KWH_PD(p) (frac16)(p)->wh.puDly

/***************************************************************************/ /*!
                                                                               * @brief   Return raw state of the active
                                                                               *energy pulse output.
                                                                               * @param   p     Pointer to either
                                                                               *tMETERLIB1PH_DATA, tMETERLIB2PH_DATA or
                                                                               *                tMETERLIB3PH_DATA
                                                                               *structure.
                                                                               * @return  If raw pulse output state
                                                                               *changes then @ref METERLIB_KWH_PD macro
                                                                               *          returns fine delay in range
                                                                               *from 0x0000 to 0x7fff otherwise 0x8000.
                                                                               ******************************************************************************/
#define METERLIB_KWH_PS(p) (int)(p)->wh.puOut

/***************************************************************************/ /*!
                                                                               * @brief   Return fine delay of the
                                                                               *reactive energy pulse output transition
                                                                               *          scaled to the computation step
                                                                               *(1/KVARH_CALC_FREQ).
                                                                               * @param   p     Pointer to either
                                                                               *tMETERLIB1PH_DATA, tMETERLIB2PH_DATA or
                                                                               ...
                                                                               *otherwise 0x8000. The raw pulse output
                                                                               *state can be read by @ref
                                                                               *METERLIB_KVARH_PS macro.
                                                                               ******************************************************************************/
#define METERLIB_KVARH_PD(p) (frac16)(p)->varh.puDly

/***************************************************************************/ /*!
                                                                               * @brief   Return raw state of the
                                                                               ...
                                                                               *structure.
                                                                               * @return  If raw pulse output state
                                                                               *changes then @ref METERLIB_KVARH_PD
                                                                               *macro returns fine delay in range from
                                                                               *0x0000 to 0x7fff otherwise 0x8000.
                                                                               ******************************************************************************/
#define METERLIB_KVARH_PS(p) (int)(p)->varh.puOut

/***************************************************************************/ /*!
                                                                               * @brief   Convert imp/kWh to pulse
                                                                               *output resolution required by the
                                                                               *metering library.
                                                                               * @param   x     imp/kWh.
...
/***************************************************************************/ /*!
                                                                               * @brief   Convert U-I phase shift in
                                                                               *degrees to a 16-bit fractional number
                                                                               *with resolution of
                                                                               *fn*360/(32768*KWH_CALC_FREQ) degrees.
                                                                               * @param   x     U-I phase shift in
                                                                               *degrees.
                                                                               * @param   fn    Nominal frequency in
                                                                               *Hertz.
                                                                               * @see     @ref METERLIB1PH_ProcSamples,
                                                                               *@ref METERLIB2PH_ProcSamples,
...
/***************************************************************************/ /*!
                                                                               * @brief   Convert U-I phase shift in
                                                                               *radians to a 16-bit fractional number
                                                                               *with resolution of
...
/***************************************************************************/ /*!
                                                                               * @brief   Convert imp/kVARh to pulse
                                                                               *output resolution required by the
                                                                               *metering library.
                                                                               * @param   x     imp/kVARh.
 ...
 ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @brief   Remove DC bias from phase
                                                                               *voltage and phase current samples
                                                                               *together with performing an optional
                                                                               *sensor phase shift correction.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @param   u1Q   Instantaneous voltage
                                                                               *sample in 24-bit data format.
                                                                               * @param   i1Q   Instantaneous current
                                                                               *sample in 24-bit data format.
                                                                               * @param   shift Pointer to value for U-I
                                                                               *phase shift correction. Set value in
                                                                               *                range -32768...32767 to
                                                                               *phase shift the voltage with resolution
                                                                               *                1/(32768*KWH_CALC_FREQ)
                                                                               *seconds. Use NULL pointer to disable
                                                                               *                software sensor phase
                                                                               *shift correction.
                                                                               * @note    The @ref
                                                                               *METERLIB1PH_ProcSamples function must be
                                                                               *called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB1PH_ProcSamples(tMETERLIB1PH_DATA *p, frac24 u1Q, frac24 i1Q, frac16 *shift);

/***************************************************************************/ /*!
                                                                               * @brief   Recalculate active energy
                                                                               *using new voltage and current samples.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @param   pCnt  Pointer to LCD counters
                                                                               *representing active energy.
                                                                               * @param   puRes Resolution of pulse
                                                                               *output (calculated by @ref
                                                                               *METERLIB_KWH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIB1PH_CalcWattHours function must
                                                                               *be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB1PH_CalcWattHours(tMETERLIB1PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @param   pCnt  Pointer to LCD counters
                                                                               *representing reactive energy.
                                                                               * @param   puRes Resolution of pulse
                                                                               *output (calculated by @ref
                                                                               *METERLIB_KVARH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIB1PH_CalcVarHours function must
                                                                               *be called at frequency defined by
                                                                               *KVARH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB1PH_CalcVarHours(tMETERLIB1PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);

/***************************************************************************/ /*!
                                                                               * @brief   Recalculate URMS, IRMS, PAVG,
                                                                               *QAVG and S auxiliary quantities.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIB1PH_CalcAuxiliary function must
                                                                               *be called at the frequency defined by
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @note    The @ref METERLIB1PH_CalcURMS
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @note    The @ref METERLIB1PH_CalcIRMS
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @note    The @ref METERLIB1PH_CalcPAVG
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               * @brief   Read URMS, IRMS, PAVG, QAVG
                                                                               *and S auxiliary quantities.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB1PH_DATA structure.
                                                                               * @param   urms  Pointer to phase voltage
                                                                               *RMS value in Volts.
                                                                               * @param   irms  Pointer to phase current
                                                                               *RMS value in Amperes.
                                                                               * @param   pavg  Pointer to active power
                                                                               *in Watts.
                                                                               * @param   qavg  Pointer to reactive
                                                                               *power in Volt-amperes reactive.
                                                                               * @param   s     Pointer to apparent
                                                                               *power in Volt-amperes.
                                                                               * @note    The IRMS, PAVG, QAVG and S
                                                                               *quantities are zeroed if either of
                                                                               *powers is below the power sense
                                                                               *threshold or rms current is below
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB1PH_ReadResults(
    tMETERLIB1PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   irms  Pointer to phase current
                                                                               *RMS value in Amperes.
                                                                               * @note    The IRMS value is not zeroed
                                                                               *below starting current threshold.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   pavg  Pointer to active power
                                                                               *in Watts.
                                                                               * @note    The PAVG value is not zeroed
                                                                               *below power sense threshold.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   s     Pointer to apparent
                                                                               *power in Volt-amperes reactive.
                                                                               * @note    The @ref METERLIB1PH_ReadS
                                                                               *function returns apparent power. The S
                                                                               *value is not zeroed below power sense
                                                                               *threshold.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *sensor phase shift correction.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   u1Q   Instantaneous voltage
                                                                               *sample in 24-bit data format.
                                                                               * @param   i1Q   Instantaneous current
                                                                               *sample in 24-bit data format.
                                                                               * @param   u2Q   Instantaneous voltage
                                                                               *sample in 24-bit data format.
                                                                               * @param   i2Q   Instantaneous current
                                                                               *sample in 24-bit data format.
                                                                               * @param   shift Pointer to two values
                                                                               *for U-I phase shift correction. Set each
                                                                               *                value in range
                                                                               *-32768...32767 to phase shift the
                                                                               *voltage with resolution of
                                                                               *1/(32768*KWH_CALC_FREQ) seconds. Use
                                                                               *NULL pointer to disable software sensor
                                                                               *phase shift correction.
                                                                               * @note    The @ref
                                                                               *METERLIB2PH_ProcSamples function must be
                                                                               *called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB2PH_ProcSamples(
    tMETERLIB2PH_DATA *p, frac24 u1Q, frac24 i1Q, frac24 u2Q, frac24 i2Q, frac16 *shift);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIB_KWH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIB2PH_CalcWattHours function must
                                                                               *be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB2PH_CalcWattHours(tMETERLIB2PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIB_KVARH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIB2PH_CalcVarHours function must
                                                                               *be called at frequency defined by
                                                                               *KVARH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB2PH_CalcVarHours(tMETERLIB2PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIB2PH_CalcAuxiliary function must
                                                                               *be called at the frequency defined by
                                                                               *ratio KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @note    The @ref METERLIB2PH_CalcURMS
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @note    The @ref METERLIB2PH_CalcIRMS
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @note    The @ref METERLIB2PH_CalcPAVG
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               * @brief   Read URMS, IRMS, PAVG, QAVG
                                                                               *and S auxiliary quantities from phase 1.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   urms  Pointer to phase voltage
                                                                               *RMS value in Volts.
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB2PH_ReadResultsPh1(
    tMETERLIB2PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);

/***************************************************************************/ /*!
                                                                               * @brief   Read URMS, IRMS, PAVG, QAVG
                                                                               *and S auxiliary quantities from phase 2.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   urms  Pointer to phase voltage
                                                                               *RMS value in Volts.
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB2PH_ReadResultsPh2(
    tMETERLIB2PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   urms1 Pointer to phase 1
                                                                               *voltage RMS value in Volts.
                                                                               * @param   urms2 Pointer to phase 2
                                                                               *voltage RMS value in Volts.
                                                                               ******************************************************************************/
extern void METERLIB2PH_ReadURMS(tMETERLIB2PH_DATA *p, double *urms1, double *urms2);

/***************************************************************************/ /*!
                                                                               * @brief   Read IRMS.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   irms1 Pointer to phase 1
                                                                               *current RMS value in Amperes.
                                                                               * @param   irms2 Pointer to phase 2
                                                                               *current RMS value in Amperes.
                                                                               * @note    The IRMS values are not zeroed
                                                                               *below starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB2PH_ReadIRMS(tMETERLIB2PH_DATA *p, double *irms1, double *irms2);

/***************************************************************************/ /*!
                                                                               * @brief   Read PAVG.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   pavg1 Pointer to phase 1
                                                                               *active power in Watts.
                                                                               * @param   pavg2 Pointer to phase 2
                                                                               *active power in Watts.
                                                                               * @note    The PAVG values are not zeroed
                                                                               *below power sense threshold.
                                                                               ******************************************************************************/
extern void METERLIB2PH_ReadPAVG(tMETERLIB2PH_DATA *p, double *pavg1, double *pavg2);

/***************************************************************************/ /*!
                                                                               * @brief   Calculate and read S.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB2PH_DATA structure.
                                                                               * @param   s1    Pointer to phase 1
                                                                               *apparent power in Volt-amperes reactive.
                                                                               * @param   s2    Pointer to phase 2
                                                                               *apparent power in Volt-amperes reactive.
                                                                               * @note    The @ref METERLIB2PH_ReadS
                                                                               *function returns apparent powers. The S
                                                                               *values are not zeroed below power sense
                                                                               *threshold.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               * @brief   Remove DC bias from phase
                                                                               *voltage and phase current samples
                                                                               *together with determining the phase
                                                                               *sequence and performing an optional
                                                                               *sensor phase shift correction.
                                                                               * @param   p     Pointer to
                                                                               ...
                                                                               * @param   i2Q   Instantaneous current
                                                                               *sample in 24-bit data format.
                                                                               * @param   u3Q   Instantaneous voltage
                                                                               *sample in 24-bit data format.
                                                                               * @param   i3Q   Instantaneous current
                                                                               *sample in 24-bit data format.
                                                                               * @param   shift Pointer to three values
                                                                               *for U-I phase shift correction. Set each
                                                                               *                value in range
                                                                               *-32768...32767 to phase shift the
                                                                               *voltage with resolution of
                                                                               ...
                                                                               *NULL pointer to disable software sensor
                                                                               *phase shift correction.
                                                                               * @return   1    Phase sequence 1-2-3
                                                                               *(clockwise rotation). 0    Phase
                                                                               *sequence not detected. -1    Phase
                                                                               *sequence 3-2-1 (counter-clockwise
                                                                               *rotation).
                                                                               * @note    The @ref
                                                                               *METERLIB3PH_ProcSamples function must be
                                                                               *called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern int METERLIB3PH_ProcSamples(
    tMETERLIB3PH_DATA *p, frac24 u1Q, frac24 i1Q, frac24 u2Q, frac24 i2Q, frac24 u3Q, frac24 i3Q, frac16 *shift);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIB_KWH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIB3PH_CalcWattHours function must
                                                                               *be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB3PH_CalcWattHours(tMETERLIB3PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIB_KVARH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIB3PH_CalcVarHours function must
                                                                               *be called at frequency defined by
                                                                               *KVARH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIB3PH_CalcVarHours(tMETERLIB3PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIB3PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIB3PH_CalcAuxiliary function must
                                                                               *be called at the frequency defined by
                                                                               *ratio KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB3PH_DATA structure.
                                                                               * @note    The @ref METERLIB3PH_CalcURMS
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB3PH_DATA structure.
                                                                               * @note    The @ref METERLIB3PH_CalcIRMS
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB3PH_DATA structure.
                                                                               * @note    The @ref METERLIB3PH_CalcPAVG
                                                                               *function must be called at the frequency
                                                                               *defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadResultsPh1(
    tMETERLIB3PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadResultsPh2(
    tMETERLIB3PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);

/***************************************************************************/ /*!
                                                                               * @brief   Read URMS, IRMS, PAVG, QAVG
                                                                               *and S auxiliary quantities from phase 3.
                                                                               * @param   p     Pointer to
                                                                               *tMETERLIB3PH_DATA structure.
                                                                               * @param   urms  Pointer to phase voltage
                                                                               *RMS value in Volts.
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadResultsPh3(
    tMETERLIB3PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   urms2 Pointer to phase 2
                                                                               *voltage RMS value in Volts.
                                                                               * @param   urms3 Pointer to phase 3
                                                                               *voltage RMS value in Volts.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadURMS(tMETERLIB3PH_DATA *p, double *urms1, double *urms2, double *urms3);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   irms2 Pointer to phase 2
                                                                               *current RMS value in Amperes.
                                                                               * @param   irms3 Pointer to phase 3
                                                                               *current RMS value in Amperes.
                                                                               * @note    The IRMS values are not zeroed
                                                                               *below starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadIRMS(tMETERLIB3PH_DATA *p, double *irms1, double *irms2, double *irms3);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   pavg2 Pointer to phase 2
                                                                               *active power in Watts.
                                                                               * @param   pavg3 Pointer to phase 3
                                                                               *active power in Watts.
                                                                               * @note    The PAVG values are not zeroed
                                                                               *below power sense threshold.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadPAVG(tMETERLIB3PH_DATA *p, double *pavg1, double *pavg2, double *pavg3);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   s2    Pointer to phase 2
                                                                               *apparent power in Volt-amperes reactive.
                                                                               * @param   s3    Pointer to phase 3
                                                                               *apparent power in Volt-amperes reactive.
                                                                               * @note    The @ref METERLIB3PH_ReadS
                                                                               *function returns apparent powers. The S
                                                                               *values are not zeroed below power sense
                                                                               *threshold.
                                                                               ******************************************************************************/
extern void METERLIB3PH_ReadS(tMETERLIB3PH_DATA *p, double *s1, double *s2, double *s3);

/***************************************************************************/ /*!
                                                                               * @example   meterlib1ph_test.c
                                                                               * Example I. This example demonstrates
                                                                               *use of the metering library in typical
                                                                               * one-phase power meter application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib2ph_test.c
                                                                               * Example II. This example demonstrates
                                                                               *use of the metering library in typical
                                                                               * two-phase power meter application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib3ph_test.c
                                                                               * Example III. This example demonstrates
                                                                               *use of the metering library in typical
                                                                               * polyphase power meter application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib1phrc_test.c
                                                                               * Example IV. This example demonstrates
                                                                               *use of the metering library in typical
                                                                               * one-phase power meter application with
                                                                               *Rogowski coil sensor.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib2phrc_test.c
                                                                               * Example V. This example demonstrates
                                                                               *use of the metering library in typical
                                                                               * two-phase power meter application with
                                                                               *Rogowski coil sensor.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib3phrc_test.c
                                                                               * Example VI. This example demonstrates
                                                                               *use of the metering library in typical
                                                                               * polyphase power meter application with
                                                                               *Rogowski coil sensor.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib1phkwh_test.c
                                                                               * Example VII. This example demonstrates
                                                                               *use of the metering library in active
                                                                               * energy one-phase power meter
                                                                               *application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               * @example   meterlib2phkwh_test.c
                                                                               * Example VIII. This example demonstrates
                                                                               *use of the metering library in active
                                                                               * energy two-phase power meter
                                                                               *application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
