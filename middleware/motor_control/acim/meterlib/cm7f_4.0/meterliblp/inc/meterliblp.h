...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP1PH_DATA, tMETERLIBLP2PH_DATA
                                                                               *or tMETERLIBLP3PH_DATA structure.
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *or tMETERLIBLP3PH_DATA structure.
                                                                               * @return  If raw pulse output state
                                                                               *changes then @ref METERLIBLP_KWH_PD
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *or tMETERLIBLP3PH_DATA structure.
                                                                               * @return  If raw pulse output state
                                                                               *changes then @ref METERLIBLP_KVARH_PD
                                                                               *macro returns fine delay in range from
                                                                               *0x0000 to 0x7fff otherwise 0x8000.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *Hertz.
                                                                               * @see     @ref
                                                                               *METERLIBLP1PH_ProcSamples, @ref
                                                                               *METERLIBLP2PH_ProcSamples,
                                                                               *          @ref
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_ProcSamples function must
                                                                               *be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP1PH_ProcSamples(tMETERLIBLP1PH_DATA *p, frac24 u1Q, frac24 i1Q, frac16 *shift);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIBLP_KWH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_CalcWattHours function
                                                                               *must be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP1PH_CalcWattHours(tMETERLIBLP1PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIBLP_KVARH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_CalcVarHours function must
                                                                               *be called at frequency defined by
                                                                               *KVARH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP1PH_CalcVarHours(tMETERLIBLP1PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP1PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_CalcAuxiliary function
                                                                               *must be called at the frequency defined
                                                                               *by KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP1PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_CalcURMS function must be
                                                                               *called at the frequency defined by ratio
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP1PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_CalcIRMS function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP1PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP1PH_CalcPAVG function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               ******************************************************************************/
extern void METERLIBLP1PH_ReadResults(
    tMETERLIBLP1PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               * @param   s     Pointer to apparent
                                                                               *power in Volt-amperes reactive.
                                                                               * @note    The @ref METERLIBLP1PH_ReadS
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *phase shift correction.
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_ProcSamples function must
                                                                               *be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_ProcSamples(
    tMETERLIBLP2PH_DATA *p, frac24 u1Q, frac24 i1Q, frac24 u2Q, frac24 i2Q, frac16 *shift);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIBLP_KWH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_CalcWattHours function
                                                                               *must be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_CalcWattHours(tMETERLIBLP2PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIBLP_KVARH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_CalcVarHours function must
                                                                               *be called at frequency defined by
                                                                               *KVARH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_CalcVarHours(tMETERLIBLP2PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP2PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_CalcAuxiliary function
                                                                               *must be called at the frequency defined
                                                                               *by ratio KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP2PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_CalcURMS function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP2PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_CalcIRMS function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP2PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP2PH_CalcPAVG function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_ReadResultsPh1(
    tMETERLIBLP2PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_ReadResultsPh2(
    tMETERLIBLP2PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *voltage RMS value in Volts.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_ReadURMS(tMETERLIBLP2PH_DATA *p, double *urms1, double *urms2);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *below starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_ReadIRMS(tMETERLIBLP2PH_DATA *p, double *irms1, double *irms2);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *below power sense threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP2PH_ReadPAVG(tMETERLIBLP2PH_DATA *p, double *pavg1, double *pavg2);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *apparent power in Volt-amperes reactive.
                                                                               * @note    The @ref METERLIBLP2PH_ReadS
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *rotation).
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_ProcSamples function must
                                                                               *be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern int METERLIBLP3PH_ProcSamples(
    tMETERLIBLP3PH_DATA *p, frac24 u1Q, frac24 i1Q, frac24 u2Q, frac24 i2Q, frac24 u3Q, frac24 i3Q, frac16 *shift);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIBLP_KWH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_CalcWattHours function
                                                                               *must be called at frequency defined by
                                                                               *KWH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_CalcWattHours(tMETERLIBLP3PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *METERLIBLP_KVARH_PD)
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_CalcVarHours function must
                                                                               *be called at frequency defined by
                                                                               *KVARH_CALC_FREQ.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_CalcVarHours(tMETERLIBLP3PH_DATA *p, tENERGY_CNT *pCnt, frac64 puRes);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP3PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_CalcAuxiliary function
                                                                               *must be called at the frequency defined
                                                                               *by ratio KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP3PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_CalcURMS function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP3PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_CalcIRMS function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *tMETERLIBLP3PH_DATA structure.
                                                                               * @note    The @ref
                                                                               *METERLIBLP3PH_CalcPAVG function must be
                                                                               *called at the frequency defined by ratio
                                                                               *KWH_CALC_FREQ/DECIM_FACTOR.
                                                                               ******************************************************************************/
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadResultsPh1(
    tMETERLIBLP3PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadResultsPh2(
    tMETERLIBLP3PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadResultsPh3(
    tMETERLIBLP3PH_DATA *p, double *urms, double *irms, double *pavg, double *qavg, double *s);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *voltage RMS value in Volts.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadURMS(tMETERLIBLP3PH_DATA *p, double *urms1, double *urms2, double *urms3);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *below starting current threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadIRMS(tMETERLIBLP3PH_DATA *p, double *irms1, double *irms2, double *irms3);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *below power sense threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadPAVG(tMETERLIBLP3PH_DATA *p, double *pavg1, double *pavg2, double *pavg3);
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *apparent power in Volt-amperes reactive.
                                                                               * @note    The @ref METERLIBLP3PH_ReadS
                                                                               *function returns apparent powers. The S
                                                                               *values are not zeroed below power sense
                                                                               *threshold.
                                                                               ******************************************************************************/
extern void METERLIBLP3PH_ReadS(tMETERLIBLP3PH_DATA *p, double *s1, double *s2, double *s3);

/***************************************************************************/ /*!
                                                                               * @example   meterliblp1ph_test.c
                                                                               * Example I. This example demonstrates
                                                                               *use of the low power metering library in
                                                                               *typical one-phase power meter
                                                                               *application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
...
/***************************************************************************/ /*!
                                                                               ...
                                                                               *use of the low power metering library in
                                                                               *active energy one-phase power meter
                                                                               *application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               ...
                                                                               *use of the low power metering library in
                                                                               *active energy two-phase power meter
                                                                               *application.
                                                                               ******************************************************************************/
/***************************************************************************/ /*!
                                                                               ...
                                                                               *use of the low power metering library in
                                                                               *active energy polyphase power meter
                                                                               *application.
                                                                               ******************************************************************************/
