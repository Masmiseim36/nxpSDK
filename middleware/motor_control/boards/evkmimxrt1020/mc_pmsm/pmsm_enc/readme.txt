...
Boards settings
===============
Before you connect the MIMXRT1020-EVK board with FRDM-MC-LVPMSM ensures that the jumpers are configured according to the documentation available on http://www.nxp.com/motorcontrol_pmsm.

For correct signal connection and proper demo working, it is necessary to solder/remove resistors from the board. Please, see the documentation (http://www.nxp.com/motorcontrol_pmsm) and MIMXRT1020-EVK board schematic.

The low-voltage evaluation board does not require any hardware configuration or jumper settings as well.

Prepare the Demo
===============
1.  Connect the FRDM-MC-LVPMSM with MIMXRT1020-EVK board through cables according documentation available on (http://www.nxp.com/motorcontrol_pmsm). 
