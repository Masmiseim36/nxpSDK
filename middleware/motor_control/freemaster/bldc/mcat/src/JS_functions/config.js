...
function build_parameter_line( varLabel, varID, varUnit, varComment, inObj, inObjDescr)
{
    ...
    string = string + "<td align=\"left\"  width=\"50%\" style=\"font-family:Arial; font-size:12px; padding-left:0.4cm\"> <label id = \"parText" + varLabel + "\" title=\"" + varComment + "\" >" + varLabel + "</label> </td>";
	 // next column
    ...
    string = string + "<div style=\"float:left; width:10px; margin-bottom: 2px;\"><input type=\"text\" style=\"text-align:right; font-size: 12px; \" id=\"" + varIDprefix + "\" \n\
	 ...
	 // add param unit
    string = string + "<td valign=\"center\" width=\"20%\" style=\"font-family: Arial; font-size: 12px;\">" + varUnitField + "</td>";
...
function build_constant_line( varLabel, varID, valComment)
{
	 var string = "<tr>";
  	...
  	string = string + "<td align=\"left\" width=\"50%\" style=\"font-family: Arial; font-size: 12px; padding-left:0.4cm\"> <label id = \"constText" + varLabel + "\" title=\"" + valComment + "\" >" + varLabel + "</label> </td>";
...
function build_line_with_selector(varLabel, varID,varComment)
{
    ...
    if(getBoardType() == "HVP")
    {
      ...
      string = string + "<option value=\"1\">User HW</option></select></div></td><td colspan=\"2\"></td>";
    }
    ...
    else if(getBoardType() == "FRDM")
    {
      ...
      string = string + "<option value=\"0\">User HW</option></select></div></td><td colspan=\"2\"></td>";
