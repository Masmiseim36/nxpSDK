...
var paramFilePath = './../../../../middleware/motor_control/freemaster/bldc/mcat/param_files/';
...
* @remarks 
*******************************************************************************/       
function conversionMotorsNumber(inPointer)
{
...
function initLoadParamFiles()
{
  ...
  var MotorsNumber_No   = conversionMotorsNumber(MotorsNumber);
