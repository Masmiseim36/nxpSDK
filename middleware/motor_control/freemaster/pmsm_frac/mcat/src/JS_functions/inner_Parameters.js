...
function clickCalculateParam()
{
    ...
    if(document.getElementById("HeaderFileTab") != undefined)
    {
      ...
      setInnerHtmlValueAsText("MOTOR_PP",2,Motor_pp, Motor_pp);
      ...
      setInnerHtmlValueAsText("N_OVERSPEED",0,N_over_sc, Nover);
      ...
      setInnerHtmlValueAsText("E_BLOCK_TRH",0,E_block_sc);
      setInnerHtmlValueAsText("E_BLOCK_PER",2,getParentHtmlValue("E_block_per"));
      
      // DCB voltage IIR filter
      setInnerHtmlValueAsText("UDCB_IIR_B0",7,UDCB_IIR_B0_out,UDCB_IIR_B0_fl);
      setInnerHtmlValueAsText("UDCB_IIR_B1",7,UDCB_IIR_B1_out,UDCB_IIR_B1_fl);
      setInnerHtmlValueAsText("UDCB_IIR_A1",7,UDCB_IIR_A1_out,UDCB_IIR_A1_fl);
...
function clickUpdateParamFM()
{
    ...
    // Scales
    errorArray.push(UpdateFMVariable(xmlDoc,'N_max',Nmax,Nmax));
