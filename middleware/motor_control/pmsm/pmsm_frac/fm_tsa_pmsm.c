...
FMSTR_TSA_RW_VAR(g_sM1Drive.sScalarCtrl.i16VHzGainShift, FMSTR_TSA_SINT16) /* VHz Factor Gain Shift */
...
FMSTR_TSA_RW_MEM(sMIDPwrStgChar.f16UdErrorLookUp,
                 FMSTR_TSA_FRAC16,
                 &sMIDPwrStgChar.f16UdErrorLookUp[0],
                 (65 << 1)) /* MID Ud Error Lookup */
