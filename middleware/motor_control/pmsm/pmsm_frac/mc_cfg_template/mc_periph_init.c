...
static void InitADC(void)
{
    ...
    SIM->CLKDIV1 = ((SIM->CLKDIV1 & ~(SIM_CLKDIV1_OUTDIV4_MASK)) | SIM_CLKDIV1_OUTDIV4((((SIM->CLKDIV1 & SIM_CLKDIV1_OUTDIV4_MASK) >> SIM_CLKDIV1_OUTDIV4_SHIFT) << 1U) + 1U));
...
static void InitPDB(void)
{
    ...
    /* PDB interrupt delay */
    PDB0->IDLY = (M1_PWM_MODULO * M1_FOC_FREQ_VS_PWM_FREQ - M1_PWM_MODULO / 2) / 3;
...
static void InitCMP(void)
{
    ...
    M1_FAULT_CMP_INSTANCE->MUXCR = CMP_MUXCR_PSEL(4) | CMP_MUXCR_MSEL(7);
