...
#define M1_PWM_MODULO           (75000000UL / M1_PWM_FREQ)
...
#define M1_PWM_DEADTIME_LENGTH_DTVAL    (37U)
...
#define M1_SEC16_PH_C_CHANNEL   (7U)
#define M1_SEC16_PH_B_BASE      (ADC1)
#define M1_SEC16_PH_B_CHANNEL   (9U)
/* Phase current assignment in sectors 2,3 */
#define M1_SEC23_PH_C_BASE      (ADC1)
#define M1_SEC23_PH_C_CHANNEL   (7U)
#define M1_SEC23_PH_A_BASE      (ADC0)
#define M1_SEC23_PH_A_CHANNEL   (6U)
/* Phase current assignment in sectors 4,5 */
#define M1_SEC45_PH_A_BASE      (ADC0)
#define M1_SEC45_PH_A_CHANNEL   (6U)
#define M1_SEC45_PH_B_BASE      (ADC1)
#define M1_SEC45_PH_B_CHANNEL   (9U)
/* DC bus voltage channels assingnment */
#define M1_UDCB_BASE            (ADC0)
#define M1_UDCB_CHANNEL         (5U)
/* Auxiliary channel assingnment */
#define M1_AUX_BASE             (ADC1)
#define M1_AUX_CHANNEL          (4U)
