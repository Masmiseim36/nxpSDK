...
#define MC_FAULT_LOAD_OVER (3U)     /* Overload fault flag */
...
#define MC_FAULT_SET(faults, faultid) ((faults) |= (((mcdef_fault_t)1U) << (faultid)))

/* Clears the fault bit defined by faultid in the faults variable */
#define MC_FAULT_CLEAR(faults, faultid) ((faults) &= ~(((mcdef_fault_t)1U) << (faultid)))

/* Check the fault bit defined by faultid in the faults variable, returns 1 or 0 */
#define MC_FAULT_CHECK(faults, faultid) (((faults) & (((mcdef_fault_t)1U) << (faultid))) >> (faultid))
...
#define MC_FAULT_ANY(faults) ((faults) > 0U)
