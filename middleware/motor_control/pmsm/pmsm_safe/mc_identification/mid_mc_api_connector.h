 ...
 ******************************************************************************/
/*!
 * @brief   Function sets application switch variable.
 *
 * @param   bValue - Requested application switch state.
 *
 * @return  none
 */
...
/*!
 * @brief   Function gets the actual state-machine state.
 *
 * @param   void
 *
 * @return  The actual application state.
 */
