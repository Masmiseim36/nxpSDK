if(NOT MIDDLEWARE_MULTICORE_RPMSG_LITE_K32L3A60_cm0plus_INCLUDED)
    
    set(MIDDLEWARE_MULTICORE_RPMSG_LITE_K32L3A60_cm0plus_INCLUDED true CACHE BOOL "middleware_multicore_rpmsg_lite component is included.")
    ...
    if(CONFIG_USE_middleware_baremetal_K32L3A60_cm0plus)
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
        ${CMAKE_CURRENT_LIST_DIR}/rpmsg_lite/lib/rpmsg_lite/porting/environment/rpmsg_env_bm.c
    )
    elseif(CONFIG_USE_middleware_freertos-kernel_K32L3A60_cm0plus)
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
        ...
        message(WARNING "please config middleware.baremetal_K32L3A60_cm0plus or middleware.freertos-kernel_K32L3A60_cm0plus first.")
    endif()
