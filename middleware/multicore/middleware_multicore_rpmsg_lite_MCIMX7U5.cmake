if(NOT MIDDLEWARE_MULTICORE_RPMSG_LITE_MCIMX7U5_INCLUDED)
    
    set(MIDDLEWARE_MULTICORE_RPMSG_LITE_MCIMX7U5_INCLUDED true CACHE BOOL "middleware_multicore_rpmsg_lite component is included.")
    ...
    elseif(CONFIG_USE_middleware_freertos-kernel_MCIMX7U5)
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
        ...
        message(WARNING "please config middleware.baremetal_MCIMX7U5 or middleware.freertos-kernel_MCIMX7U5 first.")
    endif()
