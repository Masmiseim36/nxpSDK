...
#ifndef __PNGDEC__
#define __PNGDEC__
#if defined( __MACH__ ) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || ( __IAR_SYSTEMS_ICC__ ) || defined ( __GNUC__ )
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
#include <stdio.h>
...
#define PNG_FILE_BUF_SIZE 8192 // AUBINEAU 2048
// Number of bytes to reserve for current and previous lines
// Defaults to 640 32-bit pixels max width
#define PNG_MAX_BUFFERED_PIXELS (2*720*4+70) // Buffer for 2 lines = 2 * (maxPixWidth*BPP+2) , you must put '+2' for the line filter (one per line) --> 32+8 to be aligned!
...
enum {
    ...
    PNG_INVALID_FILE = 6,
    //PNG_TOO_BIG,  // removed
    PNG_WIDTH_TOO_BIG, // added
    PNG_UNSUPPORTED_COLORTYPE, // added
    PNG_BPP_NOT_SUPPORTED, // added
    //PNG_UNKNOWN_MARKER, // added
    PNG_UNSUPPORTED_INTERLACED, // added
    PNG_MARKER_IDAT_MISSING, // added
};
