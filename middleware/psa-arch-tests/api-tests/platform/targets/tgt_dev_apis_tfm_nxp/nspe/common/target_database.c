...
target_database_t target_database =
{
    ...
    .miscellaneous = {                           /* System Miscellaneous Information */
        .cfg_type = {
            .cfg_id = TARGET_CONFIG_CREATE_ID(GROUP_MISCELLANEOUS, MISCELLANEOUS_DUT, 0),
            .size = sizeof(cfg_type_t) + sizeof(miscellaneous_desc_t), /* size inclusive of this header */
        },
        .combine_test_binary_in_ram = AVAILABLE,
    },
    .type_end = {
