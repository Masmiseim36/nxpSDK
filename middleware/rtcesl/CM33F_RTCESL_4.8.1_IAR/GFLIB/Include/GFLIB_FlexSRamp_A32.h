...
#define GFLIB_FlexSRampCalcIncrPQ_F16_C(f16Target, a32Duration, psParam)      \
        GFLIB_FlexSRampCalcIncrPQ_F16_FC(f16Target, a32Duration, psParam)       
...
******************************************************************************/
extern bool_t GFLIB_FlexSRampCalcIncr_F16_FC(frac16_t f16Target, acc32_t a32Duration, 
                                             GFLIB_FLEXSRAMP_T_F32 *psParam);
extern bool_t GFLIB_FlexSRampCalcIncrPQ_F16_FC(frac16_t f16Target, acc32_t a32Duration, 
                                               GFLIB_FLEXSRAMP_T_F32 *psParam);
