...
#define GFLIB_SinCosPQ_FLTa_Ci(a32AngleExt, fltSinCos) GFLIB_SinCosPQ_FLTa_FCi(a32AngleExt, fltSinCos)
...
static inline float_t GFLIB_SinPQ_FLTa_FCi(acc32_t a32AngleExt)
{
    ...
    fltTemp = (float_t)((float_t)(frac16_t)a32AngleExt *
    ...
    RTCESL_PQ_SIN0(*(uint32_t *)(void *)&fltTemp);
    u32Temp = RTCESL_PQ_READ_ADD0();
    return *(float_t*)(void *)&u32Temp;
...
static inline float_t GFLIB_CosPQ_FLTa_FCi(acc32_t a32AngleExt)
{
    ...
    RTCESL_PQ_COS0(*(uint32_t *)(void *)&fltTemp);
    u32Temp = RTCESL_PQ_READ_ADD0();
    return *(float_t*)(void *)&u32Temp;
...
*******************************************************************************/
static inline void GFLIB_SinCosPQ_FLTa_FCi(acc32_t a32AngleExt, GMCLIB_2COOR_SINCOS_T_FLT *fltSinCos)
{   
    uint32_t u32Temp;
    float_t fltTemp, fltRes;    
    fltTemp = (float_t)((float_t)(frac16_t)a32AngleExt *
              ((float_t)FLOAT_PI/(float_t)32768.0F)); /* Converts fractional to float */
    ...
    RTCESL_PQ_SIN0(*(uint32_t *)(void *)&fltTemp);
    RTCESL_PQ_COS1(*(uint32_t *)(void *)&fltTemp);    
    u32Temp = RTCESL_PQ_READ_ADD0();
    fltRes = *(float_t*)(void *)&u32Temp;
    fltSinCos->fltSin = fltRes;    
    u32Temp = RTCESL_PQ_READ_ADD1();    
    fltRes = *(float_t*)(void *)&u32Temp;
    fltSinCos->fltCos = *(float_t*)(void *)&u32Temp;
