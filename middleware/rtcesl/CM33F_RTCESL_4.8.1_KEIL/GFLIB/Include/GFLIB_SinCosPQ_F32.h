...
#define GFLIB_SinCosPQ_F16_Ci(f16Angle, f16SinCos) GFLIB_SinCosPQ_F16_FCi(f16Angle, f16SinCos)
/****************************************************************************
* Inline functions 
****************************************************************************/ 
...
*
*******************************************************************************/ 
static inline frac16_t GFLIB_CosPQ_F16_FCi(frac16_t f16Angle)
{
    register frac32_t ret;
    register uint32_t cppre;
...
*******************************************************************************/
static inline void GFLIB_SinCosPQ_F16_FCi(frac16_t f16Angle, GMCLIB_2COOR_SINCOS_T_F16 *f16SinCos)
{   
    register frac32_t ret;
    register uint32_t cppre;    
    ...
    RTCESL_PQ_CPPRE = RTCESL_PQ_CPPRE_CPPRE_OUT(31);
    RTCESL_PQ_SIN0(valFloat.u32);
    RTCESL_PQ_COS1(valFloat.u32);

    ret = (frac32_t)RTCESL_PQ_READ_ADD0();
    ret = (frac32_t)RTCESL_PQ_READ_ADD0_FLT();
    ret = MLIB_Conv_F16l(ret);
    f16SinCos->f16Sin = ret;
    
    ret = (frac32_t)RTCESL_PQ_READ_ADD1();
    ret = (frac32_t)RTCESL_PQ_READ_ADD1_FLT();
    ret = MLIB_Conv_F16l(ret);    
    f16SinCos->f16Cos = ret; 
