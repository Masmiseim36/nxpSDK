...
#elif (RTCESL_MAU)
  #define GFLIB_Atan_FLT(fltVal)                                              GFLIB_AtanMAU_FLT_Ci(fltVal)
  #define GFLIB_AtanYX_FLT(fltY, fltX, pbErrFlag)                             GFLIB_AtanYXMAU_FLT_Ci(fltY, fltX, pbErrFlag)
  #define GFLIB_Cos_FLT(fltVal)                                               GFLIB_CosMAU_FLT_Ci(fltVal)
  #define GFLIB_Cos_FLTa(a32AngleExt)                                         GFLIB_CosMAU_FLTa_Ci(a32AngleExt)
  #define GFLIB_Sin_FLT(fltVal)                                               GFLIB_SinMAU_FLT_Ci(fltVal)
  #define GFLIB_Sin_FLTa(a32AngleExt)                                         GFLIB_SinMAU_FLTa_Ci(a32AngleExt)
  #define GFLIB_SinCos_FLTa(a32AngleExt, fltSinCos)                           GFLIB_SinCosMAU_FLTa_Ci(a32AngleExt, fltSinCos)
