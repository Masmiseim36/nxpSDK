...
#define GFLIB_VectorLimit1_F16(psVectorIn, f16Lim, psVectorOut)               GFLIB_VectorLimit1_F16_C(psVectorIn, f16Lim, psVectorOut)
  ...
  #define GFLIB_Cos_F16(f16Angle)                                             GFLIB_CosMAU_F16_Ci(f16Angle)
  #define GFLIB_Sin_F16(f16Angle)                                             GFLIB_SinMAU_F16_Ci(f16Angle)
  #define GFLIB_SinCos_F16(f16Angle, f16SinCos)                               GFLIB_SinCosMAU_F16_Ci(f16Angle, f16SinCos)
  #define GFLIB_Sqrt_F16l(f32Val)                                             GFLIB_SqrtMAU_F16l_Ci(f32Val)
  #define GFLIB_Sqrt_F16(f16Val)                                              GFLIB_SqrtMAU_F16_Ci(f16Val)
