...
#include "GFLIB_SinCosMAU_F32.h"    
#include "GFLIB_SinCosPQ_F32.h"
#include "GFLIB_Sqrt_F16.h"
#include "GFLIB_SqrtMAU_F16.h"    
#include "GFLIB_SqrtPQ_F16.h"
#include "GFLIB_Sqrt_F32.h"
#include "GFLIB_SqrtMAU_F32.h"     
#include "GFLIB_SqrtPQ_F32.h"
...
#if (RTCESL_PQ)
  #define GFLIB_AtanYX_F16(f16Y, f16X, pbErrFlag)                             GFLIB_AtanYXPQ_F16_Ci(f16Y, f16X, pbErrFlag)
  #define GFLIB_Cos_F16(f16Angle)                                             GFLIB_CosPQ_F16_Ci(f16Angle)
  #define GFLIB_Sin_F16(f16Angle)                                             GFLIB_SinPQ_F16_Ci(f16Angle)
  #define GFLIB_SinCos_F16(f16Angle, f16SinCos)                               GFLIB_SinCosPQ_F16_Ci(f16Angle, f16SinCos)
  #define GFLIB_Sqrt_F16l(f32Val)                                             GFLIB_SqrtPQ_F16l_Ci(f32Val)
  #define GFLIB_Sqrt_F16(f16Val)                                              GFLIB_SqrtPQ_F16_Ci(f16Val)
#elif (RTCESL_MAU)
  #define GFLIB_AtanYX_F16(f16Y, f16X, pbErrFlag)                             GFLIB_AtanYX_F16_Asm(f16Y, f16X, pbErrFlag)
  #define GFLIB_Cos_F16(f16Angle)                                             GFLIB_CosMAU_F16_Ci(f16Angle, RTCESL_MAU_DT_RES1)
  #define GFLIB_Sin_F16(f16Angle)                                             GFLIB_SinMAU_F16_Ci(f16Angle, RTCESL_MAU_DT_RES0)
  #define GFLIB_SinCos_F16(f16Angle, f16SinCos)                               GFLIB_SinCosMAU_F16_Ci(f16Angle, f16SinCos, RTCESL_MAU_DT_RES0, RTCESL_MAU_DT_RES1)
  #define GFLIB_Sqrt_F16l(f32Val)                                             GFLIB_SqrtMAU_F16l_Ci(f32Val, RTCESL_MAU_DT_RES3)
  #define GFLIB_Sqrt_F16(f16Val)                                              GFLIB_SqrtMAU_F16_Ci(f16Val, RTCESL_MAU_DT_RES3)
