...
#include "GFLIB_AtanMAU_FLT.h"
#include "GFLIB_AtanYX_FLT.h" 
#include "GFLIB_AtanYXMAU_FLT.h"
...
#include "GFLIB_SinCosMAU_FLT.h"  
#include "GFLIB_SinCosPQ_FLT.h" 
...
#define GFLIB_VectorLimit1_FLT(psVectorIn, fltLim, psVectorOut)               GFLIB_VectorLimit1_FLT_C(psVectorIn, fltLim, psVectorOut)
  ...
  #define GFLIB_Cos_FLT(fltAngle)                                             GFLIB_CosPQ_FLT_Ci(fltAngle)
  #define GFLIB_Cos_FLTa(a32AngleExt)                                         GFLIB_CosPQ_FLTa_Ci(a32AngleExt)
  #define GFLIB_Sin_FLT(fltAngle)                                             GFLIB_SinPQ_FLT_Ci(fltAngle)
  #define GFLIB_Sin_FLTa(a32AngleExt)                                         GFLIB_SinPQ_FLTa_Ci(a32AngleExt)
  #define GFLIB_SinCos_FLTa(a32AngleExt, fltSinCos)                           GFLIB_SinCosPQ_FLTa_Ci(a32AngleExt, fltSinCos)
#elif (RTCESL_MAU)
  #define GFLIB_Atan_FLT(fltVal)                                              GFLIB_AtanMAU_FLT_Ci(fltVal, RTCESL_MAU_DT_RES2)
  #define GFLIB_AtanYX_FLT(fltY, fltX, pbErrFlag)                             GFLIB_AtanYXMAU_FLT_Ci(fltY, fltX, pbErrFlag, RTCESL_MAU_DT_RES2)
  #define GFLIB_Cos_FLT(fltVal)                                               GFLIB_CosMAU_FLT_Ci(fltVal, RTCESL_MAU_DT_RES1)
  #define GFLIB_Cos_FLTa(a32AngleExt)                                         GFLIB_CosMAU_FLTa_Ci(a32AngleExt, RTCESL_MAU_DT_RES1)
  #define GFLIB_Sin_FLT(fltVal)                                               GFLIB_SinMAU_FLT_Ci(fltVal, RTCESL_MAU_DT_RES0)
  #define GFLIB_Sin_FLTa(a32AngleExt)                                         GFLIB_SinMAU_FLTa_Ci(a32AngleExt, RTCESL_MAU_DT_RES0)
  #define GFLIB_SinCos_FLTa(a32AngleExt, fltSinCos)                           GFLIB_SinCosMAU_FLTa_Ci(a32AngleExt, fltSinCos, RTCESL_MAU_DT_RES0, RTCESL_MAU_DT_RES1)
#else /* nor RTCESL_MAU nor RTCESL_PQ defined */                                                     
  #define GFLIB_Atan_FLT(fltVal)                                              GFLIB_Atan_FLT_C(fltVal)
  #define GFLIB_AtanYX_FLT(fltY, fltX, pbErrFlag)                             GFLIB_AtanYX_FLT_C(fltY, fltX, pbErrFlag)
...
#endif /* RTCESL_MAU or RTCESL_PQ end */
