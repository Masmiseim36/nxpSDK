...
#define RTCESL_PQ_SIN1(x)          __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_SIN, x, RTCESL_PQ_FLT | RTCESL_PQ_COMP1, 0, RTCESL_PQ_TRIG)
#define RTCESL_PQ_COS0(x)          __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_COS, x, RTCESL_PQ_FLT | RTCESL_PQ_COMP0, 0, RTCESL_PQ_TRIG)
#define RTCESL_PQ_COS1(x)          __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_COS, x, RTCESL_PQ_FLT | RTCESL_PQ_COMP1, 0, RTCESL_PQ_TRIG)
#define RTCESL_PQ_SIN0_FIX(x)      __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_SIN, x, RTCESL_PQ_FIX | RTCESL_PQ_COMP0, 0, RTCESL_PQ_TRIG_FIX)
#define RTCESL_PQ_SIN1_FIX(x)      __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_SIN, x, RTCESL_PQ_FIX | RTCESL_PQ_COMP1, 0, RTCESL_PQ_TRIG_FIX)
#define RTCESL_PQ_COS0_FIX(x)      __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_COS, x, RTCESL_PQ_FIX | RTCESL_PQ_COMP0, 0, RTCESL_PQ_TRIG_FIX)
#define RTCESL_PQ_COS1_FIX(x)      __arm_mcr(RTCESL_PQ_CP, RTCESL_PQ_COS, x, RTCESL_PQ_FIX | RTCESL_PQ_COMP1, 0, RTCESL_PQ_TRIG_FIX)
...
#define RTCESL_PQ_READ_ADD1()      __arm_mrc(RTCESL_PQ_CP, 1U, RTCESL_PQ_FLT | RTCESL_PQ_COMP1, 0U, 0U)
#define RTCESL_PQ_READ_ADD0_FLT()  __arm_mrc(RTCESL_PQ_CP, 1U, RTCESL_PQ_FIX | RTCESL_PQ_COMP0, 0U, 0U)
#define RTCESL_PQ_READ_ADD1_FLT()  __arm_mrc(RTCESL_PQ_CP, 1U, RTCESL_PQ_FIX | RTCESL_PQ_COMP1, 0U, 0U)
