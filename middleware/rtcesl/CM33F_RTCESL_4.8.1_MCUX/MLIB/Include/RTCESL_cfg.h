...
/* Warning if RTCESL_PQ_ON and RTCESL_PQ_OFF are defined in IDE */       
    ...
    #warning "Wrong configuration RTCESL_PQ_ON and RTCESL_PQ_OFF are defined !" 
#endif 
#if defined(RTCESL_PQ_ON) && defined(RTCESL_MAU_ON)
    #warning "Wrong configuration RTCESL_PQ_ON and RTCESL_MAU_ON are defined !" 
#endif 
