...
* Variables
*******************************************************************************/
extern uint32_t Load$$ROM_VECTOR_TABLE$$Base;
...
{
    volatile uint32_t IVT_address           = (uint32_t) &Load$$ROM_VECTOR_TABLE$$Base;    /* Interrupt vector table address */
...
{
    int32_t *pVTOR = (int32_t *)0xE000ED08;
    *pVTOR = vtor;
}
