...
#define VECTOR_000      (pointer*)__BOOT_STACK_ADDRESS	//             ARM core        Initial SP
#define VECTOR_001      start	                         //             ARM core        Initial PC
#ifndef VECTOR_002
...
#endif
#ifndef VECTOR_004
  #define VECTOR_004      default_isr     // 0x0000_0010 4 -          ARM core        Memory Manage
#endif
#ifndef VECTOR_005
...
#endif
#ifndef VECTOR_007
  #define VECTOR_007      default_isr     // 0x0000_001C 7 -          ARM core        Reserved
#endif
/*****************************************************************************************************/
...
/*****************************************************************************************************/
#ifndef VECTOR_011
  #define VECTOR_011      default_isr     // 0x0000_002C 11 -         ARM core        Offset to certificate block in bytes
#endif
#ifndef VECTOR_0012
  #define VECTOR_012      default_isr     // 0x0000_0030 12 -         ARM core        Supervisor call (SVCall)
#endif
#ifndef VECTOR_013
  #define VECTOR_013      default_isr     // 0x0000_0034 13 -         ARM core        Debug Monitor
#endif
#ifndef VECTOR_014
  #define VECTOR_014      default_isr     // 0x0000_0038 14 -         ARM core        Reserved
#endif
#ifndef VECTOR_015
