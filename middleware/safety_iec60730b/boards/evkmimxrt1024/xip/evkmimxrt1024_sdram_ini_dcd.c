...
const uint8_t dcd_data[] = {
	...
	/* #3.1-96, command header bytes for merged 'Write - value' command */
	0xCC, 0x03, 0x04, 0x04,
	...
	/* #3.71, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_06, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0x88, 0x00, 0x00, 0x00, 0xE1,
	/* #3.72, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_07, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0x8C, 0x00, 0x00, 0x00, 0xE1,
	/* #3.73, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_08, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0x90, 0x00, 0x00, 0x00, 0xE1,
	/* #3.74, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_09, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0x94, 0x00, 0x00, 0x00, 0xE1,
	/* #3.75, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_10, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0x98, 0x00, 0x00, 0x00, 0xE1,
	/* #3.76, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_11, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0x9C, 0x00, 0x00, 0x00, 0xE1,
	/* #3.77, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_12, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0xA0, 0x00, 0x00, 0x00, 0xE1,
	/* #3.78, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_13, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0xA4, 0x00, 0x00, 0x00, 0xE1,
	/* #3.79, command: write_value, address: IOMUXC_SW_PAD_CTL_PAD_GPIO_AD_B1_14, value: 0xE1, size: 4 */
	0x40, 0x1F, 0x82, 0xA8, 0x00, 0x00, 0x00, 0xE1,
	/* #3.80, command: write_value, address: SEMC_MCR, value: 0x10000004, size: 4 */
	0x40, 0x2F, 0x00, 0x00, 0x10, 0x00, 0x00, 0x04,
	/* #3.81, command: write_value, address: SEMC_BMCR0, value: 0x30524, size: 4 */
	0x40, 0x2F, 0x00, 0x08, 0x00, 0x03, 0x05, 0x24,
	/* #3.82, command: write_value, address: SEMC_BMCR1, value: 0x6030524, size: 4 */
	0x40, 0x2F, 0x00, 0x0C, 0x06, 0x03, 0x05, 0x24,
	/* #3.83, command: write_value, address: SEMC_BR0, value: 0x8000001B, size: 4 */
	0x40, 0x2F, 0x00, 0x10, 0x80, 0x00, 0x00, 0x1B,
	/* #3.84, command: write_value, address: SEMC_BR1, value: 0x8200001B, size: 4 */
	0x40, 0x2F, 0x00, 0x14, 0x82, 0x00, 0x00, 0x1B,
	/* #3.85, command: write_value, address: SEMC_BR2, value: 0x8400001B, size: 4 */
	0x40, 0x2F, 0x00, 0x18, 0x84, 0x00, 0x00, 0x1B,
	/* #3.86, command: write_value, address: SEMC_IOCR, value: 0x7988, size: 4 */
	0x40, 0x2F, 0x00, 0x04, 0x00, 0x00, 0x79, 0x88,
	/* #3.87, command: write_value, address: SEMC_SDRAMCR0, value: 0xF37, size: 4 */
	0x40, 0x2F, 0x00, 0x40, 0x00, 0x00, 0x0F, 0x37,
	/* #3.88, command: write_value, address: SEMC_SDRAMCR1, value: 0x652922, size: 4 */
	0x40, 0x2F, 0x00, 0x44, 0x00, 0x65, 0x29, 0x22,
	/* #3.89, command: write_value, address: SEMC_SDRAMCR2, value: 0x10920, size: 4 */
	0x40, 0x2F, 0x00, 0x48, 0x00, 0x01, 0x09, 0x20,
	/* #3.90, command: write_value, address: SEMC_SDRAMCR3, value: 0x50210A08, size: 4 */
	0x40, 0x2F, 0x00, 0x4C, 0x50, 0x21, 0x0A, 0x08,
	/* #3.91, command: write_value, address: SEMC_DBICR0, value: 0x21, size: 4 */
	0x40, 0x2F, 0x00, 0x80, 0x00, 0x00, 0x00, 0x21,
	/* #3.92, command: write_value, address: SEMC_DBICR1, value: 0x888888, size: 4 */
	0x40, 0x2F, 0x00, 0x84, 0x00, 0x88, 0x88, 0x88,
	/* #3.93, command: write_value, address: SEMC_IPCR1, value: 0x02, size: 4 */
	0x40, 0x2F, 0x00, 0x94, 0x00, 0x00, 0x00, 0x02,
	/* #3.94, command: write_value, address: SEMC_IPCR2, value: 0x00, size: 4 */
	0x40, 0x2F, 0x00, 0x98, 0x00, 0x00, 0x00, 0x00,
	/* #3.95, command: write_value, address: SEMC_IPCR0, value: 0x80000000, size: 4 */
	0x40, 0x2F, 0x00, 0x90, 0x80, 0x00, 0x00, 0x00,
	/* #3.96, command: write_value, address: SEMC_IPCMD, value: 0xA55A000F, size: 4 */
