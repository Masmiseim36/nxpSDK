...
#ifndef _IEC60730B_TSI_H_
#define _IEC60730B_TSI_H_
 ...
 ******************************************************************************/
/* Return values */
#define FS_FAIL_TSI              (FS_TSI_CODE + 0x1)
#define FS_TSI_PROGRESS_NONSTIM  (FS_TSI_CODE + 0x2)
#define FS_TSI_PASS_NONSTIM      (FS_TSI_CODE + 0x3)
#define FS_TSI_PROGRESS_STIM     (FS_TSI_CODE + 0x4)
#define FS_TSI_PASS_STIM         (FS_TSI_CODE + 0x5)
#define FS_TSI_INPROGRESS        (FS_TSI_CODE + 0x6)
#define FS_TSI_INIT              (FS_TSI_CODE + 0x7)
#define FS_TSI_INCORRECT_CALL    (FS_TSI_CODE + 0x8)
 ...
 *
 * @param    *pObj - input argument is pointer to tsi test instance.
 * @param    *pTsi - input argument is pointer to tsi module.
 *
