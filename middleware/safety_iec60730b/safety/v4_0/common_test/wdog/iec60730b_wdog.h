...
#ifndef _IEC60730B_WDOG_H_
#define _IEC60730B_WDOG_H_
 ...
 * Definitions
 ******************************************************************************/
#define FS_FAIL_WDOG_OVER_RESET       (FS_WDOG_CODE + 0x1)
#define FS_FAIL_WDOG_VALUE            (FS_WDOG_CODE + 0x2)
#define FS_FAIL_WDOG_WRONG_RESET      (FS_WDOG_CODE + 0x3)
 ...
 * @param    refresh_index - Index for select WDOG refresh sequence : FS_KINETIS_WDOG, FS_WDOG32 or FS_COP_WDOG - see LIbrary UG for chooce correct type.
 *
 * @return   void
 *
 ******************************************************************************/
 ...
 *
 * @param    *pWatchdogBackup - pointer to structure with fs_wdog_test_t variables.
 * @param    refresh_index - Index for select WDOG refresh sequence : FS_IMXRT or FS_IMX8M - see LIbrary UG for chooce correct type.
 *
 * @return   void
 *
 ******************************************************************************/
