...
#ifndef _IEC60730B_CM0_PC_H_
#define _IEC60730B_CM0_PC_H_
 ...
 * Definitions
 ******************************************************************************/
/* For using the address of function FS_PC_Object as a parameter of FS_CM0_PC_Test */
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM0_PC_Test(uint32_t pattern1, tFcn_pc pObjectFunction, uint32_t *pFlag);

/*******************************************************************************
 *
 * @brief    This function is internally used by the FS_CM0_PC_Test() function.
 *           Function is used for performing PC test, it should be called only 
 *           by FS_CM0_PC_Test() function.
