...
#ifndef _IEC60730B_CM0_RAM_H_
#define _IEC60730B_CM0_RAM_H_
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM0_RAM_AfterReset(uint32_t startAddress, uint32_t endAddress, uint32_t blockSize, uint32_t backupAddress, tFcn pMarchType);
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM0_RAM_Runtime(uint32_t startAddress, uint32_t endAddress, uint32_t *pActualAddress, uint32_t blockSize, uint32_t backupAddress, tFcn pMarchType);
 ...
 *
 ******************************************************************************/
void FS_CM0_RAM_CopyToBackup(uint32_t startAddress, uint32_t blockSize, uint32_t backupAddress);
 ...
 *
 ******************************************************************************/
void FS_CM0_RAM_CopyFromBackup(uint32_t startAddress, uint32_t blockSize, uint32_t backupAddress);
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM0_RAM_SegmentMarchC(uint32_t startAddress, uint32_t blockSize);
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM0_RAM_SegmentMarchX(uint32_t startAddress, uint32_t blockSize);

#endif /* __ASM__ */
#endif  /* _IEC60730B_CM0_RAM_H_ */
