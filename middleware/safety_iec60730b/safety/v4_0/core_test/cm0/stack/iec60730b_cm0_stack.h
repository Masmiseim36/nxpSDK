 ...
 * @version 4.0
 *
 * @brief Stack overflow test routines for Cortex-M0+ core - IEC60730 Class B.
 */

#ifndef _IEC60730B_CM0_STACK_H_
#define _IEC60730B_CM0_STACK_H_
 ...
 *
 ******************************************************************************/
void FS_CM0_STACK_Init(uint32_t stackTestPattern, uint32_t firstAddress, uint32_t secondAddress, uint32_t blockSize);
 ...
 *           Corresponds to one 32-bit memory space.
 *
 * @param    stackTestPattern - pattern to be checked in the areas (e.g. 0x77777777).
 * @param    firstAddress     - first address of block under the stack area.
 * @param    secondAddress    - first address of block above the stack area.
 * @param    blockSize        - size of areas under and above the stack.
 *
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM0_STACK_Test(uint32_t stackTestPattern, uint32_t firstAddress, uint32_t secondAddress, uint32_t blockSize);

#endif /* __ASM__ */
#endif /* _IEC60730B_CM0_STACK_H_ */
