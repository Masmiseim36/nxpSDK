 ...
 * @version 4.0
 *
 * @brief Program counter test routines for Cortex-M33 core - IEC60730 Class B.
 */

#ifndef _IEC60730B_CM33_PC_H_
#define _IEC60730B_CM33_PC_H_
 ...
 * Definitions
 ******************************************************************************/
/* For using the address of function FS_PC_Object as a parameter of FS_CM33_PC_Test */
...
/*******************************************************************************
 *
 * @brief    This function is internally used by the FS_CM33_PC_Test() function.
 *           Function is used for performing PC test, it should be called only 
 *           by FS_CM33_PC_Test() function.
