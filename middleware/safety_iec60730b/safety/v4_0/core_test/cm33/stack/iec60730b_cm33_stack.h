 ...
 * @version 4.0
 *
 * @brief Stack overflow test routines for Cortex-M33 core - IEC60730 Class B.
 */

#ifndef _IEC60730B_CM33_STACK_H_
#define _IEC60730B_CM33_STACK_H_
 ...
 *
 ******************************************************************************/
FS_RESULT FS_CM33_STACK_Test(uint32_t stackTestPattern, uint32_t firstAddress, uint32_t secondAddress, uint32_t blockSize);

#endif /* __ASM__ */
#endif /* _IEC60730B_CM33_STACK_H_ */
