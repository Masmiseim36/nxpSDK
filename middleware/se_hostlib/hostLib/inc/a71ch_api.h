...
// The A71CH has been tested in combination with: I2C interface & SMCOM_JRCP_V1
...
#elif defined(IPC)
#define MAX_CHUNK_LENGTH_LINK     256    //!< Limited by A71CH applet capability
#elif defined(RJCT_VCOM) || defined(SMCOM_JRCP_V1) || defined(SMCOM_JRCP_V2) || defined(SMCOM_PN7150) || defined(SMCOM_THREAD)
#define MAX_CHUNK_LENGTH_LINK     256    //!< Limited by A71CH applet capability
#else
