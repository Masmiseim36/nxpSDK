 ...
 *
 */
sss_status_t sss_openssl_session_prop_get_u32(
    sss_openssl_session_t *session, uint32_t property, uint32_t *pValue);

/** @copydoc sss_session_prop_get_au8
 *
 */
sss_status_t sss_openssl_session_prop_get_au8(sss_openssl_session_t *session,
    uint32_t property,
    uint8_t *pValue,
    size_t *pValueLen);
 ...
 *
 */
sss_status_t sss_openssl_key_object_init(
    sss_openssl_object_t *keyObject, sss_openssl_key_store_t *keyStore);
 ...
 *
 */
sss_status_t sss_openssl_key_object_get_handle(
    sss_openssl_object_t *keyObject, uint32_t keyId);

/** @copydoc sss_key_object_set_user
 *
 */
sss_status_t sss_openssl_key_object_set_user(
    sss_openssl_object_t *keyObject, uint32_t user, uint32_t options);

/** @copydoc sss_key_object_set_purpose
 *
 */
sss_status_t sss_openssl_key_object_set_purpose(
    sss_openssl_object_t *keyObject, sss_mode_t purpose, uint32_t options);

/** @copydoc sss_key_object_set_access
 *
 */
sss_status_t sss_openssl_key_object_set_access(
    sss_openssl_object_t *keyObject, uint32_t access, uint32_t options);

/** @copydoc sss_key_object_set_eccgfp_group
 *
 */
sss_status_t sss_openssl_key_object_set_eccgfp_group(
    sss_openssl_object_t *keyObject, sss_eccgfp_group_t *group);

/** @copydoc sss_key_object_get_user
 *
 */
sss_status_t sss_openssl_key_object_get_user(
    sss_openssl_object_t *keyObject, uint32_t *user);

/** @copydoc sss_key_object_get_purpose
 *
 */
sss_status_t sss_openssl_key_object_get_purpose(
    sss_openssl_object_t *keyObject, sss_mode_t *purpose);

/** @copydoc sss_key_object_get_access
 *
 */
sss_status_t sss_openssl_key_object_get_access(
    sss_openssl_object_t *keyObject, uint32_t *access);
 ...
 *
 */
sss_status_t sss_openssl_derive_key_context_init(
 ...
 *
 */
sss_status_t sss_openssl_key_store_context_init(
    sss_openssl_key_store_t *keyStore, sss_openssl_session_t *session);

/** @copydoc sss_key_store_allocate
 *
 */
sss_status_t sss_openssl_key_store_allocate(
    sss_openssl_key_store_t *keyStore, uint32_t keyStoreId);
 ...
 *
 */
sss_status_t sss_openssl_key_store_open_key(
    sss_openssl_key_store_t *keyStore, sss_openssl_object_t *keyObject);

/** @copydoc sss_key_store_freeze_key
 *
 */
sss_status_t sss_openssl_key_store_freeze_key(
    sss_openssl_key_store_t *keyStore, sss_openssl_object_t *keyObject);

/** @copydoc sss_key_store_erase_key
 *
 */
sss_status_t sss_openssl_key_store_erase_key(
    sss_openssl_key_store_t *keyStore, sss_openssl_object_t *keyObject);

/** @copydoc sss_key_store_prop_get_u32
 *
 */
sss_status_t sss_openssl_key_store_prop_get_u32(
    sss_openssl_key_store_t *session, uint32_t property, uint32_t *pValue);

/** @copydoc sss_key_store_prop_get_au8
 *
 */
sss_status_t sss_openssl_key_store_prop_get_au8(
 ...
 *
 */
sss_status_t sss_openssl_asymmetric_context_init(
 ...
 *
 */
sss_status_t sss_openssl_asymmetric_encrypt(sss_openssl_asymmetric_t *context,
 ...
 *
 */
sss_status_t sss_openssl_asymmetric_decrypt(sss_openssl_asymmetric_t *context,
    const uint8_t *srcData,
    size_t srcLen,
    uint8_t *destData,
    size_t *destLen);
 ...
 *
 */
sss_status_t sss_openssl_symmetric_context_init(
 ...
 *
 */
sss_status_t sss_openssl_cipher_init(
    sss_openssl_symmetric_t *context, uint8_t *iv, size_t ivLen);

/** @copydoc sss_cipher_update
 *
 */
sss_status_t sss_openssl_cipher_update(sss_openssl_symmetric_t *context,
    const uint8_t *srcData,
    size_t srcLen,
    uint8_t *destData,
    size_t *destLen);
 ...
 *
 */
sss_status_t sss_openssl_cipher_finish(sss_openssl_symmetric_t *context,
    const uint8_t *srcData,
    size_t srcLen,
    uint8_t *destData,
    size_t *destLen);
 ...
 *
 */
sss_status_t sss_openssl_aead_init(sss_openssl_aead_t *context,
    uint8_t *nonce,
    size_t nonceLen,
    size_t tagLen,
    size_t aadLen,
 ...
 *
 */
sss_status_t sss_openssl_aead_update_aad(
    sss_openssl_aead_t *context, const uint8_t *aadData, size_t aadDataLen);

/** @copydoc sss_aead_update
 *
 */
sss_status_t sss_openssl_aead_update(sss_openssl_aead_t *context,
    const uint8_t *srcData,
    size_t srcLen,
    uint8_t destData,
    size_t *destLen);
 ...
 *
 */
sss_status_t sss_openssl_mac_one_go(sss_openssl_mac_t *context,
 ...
 *
 */
sss_status_t sss_openssl_mac_update(
    sss_openssl_mac_t *context, const uint8_t *message, size_t messageLen);

/** @copydoc sss_mac_finish
 *
 */
sss_status_t sss_openssl_mac_finish(
    sss_openssl_mac_t *context, uint8_t *mac, size_t *macLen);
 ...
 *
 */
sss_status_t sss_openssl_digest_context_init(sss_openssl_digest_t *context,
    sss_openssl_session_t *session,
    sss_algorithm_t algorithm,
    sss_mode_t mode);
 ...
 *
 */
sss_status_t sss_openssl_digest_one_go(sss_openssl_digest_t *context,
    const uint8_t *message,
    size_t messageLen,
    uint8_t *digest,
    size_t *digestLen);
 ...
 *
 */
sss_status_t sss_openssl_digest_update(
    sss_openssl_digest_t *context, const uint8_t *message, size_t messageLen);

/** @copydoc sss_digest_finish
 *
 */
sss_status_t sss_openssl_digest_finish(
    sss_openssl_digest_t *context, uint8_t *digest, size_t *digestLen);
 ...
 *
 */
sss_status_t sss_openssl_rng_context_init(
    sss_openssl_rng_context_t *context, sss_openssl_session_t *session);

/** @copydoc sss_rng_get_random
 *
 */
sss_status_t sss_openssl_rng_get_random(
    sss_openssl_rng_context_t *context, uint8_t *random_data, size_t dataLen);
...
#       define sss_session_create(session,subsystem,application_id,connetion_type,connectionData) \
            sss_openssl_session_create(((sss_openssl_session_t * ) session),(subsystem),(application_id),(connetion_type),(connectionData))
#       define sss_session_open(session,subsystem,application_id,connetion_type,connectionData) \
            sss_openssl_session_open(((sss_openssl_session_t * ) session),(subsystem),(application_id),(connetion_type),(connectionData))
...
#       define sss_key_store_prop_get_u32(session,property,pValue) \
            sss_openssl_key_store_prop_get_u32(((sss_openssl_key_store_t * ) session),(property),(pValue))
#       define sss_key_store_prop_get_au8(session,property,pValue,pValueLen) \
            sss_openssl_key_store_prop_get_au8(((sss_openssl_key_store_t * ) session),(property),(pValue),(pValueLen))
