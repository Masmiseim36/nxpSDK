    ...
    void *connectionData)
{
    ...
    if (SSS_SUBSYSTEM_TYPE_IS_SSCP(subsystem)) {
        ...
        return sss_sscp_session_open(sscp_session,
            subsystem,
            application_id,
            connetion_type,
            connectionData);
    ...
    if (SSS_SUBSYSTEM_TYPE_IS_SE05X(subsystem)) {
        ...
        return sss_se05x_session_open(se05x_session,
            subsystem,
            application_id,
            connetion_type,
            connectionData);
...
#if SSS_HAVE_MBEDTLS
    if (SSS_SUBSYSTEM_TYPE_IS_MBEDTLS(subsystem)) {
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        return sss_mbedtls_session_open(mbedtls_session,
            subsystem,
            application_id,
            connetion_type,
            connectionData);
...
#if SSS_HAVE_OPENSSL
    if (SSS_SUBSYSTEM_TYPE_IS_OPENSSL(subsystem)) {
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        return sss_openssl_session_open(openssl_session,
            subsystem,
            application_id,
            connetion_type,
            connectionData);
    ...
    sss_session_t *session, uint32_t property, uint32_t *pValue)
{
    ...
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        return sss_mbedtls_session_prop_get_u32(
            mbedtls_session, property, pValue);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        return sss_openssl_session_prop_get_u32(
            openssl_session, property, pValue);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t *pValueLen)
{
    ...
    if (SSS_SESSION_TYPE_IS_SSCP(session)) {
        sss_sscp_session_t *sscp_session = (sss_sscp_session_t *)session;
        return sss_sscp_session_prop_get_au8(
            sscp_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        return sss_se05x_session_prop_get_au8(
            se05x_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        return sss_mbedtls_session_prop_get_au8(
            mbedtls_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        return sss_openssl_session_prop_get_au8(
            openssl_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_object_t *keyObject, sss_key_store_t *keyStore)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        sss_mbedtls_key_store_t *mbedtls_keyStore =
    ...
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        sss_openssl_key_store_t *openssl_keyStore =
    ...
    uint32_t options)
{
    ...
    if (SSS_OBJECT_TYPE_IS_SSCP(keyObject)) {
        sss_sscp_object_t *sscp_keyObject = (sss_sscp_object_t *)keyObject;
        return sss_sscp_key_object_allocate_handle(
            sscp_keyObject, keyId, keyPart, cipherType, keyByteLenMax, options);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X && SSSFTR_SE05X_KEY_SET
    if (SSS_OBJECT_TYPE_IS_SE05X(keyObject)) {
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_key_object_allocate_handle(se05x_keyObject,
            keyId,
            keyPart,
            cipherType,
            keyByteLenMax,
    ...
    if (SSS_OBJECT_TYPE_IS_MBEDTLS(keyObject)) {
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_object_allocate_handle(mbedtls_keyObject,
            keyId,
            keyPart,
            cipherType,
            keyByteLenMax,
    ...
    if (SSS_OBJECT_TYPE_IS_OPENSSL(keyObject)) {
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_object_allocate_handle(openssl_keyObject,
            keyId,
            keyPart,
            cipherType,
            keyByteLenMax,
...
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X && SSSFTR_SE05X_KEY_GET
    if (SSS_OBJECT_TYPE_IS_SE05X(keyObject)) {
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
    ...
    sss_object_t *keyObject, uint32_t user, uint32_t options)
{
    ...
    if (SSS_OBJECT_TYPE_IS_MBEDTLS(keyObject)) {
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_object_set_user(
            mbedtls_keyObject, user, options);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_OBJECT_TYPE_IS_OPENSSL(keyObject)) {
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_object_set_user(
            openssl_keyObject, user, options);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_object_t *keyObject, sss_mode_t purpose, uint32_t options)
{
    ...
    if (SSS_OBJECT_TYPE_IS_SSCP(keyObject)) {
        sss_sscp_object_t *sscp_keyObject = (sss_sscp_object_t *)keyObject;
        return sss_sscp_key_object_set_purpose(
            sscp_keyObject, purpose, options);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_OBJECT_TYPE_IS_SE05X(keyObject)) {
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_key_object_set_purpose(
            se05x_keyObject, purpose, options);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_OBJECT_TYPE_IS_MBEDTLS(keyObject)) {
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_object_set_purpose(
            mbedtls_keyObject, purpose, options);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_OBJECT_TYPE_IS_OPENSSL(keyObject)) {
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_object_set_purpose(
            openssl_keyObject, purpose, options);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_object_t *keyObject, uint32_t access, uint32_t options)
{
    ...
    if (SSS_OBJECT_TYPE_IS_SE05X(keyObject)) {
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_key_object_set_access(
            se05x_keyObject, access, options);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_OBJECT_TYPE_IS_MBEDTLS(keyObject)) {
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_object_set_access(
            mbedtls_keyObject, access, options);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_OBJECT_TYPE_IS_OPENSSL(keyObject)) {
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_object_set_access(
            openssl_keyObject, access, options);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_object_t *keyObject, sss_eccgfp_group_t *group)
{
    ...
    if (SSS_OBJECT_TYPE_IS_MBEDTLS(keyObject)) {
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_object_set_eccgfp_group(
            mbedtls_keyObject, group);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_OBJECT_TYPE_IS_OPENSSL(keyObject)) {
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_object_set_eccgfp_group(
            openssl_keyObject, group);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_mode_t mode)
{
    ...
    if (SSS_SESSION_TYPE_IS_SSCP(session)) {
        ...
        return sss_sscp_derive_key_context_init(
            sscp_context, sscp_session, sscp_keyObject, algorithm, mode);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        sss_se05x_derive_key_t *se05x_context =
            (sss_se05x_derive_key_t *)context;
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_derive_key_context_init(
            se05x_context, se05x_session, se05x_keyObject, algorithm, mode);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_derive_key_t *mbedtls_context =
            (sss_mbedtls_derive_key_t *)context;
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_derive_key_context_init(mbedtls_context,
            mbedtls_session,
            mbedtls_keyObject,
            algorithm,
            mode);
...
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        sss_openssl_derive_key_t *openssl_context =
            (sss_openssl_derive_key_t *)context;
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_derive_key_context_init(openssl_context,
            openssl_session,
            openssl_keyObject,
            algorithm,
            mode);
    ...
    size_t *hkdfOutputLen)
{
    ...
    if (SSS_DERIVE_KEY_TYPE_IS_SSCP(context)) {
        sss_sscp_derive_key_t *sscp_context = (sss_sscp_derive_key_t *)context;
        sss_sscp_object_t *sscp_derivedKeyObject =
    ...
    if (SSS_DERIVE_KEY_TYPE_IS_SE05X(context)) {
        sss_se05x_derive_key_t *se05x_context =
            (sss_se05x_derive_key_t *)context;
        sss_se05x_object_t *se05x_derivedKeyObject =
    ...
    if (SSS_DERIVE_KEY_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_derive_key_t *mbedtls_context =
            (sss_mbedtls_derive_key_t *)context;
        sss_mbedtls_object_t *mbedtls_derivedKeyObject =
    ...
    if (SSS_DERIVE_KEY_TYPE_IS_OPENSSL(context)) {
        sss_openssl_derive_key_t *openssl_context =
            (sss_openssl_derive_key_t *)context;
        sss_openssl_object_t *openssl_derivedKeyObject =
    ...
    sss_object_t *derivedKeyObject)
{
    ...
    if (SSS_DERIVE_KEY_TYPE_IS_SSCP(context)) {
        sss_sscp_derive_key_t *sscp_context = (sss_sscp_derive_key_t *)context;
        sss_sscp_object_t *sscp_otherPartyKeyObject =
            (sss_sscp_object_t *)otherPartyKeyObject;
        sss_sscp_object_t *sscp_derivedKeyObject =
            (sss_sscp_object_t *)derivedKeyObject;
        return sss_sscp_derive_key_dh(
            sscp_context, sscp_otherPartyKeyObject, sscp_derivedKeyObject);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_DERIVE_KEY_TYPE_IS_SE05X(context)) {
        sss_se05x_derive_key_t *se05x_context =
            (sss_se05x_derive_key_t *)context;
        sss_se05x_object_t *se05x_otherPartyKeyObject =
            (sss_se05x_object_t *)otherPartyKeyObject;
        sss_se05x_object_t *se05x_derivedKeyObject =
            (sss_se05x_object_t *)derivedKeyObject;
        return sss_se05x_derive_key_dh(
            se05x_context, se05x_otherPartyKeyObject, se05x_derivedKeyObject);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_DERIVE_KEY_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_derive_key_t *mbedtls_context =
            (sss_mbedtls_derive_key_t *)context;
        sss_mbedtls_object_t *mbedtls_otherPartyKeyObject =
            (sss_mbedtls_object_t *)otherPartyKeyObject;
        sss_mbedtls_object_t *mbedtls_derivedKeyObject =
            (sss_mbedtls_object_t *)derivedKeyObject;
        return sss_mbedtls_derive_key_dh(mbedtls_context,
            mbedtls_otherPartyKeyObject,
            mbedtls_derivedKeyObject);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_DERIVE_KEY_TYPE_IS_OPENSSL(context)) {
        sss_openssl_derive_key_t *openssl_context =
            (sss_openssl_derive_key_t *)context;
        sss_openssl_object_t *openssl_otherPartyKeyObject =
            (sss_openssl_object_t *)otherPartyKeyObject;
        sss_openssl_object_t *openssl_derivedKeyObject =
            (sss_openssl_object_t *)derivedKeyObject;
        return sss_openssl_derive_key_dh(openssl_context,
            openssl_otherPartyKeyObject,
            openssl_derivedKeyObject);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
    ...
    sss_key_store_t *keyStore, sss_session_t *session)
{
    ...
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        ...
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        return sss_mbedtls_key_store_context_init(
            mbedtls_keyStore, mbedtls_session);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        ...
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        return sss_openssl_key_store_context_init(
            openssl_keyStore, openssl_session);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t optionsLen)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_SSCP(keyStore)) {
        sss_sscp_key_store_t *sscp_keyStore = (sss_sscp_key_store_t *)keyStore;
        sss_sscp_object_t *sscp_keyObject = (sss_sscp_object_t *)keyObject;
        return sss_sscp_key_store_set_key(sscp_keyStore,
            sscp_keyObject,
            data,
            dataLen,
            keyBitLen,
    ...
    if (SSS_KEY_STORE_TYPE_IS_SE05X(keyStore)) {
        sss_se05x_key_store_t *se05x_keyStore =
            (sss_se05x_key_store_t *)keyStore;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_key_store_set_key(se05x_keyStore,
            se05x_keyObject,
            data,
            dataLen,
            keyBitLen,
    ...
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        ...
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_store_set_key(mbedtls_keyStore,
            mbedtls_keyObject,
            data,
            dataLen,
            keyBitLen,
    ...
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_store_set_key(openssl_keyStore,
            openssl_keyObject,
            data,
            dataLen,
            keyBitLen,
    ...
    void *options)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_SSCP(keyStore)) {
        sss_sscp_key_store_t *sscp_keyStore = (sss_sscp_key_store_t *)keyStore;
        sss_sscp_object_t *sscp_keyObject = (sss_sscp_object_t *)keyObject;
        return sss_sscp_key_store_generate_key(
            sscp_keyStore, sscp_keyObject, keyBitLen, options);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_KEY_STORE_TYPE_IS_SE05X(keyStore)) {
        sss_se05x_key_store_t *se05x_keyStore =
            (sss_se05x_key_store_t *)keyStore;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_key_store_generate_key(
            se05x_keyStore, se05x_keyObject, keyBitLen, options);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        ...
        return sss_mbedtls_key_store_generate_key(
            mbedtls_keyStore, mbedtls_keyObject, keyBitLen, options);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        return sss_openssl_key_store_generate_key(
            openssl_keyStore, openssl_keyObject, keyBitLen, options);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t *pKeyBitLen)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_SSCP(keyStore)) {
        sss_sscp_key_store_t *sscp_keyStore = (sss_sscp_key_store_t *)keyStore;
        sss_sscp_object_t *sscp_keyObject = (sss_sscp_object_t *)keyObject;
        return sss_sscp_key_store_get_key(
            sscp_keyStore, sscp_keyObject, data, dataLen, pKeyBitLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X && SSSFTR_SE05X_KEY_GET
    if (SSS_KEY_STORE_TYPE_IS_SE05X(keyStore)) {
        ...
        return sss_se05x_key_store_get_key(
            se05x_keyStore, se05x_keyObject, data, dataLen, pKeyBitLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        ...
        return sss_mbedtls_key_store_get_key(
            mbedtls_keyStore, mbedtls_keyObject, data, dataLen, pKeyBitLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        return sss_openssl_key_store_get_key(
            openssl_keyStore, openssl_keyObject, data, dataLen, pKeyBitLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_key_store_t *keyStore, sss_object_t *keyObject)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        ...
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_store_open_key(
            mbedtls_keyStore, mbedtls_keyObject);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_store_open_key(
            openssl_keyStore, openssl_keyObject);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_key_store_t *keyStore, sss_object_t *keyObject)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        ...
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_store_freeze_key(
            mbedtls_keyStore, mbedtls_keyObject);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_store_freeze_key(
            openssl_keyStore, openssl_keyObject);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
    ...
    sss_key_store_t *keyStore, sss_object_t *keyObject)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(keyStore)) {
        ...
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_key_store_erase_key(
            mbedtls_keyStore, mbedtls_keyObject);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(keyStore)) {
        ...
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_key_store_erase_key(
            openssl_keyStore, openssl_keyObject);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
...
sss_status_t sss_key_store_prop_get_u32(
    sss_key_store_t *session, uint32_t property, uint32_t *pValue)
{
#if SSS_HAVE_SSCP
    if (SSS_KEY_STORE_TYPE_IS_SSCP(session)) {
        sss_sscp_key_store_t *sscp_session = (sss_sscp_key_store_t *)session;
        return sss_sscp_key_store_prop_get_u32(sscp_session, property, pValue);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_KEY_STORE_TYPE_IS_SE05X(session)) {
        sss_se05x_key_store_t *se05x_session = (sss_se05x_key_store_t *)session;
        return sss_se05x_key_store_prop_get_u32(
            se05x_session, property, pValue);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_key_store_t *mbedtls_session =
            (sss_mbedtls_key_store_t *)session;
        return sss_mbedtls_key_store_prop_get_u32(
            mbedtls_session, property, pValue);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(session)) {
        sss_openssl_key_store_t *openssl_session =
            (sss_openssl_key_store_t *)session;
        return sss_openssl_key_store_prop_get_u32(
            openssl_session, property, pValue);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
...
sss_status_t sss_key_store_prop_get_au8(sss_key_store_t *session,
    uint32_t property,
    uint8_t *pValue,
    size_t *pValueLen)
{
    ...
    if (SSS_KEY_STORE_TYPE_IS_SSCP(session)) {
        sss_sscp_key_store_t *sscp_session = (sss_sscp_key_store_t *)session;
        return sss_sscp_key_store_prop_get_au8(
            sscp_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_KEY_STORE_TYPE_IS_SE05X(session)) {
        sss_se05x_key_store_t *se05x_session = (sss_se05x_key_store_t *)session;
        return sss_se05x_key_store_prop_get_au8(
            se05x_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_KEY_STORE_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_key_store_t *mbedtls_session =
            (sss_mbedtls_key_store_t *)session;
        return sss_mbedtls_key_store_prop_get_au8(
            mbedtls_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_KEY_STORE_TYPE_IS_OPENSSL(session)) {
        sss_openssl_key_store_t *openssl_session =
            (sss_openssl_key_store_t *)session;
        return sss_openssl_key_store_prop_get_au8(
            openssl_session, property, pValue, pValueLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
...
#if SSS_HAVE_SE05X
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        sss_se05x_asymmetric_t *se05x_context =
            (sss_se05x_asymmetric_t *)context;
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_asymmetric_context_init(
            se05x_context, se05x_session, se05x_keyObject, algorithm, mode);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_asymmetric_t *mbedtls_context =
            (sss_mbedtls_asymmetric_t *)context;
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_asymmetric_context_init(mbedtls_context,
            mbedtls_session,
            mbedtls_keyObject,
            algorithm,
            mode);
...
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        sss_openssl_asymmetric_t *openssl_context =
            (sss_openssl_asymmetric_t *)context;
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_asymmetric_context_init(openssl_context,
            openssl_session,
            openssl_keyObject,
            algorithm,
            mode);
    ...
    size_t *destLen)
{
    ...
    if (SSS_ASYMMETRIC_TYPE_IS_SSCP(context)) {
        sss_sscp_asymmetric_t *sscp_context = (sss_sscp_asymmetric_t *)context;
        return sss_sscp_asymmetric_encrypt(
            sscp_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_ASYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_asymmetric_t *se05x_context =
            (sss_se05x_asymmetric_t *)context;
        return sss_se05x_asymmetric_encrypt(
            se05x_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_ASYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_asymmetric_t *mbedtls_context =
            (sss_mbedtls_asymmetric_t *)context;
        return sss_mbedtls_asymmetric_encrypt(
            mbedtls_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_ASYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_asymmetric_t *openssl_context =
            (sss_openssl_asymmetric_t *)context;
        return sss_openssl_asymmetric_encrypt(
            openssl_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t *destLen)
{
    ...
    if (SSS_ASYMMETRIC_TYPE_IS_SSCP(context)) {
        sss_sscp_asymmetric_t *sscp_context = (sss_sscp_asymmetric_t *)context;
        return sss_sscp_asymmetric_decrypt(
            sscp_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_ASYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_asymmetric_t *se05x_context =
            (sss_se05x_asymmetric_t *)context;
        return sss_se05x_asymmetric_decrypt(
            se05x_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_ASYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_asymmetric_t *mbedtls_context =
            (sss_mbedtls_asymmetric_t *)context;
        return sss_mbedtls_asymmetric_decrypt(
            mbedtls_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_ASYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_asymmetric_t *openssl_context =
            (sss_openssl_asymmetric_t *)context;
        return sss_openssl_asymmetric_decrypt(
            openssl_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
    ...
    size_t *signatureLen)
{
    ...
    if (SSS_ASYMMETRIC_TYPE_IS_SSCP(context)) {
        sss_sscp_asymmetric_t *sscp_context = (sss_sscp_asymmetric_t *)context;
        return sss_sscp_asymmetric_sign_digest(
            sscp_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_ASYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_asymmetric_t *se05x_context =
            (sss_se05x_asymmetric_t *)context;
        return sss_se05x_asymmetric_sign_digest(
            se05x_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_ASYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_asymmetric_t *mbedtls_context =
            (sss_mbedtls_asymmetric_t *)context;
        return sss_mbedtls_asymmetric_sign_digest(
            mbedtls_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_ASYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_asymmetric_t *openssl_context =
            (sss_openssl_asymmetric_t *)context;
        return sss_openssl_asymmetric_sign_digest(
            openssl_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t signatureLen)
{
    ...
    if (SSS_ASYMMETRIC_TYPE_IS_SSCP(context)) {
        sss_sscp_asymmetric_t *sscp_context = (sss_sscp_asymmetric_t *)context;
        return sss_sscp_asymmetric_verify_digest(
            sscp_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_ASYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_asymmetric_t *se05x_context =
            (sss_se05x_asymmetric_t *)context;
        return sss_se05x_asymmetric_verify_digest(
            se05x_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_ASYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_asymmetric_t *mbedtls_context =
            (sss_mbedtls_asymmetric_t *)context;
        return sss_mbedtls_asymmetric_verify_digest(
            mbedtls_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_ASYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_asymmetric_t *openssl_context =
            (sss_openssl_asymmetric_t *)context;
        return sss_openssl_asymmetric_verify_digest(
            openssl_context, digest, digestLen, signature, signatureLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
...
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X && SSSFTR_SE05X_AES
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        sss_se05x_symmetric_t *se05x_context = (sss_se05x_symmetric_t *)context;
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_symmetric_context_init(
            se05x_context, se05x_session, se05x_keyObject, algorithm, mode);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_symmetric_t *mbedtls_context =
            (sss_mbedtls_symmetric_t *)context;
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_symmetric_context_init(mbedtls_context,
            mbedtls_session,
            mbedtls_keyObject,
            algorithm,
            mode);
...
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        sss_openssl_symmetric_t *openssl_context =
            (sss_openssl_symmetric_t *)context;
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_symmetric_context_init(openssl_context,
            openssl_session,
            openssl_keyObject,
            algorithm,
            mode);
    ...
    size_t dataLen)
{
    ...
    if (SSS_SYMMETRIC_TYPE_IS_SSCP(context)) {
        sss_sscp_symmetric_t *sscp_context = (sss_sscp_symmetric_t *)context;
        return sss_sscp_cipher_one_go(
            sscp_context, iv, ivLen, srcData, destData, dataLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X && SSSFTR_SE05X_AES
    if (SSS_SYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_symmetric_t *se05x_context = (sss_se05x_symmetric_t *)context;
        return sss_se05x_cipher_one_go(
            se05x_context, iv, ivLen, srcData, destData, dataLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_symmetric_t *mbedtls_context =
            (sss_mbedtls_symmetric_t *)context;
        return sss_mbedtls_cipher_one_go(
            mbedtls_context, iv, ivLen, srcData, destData, dataLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_symmetric_t *openssl_context =
            (sss_openssl_symmetric_t *)context;
        return sss_openssl_cipher_one_go(
            openssl_context, iv, ivLen, srcData, destData, dataLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t *destLen)
{
    ...
    if (SSS_SYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_symmetric_t *se05x_context = (sss_se05x_symmetric_t *)context;
        return sss_se05x_cipher_update(
            se05x_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_symmetric_t *mbedtls_context =
            (sss_mbedtls_symmetric_t *)context;
        return sss_mbedtls_cipher_update(
            mbedtls_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_symmetric_t *openssl_context =
            (sss_openssl_symmetric_t *)context;
        return sss_openssl_cipher_update(
            openssl_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
    ...
    size_t *destLen)
{
    ...
    if (SSS_SYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_symmetric_t *se05x_context = (sss_se05x_symmetric_t *)context;
        return sss_se05x_cipher_finish(
            se05x_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_symmetric_t *mbedtls_context =
            (sss_mbedtls_symmetric_t *)context;
        return sss_mbedtls_cipher_finish(
            mbedtls_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_symmetric_t *openssl_context =
            (sss_openssl_symmetric_t *)context;
        return sss_openssl_cipher_finish(
            openssl_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
    ...
    size_t *szLeft)
{
    ...
    if (SSS_SYMMETRIC_TYPE_IS_SSCP(context)) {
        sss_sscp_symmetric_t *sscp_context = (sss_sscp_symmetric_t *)context;
        return sss_sscp_cipher_crypt_ctr(sscp_context,
            srcData,
            destData,
            size,
            initialCounter,
    ...
    if (SSS_SYMMETRIC_TYPE_IS_SE05X(context)) {
        sss_se05x_symmetric_t *se05x_context = (sss_se05x_symmetric_t *)context;
        return sss_se05x_cipher_crypt_ctr(se05x_context,
            srcData,
            destData,
            size,
            initialCounter,
    ...
    if (SSS_SYMMETRIC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_symmetric_t *mbedtls_context =
            (sss_mbedtls_symmetric_t *)context;
        return sss_mbedtls_cipher_crypt_ctr(mbedtls_context,
            srcData,
            destData,
            size,
            initialCounter,
    ...
    if (SSS_SYMMETRIC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_symmetric_t *openssl_context =
            (sss_openssl_symmetric_t *)context;
        return sss_openssl_cipher_crypt_ctr(openssl_context,
            srcData,
            destData,
            size,
            initialCounter,
    ...
    sss_mode_t mode)
{
    ...
    if (SSS_AEAD_TYPE_IS_SE05X(context)) {
        ...
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_aead_context_init(
            se05x_context, se05x_session, se05x_keyObject, algorithm, mode);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_AEAD_TYPE_IS_MBEDTLS(context)) {
        ...
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_aead_context_init(mbedtls_context,
            mbedtls_session,
            mbedtls_keyObject,
            algorithm,
            mode);
    ...
    if (SSS_AEAD_TYPE_IS_OPENSSL(context)) {
        ...
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_aead_context_init(openssl_context,
            openssl_session,
            openssl_keyObject,
            algorithm,
            mode);
    ...
    size_t *tagLen)
{
    ...
    if (SSS_AEAD_TYPE_IS_SSCP(context)) {
        sss_sscp_aead_t *sscp_context = (sss_sscp_aead_t *)context;
        return sss_sscp_aead_one_go(sscp_context,
            srcData,
            destData,
            size,
            nonce,
    ...
    if (SSS_AEAD_TYPE_IS_SE05X(context)) {
        sss_se05x_aead_t *se05x_context = (sss_se05x_aead_t *)context;
        return sss_se05x_aead_one_go(se05x_context,
            srcData,
            destData,
            size,
            nonce,
    ...
    if (SSS_AEAD_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_aead_t *mbedtls_context = (sss_mbedtls_aead_t *)context;
        return sss_mbedtls_aead_one_go(mbedtls_context,
            srcData,
            destData,
            size,
            nonce,
    ...
    if (SSS_AEAD_TYPE_IS_OPENSSL(context)) {
        sss_openssl_aead_t *openssl_context = (sss_openssl_aead_t *)context;
        return sss_openssl_aead_one_go(openssl_context,
            srcData,
            destData,
            size,
            nonce,
    ...
    size_t payloadLen)
{
    ...
    if (SSS_AEAD_TYPE_IS_SSCP(context)) {
        sss_sscp_aead_t *sscp_context = (sss_sscp_aead_t *)context;
        return sss_sscp_aead_init(
            sscp_context, nonce, nonceLen, tagLen, aadLen, payloadLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_AEAD_TYPE_IS_SE05X(context)) {
        sss_se05x_aead_t *se05x_context = (sss_se05x_aead_t *)context;
        return sss_se05x_aead_init(
            se05x_context, nonce, nonceLen, tagLen, aadLen, payloadLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_AEAD_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_aead_t *mbedtls_context = (sss_mbedtls_aead_t *)context;
        return sss_mbedtls_aead_init(
            mbedtls_context, nonce, nonceLen, tagLen, aadLen, payloadLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_AEAD_TYPE_IS_OPENSSL(context)) {
        sss_openssl_aead_t *openssl_context = (sss_openssl_aead_t *)context;
        return sss_openssl_aead_init(
            openssl_context, nonce, nonceLen, tagLen, aadLen, payloadLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_aead_t *context, const uint8_t *aadData, size_t aadDataLen)
{
    ...
    if (SSS_AEAD_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_aead_t *mbedtls_context = (sss_mbedtls_aead_t *)context;
        return sss_mbedtls_aead_update_aad(
            mbedtls_context, aadData, aadDataLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_AEAD_TYPE_IS_OPENSSL(context)) {
        sss_openssl_aead_t *openssl_context = (sss_openssl_aead_t *)context;
        return sss_openssl_aead_update_aad(
            openssl_context, aadData, aadDataLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t *destLen)
{
    ...
    if (SSS_AEAD_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_aead_t *mbedtls_context = (sss_mbedtls_aead_t *)context;
        return sss_mbedtls_aead_update(
            mbedtls_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_AEAD_TYPE_IS_OPENSSL(context)) {
        sss_openssl_aead_t *openssl_context = (sss_openssl_aead_t *)context;
        return sss_openssl_aead_update(
            openssl_context, srcData, srcLen, destData, destLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
    ...
    size_t *tagLen)
{
    ...
    if (SSS_AEAD_TYPE_IS_SSCP(context)) {
        sss_sscp_aead_t *sscp_context = (sss_sscp_aead_t *)context;
        return sss_sscp_aead_finish(
            sscp_context, srcData, srcLen, destData, destLen, tag, tagLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_AEAD_TYPE_IS_SE05X(context)) {
        sss_se05x_aead_t *se05x_context = (sss_se05x_aead_t *)context;
        return sss_se05x_aead_finish(
            se05x_context, srcData, srcLen, destData, destLen, tag, tagLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_AEAD_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_aead_t *mbedtls_context = (sss_mbedtls_aead_t *)context;
        return sss_mbedtls_aead_finish(
            mbedtls_context, srcData, srcLen, destData, destLen, tag, tagLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_AEAD_TYPE_IS_OPENSSL(context)) {
        sss_openssl_aead_t *openssl_context = (sss_openssl_aead_t *)context;
        return sss_openssl_aead_finish(
            openssl_context, srcData, srcLen, destData, destLen, tag, tagLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_mode_t mode)
{
    ...
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        ...
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        sss_se05x_object_t *se05x_keyObject = (sss_se05x_object_t *)keyObject;
        return sss_se05x_mac_context_init(
            se05x_context, se05x_session, se05x_keyObject, algorithm, mode);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        ...
        sss_mbedtls_object_t *mbedtls_keyObject =
            (sss_mbedtls_object_t *)keyObject;
        return sss_mbedtls_mac_context_init(mbedtls_context,
            mbedtls_session,
            mbedtls_keyObject,
            algorithm,
            mode);
    ...
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        ...
        sss_openssl_object_t *openssl_keyObject =
            (sss_openssl_object_t *)keyObject;
        return sss_openssl_mac_context_init(openssl_context,
            openssl_session,
            openssl_keyObject,
            algorithm,
            mode);
    ...
    size_t *macLen)
{
    ...
    if (SSS_MAC_TYPE_IS_SSCP(context)) {
        sss_sscp_mac_t *sscp_context = (sss_sscp_mac_t *)context;
        return sss_sscp_mac_one_go(
            sscp_context, message, messageLen, mac, macLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_MAC_TYPE_IS_SE05X(context)) {
        sss_se05x_mac_t *se05x_context = (sss_se05x_mac_t *)context;
        return sss_se05x_mac_one_go(
            se05x_context, message, messageLen, mac, macLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_MAC_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_mac_t *mbedtls_context = (sss_mbedtls_mac_t *)context;
        return sss_mbedtls_mac_one_go(
            mbedtls_context, message, messageLen, mac, macLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_MAC_TYPE_IS_OPENSSL(context)) {
        sss_openssl_mac_t *openssl_context = (sss_openssl_mac_t *)context;
        return sss_openssl_mac_one_go(
            openssl_context, message, messageLen, mac, macLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    sss_mode_t mode)
{
    ...
    if (SSS_SESSION_TYPE_IS_SSCP(session)) {
        ...
        sss_sscp_session_t *sscp_session = (sss_sscp_session_t *)session;
        return sss_sscp_digest_context_init(
            sscp_context, sscp_session, algorithm, mode);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        ...
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
        return sss_se05x_digest_context_init(
            se05x_context, se05x_session, algorithm, mode);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        ...
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
        return sss_mbedtls_digest_context_init(
            mbedtls_context, mbedtls_session, algorithm, mode);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        ...
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
        return sss_openssl_digest_context_init(
            openssl_context, openssl_session, algorithm, mode);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
    ...
    size_t *digestLen)
{
    ...
    if (SSS_DIGEST_TYPE_IS_SSCP(context)) {
        sss_sscp_digest_t *sscp_context = (sss_sscp_digest_t *)context;
        return sss_sscp_digest_one_go(
            sscp_context, message, messageLen, digest, digestLen);
    }
#endif /* SSS_HAVE_SSCP */
#if SSS_HAVE_SE05X
    if (SSS_DIGEST_TYPE_IS_SE05X(context)) {
        sss_se05x_digest_t *se05x_context = (sss_se05x_digest_t *)context;
        return sss_se05x_digest_one_go(
            se05x_context, message, messageLen, digest, digestLen);
    }
#endif /* SSS_HAVE_SE05X */
#if SSS_HAVE_MBEDTLS
    if (SSS_DIGEST_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_digest_t *mbedtls_context = (sss_mbedtls_digest_t *)context;
        return sss_mbedtls_digest_one_go(
            mbedtls_context, message, messageLen, digest, digestLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_DIGEST_TYPE_IS_OPENSSL(context)) {
        sss_openssl_digest_t *openssl_context = (sss_openssl_digest_t *)context;
        return sss_openssl_digest_one_go(
            openssl_context, message, messageLen, digest, digestLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
...
#if SSS_HAVE_SSCP
    if (SSS_SESSION_TYPE_IS_SSCP(session)) {
        sss_sscp_rng_context_t *sscp_context =
            (sss_sscp_rng_context_t *)context;
        sss_sscp_session_t *sscp_session = (sss_sscp_session_t *)session;
...
#if SSS_HAVE_SE05X
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        sss_se05x_rng_context_t *se05x_context =
            (sss_se05x_rng_context_t *)context;
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
...
#if SSS_HAVE_MBEDTLS
    if (SSS_SESSION_TYPE_IS_MBEDTLS(session)) {
        sss_mbedtls_rng_context_t *mbedtls_context =
            (sss_mbedtls_rng_context_t *)context;
        sss_mbedtls_session_t *mbedtls_session =
            (sss_mbedtls_session_t *)session;
...
#if SSS_HAVE_OPENSSL
    if (SSS_SESSION_TYPE_IS_OPENSSL(session)) {
        sss_openssl_rng_context_t *openssl_context =
            (sss_openssl_rng_context_t *)context;
        sss_openssl_session_t *openssl_session =
            (sss_openssl_session_t *)session;
    ...
    sss_rng_context_t *context, uint8_t *random_data, size_t dataLen)
{
    ...
    if (SSS_RNG_CONTEXT_TYPE_IS_MBEDTLS(context)) {
        sss_mbedtls_rng_context_t *mbedtls_context =
            (sss_mbedtls_rng_context_t *)context;
        return sss_mbedtls_rng_get_random(
            mbedtls_context, random_data, dataLen);
    }
#endif /* SSS_HAVE_MBEDTLS */
#if SSS_HAVE_OPENSSL
    if (SSS_RNG_CONTEXT_TYPE_IS_OPENSSL(context)) {
        sss_openssl_rng_context_t *openssl_context =
            (sss_openssl_rng_context_t *)context;
        return sss_openssl_rng_get_random(
            openssl_context, random_data, dataLen);
    }
#endif /* SSS_HAVE_OPENSSL */
    return kStatus_SSS_InvalidArgument;
}
...
#if SSS_HAVE_SE05X
    if (SSS_SESSION_TYPE_IS_SE05X(session)) {
        sss_se05x_tunnel_context_t *se05x_context =
            (sss_se05x_tunnel_context_t *)context;
        sss_se05x_session_t *se05x_session = (sss_se05x_session_t *)session;
