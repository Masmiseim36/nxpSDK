...
#       define sss_open_session(session,subsystem,additionalApplicationId,connectionMethod,connectionData) \
            sss_openssl_open_session(((sss_openssl_session_t * ) session),(subsystem),(additionalApplicationId),(connectionMethod),(connectionData))
#       define sss_close_session(session) \
            sss_openssl_close_session(((sss_openssl_session_t * ) session))
        /* Direct Call : keyobj */
...
#       define sss_key_object_allocate_handle(keyObject,keyId,keyType,keyByteLenMax,options) \
            sss_openssl_key_object_allocate_handle(((sss_openssl_object_t * ) keyObject),(keyId),(keyType),(keyByteLenMax),(options))
...
#       define sss_derive_key(context,saltData,saltLen,info,infoLen,derivedKeyObject) \
            sss_openssl_derive_key(((sss_openssl_derive_key_t * ) context),(saltData),(saltLen),(info),(infoLen),((sss_openssl_object_t * ) derivedKeyObject))
#       define sss_asymmetric_dh_derive_key(context,otherPartyKeyObject,derivedKeyObject) \
            sss_openssl_asymmetric_dh_derive_key(((sss_openssl_derive_key_t * ) context),((sss_openssl_object_t * ) otherPartyKeyObject),((sss_openssl_object_t * ) derivedKeyObject))
...
#       define sss_key_store_set_key(keyStore,keyObject,key,keyBitLen,options,optionsLen) \
            sss_openssl_key_store_set_key(((sss_openssl_key_store_t * ) keyStore),((sss_openssl_object_t * ) keyObject),(key),(keyBitLen),(options),(optionsLen))
...
#       define sss_key_store_get_key(keyStore,keyObject,key,pKeyBitLen) \
            sss_openssl_key_store_get_key(((sss_openssl_key_store_t * ) keyStore),((sss_openssl_object_t * ) keyObject),(key),(pKeyBitLen))
