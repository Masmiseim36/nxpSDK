    ...
    psa_algorithm_t alg )
{
    ...
    //NXP TFM if( psa_key_lifetime_is_external( (*p_slot)->attr.lifetime ) )
...
//NXP TFM    status = psa_key_agreement_raw_internal( alg, slot,
//NXP TFM                                             peer_key, peer_key_length,
//NXP TFM                                             output, output_size,
//NXP TFM                                             output_length );
    psa_key_attributes_t attributes = {                                         //NXP TFM
      .core = slot->attr                                                        //NXP TFM
    };                                                                          //NXP TFM

    status = psa_driver_wrapper_key_agreement( alg, &attributes,                //NXP TFM
                                               slot->key.data,                  //NXP TFM
                                               slot->key.bytes,                 //NXP TFM
                                               peer_key, peer_key_length,       //NXP TFM
                                               output, output_size,             //NXP TFM
                                               output_length );                 //NXP TFM
 
    if (status == PSA_ERROR_NOT_SUPPORTED)                                      //NXP TFM
    {                                                                           //NXP TFM
        status = psa_key_agreement_raw_internal( alg, slot,                     //NXP TFM
                                                 peer_key, peer_key_length,     //NXP TFM
                                                 output, output_size,           //NXP TFM
                                                 output_length );               //NXP TFM
    }                                                                           //NXP TFM
...
psa_status_t psa_crypto_init( void )
{
    ...
    /* Init drivers */                      //NXP TFM
    status = psa_driver_wrapper_init( );    //NXP TFM
...
//NXP TFM    /* Init drivers */
//NXP TFM    status = psa_driver_wrapper_init( );
//NXP TFM    if( status != PSA_SUCCESS )
//NXP TFM        goto exit;
