...
enum tfm_plat_err_t tfm_plat_get_boot_seed(uint32_t size, uint8_t *buf)
{
    ...
    //DM LOG_MSG("\r\n BOOT_SEED = [0x%x,0x%x,0x%x,0x%x,0x%x,0x%x,0x%x,0x%x]\r\n", SYSCON->BOOT_SEED_REG0, SYSCON->BOOT_SEED_REG1, SYSCON->BOOT_SEED_REG2, SYSCON->BOOT_SEED_REG3, SYSCON->BOOT_SEED_REG4, SYSCON->BOOT_SEED_REG5, SYSCON->BOOT_SEED_REG6, SYSCON->BOOT_SEED_REG7);
