...
#define FLASH_S_PARTITION_SIZE                (0x40000 - 0x1000)    /* S partition: 256 kB - 4KB Offset */
...
#define FLASH_PS_AREA_SIZE             (0x64000)   /* 400 KB */

/* Internal Trusted Storage (ITS) Service definitions */
#define FLASH_ITS_AREA_OFFSET           (FLASH_PS_AREA_OFFSET + \
                                         FLASH_PS_AREA_SIZE)
#define FLASH_ITS_AREA_SIZE             (0x64000)   /* 400 KB */
...
#define PS_SECTORS_PER_BLOCK   (0x3)
...
#define ITS_SECTORS_PER_BLOCK   (0x3)
/* Specifies the smallest flash programmable unit in bytes */
