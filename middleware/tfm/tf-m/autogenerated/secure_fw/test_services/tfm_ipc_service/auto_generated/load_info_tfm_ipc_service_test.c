...
const struct partition_tfm_sp_ipc_service_test_load_info_t tfm_sp_ipc_service_test_load
    ...
    .services = {
        ...
        {
            .name_strid             = STRING_PTR_TO_STRID("IPC_SERVICE_TEST_CLIENT_ID_TRANSLATE"),
            .sfn                    = 0,
...
#if defined(__ICCARM__)
#pragma location=".bss.part_runtime_priority_03"
__root
#endif /* __ICCARM__ */
static struct partition_t tfm_sp_ipc_service_test_partition_runtime_item
    __attribute__((used, section(".bss.part_runtime_priority_03")));
#if defined(__ICCARM__)
#pragma location = ".bss.serv_runtime_priority_03"
__root
#endif /* __ICCARM__ */
static struct service_t tfm_sp_ipc_service_test_service_runtime_item[TFM_SP_IPC_SERVICE_TEST_NSERVS]
    __attribute__((used, section(".bss.serv_runtime_priority_03")));
