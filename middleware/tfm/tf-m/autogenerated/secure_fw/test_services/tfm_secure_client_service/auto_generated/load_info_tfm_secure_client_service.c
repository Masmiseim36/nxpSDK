...
#define TFM_SP_SECURE_TEST_PARTITION_NDEPS                      (22)
...
#if defined(__ICCARM__)
#pragma location=".bss.part_runtime_priority_01"
__root
#endif /* __ICCARM__ */
static struct partition_t tfm_sp_secure_test_partition_partition_runtime_item
    __attribute__((used, section(".bss.part_runtime_priority_01")));
#if defined(__ICCARM__)
#pragma location = ".bss.serv_runtime_priority_01"
__root
#endif /* __ICCARM__ */
static struct service_t tfm_sp_secure_test_partition_service_runtime_item[TFM_SP_SECURE_TEST_PARTITION_NSERVS]
    __attribute__((used, section(".bss.serv_runtime_priority_01")));
