 ...
 */
//DM #define MBEDTLS_PK_PARSE_C       //NXP avoid compilation error caused by new PSA configuration
 ...
 */
//DM #define MBEDTLS_PK_WRITE_C       //NXP avoid compilation error caused by new PSA configuration
