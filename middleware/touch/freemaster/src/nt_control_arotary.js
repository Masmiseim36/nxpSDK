...
function NTControl_arotary(symbol, addr)
{
    ...
    pcm_define_symbol(this._symbol + "->data", pcm.LastVariable_vValue, "nt_control_arotary_data");

    pcm_read_ptr(this._symbol + "->rom->control_params");
    pcm_define_symbol(this._symbol + "->rom->control_params", pcm.LastVariable_vValue, "nt_control_arotary*");
...
NTControl_arotary.prototype.GetRange = function()
{
    return this._range;
}

NTControl_arotary.prototype.GetPosition = function()
{
...
NTControl_arotary.prototype.GetGuiTag = function()
{
    var str = "";
...
NTControl_arotary.prototype.GetGuiTags = function()
{
    var str = "";
...
NTControl_arotary.prototype.GetGuiTagsLabels = function()
{
    var str = "";
...
NTControl_arotary.prototype.UpdateGui = function()
{
...
NTControl_arotary.prototype.DefinePositionVariable = function(vname)
{
    return pcm_define_variable(vname, this._symbol + "->data.position");
}

NTControl_arotary.prototype.OnLinkClicked = function()
{
    ...
    def["href"] = DOC_PATH+"group__arotary.html#details";
