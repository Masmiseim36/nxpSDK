 ...
 */
 ...
 /* NTControl_slider class */

function NTControl_slider(symbol, addr)
{
    ...
    this._gui_id0 = get_unique_id(); // slider image
    this._range = this._electrodes.length * 2 - 2;

    // define RAM type
    pcm_read_ptr(this._symbol + "->data");
    pcm_define_symbol(this._symbol + "->data", pcm.LastVariable_vValue, "nt_control_slider_data");

    debug_print("The Slider Control has been Created.", false);
}

NTControl_slider.prototype.GetRange = function()
{
    return this._range;
}

NTControl_slider.prototype.GetPosition = function()
{
...
NTControl_slider.prototype.GetGuiTag = function()
{
    var str = "";
...
NTControl_slider.prototype.GetGuiTagsLabels = function()
{
    var str = "";
...
NTControl_slider.prototype.GetGuiTags = function()
{
...
NTControl_slider.prototype.UpdateGui = function()
{
    ...
    if(kobj)
        kobj.innerHTML = pos.toString(10);

    kobj = document.getElementById(this._gui_id0+"range");    
    if(kobj)
        kobj.innerHTML = rng.toString(10);

    kobj = document.getElementById(this._gui_id0+"Touch");    
    if(kobj)
    {
        kobj.src = (flags & (1<<19)) ? "images/gui_yes.png" : "images/gui_yes_hidden.png"; 
    }

    kobj = document.getElementById(this._gui_id0+"Movement");    
    if(kobj)
    {
        kobj.src = (flags & (1<<18)) ? "images/gui_arrow_move.png" : "images/gui_arrow_move_hidden.png"; 
    }

    kobj = document.getElementById(this._gui_id0+"Direction");    
    if(kobj)
    {
        kobj.src = (flags & (1<<17)) ? "images/gui_dir_right.png" : "images/gui_dir_left.png"; 
    }

    kobj = document.getElementById(this._gui_id0+"Invalid");    
    if(kobj)
    {
        kobj.src = (flags & (1<<16)) ? "images/gui_warning.png" : "images/gui_warning_hidden.png"; 
    }       
}

NTControl_slider.prototype.DefinePositionVariable = function(vname)
{
    return pcm_define_variable(vname, this._symbol + "->data.position");
}

NTControl_slider.prototype.OnLinkClicked = function()
{
    ...
    def["href"] = DOC_PATH+"group__slider.html#details";
