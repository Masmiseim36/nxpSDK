 ...
 */
 ...
 /* NTElectrode_safa class */
  
function NTElectrode_safa(module, symbol, addr, type)
{
...
NTElectrode_safa.prototype.OnLinkClicked = function()
{
    ...
    var vname_deadband_l = this._name + "_deadband_l";
    ...
    var ok =
        ...
        this.DefineDeadBandLowVariable(vname_deadband_l);
    ...
    var vars = [ 
        ...
        {"variable":vname_deadband_l, "visible":true, "color":9055202, "y_block":0 },
        {"variable":vname_noise, "visible":true, "color":2104737, "y_block":1 },
        {"variable":vname_evnt_cnt, "visible":true, "color":9514086, "y_block":2 },
        {"variable":vname_deadband, "visible":true, "color":16766720, "y_block":2 },
    ]; 
...
NTElectrode_safa.prototype.GetKeydetGui = function(shieldding)
{
  var str = "";
...
NTElectrode_safa.prototype.UpdateGuiKeydetRaw = function(shieldding)
{
