 ...
 *     .gesture = (nt_points64 []){{{0x0BA9977555533211,0x0BBA987765443221},{0x0000000000000000,0x0000000000000000}},// gesture "\" 
 *                                {{0x0000001111223578,0x000000567889ABAA},{0x0000000000000000,0x0000000000000000}}, // gesture "O" 
 *                                {{0x00000BAAABBBBAA9,0x00000BBA98765422},{0x0000000000000000,0x0000000000000000}}, // gesture "Z" 
 *                                {{0x0022222222222211,0x00BABA987654322B},{0x009AAAAAAAAAAAA9,0x009AAAAAAAAAAAA9}}, // gesture "=" 
 *                                {{0,0},{0,0}}},             
 *  };
 *
