 ...
 *
 * The uSafa key detector is a method for recognition of the touch or release states. It can be used for each type of control.
 *
 ...
 * released to touched, and changing from touched to released. The method uses moving average filters to determine the baseline and expected signal values 
