...
extern int rwl_read_eth_port(void* hndle, char* read_buf, unsigned int data_size, unsigned int *numread);
extern int rwl_write_eth_port(void* hndle, char* write_buf, unsigned long size, unsigned long *numwritten);
#endif
