 ...
 *
 * $Id: 802.11.h 547010 2015-04-07 09:16:13Z danielh $
 */
...
#define MGMT_AUTH_LT    0x1
#define MGMT_ASSOC_LT	0x2
#endif
...
BWL_PRE_PACKED_STRUCT struct dot11_ftm_range_entry {
	...
	struct ether_addr bssid;
	uint16 range_lo;		/* 3 bytes in 1/256m units */
	uint8  range_hi;
	uint16 max_err;
	uint8  rsvd;
} BWL_POST_PACKED_STRUCT;
...
#define TDLS_VENDR_SPECIFIC	221
#define WFDIE_VENDR_TYPE	0x506f9a0a
