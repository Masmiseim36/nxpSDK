 ...
 *
 * $Id: bcmdefs.h 514055 2014-11-08 18:42:49Z sudhirbs $
 */
...
#else
/* Included offload to support 4360 firmware (SROM12 defined) */
#if (defined(SROM12) || (defined(WLOFFLD) && defined(WL_TOF)))
