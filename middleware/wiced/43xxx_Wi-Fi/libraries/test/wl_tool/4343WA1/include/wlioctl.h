 ...
 *
 * $Id: wlioctl.h 547010 2015-04-07 09:16:13Z danielh $
 */
...
enum wl_nan_cmd_xtlv_id {
	...
	WL_NAN_XTLV_PEER_INSTANCE_ID = 0x131,   /* Identifies peer publish or subscribe instance */
...
#define WL_NAN_RANGE_LIMITED           0x0020
...
#define WL_P2P_NAN_DEVICE_P2P  0x1
#define WL_P2P_NAN_DEVICE_GO   0x2
#define WL_P2P_NAN_DEVICE_GC   0x4

enum wl_nan_avail_resolution {
	WL_NAN_AVAIL_RES_16TU = 0,
	WL_NAN_AVAIL_RES_32TU = 1,
	WL_NAN_AVAIL_RES_64TU = 2
};
...
typedef struct p2p_nan_config {
	...
	uint32 flags;                   /* flags */
	wl_nan_instance_id_t inst_id;   /* publisher/subscriber id */
...
typedef struct wl_nan_svc_inst_list {
	uint16 version;                 /* wl_nan_service_instance_t structure version */
	uint16 len;                     /* total length */
	uint32 count;                   /* service instane count */
	wl_nan_svc_inst_t svc[1]; /* svc list */
...
typedef BWL_PRE_PACKED_STRUCT struct wl_proxd_tlv_id_list {
	uint16			num_ids;
	uint16			ids[1];
...
/* ROAM OFFLOAD modes */
#define ROAMOFFL_ON_BSSID_LIST		1
#define ROAMOFFL_BY_DEFAULT			2
