/** @file wlan_enhanced_tests_murata_1XK_JP.h
 *
 *  @brief  This file provides JP TX powers for Murata 1XK WLAN ENHANCED Test
 *
            ...
            .txpwrlimit_config[0] =
                {
                    ...
                    .txpwrlimit_entry = {{0, 16}, {1, 17}, {2, 16}, {3, 16}, {4, 16}, {5, 15}, {6, 15}},
                },
            .txpwrlimit_config[1] =
                {
                    .num_mod_grps = 7,
