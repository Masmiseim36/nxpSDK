/** @file wlan_enhanced_tests_murata_1XK_US.h
 *
 *  @brief  This file provides US TX powers for Murata 1XK WLAN ENHANCED Test
 *
            ...
            .txpwrlimit_config[0] =
                {
                    ...
                    .txpwrlimit_entry = {{0, 17}, {1, 14}, {2, 14}, {3, 14}, {4, 13}, {5, 13}, {6, 13}},
                },
            .txpwrlimit_config[1] =
                {
                    .num_mod_grps = 7,
            ...
            .txpwrlimit_config[3] =
                {
                    ...
                    .txpwrlimit_entry = {{0, 17}, {1, 17}, {2, 16}, {3, 16}, {4, 16}, {5, 15}, {6, 15}},
                },
            .txpwrlimit_config[4] =
                {
                    .num_mod_grps = 7,
