...
#OR Logic component
if(CONFIG_USE_middleware_wifi_sdio_MIMXRT1062)
     include(middleware_wifi_sdio_MIMXRT1062)
endif()
if(CONFIG_USE_middleware_wifi_fwdnld_MIMXRT1062)
     include(middleware_wifi_fwdnld_MIMXRT1062)
endif()
if(CONFIG_USE_middleware_wifi_imu_MIMXRT1062)
     include(middleware_wifi_imu_MIMXRT1062)
endif()
if(CONFIG_USE_middleware_wifi_common_files_MIMXRT1062)
     include(middleware_wifi_common_files_MIMXRT1062)
endif()
if(NOT (CONFIG_USE_middleware_wifi_sdio_MIMXRT1062 OR CONFIG_USE_middleware_wifi_fwdnld_MIMXRT1062 OR CONFIG_USE_middleware_wifi_imu_MIMXRT1062 OR CONFIG_USE_middleware_wifi_common_files_MIMXRT1062))
    message(WARNING "Since middleware_wifi_sdio_MIMXRT1062/middleware_wifi_fwdnld_MIMXRT1062/middleware_wifi_imu_MIMXRT1062/middleware_wifi_common_files_MIMXRT1062 is not included at first or config in config.cmake file, use middleware_wifi_sdio_MIMXRT1062/middleware_wifi_fwdnld_MIMXRT1062 by default.")
    include(middleware_wifi_sdio_MIMXRT1062)
    include(middleware_wifi_fwdnld_MIMXRT1062)
endif()
