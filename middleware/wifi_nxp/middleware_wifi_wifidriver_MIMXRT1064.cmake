...
#OR Logic component
if(CONFIG_USE_middleware_wifi_sdio_MIMXRT1064)
     include(middleware_wifi_sdio_MIMXRT1064)
endif()
if(CONFIG_USE_middleware_wifi_fwdnld_MIMXRT1064)
     include(middleware_wifi_fwdnld_MIMXRT1064)
endif()
if(CONFIG_USE_middleware_wifi_imu_MIMXRT1064)
     include(middleware_wifi_imu_MIMXRT1064)
endif()
if(CONFIG_USE_middleware_wifi_common_files_MIMXRT1064)
     include(middleware_wifi_common_files_MIMXRT1064)
endif()
if(NOT (CONFIG_USE_middleware_wifi_sdio_MIMXRT1064 OR CONFIG_USE_middleware_wifi_fwdnld_MIMXRT1064 OR CONFIG_USE_middleware_wifi_imu_MIMXRT1064 OR CONFIG_USE_middleware_wifi_common_files_MIMXRT1064))
    message(WARNING "Since middleware_wifi_sdio_MIMXRT1064/middleware_wifi_fwdnld_MIMXRT1064/middleware_wifi_imu_MIMXRT1064/middleware_wifi_common_files_MIMXRT1064 is not included at first or config in config.cmake file, use middleware_wifi_sdio_MIMXRT1064/middleware_wifi_fwdnld_MIMXRT1064 by default.")
    include(middleware_wifi_sdio_MIMXRT1064)
    include(middleware_wifi_fwdnld_MIMXRT1064)
endif()
