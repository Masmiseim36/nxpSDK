...
typedef enum
{
    ...
    gBleGapCmdReadControllerLocalRPAOpCode_c,                               /*! Gap_ReadLocalPrivateAddress command operation code */
    ...
    gBleGapCmdGetDeviceIdFromConnHandleOpCode_c,                            /*! Gap_GetDeviceIdFromConnHandle command operation code */
    gBleGapCmdGetConnectionHandleFromDeviceIdOpCode_c,                      /*! Gap_GetConnectionHandleFromDeviceId command operation code */
    ...
    gBleGapEvtGenericEventPeriodicAdvertisingStateChangedOpCode_c,          /*! gapGenericCallback  (type = gPeriodicAdvertisingStateChanged_c) event operation code */
    ...
    gBleGapEvtGenericEventControllerLocalRPAReadOpCode_c,                   /*! gapGenericCallback (type = gLocalPrivateAddressRead_c) event operation code */

    gBleGapEvtCheckNvmIndexOpCode_c,                                        /*! Gap_CheckNvmIndex command out parameters event operation code */
    gBleGapEvtGetDeviceIdFromConnHandleOpCode_c,                            /*! Gap_GetDeviceIdFromConnHandle command operation code */
    gBleGapEvtGetConnectionHandleFromDeviceIdOpCode_c,                      /*! Gap_GetConnectionHandleFromDeviceId command operation code */
}fsciBleGapOpCode_t;
