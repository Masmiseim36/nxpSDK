...
typedef enum bleResult_tag
{
    ...
    */
    ...
    gBleReassemblyInProgress_c                                  = gBleStatusBase_c | 0x0BU,  /*!< HCI Packet reassembly was in progress. The old packed was discarded */
...
typedef enum {
    ...
    gPeriodicAdvertisingStateChanged_c,         /*!< Periodic advertising has been successfully enabled or disabled. */
...
typedef enum {
    ...
    gHciDataDiscardedAlloc_c,
    gHciDataDiscardedInvalidStateParam_c
