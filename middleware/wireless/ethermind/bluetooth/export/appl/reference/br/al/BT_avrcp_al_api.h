...
/* --------------------------------------------- Global Definitions */
#define     AVRCP_AL_FIXED_CMD_LEN_UNIT_INFO           (AVRCP_COMMAND_HDR_LEN + 5U)
#define     AVRCP_AL_FIXED_CMD_LEN_PASSTHROUGH         (AVRCP_COMMAND_HDR_LEN + 2U)
#define     AVRCP_AL_FIXED_CMD_LEN_VU_PASSTHROUGH      (AVRCP_COMMAND_HDR_LEN + 7U)

#define     AVRCP_AL_MAX_AVC_PACKET_LEN                512U
