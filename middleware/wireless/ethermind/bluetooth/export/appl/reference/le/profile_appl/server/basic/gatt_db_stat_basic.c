 ...
 *  --------+--------------------+------------------+---------------------
 *  0x0003  |       0x2A00       | Rd               | MindtreeBasicGattDB
 *  --------+--------------------+------------------+---------------------
 ...
 *  --------+--------------------+------------------+---------------------
 *  0x0013  |       0x2A24       | Rd               | GATT-DB-1.0.0
 *  --------+--------------------+------------------+---------------------
...
DECL_CONST UCHAR gatt_const_value_arr[GATT_CONST_VALUE_ARRAY_SIZE] =
{
    ...
    /* 5 - DeviceName(0); Default: MindtreeBasicGattDB */
    0x4DU, 0x69U, 0x6EU, 0x64U, 0x74U, 0x72U, 0x65U, 0x65U, 0x42U, 0x61U, 0x73U, 0x69U,
    0x63U, 0x47U, 0x61U, 0x74U, 0x74U, 0x44U, 0x42U,

    /* 24 - Appearance(1); Property: 0x02, Value Handle: 0x0005, UUID: 0x2A01 */
    0x02U, 0x05U, 0x00U, 0x01U, 0x2AU,

    /* 29 - Appearance(1); Default: 768.0 */
    0x03U, 0x00U,
    ...
    /* 53 - ManufacturerName(4); Default: Mindtree Limited. */
    ...
    /* 75 - ModelNumber(5); Default: GATT-DB-1.0.0 */
    0x47U, 0x41U, 0x54U, 0x54U, 0x2DU, 0x44U, 0x42U, 0x2DU, 0x31U, 0x2EU, 0x30U, 0x2EU,
    0x30U,
...
DECL_CONST GATT_DB_DESC_DATA gatt_db_attr_table[GATT_DB_MAX_ATTRIBUTES] =
{
    ...
    /* 3 - BatteryLevel - Characteristic Declaration */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[36U]),
    },
    ...
    /* Characteristic 3 - BatteryLevel - Presentation Format */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[41U]),
    },
    ...
    /* 4 - ManufacturerName - Characteristic Declaration */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[48U]),
    },
...
#endif /* ((defined BASIC) && (defined GATT_DB)) */
