...
{
    {
         ...
         *      Cycling Power Meter Service (0x1818)
         */
        0x07U, 0x03U, 0x0FU, 0x18U, 0x0AU, 0x18U, 0x18U, 0x18U,

        /**
         *  Shortened Device Name: Mt-CPMS
         */
        0x08U, 0x08U, 'M', 't', '-', 'C', 'P', 'M', 'S',

        /**
         * Appearance: Cycling: Power Sensor
         */
        0x03U, 0x19U, 0x84U, 0x04U,
