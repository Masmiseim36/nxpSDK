...
/* Service Instances */
UINT16 GATT_SER_CSCS_GAP_INST;
UINT16 GATT_SER_CSCS_GATT_INST;
UINT16 GATT_SER_CSCS_BATTERY_INST;
UINT16 GATT_SER_CSCS_DEV_INFO_INST;
UINT16 GATT_SER_CSCS_CSC_INST;

/* Characteristic Instances */
UINT16 GATT_CHAR_CSCS_BATTERY_LVL_INST;
UINT16 GATT_CHAR_CSCS_CSC_MSRMNT_INST;
UINT16 GATT_CHAR_CSCS_CSC_FEATURE_INST;
UINT16 GATT_CHAR_CSCS_SNSR_LOC_INST;
UINT16 GATT_CHAR_CSCS_SC_CNTRL_PNT_INST;
...
API_RESULT appl_cscs_add_gaps(void)
{
    ...
    {
        APPL_TRC(
            "[CSCS APPL]: BT_gatt_db_add_service() failed. Result: 0x%04X\n",
            retval);
    }
    else
    {
        /* Store the Service Handle in the Global */
        GATT_SER_CSCS_GAP_INST = service_handle;
        /* Device Name */
        ...
        char_value.val         = (UCHAR *)"Mindtree-CSCS";
        ...
        {
            APPL_TRC(
                "[CSCS APPL]: BT_gatt_db_add_characteristic() failed. Result: 0x%04X\n",
                retval);
        }
...
API_RESULT appl_cscs_add_gatts(void)
{
    ...
    {
        /* Store the Service Handle in the Global */
        GATT_SER_CSCS_GATT_INST = service_handle;
        char_uuid.uuid_format   = ATT_16_BIT_UUID_FORMAT;
...
API_RESULT appl_cscs_add_bas(void)
{
    ...
    else
    {
        ...
        GATT_SER_CSCS_BATTERY_INST = service_handle;
        ...
        else
        {
            ...
            GATT_CHAR_CSCS_BATTERY_LVL_INST = char_handle;
...
API_RESULT appl_cscs_add_dis(void)
{
    ...
    else
    {
        ...
        GATT_SER_CSCS_DEV_INFO_INST  = service_handle;
        /* ManufacturerName */
        {
            /* Mindtree Limited */
        ...
        {
            /* CSCS-1.0.0 */
            UCHAR model_number[]   = { 'C', 'S', 'C', 'S', '-', '1', '.', '0', '.', '0' };
            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
...
API_RESULT appl_cscs_add_cscs(void)
{
    ...
    service_info.is_primary        = BT_TRUE;
    service_info.uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
    service_info.uuid.uuid.uuid_16 = GATT_CYCLING_SPEED_AND_CADENCE_SERVICE;
    service_info.link_req          = GATT_DB_SER_SUPPORT_ANY_LINK_TYPE;
    service_info.sec_req           = GATT_DB_SER_NO_SECURITY_PROPERTY;
    ...
    {
        /* Save CSCS Service Instance for future reference */
        GATT_SER_CSCS_CSC_INST = service_handle;

        /* CSC Measurement */
        {
            UCHAR csc_msrmt = 0U;
            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
            char_uuid.uuid.uuid_16 = GATT_CSC_MSRMT_CHARACTERISTIC;

            perm                   = GATT_DB_PERM_NONE;
            property               = GATT_DB_CHAR_NOTIFY_PROPERTY;

            char_value.val         = &csc_msrmt;
            char_value.len         = sizeof(csc_msrmt);
            char_value.actual_len  = char_value.len;
            ...
            {
                /* Save CSC Measurement Characteristic Instance for future reference */
                GATT_CHAR_CSCS_CSC_MSRMNT_INST = char_handle;
            }
        ...
        /* CSC Feature */
        {
            UCHAR csc_feature[2U]   = { 0x07U, 0x00U };

            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
            char_uuid.uuid.uuid_16 = GATT_CSC_FEATURE_CHARACTERISTIC;

            perm                   = GATT_DB_PERM_READ;
            property               = GATT_DB_CHAR_READ_PROPERTY;

            char_value.val         = csc_feature;
            char_value.len         = sizeof(csc_feature);
            char_value.actual_len  = char_value.len;
            ...
            else
            {
                ...
                GATT_CHAR_CSCS_CSC_FEATURE_INST = char_handle;
            }
        }
        ...
        /* Sensor Location */
        {
            ...
            {
                /* Save Characteristic Instance for future reference */
                GATT_CHAR_CSCS_SNSR_LOC_INST = char_handle;
            }
        }
        ...
        /* SC Control Point */
        {
            ...
            char_value.val         = sc_cp;
            char_value.len         = sizeof(sc_cp);
            char_value.actual_len  = char_value.len;
            ...
            else
            {
                ...
                GATT_CHAR_CSCS_SC_CNTRL_PNT_INST = char_handle;
            }
