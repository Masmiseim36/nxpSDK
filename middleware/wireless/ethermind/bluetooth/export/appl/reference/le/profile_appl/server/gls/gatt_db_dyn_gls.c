...
/* Service Instances */
UINT16 GATT_SER_GLS_GAP_INST;
UINT16 GATT_SER_GLS_GATT_INST;
UINT16 GATT_SER_GLS_BATTERY_INST;
UINT16 GATT_SER_GLS_DEV_INFO_INST;
UINT16 GATT_SER_GLS_GLUCOSE_METER_INST;

/* Characteristic Instances */
UINT16 GATT_CHAR_GLS_BATTERY_LVL_INST;
UINT16 GATT_CHAR_GLS_GL_MSRMNT_INST;
UINT16 GATT_CHAR_GLS_GL_CNTXT_INST;
UINT16 GATT_CHAR_GLS_GL_FEATURES_INST;
UINT16 GATT_CHAR_GLS_GL_RACP_INST;
...
API_RESULT appl_gls_add_gaps(void)
{
    ...
    {
        APPL_TRC(
            "[GLS APPL]: BT_gatt_db_add_service() failed. Result: 0x%04X\n",
            retval);
    }
    else
    {
        /* Store the Service Handle in the Global */
        GATT_SER_GLS_GAP_INST = service_handle;
        /* Device Name */
        ...
        char_value.val         = (UCHAR *)"Mindtree-GLS";
        ...
        {
            APPL_TRC(
                "[GLS APPL]: BT_gatt_db_add_characteristic() failed. Result: 0x%04X\n",
                retval);
        }
...
API_RESULT appl_gls_add_gatts(void)
{
    ...
    {
        /* Store the Service Handle in the Global */
        GATT_SER_GLS_GATT_INST  = service_handle;
        char_uuid.uuid_format   = ATT_16_BIT_UUID_FORMAT;
...
API_RESULT appl_gls_add_bas(void)
{
    ...
    else
    {
        ...
        GATT_SER_GLS_BATTERY_INST = service_handle;
        ...
        else
        {
            ...
            GATT_CHAR_GLS_BATTERY_LVL_INST = char_handle;
...
API_RESULT appl_gls_add_dis(void)
{
    ...
    else
    {
        ...
        GATT_SER_GLS_DEV_INFO_INST  = service_handle;
        /* ManufacturerName */
        {
            char_uuid.uuid_format     = ATT_16_BIT_UUID_FORMAT;
        ...
        {
            /* GLS-1.0.0 */
            UCHAR model_number[]   = { 'G', 'L', 'S', '-', '1', '.', '0', '.', '0' };
            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
...
API_RESULT appl_gls_add_gls(void)
{
    ...
    service_info.is_primary        = BT_TRUE;
    service_info.uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
    service_info.uuid.uuid.uuid_16 = GATT_GLUCOSE_SERVICE;
    ...
    {
        /* Save GLS Service Instance for future reference */
        GATT_SER_GLS_GLUCOSE_METER_INST = service_handle;

        /* GlucoseMeasurement */
        {
            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
            char_uuid.uuid.uuid_16 = GATT_GLUCOSE_MSRMNT_CHARACTERISTIC;
            ...
            {
                /* Save Glucose Measurement Characteristic Instance for future reference */
                GATT_CHAR_GLS_GL_MSRMNT_INST = char_handle;
            }
        ...
        {
            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
            char_uuid.uuid.uuid_16 = GATT_GL_MSRMT_CTX_CHARACTERISTIC;
            ...
            {
                /* Save GlucoseContext Characteristic Instance for future reference */
                GATT_CHAR_GLS_GL_CNTXT_INST = char_handle;
            }
        ...
        /* GlucoseFeatures */
        {
            UCHAR gl_feature[2U] = { 0xFFU, 0x07U };

            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
            char_uuid.uuid.uuid_16 = GATT_GL_FEATURE_CHARACTERISTIC;

            perm                   = GATT_DB_PERM_READ;
            property               = GATT_DB_CHAR_READ_PROPERTY;

            char_value.val         = gl_feature;
            char_value.len         = sizeof(gl_feature);
            char_value.actual_len  = char_value.len;
            ...
            else
            {
                ...
                GATT_CHAR_GLS_GL_FEATURES_INST = char_handle;
            }
        }
        ...
        {
            char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
            char_uuid.uuid.uuid_16 = GATT_RACP_CHARACTERISTIC;
            ...
            {
                /* Save Characteristic Instance for future reference */
                GATT_CHAR_GLS_GL_RACP_INST = char_handle;
            }
