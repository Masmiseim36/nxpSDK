...
/**
 *  \file appl_hid_gap_config_params.c
 *
...
{
    {
         ...
         */
        0x09U, 0x03U, 0x0AU, 0x18U, 0x0FU, 0x18U, 0x12U, 0x18U, 0x13U, 0x18U,

        /**
         * Appearence:
         *      HID Mouse & Keyboard (0x03C0)
         */
        0x03U, 0x19U, 0xC0U, 0x03U,

        /**
         *  Shortened Device Name: Mt-HID
         */
        0x07U, 0x08U, 'M', 't', '-', 'H', 'I', 'D',
