...
/**
 *  \file appl_pass_gap_config_params.c
 *
...
{
    {
         ...
         *      PhoneAlertStatus Service (0x180E)
         */
        0x05U, 0x03U, 0x0FU, 0x18U, 0x0EU, 0x18U,

        /**
         *  Shortened Device Name: Mt-PASS
         */
        0x08U, 0x08U, 'M', 't', '-', 'P', 'A', 'S', 'S',
