...
/**
 *  \file appl_rscs_gap_config_params.c
 *
...
{
    {
         ...
         *      RSC Service (0x1814)
         */
        0x07U, 0x03U, 0x0AU, 0x18U, 0x0FU, 0x18U, 0x14U, 0x18U,

        /**
         *  Shortened Device Name: Mt-RSCS
         */
        0x08U, 0x08U, 'M', 't', '-', 'R', 'S', 'C', 'S',

        /**
         * Appearance: Running Walking Sensor: In-Shoe
         */
        0x03U, 0x19U, 0x41U, 0x04U,
