 ...
 *  ========+====================+==================+=====================
 *  0x0022  |       0x2800       | Rd               | 0x1814
 *  --------+--------------------+------------------+---------------------
 *  0x0023  |       0x2803       | Rd               | 0x10, 0x0024, 0x2A53
 *  --------+--------------------+------------------+---------------------
 *  0x0024  |       0x2A53       | Ntf              | N/A
 *  --------+--------------------+------------------+---------------------
 *  0x0025  |       0x2902       | Rd, Wr           | 0x0000
 *  --------+--------------------+------------------+---------------------
 *  0x0026  |       0x2803       | Rd               | 0x02, 0x0027, 0x2A54
 *  --------+--------------------+------------------+---------------------
 *  0x0027  |       0x2A54       | Rd               | 0
 *  --------+--------------------+------------------+---------------------
...
DECL_CONST UCHAR gatt_const_uuid_arr[GATT_UUID_ARRAY_SIZE] =
{
    ...
    /* 56 - RSC Measurement Characteristic UUID */
    0x53U, 0x2AU,

    /* 58 - RSC Feature Characteristic UUID */
    0x54U, 0x2AU,
...
DECL_CONST UCHAR gatt_const_value_arr[GATT_CONST_VALUE_ARRAY_SIZE] =
{
    ...
    /* 5 - DeviceName(0); Default: MindtreeRSC */
    0x4DU, 0x69U, 0x6EU, 0x64U, 0x74U, 0x72U, 0x65U, 0x65U, 0x52U, 0x53U, 0x43U,
    ...
    /* 28 - ManufacturerName(3); Property: 0x02, Value Handle: 0x000C, UUID: 0x2A29 */
    0x02U, 0x0CU, 0x00U, 0x29U, 0x2AU,

    /* 33 - ManufacturerName(3); Default: Mindtree Limited. */
    0x4DU, 0x69U, 0x6EU, 0x64U, 0x74U, 0x72U, 0x65U, 0x65U, 0x20U, 0x4CU, 0x69U, 0x6DU,
    0x69U, 0x74U, 0x65U, 0x64U, 0x2EU,

    /* 50 - ModelNumber(4); Property: 0x02, Value Handle: 0x000E, UUID: 0x2A24 */
    0x02U, 0x0EU, 0x00U, 0x24U, 0x2AU,

    /* 55 - ModelNumber(4); Default: RSC-1.0.0 */
    0x52U, 0x53U, 0x43U, 0x2DU, 0x31U, 0x2EU, 0x30U, 0x2EU, 0x30U,

    /* 64 - SerialNumber(5); Property: 0x02, Value Handle: 0x0010, UUID: 0x2A25 */
    0x02U, 0x10U, 0x00U, 0x25U, 0x2AU,

    /* 69 - SerialNumber(5); Default: 1.0.0 */
    0x31U, 0x2EU, 0x30U, 0x2EU, 0x30U,

    /* 74 - FirmwareRevision(6); Property: 0x02, Value Handle: 0x0012, UUID: 0x2A26 */
    0x02U, 0x12U, 0x00U, 0x26U, 0x2AU,

    /* 79 - FirmwareRevision(6); Default: 1.0.0 */
    0x31U, 0x2EU, 0x30U, 0x2EU, 0x30U,

    /* 84 - HardwareRevision(7); Property: 0x02, Value Handle: 0x0014, UUID: 0x2A27 */
    0x02U, 0x14U, 0x00U, 0x27U, 0x2AU,

    /* 89 - HardwareRevision(7); Default: 1.0.0 */
    0x31U, 0x2EU, 0x30U, 0x2EU, 0x30U,

    /* 94 - SoftwareRevision(8); Property: 0x02, Value Handle: 0x0016, UUID: 0x2A28 */
    0x02U, 0x16U, 0x00U, 0x28U, 0x2AU,

    /* 99 - SoftwareRevision(8); Default: 1.0.0 */
    0x31U, 0x2EU, 0x30U, 0x2EU, 0x30U,

    /* 104 - SystemId(9); Property: 0x02, Value Handle: 0x0018, UUID: 0x2A23 */
    0x02U, 0x18U, 0x00U, 0x23U, 0x2AU,

    /* 109 - SystemId(9); Default: 11223344.0 */
    0x31U, 0x31U, 0x32U, 0x32U, 0x33U, 0x33U, 0x34U, 0x34U,

    /* 117 - RegCertDataList(10); Property: 0x02, Value Handle: 0x001A, UUID: 0x2A2A */
    0x02U, 0x1AU, 0x00U, 0x2AU, 0x2AU,

    /* 122 - RegCertDataList(10); Default: 0 */
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,

    /* 154 - PnPID(11); Property: 0x02, Value Handle: 0x001C, UUID: 0x2A50 */
    0x02U, 0x1CU, 0x00U, 0x50U, 0x2AU,

    /* 159 - PnPID(11); Default: 0 */
    0x01U, 0x6AU, 0x00U, 0x4DU, 0x01U, 0x00U, 0x01U,

    /* 166 - BatteryLevel(12); Property: 0x12, Value Handle: 0x001F, UUID: 0x2A19 */
    0x12U, 0x1FU, 0x00U, 0x19U, 0x2AU,

    /* 171 - Presentation Fromat for BatteryLevel */
    /**
    ...
    /* 178 - RSC Measurement(13); Property: 0x10, Value Handle: 0x0024, UUID: 0x2A53 */
    0x10U, 0x24U, 0x00U, 0x53U, 0x2AU,

    /* 183 - RSC Feature(14); Property: 0x02, Value Handle: 0x0027, UUID: 0x2A54 */
    0x02U, 0x27U, 0x00U, 0x54U, 0x2AU,

    /* 188 - Sensor Location(15); Property: 0x02, Value Handle: 0x0029, UUID: 0x2A5D */
    0x02U, 0x29U, 0x00U, 0x5DU, 0x2AU,

    /* 193 - SC Control Point(16); Property: 0x28, Value Handle: 0x002B, UUID: 0x2A55 */
...
DECL_CONST UCHAR gatt_db_const_peer_specific_val_arr[GATT_DB_PEER_VALUE_ARRAY_SIZE] =
{
    ...
    /* 4 - Client Configuration for RSC Measurement */
    /* Client Instance 0 */
    0x00U, 0x00U,
...
DECL_CONST GATT_DB_DESC_DATA gatt_db_attr_table[GATT_DB_MAX_ATTRIBUTES] =
{
    ...
    /* 4 - ModelNumber - Characteristic Value */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[55U]),
    },
    ...
    /* 10 - RegCertDataList - Characteristic Declaration */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[117U]),
    },
    ...
    /* 11 - PnPID - Characteristic Declaration */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[154U]),
    },
    ...
    /* 12 - BatteryLevel - Characteristic Declaration */
    {
        ...
        /* Value */
        (UCHAR *)(&gatt_const_value_arr[166U]),
    },
    ...
    /* Handle - 0x0023 */
    /* 13 - RSC Measurement - Characteristic Declaration */
    {
        /* Property */
        GATT_DB_READ,
    ...
    /* Handle - 0x0024 */
    /* 13 - RSC Measurement - Characteristic Value */
    {
        /* Property */
        GATT_DB_CHAR_NOTIFY_PROPERTY,
    ...
    /* Handle - 0x0026 */
    /* 14 - RSC Feature - Characteristic Declaration */
    {
        /* Property */
        GATT_DB_READ,
    ...
    /* Handle - 0x0027 */
    /* 14 - RSC Feature - Characteristic Value */
    {
        /* Property */
        GATT_DB_READ,
...
#endif /* ((defined RSCS) && (defined GATT_DB)) */
