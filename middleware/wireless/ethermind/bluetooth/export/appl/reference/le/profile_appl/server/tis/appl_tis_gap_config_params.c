...
/**
 *  \file appl_tis_gap_config_params.c
 *
...
{
    {
         ...
         *      CurrentTimeService Service (0x1805)
         *      ReferenceTimeUpdate Service (0x1806)
         *      NextDSTChangeService Service (0x1807)
         */
        0x09U, 0x03U, 0x0FU, 0x18U, 0x05U, 0x18U, 0x06U, 0x18U, 0x07U, 0x18U,

        /**
         *  Shortened Device Name: Mt-TIS
         */
        0x07U, 0x08U, 'M', 't', '-', 'T', 'I', 'S',
