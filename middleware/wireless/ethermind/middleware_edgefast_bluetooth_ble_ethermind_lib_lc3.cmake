# Add set(CONFIG_USE_middleware_edgefast_bluetooth_ble_ethermind_lib_lc3 true) in config.cmake to use this component
...
message("${CMAKE_CURRENT_LIST_FILE} component is included.")
    ...
    target_link_libraries(${MCUX_SDK_PROJECT_NAME} PRIVATE
    -Wl,--start-group
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/gcc/libethermind_lc3_common.a
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/gcc/libethermind_lc3_decoder.a
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/gcc/libethermind_lc3_encoder.a
        -Wl,--end-group
    )
    endif()
    ...
    target_link_libraries(${MCUX_SDK_PROJECT_NAME} PRIVATE
    -Wl,--start-group
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/iar/libethermind_lc3_common.a
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/iar/libethermind_lc3_decoder.a
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/iar/libethermind_lc3_encoder.a
        -Wl,--end-group
    )
    endif()
    ...
    target_link_libraries(${MCUX_SDK_PROJECT_NAME} PRIVATE
    -Wl,--start-group
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/mdk/libethermind_lc3_common.lib
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/mdk/libethermind_lc3_decoder.lib
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/mdk/libethermind_lc3_encoder.lib
        -Wl,--end-group
    )
    endif()
    ...
    target_link_libraries(${MCUX_SDK_PROJECT_NAME} PRIVATE
    -Wl,--start-group
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/mcuxpresso/libethermind_lc3_decoder.a
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/mcuxpresso/libethermind_lc3_encoder.a
          ${CMAKE_CURRENT_LIST_DIR}/bluetooth/private/lib/mcux/default/ble/cm33/mcuxpresso/libethermind_lc3_common.a
        -Wl,--end-group
    )
    endif()
