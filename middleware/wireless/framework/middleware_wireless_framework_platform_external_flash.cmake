# Add set(CONFIG_USE_middleware_wireless_framework_platform_external_flash true) in config.cmake to use this component
...
message("${CMAKE_CURRENT_LIST_FILE} component is included.")
    ...
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
          ${CMAKE_CURRENT_LIST_DIR}/platform/wireless_mcu/fwk_platform_extflash.c
        )
    endif()
    ...
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
          ${CMAKE_CURRENT_LIST_DIR}/platform/rt1060/fwk_platform_extflash.c
        )
    endif()
