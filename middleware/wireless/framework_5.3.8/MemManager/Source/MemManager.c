...
)
{
    ...
    {
#if defined(MEM_DEBUG_INVALID_POINTERS) && MEM_DEBUG_INVALID_POINTERS
...
*         buffer was not allocated successfully, MEM_FREE_ERROR_c  if a
*         buffer was not freed successfully or MEM_UNKNOWN_ERROR_c if a verify error,
