...
#if RF_OSC_26MHZ == 1
    {
        XCVR_RX_DIG->DC_RESID_CTRL = com_config->dc_resid_ctrl_init | mode_datarate_config->dc_resid_ctrl_26mhz;
    }
#else
    {
        XCVR_RX_DIG->DC_RESID_CTRL = com_config->dc_resid_ctrl_init | mode_datarate_config->dc_resid_ctrl_32mhz;
    }
#endif /* RF_OSC_26MHZ == 1 */
#else
#if RF_OSC_26MHZ == 1
