...
#define WAKEUP_CONFIG2          (0x278) /* 32-bit:0x4F0 */
...
#define BLE_LL_OSC_STARTUP_DELAY_SHIFT                 (0)
#define BLE_LL_OSC_STARTUP_DELAY_MASK                  (0x0FFF)
#define BLE_LL_OSC_STARTUP_DELAY_SLOT_SHIFT            (5)
#define BLE_LL_OSC_STARTUP_DELAY_SLOT_MASK             (0x0FE0)
#define BLE_LL_OSC_STARTUP_DELAY_CLK_SHIFT             (0)
#define BLE_LL_OSC_STARTUP_DELAY_CLK_MASK              (0x001F)

#define BLE_LL_WAKEUP_CONFIG2_OSC_DELAY_SLOT_SHIFT      (0)
#define BLE_LL_WAKEUP_CONFIG2_OSC_DELAY_SLOT_MASK       (0x007F)
...
#define gPWRLib_MaxLPTMRTimeoutForMaxFreqMs_c         (1999U)
/*****************************************************************************
 ...
 *              the LPTMR is ON and no roll over has been occurred
 * Parameters: -
 * Return: -
 *---------------------------------------------------------------------------*/
