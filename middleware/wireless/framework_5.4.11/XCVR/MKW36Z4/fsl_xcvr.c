...
void XCVR_bumpPaPowerUp(void)
{
    ...
    uint32_t temp_trim;
    temp_trim = XCVR_ANALOG->BB_LDO_1;
    temp_trim &= ~(XCVR_ANALOG_BB_LDO_1_BB_LDO_HF_TRIM_MASK);
    temp_trim |= XCVR_ANALOG_BB_LDO_1_BB_LDO_HF_TRIM(0x5U);  /* Measured value required for high PA power output (+5dBm) */
    XCVR_ANALOG->BB_LDO_1 = temp_trim;
}
...
void XCVR_releasePaPowerBump(void)
{
    ...
    temp_trim = XCVR_ANALOG->BB_LDO_1;
    temp_trim &= ~(XCVR_ANALOG_BB_LDO_1_BB_LDO_HF_TRIM_MASK);
    temp_trim |= XCVR_ANALOG_BB_LDO_1_BB_LDO_HF_TRIM(0x0U);  /* Put back the original value (bitfield default value) */
    XCVR_ANALOG->BB_LDO_1 = temp_trim;
}
#endif /* RADIO_IS_GEN_2P1 */
