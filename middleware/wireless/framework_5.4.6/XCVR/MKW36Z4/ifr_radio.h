...
#if (defined(CPU_K32W032S1M2CAx_cm0plus) || defined(CPU_K32W032S1M2VPJ_cm0plus) || \
     defined(CPU_K32W032S1M2CAx_M0P) || defined(CPU_K32W032S1M2VPJ_M0P))
#define IS_VALID_REG_ADDR(x)    (((x) & 0xFFFF0000U) == 0x41000000U) /*!< Valid addresses are 0x410xxxxx */
#endif /* (defined(CPU_K32W032S1M2CAx_M0P) || defined(CPU_K32W032S1M2VPJ_M0P)) */
