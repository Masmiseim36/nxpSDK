...
)
{
    ...
    if(flexMetaInfo.rawValue == gNvFlexGuardValue_c) /* no meta found for this table entry ID */
    {
        ...
        {
            flexMetaInfo.fields.NvDataOffset = gFlashConfig.FlexRAMTotalSize - recordSize;
            destRecordEndAddress = gFlashConfig.FlexRAMBlockBase + gFlashConfig.FlexRAMTotalSize;
        ...
        else
        {
            ...
            destRecordEndAddress = gFlashConfig.FlexRAMBlockBase + lastFlexMetaInfo.fields.NvDataOffset;
    ...
    else /* table entry ID already in FlexRAM, update the corresponding record */
    {
        ...
        if(kStatus_FLASH_Success != EEEWrite(&gFlashConfig, (uint32_t)(gFlashConfig.FlexRAMBlockBase + flexMetaInfo.fields.NvDataOffset), recordSize,
