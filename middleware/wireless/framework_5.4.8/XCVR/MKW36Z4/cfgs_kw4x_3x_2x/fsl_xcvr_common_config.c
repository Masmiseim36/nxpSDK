...
/*-------------------------------------------------------------------------------------------------*/
...
#else
                        0, /* Gen 2.1 UP_SRC and RSSI_THRESH are moved to mode/datarate config */
#endif /* !RADIO_IS_GEN_2P0 */


    .agc_ctrl_1_init_26mhz =
#if RADIO_IS_GEN_2P1 
                        XCVR_RX_DIG_AGC_CTRL_1_PDET_HI_SEL_HOLD(1) |
                        XCVR_RX_DIG_AGC_CTRL_1_PRESLOW_UP_THRESH(0x02) |
                        XCVR_RX_DIG_AGC_CTRL_1_PRESLOW_DOWN_THRESH(0x0C) |
#endif /* RADIO_IS_GEN_2P1 */
                        XCVR_RX_DIG_AGC_CTRL_1_PRESLOW_EN(PRESLOW_ENA),
    .agc_ctrl_1_init_32mhz =
#if RADIO_IS_GEN_2P1
                        XCVR_RX_DIG_AGC_CTRL_1_PDET_HI_SEL_HOLD(1) |
                        XCVR_RX_DIG_AGC_CTRL_1_PRESLOW_UP_THRESH(0x02) |
                        XCVR_RX_DIG_AGC_CTRL_1_PRESLOW_DOWN_THRESH(0x0C) |
...
#else                          
                          XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_ITER_FREEZE(4) |
                          XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_MIN_AGC_IDX(26) | /* Gen 2.0 retains this as a common setting */
#endif
    ...
    .dcoc_cal_gain_init = XCVR_RX_DIG_DCOC_CAL_GAIN_DCOC_BBA_CAL_GAIN1(1) |
                          XCVR_RX_DIG_DCOC_CAL_GAIN_DCOC_LNA_CAL_GAIN1(1) |
                          XCVR_RX_DIG_DCOC_CAL_GAIN_DCOC_BBA_CAL_GAIN2(1) |
                          XCVR_RX_DIG_DCOC_CAL_GAIN_DCOC_LNA_CAL_GAIN2(7) |
    ...
    .lna_gain_lin_val_8_6_init = XCVR_RX_DIG_LNA_GAIN_LIN_VAL_8_6_LNA_GAIN_LIN_VAL_6(113) |
                                 ...
                                 XCVR_RX_DIG_LNA_GAIN_LIN_VAL_8_6_LNA_GAIN_LIN_VAL_8(427),
...
#else
    .end_of_seq_init_26mhz = B3(END_OF_RX_WD_26MHZ) | B2(END_OF_RX_WU_26MHZ) | B1(END_OF_TX_WD) | B0(END_OF_TX_WU+1),
#endif
    ...
    /* TSM_TIMING_43.. TSM_TIMING_51 are SPARE and GPIO_TRIG signals */
...
#define dft_max_ram_size 0
    ...
    .tx_ctrl = XCVR_TX_DIG_CTRL_RADIO_DFT_MODE(radio_dft_mode) |
               ...
               XCVR_TX_DIG_CTRL_TX_CAPTURE_POL(tx_capture_pol) |
                ...
                XCVR_TX_DIG_CTRL_ZERO_FDEV(USE_ZERO_FDEV) |
#endif
