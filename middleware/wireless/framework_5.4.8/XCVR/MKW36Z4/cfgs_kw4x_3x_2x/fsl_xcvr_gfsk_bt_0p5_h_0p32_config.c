...
#else
    .phy_pre_ref0_init = 0x04220C64,
    .phy_pre_ref1_init = 0x20882000,
    .phy_pre_ref2_init = 0x000018C4,
...
const xcvr_mode_datarate_config_t xcvr_GFSK_BT_0p5_h_0p32_1mbps_config =
{
...
#else
    .rx_chf_coeffs_26mhz.rx_chf_coef_0  = 0xFFFB,
    .rx_chf_coeffs_26mhz.rx_chf_coef_1  = 0xFFF7,
    ...
    .rx_chf_coeffs_26mhz.rx_chf_coef_6  = 0x000B,
    .rx_chf_coeffs_26mhz.rx_chf_coef_7  = 0x001B,
    .rx_chf_coeffs_26mhz.rx_chf_coef_8  = 0x002D,
    .rx_chf_coeffs_26mhz.rx_chf_coef_9  = 0x003E,
    .rx_chf_coeffs_26mhz.rx_chf_coef_10 = 0x004B,
    .rx_chf_coeffs_26mhz.rx_chf_coef_11 = 0x0052,
    ...
    .rx_chf_coeffs_32mhz.rx_chf_coef_5  = 0xFFEE,
    .rx_chf_coeffs_32mhz.rx_chf_coef_6  = 0xFFF5,
    .rx_chf_coeffs_32mhz.rx_chf_coef_7  = 0x0007,
    .rx_chf_coeffs_32mhz.rx_chf_coef_8  = 0x0023,
    .rx_chf_coeffs_32mhz.rx_chf_coef_9  = 0x0043,
    .rx_chf_coeffs_32mhz.rx_chf_coef_10 = 0x0060,
    .rx_chf_coeffs_32mhz.rx_chf_coef_11 = 0x0070,
...
const xcvr_mode_datarate_config_t xcvr_GFSK_BT_0p5_h_0p32_500kbps_config =
{
    ...
    .dcoc_ctrl_1_init_26mhz = XCVR_RX_DIG_DCOC_CTRL_1_DCOC_ALPHA_RADIUS_IDX(5),
    .dcoc_ctrl_1_init_32mhz = XCVR_RX_DIG_DCOC_CTRL_1_DCOC_ALPHA_RADIUS_IDX(5),
    .dc_resid_ctrl_init_26mhz = XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_NWIN(60) |
                            XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_MIN_AGC_IDX(26),
    .dc_resid_ctrl_init_32mhz = XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_NWIN(60) |
                            XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_MIN_AGC_IDX(26),
#endif
...
const xcvr_mode_datarate_config_t xcvr_GFSK_BT_0p5_h_0p32_250kbps_config =
{
    ...
    .dcoc_ctrl_1_init_26mhz = XCVR_RX_DIG_DCOC_CTRL_1_DCOC_ALPHA_RADIUS_IDX(5),
    .dcoc_ctrl_1_init_32mhz = XCVR_RX_DIG_DCOC_CTRL_1_DCOC_ALPHA_RADIUS_IDX(5),
    .dc_resid_ctrl_init_26mhz = XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_NWIN(45) |
                            XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_MIN_AGC_IDX(26),
    .dc_resid_ctrl_init_32mhz = XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_NWIN(45) |
                            XCVR_RX_DIG_DC_RESID_CTRL_DC_RESID_MIN_AGC_IDX(26),
#endif
