...
/*!=================================================================================================
\file       host_controlled_device_app.c
\brief      This is a public source file for the router thci application.
==================================================================================================*/
...
/* Application */
#include "host_controlled_device_app.h"
#include "shell_ip.h"
...
static void APP_ResetToFactory(void);
...
)
{
    ...
    APP_InitEventMonitor(mThrInstanceId);
        ...
        BR_Start((uint8_t *)mpAppThreadMsgQueue, mThrInstanceId);
#endif
...
#if LARGE_NETWORK
        (void)MgmtDiagnostic_RegisterEventCb(THCI_DiagnosticsEventDataCb);
#endif
#endif
    }
}
...
/*!*************************************************************************************************
\private
\fn     static void APP_ResetToFactory(void)
\brief  Resets the application parameters to factory default.
***************************************************************************************************/
static void APP_ResetToFactory
(
    void
)
{
    ...
    gEnable802154TxLed = FALSE;
#endif
    gbCreateNetwork = FALSE;
    mJoiningIsAppInitiated = FALSE;
    mFirstPushButtonPressed = FALSE;

    /* Reset thresholds: */
    THR_SetRouterUpgradeThreshold(THR_ROUTER_UPGRADE_THRESHOLD);
    THR_SetRouterDowngradeThreshold(THR_ROUTER_DOWNGRADE_THRESHOLD);
    THR_SetMinDowngradNeigbors(THR_MIN_DOWNGRADE_NEIGHBORS);
    THR_SetMaxAllowedRouters(THR_MAX_ROUTERS);
    THR_SetContextReuseDelaySec(THR_CONTEXT_REUSE_DELAY_SEC);
    THR_SetNetworkIdTimeoutSec(THR_LEADER_TIMEOUT_SEC);
    THR_SetParentPriority(THR_ALL_FFs8);
}
