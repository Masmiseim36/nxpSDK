...
#if USE_SED_RESYNC_TO_PARENT
/* User can set the desired timeout for SED to resync with parent */
#define SED_RESYNC_TO_PARENT_TIMEOUT            60000 /* milliseconds */
#endif
/*==================================================================================================
...
#if USE_SED_RESYNC_TO_PARENT
static void APP_StartSedResyncTimer(void);
#endif
/*==================================================================================================
...
#if USE_SED_RESYNC_TO_PARENT
tmrTimerID_t gAppSedResyncTimer = gTmrInvalidTimerID_c;
#endif
...
#if USE_SED_RESYNC_TO_PARENT
            TMR_StopTimer(gAppSedResyncTimer);
#endif
            break;
...
#if USE_SED_RESYNC_TO_PARENT
static void APP_SendResyncToParent
(
    void
)
{
...
)
{
    ...
    {
        gAppSedResyncTimer = TMR_AllocateTimer();
    }
