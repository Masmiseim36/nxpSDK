...
#define ANQP_REQ_EMERGENCY_CALL_NUMBER     (1 << (ANQP_EMERGENCY_CALL_NUMBER - ANQP_QUERY_LIST))
...
#define ANQP_REQ_AP_GEOSPATIAL_LOCATION    (1 << (ANQP_AP_GEOSPATIAL_LOCATION - ANQP_QUERY_LIST))
#define ANQP_REQ_AP_CIVIC_LOCATION         (1 << (ANQP_AP_CIVIC_LOCATION - ANQP_QUERY_LIST))
#define ANQP_REQ_AP_LOCATION_PUBLIC_URI    (1 << (ANQP_AP_LOCATION_PUBLIC_URI - ANQP_QUERY_LIST))
#define ANQP_REQ_DOMAIN_NAME               (1 << (ANQP_DOMAIN_NAME - ANQP_QUERY_LIST))
#define ANQP_REQ_EMERGENCY_ALERT_URI       (1 << (ANQP_EMERGENCY_ALERT_URI - ANQP_QUERY_LIST))
...
#define ANQP_REQ_OPERATOR_ICON_METADATA (0x10000 << HS20_STYPE_OPERATOR_ICON_METADATA)
#define ANQP_REQ_OSU_PROVIDERS_NAI_LIST (0x10000 << HS20_STYPE_OSU_PROVIDERS_NAI_LIST)
/* The first MBO ANQP-element can be included in the optimized bitmap. */
#define ANQP_REQ_MBO_CELL_DATA_CONN_PREF (BIT(29) << MBO_ANQP_SUBTYPE_CELL_CONN_PREF)
