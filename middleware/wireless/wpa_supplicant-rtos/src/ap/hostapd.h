...
#define OCE_STA_CFON_ENABLED(hapd) \
    ((hapd->conf->oce & OCE_STA_CFON) && (hapd->iface->drv_flags & WPA_DRIVER_FLAGS_OCE_STA_CFON))
#define OCE_AP_ENABLED(hapd) ((hapd->conf->oce & OCE_AP) && (hapd->iface->drv_flags & WPA_DRIVER_FLAGS_OCE_AP))
...
int hostapd_probe_req_rx(struct hostapd_data *hapd,
                         const u8 *sa,
                         const u8 *da,
                         const u8 *bssid,
                         const u8 *ie,
