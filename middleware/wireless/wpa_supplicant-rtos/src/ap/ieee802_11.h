...
u16 copy_sta_vht_oper(struct hostapd_data *hapd, struct sta_info *sta, const u8 *vht_oper);
...
static inline u8 *hostapd_eid_mbo(struct hostapd_data *hapd, u8 *eid, size_t len)
{
    return eid;
}
...
void ieee802_11_finish_fils_auth(struct hostapd_data *hapd,
                                 ...
                                 const u8 *msk,
                                 size_t msk_len);
u8 *owe_assoc_req_process(struct hostapd_data *hapd,
                          struct sta_info *sta,
                          const u8 *owe_dh,
                          u8 owe_dh_len,
                          u8 *owe_buf,
...
u16 owe_process_rsn_ie(struct hostapd_data *hapd,
                       ...
                       const u8 *owe_dh,
                       size_t owe_dh_len);
u16 owe_validate_request(struct hostapd_data *hapd,
                         const u8 *peer,
                         const u8 *rsn_ie,
                         size_t rsn_ie_len,
                         const u8 *owe_dh,
...
void handle_auth_fils(
    ...
    u16 status_code,
    void (*cb)(struct hostapd_data *hapd, struct sta_info *sta, u16 resp, struct wpabuf *data, int pub));
