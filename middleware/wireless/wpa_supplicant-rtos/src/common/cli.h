...
struct cli_txt_entry *cli_txt_list_get(struct dl_list *txt_list, const char *txt);
...
void cli_txt_list_del_word(struct dl_list *txt_list, const char *txt, int separator);
...
int cli_txt_list_add_word(struct dl_list *txt_list, const char *txt, int separator);
