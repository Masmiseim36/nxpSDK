...
#define WPA_KEY_MGMT_FT                                                                                         \
    (WPA_KEY_MGMT_FT_PSK | WPA_KEY_MGMT_FT_IEEE8021X | WPA_KEY_MGMT_FT_IEEE8021X_SHA384 | WPA_KEY_MGMT_FT_SAE | \
     WPA_KEY_MGMT_FT_FILS_SHA256 | WPA_KEY_MGMT_FT_FILS_SHA384)

static inline int wpa_key_mgmt_wpa_ieee8021x(int akm)
{
    return !!(akm & (WPA_KEY_MGMT_IEEE8021X | WPA_KEY_MGMT_FT_IEEE8021X | WPA_KEY_MGMT_FT_IEEE8021X_SHA384 |
                     WPA_KEY_MGMT_CCKM | WPA_KEY_MGMT_OSEN | WPA_KEY_MGMT_IEEE8021X_SHA256 |
                     WPA_KEY_MGMT_IEEE8021X_SUITE_B | WPA_KEY_MGMT_IEEE8021X_SUITE_B_192 | WPA_KEY_MGMT_FILS_SHA256 |
                     WPA_KEY_MGMT_FILS_SHA384 | WPA_KEY_MGMT_FT_FILS_SHA256 | WPA_KEY_MGMT_FT_FILS_SHA384));
}

static inline int wpa_key_mgmt_wpa_psk_no_sae(int akm)
{
    return !!(akm & (WPA_KEY_MGMT_PSK | WPA_KEY_MGMT_FT_PSK | WPA_KEY_MGMT_PSK_SHA256));
}

static inline int wpa_key_mgmt_wpa_psk(int akm)
{
    return !!(akm & (WPA_KEY_MGMT_PSK | WPA_KEY_MGMT_FT_PSK | WPA_KEY_MGMT_PSK_SHA256 | WPA_KEY_MGMT_SAE |
                     WPA_KEY_MGMT_SAE_EXT_KEY | WPA_KEY_MGMT_FT_SAE));
}
...
{
    return !!(akm & (WPA_KEY_MGMT_SAE | WPA_KEY_MGMT_SAE_EXT_KEY | WPA_KEY_MGMT_FT_SAE));
}
...
{
    return !!(akm & (WPA_KEY_MGMT_FILS_SHA256 | WPA_KEY_MGMT_FILS_SHA384 | WPA_KEY_MGMT_FT_FILS_SHA256 |
                     WPA_KEY_MGMT_FT_FILS_SHA384));
}

static inline int wpa_key_mgmt_sha256(int akm)
{
    return !!(akm & (WPA_KEY_MGMT_PSK_SHA256 | WPA_KEY_MGMT_IEEE8021X_SHA256 | WPA_KEY_MGMT_SAE | WPA_KEY_MGMT_FT_SAE |
                     WPA_KEY_MGMT_OSEN | WPA_KEY_MGMT_IEEE8021X_SUITE_B | WPA_KEY_MGMT_FILS_SHA256 |
                     WPA_KEY_MGMT_FT_FILS_SHA256));
}

static inline int wpa_key_mgmt_sha384(int akm)
{
    return !!(akm & (WPA_KEY_MGMT_IEEE8021X_SUITE_B_192 | WPA_KEY_MGMT_FT_IEEE8021X_SHA384 | WPA_KEY_MGMT_FILS_SHA384 |
                     WPA_KEY_MGMT_FT_FILS_SHA384));
}
...
{
    return wpa_key_mgmt_wpa_ieee8021x(akm) || wpa_key_mgmt_wpa_psk(akm) || wpa_key_mgmt_fils(akm) ||
           wpa_key_mgmt_sae(akm) || akm == WPA_KEY_MGMT_OWE || akm == WPA_KEY_MGMT_DPP;
}
...
{
    return !!(akm & (WPA_KEY_MGMT_PSK | WPA_KEY_MGMT_PSK_SHA256 |
...
{
    return alg == WPA_ALG_BIP_CMAC_128 || alg == WPA_ALG_BIP_GMAC_128 || alg == WPA_ALG_BIP_GMAC_256 ||
...
enum key_flag
{
    ...
    KEY_FLAG_GROUP_RX_TX_DEFAULT   = KEY_FLAG_GROUP_RX_TX | KEY_FLAG_DEFAULT,
    ...
    KEY_FLAG_PAIRWISE_RX_TX_MODIFY = KEY_FLAG_PAIRWISE_RX_TX | KEY_FLAG_MODIFY,
...
{
    return !!(!key_flag ||
              ((key_flag & (KEY_FLAG_PAIRWISE | KEY_FLAG_MODIFY)) && (key_flag & ~KEY_FLAG_PAIRWISE_MASK)) ||
              ((key_flag & KEY_FLAG_GROUP) && (key_flag & ~KEY_FLAG_GROUP_MASK)) ||
              ((key_flag & KEY_FLAG_PMK) && (key_flag & ~KEY_FLAG_PMK_MASK)));
}
