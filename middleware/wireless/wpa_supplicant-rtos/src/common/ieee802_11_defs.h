...
#define HE_OPERATION_RTS_THRESHOLD_MASK \
    ((u32)(BIT(4) | BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9) | BIT(10) | BIT(11) | BIT(12) | BIT(13)))
...
#define HE_OPERATION_BSS_COLOR_MASK       ((u32)(BIT(24) | BIT(25) | BIT(26) | BIT(27) | BIT(28) | BIT(29)))
...
/* HE QoS Info field */
#define HE_QOS_INFO_EDCA_PARAM_SET_COUNT ((u8)(BIT(0) | BIT(1) | BIT(2) | BIT(3)))
