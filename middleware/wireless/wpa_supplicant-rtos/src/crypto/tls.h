 ...
 */
int __must_check tls_connection_get_eap_fast_key(void *tls_ctx, struct tls_connection *conn, u8 *out, size_t out_len);
 ...
 * Returns: 0 on success, -1 on failure
 */
int __must_check tls_connection_client_hello_ext(
