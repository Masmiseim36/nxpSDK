...
struct wpa_driver_ops
{
     ...
     */
    int (*tx_control_port)(void *priv, const u8 *dest, u16 proto, const u8 *buf, size_t len, int no_encrypt);
     ...
     */
    int (*sta_deauth)(void *priv, const u8 *own_addr, const u8 *addr, u16 reason);
     ...
     */
    int (*sta_disassoc)(void *priv, const u8 *own_addr, const u8 *addr, u16 reason);
     ...
     */
    int (*sta_set_flags)(
        void *priv, const u8 *addr, unsigned int total_flags, unsigned int flags_or, unsigned int flags_and);
     ...
     * Returns: 0 on success, -1 on failure
     */
    int (*sta_set_airtime_weight)(void *priv, const u8 *addr, unsigned int weight);
     ...
     */
    void (*set_rekey_info)(
        void *priv, const u8 *kek, size_t kek_len, const u8 *kck, size_t kck_len, const u8 *replay_ctr);
     ...
     * Returns: 0 on success, -1 on failure
     */
    int (*sta_auth)(void *priv, struct wpa_driver_sta_auth_params *params);
     ...
     */
    int (*tdls_enable_channel_switch)(void *priv,
                                      const u8 *addr,
                                      u8 oper_class,
     ...
     * Returns: 0 on success, -1 on failure (or if not supported)
     */
    int (*create_receive_sc)(void *priv, struct receive_sc *sc, unsigned int conf_offset, int validation);
     ...
     * Returns: 0 on success, -1 on failure
     */
    int (*create_transmit_sc)(void *priv, struct transmit_sc *sc, unsigned int conf_offset);
     ...
     * candidates.
     */
    struct wpa_bss_candidate_info *(*get_bss_transition_status)(void *priv, struct wpa_bss_trans_info *params);
    /**
     ...
     */
    int (*set_bssid_tmp_disallow)(void *priv, unsigned int num_bssid, const u8 *bssid);
     ...
     * roaming.
     */
    int (*update_connect_params)(void *priv,
     ...
     * Returns: 0 on success, -1 on failure
     */
    int (*send_external_auth_status)(void *priv, struct external_auth *params);
     ...
     */
    int (*update_dh_ie)(void *priv, const u8 *peer_mac, u16 reason_code, const u8 *ie, size_t ie_len);
    ...
    int (*register_frame)(void *priv, u16 type, const u8 *match, size_t match_len, bool multicast);
