...
void eap_teap_put_tlv_buf(struct wpabuf *buf, u16 type, const struct wpabuf *data);
...
int eap_teap_derive_imck(u16 tls_cs,
                         const u8 *prev_s_imck_msk,
                         const u8 *prev_s_imck_emsk,
                         const u8 *msk,
                         size_t msk_len,
                         const u8 *emsk,
                         size_t emsk_len,
                         ...
                         u8 *s_imck_emsk,
                         u8 *cmk_emsk);
int eap_teap_compound_mac(u16 tls_cs,
                          const struct teap_tlv_crypto_binding *cb,
                          const struct wpabuf *server_outer_tlvs,
                          const struct wpabuf *peer_outer_tlvs,
                          const u8 *cmk,
                          u8 *compound_mac);
int eap_teap_parse_tlv(struct eap_teap_tlv_parse *tlv, int tlv_type, u8 *pos, size_t len);
