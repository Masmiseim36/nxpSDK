...
struct eap_proxy_sm *eap_proxy_init(void *eapol_ctx, const struct eapol_callbacks *eapol_cb, void *msg_ctx);
...
int eap_proxy_get_imsi(struct eap_proxy_sm *eap_proxy, int sim_num, char *imsi_buf, size_t *imsi_len);
