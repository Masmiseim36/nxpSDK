 ...
 */
const struct eap_method *eap_server_get_eap_method(int vendor, enum eap_type method)
{
    struct eap_method *m;
 ...
 */
struct eap_method *eap_server_method_alloc(int version, int vendor, enum eap_type method, const char *name)
{
