...
#define SESSION_CONTROL(session_type, switch_intent) (((u8)((session_type)&0x7)) | ((switch_intent) ? 0x10 : 0x00))

#define GET_SESSION_CONTROL_TYPE(session_control) ((u8)((session_control)&0x7))

#define GET_SESSION_CONTROL_SWITCH_INTENT(session_control) (((session_control)&0x10) >> 4)
