...
void fst_session_set_iface(struct fst_session *s, struct fst_iface *iface, bool is_old);
void fst_session_set_llt(struct fst_session *s, u32 llt);
void fst_session_set_peer_addr(struct fst_session *s, const u8 *addr, bool is_old);
...
typedef void (*fst_session_enum_clb)(struct fst_group *g, struct fst_session *s, void *ctx);

void fst_session_enum(struct fst_group *g, fst_session_enum_clb clb, void *ctx);

void fst_session_on_action_rx(struct fst_iface *iface, const struct ieee80211_mgmt *mgmt, size_t len);

int fst_session_set_str_ifname(struct fst_session *s, const char *ifname, bool is_old);
int fst_session_set_str_peer_addr(struct fst_session *s, const char *mac, bool is_old);
