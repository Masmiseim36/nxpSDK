...
#define P2P_SEC_DEVICE_TYPES 5
     ...
     */
    u8 (*invitation_process)(void *ctx,
                             const u8 *sa,
                             const u8 *bssid,
     ...
     */
    void (*invitation_received)(void *ctx,
                                const u8 *sa,
                                const u8 *bssid,
                                const u8 *ssid,
                                size_t ssid_len,
     ...
     */
    void (*invitation_result)(void *ctx,
                              int status,
                              const u8 *bssid,
                              const struct p2p_channels *channels,
                              const u8 *addr,
     ...
     */
    int (*get_persistent_group)(void *ctx,
                                const u8 *addr,
                                const u8 *ssid,
                                size_t ssid_len,
                                u8 *go_dev_addr,
     ...
     */
    void (*p2ps_prov_complete)(void *ctx,
                               u8 status,
                               const u8 *dev,
                               const u8 *adv_mac,
                               const u8 *ses_mac,
 ...
 * found
 */
const u8 *p2p_group_get_client_interface_addr(struct p2p_group *group, const u8 *dev_addr);
...
void p2p_loop_on_all_groups(struct p2p_data *p2p,
                            int (*group_callback)(struct p2p_group *group, void *user_data),
                            void *user_data);
