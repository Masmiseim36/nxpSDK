...
struct ieee802_1x_kay_ctx
{
    ...
    int (*create_receive_sc)(void *ctx, struct receive_sc *sc, enum validate_frames vf, enum confidentiality_offset co);
    ...
    int (*create_transmit_sc)(void *ctx, struct transmit_sc *sc, enum confidentiality_offset co);
...
struct ieee802_1x_mka_participant *ieee802_1x_kay_create_mka(struct ieee802_1x_kay *kay,
...
void ieee802_1x_kay_mka_participate(struct ieee802_1x_kay *kay, struct mka_key_name *ckn, bool status);
int ieee802_1x_kay_new_sak(struct ieee802_1x_kay *kay);
int ieee802_1x_kay_change_cipher_suite(struct ieee802_1x_kay *kay, unsigned int cs_index);

int ieee802_1x_kay_set_latest_sa_attr(
    struct ieee802_1x_kay *kay, struct ieee802_1x_mka_ki *lki, u8 lan, bool ltx, bool lrx);
int ieee802_1x_kay_set_old_sa_attr(
    struct ieee802_1x_kay *kay, struct ieee802_1x_mka_ki *oki, u8 oan, bool otx, bool orx);
...
int ieee802_1x_kay_get_status(struct ieee802_1x_kay *kay, char *buf, size_t buflen);
int ieee802_1x_kay_get_mib(struct ieee802_1x_kay *kay, char *buf, size_t buflen);
