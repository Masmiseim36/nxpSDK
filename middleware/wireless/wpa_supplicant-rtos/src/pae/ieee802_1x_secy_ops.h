...
int secy_set_receive_lowest_pn(struct ieee802_1x_kay *kay, struct receive_sa *txsa);
...
int secy_delete_transmit_sa(struct ieee802_1x_kay *kay, struct transmit_sa *txsa);
