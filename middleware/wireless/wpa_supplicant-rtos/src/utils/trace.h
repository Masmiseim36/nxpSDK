...
#define wpa_trace_dump(title, ptr) wpa_trace_dump_func((title), (ptr)->btrace, (ptr)->btrace_num)
...
#define wpa_trace_add_ref(ptr, name, addr) wpa_trace_add_ref_func(&(ptr)->wpa_trace_ref_##name, (addr))
