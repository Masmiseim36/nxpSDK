...
#define MAC_ADDR_RAND_ALL        (MAC_ADDR_RAND_SCAN | MAC_ADDR_RAND_SCHED_SCAN | MAC_ADDR_RAND_PNO)
...
void wpas_mbo_ie_trans_req(struct wpa_supplicant *wpa_s, const u8 *ie, size_t len);
...
int wpas_pasn_auth_tx_status(struct wpa_supplicant *wpa_s, const u8 *data, size_t data_len, u8 acked);
