...
/*!=============================================================================
\file       bdb_tl_router_initiator_target.c
\brief      BDB Touchlink implementation of Router as Initiator/Target
==============================================================================*/
                               ...
                               uint32 u32ResponseId)
{
    ...
    FLib_MemSet(&sScanRsp, 0, sizeof(tsCLD_ZllCommission_ScanRspCommandPayload));
...
#endif
    FLib_MemSet(&sDeviceInfoRspPayload, 0, sizeof(tsCLD_ZllCommission_DeviceInfoRspCommandPayload));
                                ...
                                uint32 u32TransactionId)
{
    ...
    FLib_MemSet(&sNwkStartReqPayload, 0, sizeof(tsCLD_ZllCommission_NetworkStartReqCommandPayload));
                                       ...
                                       uint32 u32TransactionId)
{
    ...
    uint8 u8Seq;
    FLib_MemSet(&sFacRstPayload, 0, sizeof(tsCLD_ZllCommission_FactoryResetReqCommandPayload));
    sDstAddr.eMode = 3;
    sDstAddr.u16PanId = 0xffff;
    sDstAddr.uAddress.u64Addr = psScanTarget->sScanDetails.sSrcAddr.uAddress.u64Addr;
                                     ...
                                     uint32 u32TransactionId)
{
    ...
    FLib_MemSet(&sNwkJoinRouterReqPayload, 0, sizeof(tsCLD_ZllCommission_NetworkJoinRouterReqCommandPayload));
                                        ...
                                        uint32 u32TransactionId)
{
    ...
    FLib_MemSet(&sNwkJoinEndDeviceReqPayload, 0, sizeof(tsCLD_ZllCommission_NetworkJoinEndDeviceReqCommandPayload));
                                            ...
                                            ZPS_tsInterPanAddress       *psSrcAddr)
{
    ...
    else
    {
       ...
       FLib_MemCpy( sStartParams.au8NwkKey,
