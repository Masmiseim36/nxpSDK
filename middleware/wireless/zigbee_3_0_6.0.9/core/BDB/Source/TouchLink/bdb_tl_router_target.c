...
/*!=============================================================================
\file       bdb_tl_router_target.c
\brief      BDB Touchlink implementation of Router as Target
==============================================================================*/
...
PRIVATE teZCL_Status BDB_eTlSendScanResponse(ZPS_tsNwkNib *psNib,
                               ...
                               uint32 u32TransactionId,
                               uint32 u32ResponseId);
PRIVATE bool BDB_bTlSearchDiscNt(ZPS_tsNwkNib *psNib, uint64 u64EpId, uint16 u16PanId);
...
*/
    ...
    FLib_MemSet( &sZllCommand, 0, sizeof(tsZllPayloads));
