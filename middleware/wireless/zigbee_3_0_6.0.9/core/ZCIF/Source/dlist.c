...
/*!=============================================================================
\file       dlist.c
\brief      Routines for creation, deletion and manipulation of 
            arbitrary doubly-linked lists
==============================================================================*/
...
PRIVATE bool boIsHead(DLIST *psList, DNODE *psNode);
PRIVATE bool boIsTail(DLIST *psList, DNODE *psNode);
