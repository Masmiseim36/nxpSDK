...
#ifndef PC_PLATFORM_BUILD
//PUBLIC const uint32 gu32ZCLVersion USED = SVN_VERSION;
/*!   
 * \brief The version string of the ZPS Apl module
 */
static char* mZclVersionString = gZclVerString_c;

/*!   
 * \brief Registers the Connectivity ZPS Apl module info
 */
RegisterModuleInfo(ZCL, /* DO NOT MODIFY */
                   mZclVersionString, /* DO NOT MODIFY */
                   gZclModuleId_c, /* DO NOT MODIFY */
                   gZclVerMajor_c, /* DO NOT MODIFY */
                   gZclVerMinor_c, /* DO NOT MODIFY */
                   gZclVerPatch_c, /* DO NOT MODIFY */
                   gZclBuildNo_c); /* DO NOT MODIFY */
#endif
...
PUBLIC  teZCL_Status eZCL_CreateZCL(tsZCL_Config *psZCL_Config)
{
    ...
    FLib_MemSet(&sZCL_Common, 0, sizeof(sZCL_Common));
...
PUBLIC teZCL_Status eZCL_GetMutex(tsZCL_EndPointDefinition *psEndPointDefinition)
{
    ...
    // set up mutex call
    FLib_MemSet(&psZCL_Common->sZCL_CallBackEvent, 0, sizeof(tsZCL_CallBackEvent));
...
{
    // set up mutex call
    FLib_MemSet(&psZCL_Common->sZCL_InternalCallBackEvent, 0, sizeof(tsZCL_CallBackEvent));
                        ...
                        uint8                       *pu8EndpointIndex)
{
    ...
    {
        if((psZCL_Common->psZCL_EndPointRecord[i].psEndPointDefinition != NULL) &&
           (psZCL_Common->psZCL_EndPointRecord[i].psEndPointDefinition->u8EndPointNumber == u8endpointId))
        {
            *pu8EndpointIndex = i;
            return E_ZCL_SUCCESS;
        }
 ...
 ** bool                        bIsServerClusterInstance     Is server
