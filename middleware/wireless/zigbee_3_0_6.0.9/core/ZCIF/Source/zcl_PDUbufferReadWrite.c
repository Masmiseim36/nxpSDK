...
/*!=============================================================================
\file       zcl_PDUbufferReadWrite.c
\brief      Modified Zigbee stack PDU buffer read and write functions
==============================================================================*/
...
PUBLIC uint16 u16ZCL_WriteTypeNBO(uint8 *pu8Data, teZCL_ZCLAttributeType eAttributeDataType, void *pvData)
{
    ...
    {
        FLib_MemCpy(pu8Data, pvData, E_ZCL_KEY_128_SIZE);
    }
    else
    {
    ...
    #else   
        FLib_MemCpy(pu8Data,pvData,u8NumOfBytes);
    #endif
    }
...
PUBLIC uint16 u16ZCL_ReadTypeNBO(uint8 *pu8Data, teZCL_ZCLAttributeType eAttributeDataType, uint8 *pu8Struct)
{
    ...
    if (eAttributeDataType == E_ZCL_KEY_128)
    {
        FLib_MemCpy(pu8Struct, pu8Data, E_ZCL_KEY_128_SIZE);
    }
    else
    {
