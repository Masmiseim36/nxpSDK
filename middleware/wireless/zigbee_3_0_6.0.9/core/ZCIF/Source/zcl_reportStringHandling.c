...
/*!=============================================================================
\file       zcl_reportStringHandling.c
\brief      ZCL reporting
==============================================================================*/
                     ...
                     tsZCL_ReportRecord        *psAttributeReportingRecord)
{
    ...
    switch(eAttributeDataType)
    {
        case(E_ZCL_OSTRING):
        {
            ...
            FLib_MemCpy(psAttributeReportingRecord->uAttributeStorage.sOctetString.pu8Data, psOctetString->pu8Data, psAttributeReportingRecord->uAttributeStorage.sOctetString.u8Length);
            break;
        }
        ...
        case(E_ZCL_CSTRING):
        {
            ...
            FLib_MemCpy(psAttributeReportingRecord->uAttributeStorage.sCharacterString.pu8Data, psCharacterString->pu8Data, psAttributeReportingRecord->uAttributeStorage.sCharacterString.u8Length);
            break;
        }
        case(E_ZCL_LCSTRING):
        {
            ...
            FLib_MemCpy(psAttributeReportingRecord->uAttributeStorage.sLongCharacterString.pu8Data, psLongCharacterString->pu8Data, psAttributeReportingRecord->uAttributeStorage.sLongCharacterString.u16Length);
            break;
        }
        case(E_ZCL_LOSTRING):
        {
            ...
            FLib_MemCpy(psAttributeReportingRecord->uAttributeStorage.sLongOctetString.pu8Data, psLongOctetString->pu8Data, psAttributeReportingRecord->uAttributeStorage.sLongOctetString.u16Length);
            break;
        }
