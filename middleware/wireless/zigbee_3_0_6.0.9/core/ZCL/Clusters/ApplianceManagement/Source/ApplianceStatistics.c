...
/*!=============================================================================
\file       ApplianceStatistics.c
\brief      Appliance Statistics Cluster definition
==============================================================================*/
        ...
        if( pCustomDataStructure->asLogTable[u8LogCount].u8LogLength > CLD_APPLIANCE_STATISTICS_ATTR_LOG_MAX_SIZE )
            {
                ...
                FLib_MemCpy(&sPayload,(tsCLD_LogTable *)&pCustomDataStructure->asLogTable[u8LogCount],sizeof(tsCLD_LogTable));
