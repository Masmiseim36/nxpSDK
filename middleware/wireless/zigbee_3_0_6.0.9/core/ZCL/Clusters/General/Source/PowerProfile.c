...
/*!=============================================================================
\file        PowerProfile.c
\brief       Power Profile cluster definition
==============================================================================*/
                                            ...
                                            tsCLD_PPEntry                   *psPowerProfileEntry)   
{
    ...
    if((eCLD_PPGetPowerProfileEntry(u8SourceEndPointId,psPowerProfileEntry->u8PowerProfileId,&psPPEntry) == E_ZCL_SUCCESS)){
        FLib_MemCpy(psPPEntry,psPowerProfileEntry,sizeof(tsCLD_PPEntry));
    ...
    {    
        if(psCustomDataStructure->asPowerProfileEntry[u8EntryPosition].u8PowerProfileId == 0) {
            ...
            FLib_MemCpy(&(psCustomDataStructure->asPowerProfileEntry[u8EntryPosition]),psPowerProfileEntry,sizeof(tsCLD_PPEntry));
