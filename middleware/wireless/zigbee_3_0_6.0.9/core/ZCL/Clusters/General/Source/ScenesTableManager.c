                            ...
                            bool_t                      bEnhanced)
{
    ...
    psTableEntry = (tsCLD_ScenesTableEntry*)psDLISTsearchFromHead(&psCommon->lScenesAllocList, (boDLISTtest *)bCLD_ScenesSearchForScene, (void*)&sSearchParameter);
    ...
    FLib_MemSet(psTableEntry->au8SceneName, 0, sizeof(psTableEntry->au8SceneName));
    ...
    FLib_MemSet(psTableEntry->au8SceneData, 0, sizeof(psTableEntry->au8SceneData));
    ...
    FLib_MemCpy(&psTableEntry->au8SceneData, psPayload->sExtensionField.pu8Data, psPayload->sExtensionField.u16Length);
                            ...
                            uint8                       u8ToSceneId)
{
   ...
   eStatus = eCLD_GroupsCheckGroupExists(psEndPointDefinition, u16ToGroupId);
    ...
    psFrom = (tsCLD_ScenesTableEntry*)psDLISTsearchFromHead(&psCommon->lScenesAllocList, (boDLISTtest *)bCLD_ScenesSearchForScene, (void*)&sSearchParameter);
    if(psFrom == NULL)
    {
        #ifndef COOPERATIVE
            eZCL_ReleaseMutex(psEndPointDefinition);
    ...
    psTo = (tsCLD_ScenesTableEntry*)psDLISTsearchFromHead(&psCommon->lScenesAllocList, (boDLISTtest *)bCLD_ScenesSearchForScene, (void*)&sSearchParameter);
    if (psTo == NULL)
    {
                            ...
                            uint16                      u16ToGroupId)
{
    ...
    while(psFrom != NULL)
    {
        ...
        sSearchParameter.u8SearchOptions = CLD_SCENES_SEARCH_GROUP_ID;
        sSearchParameter.u16GroupId = u16FromGroupId;
        psFrom = (tsCLD_ScenesTableEntry*)psDLISTsearchForward((DNODE*)psFrom, (boDLISTtest *)bCLD_ScenesSearchForScene, (void*)&sSearchParameter);
                            ...
                            uint8                       u8ToSceneId)
{
    ...
    FLib_MemCpy(psTo->au8SceneName, psFrom->au8SceneName, CLD_SCENES_MAX_SCENE_NAME_LENGTH + 1);
    psTo->u16SceneDataLength    = psFrom->u16SceneDataLength;
    FLib_MemCpy(psTo->au8SceneData, psFrom->au8SceneData, CLD_SCENES_MAX_SCENE_STORAGE_BYTES);
    #ifdef CLD_SCENES_TABLE_SUPPORT_TRANSITION_TIME_IN_MS
