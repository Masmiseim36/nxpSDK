...
/*!=============================================================================
\file       ColourControl.c
\brief      Colour Control cluster definition
==============================================================================*/
...
/****************************************************************************/
    ...
    #endif
    #if (CLD_COLOURCONTROL_COLOUR_CAPABILITIES == 0)
        {E_CLD_COLOURCONTROL_CMD_STEP_COLOUR_TEMPERATURE,             E_ZCL_CF_RX}/* Optional */ /* to be looked later */
    #endif
    };
#endif
...
const tsZCL_AttributeDefinition asCLD_ColourControlClusterAttributeDefinitions[] = {
    ...
    tsZCL_SceneExtensionTable sCLD_ColourControlSceneExtensionTable =
    {
            ...
            8,
           {
            ...
            E_CLD_COLOURCONTROL_ATTR_ENHANCED_CURRENT_HUE,
        ...
        tsCLD_ColourControlCustomDataStructure  *psCustomDataStructure)
{
    ...
    /* Set attribute default values */
        ...
        // set default state
        #ifdef CLD_COLOURCONTROL_ATTR_COLOUR_TEMPERATURE_MIRED
            #ifdef CLD_COLOURCONTROL_ATTR_STARTUP_COLOUR_TEMPERATURE_MIRED
                if(psSharedStructPtr->u16StartupColourTemperatureMired <= 0xFFEF)
                {
                ...
                #if CLD_COLOURCONTROL_COLOUR_TEMPERATURE_PHY_MIN /* Avoid compiler warning */
...
PUBLIC  teZCL_Status eCLD_ColourControlUpdate(uint8 u8SourceEndPointId)
{
    ...
    {
        FLib_MemCpy(&psCommon->sTransition.sPrevious, &psCommon->sTransition.sCurrent, sizeof(tsCLD_ColourControl_Attributes));
    }
    ...
    case E_CLD_COLOURCONTROL_COLOURMODE_CURRENT_HUE_AND_CURRENT_SATURATION:
        ...
        if(eStatus == E_ZCL_ERR_PARAMETER_RANGE)
        {
            ...
            FLib_MemCpy(&psCommon->sTransition.sCurrent, &psCommon->sTransition.sPrevious, sizeof(tsCLD_ColourControl_Attributes));
        }
         ...
         tsCLD_ColourControlCustomDataStructure *psCommon)
{
    ...
    FLib_MemCpy(&psCommon->sTransition.sCurrent, &psCommon->sTransition.sTarget, sizeof(tsCLD_ColourControl_Attributes));
