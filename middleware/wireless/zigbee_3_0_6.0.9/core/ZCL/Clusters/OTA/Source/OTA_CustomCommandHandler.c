...
/*!
\file       OTA_CustomCommandHandler.c
\brief      Over The Air Upgrade custom command handler
*/
...
#else
                    ((tsOTA_Common *)psClusterInstance->pvEndPointCustomStructPtr)->sOTACallBackMessage.sPersistedData.serverAddress.uAddress.u16DestinationAddress !=
#endif
...
#else
            //TODO: verify IP src addr for ZCLIP
#endif
