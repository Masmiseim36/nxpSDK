...
/*!=============================================================================
\file       IASACE.c
\brief      IAS ACE cluster definition
==============================================================================*/
                ...
                uint8                                       u8ParameterValue)
{
    ...
    switch(eParameterId)
    {
        case E_CLD_IASACE_PANEL_PARAMETER_PANEL_STATUS:
            ...
            FLib_MemCpy(&sPayload,(tsCLD_IASACE_PanelStatusChangedOrGetPanelStatusRespPayload *)&pCustomDataStructure->sCLD_IASACE_PanelParameter,sizeof(tsCLD_IASACE_PanelStatusChangedOrGetPanelStatusRespPayload));
                ...
                uint8                                       *pu8ParameterValue)
{
    ...
    switch(eParameterId)
    {
        ...
        case E_CLD_IASACE_ZONE_PARAMETER_ZONE_LABEL:
            ...
            FLib_MemCpy(pCustomDataStructure->asCLD_IASACE_ZoneParameter[u8ZoneID].au8ZoneLabel,pu8ParameterValue,u8ParameterLength);
        break;
        ...
        case E_CLD_IASACE_ZONE_PARAMETER_ARM_DISARM_CODE:
            ...
            FLib_MemCpy(pCustomDataStructure->asCLD_IASACE_ZoneParameter[u8ZoneID].au8ArmDisarmCode,pu8ParameterValue,u8ParameterLength);
        break;
    ...
    switch(eParameterId)
    {
        ...
        case E_CLD_IASACE_ZONE_PARAMETER_ZONE_LABEL:
            ...
            *pu8ParameterLength = pCustomDataStructure->asCLD_IASACE_ZoneParameter[u8ZoneID].sZoneLabel.u8Length;
            FLib_MemCpy(pu8ParameterValue,pCustomDataStructure->asCLD_IASACE_ZoneParameter[u8ZoneID].au8ZoneLabel,*pu8ParameterLength);
        break;
        ...
        case E_CLD_IASACE_ZONE_PARAMETER_ARM_DISARM_CODE:
            ...
            *pu8ParameterLength = pCustomDataStructure->asCLD_IASACE_ZoneParameter[u8ZoneID].sArmDisarmCode.u8Length;
            FLib_MemCpy(pu8ParameterValue,pCustomDataStructure->asCLD_IASACE_ZoneParameter[u8ZoneID].au8ArmDisarmCode,*pu8ParameterLength);
        break;
