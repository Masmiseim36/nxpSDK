...
/*!=============================================================================
\file       DRLCCustomCommandResponsesClient.c
\brief      DRLC client command handlers
==============================================================================*/
                    ...
                    tsZCL_ClusterInstance       *psClusterInstance)
{
    ...
    FLib_MemSet(&sReportEvent, 0, sizeof(tsSE_DRLCReportEvent));
    ...
    if(u8DRLCClusterReturn != E_ZCL_SUCCESS)
    {
        ...
        // call user
        FLib_MemSet(&psDRLC_Common->sDRLCCallBackMessage.uMessage.sLoadControlEvent, 0, sizeof(tsSE_DRLCLoadControlEvent));
                    ...
                    tsZCL_ClusterInstance       *psClusterInstance)
{
    ...
    if(u8DRLCClusterReturn != E_ZCL_SUCCESS)
    {
        // assume we don't send an event for this - the data isn't valid to be able act on
        // call user
        FLib_MemSet(&psDRLC_Common->sDRLCCallBackMessage.uMessage.sCancelLoadControlEvent, 0, sizeof(tsSE_DRLCCancelLoadControlEvent));
        psEndPointDefinition->pCallBackFunctions(&psDRLC_Common->sDRLCCustomCallBackEvent);
        // release mutex
        #ifndef COOPERATIVE
            eZCL_ReleaseMutex(psEndPointDefinition);
                    ...
                    tsZCL_ClusterInstance       *psClusterInstance)
{
    ...
    if(u8DRLCClusterReturn != E_ZCL_SUCCESS)
    {
        // assume we don't send an event for this - the data isn't valid to be able act on
        // call user
        FLib_MemSet(&psDRLC_Common->sDRLCCallBackMessage.uMessage.sCancelLoadControlAllEvent, 0, sizeof(tsSE_DRLCCancelLoadControlAllEvent));
        psEndPointDefinition->pCallBackFunctions(&psDRLC_Common->sDRLCCustomCallBackEvent);
