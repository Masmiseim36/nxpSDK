...
/*!=============================================================================
\file       DRLCScheduler.c
\brief      DRLC Event scheduler
==============================================================================*/
                            ...
                            uint32  u32UTCtime)
{
    ...
    while(psLoadControlEventRecord != NULL)
    {
        ...
        if(boEffectiveExpiredTimeCheck(psLoadControlEventRecord, psEndPointDefinition, psClusterInstance, u32UTCtime))
        {
            ...
            FLib_MemCpy(&psDRLC_Common->sDRLCCallBackMessage.uMessage.sLoadControlEvent, &psLoadControlEventRecord->sLoadControlEvent, sizeof(tsSE_DRLCLoadControlEvent));
