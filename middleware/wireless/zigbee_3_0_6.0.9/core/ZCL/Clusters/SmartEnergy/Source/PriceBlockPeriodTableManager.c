...
/*!=============================================================================
\file        PriceBlockPeriodTableManager.c
\brief       Maintain the list of Block Period Table events
==============================================================================*/
        ...
        tsSE_BlockThresholds                    *psBlockThresholds)
{
    ...
    FLib_MemCpy(&psTablePublishBlockPeriod->sPublishBlockPeriodCmdPayload, psPublishBlockPeriodCmdPayload,
    ...
    {
        FLib_MemCpy(&psTablePublishBlockPeriod->sBlockThresholds, psBlockThresholds,
