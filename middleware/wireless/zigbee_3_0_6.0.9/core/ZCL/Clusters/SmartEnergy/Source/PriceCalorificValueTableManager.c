...
/*!=============================================================================
\file       PriceCalorificValueTableManager.c
\brief      Maintain the list of Calorific Value with their start time.
==============================================================================*/
...

{
    ...
    FLib_MemCpy(&psTablePublishCalorificValue->sPublishCalorificValueCmdPayload, psPublishCalorificValueCmdPayload,
