...
/*!=============================================================================
\file       PriceConversionFactorTableManager.c
\brief      Maintain the list of Conversion Factor with their start time.
==============================================================================*/
...

{
    ...
    FLib_MemCpy(&psTablePublishConversionFactor->sPublishConversionCmdPayload, psPublishConversionCmdPayload,
