...
/*!=============================================================================
\file       PriceTableManager.c
\brief      Maintain the list of price events.
==============================================================================*/
...
/****************************************************************************/
//PRIVATE bool boSearchForInsertPoint( void *pvSearchParam, DNODE *psNodeUnderTest);
...
)
{
    ...
    psPublishPriceRecord = (tsSE_PricePublishPriceRecord *)psDLISTgetHead( &psPriceCustomDataStructure->lPriceAllocList );
    psPublishPriceRecord = (tsSE_PricePublishPriceRecord *)psDLISTsearchForward((DNODE *)psPublishPriceRecord, (boDLISTtest*)boSearchForExisting, (void *)&u32StartTime);
...
PRIVATE  void vCopyRecordIntoTable(tsSE_PricePublishPriceCmdPayload *psTablePublishPriceCmdPayload, tsSE_PricePublishPriceCmdPayload *psPublishPriceCmdPayload)
{
    ...
    FLib_MemCpy(psTablePublishPriceCmdPayload, psPublishPriceCmdPayload, sizeof(tsSE_PricePublishPriceCmdPayload));
    ...
    FLib_MemCpy(psTablePublishPriceCmdPayload->sRateLabel.pu8Data, psPublishPriceCmdPayload->sRateLabel.pu8Data, sRateLabel.u8MaxLength);
