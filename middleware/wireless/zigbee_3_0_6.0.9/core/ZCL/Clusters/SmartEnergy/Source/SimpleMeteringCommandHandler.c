...
/*!=============================================================================
\file       SimpleMetering.c
\brief      Simple Metering Cluster Definition
==============================================================================*/
...
PRIVATE bool bSM_IsMirroredEndPoint(uint8 u8EndPoint);
...
PRIVATE void vSM_UpdateFastPollModeStatus(bool bStatus);

PRIVATE  bool bSM_GetFastPollModeStatus(void);
