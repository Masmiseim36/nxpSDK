...
typedef enum {
    ZPS_APS_UNIQUE_LINK_KEY = 0x00,                 /*Initial key*/
    ZPS_APS_GLOBAL_LINK_KEY = 0x01,
#ifdef WWAH_SUPPORT
    ZPS_APS_TCLK_LINK_KEY = 0x02,
    ZPS_APS_PARTNER_LINK_KEY = 0x03,
    ZPS_APS_NEG_LINK_KEY = 0x04,
    ZPS_APS_NO_KEY_PRESENT = 0x05
#endif
...
{
    zps_vAplZdoSetVsOUI(ZPS_pvAplZdoGetAplHandle(), pu8VsOUI);
}
