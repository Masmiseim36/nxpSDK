...
/*!
\file       zps_apl_zdp.h
\brief      Zigbee Device Profile (ZDP) interface
*/
...
INLINE ZPS_teStatus ZPS_eAplZdpNwkAddrRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpNwkAddrReq *psZdpNwkAddrReq)
{
    return zps_eAplZdpNwkAddrRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpNwkAddrReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpIeeeAddrRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpIeeeAddrReq *psZdpIeeeAddrReq)
{
    return zps_eAplZdpIeeeAddrRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpIeeeAddrReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpNodeDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpNodeDescReq *psZdpNodeDescReq)
{
    return zps_eAplZdpNodeDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpNodeDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpPowerDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpPowerDescReq *psZdpPowerDescReq)
{
    return zps_eAplZdpPowerDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpPowerDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpSimpleDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpSimpleDescReq *psZdpSimpleDescReq)
{
    return zps_eAplZdpSimpleDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpSimpleDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpActiveEpRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpActiveEpReq *psZdpActiveEpReq)
{
    return zps_eAplZdpActiveEpRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpActiveEpReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMatchDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMatchDescReq *psZdpMatchDescReq)
{
    return zps_eAplZdpMatchDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMatchDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpComplexDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpComplexDescReq *psZdpComplexDescReq)
{
    return zps_eAplZdpComplexDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpComplexDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpUserDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpUserDescReq *psZdpUserDescReq)
{
    return zps_eAplZdpUserDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpUserDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpDiscoveryCacheRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpDiscoveryCacheReq *psZdpDiscoveryCacheReq)
{
    return zps_eAplZdpDiscoveryCacheRequest(pvApl, hAPduInst, pu8SeqNumber, psZdpDiscoveryCacheReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpDeviceAnnceRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpDeviceAnnceReq *psZdpDeviceAnnceReq)
{
    return zps_eAplZdpDeviceAnnceRequest(pvApl, hAPduInst, pu8SeqNumber, psZdpDeviceAnnceReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpUserDescSetRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpUserDescSet *psZdpUserDescSetReq)
{
    return zps_eAplZdpUserDescSetRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpUserDescSetReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpSystemServerDiscoveryRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpSystemServerDiscoveryReq *psZdpSystemServerDiscoveryReq)
{
    return zps_eAplZdpSystemServerDiscoveryRequest(pvApl, hAPduInst, pu8SeqNumber, psZdpSystemServerDiscoveryReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpDiscoveryStoreRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpDiscoveryStoreReq *psZdpDiscoveryStoreReq)
{
    return zps_eAplZdpDiscoveryStoreRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpDiscoveryStoreReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpNodeDescStoreRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpNodeDescStoreReq *psZdpNodeDescStoreReq)
{
    return zps_eAplZdpNodeDescStoreRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpNodeDescStoreReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpPowerDescStoreRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpPowerDescStoreReq *psZdpPowerDescStoreReq)
{
    return zps_eAplZdpPowerDescStoreRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpPowerDescStoreReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpActiveEpStoreRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpActiveEpStoreReq *psZdpActiveEpStoreReq)
{
    return zps_eAplZdpActiveEpStoreRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpActiveEpStoreReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpSimpleDescStoreRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpSimpleDescStoreReq *psZdpSimpleDescStoreReq)
{
    return zps_eAplZdpSimpleDescStoreRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpSimpleDescStoreReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpRemoveNodeCacheRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpRemoveNodeCacheReq *psZdpRemoveNodeCacheReq)
{
    return zps_eAplZdpRemoveNodeCacheRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpRemoveNodeCacheReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpFindNodeCacheRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpFindNodeCacheReq *psZdpFindNodeCacheReq)
{
    return zps_eAplZdpFindNodeCacheRequest(pvApl, hAPduInst, pu8SeqNumber, psZdpFindNodeCacheReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpExtendedSimpleDescRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpExtendedSimpleDescReq *psZdpExtendedSimpleDescReq)
{
    return zps_eAplZdpExtendedSimpleDescRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpExtendedSimpleDescReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpExtendedActiveEpRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpExtendedActiveEpReq *psZdpExtendedActiveEpReq)
{
    return zps_eAplZdpExtendedActiveEpRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpExtendedActiveEpReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpEndDeviceBindRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    uint8 *pu8SeqNumber,
    ZPS_tsAplZdpEndDeviceBindReq *psZdpEndDeviceBindReq)
{
    return zps_eAplZdpEndDeviceBindRequest(pvApl, hAPduInst, pu8SeqNumber, psZdpEndDeviceBindReq);
}
...
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpBindUnbindRequest(
    ...
    ZPS_tsAplZdpBindUnbindReq *psZdpBindReq)
{
    return zps_eAplZdpBindUnbindRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, bBindReq, psZdpBindReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpBindRegisterRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpBindRegisterReq *psZdpBindRegisterReq)
{
    return zps_eAplZdpBindRegisterRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpBindRegisterReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpReplaceDeviceRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpReplaceDeviceReq *psZdpReplaceDeviceReq)
{
    return zps_eAplZdpReplaceDeviceRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpReplaceDeviceReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpStoreBkupBindEntryRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpStoreBkupBindEntryReq *psZdpStoreBkupBindEntryReq)
{
    return zps_eAplZdpStoreBkupBindEntryRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpStoreBkupBindEntryReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpRemoveBkupBindEntryRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpRemoveBkupBindEntryReq *psZdpRemoveBkupBindEntryReq)
{
    return zps_eAplZdpRemoveBkupBindEntryRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpRemoveBkupBindEntryReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpBackupBindTableRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpBackupBindTableReq *psZdpBackupBindTableReq)
{
    return zps_eAplZdpBackupBindTableRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpBackupBindTableReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpRecoverBindTableRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpRecoverBindTableReq *psZdpRecoverBindTableReq)
{
    return zps_eAplZdpRecoverBindTableRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpRecoverBindTableReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpBackupSourceBindRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpBackupSourceBindReq *psZdpBackupSourceBindReq)
{
    return zps_eAplZdpBackupSourceBindRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpBackupSourceBindReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpRecoverSourceBindRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpRecoverSourceBindReq *psZdpRecoverSourceBindReq)
{
    return zps_eAplZdpRecoverSourceBindRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpRecoverSourceBindReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtNwkDiscRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtNwkDiscReq *psZdpMgmtNwkDiscReq)
{
    return zps_eAplZdpMgmtNwkDiscRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtNwkDiscReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtLqiRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtLqiReq *psZdpMgmtLqiReq)
{
    return zps_eAplZdpMgmtLqiRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtLqiReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtRtgRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtRtgReq *psZdpMgmtRtgReq)
{
    return zps_eAplZdpMgmtRtgRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtRtgReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtBindRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtBindReq *psZdpMgmtBindReq)
{
    return zps_eAplZdpMgmtBindRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtBindReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtLeaveRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtLeaveReq *psZdpMgmtLeaveReq)
{
    return zps_eAplZdpMgmtLeaveRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtLeaveReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtDirectJoinRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtDirectJoinReq *psZdpMgmtDirectJoinReq)
{
    return zps_eAplZdpMgmtDirectJoinRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtDirectJoinReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtPermitJoiningRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtPermitJoiningReq *psZdpMgmtPermitJoiningReq)
{
    return zps_eAplZdpMgmtPermitJoiningRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtPermitJoiningReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtCacheRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtCacheReq *psZdpMgmtCacheReq)
{
    return zps_eAplZdpMgmtCacheRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtCacheReq);
}

INLINE ZPS_teStatus ZPS_eAplZdpMgmtNwkUpdateRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtNwkUpdateReq *psZdpMgmtNwkUpdateReq)
{
    return zps_eAplZdpMgmtNwkUpdateRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtNwkUpdateReq);
}
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpParentAnnceReq
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
...
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdpParentAnnceReq(
    ...
    ZPS_tsAplZdpParentAnnceReq *psZdpParentAnnceReq)
{
    return zps_eAplZdpParentAnnceReq(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpParentAnnceReq);
}




INLINE ZPS_teStatus ZPS_eAplZdpMgmtMibIeeeRequest(
    void *pvApl,
    PDUM_thAPduInstance hAPduInst,
    ZPS_tuAddress uDstAddr,
    bool bExtAddr,
    ...
    ZPS_tsAplZdpMgmtMibIeeeReq *psZdpMgmtMibIeeeReq)
{
    return zps_eAplZdpMgmtMibIeeeRequest(pvApl, hAPduInst, uDstAddr, bExtAddr, pu8SeqNumber, psZdpMgmtMibIeeeReq);
}
