...
/*!
\file       mac_sap.h
\brief      SAP interface for MLME and MCPS
*/
...
#define MAC_TX_OPTION_CSMA_OFF          (16)            /**< Disable CSMA */
...
#define FCF_ADDR_MODE_OFF    0
#define FCF_ADDR_MODE_SHORT  2
#define FCF_ADDR_MODE_LONG   3
...
#define MAC_TX_POWER_DEFAULT		(22)                    /* 0dBm on KW41Z, default value of gPhyDefaultTxPowerLevel_d */
...
typedef teTxDoneAction (*tpreTxCallback)(struct tsTxFrameFormat_tag *, uint32);
 ...
 */
typedef void (*TSV_ExpireCb_pr)(void *);
...
PUBLIC PHY_Enum_e eAppApiPlmeSet(PHY_PibAttr_e ePhyPibAttribute,
                                  uint32 u32PhyPibValue);
PUBLIC int8_t eAppApiPhyConvertLQIToRSSI(uint8_t lqi);
PUBLIC void vAppApiEnableBeaconResponse(bool_t bEnable);
PUBLIC void *pvAppApiGetMacAddrLocation(void);
PUBLIC void vAppApiSetMacAddrLocation(void* pu64MacAddress);
