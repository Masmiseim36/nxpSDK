                                              ...
                                              ZPS_tsAfZdpEvent* psReturnStruct )                                              
{
    ...
    if( psZdoServerEvent != NULL)
    {
        ...
        {
            FLib_MemSet( &psReturnStruct->uZdpData.sNodeDescRsp.sNodeDescriptor,0, sizeof( psReturnStruct->uZdpData.sNodeDescRsp.sNodeDescriptor ));
        }
    }
    return bZdp;
}    
                                               ...
                                               ZPS_tsAfZdpEvent* psReturnStruct )
{
    ...
    if( psZdoServerEvent != NULL)
    {
        ...
        {
            FLib_MemSet( &psReturnStruct->uZdpData.sPowerDescRsp.sPowerDescriptor,0, sizeof( psReturnStruct->uZdpData.sPowerDescRsp.sPowerDescriptor ));
        }
    }
    return bZdp;
}
                                                ...
                                                ZPS_tsAfZdpEvent* psReturnStruct )
{
    ...
    if( psZdoServerEvent != NULL)
    {
        ...
        {
            FLib_MemSet( &psReturnStruct->uZdpData.sSimpleDescRsp.sSimpleDescriptor,0, sizeof( psReturnStruct->uZdpData.sSimpleDescRsp.sSimpleDescriptor ));
        }
    }
    return bZdp;
}    
                                                 ...
                                                 ZPS_tsAfZdpEvent* psReturnStruct )
{
    ...
    if( psZdoServerEvent != NULL)
    {
        ...
        {
            FLib_MemSet( &psReturnStruct->uZdpData.sComplexDescRsp.sComplexDescriptor,0, sizeof( psReturnStruct->uZdpData.sComplexDescRsp.sComplexDescriptor ));
        }
    }
    return bZdp;
}    
                                                      ...
                                                      ZPS_tsAfZdpEvent* psReturnStruct )
{
    ...
    if( psZdoServerEvent != NULL)
    {
        ...
        {
            FLib_MemSet( &psReturnStruct->uZdpData.sRecoverBindTableRsp.sBindingTableList ,0, sizeof( psReturnStruct->uZdpData.sRecoverBindTableRsp.sBindingTableList ));
        }
    }
    return bZdp;
}
                                                  ...
                                                  ZPS_tsAfZdpEvent* psReturnStruct )
{
    ...
    if( psZdoServerEvent != NULL)
    {
        ...
        {
            FLib_MemSet( &psReturnStruct->uZdpData.sBindRegisterRsp.sBindingTableList ,0, sizeof( psReturnStruct->uZdpData.sBindRegisterRsp.sBindingTableList ));
        }
    }
    return bZdp;
}
