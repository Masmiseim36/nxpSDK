...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _ux_dcd_nxp_dci_callback                            PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*    _ux_dcd_nxp_dci_initialize_complete   Complete initialization       */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
/*    NXP_DCI Driver                                                      */
...
uint8_t device_speed;
    ...
    if ((uint32_t)kUSB_DeviceEventBusReset == event)
    {
        ...
        _ux_dcd_nxp_dci_initialize_complete();

        /* Mark the device as attached now.  */
        _ux_system_slave -> ux_system_slave_device.ux_slave_device_state =  UX_DEVICE_ATTACHED;
    }
    if ((uint32_t)kUSB_DeviceEventDetach == event)
    {
