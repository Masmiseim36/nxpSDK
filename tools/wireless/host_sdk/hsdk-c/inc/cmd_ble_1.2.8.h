/* Header file generated from BLE_1.2.6.xml */
/*
 * Copyright 2018 NXP
 * All rights reserved.
 *
...
typedef enum L2CAPConfirm_Status_tag {
	...
	L2CAPConfirm_Status_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041B,
...
{
	L2CAPRegisterLePsmRequest_FSCI_ID = 0x4108,
	L2CAPDeregisterLePsmRequest_FSCI_ID = 0x4109,
	L2CAPConnectLePsmRequest_FSCI_ID = 0x410A,
	L2CAPDisconnectLeCbChannelRequest_FSCI_ID = 0x410B,
	L2CAPCancelConnectionRequest_FSCI_ID = 0x410C,
	L2CAPSendLeCbDataRequest_FSCI_ID = 0x410D,
	L2CAPSendLeCreditRequest_FSCI_ID = 0x410E,
	GATTInitRequest_FSCI_ID = 0x4401,
	GATTGetMtuRequest_FSCI_ID = 0x4402,
	GATTClientInitRequest_FSCI_ID = 0x4403,
	GATTClientResetProcedureRequest_FSCI_ID = 0x4404,
	GATTClientRegisterProcedureCallbackRequest_FSCI_ID = 0x4405,
	GATTClientRegisterNotificationCallbackRequest_FSCI_ID = 0x4406,
	GATTClientRegisterIndicationCallbackRequest_FSCI_ID = 0x4407,
	GATTClientExchangeMtuRequest_FSCI_ID = 0x4408,
	GATTClientDiscoverAllPrimaryServicesRequest_FSCI_ID = 0x4409,
	GATTClientDiscoverPrimaryServicesByUuidRequest_FSCI_ID = 0x440A,
	GATTClientFindIncludedServicesRequest_FSCI_ID = 0x440B,
	GATTClientDiscoverAllCharacteristicsOfServiceRequest_FSCI_ID = 0x440C,
	GATTClientDiscoverCharacteristicOfServiceByUuidRequest_FSCI_ID = 0x440D,
	GATTClientDiscoverAllCharacteristicDescriptorsRequest_FSCI_ID = 0x440E,
	GATTClientReadCharacteristicValueRequest_FSCI_ID = 0x440F,
	GATTClientReadUsingCharacteristicUuidRequest_FSCI_ID = 0x4410,
	GATTClientReadMultipleCharacteristicValuesRequest_FSCI_ID = 0x4411,
	GATTClientWriteCharacteristicValueRequest_FSCI_ID = 0x4412,
	GATTClientReadCharacteristicDescriptorRequest_FSCI_ID = 0x4413,
	GATTClientWriteCharacteristicDescriptorRequest_FSCI_ID = 0x4414,
	GATTServerInitRequest_FSCI_ID = 0x4415,
	GATTServerRegisterCallbackRequest_FSCI_ID = 0x4416,
	GATTServerRegisterHandlesForWriteNotificationsRequest_FSCI_ID = 0x4417,
	GATTServerSendAttributeWrittenStatusRequest_FSCI_ID = 0x4418,
	GATTServerSendNotificationRequest_FSCI_ID = 0x4419,
	GATTServerSendIndicationRequest_FSCI_ID = 0x441A,
	GATTServerSendInstantValueNotificationRequest_FSCI_ID = 0x441B,
	GATTServerSendInstantValueIndicationRequest_FSCI_ID = 0x441C,
	GATTServerRegisterHandlesForReadNotificationsRequest_FSCI_ID = 0x441D,
	GATTServerSendAttributeReadStatusRequest_FSCI_ID = 0x441E,
	GATTDBInitRequest_FSCI_ID = 0x4501,
	GATTDBWriteAttributeRequest_FSCI_ID = 0x4502,
	GATTDBReadAttributeRequest_FSCI_ID = 0x4503,
	GATTDBFindServiceHandleRequest_FSCI_ID = 0x4504,
	GATTDBFindCharValueHandleInServiceRequest_FSCI_ID = 0x4505,
	GATTDBFindCccdHandleForCharValueHandleRequest_FSCI_ID = 0x4506,
	GATTDBFindDescriptorHandleForCharValueHandleRequest_FSCI_ID = 0x4507,
	GATTDBDynamicInitRequest_FSCI_ID = 0x4508,
	GATTDBDynamicReleaseDatabaseRequest_FSCI_ID = 0x4509,
	GATTDBDynamicAddPrimaryServiceDeclarationRequest_FSCI_ID = 0x450A,
	GATTDBDynamicAddSecondaryServiceDeclarationRequest_FSCI_ID = 0x450B,
	GATTDBDynamicAddIncludeDeclarationRequest_FSCI_ID = 0x450C,
	GATTDBDynamicAddCharacteristicDeclarationAndValueRequest_FSCI_ID = 0x450D,
	GATTDBDynamicAddCharacteristicDescriptorRequest_FSCI_ID = 0x450E,
	GATTDBDynamicAddCccdRequest_FSCI_ID = 0x450F,
	GATTDBDynamicAddCharacteristicDeclarationWithUniqueValueRequest_FSCI_ID = 0x4510,
	GATTDBDynamicRemoveServiceRequest_FSCI_ID = 0x4511,
	GATTDBDynamicRemoveCharacteristicRequest_FSCI_ID = 0x4512,
	BLEHostInitializeRequest_FSCI_ID = 0x4701,
	GAPRegisterDeviceSecurityRequirementsRequest_FSCI_ID = 0x4702,
	GAPSetAdvertisingParametersRequest_FSCI_ID = 0x4703,
	GAPSetAdvertisingDataRequest_FSCI_ID = 0x4704,
	GAPStartAdvertisingRequest_FSCI_ID = 0x4705,
	GAPStopAdvertisingRequest_FSCI_ID = 0x4706,
	GAPAuthorizeRequest_FSCI_ID = 0x4707,
	GAPSaveCccdRequest_FSCI_ID = 0x4708,
	GAPCheckNotificationStatusRequest_FSCI_ID = 0x4709,
	GAPCheckIndicationStatusRequest_FSCI_ID = 0x470A,
	GAPGetBondedStaticAddressesRequest_FSCI_ID = 0x470B,
	GAPPairRequest_FSCI_ID = 0x470C,
	GAPSendSlaveSecurityRequestRequest_FSCI_ID = 0x470D,
	GAPEncryptLinkRequest_FSCI_ID = 0x470E,
	GAPAcceptPairingRequestRequest_FSCI_ID = 0x470F,
	GAPRejectPairingRequest_FSCI_ID = 0x4710,
	GAPEnterPasskeyRequest_FSCI_ID = 0x4711,
	GAPProvideOobRequest_FSCI_ID = 0x4712,
	GAPRejectPasskeyRequestRequest_FSCI_ID = 0x4713,
	GAPSendSmpKeysRequest_FSCI_ID = 0x4714,
	GAPRejectKeyExchangeRequestRequest_FSCI_ID = 0x4715,
	GAPProvideLongTermKeyRequest_FSCI_ID = 0x4716,
	GAPDenyLongTermKeyRequest_FSCI_ID = 0x4717,
	GAPLoadEncryptionInformationRequest_FSCI_ID = 0x4718,
	GAPSetLocalPasskeyRequest_FSCI_ID = 0x4719,
	GAPStartScanningRequest_FSCI_ID = 0x471A,
	GAPStopScanningRequest_FSCI_ID = 0x471B,
	GAPConnectRequest_FSCI_ID = 0x471C,
	GAPDisconnectRequest_FSCI_ID = 0x471D,
	GAPSaveCustomPeerInformationRequest_FSCI_ID = 0x471E,
	GAPLoadCustomPeerInformationRequest_FSCI_ID = 0x471F,
	GAPCheckIfBondedRequest_FSCI_ID = 0x4720,
	GAPReadWhiteListSizeRequest_FSCI_ID = 0x4721,
	GAPClearWhiteListRequest_FSCI_ID = 0x4722,
	GAPAddDeviceToWhiteListRequest_FSCI_ID = 0x4723,
	GAPRemoveDeviceFromWhiteListRequest_FSCI_ID = 0x4724,
	GAPReadPublicDeviceAddressRequest_FSCI_ID = 0x4725,
	GAPCreateRandomDeviceAddressRequest_FSCI_ID = 0x4726,
	GAPSaveDeviceNameRequest_FSCI_ID = 0x4727,
	GAPGetBondedDevicesCountRequest_FSCI_ID = 0x4728,
	GAPGetBondedDeviceNameRequest_FSCI_ID = 0x4729,
	GAPRemoveBondRequest_FSCI_ID = 0x472A,
	GAPRemoveAllBondsRequest_FSCI_ID = 0x472B,
	GAPReadRadioPowerLevelRequest_FSCI_ID = 0x472C,
	GAPVerifyPrivateResolvableAddressRequest_FSCI_ID = 0x472D,
	GAPSetRandomAddressRequest_FSCI_ID = 0x472E,
	GAPSetScanModeRequest_FSCI_ID = 0x472F,
	GAPSetDefaultPairingParametersRequest_FSCI_ID = 0x4730,
	GAPUpdateConnectionParametersRequest_FSCI_ID = 0x4731,
	GAPEnableUpdateConnectionParametersRequest_FSCI_ID = 0x4732,
	GapUpdateLeDataLengthRequest_FSCI_ID = 0x4733,
	GAPControllerResetRequest_FSCI_ID = 0x4734,
	GAPEnableHostPrivacyRequest_FSCI_ID = 0x4735,
	GAPEnableControllerPrivacyRequest_FSCI_ID = 0x4736,
	GAPLeScRegeneratePublicKeyRequest_FSCI_ID = 0x4737,
	GAPLeScValidateNumericValueRequest_FSCI_ID = 0x4738,
	GAPLeScGetLocalOobDataRequest_FSCI_ID = 0x4739,
	GAPLeScSetPeerOobDataRequest_FSCI_ID = 0x473A,
	GAPLeScSendKeypressNotificationPrivacyRequest_FSCI_ID = 0x473B,
	GAPGetBondedDevicesIdentityInformationRequest_FSCI_ID = 0x473C,
	GAPSetTxPowerLevelRequest_FSCI_ID = 0x473D,
	...
	L2CAPConfirm_FSCI_ID = 0x4180,
	L2CAPLePsmConnectionRequestIndication_FSCI_ID = 0x4184,
	L2CAPLePsmConnectionCompleteIndication_FSCI_ID = 0x4185,
	L2CAPLePsmDisconnectNotificationIndication_FSCI_ID = 0x4186,
	L2CAPNoPeerCreditsIndication_FSCI_ID = 0x4187,
	L2CAPLocalCreditsNotificationIndication_FSCI_ID = 0x4188,
	L2CAPLeCbDataIndication_FSCI_ID = 0x4189,
	GATTConfirm_FSCI_ID = 0x4480,
	GATTGetMtuIndication_FSCI_ID = 0x4481,
	GATTClientProcedureExchangeMtuIndication_FSCI_ID = 0x4482,
	GATTClientProcedureDiscoverAllPrimaryServicesIndication_FSCI_ID = 0x4483,
	GATTClientProcedureDiscoverPrimaryServicesByUuidIndication_FSCI_ID = 0x4484,
	GATTClientProcedureFindIncludedServicesIndication_FSCI_ID = 0x4485,
	GATTClientProcedureDiscoverAllCharacteristicsIndication_FSCI_ID = 0x4486,
	GATTClientProcedureDiscoverCharacteristicByUuidIndication_FSCI_ID = 0x4487,
	GATTClientProcedureDiscoverAllCharacteristicDescriptorsIndication_FSCI_ID = 0x4488,
	GATTClientProcedureReadCharacteristicValueIndication_FSCI_ID = 0x4489,
	GATTClientProcedureReadUsingCharacteristicUuidIndication_FSCI_ID = 0x448A,
	GATTClientProcedureReadMultipleCharacteristicValuesIndication_FSCI_ID = 0x448B,
	GATTClientProcedureWriteCharacteristicValueIndication_FSCI_ID = 0x448C,
	GATTClientProcedureReadCharacteristicDescriptorIndication_FSCI_ID = 0x448D,
	GATTClientProcedureWriteCharacteristicDescriptorIndication_FSCI_ID = 0x448E,
	GATTClientNotificationIndication_FSCI_ID = 0x448F,
	GATTClientIndicationIndication_FSCI_ID = 0x4490,
	GATTServerMtuChangedIndication_FSCI_ID = 0x4491,
	GATTServerHandleValueConfirmationIndication_FSCI_ID = 0x4492,
	GATTServerAttributeWrittenIndication_FSCI_ID = 0x4493,
	GATTServerCharacteristicCccdWrittenIndication_FSCI_ID = 0x4494,
	GATTServerAttributeWrittenWithoutResponseIndication_FSCI_ID = 0x4495,
	GATTServerErrorIndication_FSCI_ID = 0x4496,
	GATTServerLongCharacteristicWrittenIndication_FSCI_ID = 0x4497,
	GATTServerAttributeReadIndication_FSCI_ID = 0x4498,
	GATTDBConfirm_FSCI_ID = 0x4580,
	GATTDBReadAttributeIndication_FSCI_ID = 0x4581,
	GATTDBFindServiceHandleIndication_FSCI_ID = 0x4582,
	GATTDBFindCharValueHandleInServiceIndication_FSCI_ID = 0x4583,
	GATTDBFindCccdHandleForCharValueHandleIndication_FSCI_ID = 0x4584,
	GATTDBFindDescriptorHandleForCharValueHandleIndication_FSCI_ID = 0x4585,
	GATTDBDynamicAddPrimaryServiceDeclarationIndication_FSCI_ID = 0x4586,
	GATTDBDynamicAddSecondaryServiceDeclarationIndication_FSCI_ID = 0x4587,
	GATTDBDynamicAddIncludeDeclarationIndication_FSCI_ID = 0x4588,
	GATTDBDynamicAddCharacteristicDeclarationAndValueIndication_FSCI_ID = 0x4589,
	GATTDBDynamicAddCharacteristicDescriptorIndication_FSCI_ID = 0x458A,
	GATTDBDynamicAddCccdIndication_FSCI_ID = 0x458B,
	GATTDBDynamicAddCharacteristicDeclarationWithUniqueValueIndication_FSCI_ID = 0x458C,
	GAPConfirm_FSCI_ID = 0x4780,
	GAPCheckNotificationStatusIndication_FSCI_ID = 0x4781,
	GAPCheckIndicationStatusIndication_FSCI_ID = 0x4782,
	GAPGetBondedStaticAddressesIndication_FSCI_ID = 0x4783,
	GAPLoadEncryptionInformationIndication_FSCI_ID = 0x4784,
	GAPLoadCustomPeerInformationIndication_FSCI_ID = 0x4785,
	GAPCheckIfBondedIndication_FSCI_ID = 0x4786,
	GAPGetBondedDevicesCountIndication_FSCI_ID = 0x4787,
	GAPGetBondedDeviceNameIndication_FSCI_ID = 0x4788,
	GAPGenericEventInitializationCompleteIndication_FSCI_ID = 0x4789,
	GAPGenericEventInternalErrorIndication_FSCI_ID = 0x478A,
	GAPGenericEventAdvertisingSetupFailedIndication_FSCI_ID = 0x478B,
	GAPGenericEventAdvertisingParametersSetupCompleteIndication_FSCI_ID = 0x478C,
	GAPGenericEventAdvertisingDataSetupCompleteIndication_FSCI_ID = 0x478D,
	GAPGenericEventWhiteListSizeReadIndication_FSCI_ID = 0x478E,
	GAPGenericEventDeviceAddedToWhiteListIndication_FSCI_ID = 0x478F,
	GAPGenericEventDeviceRemovedFromWhiteListIndication_FSCI_ID = 0x4790,
	GAPGenericEventWhiteListClearedIndication_FSCI_ID = 0x4791,
	GAPGenericEventRandomAddressReadyIndication_FSCI_ID = 0x4792,
	GAPGenericEventCreateConnectionCanceledIndication_FSCI_ID = 0x4793,
	GAPGenericEventPublicAddressReadIndication_FSCI_ID = 0x4794,
	GAPGenericEventAdvTxPowerLevelReadIndication_FSCI_ID = 0x4795,
	GAPGenericEventPrivateResolvableAddressVerifiedIndication_FSCI_ID = 0x4796,
	GAPGenericEventRandomAddressSetIndication_FSCI_ID = 0x4797,
	GAPAdvertisingEventStateChangedIndication_FSCI_ID = 0x4798,
	GAPAdvertisingEventCommandFailedIndication_FSCI_ID = 0x4799,
	GAPScanningEventStateChangedIndication_FSCI_ID = 0x479A,
	GAPScanningEventCommandFailedIndication_FSCI_ID = 0x479B,
	GAPScanningEventDeviceScannedIndication_FSCI_ID = 0x479C,
	GAPConnectionEventConnectedIndication_FSCI_ID = 0x479D,
	GAPConnectionEventPairingRequestIndication_FSCI_ID = 0x479E,
	GAPConnectionEventSlaveSecurityRequestIndication_FSCI_ID = 0x479F,
	GAPConnectionEventPairingResponseIndication_FSCI_ID = 0x47A0,
	GAPConnectionEventAuthenticationRejectedIndication_FSCI_ID = 0x47A1,
	GAPConnectionEventPasskeyRequestIndication_FSCI_ID = 0x47A2,
	GAPConnectionEventOobRequestIndication_FSCI_ID = 0x47A3,
	GAPConnectionEventPasskeyDisplayIndication_FSCI_ID = 0x47A4,
	GAPConnectionEventKeyExchangeRequestIndication_FSCI_ID = 0x47A5,
	GAPConnectionEventKeysReceivedIndication_FSCI_ID = 0x47A6,
	GAPConnectionEventLongTermKeyRequestIndication_FSCI_ID = 0x47A7,
	GAPConnectionEventEncryptionChangedIndication_FSCI_ID = 0x47A8,
	GAPConnectionEventPairingCompleteIndication_FSCI_ID = 0x47A9,
	GAPConnectionEventDisconnectedIndication_FSCI_ID = 0x47AA,
	GAPConnectionEventRssiReadIndication_FSCI_ID = 0x47AB,
	GAPConnectionEventTxPowerLevelReadIndication_FSCI_ID = 0x47AC,
	GAPConnectionEventPowerReadFailureIndication_FSCI_ID = 0x47AD,
	GAPConnectionEventParameterUpdateRequestIndication_FSCI_ID = 0x47AE,
	GAPConnectionEventParameterUpdateCompleteIndication_FSCI_ID = 0x47AF,
	GAPConnectionEventLeDataLengthChangedIndication_FSCI_ID = 0x47B0,
	GAPConnectionEventLeScOobDataRequestIndication_FSCI_ID = 0x47B1,
	GAPConnectionEventLeScDisplayNumericValueIndication_FSCI_ID = 0x47B2,
	GAPConnectionEventLeScKeypressNotificationIndication_FSCI_ID = 0x47B3,
	GAPGenericEventControllerResetCompleteIndication_FSCI_ID = 0x47B4,
	GAPLeScPublicKeyRegeneratedIndication_FSCI_ID = 0x47B5,
	GAPGenericEventLeScLocalOobDataIndication_FSCI_ID = 0x47B6,
	GAPGenericEventControllerPrivacyStateChangedIndication_FSCI_ID = 0x47B7,
	GAPGenericEventTxPowerLevelSetCompleteIndication_FSCI_ID = 0x47B8,
	GAPGetBondedDevicesIdentityInformationIndication_FSCI_ID = 0x47B9,
} bleFsciIds_t;
...
==================================================================================================*/
#if L2CAP_ENABLE
memStatus_t L2CAPRegisterLePsmRequest(L2CAPRegisterLePsmRequest_t *req, void *arg, uint8_t fsciInterface);
memStatus_t L2CAPDeregisterLePsmRequest(L2CAPDeregisterLePsmRequest_t *req, void *arg, uint8_t fsciInterface);
memStatus_t L2CAPConnectLePsmRequest(L2CAPConnectLePsmRequest_t *req, void *arg, uint8_t fsciInterface);
memStatus_t L2CAPDisconnectLeCbChannelRequest(L2CAPDisconnectLeCbChannelRequest_t *req, void *arg, uint8_t fsciInterface);
memStatus_t L2CAPCancelConnectionRequest(L2CAPCancelConnectionRequest_t *req, void *arg, uint8_t fsciInterface);
memStatus_t L2CAPSendLeCbDataRequest(L2CAPSendLeCbDataRequest_t *req, void *arg, uint8_t fsciInterface);
memStatus_t L2CAPSendLeCreditRequest(L2CAPSendLeCreditRequest_t *req, void *arg, uint8_t fsciInterface);
#endif  /* L2CAP_ENABLE */
...
#if GATTDB_APP_ENABLE
memStatus_t GATTDBInitRequest(void *arg, uint8_t fsciInterface);
...
memStatus_t GAPGetBondedStaticAddressesRequest(GAPGetBondedStaticAddressesRequest_t *req, void *arg, uint8_t fsciInterface);
