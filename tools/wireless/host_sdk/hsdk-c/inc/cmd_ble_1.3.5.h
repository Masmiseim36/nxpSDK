/* Header file generated from BLE_1.3.5.xml */
/*
 * Copyright 2019 NXP
 * All rights reserved.
 *
...
typedef PACKED_STRUCT GAPControllerEnhancedNotificationRequest_tag {
	uint16_t EventType;  // 0x0400|0x0200|0x0100|0x80|0x40|0x20|0x10|0x08|0x04|0x02|0x01  // Events to enable.
	uint8_t DeviceId;  // Device ID of the peer.
...
/* Bluetooth device address types */
typedef enum GAPUpdatePeriodicAdvListRequest_DeviceAddressType_tag {
	GAPUpdatePeriodicAdvListRequest_DeviceAddressType_gPublic_c = 0x00,
	GAPUpdatePeriodicAdvListRequest_DeviceAddressType_gRandom_c = 0x01
} GAPUpdatePeriodicAdvListRequest_DeviceAddressType_t;

typedef PACKED_STRUCT GAPUpdatePeriodicAdvListRequest_tag {
	GAPUpdatePeriodicAdvListRequest_Operation_t Operation;  // The operation to be executed on the list
	GAPUpdatePeriodicAdvListRequest_DeviceAddressType_t DeviceAddressType;  // Bluetooth device address types
