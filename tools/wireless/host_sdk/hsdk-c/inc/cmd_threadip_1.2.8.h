/* Header file generated from ThreadIP_1.2.8.xml */
/*
...
typedef PACKED_STRUCT THR_CpuResetRequest_tag {
	uint32_t TimeoutMs;  // The time in milliseconds after which the device will reset.
...
typedef enum THR_MgmtDiagnosticGetRequest_TlvIds_TlvId_tag {
	...
	THR_MgmtDiagnosticGetRequest_TlvIds_TlvId_IeeeAddress = 0xA8
...
typedef PACKED_STRUCT THR_GetDeviceInfoRequest_tag {
	uint8_t InstanceID;  // Thread instance ID
} THR_GetDeviceInfoRequest_t;
...
/* Parent Priority */
typedef enum THR_SetParentPriorityRequest_Priority_tag {
	THR_SetParentPriorityRequest_Priority_MediumPriority = 0x00,
	THR_SetParentPriorityRequest_Priority_HighPriority = 0x01,
	THR_SetParentPriorityRequest_Priority_LowPriority = 0x03,
	THR_SetParentPriorityRequest_Priority_Reset = 0xFF
} THR_SetParentPriorityRequest_Priority_t;

typedef PACKED_STRUCT THR_SetParentPriorityRequest_tag {
	THR_SetParentPriorityRequest_Priority_t Priority;  // Parent Priority
} THR_SetParentPriorityRequest_t;
...
/* Threshold type */
typedef enum THR_SetThreshold32Request_ThresholdType_tag {
	THR_SetThreshold32Request_ThresholdType_ContextReuseDelay = 0x04
} THR_SetThreshold32Request_ThresholdType_t;

typedef PACKED_STRUCT THR_SetThreshold32Request_tag {
	uint8_t InstanceId;  // Thread instance Id
	THR_SetThreshold32Request_ThresholdType_t ThresholdType;  // Threshold type
	uint32_t Value;  // Value
} THR_SetThreshold32Request_t;
...
typedef PACKED_STRUCT THR_SetRouterPromoteMaxJitterRequest_tag {
	uint32_t MaxJitterInSeconds;  // MaxJitterInSeconds
} THR_SetRouterPromoteMaxJitterRequest_t;
...
typedef struct THR_SetAttrRequest_tag {
	...
	union {
		...
		struct {
			uint8_t AttrSize;  // Attribute size
			uint32_t Value;  // Value
		} SedPollInterval;  // The polling interval for the sleepy end device (SED) [milliseconds]
		struct {
			uint8_t AttrSize;  // Attribute size
			bool_t Value;  // Value
...
typedef enum SocketSetOptionRequest_SocketOption_tag {
	...
	SocketSetOptionRequest_SocketOption_SO_SOCKETBLOCK = 0x1003
...
typedef enum SocketGetOptionRequest_SocketOption_tag {
	...
	SocketGetOptionRequest_SocketOption_SO_SOCKETBLOCK = 0x1003
...
typedef PACKED_STRUCT SocketCloseRequest_tag {
	uint8_t SocketIndex;  // The socket index.
} SocketCloseRequest_t;
...
typedef PACKED_STRUCT MESHCOP_MgmNwkLeaveRequest_tag {
	uint8_t IPAddress[16];  // The IPv6 address of the device which will leave the network
} MESHCOP_MgmNwkLeaveRequest_t;
...
typedef PACKED_STRUCT NWKU_PingRequest_tag {
	...
	uint8_t HopLimit;  // Set hop limit for ping packets
} NWKU_PingRequest_t;
...
typedef enum NWKU_McastGroupManageRequest_Action_tag {
	...
	NWKU_McastGroupManageRequest_Action_Commissioner = 0x03
} NWKU_McastGroupManageRequest_Action_t;

typedef struct NWKU_McastGroupManageRequest_tag {
	uint8_t InterfaceId;  // Interface Id
	NWKU_McastGroupManageRequest_Action_t Action;  // Join or leave a multicast group
	bool_t UseTimeout;  // If TRUE, Timeout value will be used
	uint8_t McastAddrCount;  // Multicast Address Count
	uint32_t Timeout;  // Multicast group lifetime in seconds
	uint8_t DestIpAddress[16];  // Destination Ip Address - leave it 0 for auto select
	uint8_t *McastAddress;  // Multicast group address
} NWKU_McastGroupManageRequest_t;

typedef PACKED_STRUCT NWKU_FirewallEnableRequest_tag {
	bool_t Enable;  // Enable
} NWKU_FirewallEnableRequest_t;

typedef PACKED_STRUCT NWKU_FirewallRuleRemoveRequest_tag {
	uint8_t RuleEntryNumber;  // RuleEntryNumber
} NWKU_FirewallRuleRemoveRequest_t;

/* Rule can be accept or drop */
typedef enum NWKU_FirewallRuleAddRequest_Rule_tag {
	NWKU_FirewallRuleAddRequest_Rule_Drop = 0x00,
	NWKU_FirewallRuleAddRequest_Rule_Accept = 0x01
} NWKU_FirewallRuleAddRequest_Rule_t;

typedef PACKED_STRUCT NWKU_FirewallRuleAddRequest_tag {
	uint8_t RuleEntryNumber;  // RuleEntryNumber
	uint8_t SourcePrefix[16];  // Source IPv6 address/prefix
	uint8_t DestinationPrefix[16];  // Destination IPv6 address/prefix
	uint16_t SourcePort;  // Source UDP port
	uint16_t DestinationPort;  // Destination UDP port
	uint8_t SourcePrefixLen;  // Length in bits of source prefix
	uint8_t DestinationPrefixLen;  // Length in bits of destination prefix
	uint8_t SecurityLevel;  // SecurityLevel
	uint8_t InterfaceID;  // IP InterfaceID
	NWKU_FirewallRuleAddRequest_Rule_t Rule;  // Rule can be accept or drop
} NWKU_FirewallRuleAddRequest_t;
...
typedef enum SocketShutdownConfirm_Status_tag {
	...
	SocketShutdownConfirm_Status_ERRORSocketisnoTCP = 0xFF
...
/* Status */
typedef enum SocketCloseConfirm_Status_tag {
	SocketCloseConfirm_Status_OK = 0x00,
	SocketCloseConfirm_Status_ERROR = 0xFF
} SocketCloseConfirm_Status_t;

typedef PACKED_STRUCT SocketCloseConfirm_tag {
	SocketCloseConfirm_Status_t Status;  // Status
} SocketCloseConfirm_t;
...
typedef enum THR_PromoteAsRouterConfirm_Status_tag {
	...
	THR_PromoteAsRouterConfirm_Status_InvalidInstance = 0x02,
	THR_PromoteAsRouterConfirm_Status_NotPermitted = 0x04
...
typedef enum THR_EventGeneralConfirm_EventStatus_tag {
	...
	THR_EventGeneralConfirm_EventStatus_ChildRemoved = 0x0018,
	THR_EventGeneralConfirm_EventStatus_AllChildrenRemoved = 0x0019,
	THR_EventGeneralConfirm_EventStatus_RouterRemoved = 0x001A,
	THR_EventGeneralConfirm_EventStatus_RoutingUpdates = 0x001B
...
/* Status */
typedef enum THR_SetParentPriorityConfirm_Status_tag {
	THR_SetParentPriorityConfirm_Status_OK = 0x00,
	THR_SetParentPriorityConfirm_Status_Error = 0xFF
} THR_SetParentPriorityConfirm_Status_t;

typedef PACKED_STRUCT THR_SetParentPriorityConfirm_tag {
	THR_SetParentPriorityConfirm_Status_t Status;  // Status
} THR_SetParentPriorityConfirm_t;
...
typedef PACKED_STRUCT THR_GetDeviceInfoConfirm_tag {
	uint8_t InstanceId;  // Instance Id
	...
	uint8_t ExtendedNwkCapabilities;  // IsNdRouterBr|IsBrDev  // Extended Network Capabilities
} THR_GetDeviceInfoConfirm_t;
...
typedef enum THR_MgmtDiagnosticGetRspIndication_Payload_TlvId_tag {
	...
	THR_MgmtDiagnosticGetRspIndication_Payload_TlvId_IeeeAddress = 0xA8
...
typedef struct THR_MgmtDiagnosticGetRspIndication_tag {
	...
	uint8_t NoOfTLVs;  // Number of TLVs
	struct {
		...
		union {
			...
			uint64_t IeeeAddress;  // IEEE Address
		} TlvData;  // TLV data
	} *Payload;  // Payload
...
/* Status */
typedef enum THR_SetRouterPromoteMaxJitterConfirm_Status_tag {
	THR_SetRouterPromoteMaxJitterConfirm_Status_Success = 0x00,
	THR_SetRouterPromoteMaxJitterConfirm_Status_Notpermitted = 0x04
} THR_SetRouterPromoteMaxJitterConfirm_Status_t;

typedef PACKED_STRUCT THR_SetRouterPromoteMaxJitterConfirm_tag {
	THR_SetRouterPromoteMaxJitterConfirm_Status_t Status;  // Status
} THR_SetRouterPromoteMaxJitterConfirm_t;
...
/* Status */
typedef enum THR_SetThreshold32Confirm_Status_tag {
	THR_SetThreshold32Confirm_Status_Success = 0x00,
	THR_SetThreshold32Confirm_Status_InvalidParameter = 0x03
} THR_SetThreshold32Confirm_Status_t;

typedef PACKED_STRUCT THR_SetThreshold32Confirm_tag {
	THR_SetThreshold32Confirm_Status_t Status;  // Status
} THR_SetThreshold32Confirm_t;
...
typedef struct THR_GetNeighborInfoConfirm_tag {
	...
	union {
		...
		uint64_t NeighborNotFound;  // NeighborNotFound
...
/* Status */
typedef enum NWKU_FirewallEnableConfirm_Status_tag {
	NWKU_FirewallEnableConfirm_Status_Success = 0x00,
	NWKU_FirewallEnableConfirm_Status_Failed = 0x01
} NWKU_FirewallEnableConfirm_Status_t;

typedef PACKED_STRUCT NWKU_FirewallEnableConfirm_tag {
	NWKU_FirewallEnableConfirm_Status_t Status;  // Status
} NWKU_FirewallEnableConfirm_t;

/* Status */
typedef enum NWKU_FirewallRuleAddConfirm_Status_tag {
	NWKU_FirewallRuleAddConfirm_Status_Success = 0x00,
	NWKU_FirewallRuleAddConfirm_Status_Failed = 0x01
} NWKU_FirewallRuleAddConfirm_Status_t;

typedef PACKED_STRUCT NWKU_FirewallRuleAddConfirm_tag {
	NWKU_FirewallRuleAddConfirm_Status_t Status;  // Status
} NWKU_FirewallRuleAddConfirm_t;

/* Status */
typedef enum NWKU_FirewallRuleRemoveConfirm_Status_tag {
	NWKU_FirewallRuleRemoveConfirm_Status_Success = 0x00,
	NWKU_FirewallRuleRemoveConfirm_Status_Failed = 0x01
} NWKU_FirewallRuleRemoveConfirm_Status_t;

typedef PACKED_STRUCT NWKU_FirewallRuleRemoveConfirm_tag {
	NWKU_FirewallRuleRemoveConfirm_Status_t Status;  // Status
} NWKU_FirewallRuleRemoveConfirm_t;

typedef struct NWKU_FirewallTableShowResponse_tag {
	uint8_t CountEntries;  // Number of IPv6 rules
	struct {
		uint8_t RuleEntryNumber;  // RuleEntryNumber
		uint8_t SourcePrefix[16];  // SourcePrefix
		uint8_t DestinationPrefix[16];  // DestinationPrefix
		uint16_t SourcePort;  // SourcePort
		uint16_t DestinationPort;  // DestinationPort
		uint8_t SourcePrefixLength;  // SourcePrefixLength
		uint8_t DestinationPrefixLength;  // DestinationPrefixLength
		uint8_t SecurityLevel;  // SecurityLevel
		uint8_t InterfaceID;  // InterfaceID
		uint8_t Rule;  // Rule can be accept or drop
	} *Rule;  // FirewallRulesTable
} NWKU_FirewallTableShowResponse_t;
...
typedef enum thrFsciIds_tag
{
	...
	THR_GetDeviceInfoRequest_FSCI_ID = 0xCEC3,
	THR_ChildUpdateToParentRequest_FSCI_ID = 0xCE2F,
	THR_SetParentPriorityRequest_FSCI_ID = 0xCEC4,
	...
	THR_SetThreshold32Request_FSCI_ID = 0xCEE0,
	THR_SetNwkIdTimeoutRequest_FSCI_ID = 0xCE2E,
	THR_SetRouterPromoteMaxJitterRequest_FSCI_ID = 0xCE81,
	...
	SocketCloseRequest_FSCI_ID = 0xCE0F,
	...
	MESHCOP_MgmNwkLeaveRequest_FSCI_ID = 0xCE4A,
	...
	NWKU_FirewallEnableRequest_FSCI_ID = 0xCE77,
	NWKU_FirewallTableShowRequest_FSCI_ID = 0xCE7A,
	NWKU_FirewallRuleRemoveRequest_FSCI_ID = 0xCE79,
	NWKU_FirewallRuleAddRequest_FSCI_ID = 0xCE78,
	...
	SocketCloseConfirm_FSCI_ID = 0xCF0F,
	...
	THR_SetParentPriorityConfirm_FSCI_ID = 0xCFC4,
	...
	THR_GetDeviceInfoConfirm_FSCI_ID = 0xCFC3,
	...
	THR_SetRouterPromoteMaxJitterConfirm_FSCI_ID = 0xCF81,
	THR_SetThresholdConfirm_FSCI_ID = 0xCF20,
	THR_SetThreshold32Confirm_FSCI_ID = 0xCFE0,
	...
	NWKU_FirewallEnableConfirm_FSCI_ID = 0xCF77,
	NWKU_FirewallRuleAddConfirm_FSCI_ID = 0xCF78,
	NWKU_FirewallRuleRemoveConfirm_FSCI_ID = 0xCF79,
	NWKU_FirewallTableShowResponse_FSCI_ID = 0xCF7A,
...
typedef struct thrEvtContainer_tag
{
	...
	union {
		...
		SocketCloseConfirm_t SocketCloseConfirm;
#endif  /* SOCKET_ENABLE */
		...
		THR_SetParentPriorityConfirm_t THR_SetParentPriorityConfirm;
		...
		THR_GetDeviceInfoConfirm_t THR_GetDeviceInfoConfirm;
		...
		THR_SetRouterPromoteMaxJitterConfirm_t THR_SetRouterPromoteMaxJitterConfirm;
		THR_SetThresholdConfirm_t THR_SetThresholdConfirm;
		THR_SetThreshold32Confirm_t THR_SetThreshold32Confirm;
		...
		NWKU_FirewallEnableConfirm_t NWKU_FirewallEnableConfirm;
		NWKU_FirewallRuleAddConfirm_t NWKU_FirewallRuleAddConfirm;
		NWKU_FirewallRuleRemoveConfirm_t NWKU_FirewallRuleRemoveConfirm;
		NWKU_FirewallTableShowResponse_t NWKU_FirewallTableShowResponse;
