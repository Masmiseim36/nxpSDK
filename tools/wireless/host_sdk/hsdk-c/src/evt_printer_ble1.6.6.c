...
void SHELL_BleEventNotify(void *param)
{
	...
	switch (container->id)
	{
		...
		case GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication_FSCI_ID:
			shell_write("GAPAdvertisingEventPeriodicAdvertisingStateChangedIndication");
			break;
