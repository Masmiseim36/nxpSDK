...
static const char *ERRORSocketisnoTCP = "ERRORSocketisnoTCP";
...
static const char *ChildRemoved = "ChildRemoved";
static const char *AllChildrenRemoved = "AllChildrenRemoved";
static const char *RouterRemoved = "RouterRemoved";
static const char *RoutingUpdates = "RoutingUpdates";
...
void SHELL_ThrEventNotify(void *param)
{
	...
	switch (container->id)
	{
		...
		case SocketShutdownConfirm_FSCI_ID:
			...
			switch (container->Data.SocketShutdownConfirm.Status)
			{
				case SocketShutdownConfirm_Status_OK:
					shell_write(OK);
					break;
				case SocketShutdownConfirm_Status_ERRORSocketisnoTCP:
					shell_write(ERRORSocketisnoTCP);
					break;
				default:
		...
		case SocketCloseConfirm_FSCI_ID:
			shell_write("SocketCloseConfirm");
			shell_write(" -> ");
			switch (container->Data.SocketCloseConfirm.Status)
			{
				case SocketCloseConfirm_Status_OK:
					shell_write(OK);
					break;
				case SocketCloseConfirm_Status_ERROR:
					shell_write(ERROR);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.SocketCloseConfirm.Status);
					break;
			}
			break;
		...
		case THR_PromoteAsRouterConfirm_FSCI_ID:
			...
			switch (container->Data.THR_PromoteAsRouterConfirm.Status)
			{
				case THR_PromoteAsRouterConfirm_Status_OK:
					shell_write(OK);
					break;
				case THR_PromoteAsRouterConfirm_Status_InvalidInstance:
					shell_write(InvalidInstance);
					break;
				case THR_PromoteAsRouterConfirm_Status_NotPermitted:
					shell_write(NotPermitted);
					break;
				default:
		...
		case THR_EventGeneralConfirm_FSCI_ID:
			...
			switch (container->Data.THR_EventGeneralConfirm.EventStatus)
			{
				...
				case THR_EventGeneralConfirm_EventStatus_DeviceisMinimalEndDevice:
					...
					break;
				case THR_EventGeneralConfirm_EventStatus_ChildRemoved:
					shell_write(ChildRemoved);
					break;
				case THR_EventGeneralConfirm_EventStatus_AllChildrenRemoved:
					shell_write(AllChildrenRemoved);
					break;
				case THR_EventGeneralConfirm_EventStatus_RouterRemoved:
					shell_write(RouterRemoved);
					break;
				case THR_EventGeneralConfirm_EventStatus_RoutingUpdates:
					shell_write(RoutingUpdates);
					break;
				default:
		...
		case THR_SetParentPriorityConfirm_FSCI_ID:
			shell_write("THR_SetParentPriorityConfirm");
			shell_write(" -> ");
			switch (container->Data.THR_SetParentPriorityConfirm.Status)
			{
				case THR_SetParentPriorityConfirm_Status_OK:
					shell_write(OK);
					break;
				case THR_SetParentPriorityConfirm_Status_Error:
					shell_write(Error);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.THR_SetParentPriorityConfirm.Status);
					break;
			}
			break;
		...
		case THR_GetDeviceInfoConfirm_FSCI_ID:
			shell_write("THR_GetDeviceInfoConfirm");
			break;
		...
		case THR_SetRouterPromoteMaxJitterConfirm_FSCI_ID:
			shell_write("THR_SetRouterPromoteMaxJitterConfirm");
			shell_write(" -> ");
			switch (container->Data.THR_SetRouterPromoteMaxJitterConfirm.Status)
			{
				case THR_SetRouterPromoteMaxJitterConfirm_Status_Success:
					shell_write(Success);
					break;
				case THR_SetRouterPromoteMaxJitterConfirm_Status_Notpermitted:
					shell_write(Notpermitted);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.THR_SetRouterPromoteMaxJitterConfirm.Status);
					break;
			}
			break;
		...
		case THR_SetThreshold32Confirm_FSCI_ID:
			shell_write("THR_SetThreshold32Confirm");
			shell_write(" -> ");
			switch (container->Data.THR_SetThreshold32Confirm.Status)
			{
				case THR_SetThreshold32Confirm_Status_Success:
					shell_write(Success);
					break;
				case THR_SetThreshold32Confirm_Status_InvalidParameter:
					shell_write(InvalidParameter);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.THR_SetThreshold32Confirm.Status);
					break;
			}
			break;
		...
		case NWKU_FirewallEnableConfirm_FSCI_ID:
			shell_write("NWKU_FirewallEnableConfirm");
			shell_write(" -> ");
			switch (container->Data.NWKU_FirewallEnableConfirm.Status)
			{
				case NWKU_FirewallEnableConfirm_Status_Success:
					shell_write(Success);
					break;
				case NWKU_FirewallEnableConfirm_Status_Failed:
					shell_write(Failed);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.NWKU_FirewallEnableConfirm.Status);
					break;
			}
			break;

		case NWKU_FirewallRuleAddConfirm_FSCI_ID:
			shell_write("NWKU_FirewallRuleAddConfirm");
			shell_write(" -> ");
			switch (container->Data.NWKU_FirewallRuleAddConfirm.Status)
			{
				case NWKU_FirewallRuleAddConfirm_Status_Success:
					shell_write(Success);
					break;
				case NWKU_FirewallRuleAddConfirm_Status_Failed:
					shell_write(Failed);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.NWKU_FirewallRuleAddConfirm.Status);
					break;
			}
			break;

		case NWKU_FirewallRuleRemoveConfirm_FSCI_ID:
			shell_write("NWKU_FirewallRuleRemoveConfirm");
			shell_write(" -> ");
			switch (container->Data.NWKU_FirewallRuleRemoveConfirm.Status)
			{
				case NWKU_FirewallRuleRemoveConfirm_Status_Success:
					shell_write(Success);
					break;
				case NWKU_FirewallRuleRemoveConfirm_Status_Failed:
					shell_write(Failed);
					break;
				default:
					shell_printf("Unrecognized status 0x%02X", container->Data.NWKU_FirewallRuleRemoveConfirm.Status);
					break;
			}
			break;

		case NWKU_FirewallTableShowResponse_FSCI_ID:
			shell_write("NWKU_FirewallTableShowResponse");
			break;
